...
$sql_current_l = "SELECT b.factory_workshop,b.sales_team_id,b.competitor,b.locality,b.phone,b.ratings as cc,b.price_rateings as pp,b.delivery_time_rateings as dd,b.quality_rateings as qq,b.response_commission as rr,b.id as customer_id,b.company_name,b.sales_team_id FROM customers as b  JOIN all_ledgers as c ON b.id=c.customer_id  WHERE    b.deleteid='0' AND c.Party_type=1 $sql1  ORDER BY b.sales_team_id DESC";
   ...
   $cus_sql="INSERT INTO `customer_yes_or_no_report` (
                                           ...
                                           $customer_ids=mysqli_insert_id($conn); 
                                                                ...
                                                                $monthss="SELECT count(id) as nos,MONTHNAME(create_date) as month FROM orders_process   WHERE  deleteid=0 AND customer_id='".$value['customer_id']."' GROUP BY customer_id HAVING month='".$months[$j]."'";
      ...
      $monthsval=  $months[$j];
                                     ...
                                     $sqlssvss="UPDATE `customer_yes_or_no_report` SET ".$monthsval."='".$Setup."' WHERE customer_id='".$customer_id."'";
 ...
 $totalba=0;
       ...
       $monthss_setval="SELECT count(a.id) as nos,SUM(a.bill_total) as totalamount  FROM orders_process as a WHERE  a.deleteid=0 AND a.order_base=1 AND a.customer_id='".$value['customer_id']."'";

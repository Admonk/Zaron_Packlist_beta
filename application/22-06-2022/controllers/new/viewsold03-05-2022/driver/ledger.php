...
<body data-layout="horizontal" class="full-vh-overflow-hide" data-topbar="dark" ng-app="crudApp" ng-controller="crudController">
 ...
 <div class="main-content">
                            ...
                            <div class="col-xl-4 col-md-4">
                                ...
                                <div class="card card-h-50">
                                    ...
                                    <div class="card-body">
                                        <div class="d-flex align-items-center">
                                            <div class="flex-grow-1">
                                                <h3 class="text-muted mb-3 lh-1 d-block text-truncate">Total Paid</h3>
                                                <h4 class="mb-3">
                                    ...
                                    <div class="card-body">
                                        <div class="d-flex align-items-center">
                                            <div class="flex-grow-1">
                                                ...
                                                <h4 class="mb-3">
                                                    <span  ng-if="totalblance<0" style="color:red">Rs. {{totalblance}}</span>
                                                     <span  ng-if="totalblance>=0" style="color:green">Rs. {{totalblance}}</span>
                                                </h4>
              ...
              <button type="button" ng-click="onview()" id="exportdatadata"  class="btn btn-soft-success  waves-effect waves-light" style="float: right;margin: 24px 12px;">Payout</button>
                   ...
                   <table id="datatable"  class="table table-striped table-bordered"  ng-init="fetchDatagetlegderGroup(0)" >
                      <thead>
                        <tr>
                        ...
                        <tr  class="trpoint" >
                          ...
                          <td>{{names.no}}</td>
                         <td><a href="<?php echo base_url(); ?>index.php/driver/ledger_find?driver_id={{names.customer_id}}" target="_blank">{{names.name}}</a></td>
                           ...
                           <td style="font-weight:800;text-align: right;">
                                 ...
                                 <span  ng-if="names.no==1">
                                   ...
                                   <span  ng-if="totalblance<0" style="color:red">{{totalblance}}</span>
                                   <span  ng-if="totalblance>=0" style="color:green">{{totalblance}}</span>

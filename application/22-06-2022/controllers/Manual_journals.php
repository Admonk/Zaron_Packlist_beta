                                                ...
                                                foreach($additional_information as $vl)
                                                {
                                                     ...
                                                     $data['party_type']= $form_data->party_type; 
                                                      ...
                                                      $data['get_users']= $form_data->get_users;
                                                       ...
                                                       {
                                                           $query = $this->db->query("SELECT id,company_name as name,account_heads_id FROM customers  WHERE deleteid='0' AND id='".$form_data->get_users."' ORDER BY company_name ASC");
                                                       ...
                                                       {
                                                            $query = $this->db->query("SELECT id,name,account_heads_id FROM driver  WHERE deleteid='0'  AND id='".$form_data->get_users."' ORDER BY name ASC");
                                                            $tableleg="all_ledgers";
                                                       }
                                                       elseif($form_data->party_type=='3')
                                                       {
                                                           $query = $this->db->query("SELECT id,name,account_heads_id FROM vendor  WHERE deleteid='0' AND id='".$form_data->get_users."' ORDER BY name ASC");
                                                           $tableleg="all_ledgers";
                                                       ...
                                                       elseif($form_data->party_type=='4')
                                                       {
                                                           ...
                                                           $query = $this->db->query("SELECT id,bank_name,account_heads_id as name FROM bankaccount  WHERE deleteid='0' AND id='".$form_data->get_users."' ORDER BY bank_name ASC");
                                                       ...
                                                       elseif($form_data->party_type=='5')
                                                       {
                                                            ...
                                                            $query = $this->db->query("SELECT id,name,account_heads_id FROM accountheads  WHERE deleteid='0' AND id='".$form_data->get_users."' ORDER BY name ASC");
                                                            $tableleg="all_ledgers";
                                                       ...
                                                       else
                                                       {
                                                          // $query = $this->db->query("SELECT id,name FROM partyusers  WHERE deleteid='0' AND  id='".$form_data->get_users."' ORDER BY name ASC");
                                                           ...
                                                           $query = $this->db->query("SELECT id,name,account_heads_id FROM admin_users  WHERE deleteid='0' AND access!='13' AND id='".$form_data->get_users."' ORDER BY name ASC");
                                                           $tableleg="all_ledgers";
                                                     ...
                                                     $sizedata['primary_id']=$insert_id;
                                                       ...
                                                       if($bankaccount!='0')
                                                       {
                                                             ...
                                                             foreach($resbankaccount as $valb)
                                                             {
                                                                ...
                                                                $data_bank['account_head_id']=$account_heads_by_bank;

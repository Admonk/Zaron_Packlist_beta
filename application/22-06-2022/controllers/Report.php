...
class Report extends CI_Controller {
		...
		public function trial_balance_report_full()
	{
                     ...
                     $result=$this->db->query("SELECT * FROM accountheads_sub_group WHERE deleteid=0  $sql  ORDER BY id DESC");
                 	 $result=$result->result();
                 	 ...
                 	 foreach ($result as  $value) {
                             ...
                             $debit1=0;
                             $balance1=0;
                             $result=$this->db->query("SELECT SUM(credits) as totalcridit,SUM(debits) as totaldebit FROM all_ledgers WHERE deleteid=0 AND account_head_id='".$value->id."'  ORDER BY id DESC");
                 	         $result=$result->result();
                    ...
                    $accountshead=$_GET['accountshead'];
                     ...
                     if(isset($_GET['payment_status']))
                     {
                              ...
                              if($payment_status!='')
                              {
                                      if($payment_status=='1')
                                      {
                                          $Stl=' AND cash_trasfer_status="0"';
                                      }
                                      else
                                      {
                                          $Stl=' AND cash_trasfer_status="1"';
                                      } 

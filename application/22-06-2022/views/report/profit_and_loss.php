...
<body data-layout="horizontal" class="full-vh-overflow-hide" data-topbar="dark" ng-app="crudApp" ng-controller="crudController">
 ...
 <div class="main-content">
  ...
  <tr><td> <b > <a href="#"  style="color: #ef7b3f;font-weight: 800;">{{names.name}}</a> </b> </td> <td></td></tr>
   ...
   <tr ng-repeat="namesvv in names.resultsub"><td>  <a href="{{namesvv.url}}" >{{namesvv.name}}</a>  </td> <td>{{namesvv.credit | number}}</td></tr>
  ...
  <tr>
    ...
    <th> Amount </th>
                         ...
                         <tr>
                          <td>GROSS PROFIT (TRANSFERRED FROM TRADING A/C) </td>
                          <td>{{btotal-atotal | number}}</td>
                         </tr>

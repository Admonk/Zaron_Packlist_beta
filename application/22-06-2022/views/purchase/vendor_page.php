                     ...
                     ?>
                                ...
                                <tr>
                                    <th><?php echo $val->product_name; ?></th>
                                     ...
                                     <th><?php  if($val->uom=='1') { echo 'TON';  } else{   echo 'KG';  } ?></th>
                                     <th><?php echo $val->qty; ?></th>
                                     <th>
                                         
                                         <input  style="width: 60%;" class="form-control price" name="price"  required  type="text">

                                                ...
                                                <div class="flex-shrink-0">
                                                   <ul class="nav justify-content-end nav-tabs-custom rounded card-header-tabs" role="tablist" ng-init="getcount('purchase_orders_process')">
                                                      ...
                                                      <li class="nav-item">
                                                         ...
                                                         <span class="d-block d-sm-none"><i class="far fa-envelope"></i></span>
                                                         <span class="d-none d-sm-block">Partial Payout<span class="badge rounded-pill bg-success float-end"> {{payment_vendor}} </span></span>   
                                                         </a>
                                                      </li>
                                                      ...
                                                      <li class="nav-item">
                                                         ...
                                                         <span class="d-block d-sm-none"><i class="far fa-envelope"></i></span>
                                                         <span class="d-none d-sm-block">Full Payout<span class="badge rounded-pill bg-success float-end"> {{payment_vendor_f}} </span></span>   
                                                         </a>
                                                      </li>
                                                              ...
                                                              <table class="table align-middle table-nowrap newBorderedTable" >
                                                                  ...
                                                                  <tbody>
                                                                      ...
                                                                      <td><a href="<?php echo base_url(); ?>index.php/purchase/purchase_ordercreate_product?order_id={{name.base_id}}&sales_request=0">{{name.totalamount}}</a></td>
                                                                           ...
                                                                           <td> <a href="<?php echo base_url(); ?>index.php/purchase/purchase_ordercreate_product?order_id={{name.base_id}}&sales_request=0">{{name.reason}}</a></td>
                                                                             ...
                                                                             <?php
                                                                              ...
                                                                              <td><a href="<?php echo base_url(); ?>index.php/purchase/purchase_ordercreate_product?order_id={{name.base_id}}&sales_request=0">{{name.order_by}}</a></td>
                                                                          ...
                                                                          <td>
                                                                             ...
                                                                             <a href="<?php echo base_url(); ?>index.php/purchase/purchase_ordercreate_product?order_id={{name.base_id}}" ><i class="mdi mdi-eye font-size-16 text-success me-1"></i> View</a>
                                                                              ...
                                                                              <a href="<?php echo base_url(); ?>index.php/purchase/po_edit?order_id={{name.base_id}}&old_tablename=0&old_tablename_sub=0&tablename=purchase_orders_process&tablename_sub=purchase_product_list_process&movetablename=purchase_orders_process&movetablename_sub=purchase_product_list_process" ng-if="name.invoice!=0"  target="_blank"><i class="mdi mdi-pencil font-size-16 text-success me-1"></i> Invoice Edit</a>
                                                                              </span>

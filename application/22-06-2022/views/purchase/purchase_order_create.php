...
<body data-layout="horizontal" class="full-vh-overflow-hide" data-topbar="dark" ng-app="crudApp" ng-controller="crudController">
                    ...
                    <div class="col-lg-9 col-12">
                        ...
                        <div class="customer-bill-info mb-1" ng-init="fetchVendor()">
                           <div class="row">
                                ...
                                <div  class="d-inline col-4 pe-3 border-end  "  >
                                    ...
                                    <label>Selected Vendor</label>
                                            ...
                                            <?php
                                             ...
                                             ?>
                                                  ...
                                                  <a href="<?php echo base_url(); ?>index.php/purchase/po_edit?order_id=<?php echo $enable_order; ?>&old_tablename=<?php echo $old_tablename; ?>&old_tablename_sub=<?php echo $old_tablename_sub; ?>&tablename=<?php echo $tablename; ?>&tablename_sub=<?php echo $tablename_sub; ?>&movetablename=<?php echo $movetablename; ?>&movetablename_sub=<?php echo $movetablename_sub; ?>" target="_blank" style="background: #ff1800;padding: 4px;color: white;"  ng-if="invoice!=0">Invoice Edit</a>
                                            ...
                                            <?php
                                            if($this->session->userdata['logged_in']['access']=='19' || $this->session->userdata['logged_in']['access']=='1')
                                            {
                                            ?>
                                            <span ng-if="order_base==6">
                                                   <a href="<?php echo base_url(); ?>index.php/purchase/po_inward?order_id=<?php echo $enable_order; ?>&old_tablename=<?php echo $old_tablename; ?>&old_tablename_sub=<?php echo $old_tablename_sub; ?>&tablename=<?php echo $tablename; ?>&tablename_sub=<?php echo $tablename_sub; ?>&movetablename=<?php echo $movetablename; ?>&movetablename_sub=<?php echo $movetablename_sub; ?>" ng-if="name.invoice!=0"  target="_blank"><i class="mdi mdi-upload font-size-16 text-success me-1"></i> Inward</a>
                                            </span>
                                             <?php
                                             }
                                            ?>
                            ...
                            <span ng-if="order_base>=2">
                                   <?php
                                    ...
                                    <button type="button"  data-bs-toggle="offcanvas" data-bs-target="#offcanvasPayout" ng-Click="onClickPayment(vendor_id_fix)" aria-controls="offcanvasRight" class="btn btn-outline-success" ><i class="mdi mdi-cash"></i> Payout </button>
                                    <?php
                                    }
                                    ?>
                             
                                <button type="button"  data-bs-toggle="offcanvas" data-bs-target="#offcanvasDelivery" ng-Click="onClickDelivery(vendor_id_fix)" aria-controls="offcanvasRight" class="btn btn-outline-danger" ><i class="mdi mdi-map"></i> Delivery Status </button>
                             </span>
                                       ...
                                       <thead class="bg-gray text-red" >
                                          ...
                                          <tr>
                                              ...
                                              <th class="table-width-8" data-priority="3">UNIT</th>
                                                  ...
                                                  <th class="table-width-8" data-priority="3">PRICE</th>
                                              ...
                                              <th class="table-width-8" data-priority="3">AMOUNT</th>
                                          ...
                                          <tr class="view" >
                                            ...
                                            <td title="{{name.categories}}"  data-label="Products">
                                             ...
                                             <span ng-if="order_base==2">
                                               ...
                                               <?php if (in_array($this->session->userdata['logged_in']['access'],$arr)) { ?>
                                              <input type="text"  ng-keyup="inputsave_1(name.id,'qty',1,1)"    id="qty_{{name.id}}" value="{{name.qty_tab}}">
                                              <?php }else{ ?> {{name.qty_tab}} <?php } ?>
                                                 </span>
                                             <span ng-if="order_base!=2"><input type="text"  ng-keyup="inputsave_1(name.id,'qty',1,1)"    id="qty_{{name.id}}" value="{{name.qty_tab}}"> </span>
                                             
                                             
                                             
                                             </td>
                                             <td id="amount_{{name.id}}" data-label="Amount" >{{name.amount_tab}}</td>
                        ...
                        <div class="floater-options1"    ng-init="fetchSingleDatatotal('1')">
                            ...
                            <div class="row">
                              ...
                              <div class="col-8 <?php echo $none; ?>" >
                                 ...
                                 <div class="mt-3 hstack gap-3" ng-if="vendorcount>0" >
                              ...
                              <div class="col-4 ">
                                 ...
                                 <div class="mt-3 hstack gap-3">
                                     ...
                                     <h4>Total Amount : {{discountfulltotal}}</h4>
 ...
 <div class="modal fade" id="firstmodal2" aria-hidden="true" aria-labelledby="exampleModalToggleLabel" tabindex="-1">
  ...
  <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasPayout" aria-labelledby="offcanvasRightLabel" style="width: 800px;" >
         ...
         <div class="offcanvas-body pt-0" >
            <div class="card bg-transparent pt-0" style="box-shadow: none !important;">
               <div class="card-body pt-0" >
                  ...
                  <form ng-submit="submitPayment()" method="post" class="ng-pristine ng-invalid ng-invalid-required">

                       <h4>Bill Amount : {{discountfulltotal}} Pending Amount : {{discountfulltotal-amounttotal}}</h4>
                       ...
                       <div class="row">
                           ...
                           <label class="col-sm-12 col-form-label">Amount <span style="color:red;">*</span></label>
                            <div class="col-sm-12">
                            <input type="number" max="{{discountfulltotal-amounttotal}}" value="{{discountfulltotal-amounttotal}}" style="padding:9px;" class="form-control" required  id="vendor_amount">                            
                            </div>
                             </div>
                        ...
                        <div class="row">
                           ...
                           <label class="col-sm-12 col-form-label">Payment Mode <span style="color:red;">*</span></label>
                            <div class="col-sm-12">
                           <select class="form-control" name="payment_mode_payoff" required id="payment_mode_payoff">
                           ...
                           <div class="row">
                              <div class="col">
                                 <div class="position-relative">
                                    <input type="text" class="form-control border bg-soft-light" required id="notes" placeholder="Enter Notes...">
                                 </div>
                              </div>
                              <div class="col-auto">
                                 <button type="submit" class="btn btn-primary chat-send w-md waves-effect waves-light"><span class="d-none d-sm-inline-block me-2" id="savePayment">Payout</span> <i class="mdi mdi-save float-end"></i></button>
                              </div>
                           </div>
                        </div>
                     </div>
                  ...
                  <table class="table">
                      ...
                      <tr ng-repeat="selectPayment in paymentHistory" style="vertical-align: baseline;">
                          <td>{{selectPayment.no}}</td>
                          <td>{{selectPayment.amount}}</td>
                        
                         
                           <td>{{selectPayment.payment_type}}</td>
                           <td>{{selectPayment.payment_mode}} {{selectPayment.bankname}}</td>
                           <td>{{selectPayment.notes}}</td>
                           <td>{{selectPayment.create_date}}</td>
               ...
               <div class="card-body pt-0" >
                         ...
                         <input type="hidden" id="vendor_id_fix_delivery" value="{{vendor_id_fix}}">
                           <div class="row">
                             ...
                             <div class="form-group col-md-12">
                              ...
                              <div class="col-sm-12">
                              <select class="form-control" name="delivery_status" required id="delivery_status">
                                                             
                                         <option value="">Select</option>     
                                         <option value="7">Production Complete</option>
                ...
                <div class="row">
                               ...
                               <div class="progress-barr-wrapper">
                                  <div class="status-bar" style="width: 87.5%;">
                                     <div class="current-status" style="width: 85.7143%; transition: width 9000ms linear 0s;"></div>
                                  </div>
                                       ...
                                       <span ng-if="order_base==0">
                                            <ul class="progress-barr">
                                             <li class="section visited"  style="width: 10.5%;">Create </li>
                                             <li class="section"  style="width: 10.5%;">Enquiry to Vendor</li>
                                             <li class="section"  style="width: 10.5%;">PO</li>
                                             <li class="section"  style="width: 10.5%;">Partial Payout</li>
                                             <li class="section"  style="width: 10.5%;">Full Payout</li>
                                              <li class="section "  style="width: 10.5%;">Production Complete</li>
                                             <li class="section"  style="width: 10.5%;">Dispatch</li>
                                            
                                             <li class="section" style="width: 10.5%;">Delivered</li>
                                             <li class="section " style="width: 10.5%;">Inward</li>
                                            </ul>
                                       </span>
                                       ...
                                       <span ng-if="order_base==1">
                                            <ul class="progress-barr">
                                             <li class="section visited"  style="width: 10.5%;">Create </li>
                                             <li class="section visited"  style="width: 10.5%;">Enquiry to Vendor</li>
                                             <li class="section"  style="width: 10.5%;">PO</li>
                                             <li class="section"  style="width: 10.5%;">Partial Payout</li>
                                             <li class="section"  style="width: 10.5%;">Full Payout</li>
                                              <li class="section "  style="width: 10.5%;">Production Complete</li>
                                       ...
                                       <span ng-if="order_base==2">
                                            <ul class="progress-barr">
                                             <li class="section visited"  style="width: 10.5%;">Create </li>
                                             <li class="section visited"  style="width: 10.5%;">Enquiry to Vendor</li>
                                             <li class="section visited"  style="width: 10.5%;">PO</li>
                                             <li class="section"  style="width: 10.5%;">Partial Payout</li>
                                             <li class="section"  style="width: 10.5%;">Full Payout</li>
                                              <li class="section "  style="width: 10.5%;">Production Complete</li>
                                             <li class="section"  style="width: 10.5%;">Dispatch</li>
                                       ...
                                       <span ng-if="order_base==3">
                                            <ul class="progress-barr">
                                             ...
                                             <li class="section visited"  style="width: 10.5%;">Enquiry to Vendor</li>
                                             <li class="section visited"  style="width: 10.5%;">PO</li>
                                             <li class="section visited"  style="width: 10.5%;">Partial Payout</li>
                                             <li class="section"  style="width: 10.5%;">Full Payout</li>
                                              <li class="section "  style="width: 10.5%;">Production Complete</li>
                                             <li class="section"  style="width: 10.5%;">Dispatch</li>
                                        ...
                                        <span ng-if="order_base==4">
                                            <ul class="progress-barr">
                                             ...
                                             <li class="section visited"  style="width: 10.5%;">PO</li>
                                             <li class="section visited"  style="width: 10.5%;">Partial Payout</li>
                                             <li class="section visited"  style="width: 10.5%;">Full Payout</li>
                                              <li class="section "  style="width: 10.5%;">Production Complete</li>
                                             <li class="section"  style="width: 10.5%;">Dispatch</li>
                                          ...
                                          <span ng-if="order_base==7">
                                            <ul class="progress-barr">
                                             ...
                                             <li class="section visited"  style="width: 10.5%;">Partial Payout</li>
                                             <li class="section visited"  style="width: 10.5%;">Full Payout</li>
                                              <li class="section visited"  style="width: 10.5%;">Production Complete</li>
                                             <li class="section"  style="width: 10.5%;">Dispatch</li>
                                             <li class="section" style="width: 10.5%;">Delivered</li>
                                             <li class="section " style="width: 10.5%;">Inward</li>
                                            </ul>
                                        ...
                                        <span ng-if="order_base==5">
                                            <ul class="progress-barr">
                                             ...
                                             <li class="section visited"  style="width: 10.5%;">Full Payout</li>
                                              <li class="section visited"  style="width: 10.5%;">Production Complete</li>
                                             <li class="section visited"  style="width: 10.5%;">Dispatch</li>
                                        ...
                                        <span ng-if="order_base==6">
                                            <ul class="progress-barr">
                                             ...
                                             <li class="section visited"  style="width: 10.5%;">Production Complete</li>
                                             <li class="section visited"  style="width: 10.5%;">Dispatch</li>
                                             <li class="section visited" style="width: 10.5%;">Delivered</li>
                                             <li class="section " style="width: 10.5%;">Inward</li>
                                            </ul>
                                       </span>
                                       ...
                                       <span ng-if="order_base==8">
                                            <ul class="progress-barr">
                                             ...
                                             <li class="section visited"  style="width: 10.5%;">Dispatch</li>
                                             <li class="section visited" style="width: 10.5%;">Delivered</li>
                                             <li class="section visited" style="width: 10.5%;">Inward</li>
                                            </ul>
                                       </span>
         ...
         <div class="offcanvas-body pt-0">
            <div class="card bg-transparent pt-0" style="box-shadow: none !important;">
               ...
               <table style="width: 100%;">
                ...
                <tr ><td> QTY</td></tr>
                <tr ><td> Price</td></tr>
                    <tr ><td> Time Line (Days)</td></tr>
                <tr ><td> Freight included or extra</td></tr>
                <tr ><td> Extra</td></tr>
                <tr ><td> Payment Terms</td></tr>
                <tr ><td> Due Date</td></tr>
                ...
                <td ng-repeat="compareunc in getcomparedata"  ng-style="compareunc.selected_status == 1 && {'background-color':'#ffe0e0'}">
            <table class="price-table" >
               
              
                <tr><td><b>{{compareunc.vendor_name}}</b></td></tr>
                <tr><td>  {{compareunc.uom}}</td></tr>
                <tr><td>  {{compareunc.qty}}</td></tr>
                <tr><td>  {{compareunc.price}}</td></tr>
                <tr><td>  {{compareunc.timeline}}</td></tr>
                <tr><td> {{compareunc.extra_included}}</td></tr>
                <tr><td> {{compareunc.extra}}</td></tr>
                <tr><td> {{compareunc.payment_terms}}</td></tr>
                <tr><td> {{compareunc.due_date}}</td></tr>
                
                <tr><td> {{compareunc.remarks}}</td></tr>
                 <tr ><td> <b> {{compareunc.total}}</b></td></tr>
                <tr><td data-bs-toggle="modal" ng-click="seletQutationfile(compareunc.attachement)" data-bs-target="#previewPdf"><u><i class="mdi mdi-file-outline text-muted font-size-16  me-1"></i><span style="margin:3px;"> QUOTE </span></u></td></tr>
                <tr><td class="price">     
                
                       <span ng-if="order_base==1">
                          <a href="javascript:void(0);" ng-click="seletQutation(compareunc.id,compareunc.order_id,compareunc.vendor_id)">Select</a>
                       </span>
...
var vendor_id=$('#vendor_id_fix').val();
 ...
 if(vendor_amount!='')
 {
    ...
    $http({
      ...
      data:{'notes':notes,'payment_type':payment_type,'payment_mode_payoff':payment_mode_payoff,'amount':vendor_amount,'bankaccount':bankaccount,'vendor_id':vendor_id,'order_no':'<?php echo $order_no; ?>','order_id':'<?php echo $order_id; ?>','tablenamemain':'purchase_order_remarks'}
    }).success(function(data){

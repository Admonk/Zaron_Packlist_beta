  ...
  $scope.submitForm = function(){
    ...
    $http({
      ...
      url:"<?php echo base_url() ?>index.php/customer/insertandupdate",
       ...
       ?>
       'google_map_link':$scope.google_map_link,'gst_status':$scope.gst_status,'feedback_details':$scope.feedback_details,'zone':$scope.zone,'price_rateings':price_rateings,'delivery_time_rateings':delivery_time_rateings,'quality_rateings':quality_rateings,'response_commission':response_commission,'ratings':ratings,'credit_period':$scope.credit_period,'credit_limit':$scope.credit_limit,'feedback':$scope.feedback,'phone':$scope.phone,'city':$scope.city,'locality':$scope.locality,'state':$scope.state,'pincode':$scope.pincode,'landmark':$scope.landmark,'address1':$scope.address1,'address2':$scope.address2,'company_name':$scope.company_name,'gst':$scope.gst,'landline':$scope.landline,'email':$scope.email,'sales_group':$scope.sales_group,'id':$scope.hidden_id,'action':$scope.submit_button,'tablename':'customers'}
    }).success(function(data){

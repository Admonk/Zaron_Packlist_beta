 ...
 <div class="dropdown">
                 ...
                 <a class="dropdown-item"  href="<?php echo base_url(); ?>index.php/vehicle/vehicle_view">Vehicle List</a>
                  <a class="dropdown-item" href="<?php echo base_url(); ?>index.php/driver/driverview">Driver List</a>
                                       ...
                                       <a class="dropdown-item"  href="<?php echo base_url(); ?>index.php/accountheads">Others Creation</a>
                                    ...
                                    <a class="nav-link dropdown-toggle arrow-none" href="#" id="topnav-ledger" role="button">
                                     ...
                                     <div class="dropdown">
                                          ...
                                          <div class="dropdown-menu" aria-labelledby="topnav-accountsmaster">
                                                         ...
                                                         <a class="dropdown-item"  href="<?php echo base_url(); ?>index.php/accounttype">Priamry Group</a>
                                          ...
                                          <div class="dropdown-menu" aria-labelledby="topnav-accountsmaster">
                                              ...
                                              <a class="dropdown-item" href="<?php echo base_url(); ?>index.php/report/balancereport?type=1">Cash In Hand Report</a>
                                              <a class="dropdown-item" href="<?php echo base_url(); ?>index.php/report/accountsreport">Bank Accounts Report</a>
                                              ...
                                              <a class="dropdown-item" href="<?php echo base_url(); ?>index.php/manual_journals/newcreate">Journal Entry</a>

                             ...
                             <div class="col-xl-4 col-md-4" >
                                ...
                                <div class="card card-h-50">
                                    ...
                                    <div class="card-body">
                                        <div class="d-flex align-items-center">
                                            <div class="flex-grow-1">
                                                <h3 class="text-muted mb-3 lh-1 d-block text-truncate">Pending Amount</h3>
                                                <h4 class="mb-3">
                                                   <span  ng-if="totalblance<0" style="color:red"> {{totalblance | number}}</span>
                                                     <span  ng-if="totalblance>=0" style="color:green"> {{0 | number}}</span>
                                                </h4>
                   ...
                   <table id="datatable"  class="table table-striped table-bordered" width="100%" ng-init="fetchDatagetlegderGroup(0)" >
                      <thead>
                        <tr>
                          ...
                          <th style="width:130px;"><h5 class="font-size-14 mb-0">Chq/Ref.No</h5></th>
                             
                          <th style="width:100px;"><h5 class="font-size-14 mb-0">Amount</h5></th>
                          <th style="width:100px;"><h5 class="font-size-14 mb-0">Debit</h5></th>
                          <th style="width:100px;"><h5 class="font-size-14 mb-0">Credit</h5></th>
                          <th style="width:100px;display:none;"><h5 class="font-size-14 mb-0">Balance</h5></th>
                           <th style="width:200px;"><h5 class="font-size-14 mb-0">Payment Mode</h5></th>
                        ...
                        <tr  class="trpoint" >
                           ...
                           <td style="font-weight:800;text-align: right;display:none;">

...
$('#exportdata').on('click', function() {
    ...
    url = '<?php echo base_url() ?>index.php/accountheads/fetch_data_get_ledger_view_export?limit=10&customer_id='+id+'&formdate='+fromdate+'&todate='+fromto+'&payment_status='+payment_status;
...
$scope.onview = function(id,billno,pendingamount,resno){
 ...
 $scope.Getbalance1 = function () {
        ...
        var party=  $('#party1').val();
           ...
           $http({
		      method:"POST",
		      url:"<?php echo base_url(); ?>index.php/accountheads/fetch_balance",
		      data:{'id':party, 'action':'fetch_single_data','tablename':'accountheads'}
		    }).success(function(data){
...
$scope.onviewparty = function(){
     ...
     $scope.completeCustomer1=function(){
        ...
        $http({
          ...
          data:{'search':search,'party_type':'5'}
        }).success(function(data){
...
$scope.saveTransfer = function(party1,party2,fromdate,fromto,enteramount,notes){
                        ...
                        $http({
                        method:"POST",
                        url:"<?php echo base_url() ?>index.php/accountheads/save_to_pay_transfer",
...
$scope.saveTransfer1 = function(party1,party2,fromdate,fromto,enteramount,notes){
                        ...
                        $http({
                        method:"POST",
                        url:"<?php echo base_url() ?>index.php/accountheads/save_to_pay_transfer1",
                        data:{'notes':notes,'enteramount':enteramount,'customer_id':party1,'customer_id2':party2,'account_head_id':$scope.account_head_id}
                        }).success(function(data){
...
$scope.fetchDatagetlegderGroup = function(id,fromdate,fromto,payment_status){
    ...
    $http.get('<?php echo base_url() ?>index.php/accountheads/fetch_data_get_ledger_view?limit=10&customer_id='+id+'&formdate='+fromdate+'&todate='+fromto+'&payment_status='+payment_status).success(function(data){
...
$scope.fetchDatagetlegderGroupTotal = function(id,fromdate,fromto,payment_status){
    ...
    $http.get('<?php echo base_url() ?>index.php/accountheads/fetch_data_get_ledger_view_total?limit=10&customer_id='+id+'&formdate='+fromdate+'&todate='+fromto+'&payment_status='+payment_status).success(function(data){

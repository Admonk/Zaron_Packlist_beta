                                                            ...
                                                            <tr ng-repeat="namess in namesDatadetails | filter:query">
                                                               ...
                                                               <td style="text-align: left;">{{namess.create_date}}</td>
                                                                ...
                                                                <td style="text-align: left;">
                                                                   <p ng-if="namess.name"><small><b>{{namess.name}}</b></small></p> 
                                                                  
                                                                   <p ng-if="namess.status_by">{{namess.status_by}}</p> 
                                                                ...
                                                                <td style="text-align: right;">
                                                                 ...
                                                                 <td style="text-align: right;">
                                                                      ...
                                                                      <span  ng-if="namess.balance<0" style="color:red">{{namess.balance | number}}</span>
                                   <span  ng-if="namess.balance>=0" style="color:green">{{namess.balance | number}}</span>

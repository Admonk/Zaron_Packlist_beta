                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    <h4 class="mb-sm-0 font-size-18">Sale Head Form</h4>

                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            <li class="breadcrumb-item"><a href="<?php echo base_url(); ?>index.php/dashboard">Dashboard</a></li>
                                            <li class="breadcrumb-item active"> Sale Head Form</li>
                                        </ol>
                                    </div>
...
<form id="pristine-valid-example" novalidate method="post"></form>
 ...
 <div class="row">
                     ...
                     <div class="col-md-3">
                         ...
                         <div class="col-md-3">
                          <div class="form-group row">
                            <label class="col-sm-12 col-form-label">Login Pin</label>
                            <div class="col-sm-12">
...
<hr></hr>
<h4 class="mb-sm-0 font-size-18">Sales Head List</h4>      
<br>
...
app.controller('crudController', function($scope, $http){
  ...
  $scope.fetchData = function(){
    $http.get('<?php echo base_url() ?>index.php/sales/fetch_data_sales_group').success(function(data){
  ...
  $scope.submitForm = function(){
    $http({
      ...
      data:{'name':$scope.name,'sales_group':$scope.sales_group,'email':$scope.email,'phone':$scope.phone,'pin':$scope.pin,'status':$scope.status,'id':$scope.hidden_id,'action':$scope.submit_button,'tablename':'sales_head'}
      ...
      if(data.error != '1')
      {
        ...
        $scope.hidden_id = "";
        $scope.successMessage = "Sales Head successfully "+$scope.submit_button;
        $scope.fetchData();
      }
...
$scope.fetchSingleData = function(id){
    $http({
      method:"POST",
      url:"<?php echo base_url() ?>index.php/sales/fetch_single_data",
      data:{'id':id, 'action':'fetch_single_data','tablename':'sales_head'}
    }).success(function(data){
...
$scope.deleteData = function(id){
    if(confirm("Are you sure you want to remove it?"))
    {
      $http({
        method:"POST",
        url:"<?php echo base_url() ?>index.php/sales/insertandupdate",
        data:{'id':id, 'action':'Delete','tablename':'sales_head'}
      }).success(function(data){
        $scope.success = false;
        $scope.error = false;
        $scope.fetchData();

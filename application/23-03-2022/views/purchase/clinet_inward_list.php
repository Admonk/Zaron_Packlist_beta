              ...
              <div class="col-lg-12">
                <div class="card">
                    ...
                    <div class="card-header">
                                        <h4 class="card-title">Clinet Inward List Table</h4>
                                        
                    </div>
                    
                      <div class="col-lg-12">
                         <button type="button" style="float: right;margin: 7px 20px;" class="btn btn-primary  waves-effect" data-bs-toggle="modal"  data-bs-target=".bs-example-modal-lg">Add Client Inward</button>
                       </div>                           
                                                    ...
                                                    <div class="modal-dialog modal-lg">
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                                <h5 class="modal-title" id="myLargeModalLabel">Imward Product</h5>
                       ...
                       <div class="row">
                          ...
                          <div class="form-group row">
                            ...
                            <div class="col-sm-12" ng-init="fetchData()">
                               <select class="form-control product_id"  name="product_id"  ng-model="product_id">

                              <option value="OrderMAP"> Select Product</option>
                          ...
                          <div class="form-group row">
                            ...
                            <div class="col-sm-12" ng-init="fetchDatavendor()">
                               ...
                               <option value=""> Select Customer</option>
                                ...
                                <option ng-repeat="namevendor in vendorData" value="{{namevendor.id}}">{{namevendor.company_name}}</option>
                        ...
                        <div class="col-md-6" style="display:none;">
                          <div class="form-group row">
                            ...
                            <div class="col-sm-12">
                             <input id="price" class="form-control" name="price" value="0"    ng-model="price" type="text">
                            </div>
                          </div>
                        </div>
                        ...
                        <div class="col-md-6" style="display:none;">
                          <div class="form-group row">
                            ...
                            <div class="col-sm-12">
                              <input id="total_amount" class="form-control"  value="0" name="total_amount"   ng-model="total_amount" type="text">
                            </div>
                          </div>
                        </div>
...
app.controller('crudController', function($scope, $http){
 ...
 $scope.submit_button = 'Save';
  ...
  $scope.fetchDatapurchase= function(){
    $http.get('<?php echo base_url() ?>index.php/purchase/fetch_data_inward').success(function(data){

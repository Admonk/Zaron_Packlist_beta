	...
	public function productscreate()
	{
									    ...
									    if(isset($this->session->userdata['logged_in']))
							            {
							            	 ...
							            	 $data['brand'] = $this->Main_model->where_names_order_by('brand','deleteid','0','id','ASC');
							            	  ...
							            	  $data['additional_information'] =$this->Main_model->where_names_two_order_by('additional_information','grouping','1','deleteid','0','id','ASC');
	...
	public function insertandupdate()
	{
                 ...
                 if($form_data->action=='Save')
                 {
                     ...
                     if($form_data->color!='')
                     {
                                     ...
                                     $additional_information =$this->Main_model->where_names_two_order_by('additional_information','grouping','1','deleteid','0','id','ASC');              
                     ...
                     $valuess=0;
                 	 ...
                 	 foreach ($result as  $value) {
                          ...
                          {   
                              ...
                              $array[]=array('id'=>$valuess[$i],'base_id'=>$value->id,'profilevalsize'=>$qty,'calculation'=>round($qty/$valuess[$i],2),'checkstatus'=>$checkstatus);
                          }
            ...
            for ($i=0; $i <count($_FILES['file']) ; $i++) { 
                   ...
                   if($_FILES['file']['name'][$i]!='')
                   {
                         ...
                         {  
                            ...
                            $this->db->query("INSERT INTO product_images  (`product_id`,`product_image`,`image_layout_plan`)VALUES('".$ticket_id."','".$path."','".$layout_plan."')");

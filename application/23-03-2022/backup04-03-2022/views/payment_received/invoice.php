                        ...
                        <div class="row">
                            <div class="col-sm-6 mb-30">
                                <div class="invoice-number" ng-init="fetchCustomerorderdata()">
                                    <h4 class="inv-title-1"><b>Receipt To :</b> </h4>
                                      <p class="invo-addr-1">Customer Name :  {{partyname }} </p>
  ...
  $scope.submitForm = function(){
    ...
    $http({
      ...
      data:{
          ...
          ?>
          'id':'<?php echo $id; ?>','action':$scope.submit_button,'party_type':$scope.party_type,'get_users':$scope.get_users,'tablename':'payment_received'}
         }).success(function(data){

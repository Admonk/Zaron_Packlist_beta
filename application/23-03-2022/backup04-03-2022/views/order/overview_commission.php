                           ...
                           <div class="navclass">
                                    ...
                                    <table id="datatable" class="table invoice-table" >
                                       ...
                                       <thead class="bg-gray text-red" ng-if="namecate.categories_id==1">
                                          ...
                                          <tr>
                                             ...
                                             <th class="table-width-6" ng-if="namecate.labletype==2 || namecate.labletype==1" rowspan="2" style="padding-bottom:0px" >Nos </th>
                                        ...
                                        <thead class="bg-gray text-red" ng-if="namecate.categories_id!=1">
                                          ...
                                          <tr>
                                             ...
                                             <th class="table-width-8" ng-if="namecate.labletype==12" >Dim 2</th>
                                              ...
                                              <th class="table-width-8"  ng-if="namecate.labletype==8 || namecate.labletype==1 || namecate.labletype==4 ||  namecate.labletype==5 || namecate.labletype==6 || namecate.labletype==7 || namecate.labletype==10 || namecate.labletype==11 || namecate.labletype==12" style="padding-bottom:0px" >{{namecate.lable}} </th>
                                       ...
                                       <tbody  ng-repeat="name in namesData|orderBy:column:reverse" ng-if="namecate.categories_id==1">
                                          ...
                                          <tr class="view" ng-if="namecate.categories_id==name.categories_id_get && namecate.type==name.type">
                                             ...
                                             <td><select class="selectbox"  disabled><option value="3" ng-selected="{{name.uom == 3}}">FEET</option><option value="4" ng-selected="{{name.uom == 4}}">MM</option><option value="5" ng-selected="{{name.uom == 5}}">MTR</option><option value="6" ng-selected="{{name.uom == 6}}">INCH</option></select>
                                              </td>
                                       ...
                                       <tbody  ng-repeat="name in namesData|orderBy:column:reverse" ng-if="namecate.categories_id!=1">
                                          ...
                                          <tr   class="view" ng-if="namecate.categories_id==name.categories_id_get">
                                           ...
                                           <td  ng-if="namecate.labletype!=9">
                                                ...
                                                <select class="selectbox"  disabled><option value="3" ng-selected="{{name.uom == 3}}">FEET</option><option value="4" ng-selected="{{name.uom == 4}}">MM</option><option value="5" ng-selected="{{name.uom == 5}}">MTR</option><option value="6" ng-selected="{{name.uom == 6}}">INCH</option></select>
                                                </span>
                                                <span ng-if="namecate.labletype==14">
                                                    NOS
                                                </span>
                                             ...
                                             <td ng-if="namecate.labletype==8 || namecate.labletype==1 ||  namecate.labletype==5 || namecate.labletype==6 || namecate.labletype==7 || namecate.labletype==10 || namecate.labletype==11 || namecate.labletype==12">{{name.profile_tab}}</td>
                                             <td ng-if="namecate.labletype==8 || namecate.labletype==11 || namecate.labletype==12">{{name.crimp_tab}}</td>
                                             ...
                                             <td>{{name.nos_tab}}</td>
                                             <td ng-if="namecate.labletype!=9">{{name.fact_tab}}</td>
                                             <td>{{name.rate_tab}}</td>
                                             <th ng-if="commission_check==1" class="comdisplay"><b style="font-size:12px;" >{{namecate.commission_total}}</b></th>
                                             <td id="qty_{{name.id}}" class="qtyfind_{{namecate.type}}">{{name.qty_tab}}</td>
                                             <td id="amount_{{name.id}}" class="amounttot_{{namecate.type}}">{{name.amount_tab}}</td>
                                       ...
                                       <tfoot ng-if="namecate.categories_id!=1">
                                           <tr >
                                             ...
                                             <th ><b style="font-size:12px;" id="nostot_{{namecate.type}}">{{namecate.nos_total}}</b></th>
                                             <th ng-if="namecate.labletype!=9"><b style="font-size:12px;" >{{namecate.fact_total}}</b></th>
                                            <th ><b style="font-size:12px;" ></b></th>
                                             <th ng-if="commission_check==1" class="comdisplay"><b style="font-size:12px;" >{{namecate.commission_total}}</b></th>
                                             <th><b style="font-size:12px;" id="fullqty_{{namecate.type}}">{{namecate.qty_total}}</b></th>
                                             <th><b style="font-size:12px;" id="fulltotal_{{namecate.type}}">{{namecate.amount_total}} </b></th>
                              ...
                              <table class="table invoice-table" ng-init="fetchSingleDatatotal('1')">
                                ...
                                <tr>
                                    ...
                                    <td class="text-right bold">Rs. {{fulltotal}} </td>
                                </tr>
                                <tr>
                                   
                                    <td colspan="2" class="text-end">Discount</td>
                                    <td class="text-right bold">Rs. {{discounttotal}} </td>
                                </tr>
                                <tr>
                                   
                                    <td colspan="2" class="text-end fw-bold">Grand Total</td>
                                    <td class="text-right bold">Rs. {{discountfulltotal}} </td>
                                </tr>
                              </table>

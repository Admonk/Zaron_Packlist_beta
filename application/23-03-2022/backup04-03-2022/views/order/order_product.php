                  ...
                  <div class="row">
                    <div class="col-lg-9 col-12">
                        ...
                        <div class="customer-bill-info mb-1">
                           <div class="row">
                                 ...
                                 <div class="d-flex inlineFlexBox">
                                  ...
                                  <div class="d-inline col-4 ps-2" ng-init="fetchCustomerorderdata()">
                                      ...
                                      <div class="dropdown float-end">
                                         ...
                                         <i class="mdi mdi-truck-delivery font-size-15 pe-1" ng-if="delivery_address"></i> {{delivery_address}} 
                                         <!--</span>-->
                                           ...
                                           <?php
                                                           ...
                                                           if($tablename=='orders_process')
                                                           {
                                                               ?>
                                                                ...
                                                                <h6 style="color:red;" ng-if="paricel_mode"><i class="mdi mdi-truck-delivery font-size-15 pe-1"></i> Delivery Mode : &nbsp; 
                        ...
                        <div class="search-info mb-1 border-bottom">
                             ...
                             <div class="row" >
                             <div class="col-12">
                                   <span class="btn btn-soft-secondary  btn-sm onclick" style="cursor: pointer;" data-value="Accesories1">Accesories 1</span>
                                   <span class="btn btn-soft-secondary  btn-sm onclick" style="cursor: pointer;" data-value="Accesories2">Accesories 2</span>
                                   <span class="btn btn-soft-secondary  btn-sm onclick" style="cursor: pointer;" data-value="Accesories3">Accesories 3</span>
                                   <span class="btn btn-soft-secondary  btn-sm onclick" style="cursor: pointer;" data-value="Sag_Road"> Sag Road</span>
                                   <span class="btn btn-soft-secondary  btn-sm onclick" style="cursor: pointer;" data-value="Cleat"> Cleat</span>
                                   <span class="btn btn-soft-secondary  btn-sm onclick" style="cursor: pointer;" data-value="Iron And Steel Gar Sheet-zaron">Iron And Steel Gar Sheet-zaron</span>
                                   <span class="btn btn-soft-secondary  btn-sm onclick" style="cursor: pointer;" data-value="Arch">Arch</span>
                                   <span class="btn btn-soft-secondary  btn-sm onclick" style="cursor: pointer;" data-value="Decking sheet">Decking sheet</span>
                                   <span class="btn btn-soft-secondary  btn-sm onclick" style="cursor: pointer;" data-value="Purlin">Purlin</span>
                                   <span class="btn btn-soft-secondary  btn-sm onclick" style="cursor: pointer;" data-value="Aluminium">Aluminium</span>
                                   <span class="btn btn-soft-secondary  btn-sm onclick" style="cursor: pointer;" data-value="Screw accesories">Screw accesories</span>
                                   <span class="btn btn-soft-secondary  btn-sm onclick" style="cursor: pointer;" data-value="Tile sheet">Tile sheet</span>
                                   <span class="btn btn-soft-secondary  btn-sm onclick" style="cursor: pointer;" data-value="L Angle">L Angle</span>
                                   <span class="btn btn-soft-secondary  btn-sm onclick" style="cursor: pointer;" data-value="Z Angle">Z Angle</span>
                        ...
                        <div class="card table-editable-info" navigatable ng-init="fetchData('1')">
                           <div class="card-body p-0"  >
                              <div class="table-rep-plugin" ng-repeat="namecate in namesDatacate" >
                                 ...
                                 <h5 class="customTableHeading" style="">{{namecate.no}}. {{namecate.categories_name}} </h5>
                                 
                                  <div class="table-responsive  customTableDesign mb-0" data-pattern="priority-columns" >
                                    <table id="datatable" class="table table-bordered dt-responsive  nowrap w-100 salestable" >
                                       ...
                                       <thead class="bg-gray text-red" ng-if="namecate.categories_id==1">
                                          ...
                                          <tr>
                                             ...
                                             <th class="table-width-6" ng-if="namecate.labletype==2 || namecate.labletype==1" rowspan="2" style="padding-bottom:0px" data-priority="3" ng-click='sortColumn("nos_tab")' ng-class='sortClass("nos_tab")'>Nos <i class="fa fa-sort" aria-hidden="true"></i></th>
                                        ...
                                        <thead class="bg-gray text-red" ng-if="namecate.categories_id!=1">
                                          ...
                                          <tr>
                                             ...
                                             <th class="table-width-18" ng-if="namecate.labletype==4" rowspan="2" data-priority="1" ng-click='sortColumn("product_name_tab")' ng-class='sortClass("product_name_tab")'>Tile Material <i class="fa fa-sort" aria-hidden="true"></i></th>
                                              ...
                                              <th class="table-width-8"   data-priority="3" ng-if="namecate.labletype==8 || namecate.labletype==1 ||  namecate.labletype==5 || namecate.labletype==6 || namecate.labletype==7 || namecate.labletype==10 || namecate.labletype==11 || namecate.labletype==12 || namecate.labletype==4" style="padding-bottom:0px" ng-click='sortColumn("profile_tab")' ng-class='sortClass("profile_tab")'>{{namecate.lable}} <i class="fa fa-sort" aria-hidden="true"></i></th>
                                              ...
                                              <th class="table-width-8" ng-if="namecate.labletype==11 || namecate.labletype==12 || namecate.labletype==1 || namecate.labletype==6" data-priority="1" style="padding-bottom:0px" ng-click='sortColumn("crimp_tab")' ng-class='sortClass("crimp_tab")'>{{namecate.lable2}} <i class="fa fa-sort" aria-hidden="true"></i></th>
                                             
                                            
                                              <th class="table-width-6" ng-if="namecate.labletype==1 || namecate.labletype==9 || namecate.labletype==4 || namecate.labletype==8 || namecate.labletype==5 || namecate.labletype==6 || namecate.labletype==7 || namecate.labletype==10 || namecate.labletype==11 || namecate.labletype==12 || namecate.labletype==14" data-priority="3" rowspan="2" ng-click='sortColumn("nos_tab")' ng-class='sortClass("nos_tab")'>Nos <i class="fa fa-sort" aria-hidden="true"></i></th>
                                            
                                            
                                            
                                            
                                             <!--<th class="table-width-6" data-priority="3">Unit</th>-->
                                             <th class="table-width-6" ng-if="namecate.labletype!=9"   data-priority="6"  rowspan="2" ng-click='sortColumn("fact_tab")' ng-class='sortClass("fact_tab")'><small>Fact/Sq.Mtrs <br>Running MT </small> <i class="fa fa-sort" aria-hidden="true"></i></th>
                                       ...
                                       <tbody  ng-repeat="name in namesData|orderBy:column:reverse" ng-if="namecate.categories_id==1">
                                          ...
                                          <tr  ng-style="name.stock == 0 && {'color':'red'}"    class="view" ng-if="namecate.categories_id==name.categories_id_get && namecate.type==name.type">
                                             <td data-label="S No">{{name.no}}   <span class="td-info-icons" ng-if="name.same==1"><i class="mdi mdi-chevron-down" style="font-size: 18px;font-weight: 800;color: #ee5c17;" ng-click="similarenq(name.product_id,name.product_name_tab,namecate.categories_id)"></i></span>   </td>
                                            ...
                                            <input type="hidden"  value="{{name.product_id}}"  id="ppid_{{name.id}}">
                                             ...
                                             <td ng-if="namecate.labletype==2" data-label="Crimp"><input type="text" ng-keyup="inputsave_1(name.id,'crimp',namecate.categories_id,namecate.type)" id="crimp_{{name.id}}" value="{{name.crimp_tab}}"></td>
                                             
                                             
                                             <td data-label="Nos"><input type="text"  ng-keyup="inputsave_1(name.id,'nos',namecate.categories_id,namecate.type)" class="nos_{{name.type}}" id="nos_{{name.id}}" value="{{name.nos_tab}}"></td>
                                             ...
                                             <td data-label="Rate"><input type="text" <?php echo $read; ?>  ng-keyup="inputsave_1(name.id,'rate',namecate.categories_id,namecate.type)"  id="rate_{{name.id}}" value="{{name.rate_tab}}">
                                             ...
                                             <td id="qty_{{name.id}}"  data-label="Qty" class="qtyfind_{{namecate.type}}">{{name.qty_tab}}
                                             <!--<input type="text"  ng-blur="inputsave_1(name.id,'qty',namecate.categories_id)"   id="qty_{{name.id}}" value="{{name.qty_tab}}">-->
                                             </td>
                                             <td id="amount_{{name.id}}" data-label="Amount" class="amounttot_{{namecate.type}}">{{name.amount_tab}}</td>
                                            ...
                                            <?php
                                             ...
                                             <td data-label="Action" class="last-colorchange">
                                                ...
                                                data-bs-toggle="offcanvas" style="cursor: pointer;color:red;font-weight:800;" ng-if="name.imagestatus==1"  data-bs-target="#offcanvasSpec" ng-click="sizedefind(name.id,name.product_id,namecate.categories_id,name.profile_tab,name.base_id)" ng-if="name.cate_status==1" aria-controls="offcanvasSpec" title="Add On Size"></i>
                                                
                                                  <i class="mdi mdi-paperclip font-size-16"
                                                data-bs-toggle="offcanvas" style="cursor: pointer;" ng-if="name.imagestatus!=1"  data-bs-target="#offcanvasSpec" ng-click="sizedefind(name.id,name.product_id,namecate.categories_id,name.profile_tab,name.base_id)" ng-if="name.cate_status==1" aria-controls="offcanvasSpec" title="Add On Size"></i>
                                       ...
                                       <tfoot ng-if="namecate.categories_id==1">
                                           <tr >
                                             ...
                                             <td data-label="Toatl:"><b style="font-size:12px;" id="nostot_{{namecate.type}}">{{namecate.nos_total}}</b></td>
                                             ...
                                             <td ><b style="font-size:12px;" id="fullqty_{{namecate.type}}">{{namecate.qty_total}}</b></td>
                                             <td ><b style="font-size:12px;" id="fulltotal_{{namecate.type}}">{{namecate.amount_total}} </b></td>
                                       ...
                                       <tbody  ng-repeat="name in namesData|orderBy:column:reverse" ng-if="namecate.categories_id!=1">
                                          ...
                                          <tr  ng-style="name.stock == 0 && {'color':'red'}" class="view" ng-if="namecate.categories_id==name.categories_id_get">
                                              <td data-label="S No">{{name.no}}   <span class="td-info-icons" ng-if="name.same==1"><i class="mdi mdi-chevron-down" style="font-size: 18px;font-weight: 800;color: #ee5c17;" ng-click="similarenq(name.product_id,name.product_name_tab,namecate.categories_id)"></i></span>   </td>
                                            <input type="hidden"  value="{{namecate.categories_id}}"  id="cateid_{{name.id}}"> 
                                             <input type="hidden"  value="{{namecate.type}}"  id="cateidtype_{{name.id}}">
                                             <input type="hidden"  value="{{name.product_id}}"  id="ppid_{{name.id}}">
                                            ...
                                            <td  data-priority="3" ng-if="namecate.labletype!=9" data-label="UOM">
                                             ...
                                             <td data-label="Nos"> <input type="text" <?php echo $read; ?>  ng-keyup="inputsave_1(name.id,'nos',namecate.categories_id,namecate.type)" class="nos_{{name.type}}" id="nos_{{name.id}}" value="{{name.nos_tab}}"></td>
                                             <!--<td><input type="text"  ng-keyup="inputsave_1(name.id,'unit',namecate.categories_id)"  id="unit_{{name.id}}" value="{{name.unit_tab}}"></td>-->
                                            
                                             <td ng-if="namecate.labletype!=9" data-label="Fact"><input type="text" <?php echo $read; ?>  ng-keyup="inputsave_1(name.id,'fact',namecate.categories_id,namecate.type)" id="fact_{{name.id}}" value="{{name.fact_tab}}"></td>
                                       ...
                                       <tfoot ng-if="namecate.categories_id!=1">
                                           <tr >
                                             ...
                                             <td class="table-width-6 hidmob" ng-if="namecate.labletype==4"> </td>    
                                             ...
                                             <td data-label="Toatl:"><b style="font-size:12px;" id="nostot_{{namecate.type}}">{{namecate.nos_total}}</b></td>
                                             <!--<th ><b style="font-size:12px;">{{UNIT}}</b></th>-->
                                             <td ng-if="namecate.labletype!=9"><b style="font-size:12px;" >{{namecate.fact_total}}</b></td>
                                             <!--<th ><b style="font-size:12px;">{{Meter_to_Sqr_feet}}</b></th>-->
                                             <td class="hidmob"><b style="font-size:12px;" ></b></td>
                                             <td ng-if="commission_check==1" class="comdisplay"><b style="font-size:12px;" >{{namecate.commission_total}}</b></td>
                                             <td><b style="font-size:12px;" id="fullqty_{{namecate.type}}">{{namecate.qty_total}}</b></td>
                        ...
                        <div class="floater-options1"    ng-init="fetchSingleDatatotal('1')">
                            ...
                            <div class="row">
                              <div class="col-lg-6 col-md-6 col-sm-12 col-12 d-flex floaterOptionLeft" >
                                    ...
                                    <div class="d-inline pe-1 pe-md-3 pe-lg-5 pe-sm-1">
                                        <?php
                                        if($status_base!=6)
                                        {
                                        ?>   
                                            <b style="font-size:12px;">Discount: </b>
                                            <input type="text" ng-model="discount" placeholder="Discount" class="form-control" id="saveDiscount" ng-keyup="saveDiscount($event)" >
                                        ...
                                        <div class="d-flex align-items-center">
                                            <div class="flex-grow-1">
                                                ...
                                                <h5 class="mb-2">
                                                    ...
                                                    <input type="text"  value="{{discountfulltotal}}" class="form-control" id="roundoff" ng-keyup="saveRoundoff($event)" >
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-12 col-12 d-flex floaterOptionLeft">
                                                                   ...
                                                                   <div class="flex-shrink">
                                                                        ...
                                                                        <div class="col-sm-12 reasonSelectBox">
                                                                         <select class="form-control reasonset" ng-change="saveReason()" name="reason"  ng-model="reason">
                                                                                                                     ...
                                                                                                                     <option value="0"> Select <?php echo  $missed; ?>  Reason</option>
                                     ...
                                     <a href="#" ng-click="showCompetitor()" ng-if="reason==5">Competitor View</a>
                                      ...
                                      ?>
                                        ...
                                        <div class="d-inline">
                                           ...
                                           <div class="form-check" ng-init="fetchCustomerorderdata()">
                                                       ...
                                                       <h5 class="font-size-14 mb-3" style="cursor: pointer;" ng-click="checkValRequiesttl()"><i class="mdi mdi-arrow-right text-primary me-1"></i> Delivery View / Modify</h5>
                                     ...
                                     if($status_base==11)
                                     {
                                         ...
                                         <div class="d-inline">
                                           ...
                                           <div class="form-check" ng-init="fetchCustomerorderdata()">
                                                       ...
                                                       <label style="color:green;" ><i class="fa fa-check" aria-hidden="true"></i>&nbsp;&nbsp; Price Request Approved</label>
                                   ...
                                   <?php
                                         ...
                                         <div class="d-inline">
                                           ...
                                           <div class="form-check" ng-init="fetchCustomerorderdata()">
                                                    ...
                                                    <div class="vr"></div>
                                                     ...
                                                     <button type="submit" class="btn btn-success w-md" ng-click="approved(<?php echo $order_id; ?>,5,'Requested Price MD')">Price requested To MD</button>
                                                    <div class="vr"></div>
                                                    </span>
                                     ...
                                     <?php
                                      if($status_base==0 || $status_base==10)
                                      {
                                          ?>
                                          ...
                                          <div  class="col-md-4">
                                                          ...
                                                          <button type="button" ng-click="archiveOpen()" class="btn btn-outline-danger" >Archive</button>
                ...
                <input type="hidden" id="product_id_base_define">
                        ...
                        <div class="col-md-12">
                         ...
                         <h5 class="card-title mt-3">Size Image </h5>
                          ...
                          <div class="imagereviewset" ng-init="fetchDatasizeoptionsvalue()" ng-show="namesDataoptonsvalues.length>0" style="display:none;"> 
                          ...
                          <span ng-show="namesDataoptonsvalues.length==0" >
                             ...
                             <div id="show_details22" ></div>
                              
                          </span>
                          
                          <span  ng-init="fetchDatasizeoptionsvalue()" id="appendTwobox2">            
                        ...
                        <div class="row twoBoxInput"  ng-repeat="nameoptionv in namesDataoptonsvalues" ng-if="nameoptionv.viewstatus==0"  style="display:none;">
                         ...
                         <div id="showdraw"  class="row">
                                       ...
                                       <div class="col-md-9">
                                        ...
                                        <p>
                                             ...
                                             <a href="#" class="btn btn-light" id="imagedraw1" data-bs-toggle="modal" data-bs-target=".bs-example-modal-xl">Draw Image</a>
                                        ...
                                        <!--Reomve _1-->
                                        <div class="col-md-3"  id="defaultattacmentrow_1" style="display:none;">
                      ...
                      <span  ng-init="fetchDatasizeoptionsvalue()" id="appendTwobox">            
                        ...
                        <div class="col-md-6">
                         ...
                         <span ng-show="namesDataoptonsvalues.length==0">
                          ...
                          <div ng-init="fetchDatasizebase()" class="row showhide">
                               
                                
                                   <div class="col-6">
                                    <h5 class="card-title mt-3">Length</h5>
                                   ...
                                   <br>
                                    ...
                                    <div class="col-6">
                                    <h5 class="card-title mt-3">No</h5>
                              
                                   <input type="text" class="form-control"  id="nobase" ng-keyup="saveNo()" placeholder="No">
                                  ...
                                  <div class="col-12" style="display:none;">
                                   <span ng-repeat="nameoptionbase in namesDataoptonsbase" class="btn btn-soft-light btn-sm" id="baseid_{{nameoptionbase.base_id}}" ng-click="sizedefindbylayout(nameoptionbase.base_id)"> {{nameoptionbase.name}}</span>
                          ...
                          <span ng-init="fetchDatasizeoptions()" class="set-padding showhide" >
                          ...
                          <div class="form-group row">
                            ...
                            <div class="col-sm-12">
                                  ...
                                  <span ng-if="nameoption.checkstatus==1">
                                                      ...
                                                      <input type="radio" class="label_option_id" ng-click="getLenthandno(nameoption.id,nameoption.calculation)" checked name="idset" value="{{nameoption.id}}" >
                                 </span>
                                
                                  <span ng-if="nameoption.checkstatus==0">
                                               
                                                      <input type="radio" class="label_option_id" ng-click="getLenthandno(nameoption.id,nameoption.calculation)" name="idset" value="{{nameoption.id}}" >
                                 </span>
                        ...
                        <div class="col-md-2">
                          <div class="form-group row">
                            ...
                            <div class="col-sm-12" style="text-align: center;">
                               <b class="baseProfile" >{{nameoption.profilevalsize}}</b>
                            </div>
                          </div>
                        </div>
                        ...
                        <div class="col-md-2">
                          <div class="form-group row">
                            ...
                            <div class="col-sm-12" style="text-align: center;">
                             <b>{{nameoption.id}}</b>
                             <input type="hidden" name="base_id" id="base_id" value="{{nameoption.base_id}}">
                            </div>
                          </div>
                        </div>
...
<div class="modal fade bs-example-modal-xl-arch"  id="imagesizemodelarch" tabindex="-1" role="dialog" aria-labelledby="myExtraLargeModalLabel" aria-hidden="true">
  ...
  <img src="http://erp.zaron.in/image.jpg" alt="Snow" style="width: 70%;
    display: block;
    margin: auto;">
  <div class="bottom-left">
 <input type="text" alt="text-1" class="inputtext" placeholder="No5">
  </div>
   <div class="bottom-left-sub">
 <input type="text" alt="text-1" class="inputtext" placeholder="No4">
  </div>
  <div class="top-left">
  <input type="text" alt="text-1" class="inputtext" placeholder="No1"></div>
  <div class="top-right">
  <input type="text" alt="text-1" class="inputtext" placeholder="No2"></div>
  <div class="bottom-right">
  <input type="text" alt="text-1" class="inputtext" placeholder="No6"></div>
  <div class="bottom-right-sub">
  <input type="text" alt="text-1" class="inputtext" placeholder="No7"></div>
  <div class="centered">
  <input type="text" alt="text-1" class="inputtext" placeholder="No8"></div>
  
  <div class="center-rotate">
      <input type="text" alt="text-1" class="inputtext" placeholder="No3">
  </div>
                                                        ...
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body" style="height: 500px;overflow: auto;">
                                                                ...
                                                                <form  ng-submit="imageuploadInproduct()" method="post" id="productupload">
                                                                  <div class="row" style="margin-bottom: 10px;">
                                                                   ...
                                                                   <div class="col-md-4"><button class="btn btn-success" id="uploadbutton">Upload</button></div>
                                                            ...
                                                            <div class="row" ng-init="imgpreviewimages()">
                                                                ...
                                                                <div class="col-md-6" ng-repeat="nameimage in namesDataoptonsimages">
                                                                   ...
                                                                   <label> <input type="radio" name="imageid" class="imageid" value="{{nameimage.id}}" ng-click="sizedefindbylayout(nameimage.image_layout_plan,nameimage.id)">
...
$scope.imageuploadInproduct = function(){
                  ...
                  var layout_plan= $('#layout_plan').val();
                              ...
                              var form_data = new FormData();  
                               ...
                               $http.post('<?php echo base_url() ?>index.php/products/fileuplaodimgsave?id='+product_id+'&layout_plan='+layout_plan, form_data,  
                               {  
...
$scope.imageuploadInproductupdate = function(){
                              ...
                              var image_plan_id= $('#image_plan_id').val();
                               ...
                               $http({
                                ...
                                data:{'layout_plan':layout_plan,'id':image_plan_id,'action':'updatelayputplan','tablename':'product_images'}
                                }).success(function(data){
...
$scope.inputsave_1 = function (id,inputname,categories_id,type) {
                      ...
                      if(type==14)
                      {
                           var total=Math.round(rate*sqt_qty*fact);
...
$scope.inputsavecal_1 = function (id,uom,inputname,categories_id,type) {
                         ...
                         $http({
                          method:"POST",
                          url:"<?php echo base_url() ?>index.php/order/insertandupdate?order_id=<?php echo $order_id; ?>",
                          data:{'profile':profile,'crimp':crimp,'dim_one':dim_one,'dim_two':dim_two,'dim_three':dim_three,'values':values,'id':id,'action':'actioncalculation','tablenamemain':'<?php echo $tablename; ?>','tablename_sub':'<?php echo $tablename_sub; ?>'}
                         }).success(function(data){
...
if(event.keyCode==13)
{
    ...
    $http({
      method:"POST",
      url:"<?php echo base_url() ?>index.php/order/insertandupdate?order_id=<?php echo $order_id; ?>",
      data:{'product_id':$scope.product_id,'checkboxformula':checkboxformula,'profile':autocomplete,'order_no':'<?php echo $order_no; ?>','order_id':'<?php echo $order_id; ?>','action':'Save','tablenamemain':'<?php echo $tablename; ?>','tablename_sub':'<?php echo $tablename_sub; ?>'}
    }).success(function(data){
...
$scope.sizedefind = function(id,product_id,cateid,profile_val,base_id){
        ...
        $('#baseid_'+base_id).addClass('active');
        
        
      
         $('#baseiddd_'+base_id).addClass('active');
...
$scope.imgresult = '';
 ...
 $scope.error1 = false;
  ...
  $scope.submitSizeguid = function(){
    ...
    $http({
      method:"POST",
      url:"<?php echo base_url() ?>index.php/order/insertandupdate",
      data:{'action':'sizesave','lab1':lab1,'base_id':base_id,'lab2':lab2,'degree':degreeset,'value_id':value_id,'sub_product':sub_product,'order_product_id':order_product_id,'tablenamemain':'<?php echo $tablename; ?>','order_id':'<?php echo $order_id; ?>','tablename_sub':'<?php echo $tablename_sub; ?>'}
      }).success(function(data){ 
 ...
 $scope.sizedefindbylayout = function(base_id,id)
 {

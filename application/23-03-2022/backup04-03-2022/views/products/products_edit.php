 ...
 <a href="#" class="btn btn-light" ng-click="imgpreview()" data-bs-toggle="modal" data-bs-target=".bs-example-modal-center">Image Gallery</a>
                          ...
                          <div class="form-group row">
                            ...
                            <div class="col-sm-12">
                              ...
                              <option value="7">Purlin Or Sag Rod Type 7</option>
                              <option value="8">Profile ridge & Arch Type 8</option>
                              <option value="9">Screw Type 9</option>
                                                        ...
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="row" ng-init="imgpreviewimages()">
                                                                ...
                                                                <div class="col-md-6" ng-repeat="nameimage in namesDataoptonsimages">
                                                                   ...
                                                                   <label> <input type="radio" name="imageid" class="imageid" value="{{nameimage.id}}" ng-click="imageSizeupdate(nameimage.image_layout_plan,nameimage.id)">
...
$scope.imageSizeupdate = function(baseid,id)
{

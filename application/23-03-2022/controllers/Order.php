...
class Order extends CI_Controller {
	...
	public function insertandupdate()
	{
                ...
                $tablenamemain=$form_data->tablenamemain;
                  ...
                  if($form_data->action=='sizesave')
                 {
                     ...
                     $datass_appprox['base_id']=$form_data->base_id;
                 	 ...
                 	 foreach ($result as  $value) {
                                ...
                                else
                                {
                                  ...
                                  if($value->type=='2')
                                  {
                                       ...
                                       $lablefact1='Fact/Sq.Mtrs';
                                       $lablefact2='Running MT';
    ...
    public function fetchproduct_fullmm_val()
    {
                ...
                $array =array();
                      ...
                      $result= $this->Main_model->where_names('product_list','product_name',$product_id,'id','DESC');
                 ...
                 $order_no_new=$form_data->order_no_new;
                                            ...
                                            foreach($result_order as $orders)
                                            {
                                                                ...
                                                                $find['details']=$orders->details;
                                                                 ...
                                                                 $result_order_product= $this->Main_model->where_names($tablename_sub,'order_id',$order_idset);
                                                                 foreach($result_order_product as $orders_product)
                                                                 {

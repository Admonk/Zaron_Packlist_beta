...
$scope.onview = function(id,billno,pendingamount){
 ...
 $scope.pointtodriver = function () {
            ...
            //{
                        ...
                        data:{'enteramount':enteramount,'driver_id':driver_id,'payamount':payamount,'bankaccount':bankaccount,'payment_mode_payoff':payment_mode_payoff,'reference_no':reference_no,'notes':notes}
                        }).success(function(data){

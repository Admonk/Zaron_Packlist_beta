        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="invoice-inner-6" id="invoice_wrapper">
                    ...
                    <div class="invoice-info">
                        <div class="row">
                            <div class="col invoice-to">
                                ...
                                <div class="col invoice-details" ng-init="fetchCustomerorderdata()">
                                    ...
                                    <table id="datatable" class="table invoice-table" >
                                       ...
                                       <thead class="bg-gray text-red" ng-if="namecate.categories_id==1">
                                          ...
                                          <tr>
                                             ...
                                             <th class="table-width-10 comdisplay" rowspan="2" ng-if="commission_check==1" > Commission </th>
                                           
                                             <th class="table-width-10"  rowspan="2" >QTY  <small>{{defaultvalue}}</small> </th>
                                        ...
                                        <thead class="bg-gray text-red" ng-if="namecate.categories_id!=1">
                                          ...
                                          <tr>
                                             ...
                                             <th class="table-width-8"  ng-if="namecate.labletype==8 ||  namecate.labletype==1 || namecate.labletype==15 ||  namecate.labletype==4 ||  namecate.labletype==5 || namecate.labletype==6 || namecate.labletype==7 || namecate.labletype==10 || namecate.labletype==11 || namecate.labletype==12" style="padding-bottom:0px" >{{namecate.lable}} </th>
                                             ...
                                             <th class="table-width-6"   rowspan="2" ng-click='sortColumn("nos_tab")' ng-class='sortClass("nos_tab")'>{{namecate.lablenos}} </th>
                                       ...
                                       <tbody  ng-repeat="name in namesData|orderBy:column:reverse" ng-if="namecate.categories_id==1">
                                          ...
                                          <tr class="view" ng-if="namecate.categories_id==name.categories_id_get && namecate.type==name.type">
                                             ...
                                             <td><select class="selectbox"  disabled><option value="3" ng-selected="{{name.uom == 3}}">FEET</option><option value="4" ng-selected="{{name.uom == 4}}">MM</option><option value="5" ng-selected="{{name.uom == 5}}">MTR</option><option value="6" ng-selected="{{name.uom == 6}}">INCH</option><option value="2" ng-selected="{{name.uom == 2}}">SQMTR</option></select>
                                              </td>
                                       ...
                                       <tbody  ng-repeat="name in namesData|orderBy:column:reverse" ng-if="namecate.categories_id!=1">
                                          ...
                                          <tr   class="view" ng-if="namecate.categories_id==name.categories_id_get">
                                             ...
                                             <th>{{name.no}}</th>
                                             <td title="{{name.categories}}">{{name.product_name_tab}} </td>
                                             <td  ng-if="namecate.labletype==4">{{name.tile_material_name}}</td>
                                            ...
                                            <td  ng-if="namecate.labletype!=9">
                                                ...
                                                <select class="selectbox"  disabled><option value="3" ng-selected="{{name.uom == 3}}">FEET</option><option value="4" ng-selected="{{name.uom == 4}}">MM</option><option value="5" ng-selected="{{name.uom == 5}}">MTR</option><option value="6" ng-selected="{{name.uom == 6}}">INCH</option><option value="2" ng-selected="{{name.uom == 2}}">SQMTR</option></select>
                                                </span>
                                                <span ng-if="namecate.labletype==14">
                                                    NOS
                                                </span>
                                             ...
                                             <td ng-if="namecate.labletype==8 || namecate.labletype==1 || namecate.labletype==15 ||  namecate.labletype==5 || namecate.labletype==6 || namecate.labletype==7 || namecate.labletype==10 || namecate.labletype==11 || namecate.labletype==12">{{name.profile_tab}}</td>
                                       ...
                                       <tfoot ng-if="namecate.categories_id!=1">
                                           <tr >
                                             ...
                                             <th ><b style="font-size:12px;" id="nostot_{{namecate.type}}">{{namecate.nos_total}}</b></th>
                                             <th ng-if="namecate.labletype==1 || namecate.labletype==2 || namecate.labletype==3 || namecate.labletype==4 || namecate.labletype==5 || namecate.labletype==6 || namecate.labletype==7 || namecate.labletype==8 || namecate.labletype==10 || namecate.labletype==11 || namecate.labletype==12 || namecate.labletype==13 || namecate.labletype==14"><b style="font-size:12px;" >{{namecate.fact_total}}</b></th>
                                            <th ><b style="font-size:12px;" ></b></th>
                                            <th ng-if="commission_check==1" class="comdisplay"><b style="font-size:12px;" >{{namecate.commission_total}}</b></th>
                                             <th><b style="font-size:12px;" id="fullqty_{{namecate.type}}">{{namecate.qty_total}}</b></th>
                                             <th ng-if="gst_check==1"></th>
                              ...
                              <table class="table invoice-table" ng-init="fetchSingleDatatotal('1')">
                                ...
                                <tr>
                                    ...
                                    <td>
                                                    ...
                                                    <p  class="text-end" style="font-size: 17px;margin-right: 25px;"><b>SubTotal : Rs. {{fulltotal}}</b></p>
                                                    
                                                    <p  class="text-end" style="font-size: 17px;margin-right: 25px;"><b>Discount : Rs. {{discounttotal}}</b></p>
                                                    
                                               
                                                    <p  class="text-end" style="font-size: 17px;margin-right: 25px;" ng-if="gst_check==1"><b>GST % : Rs. {{gsttotal}}</b> </p>
                                               
                                                    <p  class="text-end" style="font-size: 17px;margin-right: 25px;"><b>Grand Total : Rs. {{discountfulltotal}} </b></p>
                   ...
                   ?>
                    ...
                    <div class="invoice-informeshon">
                        <div class="row">
                            <div class="col-sm-12" style="margin: auto">
                                ...
                                <div class="col-lg-2 col-md-2 col-sm-12">
                                       <h3 class="inv-title-1">Payment <br> Terms</h3>
                                </div> 
                                 <div class="col-lg-9">
                            ...
                            <div class="col-sm-12 ">
                             ...
                             <div class="col-sm-12">
                                 ...
                                 <div class="col-lg-9 col-md-9 col-sm-12">
                                 <textarea name="input_text[]" rows="3" class="form-control linetext"><?php echo $input6; ?></textarea>
                        ...
                        <div class="row mt-4">
                            <div class="col-sm-12">
                                <h4 class="inv-title-1">Sales Contact  :  <span class="text-success">{{salesname}}</span>  <span class="text-success">{{salesphone}}</span> <span class="text-success">{{salesphone2}}</span></h4>
                         ...
                         <div class="row mt-4" id="footer">
                             ...
                             <div class="col col-md-3 invoice-to">
                                 <img src="http://erp.zaron.in/assets/tamilnadu.png" style="width: 150px;">
                            </div>
                            <div class="col col-md-3 invoice-details">
                            ...
                            <div class="col col-md-3 invoice-details">
                                <p>
                                    <span style=" color: #ff5e14"> Call us @,  </span> <span> 0422 XXXX XXX</span>
                                    <span style=" color: #ff5e14"> Whatsapp to,  </span> <span>XXXX XXXX XXX </span>
                                    <span style=" color: #ff5e14"> Mail to us,  </span> <span> support@rlroofing.com </span>
                                    <span style=" color: #ff5e14"> log on to,  </span> <span> www.rlroofing.com</span>
                                </p>
                            </div>
                ...
                <div class="invoice-btn-section clearfix d-print-none mb-4">
                    ...
                    <button type="submit" class="btn btn-lg btn-success" style="background-color: #ff5e14!important;">
                        <i class="fa fa-save"></i> SAVE
                    </button>
                    
                    
                    <!--<a href="#" target="_blank"><img src="<?php echo base_url(); ?>assets/images/whatsapp.png"  style="width: 45px;"></a>-->
                </div>

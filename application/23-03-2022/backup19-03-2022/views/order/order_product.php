                    ...
                    <div class="col-lg-9 col-12">
                           ...
                           <div class="row">
                                 ...
                                 <div class="d-flex inlineFlexBox">
                                  ...
                                  <div class="d-inline col-2 pe-3 border-end">
                                     ...
                                     <h4 class="mb-sm-0 text-muted mt-2 font-size-10">{{create_date}} <span class="text-muted font-size-12">{{create_time}}</span></h4>
                        ...
                        <div class="search-info mb-1 border-bottom">
                             ...
                             <div class="col-12">
                                   ...
                                   <span class="btn btn-soft-secondary  btn-sm onclick" style="cursor: pointer;" data-value="UPVC">UPVC</span>
                                   <span class="btn btn-soft-secondary  btn-sm onclick" style="cursor: pointer;" data-value="Multiwall">Multiwall</span>
                                   <span class="btn btn-soft-secondary  btn-sm onclick" style="cursor: pointer;" data-value="Polynum">Polynum</span>
                                                                                      ...
                                                                                      <div class="form-group row">
                                                                                        ...
                                                                                        <div class="col-sm-12">
                                                                                              ...
                                                                                              <span ng-if="nameoption.checkstatus==1">
                                                                                                                  ...
                                                                                                                  <input type="radio" class="label_option_id" ng-click="getLenthandno(nameoption.calculation,nameoption.id)" checked name="idset" value="{{nameoption.id}}" >
                                                                                             </span>
                                                                                            
                                                                                              <span ng-if="nameoption.checkstatus==0">
                                                                                                           
                                                                                                                  <input type="radio" class="label_option_id" ng-click="getLenthandno(nameoption.calculation,nameoption.id)" name="idset" value="{{nameoption.id}}" >
                                                                                             </span>
                                    ...
                                    <table id="datatable" class="table table-bordered dt-responsive  nowrap w-100 salestable" >
                                        ...
                                        <thead class="bg-gray text-red" ng-if="namecate.categories_id!=1">
                                          ...
                                          <tr>
                                             ...
                                             <th class="table-width-18" ng-if="namecate.labletype==4" rowspan="2" data-priority="1" ng-click='sortColumn("product_name_tab")' ng-class='sortClass("product_name_tab")'>Tile Material <i class="fa fa-sort" aria-hidden="true"></i></th>
                                              ...
                                              <th class="table-width-6"  data-priority="3" rowspan="2" ng-click='sortColumn("nos_tab")' ng-class='sortClass("nos_tab")'>{{namecate.lablenos}}<i class="fa fa-sort" aria-hidden="true"></i></th>
                                            
                                            
                                            
                                            
                                             <!--<th class="table-width-6" data-priority="3">Unit</th>-->
                                             <th class="table-width-6"  ng-if="namecate.labletype==1 || namecate.labletype==2 || namecate.labletype==3 || namecate.labletype==4 || namecate.labletype==5 || namecate.labletype==6 || namecate.labletype==7 || namecate.labletype==8 || namecate.labletype==10 || namecate.labletype==11 || namecate.labletype==12 || namecate.labletype==13 || namecate.labletype==14"   data-priority="6"  rowspan="2" ng-click='sortColumn("fact_tab")' ng-class='sortClass("fact_tab")'><small> {{namecate.lablefact1}} <br> {{namecate.lablefact2}}</small> <i class="fa fa-sort" aria-hidden="true"></i></th>
                                       ...
                                       <tbody  ng-repeat="name in namesData|orderBy:column:reverse" ng-if="namecate.categories_id==1">
                                         ...
                                         <?php
                                             ...
                                             {
                                              ?>
                                              <td  data-label="Qty"    > <input type="text"  ng-keyup="inputsaveqty_1(name.id,'qty',namecate.categories_id,namecate.type)"  class="qtyfind_{{namecate.type}}"  id="qty_{{name.id}}" value="{{name.qty_tab}}"> </td>
                                             ...
                                             {
                                                 ?>
                                                    <td id="qty_{{name.id}}"  data-label="Qty" class="qtyfind_{{namecate.type}}">{{name.qty_tab}}</td>
                                            ...
                                            <?php
                                             ...
                                             <td data-label="Action" class="last-colorchange">
                                                ...
                                                data-bs-toggle="offcanvas" style="cursor: pointer;color:red;font-weight:800;" ng-if="name.imagestatus==1 && name.cate_status==1"  data-bs-target="#offcanvasSpec" ng-click="sizedefind(name.id,name.product_id,namecate.categories_id,name.profile_tab,name.base_id)" ng-if="" aria-controls="offcanvasSpec" title="Add On Size"></i>
                                                
                                                  <i class="mdi mdi-paperclip font-size-16"
                                                data-bs-toggle="offcanvas" style="cursor: pointer;" ng-if="name.imagestatus!=1 && name.cate_status==1"  data-bs-target="#offcanvasSpec" ng-click="sizedefind(name.id,name.product_id,namecate.categories_id,name.profile_tab,name.base_id)"  aria-controls="offcanvasSpec" title="Add On Size"></i>
                                       ...
                                       <tbody  ng-repeat="name in namesData|orderBy:column:reverse" ng-if="namecate.categories_id!=1">
                                          ...
                                          <tr  ng-style="name.stock == 0 && {'color':'red'}" class="view" ng-if="namecate.categories_id==name.categories_id_get">
                                            ...
                                            <td  data-priority="3" ng-if="namecate.labletype!=9" data-label="UOM">
                                             ...
                                             <td   ng-if="namecate.labletype==1 || namecate.labletype==2 || namecate.labletype==3 || namecate.labletype==4 || namecate.labletype==5 || namecate.labletype==6 || namecate.labletype==7 || namecate.labletype==8 || namecate.labletype==10 || namecate.labletype==11 || namecate.labletype==12 || namecate.labletype==13 || namecate.labletype==14" data-label="Fact"><input type="text" <?php echo $read; ?>  ng-keyup="inputsave_1(name.id,'fact',namecate.categories_id,namecate.type)" id="fact_{{name.id}}" value="{{name.fact_tab}}"></td>
                                            ...
                                            <?php
                                             ...
                                             <td data-label="Action" class="last-colorchange" >
                                               ...
                                               <i class="mdi mdi-group  font-size-16" ng-click="grouping(name.id,name.product_name_tab)" title="Grouping"  style="cursor: pointer;"></i>
                                                ...
                                                <i class="mdi mdi-paperclip font-size-16"
                                                data-bs-toggle="offcanvas" style="cursor: pointer;color:red;font-weight:800;" ng-if="name.imagestatus==1 && name.cate_status==1"  data-bs-target="#offcanvasSpec" ng-click="sizedefind(name.id,name.product_id,namecate.categories_id,name.profile_tab,name.base_id)"  aria-controls="offcanvasSpec" title="Add On Size"></i>
                                       ...
                                       <tfoot ng-if="namecate.categories_id!=1">
                                           <tr >
                                             ...
                                             <td class="table-width-6 hidmob" ng-if="namecate.labletype==1 || namecate.labletype==2 || namecate.labletype==3 || namecate.labletype==4 || namecate.labletype==5 || namecate.labletype==6 || namecate.labletype==7 || namecate.labletype==8 || namecate.labletype==10 || namecate.labletype==11 || namecate.labletype==12 || namecate.labletype==13 || namecate.labletype==14 || namecate.labletype==15"> </td>
                                             <td class="table-width-6 hidmob" ng-if="namecate.labletype==1 || namecate.labletype==2 || namecate.labletype==3 || namecate.labletype==4 || namecate.labletype==5 || namecate.labletype==6 || namecate.labletype==7 || namecate.labletype==8 || namecate.labletype==10 || namecate.labletype==11 || namecate.labletype==12 || namecate.labletype==13 || namecate.labletype==14 || namecate.labletype==15"> </td>
                        ...
                        <div class="floater-options1"    ng-init="fetchSingleDatatotal('1')">
                            ...
                            <div class="row">
                              <div class="col-lg-6 col-md-6 col-sm-12 col-12 d-flex floaterOptionLeft" >
                                    ...
                                    <div class="d-inline pe-1 pe-md-3 pe-lg-5 pe-sm-1">
                                        ...
                                        ?>   
                                            ...
                                            <div class="flex-grow-1">
                                                <span class="text-muted mb-2 lh-1 d-block text-truncate">Discount</span>
                                    ...
                                    <div class="d-inline pe-1">
                                        <div class="d-flex align-items-center">
                                            <div class="flex-grow-1">
                                                
                                                <h5 class="mb-2"> Total : {{discountfulltotal}} </h5>
                                                   
                                                    
                                               
                                                <p>Round Off : <input type="text"  value="{{minisroundoff}}"  class="roundoff" id="roundoff" ng-keyup="saveRoundoff($event)" ></p>
                                                            ...
                                                            <div class="modal-body" style="height: 500px;overflow: auto;">
                                                                ...
                                                                <form  ng-submit="imageuploadInproduct()" method="post" id="productupload">
                                                                  <div class="row" style="margin-bottom: 10px;">
                                                                   ...
                                                                   <div class="col-md-2 showhide"><input type="text" class="form-control " id="lengthvalset" placeholder="length"></div>
                                                            ...
                                                            <div class="row" ng-init="imgpreviewimages()">
                                                                ...
                                                                <div class="col-md-6" ng-repeat="nameimage in namesDataoptonsimages">
                                                                   ...
                                                                   <label> <input type="radio" name="imageid" class="imageid" value="{{nameimage.id}}" >
                                                                    <img class="border-set" alt="200x200" style="width:100%;border: #959595 solid 2px;padding: 20px" ng-click="sizedefindbylayout(nameimage.image_layout_plan,nameimage.id,nameimage.length)"  src="{{nameimage.product_image}}" data-holder-rendered="true">
                                                                    </label>
 ...
 $scope.sizedefindbylayout = function(base_id,id,length)
 {
        ...
        $scope.inputsave_1(order_product_id,'profile',categories_id,type);
                 ...
                 $http({
                  ...
                  data:{'image_length':length,'order_product_id':order_product_id,'order_no':'<?php echo $order_no; ?>','tablenamemain':'<?php echo $tablename; ?>','tablename_sub':'<?php echo $tablename_sub; ?>'}
                  }).success(function(data){

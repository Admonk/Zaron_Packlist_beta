 ...
 <h4 class="card-title mt-3">Contact Details </h4>
                       ...
                       <div class="row">
                        ...
                        <div class="col-md-6">
                          ...
                          <div class="form-group row">
                            ...
                            <div class="col-sm-12">
                             <select class="form-control" name="customer_group" id="customer_group"  required ng-model="customer_group">
                      ...
                      <div class="row" style="display:none;" id="showslaesgroup">
                          ...
                          <div class="form-group row">
                            ...
                            <div class="col-sm-12">
                             <select class="form-control" id="sales_group"  name="sales_group" ng-model="sales_group">
...
$(document).ready(function(){
  $("#customer_group").on('change',function(){
   ...
   {
       $('#showslaesgroup').show();
       $("#sales_group").attr("required", "true");

   }
   else
   {
       $('#showslaesgroup').hide();
       $("#sales_group").attr("required", "false");
   }

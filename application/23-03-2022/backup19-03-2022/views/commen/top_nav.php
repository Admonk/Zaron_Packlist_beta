                                    ...
                                    <a class="nav-link dropdown-toggle arrow-none" href="#" id="topnav-ledger" role="button">
                                     ...
                                     <div class="dropdown">
                                          ...
                                          <div class="dropdown-menu" aria-labelledby="topnav-accountsmaster">
                                                         ...
                                                         <a class="dropdown-item"  href="<?php echo base_url(); ?>index.php/accounttype">Account Type</a>
                                                         <a class="dropdown-item"  href="<?php echo base_url(); ?>index.php/accountheads">Account Heads</a>
                                              ...
                                              <a class="dropdown-item" href="<?php echo base_url(); ?>index.php/payment_received">Payment Receipt</a>
                                          ...
                                          <div class="dropdown-menu" aria-labelledby="topnav-accountsmaster">
                                              ...
                                              <a class="dropdown-item" href="<?php echo base_url(); ?>index.php/report/balancereport?type=3">Balance Report </a>
                                ...
                                <li class="nav-item dropdown">
                                    ...
                                    <a class="nav-link dropdown-toggle arrow-none" href="#" id="topnav-report" role="button">
                                     ...
                                     <div class="dropdown-menu" aria-labelledby="topnav-report">
                                              ...
                                              <a class="dropdown-item" href="<?php echo base_url(); ?>index.php/report/salesreport">Sales Report</a>
                                              ...
                                              <a class="dropdown-item" href="<?php echo base_url(); ?>index.php/report/vendor_purchase_report">Vendor Purchase Report</a>
                                              <a class="dropdown-item" href="<?php echo base_url(); ?>index.php/report/vendor_purchase_product_report">Vendor Purchase Product Report</a>

	...
	public function insertandupdate()
	{
                 ...
                 if($form_data->action=='Save')
                 {
                     ...
                     if($form_data->name!=''  && $form_data->pin!='' && $form_data->customer_group!='' && $form_data->phone!='' )
                     {
			                     ...
			                     $data['sales_group_id']=$form_data->sales_group;
                 	...
                 	$i=1;
                 	 foreach ($result as  $value) {
                        ...
                        foreach ($user_group as  $row) {
                          ...
                          $sales_group_name ='';
                        $sales_group = $this->Main_model->where_names('sales_group','id',$value->sales_group_id);
    ...
    public function fetch_single_data()
    {
    	             ...
    	             $result= $this->Main_model->where_names($tablename,'id',$id);
                      ...
                      $output['access']=$value->access;
                       ...
                       $output['sales_group']=$value->sales_group_id;

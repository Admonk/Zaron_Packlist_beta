                                                              ...
                                                              else
                                                              {
                                                                     ...
                                                                     elseif($type==7 || $type==10)
                                                                     {
                                                                         ...
                                                                         if($categories_id=='13')
                                                                         {
                                                                                 ...
                                                                                 $profile= round($data['profile']/60,3);
                                                                                 $data['amount']=round($profile*$data['rate'],3);
                                                                                 $data['nos']=round($profile,3);
                                                                                 
                                                                                 $profileset= round($data['profile']/60,3);
                                                                                 $data['fact']=round($profileset)*60-$data['profile'];
                                                              ...
                                                              else
                                                              {
                                                                     ...
                                                                     elseif($type==7 || $type==10)
                                                                     {
                                                                         ...
                                                                         if($categories_id=='13')
                                                                         {
                                                                                 ...
                                                                                 $profilevv= round($profile/60,3);
                                                                                 $datass['amount']=round($profilevv*$rate,3);
                                                                                 $datass['nos']=round($profilevv,3);
                                                                                 
                                                                                 $profileset= round($profile/60,3);
                                                                                 $datass['fact']=round($profileset)*60-$profile;
                                                                                 $datass['qty']=$profile;

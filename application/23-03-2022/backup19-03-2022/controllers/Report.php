...
class Report extends CI_Controller {
		...
		public function fetch_data_sales_report()
	{
                     ...
                     if($_GET['formdate']=='undefined')
                     {
                         ...
                         $formdate=date('Y-m-01');
                         $todate=date('Y-m-t');
                         $result=$this->db->query("SELECT a.*,b.company_name FROM orders_process as a JOIN customers as b ON a.customer_id=b.id  WHERE  a.create_date BETWEEN '".$formdate."' AND '".$todate."' AND  a.deleteid=0 AND a.order_base='1' ORDER BY a.id DESC");

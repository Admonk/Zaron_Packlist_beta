                ...
                $tablenamemain=$form_data->tablenamemain;
                 ...
                 if($form_data->action=='Save')
                 {
                     ...
                     if($form_data->profile!='')
                     {
                                    ...
                                    elseif($categories=='Screw accesories' || $categories=='Screw' || $categories=='Cleat')
                                    {
		...
		public function getcounttl_price_request()
	{
	     $tablename= $_GET['tablename'];
	      ...
	      if($this->session->userdata['logged_in']['access']=='12')
          {
                	     ...
                	     $waiting= $this->Main_model->where_names_three_order_by($tablename,'order_base','-3','user_id',$this->userid,'deleteid','0','id','DESC');
          ...
          elseif($this->session->userdata['logged_in']['access']=='11')
          {
                	     ...
                	     $resultprocessed= $this->Main_model->where_names_three_thried_where_in_order_by($tablename,'order_base','1','price_requerst_status','3','user_id',$sales_team_id,'id','DESC');
                	     ...
                	     $resultrequest= $this->Main_model->where_names_three_thried_where_in_order_by($tablename,'price_requerst_status','3','order_base','3','user_id',$sales_team_id,'id','DESC');
                	     ...
                	     $md_team= $this->Main_model->where_names_three_thried_where_in_order_by($tablename,'order_base','5','price_requerst_status','3','user_id',$sales_team_id,'id','DESC');
                	   ...
                	   $waiting= $this->Main_model->where_names_three_thried_where_in_order_by($tablename,'order_base','-3','deleteid','0','user_id',$sales_team_id,'id','DESC');
          ...
          elseif($this->session->userdata['logged_in']['access']=='4' || $this->session->userdata['logged_in']['access']=='10')
          {
        	     ...
        	     $purchase_team= $this->Main_model->where_names_two_order_by($tablename,'order_base','4','price_requerst_status',$price_requerst_status,'id','DESC');
        	     ...
        	     $waiting= $this->Main_model->where_names_two_order_by($tablename,'order_base','-3','deleteid','0','id','DESC');

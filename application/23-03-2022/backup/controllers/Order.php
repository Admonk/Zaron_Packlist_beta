...
class Order extends CI_Controller {
	...
	public function ordercreate()
	{
									    ...
									    if(isset($this->session->userdata['logged_in']))
							            {
							            	 ...
							            	 $data['sales_team'] = $this->Main_model->where_names('sales_team','deleteid','0');
	...
	{         
	               ...
	               $datass['packaging']=$form_data->packaging; 
	...
	{         
                   ...
                   $form_data = json_decode(file_get_contents("php://input"));
	               $datass['get_id']=$form_data->order_product_id;
	               $datass['remarks']=$form_data->remarks; 
	               $tablenamemain=$form_data->tablename_sub;  
	               $this->Main_model->update_commen($datass,$tablenamemain);
	...
	{         
                   ...
                   $form_data = json_decode(file_get_contents("php://input"));
	               $datass['get_id']=$form_data->order_product_id;
	               $datass['other']=$form_data->ordersval; 
	               $tablenamemain=$form_data->tablename_sub;  
	               $this->Main_model->update_commen($datass,$tablenamemain);
	...
	{         
                                                	         ...
                                                	         $customer_id=0;
                                                	         $sales_id=0;
                                                	         $result= $this->Main_model->where_names('sales_team','id',$user_id);
                                                             foreach ($result as  $form_data_val) {
                 ...
                 if($form_data->action=='Save')
                 {
                     ...
                     if($form_data->profile!='')
                     {
                                    ...
                                    elseif($categories=='Tile sheet')
                                    {
                                      ...
                                      elseif($categories=='Decking sheet')
                                    {
                                     ...
                                     elseif($categories=='Aluminium' || $categories=='Purlin')
                                    {
                                    ...
                                    if(count($result_ordercount)==0)
                                    {
                                        $this->Main_model->insert_commen($basedata,$tablenamemain);
                                                              ...
                                                              if($categories=='Cleat Sagrod & L angle')
                                                              { 
                                                                      
                                                                      $qty=$data['profile']*$data['fact']*$data['nos'];
                                                              ...
                                                              elseif($categories=='Accesories')
                                                              { 
                                                                  
                                                                  
                                                                     if($type==1)
                                                                     {
                                                                         $qty=$data['profile']*$data['nos'];
                                                              ...
                                                              elseif($categories=='Extra sheet and arch' || $categories=='Polycarbonate' || $categories=='Profile ridge & Arch' || $categories=='Puff panel')
                                                              { 
                                                              ...
                                                              else
                                                              {
                                                                     ...
                                                                     {  
                                                                         ...
                                                                         $profile=round($data['profile']/304.8,3);
                                                          ...
                                                          foreach ($resultff as  $ssdd) {
                                                           ...
                                                           if(isset($data['profile']))
                                                           {
                                                                         ...
                                                                         if($cul==4)
                                                                         {
                                                                             ...
                                                                             $data['profile']=round($data['profile']/304.8,3);
                                                                         }
                                                                         
                                                                         if($cul==5)
                                                                         {
                                                                             $data['profile']=round($data['profile']*3.2808,3);
                                                                         }
                                                                         
                                                                         
                                                                         if($cul==6)
                                                                         {
                                                                             $data['profile']=round($data['profile']/12);
                                                                         }
		...
		public function fetch_data_calculation()
	{
                 	...
                 	$result=$result->result();
                 	 ...
                 	 foreach ($result as  $value) {
                                   ...
                                   $profile=$value->profile;
                                   $crimp= $value->crimp; 
                                   if($cid==$value->categories_id && $typev==$type)
                                   {
    	             ...
    	             $result= $this->Main_model->where_names_two_order_by($tablename,'order_id',$_GET['order_id'],'deleteid','0','id','DESC');
                 	 foreach ($result as  $value) {
                       ...
                       $reason=$valuedis->reason;
                 	      ...
                 	      $salesphone="";
                 	      $salesname="";
                 	 $resultsales= $this->Main_model->where_names('sales_team','id',$user_id);
                                                                ...
                                                                $find['details']=$orders->details;
                                                                 ...
                                                                 foreach($result_order_product as $orders_product)
                                                                 {
                                                                     ...
                                                                     // $findp['id']=$orders_product->id;
                                                                      ...
                                                                      $findp['reason']='Process To Production';
    		...
    		public function specificationFind()
	{
                     ...
                     $results= $this->Main_model->where_names($tablename,'id',$product_order_id);
                 	 foreach ($results as  $values) {
                       ...
                       $output['packaging']= $values->packaging; 
                       $output['print']= $values->print; 
                       $output['other']= $values->other;
                       $output['remarks']= $values->remarks;
                     ...
                     if(count($section_lable) != 0)
                     {
                             ...
                             $lable=range('A', 'Z');
                         	 for ($i=0; $i <count($section_lable) ; $i++) { 
                                  ...
                                  $array[]=array('section_lable'=>$section_lable[$i],'section_value'=>$section_value[$i],'degree_value'=>$degree_value[$i],'lable'=>$lable[$i]);
                             }

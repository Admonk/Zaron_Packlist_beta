	...
	public function insertandupdate()
	{
                 ...
                 if($form_data->action=='Save')
                 {
                     ...
                     if($form_data->color!='')
                     {
    			                     ...
    			                     $data['product_name']=$form_data->color.' '.$form_data->gsm.' '.$form_data->thickness.' '.$form_data->ys;
 ...
 $data['link_to_purchase']=$form_data->link_to_purchase;
	...
	public function findimages()
	{
                     ...
                     $product_id=$form_data->product_id;
                 	 ...
                 	 $result= $this->Main_model->where_names_order_by('product_images','delete_id',0,'id','DESC');
                 	 foreach ($result as  $value) {

...
class Order extends CI_Controller {
                     ...
                     if($form_data->profile!='')
                     {
                                    ...
                                    if(count($result_ordercount)==0)
                                    {
                                        $this->Main_model->insert_commen($basedata,$tablenamemain);
                                                              ...
                                                              if($categories=='Aluminium' || $categories=='Purlin' || $categories=='Cleat, Sagrod & L angle' || $categories=='Cleat, Sagrod & L angle')
                                                              { 
                                                              ...
                                                              elseif($categories=='Decking sheet' || $categories=='Extra sheet and arch' || $categories=='Polycarbonate' || $categories=='Profile ridge & Arch' || $categories=='Puff panel')
                                                              { 
                                                              ...
                                                              else
                                                              {
                                                                       ...
                                                                       if($type==4)
                                                                     {
                                                                         $qty=$data['profile']*$data['nos']*$data['fact'];
                                                                         $data['Meter_to_Sqr_feet']=$qty;
                                                                         $data['Sqr_feet_to_Meter']=$qty;
                                                                         $data['qty']=round($qty,3);
                                                                         $data['amount']=round($data['rate']*$qty,3);
	...
	public function getcount()
	{
	     $tablename= $_GET['tablename'];
          ...
          elseif($this->session->userdata['logged_in']['access']=='SH')
          {

...
class Additional_information extends CI_Controller {
	...
	public function insertandupdate()
	{
                 ...
                 if($form_data->action=='Add')
                 {
    				...
    				if($this->db->field_exists(strtolower($label_name), $table))
    				{
    				   //echo 1;
    				}
    				else
    				{
    				    ...
    				    $this->db->query("ALTER TABLE 	order_product_list  ADD `".strtolower($label_name)."` VARCHAR(100) NULL DEFAULT NULL AFTER `cul`");
                        $this->db->query("ALTER TABLE 	order_product_list_process  ADD `".strtolower($label_name)."` VARCHAR(100) NULL DEFAULT NULL AFTER `cul`");
                        $this->db->query("ALTER TABLE   order_product_list_quotation  ADD `".strtolower($label_name)."` VARCHAR(100) NULL DEFAULT NULL AFTER `cul`");

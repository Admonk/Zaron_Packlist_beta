...
$scope.fetchSingleData = function(id){
  ...
  $scope.submitForm = function(){
    ...
    $http({
      method:"POST",
      url:"<?php echo base_url() ?>index.php/purchase/insertandupdate",
      data:{'product_id':$scope.product_id,'rack_info':$scope.rack_info,'bin_info':$scope.bin_info,'inward_date':$scope.inward_date,'vendor_id':$scope.vendor_id,'po_number':$scope.po_no,'qty':$scope.qty,'price':$scope.price,'id':$scope.hidden_id,'action':'Inward','tablename':'purchase_order'}
    }).success(function(data){

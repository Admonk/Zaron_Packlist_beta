...
$scope.fetchSingleData = function(id){
  ...
  $scope.submitForm = function(){
    ...
    $http({
      method:"POST",
      url:"<?php echo base_url() ?>index.php/purchase/insertandupdate",
      data:{'product_id':$scope.product_id,'vendor_id':$scope.vendor_id,'po_number':$scope.po_no,'qty':$scope.qty,'price':$scope.price,'order_date':$scope.order_date,'id':$scope.hidden_id,'action':$scope.submit_button,'tablename':'purchase_order'}
    }).success(function(data){

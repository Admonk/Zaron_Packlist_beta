                                             ...
                                             <div class="card-header align-items-start d-flex p-3">
                                                <div class="flex-shrink-0">
                                                   <ul class="nav justify-content-end nav-tabs-custom rounded card-header-tabs" role="tablist" ng-init="getcount('orders_process')">
                                                      ...
                                                      <li class="nav-item">
                                                         <a class="nav-link active" data-bs-toggle="tab" href="#messages2" role="tab" ng-click="pageTab('orders_process',5)">
                                                         <span class="d-block d-sm-none"><i class="far fa-envelope"></i></span>
                                                         <span class="d-none d-sm-block">Approved Request Order <span class="badge rounded-pill bg-warning  float-end"> {{md_team}} </span></span>   
                                                         </a>
                                                      </li>
                                              ...
                                              <div class="col-12">
                                                  <div class="card shadow-none">
                                                      <div class="card-body">
                                                          ...
                                                          <div class="table-responsive" ng-init="fetchData('orders_process',5)">
                                                                      ...
                                                                      <tr  ng-repeat="name in namesData">
                                                                         ...
                                                                         <span ng-if="name.order_base==-1">
                                                                          ...
                                                                          <td>
                                                                                     ...
                                                                                     <a href="<?php echo base_url(); ?>index.php/order/ordercreate_product_process_md_verification?order_id={{name.base_id}}" ><i class="mdi mdi-eye font-size-16 text-success me-1"></i> View</a>
...
$scope.deleteData = function(id){
    if(confirm("Are you sure you want to remove it?"))
    {
      $http({
        ...
        $scope.success = false;
        $scope.error = false;
        $scope.fetchData('orders_process','5');
      }); 
    }
};
 ...
 $http({
      ...
      data:{'pincode':$scope.pincode}
            ...
            $scope.purchase_team =  data.purchase_team;
             ...
             $scope.finance_team =  data.finance_team;

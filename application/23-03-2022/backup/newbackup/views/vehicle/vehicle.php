...
$scope.fetchSingleData = function(id){
    $http({
      ...
      data:{'id':id, 'action':'fetch_single_data','tablename':'vehicle'}
          ...
          $scope.purchased_date = data.purchased_date;
          $scope.insurance_date = data.insurance_date;
          $scope.national_permit_date = data.national_permit_date;
          $scope.fc_date = data.fc_date;
          $scope.route_id = data.route_id;
          $scope.pollution_date = data.pollution_date;

...
app.controller('crudController', function($scope, $http){
  ...
  $scope.submitForm = function(){
    ...
    $http({
      ...
      data:{'status':'1','lab_option1':lab_option1,'lab_option2':lab_option2,'label1':lab1,'label2':lab2,'stock':$scope.stock,'optimal_stock':$scope.optimal_stock,'formula2':$scope.formula2,'point':lab_point,'type':$scope.type,'link_to_purchase':$scope.link_to_purchase,'color':$scope.color,'ys':$scope.ys,'gsm':$scope.gsm,'thickness':$scope.thickness,'formula':$scope.formula,'description':$scope.description,'side_label':$scope.side_label,'input_label':$scope.input_label,'source_name':$scope.source_name,'kg_price':$scope.kg_price,'price':$scope.price,'brand':$scope.brand,'uom':$scope.uom,'HSN_SAC':$scope.HSN_SAC,'categories':$scope.categories,'id':$scope.hidden_id,'action':$scope.submit_button,'tablename':'product_list'}

                   ...
                   <table id="datatable" class="table table-bordered dt-responsive  nowrap w-100" datatable="ng" dt-options="vm.dtOptions" >
                      ...
                      <tbody>
                        <tr ng-repeat="name in namesData">
                          ...
                          <td>{{name.HSN_SAC}}</td>
                          <td>{{name.stock}}</td>
                            <!--<td>{{name.input_label}}</td>-->
                         
                          <!--<td>{{name.status}}</td>-->
                           <td>
                            <a href="<?php echo base_url(); ?>index.php/products/customer_edit/{{name.id}}" target="_blank"  class="btn btn-outline-primary"><i class="mdi mdi-pencil menu-icon"></i></a>

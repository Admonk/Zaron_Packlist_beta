...
$(document).ready(function(){
  $(".categories").change(function(){
     ...
     if(acc=='Accesories' || acc=='Tile sheet' || acc=='Aluminium' || acc=='Purlin' || acc=='Decking sheet')
     {
         $('#dis_acc').show();
     }
     else

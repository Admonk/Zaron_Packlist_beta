...
<?php  if($this->session->flashdata('success')){ ?><div class="alert alert-success"><?php echo $this->session->flashdata('success'); ?></div> <?php } ?>
                                        ...
                                        <form class="mt-4 pt-2" method="post"  action="<?php echo base_url(); ?>index.php/adminmain/userlogin">  
                                            

                                            <div class="form-floating form-floating-custom mb-4 auth-pass-inputgroup">
                                                <input type="password" class="form-control pe-5" id="password-input"  name="password" id="Password" placeholder="Enter The PIN"> 
                                                <button type="button" class="btn btn-link position-absolute h-100 end-0 top-0" id="password-addon">
                                                    <i class="mdi mdi-eye-outline font-size-18 text-muted"></i>
                                                </button>
                                                <label for="input-password">Enter PIN</label>
                            ...
                            <a href="<?php echo base_url(); ?>index.php/adminmain/adminloginpage" style="float:right;">ADMIN LOGIN</a>
                        </div>

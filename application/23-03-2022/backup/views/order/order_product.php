                                 ...
                                 <div class="table-responsive mb-0 table-scroll" data-pattern="priority-columns" >
                                    <table id="datatable" class="table table-bordered dt-responsive  nowrap w-100" >
                                          ...
                                          <tr>
                                           ...
                                           <tr>
                                              ...
                                              <th colspan="1" style="padding-top:4px" ng-if="namecate.labletype==1">
                                                    ...
                                                    <select class="selectbox" ng-change="changeCalulation(namecate.categories_id,namecate.type)" id="cal_{{namecate.categories_id}}{{namecate.type}}" ng-model="calulation" ><option value="3">FEET</option><option value="4">MM</option><option value="5">MTR</option><option value="6">INCH</option></select>
                                        ...
                                        <thead class="bg-primary text-white" ng-if="namecate.categories_id!=1">
                                          ...
                                          <tr>
                                             ...
                                             <th class="table-width-6" data-priority="3" style="padding-bottom:0px" ng-click='sortColumn("profile_tab")' ng-class='sortClass("profile_tab")'>{{namecate.lable}} <i class="fa fa-sort" aria-hidden="true"></i></th>
                                              ...
                                              <th class="table-width-6"  ng-if="namecate.labletype==5 || namecate.labletype==6 || namecate.labletype==7" data-priority="1" rowspan="2"  style="padding-bottom:0px" ng-click='sortColumn("nos_tab")' ng-class='sortClass("nos_tab")'>Nos <i class="fa fa-sort" aria-hidden="true"></i></th>
                                       ...
                                       <select class="selectbox" ng-change="changeCalulation(namecate.categories_id,namecate.type)" id="cal_{{namecate.categories_id}}{{namecate.type}}" ng-model="calulation" ><option value="3">FEET</option><option value="4">MM</option><option value="5">MTR</option><option value="6">INCH</option></select>
                                               ...
                                               <th colspan="1" style="padding-top:4px" ng-if="namecate.labletype==5 || namecate.labletype==6 || namecate.labletype==7">
                                       ...
                                       <select class="selectbox" ng-change="changeCalulationMM(namecate.categories_id,namecate.type)" id="cal_{{namecate.categories_id}}{{namecate.type}}" ng-model="calulationmm" ><option value="4">MM</option><option value="3">FEET</option></select>
                                       ...
                                       <tbody  ng-repeat="name in namesData|orderBy:column:reverse" ng-if="namecate.categories_id!=1">
                                          ...
                                          <tr  class="view" ng-if="namecate.categories_id==name.categories_id_get">
                                             ...
                                             <td ng-if="namecate.labletype==1 || namecate.labletype==5 || namecate.labletype==6 || namecate.labletype==7"><input type="text" <?php echo $read; ?>  ng-keyup="inputsave_1(name.id,'profile',namecate.categories_id,namecate.type)"  id="profile_{{name.id}}" data-title="{{name.cul}}" value="{{name.profile_tab}}"></td>
...
$scope.inputsave_1 = function (id,inputname,categories_id,type) {
                          ...
                          if(cul==5)
                          {
                              var profile= parseFloat(profile*3.2808);
                              var profile=profile.toFixed(3);
                          }
                          if(cul==6)
                          {
                        ...
                        var rate= parseFloat($('#rate_'+id).val());
                          ...
                          if(categories_id==1)
                          {
                           ...
                           if(type==5)
                           {
                               ...
                               var sqt_qty=profile/3.281*nos*fact;
                               var sqt_qty=sqt_qty.toFixed(3);

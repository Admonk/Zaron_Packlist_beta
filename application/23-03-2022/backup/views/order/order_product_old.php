               ...
               <div class="container-fluid">
                  <div class="row">
                     <div class="col-9">
                        ...
                        <span style="color:red;">*  all inputs are in feet	</span>
                                    ...
                                    <table id="datatable" class="table table-bordered dt-responsive  nowrap w-100" >
                                       ...
                                       <thead class="bg-primary text-white" ng-if="namecate.categories_id==1">
                                          ...
                                          <tr>
                                             ...
                                             <th class="table-width-6" ng-if="namecate.labletype==1"  style="padding-bottom:0px" data-priority="3" ng-click='sortColumn("profile_tab")' ng-class='sortClass("profile_tab")'>{{namecate.lable}} <i class="fa fa-sort" aria-hidden="true"></i></th>
                                             ...
                                             <th class="table-width-6" ng-if="namecate.labletype==2"  style="padding-bottom:0px" data-priority="3" ng-click='sortColumn("profile_tab")' ng-class='sortClass("profile_tab")'>{{namecate.lable}} <i class="fa fa-sort" aria-hidden="true"></i></th>
                                             <th class="table-width-6" ng-if="namecate.labletype==2" data-priority="1" ng-click='sortColumn("crimp_tab")' ng-class='sortClass("crimp_tab")'>Length <i class="fa fa-sort" aria-hidden="true"></i></th>
                                           ...
                                           <tr>
                                              ...
                                              <th colspan="1" style="padding-top:4px" ng-if="namecate.labletype==1">

                                                    <select class="selectbox" ng-change="changeCalulation(namecate.categories_id)" id="cal_{{namecate.categories_id}}" ng-model="calulation" ><option value="3">FEET</option><option value="4">MM</option><option value="5">MTR</option><option value="6">INCH</option></select>
                                     
                                              </th>
                                              
                                              
                                                  <th colspan="2" style="padding-top:4px" ng-if="namecate.labletype==2">
                                        ...
                                        <thead class="bg-primary text-white" ng-if="namecate.categories_id!=1">
                                          ...
                                          <tr>
                                             ...
                                             <th class="table-width-6" data-priority="3" style="padding-bottom:0px" ng-click='sortColumn("profile_tab")' ng-class='sortClass("profile_tab")'>{{namecate.lable}} <i class="fa fa-sort" aria-hidden="true"></i></th>
                                             ...
                                             <th class="table-width-6"  ng-if="namecate.labletype==1" data-priority="1" style="padding-bottom:0px" ng-click='sortColumn("crimp_tab")' ng-class='sortClass("crimp_tab")'>Crimp <i class="fa fa-sort" aria-hidden="true"></i></th>
                                         ...
                                         <tr>
                                             ...
                                             <th colspan="2" style="padding-top:4px" ng-if="namecate.labletype==1">
                                       ...
                                       <select class="selectbox" ng-change="changeCalulation(namecate.categories_id)" id="cal_{{namecate.categories_id}}" ng-model="calulation" ><option value="3">FEET</option><option value="4">MM</option><option value="5">MTR</option><option value="6">INCH</option></select>
                                             ...
                                             <th colspan="1" style="padding-top:4px" ng-if="namecate.labletype==4">

                                       <select class="selectbox" ng-change="changeCalulationMM(namecate.categories_id)" id="cal_{{namecate.categories_id}}" ng-model="calulationmm" ><option value="4">MM</option><option value="3">FEET</option></select>
                                       ...
                                       <tbody  ng-repeat="name in namesData|orderBy:column:reverse" ng-if="namecate.categories_id==1">
                                          ...
                                          <tr  class="view" ng-if="namecate.categories_id==name.categories_id_get && namecate.type==name.type">
                                             ...
                                             <td ><input type="text" <?php echo $read; ?>  ng-keyup="inputsave_1(name.id,'profile',namecate.categories_id,namecate.type)"  id="profile_{{name.id}}" value="{{name.profile_tab}}"></td>
                                            ...
                                            <?php
                                             ...
                                             <td>
                                                ...
                                                data-bs-toggle="offcanvas" style="cursor: pointer;" data-bs-target="#offcanvasSpec" ng-click="sizedefind(name.id,name.product_id)" ng-if="name.cate_status==1" aria-controls="offcanvasSpec" title="Add On Size"></i>
                                       ...
                                       <tbody  ng-repeat="name in namesData|orderBy:column:reverse" ng-if="namecate.categories_id!=1">
                                          ...
                                          <tr  class="view" ng-if="namecate.categories_id==name.categories_id_get">
                                             ...
                                             <td ng-if="namecate.labletype==4" >
                                                   ...
                                                   <select  ng-blur="inputsave_1(name.id,'profile',namecate.categories_id,namecate.type)" style="padding: 0px 0px;border: none;"  id="profile_{{name.id}}">

                                                   <option ng-repeat="mmset in availableProductsmm" value="{{mmset.length_mm}}" ng-if="mmset.product_name==name.product_id && mmset.length_mm==name.profile_tab"> {{mmset.length_mm}} </option>
                                                   <option ng-repeat="mmset in availableProductsmm" value="{{mmset.length_mm}}" ng-if="mmset.product_name==name.product_id"> {{mmset.length_mm}} </option>
                                             ...
                                             <td ng-if="namecate.labletype==1"><input type="text" <?php echo $read; ?>  ng-keyup="inputsave_1(name.id,'profile',namecate.categories_id,namecate.type)"  id="profile_{{name.id}}" value="{{name.profile_tab}}"></td>
...
<div class="alert alert-success alert-dismissible fade show" role="alert" ng-show="success">
 ...
 <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasSpec-Specification" aria-labelledby="offcanvasSpecLabel">
        <div class="offcanvas-header" style="background: #dddddd;">
          <h5 id="offcanvasSpecLabel">Accessories Remarks
                          </h5>
          <button type="button" class="btn-close text-reset" data-bs-dismiss="offcanvas" aria-label="Close"></button>
        </div>
        <div class="offcanvas-body">
                                 ...
                                 <div class="col-md-12" >
                                   <div class="d-inline pe-12">
                                       <div class="form-group row">
                                          <div class="flex-shrink">
                                             <label class="col-sm-12 col-form-label">Remarks</label>
                                             <div class="col-sm-12">
                                                <select class="form-control" ng-change="saveRemarks()" name="remarks"  ng-model="remarks">
                                                   <option value="0"> Select Remarks</option>
                                                   <option value="Colour Inside">Colour Inside</option>
                                                   <option value="Outside-Print Yes">Outside-Print Yes</option>
                                                   <option value="No-Packing Yes">No-Packing Yes</option>
                                                </select>
                                  ...
                                  <div class="col-md-12" >
                                   <div class="d-inline pe-12">
                                       <div class="form-group row">
                                          <div class="flex-shrink">
                                             <label class="col-sm-12 col-form-label">Packaging</label>
                                             <div class="col-sm-12">
                                                <select class="form-control" ng-change="savePackaging()" name="packaging"  ng-model="packaging">
                                   ...
                                   <div class="d-inline pe-12">
                                       <div class="form-group row">
                                          <div class="flex-shrink">
                                             <label class="col-sm-12 col-form-label">Print</label>
                                             <div class="col-sm-12">
                                                <select class="form-control" ng-change="savePrint()" name="print"  ng-model="print">
                                                   <option value="0"> Select Print</option>
                                  ...
                                  <div class="col-md-12" >
                                   <div class="d-inline pe-12">
                                       <div class="form-group row">
                                          <div class="flex-shrink">
                                             <label class="col-sm-12 col-form-label">Other</label>
                                             <div class="col-sm-12">
                                              
                                                
                                                <select class="form-control" ng-change="saveOther()" name="ordersval"  ng-model="ordersval">
                                                   <option value="0"> Select Others</option>
                                                   <option value="Combination Lot">Combination Lot</option>
                                                   <option value="Old Lots(Bill No.)">Old Lots(Bill No.)</option>
                                                   <option value="QC">QC</option>
                                                   <option value="Reverse Color">Reverse Color</option>
                                                   <option value="Reverse Crimp">Reverse Crimp</option>
                                                   <option value="Tata Profile">Tata Profile</option>
                                                   <option value="Flim Gaurd">Flim Gaurd</option>
                                                </select>
                      ...
                      <span  ng-init="fetchDatasizeoptionsvalue()" id="appendTwobox">            
                        ...
                        <div class="col-md-3">
                          <div class="form-group row">
                            ...
                            <div class="col-sm-12">
                              <input  class="form-control label1" placeholder="A" name="label1[]" ng-model="nameoptionv.section_lable" type="text">
                            </div>
                          </div>
                        </div>
                        ...
                        <div class="col-md-3">
                          <div class="form-group row">
                            ...
                            <div class="col-sm-12">
                              <input class="form-control label2" placeholder="B" name="label2[]" ng-model="nameoptionv.section_value" type="text">
                            </div>
                          </div>
                        </div>
...
<div class="modal fade bs-example-modal-center"  id="imagesizemodel1" tabindex="-1" role="dialog" aria-labelledby="myExtraLargeModalLabel" aria-hidden="true">
                                                    <div class="modal-dialog modal-xl">
                                                        <div class="modal-content">
                                                            ...
                                                            <button type="button" ng-click="imgchoose()" class="btn btn-primary">Save Image</button>
                                                        </div>
                                                               ...
                                                               <div class="accordion accordion-flush" id="accordionFlushExample">
                                                                    <div class="accordion-item">
                                                                        ...
                                                                        <select class="form-control col-md-4" id="delivery_mode">
                                                                             ...
                                                                             <option value="Spilt">Spilt</option>
                                                                                          ...
                                                                                          <div class="table-responsive" >
                                                                                            <table class="table mb-0" ng-init="fetchData()">
                                                                                                ...
                                                                                                <thead>
                                                                                                    ...
                                                                                                    <th class="addresschoose" style="display:none;">Choose Address</th>
                                                                                                ...
                                                                                                <tbody >
                                                                                                 <tr ng-repeat="name in namesData|orderBy:column:reverse">
                                                                                                    ...
                                                                                                    <td >Rs. {{name.amount_tab}}</td>
                                                                                                     ...
                                                                                                     <td class="addresschoose" style="display:none;">
                                                                                                 ...
                                                                                                 <td class="paricel" style="display:none;"><input type="checkbox" value="{{name.id}}" class="spiltparicel"></td>
                                                                                                </tr>
                                                                                                
                                                                                                <tr>
                                                                                                    <td colspan="4" class="text-end">SubTotal</td>
                                                                                                    <td class="text-right">Rs. {{fulltotal}} </td>
                                                                                                    <td class="addresschoose" style="display:none;"></td>
...
app.controller('crudController', function($scope, $http){
    ...
    $scope.oninputstatus=function(){
            ...
            var data='<div class="row twoBoxInput"> <div class="col-md-3"> <div class="form-group row"> <div class="col-sm-12"> <input class="form-control label1" placeholder="A" name="label1[]" type="text"> </div> </div> </div> <div class="col-md-2"> <div class="form-group row"> <div class="col-sm-12"> + </div> </div> </div> <div class="col-md-3"> <div class="form-group row"> <div class="col-sm-12"> <input class="form-control label2" placeholder="B" name="label2[]" type="text"> </div> </div> </div> <div class="col-md-1"> <div class="form-group row"> <div class="col-sm-12"> = </div> </div> </div> <div class="col-md-3"> <div class="form-group row"> <div class="col-sm-12"> <input class="form-control degree" placeholder="Degree" name="degree[]" type="text"> </div> </div> </div> </div>';
                        ...
                        var rate= parseFloat($('#rate_'+id).val());
                          ...
                          if(categories_id==1)
                          {
                           ...
                           if(type==0)
                           {
                               ...
                               var Meter_to_Sqr_feet = Meter_to_Sqr_feet.toFixed(3);
...
if($scope.packaging)
{
        ...
        var  order_product_id=$('#product_id_base_define').val();
          ...
          $http({
          method:"POST",
          url:"<?php echo base_url() ?>index.php/order/savePackaging?order_id=<?php echo $order_id; ?>",
          data:{'packaging':$scope.packaging,'order_product_id':order_product_id,'order_id':'<?php echo $order_id; ?>','order_no':'<?php echo $order_no; ?>','action':'Save','movetablename':'<?php echo $movetablename; ?>','old_tablename':'<?php echo $old_tablename; ?>','tablenamemain':'<?php echo $tablename; ?>','tablename_sub':'<?php echo $tablename_sub; ?>'}
          }).success(function(data){
...
if($scope.remarks)
{
        ...
        var  order_product_id=$('#product_id_base_define').val();
          ...
          data:{'remarks':$scope.remarks,'order_product_id':order_product_id,'order_id':'<?php echo $order_id; ?>','order_no':'<?php echo $order_no; ?>','action':'Save','movetablename':'<?php echo $movetablename; ?>','old_tablename':'<?php echo $old_tablename; ?>','tablenamemain':'<?php echo $tablename; ?>','tablename_sub':'<?php echo $tablename_sub; ?>'}
          }).success(function(data){
...
if($scope.print)
{
  ...
  var  order_product_id=$('#product_id_base_define').val();
        ...
        $http({
          method:"POST",
          url:"<?php echo base_url() ?>index.php/order/savePrint?order_id=<?php echo $order_id; ?>",
          data:{'print':$scope.print,'order_product_id':order_product_id,'order_id':'<?php echo $order_id; ?>','order_no':'<?php echo $order_no; ?>','action':'Save','movetablename':'<?php echo $movetablename; ?>','old_tablename':'<?php echo $old_tablename; ?>','tablenamemain':'<?php echo $tablename; ?>','tablename_sub':'<?php echo $tablename_sub; ?>'}
         }).success(function(data){
...
var  order_product_id=$('#product_id_base_define').val();
        ...
        $http({
          method:"POST",
          url:"<?php echo base_url() ?>index.php/order/saveOther?order_id=<?php echo $order_id; ?>",
          data:{'ordersval':$scope.ordersval,'order_product_id':order_product_id,'order_id':'<?php echo $order_id; ?>','order_no':'<?php echo $order_no; ?>','action':'Save','movetablename':'<?php echo $movetablename; ?>','old_tablename':'<?php echo $old_tablename; ?>','tablenamemain':'<?php echo $tablename; ?>','tablename_sub':'<?php echo $tablename_sub; ?>'}
         }).success(function(data){
...
//}
  ...
  $scope.markDeliveryaddress = function()
  {
      ...
      else
      {
        ...
        data:{'id':order_product_id,'address_id':address_id,'partial':partial, 'action':'markDeliveryaddress','tablenamemain':'<?php echo $tablename; ?>','tablename_sub':'<?php echo $tablename_sub; ?>'}
        }).success(function(data){
...
$scope.changeCalulation = function(id){
   
   var convert=$('#cal_'+id).val();
   $scope.fetchData(convert);

};

$scope.changeCalulationMM = function(id){
...
$scope.specificationFind = function(id,product_id){
 ...
 $scope.specificationFinddata = function(id,product_id){
                                ...
                                data:{'product_id':product_id,'order_product_id':id,'tablenamemain':'<?php echo $tablename; ?>','tablename_sub':'<?php echo $tablename_sub; ?>'}
                                  ...
                                  $scope.packaging = data.packaging;
                                  $scope.print = data.print;
                                  $scope.ordersval = data.other;

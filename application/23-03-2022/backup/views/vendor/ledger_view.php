 ...
 <div class="main-content">
              ...
              <div class="col-lg-12">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12" ng-init="fetchDatagetlegder(<?php echo $vendor_id; ?>)">
                      ...
                      <form>
                         ...
                         <br>
                   <h4 class="mb-sm-0 font-size-18">Vendor Name :  <?php echo $name; ?></h4>  
                   <br>
...
$scope.search = function(){
    ...
    $scope.fetchDatagetlegder(<?php echo $vendor_id; ?>,fromdate,fromto,payment_status);
 ...
 $scope.pointtodriver = function () {
            ...
            else
            {
                        ...
                        data:{'enteramount':enteramount,'payid':payid,'payamount':payamount}
                           ...
                           $scope.fetchDatagetlegder(<?php echo $vendor_id; ?>,0,0,0);
                           $('#firstmodalcommison').modal('toggle');

    ...
    $http({
      ...
      data:{'id':<?php echo $id; ?>, 'action':'fetch_single_data','tablename':'product_list'}
        ...
        if(data.categories=='Profile ridge & Arch')
        {
         ...
         if(data.categories=='Decking sheet')
        {
             $('#kgprice').show();
             $('#formula2').show();
        }

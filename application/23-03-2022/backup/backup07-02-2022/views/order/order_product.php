                                ...
                                <div class="col-7 d-flex">
                                    ...
                                    <?php
                                     ...
                                     if($status_base==1)
                                     {
                                         ...
                                         <div class="d-inline">
                                          ...
                                          <div class="d-inline" style="margin: 0px 10px;">
                                   ...
                                   <?php
                                     ...
                                     <?php
                                      ...
                                      {
                                          ?>
                                          <div class="d-inline" style="margin: 0px 10px;" ng-if="order_base"><button type="button" ng-click="archiveOpen()" class="btn btn-outline-danger" >Archive</button></div>
                      ...
                      <span  ng-init="fetchDatasizeoptionsvalue()" id="appendTwobox">            
                        ...
                        <div class="col-md-6">
                         ...
                         <span ng-show="namesDataoptonsvalues.length==0">
                              ...
                              <div id="show_details2" style="display:none;"> </div>

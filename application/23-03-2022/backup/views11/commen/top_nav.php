 <header id="page-topbar">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="topnav-products">
                                     ...
                                     <div class="dropdown">
                                          <a class="dropdown-item dropdown-toggle arrow-none" href="#" id="topnav-authmaster" role="button">
                                             <span data-key="t-authentication">Product Master</span> 
                                             <div class="arrow-down"></div>
                                          </a>
                  ...
                  <a class="dropdown-item"  href="<?php echo base_url(); ?>index.php/brand">Brand</a>
                                   ...
                                   <li class="nav-item dropdown">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="topnav-purchase">
                                     ...
                                     <a class="dropdown-item"  href="<?php echo base_url(); ?>index.php/purchase/purchase_list">Purchase Create</a>
                                 ...
                                 <li class="nav-item dropdown">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="topnav-more">
                                       ...
                                       <a class="dropdown-item"  href="<?php echo base_url(); ?>index.php/order/enquiries_list">Enquiries List</a>
                                       ...
                                       <a class="dropdown-item"  href="<?php echo base_url(); ?>index.php/order/transport_orders_list">Transport Order List</a>
   ...
   <li class="nav-item dropdown">
                                      ...
                                      <?php
                                        ...
                                        ?>
                                          ...
                                          <a class="dropdown-item dropdown-toggle arrow-none" href="#" id="topnav-auth" role="button">
                                             <span data-key="t-authentication">Users Management</span> 
                                             <div class="arrow-down"></div>
                                          </a>
                ...
                <a class="dropdown-item" href="<?php echo base_url(); ?>index.php/users/user_list">Users List</a>
                                       ...
                                       <div class="dropdown">
                                          <a class="dropdown-item dropdown-toggle arrow-none" href="#" id="topnav-auth" role="button">
                                             <span data-key="t-authentication">Sales Management</span> 
                                             <div class="arrow-down"></div>
                                          </a>
                                          <div class="dropdown-menu" aria-labelledby="topnav-auth">

                  <a class="dropdown-item" href="<?php echo base_url(); ?>index.php/group/sales_group">Sales Group</a>
                    <a class="dropdown-item" href="<?php echo base_url(); ?>index.php/sales/sales_head">Sales Head</a>
...
<div class="dropdown">
 ...
 <div class="dropdown">
                                  ...
                                  <li class="nav-item dropdown">
                                   ...
                                   <li class="nav-item dropdown">
                                    ...
                                    <a class="nav-link dropdown-toggle arrow-none" href="#" id="topnav-ledger" role="button">
                                       <i data-feather="map"></i><span data-key="t-ledger">Ledger</span> 
                                       <div class="arrow-down"></div>
                                    </a>
               ...
               <?php
                ...
                ?>
                <a class="dropdown-item" href="<?php echo base_url(); ?>index.php/ticket/ticket_history">View Ticket</a>
                <?php
                ...
                else
                {
                    ?>
                     ...
                     <a class="dropdown-item" href="<?php echo base_url(); ?>index.php/ticket/ticketcreate">Create Ticket</a>
                     <a class="dropdown-item" href="<?php echo base_url(); ?>index.php/ticket/ticket_history">Ticket History</a>
               ...
               <?php
                ...
                ?>
                           ...
                           ?>
                               ...
                               <?php
                             if($this->session->userdata['logged_in']['access']=='SH')
                            {
                              ...
                              <nav class="navbar navbar-light navbar-expand-lg topnav-menu">
                                 ...
                                 <li class="nav-item dropdown">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="topnav-more">
                                       ...
                                       <a class="dropdown-item"  href="<?php echo base_url(); ?>index.php/order/enquiries_price_request_list">Enquiries Price Request List</a>
                                       <a class="dropdown-item"  href="<?php echo base_url(); ?>index.php/order/quotation_price_request_list">Quotation Price Request List</a>
                                       <a class="dropdown-item"  href="<?php echo base_url(); ?>index.php/order/orders_list_sales_head">Verification Order List</a>

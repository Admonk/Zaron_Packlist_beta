    ...
    if(paymentmode!='')
    {
     ...
     var reference_no= $('#reference_no').val();
      ...
      if(paymentmode!='Cash')
      {
                        ...
                        data:{'c50_rs':c50_rs,'c100_rs':c100_rs,'c200_rs':c200_rs,'c500_rs':c500_rs,'c2000_rs':c2000_rs,'reference_no':reference_no,'paymentmode':paymentmode,'order_id':'<?php echo $id; ?>'}
                        }).success(function(data){

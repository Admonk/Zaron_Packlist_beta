                                                ...
                                                <div class="flex-shrink-0">
                                                   <ul class="nav justify-content-end nav-tabs-custom rounded card-header-tabs" role="tablist" ng-init="getcount('orders_process')">
                                                      ...
                                                      <li class="nav-item">
                                                         ...
                                                         <span class="d-none d-sm-block">Pending Order <span class="badge rounded-pill bg-warning  float-end"> {{pending}} </span></span> 
                                                         </a>
                                                      </li>
                                                      ...
                                                      <!--   <span class="d-none d-sm-block">TL Approved Request Order <span class="badge rounded-pill bg-success  float-end"> {{request}} </span></span>   -->
                                                      <!--   </a>-->
                                                      <!--</li>-->

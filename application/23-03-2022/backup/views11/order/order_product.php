                                    ...
                                    <table id="datatable" class="table table-bordered dt-responsive  nowrap w-100" >
                                       ...
                                       <thead class="bg-primary text-white" ng-if="namecate.categories_id==1">
                                          ...
                                          <tr>
                                             ...
                                             <th class="table-width-6" ng-if="namecate.labletype==1" style="padding-bottom:0px" data-priority="3" ng-click='sortColumn("nos_tab")' ng-class='sortClass("nos_tab")'>Nos <i class="fa fa-sort" aria-hidden="true"></i></th>
                                        ...
                                        <thead class="bg-primary text-white" ng-if="namecate.categories_id!=1">
                                          ...
                                          <tr>
                                             ...
                                             <th class="table-width-6" data-priority="3" style="padding-bottom:0px" ng-click='sortColumn("profile_tab")' ng-class='sortClass("profile_tab")'>Profile <i class="fa fa-sort" aria-hidden="true"></i></th>
                                             <th class="table-width-6" data-priority="1" style="padding-bottom:0px" ng-click='sortColumn("crimp_tab")' ng-class='sortClass("crimp_tab")'>Crimp <i class="fa fa-sort" aria-hidden="true"></i></th>
                                             <th class="table-width-6" data-priority="3" rowspan="2" ng-click='sortColumn("nos_tab")' ng-class='sortClass("nos_tab")'>Nos <i class="fa fa-sort" aria-hidden="true"></i></th>
                                       ...
                                       <tbody  ng-repeat="name in namesData|orderBy:column:reverse" ng-if="namecate.categories_id==1">
                                          ...
                                          <tr  class="view" ng-if="namecate.categories_id==name.categories_id_get && namecate.type==name.type">
                                             <th>{{name.no}}   <span class="td-info-icons" ng-if="name.same==1"><i class="mdi mdi-chevron-down" ng-click="similarenq(name.product_id,name.product_name_tab,namecate.categories_id)"></i></span>   </th>
                                       ...
                                       <tbody  ng-repeat="name in namesData|orderBy:column:reverse" ng-if="namecate.categories_id!=1">
                                          ...
                                          <tr  class="view" ng-if="namecate.categories_id==name.categories_id_get">
                                             ...
                                             <td><input type="text" <?php echo $read; ?> ng-keyup="inputsave_1(name.id,'profile',namecate.categories_id,namecate.type)"  id="profile_{{name.id}}" value="{{name.profile_tab}}"></td>
                                             <td><input type="text" <?php echo $read; ?>   ng-keyup="inputsave_1(name.id,'crimp',namecate.categories_id,namecate.type)" id="crimp_{{name.id}}" value="{{name.crimp_tab}}"></td>

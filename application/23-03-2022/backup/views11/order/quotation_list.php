                                                ...
                                                <div class="flex-shrink-0">
                                                   <ul class="nav justify-content-end nav-tabs-custom rounded card-header-tabs" role="tablist" ng-init="getcount('orders_quotation')">
                                                      ...
                                                      <li class="nav-item">
                                                         ...
                                                         <span class="d-none d-sm-block">Pending Quotation <span class="badge rounded-pill bg-warning  float-end"> {{pending}} </span></span> 
                                                         </a>
                                                      </li>
                                              ...
                                              <div class="col-12">
                                                  <div class="card shadow-none">
                                                      <div class="card-body">
                                                          ...
                                                          <div class="table-responsive" ng-init="fetchData('orders_quotation',0)">
...
$scope.deleteData = function(id){
    if(confirm("Are you sure you want to remove it?"))
    {
      $http({
        ...
        $scope.success = false;
        $scope.error = false;
        $scope.fetchData('orders_quotation','0');
      }); 
    }
};

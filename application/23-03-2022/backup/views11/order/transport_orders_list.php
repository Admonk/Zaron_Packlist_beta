                  ...
                  <div class="col-md-2">
                     <div class="route-sidebar w-100" style="min-width: unset;">  
                           ...
                           <ul class="list-unstyled chat-list" ng-init="fetchRoute()" >
                                ...
                                <li  ng-repeat="names in namesRoute"  ng-class="{active : activeMenur === names.name}">
                                    <a href="#" ng-click="routeOrder(names.id,names.name)">
                     ...
                     <div class="tripset-sidebar w-100 ms-1" style="min-width: unset;">  
                        <div class="row">
                           ...
                           <ul class="list-unstyled chat-list" ng-init="fetchRouteorder('orders_process',2,0)">
                                ...
                                <li ng-repeat="names in namesData"  >
                                        ...
                                        <div class="d-flex align-items-start">
                                            ...
                                            <div class="flex-grow-overflow-hidden" >
                                                ...
                                                <small class="text-truncate mb-0">Route Name: {{names.route_names_val}}</small>
                      ...
                      <div class="tripset-sidebar w-100 ms-1" style="min-width: unset;background: #ffeee6;">  
                           <div class="px-3">
                              <h5 class="font-size-14 mb-3">Vehicles <button type="button" id="onview" class="btn btn-soft-info btn-sm waves-effect waves-light" style="float: right;">Change</button></h5>
                                ...
                                <li  ng-repeat="namesvehicle in namesDatavehicle">
                                        ...
                                        <div class="d-flex align-items-start">
                                            ...
                                            <div class="flex-grow-overflow-hidden" >
                                                ...
                                                <small class="text-truncate mb-0">Route Name: {{namesvehicle.route_name}}</small>
                  ...
                  <div class="col-md-5">
                     <div class="active-order-sidebar h-100">
                        <div class="row">
                           <div class="col-md-12">
                              <div class="px-3">
                                 <h5 class="font-size-14 mb-3">{{statuslable}}</h5>
                              </div>
                               <div class="px-3" style="float: right;margin: -40px 0px;">
                                <div class="btn-group">
                        ...
                        <div class="row">
                           <div class="col-12">
                              <div class="active-trip-tracking p-3" ng-init="fetchRouteorderassignorder('orders_process',3,0,1)">
                                    ...
                                    <div class="card" ng-repeat="names in namesDataassign">
                                          <div class="card-body">
                                             ...
                                             <p class="text-muted float-end"><b>Date : {{names.create_date}}</b> </p>
...
app.controller('crudController', function($scope, $http){
  ...
  $scope.fetchRouteorder = function(tabelename,status,id){
    ...
    $http.get('<?php echo base_url() ?>index.php/order/fetch_data_table_transpot_assign_data?tablename='+tabelename+'&order_base='+status+'&route_id='+id+'&assaignstates='+assaignstates).success(function(data){

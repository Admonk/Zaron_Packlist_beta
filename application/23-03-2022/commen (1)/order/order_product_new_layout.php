                    ...
                    <div class="search-info mb-1 border-bottom" >
                        <div class="row">
                               <div class="col-lg-12 col-md-12">
                                  <!--<h5 class="customTableHeading ng-binding" style="">Select Base Product</h5>-->
                                                                  ...
                                                                  <div class="row">
                                                                       <div class="col-lg-4 col-md-4">
                                                                            ...
                                                                            <span ng-init="fetchDatasizeoptions()" class="set-padding showhide" >
                                                                               ...
                                                                               <div class="row ng-scope" ng-repeat="nameoption in namesDataoptons">  
                                                                                ...
                                                                                <div class="col-lg-6 row">
                                                                                    ...
                                                                                    <div class="col-lg-1">
                                                                                      <div class="form-group">
                                                                                        ...
                                                                                        <div>
                                                                                              ...
                                                                                              <!-- ngIf: nameoption.checkstatus==1 -->
                                                                                            
                                                                                              <!-- ngIf: nameoption.checkstatus==0 --><span ng-if="nameoption.checkstatus==0" class="ng-scope">
                                                                                                           
                                                                                                                  <input type="radio" class="label_option_id" name="idset" value="4">
                                                                                             </span><!-- end ngIf: nameoption.checkstatus==0 -->
                                                                                    ...
                                                                                    <div class="col-lg-1">
                                                                                      <div class="form-group ">
                                                                                        ...
                                                                                        <div class="" style="text-align: center;">
                                                                                           <b class="baseProfile ng-binding">100</b>
                                                                                        </div>
                                                                                      </div>
                                                                                    </div>
                                                                                    ...
                                                                                    <div class="col-lg-1">
                                                                                      <div class="form-group ">
                                                                                        ...
                                                                                        <div class="" style="text-align: center;">
                                                                                         <b class="ng-binding">4</b>
                                                                                         <input type="hidden" name="base_id" id="base_id" value="3">
                                                                                        </div>
                                                                                      </div>
                                                                                    </div>
                                          ...
                                          <tr  ng-style="name.stock == 0 && {'color':'red'}"    class="view" ng-if="namecate.categories_id==name.categories_id_get && namecate.type==name.type">
                                            ...
                                            <?php
                                             ...
                                             <td data-label="Action" class="last-colorchange">
                                                ...
                                                data-bs-toggle="offcanvas" style="cursor: pointer;" data-bs-target="#offcanvasSpec" ng-click="sizedefind(name.id,name.product_id,namecate.categories_id,name.profile_tab,name.base_id)" ng-if="name.cate_status==1" aria-controls="offcanvasSpec" title="Add On Size"></i>
                                    ...
                                    <div class="d-inline pe-1 pe-md-3 pe-lg-5 pe-sm-1">
                                        <div class="d-flex align-items-center">
                                            <div class="flex-grow-1">
                                                ...
                                                <h5 class="mb-2">
                                                  <input type="text" value="{{discountfulltotal}}" class="form-control" ng-keyup="saveRoundoff($event)">
                                                </h5>
                                            </div>
                                        </div>
                                    </div>
                                                                   ...
                                                                   <div class="flex-shrink">
                                                                       <lable>Select Reason</lable>
                                                                        <div class="col-sm-12 reasonSelectBox">
                                                                         <select class="form-control reasonset" ng-change="saveReason()" id="reasonval" name="reason"  ng-model="reason">
                          ...
                          <div class="form-group row">
                            ...
                            <div class="col-sm-12">
                                  ...
                                  <span ng-if="nameoption.checkstatus==1">
                                                      ...
                                                      <input type="radio" class="label_option_id" checked name="idset" value="{{nameoption.id}}">
                                 </span>
                                
                                  <span ng-if="nameoption.checkstatus==0">
                                               
                                                      <input type="radio" class="label_option_id" name="idset" value="{{nameoption.id}}">
                                 </span>
...
<div class="modal fade bs-example-modal-xl-arch"  id="imagesizemodelarch" tabindex="-1" role="dialog" aria-labelledby="myExtraLargeModalLabel" aria-hidden="true">
 ...
 <input type="text" alt="text-1" class="inputtext" placeholder="No4">
  ...
  <input type="text" alt="text-1" class="inputtext" placeholder="No5"></div>
  <div class="centered">
                                                    ...
                                                    <div class="modal-dialog modal-xl">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-footer">
                                                                    ...
                                                                    <div class="col-md-12 showhide" ng-init="fetchDatasizebase()" >
                               
                                                                                    <label><b>Layout Plan :</b> </label>
                                                                                   <span ng-repeat="nameoptionbase in namesDataoptonsbase" class="btn btn-soft-primary btn-sm" id="baseiddd_{{nameoptionbase.base_id}}" ng-click="sizedefindbylayout(nameoptionbase.base_id)"> {{nameoptionbase.name}}</span>
...
$scope.imgresult = '';
 ...
 $scope.sizedefindbylayout = function(base_id)
 {

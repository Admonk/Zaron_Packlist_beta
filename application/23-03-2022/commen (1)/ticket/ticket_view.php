                            ...
                            <div class="col-12">
                                ...
                                <div class="email-leftbar card">
                                    ...
                                    <div class="mail-list mt-4">
                                        <a href="<?php echo base_url(); ?>index.php/ticket/inbox" ><i class="mdi mdi-email-outline me-2"></i> Inbox <span class="ms-1 float-end">(18)</span></a>
                                ...
                                <div class="email-rightbar mb-3">
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body" ng-init="fetchData()">
                                            ...
                                            <input type="checkbox" id="chk10" class="chaeckboxset" style="display:none;" checked value="{{name.id}}">
                   ...
                   <div class="check{{name.reply}}">
                      ...
                      <p class="pull-right" style="float: right;"><b>Date :</b> {{name.create_date}} </p>
                                            ...
                                            <div class="d-flex align-items-center mb-4">
                                                ...
                                                <div class="flex-grow-1">
                                                    <h5 class="font-size-14 mb-0">{{name.reply_set}} : {{name.user}} </h5>
                                                    <small class="text-muted">{{name.phone}}</small>
                                                    </div>
                                               </div>
                                               
                                               <textarea class="form-control viewmsg" disabled   rows="12">{{name.message}} </textarea>
                                 
                                              
                                               

                                           <div class="row" ng-init="attachmentsub(name.id)">

                   ...
                   <table id="datatable" class="table table-bordered dt-responsive  nowrap w-100"  ng-init="fetchDatagetlegderGroup('ALL','ALL',formdate,todate,'ALL')" >
                      <thead>
                        ...
                        <tr  class="trpoint" >
                           ...
                           <td><b>{{names.no}}</b></td>
                           <td><b>{{names.create_date}}</b> </td>
                           <td><b>{{names.order_no}}</b></td>
                           <td></td>
                           <td><b>{{names.total}}</b></td>
                           <td><b>{{names.status}}</b></td>
                            
                        </tr>
                        
                        
                        <tr ng-repeat="namesval in names.resultsub">
                           
                           <td></td>
                           <td>{{namesval.categories_name}}</td>
                           <td>{{namesval.product_name}}</td>
                           <td>{{namesval.qty}}</td>
                           <td>{{namesval.totalamount}}</td>
                           <td></td>

...
<div class="alert alert-danger alert-dismissible fade show" role="alert" ng-show="error">
 ...
 <tr><td>Total Amount </td><td><span  ><input type="number" id="fulltotal" data-value="{{totalamount}}"  readonly style="width: 80px;"></span></td></tr>
    ...
    if(paymentmode!='')
    {
     ...
     var reference_no= $('#reference_no').val();
      ...
      if(paymentmode!='Cash')
      {
                        ...
                        data:{'c50_rs':c50_rs,'otp':otp,'c100_rs':c100_rs,'c200_rs':c200_rs,'c500_rs':c500_rs,'c2000_rs':c2000_rs,'reference_no':reference_no,'paymentmode':paymentmode,'order_id':'<?php echo $id; ?>'}
                        }).success(function(data){
...
$(document).ready(function(){
  ...
  $('#50_rs').on('input',function(){
     ...
     var  amount_data= parseInt(c50_total)+ parseInt(c100_total)+ parseInt(c200_total)+parseInt(c500_total)+parseInt(c2000_total);

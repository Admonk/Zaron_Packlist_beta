                     ...
                     <div class="col-9">
                        ...
                        <div class="customer-bill-info mb-1">
                           <div class="row">
                              ...
                              <div class="col-4" ng-init="fetchCustomerorderdata()">
                                        ...
                                        <thead class="bg-gray text-red" ng-if="namecate.categories_id!=1">
                                          ...
                                          <tr>
                                             ...
                                             <th class="table-width-18" ng-if="namecate.labletype==4" rowspan="2" data-priority="1" ng-click='sortColumn("product_name_tab")' ng-class='sortClass("product_name_tab")'>Tile Material <i class="fa fa-sort" aria-hidden="true"></i></th>
                                              ...
                                              <th class="table-width-8" ng-if="namecate.labletype==8" data-priority="3" style="padding-bottom:0px" ng-click='sortColumn("crimp_tab")' ng-class='sortClass("crimp_tab")'>Extra {{namecate.lable}} <i class="fa fa-sort" aria-hidden="true"></i></th>
                                              <th class="table-width-8" ng-if="namecate.labletype==8" data-priority="3" style="padding-bottom:0px" ng-click='sortColumn("back_crimp_tab")' ng-class='sortClass("back_crimp_tab")'>Back {{namecate.lable}} <i class="fa fa-sort" aria-hidden="true"></i></th>
                                          ...
                                          <tr  ng-style="name.stock == 0 && {'color':'red'}"   class="view" ng-if="namecate.categories_id==name.categories_id_get && namecate.type==name.type">
                                             <th>{{name.no}}   <span class="td-info-icons" ng-if="name.same==1"><i class="mdi mdi-chevron-down" style="font-size: 18px;font-weight: 800;color: #ee5c17;" ng-click="similarenq(name.product_id,name.product_name_tab,namecate.categories_id)"></i></span>   </th>
                                                 ...
                                                 <input type="text" <?php echo $read; ?>  ng-keyup="completeProduct2(name.id)"  ng-blur="inputsave_1(name.id,'product_name',namecate.categories_id,namecate.type)"   id="product_name_{{name.id}}" value="{{name.product_name_tab}}">
                                                       ...
                                                       <span class="td-info-icons td-competitor-price" title="Current Stock">
                                       ...
                                       <tbody  ng-repeat="name in namesData|orderBy:column:reverse" ng-if="namecate.categories_id!=1">
                                          ...
                                          <tr  ng-style="name.stock == 0 && {'color':'red'}" class="view" ng-if="namecate.categories_id==name.categories_id_get">
                                            ...
                                            <td  data-priority="3">
                                             ...
                                             <td ng-if="namecate.labletype==8"><input type="text" <?php echo $read; ?>  ng-keyup="inputsave_1(name.id,'crimp',namecate.categories_id,namecate.type)"  id="crimp_{{name.id}}"  value="{{name.crimp_tab}}"></td>

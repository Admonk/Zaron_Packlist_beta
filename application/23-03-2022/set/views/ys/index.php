                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    <h4 class="mb-sm-0 font-size-18">YS Form</h4>

                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                               <li class="breadcrumb-item"><a href="<?php echo base_url(); ?>index.php/dashboard">Dashboard</a></li>
                                            <li class="breadcrumb-item active"> YS Form</li>
                                        </ol>
                                    </div>
 ...
 <div class="row">
                         ...
                         <div class="col-md-6">
                          <div class="form-group row">
                            <label class="col-sm-5 col-form-label">YS name</label>
                            <div class="col-sm-7">
...
<hr></hr>
<h4 class="mb-sm-0 font-size-18">YS List</h4>      
<br>
...
app.controller('crudController', function($scope, $http){
  ...
  $scope.fetchData = function(){
    $http.get('<?php echo base_url() ?>index.php/ys/fetch_data').success(function(data){
  ...
  $scope.submitForm = function(){
    $http({
      method:"POST",
      url:"<?php echo base_url() ?>index.php/ys/insertandupdate",
      data:{'name':$scope.name,'id':$scope.hidden_id,'action':$scope.submit_button,'tablename':'ys'}
      ...
      if(data.error != '1')
      {
        ...
        $scope.name = "";
        $scope.hidden_id = "";
        $scope.successMessage = "YS name successfully "+$scope.submit_button;
        $scope.fetchData();
      }
...
$scope.fetchSingleData = function(id){
    $http({
      method:"POST",
      url:"<?php echo base_url() ?>index.php/ys/fetch_single_data",
      data:{'id':id, 'action':'fetch_single_data','tablename':'ys'}
    }).success(function(data){
...
$scope.deleteData = function(id){
    if(confirm("Are you sure you want to remove it?"))
    {
      $http({
        method:"POST",
        url:"<?php echo base_url() ?>index.php/ys/insertandupdate",
        data:{'id':id, 'action':'Delete','tablename':'ys'}
      }).success(function(data){
        $scope.success = false;
        $scope.error = false;
        $scope.fetchData();

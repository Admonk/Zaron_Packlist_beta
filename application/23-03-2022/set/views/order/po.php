...
//}
  ...
  $scope.fetchData = function(){
    ...
    $http.get('<?php echo base_url() ?>index.php/order/fetch_data_vendor?order_id=<?php echo $order_id; ?>&tablenamemain=<?php echo $tablename; ?>&tablename_sub=<?php echo $tablename_sub; ?>&convert=1').success(function(data){
...
$scope.fetchSingleDatatotal = function(){
    $http({
      method:"POST",
      url:"<?php echo base_url() ?>index.php/order/fetch_single_data_total_vendor?order_id=<?php echo $order_id; ?>",

...
class Salesteamsub extends CI_Controller {
	...
	public function sales_team_sub_add()
	{
									    ...
									    if(isset($this->session->userdata['logged_in']))
							            {
											 ...
											 $data['sales_head'] = $this->Main_model->where_names('admin_users','access','12');
                 ...
                 if($form_data->action=='Save')
                 {
                      ...
                      if($form_data->phone!='' && $form_data->name!='' && $form_data->sales_id!='' && $form_data->route!='' &&  $form_data->pin!='' &&  $form_data->sales_head!='')
                     {
			                     ...
			                     $data['sales_member_id']=$form_data->sales_head;
			                      ...
			                      $sales_head = $this->Main_model->where_names('admin_users','id',$form_data->sales_head);
			                     ...
			                     $data['name']=$form_data->name;
				                      ...
				                      else
				                      {
                                             ...
                                             $datas['define_saleshd_id']=$form_data->sales_head;
	...
	public function fetch_data()
	{
                 	 ...
                 	 foreach ($result as  $value) {
                        ...
                        $sales_head_name ='';
                        $sales_head = $this->Main_model->where_names('admin_users','id',$value->sales_member_id);

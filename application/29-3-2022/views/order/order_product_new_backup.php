                           ...
                           <div class="row">
                                 ...
                                 <div class="d-flex inlineFlexBox">
                                  ...
                                  <div class="d-inline col-3 pe-2 ps-2 border-end" ng-init="fetchCustomerorderdata()">
                                    ...
                                    <p style="color:red;font-size:11px;margin-bottom: 0;">After selecting the customer, press 'Enter'</p>
                                  ...
                                  <div class="d-inline col-4 ps-2" ng-init="fetchCustomerorderdata()">
                                        ...
                                        <p style="color:red;font-size:11px;margin-bottom: 0;">Click on 3 dots to change the address or add new address</p>
                                      <div class="dropdown float-end">
                                    ...
                                    <table id="datatable" class="table table-bordered dt-responsive  nowrap w-100 salestable" >
                                        ...
                                        <thead class="bg-gray text-red" ng-if="namecate.categories_id!=1">
                                          ...
                                          <tr>
                                             ...
                                             <th class="table-width-18" ng-if="namecate.labletype==4" rowspan="2" data-priority="1" ng-click='sortColumn("product_name_tab")' ng-class='sortClass("product_name_tab")'>Tile Material <i class="fa fa-sort" aria-hidden="true"></i></th>
                                              ...
                                              <th class="table-width-8" ng-if="namecate.labletype==11" >Dim 1</th>
                                              <th class="table-width-8" ng-if="namecate.labletype==11" >Dim 2</th>
                                             
                                             
                                             
                                              <th class="table-width-8" data-priority="3" ng-if="namecate.labletype!=9" style="padding-bottom:0px" ng-click='sortColumn("profile_tab")' ng-class='sortClass("profile_tab")'>{{namecate.lable}} <i class="fa fa-sort" aria-hidden="true"></i></th>
                                              ...
                                              <th class="table-width-8" ng-if="namecate.labletype==11" data-priority="1" style="padding-bottom:0px" ng-click='sortColumn("crimp_tab")' ng-class='sortClass("crimp_tab")'>{{namecate.lable2}} <i class="fa fa-sort" aria-hidden="true"></i></th>
                                             
                                              <th class="table-width-8" ng-if="namecate.labletype==1 || namecate.labletype==6" data-priority="1" style="padding-bottom:0px" ng-click='sortColumn("crimp_tab")' ng-class='sortClass("crimp_tab")'>Crimp <i class="fa fa-sort" aria-hidden="true"></i></th>
                                              <th class="table-width-6" ng-if="namecate.labletype==1  || namecate.labletype==9 || namecate.labletype==4 || namecate.labletype==8 || namecate.labletype==5 || namecate.labletype==6 || namecate.labletype==7 || namecate.labletype==10 || namecate.labletype==11" data-priority="3" rowspan="2" ng-click='sortColumn("nos_tab")' ng-class='sortClass("nos_tab")'>Nos <i class="fa fa-sort" aria-hidden="true"></i></th>
                                       ...
                                       <tbody  ng-repeat="name in namesData|orderBy:column:reverse" ng-if="namecate.categories_id!=1">
                                          ...
                                          <tr  ng-style="name.stock == 0 && {'color':'red'}" class="view" ng-if="namecate.categories_id==name.categories_id_get">
                                            ...
                                            <td  data-priority="3" ng-if="namecate.labletype!=9" data-label="UOM">
                                             ...
                                             <td ng-if="namecate.labletype==11" data-label="Dim One"><input type="text" <?php echo $read; ?>  ng-keyup="inputsave_1(name.id,'dim_one',namecate.categories_id,namecate.type)"  id="dim_one_{{name.id}}" data-title="{{name.cul}}" value="{{name.dim_one}}"></td>
                                          <td ng-if="namecate.labletype==11" data-label="Dim Two"><input type="text" <?php echo $read; ?>  ng-keyup="inputsave_1(name.id,'dim_two',namecate.categories_id,namecate.type)"  id="dim_two_{{name.id}}" data-title="{{name.cul}}" value="{{name.dim_two}}"></td>
                                             ...
                                             <td ng-if="namecate.labletype==8" style="display:none;" data-label="{{namecate.lable}}">
                                             ...
                                             <td ng-if="namecate.labletype==1 || namecate.labletype==6 || namecate.labletype==11" data-label="{{namecate.lable}}"><input type="text" <?php echo $read; ?>  ng-keyup="inputsave_1(name.id,'crimp',namecate.categories_id,namecate.type)" id="crimp_{{name.id}}" value="{{name.crimp_tab}}"></td>
                                       ...
                                       <tfoot ng-if="namecate.categories_id!=1">
                                           <tr >
                                             ...
                                             <td class="table-width-6 hidmob" ng-if="namecate.labletype==11"></td>
                                             <td class="table-width-6 hidmob" ng-if="namecate.labletype==11"></td>
                                             
                                             
                                             
                                             <td class="table-width-6 hidmob" ng-if="namecate.labletype==6 || namecate.labletype==11"> </td> 
                            ...
                            <div class="row">
                              <div class="col-lg-6 col-md-6 col-sm-12 col-12 d-flex floaterOptionLeft" >
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-12 col-12 d-flex floaterOptionLeft">
                                    ...
                                    <div class="col-md-3" ng-if="reason==5">
                                        <div class="d-flex align-items-center">
                                                
                                               
                                                <span >  <br> <br><a href="#" ng-click="showCompetitor()">Competitor View</a> </span>
                                                    ...
                                                    <div class="modal-dialog modal-xl">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-footer">
                                                                    ...
                                                                    <div class="col-md-10 showhide" ng-init="fetchDatasizebase()" >
...
<div class="modal fade bs-example-modal-xl-seq" id="imagesizemodel-delivery-setup" tabindex="-1" role="dialog" aria-labelledby="myExtraLargeModalLabel" aria-hidden="true">
                                                    <div class="modal-dialog modal-xl">
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                                <h5 class="modal-title" id="myExtraLargeModalLabel">Order Confirmation</h5>
                                                                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                                            </div>
                                                            <div class="modal-body">
...
$scope.inputsavecal_1 = function (id,uom,inputname,categories_id,type) {
                         ...
                         $http({
                          method:"POST",
                          url:"<?php echo base_url() ?>index.php/order/insertandupdate?order_id=<?php echo $order_id; ?>",
                          data:{'profile':profile,'crimp':crimp,'dim_one':dim_one,'dim_two':dim_two,'values':values,'id':id,'action':'actioncalculation','tablenamemain':'<?php echo $tablename; ?>','tablename_sub':'<?php echo $tablename_sub; ?>'}
                         }).success(function(data){

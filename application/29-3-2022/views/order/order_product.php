...
<body data-layout="horizontal" class="full-vh-overflow-hide" data-topbar="dark" ng-app="crudApp" ng-controller="crudController">
   ...
   <div id="layout-wrapper">
                                 ...
                                 <div class="d-flex inlineFlexBox">
                                  ...
                                  <div class="d-inline col-4 ps-2" >
                                      ...
                                      <div class="dropdown float-end">
                                         ...
                                         <span ng-if="delivery_address" class="text-muted d-block font-size-10"> <i class="mdi mdi-truck-delivery font-size-10 pe-1" ng-if="delivery_address"></i>&nbsp;&nbsp;&nbsp {{delivery_address}} 
                                        </span>
                                          ...
                                          <span ng-if="locality_name" class="text-muted d-block font-size-10 mt-1 mb-1"><i class="fa fa-map" aria-hidden="true"></i> &nbsp;&nbsp;&nbsp;<b>  Locality : </b> {{locality_name}} </span> 
                              ...
                              <div class="d-inline pe-1 pe-md-3 pe-sm-1">
                                 <div class="d-flex align-items-center">
                                    <div class="flex-grow-1">
                                       <input type="text" ng-model="discount" placeholder="Discount" class="form-control" id="saveDiscount" ng-keyup="saveDiscount($event)" style="
                                          padding: 5px 5px;" >
                                    </div>
                                 </div>
                              </div>
         ...
         <div class="d-inline pe-1 pe-md-3 pe-sm-1">
            <div class="d-flex align-items-center">
               <div class="flex-grow-1" style="
                  ...
                  margin-top: 8px;
                  ">
                  <span class="text-muted lh-1 d-block pe-lg-1" style="
                     margin: auto;
                     "> Discount : </span>
         ...
         <div class="d-inline pe-1">
            <div class="d-flex align-items-center">
               <div class="flex-grow-1">
                   <p>Round Off : <input type="text"  value="{{minisroundoff}}"  class="roundoff" id="roundoff" ng-keyup="saveRoundoff($event)" >
         ...
         <div class="d-inline pe-1 pe-md-3 pe-sm-1">
            <div class="d-flex align-items-center">
               <div class="flex-grow-1" style="
                  ...
                  margin-top: 8px;
                  ">
                  <span class="text-muted lh-1 pe-lg-3 d-block text-truncate" style="
                     /* vertical-align: middle; */
                     margin: auto;
                     ">Total Items : </span>
                  <h5 class="text-primary ng-binding" style="
                     margin: auto;
                     ">
                    {{totalitems}}
                  </h5>
         ...
         <div class="d-inline pe-1">
            <div class="d-flex align-items-center">
               <div class="flex-grow-1" style="
                  margin-top: 8px;
                  ">
                  <h6 class="ng-binding" style="
                     padding-bottom: 0px !important;
                     margin-bottom: 0px !important;
                     "> Total: {{discountfulltotal}} </h6>
               </div>
            </div>
         </div>
      </div>
                                      ...
                                      ?>
                                        ...
                                        <div class="d-inline">
                                           ...
                                           <div class="form-check" ng-init="fetchCustomerorderdata()">
                                                       ...
                                                       <h5 class="font-size-12 mb-3" style="cursor: pointer;" ng-click="checkValRequiesttl()"><i class="mdi mdi-arrow-right text-primary me-1"></i> Delivery View / Modify</h5>

                    ...
                    <form id="pristine-valid-common" ng-submit="submitForm()" method="post" enctype="multipart/form-data">
                       ...
                       <div class="row">
                         ...
                         <div class="col-md-2">
                          ...
                          <div class="col-md-2">
                          <div class="form-group row">
                              <label class="col-sm-12 col-form-label">YS</label>
                            <div class="col-sm-12">
  ...
  $scope.submitForm = function(){
    ...
    $http({
      ...
      data:{
          ...
          'point':lab_point,'type':$scope.type,'link_to_purchase':$scope.link_to_purchase,'color':$scope.color,'ys':$scope.ys,'gsm':$scope.gsm,'thickness':$scope.thickness,'formula':$scope.formula,'description':$scope.description,'side_label':$scope.side_label,'input_label':$scope.input_label,'source_name':$scope.source_name,'price':price,'brand':$scope.brand,'uom':$scope.uom,'HSN_SAC':$scope.HSN_SAC,'categories':$scope.categories,'id':$scope.hidden_id,'action':$scope.submit_button,'tablename':'product_list'}
    }).success(function(data){

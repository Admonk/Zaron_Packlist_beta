                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    <h4 class="mb-sm-0 font-size-18">Legder  Edit</h4>

                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            <li class="breadcrumb-item"><a href="<?php echo base_url(); ?>index.php/customer/customer_list">Legder list</a></li>
                                            <li class="breadcrumb-item active"> Legder Forms Edit</li>
                                        </ol>
                                    </div>
                       ...
                       <div class="row">
                            ...
                            <div class="col-md-3" >
                                                 ...
                                                 <div class="form-group row">
                                                         ...
                                                         <label class="col-sm-12 col-form-label">Group <span style="color:red;">*</span></label>
                                                         <div class="col-sm-12">
                        ...
                        <div class="col-md-3">
                          <div class="form-group row">
                            <label class="col-sm-12 col-form-label">Address<span style="color:red;">*</span></label>
                            <div class="col-sm-12">

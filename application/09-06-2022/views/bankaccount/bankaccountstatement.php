                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    <h4 class="mb-sm-0 font-size-18">Bank Accounts & Transactions </h4>
...
<div class="row my-5">
                            <div class="col-xl-12">
                                <div class="text-center">
                                    <h4 class="card-title font-size-18">{{bank_name}}</h4>
...
<button type="button" ng-click="onviewparty()"  class="btn btn-soft-danger  waves-effect waves-light" style="float: right;margin: 0px 12px;">Bank to Bank Transfer</button>
                 ...
                 <p ng-init="getvalOpeingBalance()"><b> Opening Balance  {{ fromdateset | date : "dd-MM-yyyy"}}
 :
                                    ...
                                    <div class="card-body">
                                        <div class="d-flex align-items-center">
                                            <div class="flex-grow-1">
                                                ...
                                                <h4 class="mb-3">
                                                     <span class="ng-binding">{{amounttotaldebits | number}}</span>
                                                </h4>
                                    ...
                                    <div class="card-body">
                                        <div class="d-flex align-items-center">
                                            <div class="flex-grow-1">
                                                ...
                                                <h4 class="mb-3">
                                                     <span class="ng-binding">{{amounttotalcredits | number}}</span>
                                                </h4>
                                        ...
                                        <div class="d-flex align-items-center">
                                            <div class="flex-grow-1">
                                                ...
                                                <h4 class="mb-3">
                                                  ...
                                                  <span ng-if="totalbalance>=0" style="color:green" class="ng-binding ng-scope">{{totalbalance | number}}</span>
                                                    <span ng-if="totalbalance<0" style="color:red" class="ng-binding ng-scope">{{totalbalance | number}}</span>
 ...
 $scope.fetchDatadetails = function(id,fromdate,fromto){
    $http.get('<?php echo base_url() ?>index.php/bankaccount/fetch_data_details?account_id='+id+'&fromdate='+fromdate+'&fromto='+fromto).success(function(data){
     ...
     $scope.namesDatadetails = data;
                 ...
                 $scope.totalbalancec=data[0].totalbalancec;
                 $scope.totalbalanced=data[0].totalbalanced;

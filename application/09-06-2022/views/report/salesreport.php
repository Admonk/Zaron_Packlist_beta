...
$scope.fetchDatagetlegderGroup = function(cateid,productid,fromdate,fromto,order_status){
    ...
    $http.get('<?php echo base_url() ?>index.php/report/fetch_data_sales_report?limit=10&formdate='+fromdate+'&todate='+fromto+'&order_status='+order_status).success(function(data){

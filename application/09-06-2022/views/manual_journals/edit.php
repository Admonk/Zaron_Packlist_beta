                                ...
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    ...
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            ...
                                            <li class="breadcrumb-item"> Manual Journals Edit !</li>
                                        </ol>
                                    </div>
...
<form id="pristine-valid-example" novalidate method="post"></form>
                    ...
                    <form id="pristine-valid-common" ng-submit="submitForm()" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row" ng-init="fetchData()">
                              ...
                              <input id="party_type" type="hidden">
                             ...
                             <div class="form-group row">
                                  <label class="col-sm-2 col-form-label"><b>Ledger Account</b> <span style="color:red;">*</span> </label>
                                                         <div class="col-sm-4">
                                                              ...
                                                              foreach($partytype as $p)
                                                              {
                                                                 ...
                                                                 <span class="btn btn-soft-secondary  btn-sm onclick" data-id="<?php echo $p->id; ?>" id="set_<?php echo $p->id; ?>" ng-click="getUser('<?php echo $p->id; ?>')" style="cursor: pointer;" ><?php echo $p->name; ?></span> 
                              ...
                              <div class="col-md-12" >
                                                 ...
                                                 <div class="form-group row">
                                                         ...
                                                         <label class="col-sm-2 col-form-label"><b>Name</b> <span style="color:red;">*</span> </label>
                                                         <div class="col-sm-4">
  ...
  $scope.submitForm = function(){
    ...
    $http({
      ...
      data:{
          ...
          ?>
          'id':'<?php echo $id; ?>','bankaccount':bankaccount,'action':$scope.submit_button,'party_type':party_type,'get_users':$scope.get_users,'tablename':'manual_journals'}
         }).success(function(data){
  ...
  $scope.fetchData = function(){
    $http({
      ...
      data:{'id':<?php echo $id; ?>, 'action':'fetch_single_data','tablename':'manual_journals'}
                                  ...
                                  $('#set_'+data.party_type).addClass('active');

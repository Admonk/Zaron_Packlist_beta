                                                                  ...
                                                                  $res =$this->Main_model->where_names_three_order_by('all_ledgers','customer_id',$form_data->id,'party_type',5,'deleteid','0','id','ASC');    
                                                                      ...
                                                                      foreach($res as $val)
                                                                      {
                                                                         ...
                                                                         $balancetotal=str_replace('-','',$balancetotal);
                                                                              ...
                                                                              if($form_data->val=='1')
                                                                              {
                                                                                                             ...
                                                                                                             $data_driver['order_no']='Opening Balance';  
                                                                                                              ...
                                                                                                              else
                                                                                                              {
                                                                                                                   ...
                                                                                                                   //$this->db->query("UPDATE all_ledgers SET balance='0' WHERE customer_id='".$form_data->id."'");
                                                                              ...
                                                                              else
                                                                              {
                                                                                                             ...
                                                                                                             $data_driver['order_no']='Opening Balance'; 
                                                                                                              ...
                                                                                                              else
                                                                                                              {
                                                                                                                    ...
                                                                                                                    //$this->db->query("UPDATE all_ledgers SET balance='0' WHERE customer_id='".$form_data->id."' AND ");
                                                                                                                    //$data_driver['balance']=$balancetotal-$obalance;
                                                                                                                    $data_driver['balance']='-'.$obalance;
                                                                              ...
                                                                              if($form_data->val!='')
                                                                              {
                                                                                   $query = $this->db->query("SELECT id FROM `all_ledgers`  WHERE customer_id='".$form_data->id."' AND order_no='Opening Balance' AND party_type=5");
                                                                                   $resultsales_team=$query->result();
                                                                                   ...
                                                                                   else
                                                                                   {
                                                                                             ...
                                                                                             $this->Main_model->update_commen_where_three($data_driver,'customer_id','order_no','Opening Balance','party_type','5','all_ledgers');
                                                                              ...
                                                                              if($obalance==0)
                                                                              {
                                                                                    $this->db->query("DELETE FROM all_ledgers  WHERE customer_id='".$form_data->id."' AND order_no='Opening Balance' AND party_type=5");
                                                                              }

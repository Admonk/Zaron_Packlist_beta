...
$i=1;
		...
		public function fetch_data_get_ledger_view()
	{
                     ...
                     if($formdate=='undefined' || $formdate=='0')
                     {
                             ...
                             $result=$this->db->query("SELECT * FROM all_ledgers  WHERE  deleteid=0  AND party_type=2 AND `payment_date` BETWEEN '".$formdate."' AND '".$todate."' $sql ORDER BY id DESC");
                     ...
                     else
                     {
                          ...
                          {
                              $result=$this->db->query("SELECT * FROM all_ledgers  WHERE `payment_date` BETWEEN '".$formdate."' AND '".$todate."'  AND order_no!=''  AND deleteid=0 AND party_type=2 $sql   ORDER BY id DESC");
                 	          $resultsub=$this->db->query("SELECT * FROM all_ledgers  WHERE `payment_date` BETWEEN '".$formdate."' AND '".$todate."'  AND order_no=''  AND deleteid=0 AND party_type=2 $sql ORDER BY id DESC");
                 	     
                          }
                          else
                          {
                             $result=$this->db->query("SELECT * FROM all_ledgers  WHERE `payment_date` BETWEEN '".$formdate."' AND '".$todate."'  AND paid_status='".$payment_status."' AND order_no!='' AND deleteid=0 AND party_type=2 $sql ORDER BY id DESC");
                 	         $resultsub=$this->db->query("SELECT * FROM all_ledgers  WHERE `payment_date` BETWEEN '".$formdate."' AND '".$todate."'  AND paid_status='".$payment_status."' AND order_no='' AND deleteid=0 AND party_type=2 $sql ORDER BY id DESC");
      	...
      	public function fetch_data_get_ledger_view_export()
	{
                     ...
                     if($customer_id=='')
                     {
                           ...
                           $result=$this->db->query("SELECT * FROM all_ledgers  WHERE  deleteid=0 AND party_type=2 AND `payment_date` BETWEEN '".$formdate."' AND '".$todate."'  ORDER BY id DESC");
                 	       $result=$result->result();  

                                             ...
                                             <div class="card-header align-items-start d-flex p-3">
                                                <div class="flex-shrink-0">
                                                   <ul class="nav justify-content-end nav-tabs-custom rounded card-header-tabs" role="tablist" ng-init="getcount('orders_process')">
                                                      ...
                                                      <li class="nav-item">
                                                         <a class="nav-link active" data-bs-toggle="tab" href="#messages2" role="tab" ng-click="pageTab('orders_process',3,1)">
                                                         <span class="d-block d-sm-none"><i class="far fa-envelope"></i></span>
                                                         <span class="d-none d-sm-block">Assigned Drivers &nbsp;&nbsp;<span class="badge rounded-pill bg-success float-end"> {{transpot}} </span></span>   
                                                         </a>
                                                      </li>
                                              ...
                                              <div class="col-12">
                                                  <div class="card shadow-none">
                                                      <div class="card-body">
                                                          ...
                                                          <div class="table-responsive" ng-init="fetchData('orders_process',3,1)">
...
app.controller('crudController', function($scope, $http){
  ...
  $scope.fetchData = function(tabelename,status,assign){
    $http.get('<?php echo base_url() ?>index.php/order/fetch_data_table_trasport_base?tablename='+tabelename+'&order_base='+status+'&assign='+assign).success(function(data){
...
$scope.fetchData(tabelename,status,assign);

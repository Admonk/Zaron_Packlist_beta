 ...
 $scope.required = 0;
  ...
  $scope.submitForm = function(){
    $http({
      ...
      data:{'label_name':$scope.label_name,'type':$scope.type,'option':$scope.option,'sort_order_id':$scope.sort_order_id,'category_id':$scope.category_id,'required':$scope.required,'grouping':$scope.grouping,'id':$scope.hidden_id,'action':$scope.submit_button,'tablename':'additional_information'}

                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    <h4 class="mb-sm-0 font-size-18">Employee ledger</h4>
              ...
              <div class="col-lg-12">
                ...
                <div class="row">
                                    ...
                                    <div class="card-body">
                                        <div class="d-flex align-items-center">
                                            <div class="flex-grow-1">
                                                ...
                                                <h4 class="mb-3">
                                                    Rs. <span >{{totaldebit-totalcridit}}</span>
                                                </h4>
                  ...
                  <div id="search-view" >
                   ...
                   <table id="datatable" class="table table-bordered dt-responsive  nowrap w-100"  ng-init="fetchDatagetlegderGroup('<?php echo $customer_id; ?>')" >
                      <thead>
                        <tr>
                        ...
                        <tr  class="trpoint" >
                           ...
                           <td>{{names.no}}</td>
                         <td><a href="<?php echo base_url(); ?>index.php/employee/ledger_find?employee_id={{names.customer_id}}" target="_blank">{{names.name}}</a></td>
                                                ...
                                                <div class="modal-dialog modal-dialog-centered">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h5 class="modal-title" id="exampleModalToggleLabel">Payout To Employee</h5>
...
$('#exportdata').on('click', function() {
    ...
    url = '<?php echo base_url() ?>index.php/employee/fetch_data_get_ledger_view_export?limit=10&customer_id='+id+'&formdate='+fromdate+'&todate='+fromto+'&payment_status='+payment_status;
...
$scope.fetchSingleData = function(id){
    $http({
      method:"POST",
      url:"<?php echo base_url() ?>index.php/employee/fetch_single_data",
      data:{'id':id, 'action':'fetch_single_data','tablename':'admin_users'}
...
$scope.onview = function(id,billno,pendingamount){
 ...
 $scope.pointtodriver = function () {
           ...
           // {
                        ...
                        $http({
                        method:"POST",
                        url:"<?php echo base_url() ?>index.php/employee/save_to_pay",
                        data:{'enteramount':enteramount,'notes':notes,'bankaccount':bankaccount,'vendor_id':vendor_id,'payamount':payamount,'payment_mode_payoff':payment_mode_payoff,'reference_no':reference_no}
                        }).success(function(data){
...
$scope.fetchDatagetlegderGroup = function(id,fromdate,fromto,payment_status){
    ...
    $http.get('<?php echo base_url() ?>index.php/employee/fetch_data_get_ledger_view?limit=10&customer_id='+id+'&formdate='+fromdate+'&todate='+fromto+'&payment_status='+payment_status).success(function(data){
...
$scope.fetchDatagetlegderGroupTotal = function(id,fromdate,fromto,payment_status){
    ...
    $http.get('<?php echo base_url() ?>index.php/employee/fetch_data_get_ledger_view_total?limit=10&customer_id='+id+'&formdate='+fromdate+'&todate='+fromto+'&payment_status='+payment_status).success(function(data){

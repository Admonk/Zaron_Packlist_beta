                                        ...
                                        <ul class="message-list"  ng-init="fetchData_sent()">
                                            ...
                                            <li ng-repeat="name in namesData | filter:query" >
                                                <div class="col-mail col-mail-1 {{name.bgcolor}}" >
                                                    ...
                                                    <a href="<?php echo base_url(); ?>index.php/ticket/ticket_view/{{name.id}}/1" class="titlestatus">{{name.lable}} : {{name.username}}</a>
                                                </div>
                                                <div class="col-mail col-mail-2 {{name.bgcolor}}" >
                                                    <a href="<?php echo base_url(); ?>index.php/ticket/ticket_view/{{name.id}}/1" class="subject">

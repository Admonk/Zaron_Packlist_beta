...
<a href="<?php echo base_url(); ?>index.php/report_new/trial_balance_log_ex_return" class="btn btn-secondary">Ex-retrun</a>
          ...
          <a href="<?php echo base_url(); ?>index.php/report_new/trial_balance_log_discount" class="btn btn-primary">Discount</a>
              </div>
...
$scope.fetchDatagetlegderGroup = function(){
    ...
    $http.get('<?php echo base_url() ?>index.php/report_new/fetch_data_accounts_log_report_discount?type='+type+'&formdate='+fromdate+'&todate='+fromto).success(function(data){

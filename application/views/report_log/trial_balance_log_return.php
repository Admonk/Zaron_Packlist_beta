...
<body data-layout="horizontal" class="full-vh-overflow-hide" data-topbar="dark" ng-app="crudApp" ng-controller="crudController">
 ...
 <div class="main-content">
            ...
            <div class="col-md-8">
              ...
              <a href="<?php echo base_url(); ?>index.php/report_new/trial_balance_log_return" class="btn btn-primary">Sales Return</a>
...
$scope.fetchDatagetlegderGroup = function(){
    ...
    $http.get('<?php echo base_url() ?>index.php/report_new/fetch_data_accounts_log_report_return?type='+type+'&formdate='+fromdate+'&todate='+fromto).success(function(data){

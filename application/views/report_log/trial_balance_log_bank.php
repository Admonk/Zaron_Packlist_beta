...
<a href="<?php echo base_url(); ?>index.php/report_new/trial_balance_log_ex_return" class="btn btn-secondary">Ex-retrun</a>
                <a href="<?php echo base_url(); ?>index.php/report_new/trial_balance_log_bank_inter_transfer" class="btn btn-primary">Bank Internel Transfer</a>
...
$scope.fetchDatagetlegderGroup = function(){
    ...
    $http.get('<?php echo base_url() ?>index.php/report_new/fetch_data_accounts_log_report_bank?type='+type+'&formdate='+fromdate+'&todate='+fromto).success(function(data){

...
<head>
   ...
   <link rel="shortcut icon" href="<?php echo FAV_ICON; ?>" />
     ...
     <link href="<?php echo base_url(); ?>assets/libs/choices.js/public/assets/styles/choices.min.css" rel="stylesheet" type="text/css" />
        ...
        <link href="<?php echo base_url(); ?>assets/css/multiselect.css" rel="stylesheet" type="text/css"  />
        ...
        <link rel="stylesheet" href="<?php echo base_url(); ?>assets/libs/%40simonwep/pickr/themes/classic.min.css"/> <!-- 'classic' theme -->
        <link rel="stylesheet" href="<?php echo base_url(); ?>assets/libs/%40simonwep/pickr/themes/monolith.min.css"/> <!-- 'monolith' theme -->
        <link rel="stylesheet" href="<?php echo base_url(); ?>assets/libs/%40simonwep/pickr/themes/nano.min.css"/> <!-- 'nano' theme -->
        ...
        <script src="<?php echo base_url(); ?>assets/angular-datatables.min.js"></script>

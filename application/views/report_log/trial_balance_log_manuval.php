...
<div class="col-md-8">
              ...
              <a href="<?php echo base_url(); ?>index.php/report_new/trial_balance_log_manual_journal" class="btn btn-primary">Journal</a>
...
$scope.fetchDatagetlegderGroup = function(){
    ...
    $http.get('<?php echo base_url() ?>index.php/report_new/fetch_data_accounts_log_report_manuval?type='+type+'&formdate='+fromdate+'&todate='+fromto).success(function(data){

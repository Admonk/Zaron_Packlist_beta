 ...
 <div class="main-content">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    <h4 class="mb-sm-0 font-size-18"><?php $title; ?></h4>
              ...
              <div class="col-lg-12">
                ...
                <div class="row">
                  ...
                  <div class="col-md-8">
              <a href="<?php echo base_url(); ?>index.php/report_new/trial_balance_log_sales" class="btn btn-primary">Sales</a>
              ...
              <a href="<?php echo base_url(); ?>index.php/report/trial_balance_log_purchase" class="btn btn-secondary">Purchase</a>

              <a href="<?php echo base_url(); ?>index.php/report_new/trial_balance_log_commission" class="btn btn-secondary">Commission</a>
<a href="<?php echo base_url(); ?>index.php/report_new/trial_balance_log_ex_return" class="btn btn-secondary">Ex-retrun</a>
                   ...
                   <table id="datatable" class="table table-bordered dt-responsive  nowrap w-100"   >
                      <thead>
                        ...
                        <tbody  ng-repeat="names in namesDataledgergroup" >
                         ...
                         <tr  class="trpoint {{names.sstcolor}}">
                           <td>{{$index + 1}}</td>
                           <td style="width: 120px;">{{names.create_date}} </td>
                           <td style="width: 150px;"><a href="<?php echo base_url(); ?>index.php/order/ordercreate_product_process?order_id={{names.order_id}}" target="_blank">{{names.order_no}}</a></td>
                           <td>{{names.deletemod}}</td>
                           <td></td>
                        ...
                        <tr  class="trpoint {{namess.SS}}_color"  ng-repeat="namess in names.subarray">
                           ...
                           <td>{{namess.payment_mode}} | {{namess.deletemod}}</td>
...
$scope.fetchDatagetlegderGroup = function(){
    ...
    $http.get('<?php echo base_url() ?>index.php/report_new/fetch_data_accounts_log_report_sales?type='+type+'&formdate='+fromdate+'&todate='+fromto).success(function(data){

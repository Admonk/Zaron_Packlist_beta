...
<div class="modal fade bs-example-modal-center" id="re_date" tabindex="-1" role="dialog" aria-hidden="true">
                         ...
                         <div class="row">
                          ...
                          <div class="col-sm-3">
                          <label>From Date: </label><input type="date" min="<?php echo date('2023-10-01'); ?>" class="form-control" id="from_date" ng-model="from_date" ng-change="DateFilter()">
                          </div>
                          
                           <div class="col-sm-3">
                           <label>To Date:</label><input type="date" min="<?php echo date('2023-10-01'); ?>" class="form-control" id="to_date" ng-model="to_date" ng-change="DateFilter()">
                           </div>
                        ...
                        <div id="example_filter" class="dataTables_filter">
                            ...
                            <table class="table align-middle table-nowrap newBorderedTable" >
                                ...
                                <input type="textt" name="advance"  class="form-control" id="ad_{{name.id}}" data-mode="{{name.payment_mode}}" ng-blur="inputsave_1(name.id)" value="{{name.totalamount | indianCurrency}}">
                                                                       ...
                                                                       <!-- <td><a href="<?php echo base_url(); ?>index.php/order/ordercreate_product_process?order_id={{name.base_id}}">
                                                                        ...
                                                                        <td><a href="<?php echo base_url(); ?>index.php/order/ordercreate_product_process?order_id={{name.base_id}}">
                                                                          ...
                                                                          <!--  <a href="<?php echo base_url(); ?>index.php/order_second/pick_list_view?id={{name.id}}&confirmed=false&DC_id={{name.randam_id}}" target="_blank" ><i class="mdi mdi-plus font-size-16 text-success me-1"></i> Packlist </a> --> 
...
$scope.fetchDataRemainder = function()
 ...
 $scope.fetchsales3 = function()
 {
  ...
  $scope.inputsave_1= function(order_id) 
  {
  ...
  //$scope.to_date = new Date();
    ...
    function getData() {
     ...
     $http.get('<?php echo base_url() ?>index.php/order_check/fetch_data_table_delivery?page=' + $scope.currentPage + '&size=' + $scope.pageSize + '&search=' + $scope.searchText + '&tablename=' + $scope.tablename+'&order_base='+order_base+'&from_date='+from_date+'&to_date='+to_date)
        .success(function(data) {
            $scope.namesData = [];

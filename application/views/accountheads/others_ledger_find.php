                                             ...
                                             <div class="d-flex align-items-center">
                                                <div class="flex-grow-1">
                                                   <h3 class="text-muted mb-1 font-size-14 lh-1 d-block text-truncate">Opening Balance :
                                                      <span  ng-if="opstatus==1" style="color:red">{{opbalance | indianCurrency}}</span>
                                                      <span  ng-if="opstatus==0" style="color:green">{{opbalance | indianCurrency}}</span>
                                                   </h3>
                                       ...
                                       <table id="datatable"  class="table table-striped table-bordered" style="position: relative;" width="100%" ng-init="fetchDatagetlegderGroup('<?php echo $customer_id; ?>')" >
                                          <thead>
                                             <tr style="position: sticky;top: 0;background: #dfdfdf;">
                                                ...
                                                <th style="width:200px;">
                                                   <h5 class="font-size-12 mb-0"><?=isset($_GET['customer_id']) && ($_GET['customer_id'] == 605) ? 'Vendor Name' : 'C Name'?></h5>
                                                </th>
                                                <th style="width:100px;">
                                          ...
                                          <tbody  ng-repeat="names in namesDataledgergroup | filter:query" >
                                             <tr  class="trpoint {{names.addclass}} {{names.md_verification}}" ng-if="names.no!='#'">
                                                ...
                                                <!-- <td>{{names.cname}}</td> -->
                                                <td>{{names.dummy_customer_name}}</td>
  ...
  <div class="form-group row">
               ...
               <div class="form-group row">
                  <div class="some-class1">
                     ...
                     <input type="radio" class="radio" name="Payer_1" ng-model="party_type1" value="11" id="Common_1" />
                     <label for="Common_1">Common</label>
               ...
               <div class="form-group row">
                  <div class="some-class1">
                     ...
                     <label for="Customer_2">Customer</label>
                      ...
                      <input type="radio" class="radio" name="Payer_2" ng-model="party_type2" value="11" id="Common_2" />
                     <label for="Common_2">Common</label>
   ...
   <input type="hidden" name="PanCard" id="PanCard" value="">
   <script>
    ...
    function remove(id) {
      ...
      $(document).ready(function(){
           ...
           $('#from-date').blur(function() 
       {
          ...
          var valdationdate='<?php echo date("2023-07-01"); ?>';
      ...
      $('#exportdata').on('click', function() {
          ...
          url = '<?php echo base_url() ?>index.php/accountheads/fetch_data_get_ledger_view_export_new?limit=10&deleteid=0&customer_id='+id+'&formdate='+fromdate+'&todate='+fromto+'&payment_status='+payment_status+'&party_type='+party_type;
 ...
 $('#UpdateCommsision').show();
      ...
      $scope.fetchDatagetlegderGroup = function(id,fromdate,fromto,payment_status){
        ...
        var fromdate= $('#from-date').val();
          ...
          $http.get('<?php echo base_url() ?>index.php/accountheads/fetch_data_get_ledger_view_new?limit=10&deleteid=0&customer_id='+id+'&formdate='+fromdate+'&todate='+fromto+'&payment_status='+payment_status+'&party_type='+party_type).success(function(data){
      ...
      $scope.fetchDatagetlegderGroupTotal = function(id,fromdate,fromto,payment_status){
          ...
          var payment_status= $('#payment_status').val();
         $http.get('<?php echo base_url() ?>index.php/accountheads/fetch_data_get_ledger_view_total_new?limit=10&deleteid=0&customer_id='+id+'&formdate='+fromdate+'&todate='+fromto+'&payment_status='+payment_status+'&party_type='+party_type).success(function(data){
            ...
            data:{'id':l_id, 'action':'fetch_single_data','tablename':'all_ledgers'}
              ...
              if(data.md_verification=='0')
             {
                 ...
                 else
                 {
                     ...
                     $('.led_party_name').prop('disabled',false);
             ...
             else
             {
                 ...
                 $('.led_party_name').prop('disabled',true);
                 $('#remarks1').prop('disabled',true);
                 $('#remarks2').prop('disabled',true);
                 $('#remarks3').prop('disabled',true);
                 $('#remarks4').prop('disabled',true);
              ...
              if(data.md_verification=='0')
             {
              ...
              $scope.weight_check(l_id,sumtot,totalsumval);
      ...
      $scope.weight_check = function(l_id,sumtot,totalsumval)
      {

                  $http({
                  method:"POST",
                  url:"<?php echo base_url(); ?>index.php/order_check/check_kg_order",
                  data:{'id':l_id}
                         ...
                         {
                             $('#UpdateCommsision').hide();
                             $('#error').text('Weight Update Pending This order');
                             $('#remarks1').prop('disabled',true);
                             $('#remarks2').prop('disabled',true);
                             $('#remarks3').prop('disabled',true);
                             $('#remarks4').prop('disabled',true);
                 ...
                 {        
                           ...
                           {    
                             ...
                             if(bank_amount>0)
                            {
                               ...
                               {
                                  var required1=0;
                                  var res="PanCard Not Updated Please Check";
                               }
                            }

              ...
              <div class="col-lg-12">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12" >  
                      <form>
                          <div class="row">
                            ...
                            <div class="col">
                              <input type="date" class="form-control" id="from-date" min="<?php echo date('2024-04-01'); ?>" value="<?php echo date('2024-08-01'); ?>">
                            </div>
                            <div class="col">
                            ...
                            <div class="col" style="display:none;">
                             ...
                             <button type="button" id="exportdata" class="btn btn-success waves-effect waves-light"  >Export</button>
                                  ...
                                  <a href="<?php echo base_url(); ?>index.php/accountheads/others_ledger_find_delete_log" target="_blank"> Log</a>
                                    ...
                                    <div class="card-body">
                                        <div class="d-flex align-items-center">
                                            <div class="flex-grow-1">
                                                <h3 class="text-muted mb-1 font-size-14 lh-1 d-block text-truncate"> Debit: <span >{{totaldebit | indianCurrency}}</span></h3>
                                            </div>
                            ...
                            <div class="col-xl-4 col-md-4">
                                ...
                                <div class="card shadow-none card-h-50 mb-0">
                                    ...
                                    <div class="card-body">
                                        <div class="d-flex align-items-center">
                                            <div class="flex-grow-1">
                                                <h3 class="text-muted mb-1 font-size-14 lh-1 d-block text-truncate"> Credit: <span >{{totalcridit | indianCurrency}}</span></h3>
                                            </div>
                                             </div>
                                    </div><!-- end card body -->
                                </div><!-- end card -->
                                        ...
                                        <div class="d-flex align-items-center">
                                            <div class="flex-grow-1">
                                                <h3 class="text-muted mb-1 font-size-14 lh-1 d-block text-truncate">Balance 
                                                    <span  ng-if="getstatus==1" style="color:red"> {{outstanding | indianCurrency}}</span>
                                                    <span  ng-if="getstatus==0" style="color:green"> {{outstanding | indianCurrency}}</span>
                                                </h3>
                                            </div>
                                             </div>
                                    </div><!-- end card body -->
                  ...
                  <div id="search-view" >
                                     ...
                                     <div class="card-header text-start py-0"  ng-init="fetchSingleData(0)">
                   ...
                   <table id="datatable"  class="table table-striped table-bordered" style="position: relative;" width="100%" ng-init="fetchDatagetlegderGroup(0)" >
                      <thead>
                        ...
                        <tr  class="trpoint {{names.done_set}}" >
                           ...
                           <td>{{names.no}}</td>
                           <td><a href="<?php echo base_url(); ?>index.php/accountheads/others_ledger_find?customer_id={{names.customer_id}}" target="_blank">{{names.name}}</a></td>
                          
                          <td ><a href="<?php echo base_url(); ?>index.php/accountheads/others_ledger_find?customer_id={{names.customer_id}}" target="_blank"><span ng-if="names.opening_balance!=0">{{names.opening_balance | indianCurrency}} {{names.payment_status}}</span></a></td>
                          
                          <td ><a href="<?php echo base_url(); ?>index.php/accountheads/others_ledger_find?customer_id={{names.customer_id}}" target="_blank"><span ng-if="names.debits>0">{{names.debits | indianCurrency}}</span></a></td>
                           <td ><a href="<?php echo base_url(); ?>index.php/accountheads/others_ledger_find?customer_id={{names.customer_id}}" target="_blank"><span ng-if="names.credits>0">{{names.credits | indianCurrency}}</span></a></td>
                           <td >
                               
                                
                                 <a href="<?php echo base_url(); ?>index.php/accountheads/others_ledger_find?customer_id={{names.customer_id}}" target="_blank">  <span  ng-if="names.getstatus==1" style="color:red">{{names.balance | indianCurrency}}</span>
                                                ...
                                                <div class="modal-dialog modal-dialog-centered">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h5 class="modal-title" id="exampleModalToggleLabel">Payout To Others</h5>
                                          ...
                                          <label class="col-sm-12 col-form-label"><b>Ledger Account</b> <span style="color:red;">*</span> </label>
                                                              ...
                                                              <div class="form-group row">
                                                                ...
                                                                <div class="some-class">
                                                                    ...
                                                                    <input type="radio" class="radio" name="Payer1" checked value="5" id="Other" />
                                                              ...
                                                              <div class="form-group row">
                                                                ...
                                                                <div class="some-class">
                                                                    ...
                                                                    <label for="Driver2">Driver</label>
                                                                     <input type="radio" class="radio" name="Payer2"  checked value="5" id="Other2" />
                                                              ...
                                                              <div class="show2" style="display:none;">
                                                                ...
                                                                <div class="some-class">
                                                                    ...
                                                                    <label for="Driver3">Driver</label>
                                                                      ...
                                                                      <input type="radio" class="radio" name="Payer3" checked value="5" id="Other3" />
...
$('#exportdata').on('click', function() {
    ...
    url = '<?php echo base_url() ?>index.php/accountheads/fetch_data_get_ledger_view_export_group?limit=10&customer_id='+id+'&formdate='+fromdate+'&todate='+fromto+'&payment_status='+payment_status;
 ...
 $scope.pointtodriver = function () {
           ...
           // {
                     ...
                     if(valuses1!=0 && valuses!=0)
                     {
                        ...
                        $http({
                        method:"POST",
                        url:"<?php echo base_url() ?>index.php/accountheads/save_to_pay",
...
$scope.loading = true;
    ...
    $http.get('<?php echo base_url() ?>index.php/accountheads/fetch_data_get_ledger_view_group?limit=10&customer_id='+id+'&formdate='+fromdate+'&todate='+fromto+'&payment_status='+payment_status).success(function(data){
...
$scope.fetchDatagetlegderGroupTotal = function(id,fromdate,fromto,payment_status){
    ...
    $http.get('<?php echo base_url() ?>index.php/accountheads/fetch_data_get_ledger_view_total_new1?limit=10&customer_id='+id+'&formdate='+fromdate+'&todate='+fromto+'&payment_status='+payment_status).success(function(data){

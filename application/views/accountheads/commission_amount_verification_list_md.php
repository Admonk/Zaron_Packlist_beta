                               ...
                               <a href="<?php echo base_url(); ?>index.php/purchase/po?order_id={{names.order_id}}&old_tablename_sub=0&tablename=purchase_orders_process&tablename_sub=purchase_product_list_process&movetablename=purchase_orders_process&movetablename_sub=purchase_product_list_process" ng-if="names.order_id!='#'" target="_blank">
                                ...
                                <samll ng-if="names.org_amount!=0"><br>Changed By  : {{names.username}} {{names.org_amount}}</samll>
                                    ...
                                    <td style="display:flex;">
                                           ...
                                           <button type="button" ng-if="names.commission_customer>0" ng-click="onviewparty_edit_new(names.id,names.customer_id,names.name,names.debits,names.credits,names.uom,names.convertion)"  class="btn btn-outline-danger btn-sm">VIEW</button>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-9">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-12">
                            <select name="selectedBank" ng-model="selectedBank" id="selectedBank"  class="form-control" >
...
app.filter('indianCurrency', function () {
    return function (input) {
        ...
        // console.log(input.toLocaleString('en-IN').toFixed(2));
         var decimal =  formattedValue.toLocaleString('en-IN', {   minimumFractionDigits: 0, maximumFractionDigits: 0 });
...
$scope.UpdateCommsision = function () {
            ...
            var id= $('#l_id').val();
                ...
                var bank_amount= $('#bank_amount').val();
                      ...
                      var selectedBank= $('#selectedBank').val();
 ...
 $scope.statusupdate = function(status,statusname)
{
 ...
 $scope.onviewparty_edit_new = function(l_id,id,name,dc,cc,uom,convertion)
{
 // console.log(convertion)
//    if (uom == 'Kg' && convertion == 2) {
//     $('#UpdateCommsision').show();
// } else if (uom == 'Kg' && convertion == 0) {
//     $('#UpdateCommsision').hide();
// } else {
//     $('#UpdateCommsision').show();
// }

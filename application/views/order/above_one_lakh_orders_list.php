               ...
               <div class="container-fluid">
                                          ...
                                          <div class="card mb-1">
                                             <div class="card-header align-items-start d-flex p-3">
                                                <div class="flex-shrink-0">
                                                   ...
                                                   <li class="nav-item ">
                                                         <a class="nav-link" data-bs-toggle="tab" href="#messages2" role="tab" ng-click="pageTab('orders',0,'enquiry')">
                                                        
                                                         <span class="d-sm-block">Above 10 lakh Enquiry List </span>   
                                                         </a>
                                                      </li> 

                                                      <li class="nav-item ">
                                                         <a class="nav-link" data-bs-toggle="tab" href="#messages2" role="tab" ng-click="pageTab('orders_quotation',1,'quotation')">
                                                        
                                                         <span class="d-sm-block">Above 10 lakh Quotation List </span>   
                                                         </a>
                                                      </li> 


                                                       <li class="nav-item ">
                                                         <a class="nav-link" data-bs-toggle="tab" href="#messages2" role="tab" ng-click="pageTab('orders_quotation',-4,'quotation')">
                                                        
                                                         <span class="d-sm-block">Above 10 lakh Remainder Quotation List </span>   
                                                         </a>
                                                      </li> 


                                                             <li class="nav-item ">
                                                         <a class="nav-link active" data-bs-toggle="tab" href="#messages2" role="tab" ng-click="pageTab('orders_process',1,'orders')">
                                                        
                                                         <span class="d-sm-block">Above 10 lakh Orders List </span>   
                                                         </a>
                                                      </li> 
                         ...
                         <div class="col-sm-2">
                            <div class="dataTables_length">
                                ...
                                <select name="example_length" id="status" class="form-control input-sm" ng-model="statuschange" ng-change="statusChanged()">
                          ...
                          <div class="col-sm-2">
                            <div class="dataTables_length" >
                                ...
                                <select name="example_length" id="range" class="form-control input-sm" ng-model="range" ng-change="rangeChanged()">

                                        <option value="1000000">Above 10 lakh</option>
                                        <option value="500000">5 lakh to 10 lakh</option>
                                        <option value="100000">1 lakh to 5 lakh</option>
                                        <option value="50000">50,000 to 1 lakh</option>
                                        <option value="49999">0 to 50,000</option>
                                                              ...
                                                              <table class="table align-middle table-nowrap newBorderedTable" >
                                                                  <thead>
                                                                      <tr>
                                                                          ...
                                                                          <!--<th>Delivery</th>-->
                                                                          <th ng-if="tabname == 'orders'">Delivery Scope</th>
                                                                          <th ng-if="tabname == 'orders'">Payment Mode</th>
                                                                          ...
                                                                          ?>
                                                                          <th ng-if="tabname == 'orders'">Delivery Date</th>
                                                                          <th>Create Date</th>
                                                                          <th>Action</th>
                                                                      </tr>
                                                                  </thead>
                                                                  <tbody>
                                                                      ...
                                                                      <tr  ng-repeat="name in namesData" >
                                                                          ...
                                                                          <td>{{name.order_no}}</td>
                                                                          <td style="width: 150px;font-size: 11px;">{{name.name}}</td>
                                                                          <td>{{name.phone}}</td>
                                                                        ...
                                                                        <td ng-if="tabname == 'orders'">
                                                                          ...
                                                                          <td style="font-size: 10px;">
                                                                               ...
                                                                               <span ng-if="name.pending_amount">{{name.pending_amount | indianCurrency}}</span>
                                                                          ...
                                                                          <td>
                                                                            ...
                                                                            <span ng-if="tabname == 'quotation'">
                                                                                <a href="<?php echo base_url(); ?>index.php/order/ordercreate_product_quotation?order_id={{name.base_id}}" ><i class="mdi mdi-eye font-size-16 text-success me-1" ng-click="disable_load()"></i> View</a>
                                                                            </span>
                                                                            <span ng-if="tabname == 'orders'">
...
// console.log($scope.tabname)
  ...
  $scope.to_date = new Date();
   ...
   function getData() {
      ...
      var status = $('#status').val();  var range = $('#range').val();
      
    
      
     $http.get('<?php echo base_url() ?>index.php/order/fetch_data_above_one_lakh?page=' + $scope.currentPage + '&size=' + $scope.pageSize + '&search=' + $scope.searchText + '&tablename=' + $scope.tablename+'&order_base='+order_base+'&from_date='+from_date+'&to_date='+to_date+'&status='+status+'&range='+range)
 ...
 $scope.pageTab = function(tabelename,status,tabname){
    
      $scope.tablename=tabelename;
...
$scope.onPre = function(currentPage,pageSize){
  ...
  function getDataPage(currentPage,pageSize) {
      ...
      var status = $('#status').val();  var range = $('#range').val();
        ...
        $http.get('<?php echo base_url() ?>index.php/order/fetch_data_above_one_lakh?page_next=' + currentPage + '&size=' + pageSize + '&search=' + $scope.searchText + '&tablename=' + $scope.tablename+'&order_base='+order_base+'&from_date='+from_date+'&to_date='+to_date+'&status='+status+'&range='+range)
        .success(function(data) {
            $scope.namesData = [];
            $scope.totalItems = data.totalCount;

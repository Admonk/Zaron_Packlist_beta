                                                ...
                                                <div class="flex-shrink-0">
                                                   <ul class="nav justify-content-end nav-tabs-custom rounded card-header-tabs" role="tablist" ng-init="getcount('orders_process')">
                                                      ...
                                                      <li class="nav-item">
                                                         ...
                                                         <span class="d-block d-sm-none"><i class="far fa-envelope"></i></span>
                                                         <span class="d-none d-sm-block">QC Verified Order &nbsp;&nbsp;<span class="badge rounded-pill bg-success float-end"> {{production_qc_completed}} </span></span>   
                                                         </a>
                                                      </li>
                                                              ...
                                                              <table class="table align-middle table-nowrap newBorderedTable" datatable="ng" dt-options="vm.dtOptions">
                                                                  ...
                                                                  <tbody>
                                                                      ...
                                                                      <tr  ng-repeat="name in namesData">
                                                                          ...
                                                                          <td><a href="<?php echo base_url(); ?>index.php/order/production_panel_quality_check?order_id={{name.base_id}}&status={{name.order_base}}" >{{name.order_no}}</a></td>
                                                                          <td>{{name.name}}</td>
                                                                          <td>
                                                                             {{name.phone}}
                                                                          </td>
                                                                          ...
                                                                          <td>
                                                                               ...
                                                                               <span ng-if="name.order_base==3">
                                                                                  ...
                                                                                  <p style="color:red;margin:0;">QC Not Verified</p>
                                                                          ...
                                                                          <td>
                                                                                     ...
                                                                                     <a href="<?php echo base_url(); ?>index.php/order/production_panel_quality_check?order_id={{name.base_id}}&status={{name.order_base}}" ><i class="mdi mdi-eye font-size-16 text-success me-1"></i> View</a>
...
app.controller('crudController', function($scope, $http){
  ...
  $scope.fetchData = function(tabelename,status){
    $http.get('<?php echo base_url() ?>index.php/order/fetch_data_table_production_by_order?tablename='+tabelename+'&order_base='+status).success(function(data){

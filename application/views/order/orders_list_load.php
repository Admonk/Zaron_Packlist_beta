...
<body data-layout="horizontal" class="full-vh-overflow-hide" data-topbar="dark" ng-app="crudApp" ng-controller="crudController">
                                                ...
                                                <div class="flex-shrink-0">
                                                   <ul class="nav justify-content-end nav-tabs-custom rounded card-header-tabs" role="tablist" ng-init="getcount('orders_process')">
                                                      ...
                                                      <li class="nav-item ">
                                                         ...
                                                         <span class="d-none d-sm-block">Load summary for Transport </span>   
                                                         </a>
                                                      </li> 
                                                              ...
                                                              <table class="table align-middle table-nowrap newBorderedTable" >
                                                                  <thead>
                                                                      <tr>
                                                                          ...
                                                                          <th>Payment_Mode</th>
                                                                          <th>Order_Date</th>
                                                                          <th>Trip_End_Date<select id="sortFilter" ng-model="sortFilter_val" ng-change="sortFilter()">
                                                                              <option value="1">Latest</option>
                                                                              <option value="0">Oldest</option>
                                                                          </select></th>
                                                                          <td>Delivery_Scope</td>
                                                                  ...
                                                                  <tbody ng-repeat="name in namesData">
                                                                       ...
                                                                       <tr ng-repeat="names in name.subarray">
                                                                          <td></td>
                                                                          <td>{{names.name}}</td>
                                                                          <td><a href="<?php echo base_url(); ?>index.php/order/ordercreate_product_process_finance_verification?order_id={{names.base_id}}">{{names.order_no}}</a></td>
                                                                          <td>{{names.order_byd}} </td>
                                                                          <td>{{names.vehicle_number}} </td>
                                                                          <td>{{names.totalamount | number}}</td>
                                                                          <td>{{names.driver_recived_payment | number}}</td>
                                                                          ...
                                                                          <td class="hideprint">
                                                                                  ...
                                                                                  <input class="btn btn-outline-success w-lg btn-rounded waves-effect waves-light"   ng-click="getorderid(names.id,names.order_no)" type="submit" value="View">
    ...
    <h4 ng-show="namesDataorderid.length==0" style="text-align: center;padding: 15px;">Denomination Not Found</h4>
                                          ...
                                          <div class="card-body" ng-repeat="namesorderid in namesDataorderid">
                                                ...
                                                <h5>Total Bill Amount : <b >Rs. {{namesorderid.totalamount | number:2}}</b></h5>
                                                ...
                                                <table  class="table" ng-if="denomination_total>0">
                                                       ...
                                                       <tr style="color:red;font-weight:700;" ng-if="namesorderid.return_excess==0"><td>Difference  </td><td></td><td><span  >{{namesorderid.totalamount-denomination_total | number : 0}}</tr>
     ...
     <div class="modal fade" id="firstmodalcommison2" aria-hidden="true" aria-labelledby="exampleModalToggleLabel" tabindex="-1">
                                          ...
                                          <div class="card-body" ng-repeat="namesorderid in namesDataorderidSingle">
                                                ...
                                                <p>Total Bill Amount : <b style="font-size:14px;" id="totamountval">{{namesorderid.totalamount | number}}</b></p>
                                                ...
                                                <p>Customer Payment Mode : 
                                                                        ...
                                                                        <select class="form-select" disabled id="payment_mode" ng-change="payment_modemodechange()" ng-model="payment_modemodechangess">
                                               ...
                                               <span  id="cash_payment_mode" class="{{payment_mode_by}}" >
                                                       ...
                                                       <tr style="color:red;font-weight:700;" ng-if="namesorderid.return_excess==0"> <td>Difference  </td><td></td><td><span  id="bal">{{namesorderid.fulltotalamount-s_denomination_totalexe | number : 0}}</tr>
                                              ...
                                              <div class="form-group row">
                                                ...
                                                <label class="col-sm-12 col-form-label">Date <span style="color:red;">*</span>
                                                <input type="date" class="form-control" disabled value="<?php echo date('Y-m-d'); ?>" id="payment_date_single">
                                                </label>
                                                ...
                                                <div class="col-sm-12">
                                                 ...
                                                 <span ng-if="namesorderid.payment_mode!='Cash'">    
                                                 <input  class="form-control" placeholder="Enther The Amount" disabled value="0" name="collectamount" id="collectamount_single" type="text">
                                                 </span>
                                                 
                                                 
                                                 <span ng-if="namesorderid.payment_mode=='Cash'">    
                                                 <input  class="form-control" placeholder="Enther The Amount" disabled value="{{s_denomination_total}}" name="collectamount" id="collectamount_single" type="text">
                                                 </span>
...
$scope.onview = function(amount,customer_id,order_no,order_id,payment_id_base){
 ...
 $scope.getorderid = function(id,name) {
  ...
  $('#displayset').show();
  $scope.activeMenu = id
  $scope.fetchorderidDetailsSingle('orders_process',2,id);
  $scope.cashmodeSingle('orders_process',2,id);
 ...
 $scope.fetchorderidDetailsSingle = function(tabelename,status,id){
 ...
 $scope.cashmodeSingle = function(tabelename,status,id){

    $http.get('<?php echo base_url() ?>index.php/order/cash_mode_reconciliation?tablename='+tabelename+'&order_base='+status+'&order_id='+id).success(function(data){
  ...
  $scope.paymentrecivedSingle = function(){
      ...
      for(var i = 0; i < paid_driver.length; i++){
       ...
       var checkid= paid_driver_value.join("|");
         ...
         if(payment_mode_edit=='Cash')
         {
                ...
                var res=$scope.denomoniationsave(order_id,order_no);
         }
   ...
   $scope.denomoniationsave = function(order_id,order_no)
     {
             ...
             if(amount_data>0)
             {
                       ...
                       $http({
                        ...
                        data:{'c1_rs':c1_rs,'c2_rs':c2_rs,'c5_rs':c5_rs,'c10_rs':c10_rs,'c20_rs':c20_rs,'c50_rs':c50_rs,'c100_rs':c100_rs,'c200_rs':c200_rs,'c500_rs':c500_rs,'c2000_rs':c2000_rs,'paymentmode':payment_mode,'order_id':order_id,'order_no':order_no}
                        }).success(function(data){

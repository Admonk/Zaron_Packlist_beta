...
<body data-layout="horizontal" class="full-vh-overflow-hide" data-topbar="dark" ng-app="crudApp" ng-controller="crudController">
  ...
  <div id="layout-wrapper">
                          ...
                          <div class="col-md-4 d-flex align-items-center justify-content-between">
                            ...
                            <div>
                              <button type="button" target="_blank"
                                href="<?php echo base_url() ?>index.php/order_second/driver_orders_list_trip_base?vehicle_id=-1"
                                class="btn btn-outline-danger">Day Wise Trip</button>
                            </div>
                          </div>
    ...
    <tr class="tr_nav_link tr_<?php echo $i; ?> <?php echo $b; ?>" ng-click="routeassignOrderclick('<?php echo $rs->vehicle_id; ?>','<?php echo $i; ?>','<?php echo $rs->countnumber; ?>','<?php echo $rs->vehicle_number; ?>','<?php echo $rs->vehicle_name; ?>')">
        ...
        <td><a href="<?php echo base_url() ?>index.php/order_second/driver_orders_list_trip_order_base?vehicle_id=<?php echo $rs->vehicle_id; ?>" target="_blank"><?php echo $i; ?></a></td>
        <td><a href="<?php echo base_url() ?>index.php/order_second/driver_orders_list_trip_order_base?vehicle_id=<?php echo $rs->vehicle_id; ?>" target="_blank" ><?php echo $rs->vehicle_name; ?></a> </td>
        <td><a href="<?php echo base_url() ?>index.php/order_second/driver_orders_list_trip_order_base?vehicle_id=<?php echo $rs->vehicle_id; ?>" target="_blank" ><?php echo $rs->vehicle_number; ?></a></td>
        <td><a href="<?php echo base_url() ?>index.php/order_second/driver_orders_list_trip_order_base?vehicle_id=<?php echo $rs->vehicle_id; ?>" target="_blank" ><?php echo $rs->vehicle_type; ?> </a></td>

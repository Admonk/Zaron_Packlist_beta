...
<div class="modal fade bs-example-modal-center" tabindex="-1" role="dialog" aria-hidden="true">
                        ...
                        <div class="col-sm-2" >
                          ...
                          <button onclick="window.print()" class="btn btn-primary" ng-click="Print()" style="margin: 25px 0px;">Print</button>
                           ...
                           <a href="<?php echo base_url(); ?>index.php/order/production_print_beta" class="btn btn-default" style="margin: 25px 0px;">All Orders</a>
                           ...
                           {
                               ?>
                             <a href="<?php echo base_url(); ?>index.php/order/production_print_attachement_beta" class="btn btn-default" style="margin: 25px 0px;">Attachments</a>
                           ...
                           {
                               ?>
                               <a href="<?php echo base_url(); ?>index.php/order/production_print_attachement_beta?status_ssd=1" class="btn btn-default" style="margin: 25px 0px;">SDP Attachments</a>

...
<style>
  ...
  html,p,h1,h2,h3,h4,h5,h6,span,td,th,li, div
  {
...
.tableBankInfoMedia
{
  text-align: left;padding: 45px 15px;
}
...
.col.col-md-4.invoice-details p {
    width: 163px;
}
...
.tableBankInfoMedia {
   ...
   textarea.form-control.linetext,input.form-control.linetext {
    font-size: 12px;
    font-weight: 500;
    margin-bottom: 0px;
...
<div class="invoice-btn-section clearfix d-print-none">
                    ...
                    <div class="text-center" style="padding:20px;">
                    		 ...
                    		 <input type="button" onclick="window.print()" value="Print" class="btn btn-info <?php echo $d_none; ?>">
                    		 <a href="<?php echo $geturl; ?>" class="btn btn-info <?php echo $d_none; ?>" target="_blank">Attachment</a>
...
<div id="invoice" class="invoice-6 invoice-content">
      ...
      <div class="col-lg-12">
        <div class="invoice-inner-6" id="invoice_wrapper">
          <div class="invoice-info">
            ...
            <div class="row">
              <div class="col-md-12"><a href='<?php echo  $_SERVER['HTTP_REFERER']; ?>' class="back1" ng-click="back()"> < Back</a></div>
              <div class="col-md-4">
          ...
          <div class="invoice-info">
            <div class="row">
              <div class="col-md-4 invoice-details" ng-init="fetchCustomerorderdata()">
                ...
                <p class="invo-addr-1" ng-if="gst!='0'">
                  <span ng-if="gst!=''">GST : {{ gst }}</span>
              ...
              <div class="col-md-4 invoice-details">
                ...
                <p ng-if="delivery_gst!='0'">

                  <span ng-if="delivery_gst!=''">GST : {{ delivery_gst }}</span>
              ...
              <div class="col-md-4 invoice-details">
                ...
                <p class="inv-title-1">Order No: {{ order_no_id }} <b ng-if="SSD_check>0" class="font-size-30"
                    style="color: red;border: #d9d9d9 solid 2px; padding: 2px 9px;"> SDP </b> </p>

                <p class="invo-addr-1"> Date : {{ create_date }}</p>

                <p ng-if="payment_mode!='0'" style="font-size: 23px; border: #b3b3b3 solid 6px; padding: 3px 8px;" class="paymentModeMedia">Payment
                  Mode : {{ payment_mode }}
                  <span ng-if="collection_remarks" style="color: green;"><br> Amount to collect
                    : {{ collection_remarks  | number : 2 }}</span>
                ...
                <p ng-if="delivery_date_time!='0'"> Delivery Date : {{ delivery_date_time }} </p>
                ...
                <p style="font-size: 23px; border: #b3b3b3 solid 6px; padding: 3px 8px;" class="paymentModeMedia"><b>Net Total : Rs.
                    {{ discountfulltotal | number : 2 }} </b></p>
          ...
          <div class="invoice-info" style="margin-top: 15px;margin-bottom: 15px;">
            ...
            <div class="row">
              <div class="col-sm-12 mb-30">
                ...
                <p>Thank you very much for your enquiry regarding the requirement of roofing sheet. We are glad to
                  inform you that we would be in a position to supply you the requirement posted by you. Given below are
                  the tentative prices and our terms and conditions.</p>
          ...
          <div class="order-summary">
            <div ng-init="fetchDataCategorybase(1)">
              ...
              <div navigatable ng-init="fetchData('1')">
                <div class="navclass">
                  <div ng-repeat="namecate in namesDatacate"  class="table-responsive">




                    <h5 style="text-align: left;padding: 3px 6px;    margin: 9px auto;">{{ namecate.no }}.
                      {{ namecate.categories_name }} </h5>

                    <div data-pattern="priority-columns">
                      <table id="datatable" border="yes" class="printmediaTable salestable">
                        ...
                        <thead class="bg-gray text-red" ng-if="namecate.categories_id==1">
                          ...
                          <tr>
                            ...
                            <th class="table-width-18 sstp" rowspan="2">Products </th>
                            <th class="table-width-8">UOM</th>
                            <th class="table-width-8" ng-if="namecate.labletype==2 || namecate.labletype==1"
                              style="padding-bottom:0px">{{ namecate.lable }} </th>
                            <th class="table-width-8" ng-if="namecate.labletype==2">Length </th>
                            <th class="table-width-6" ng-if="namecate.labletype==2 || namecate.labletype==1" rowspan="2"
                              style="padding-bottom:0px;text-align:right;">{{ namecate.lablenos }} </th>
                            <th class="table-width-10" rowspan="2" ng-if="base_check==1" style="text-align:right;">
                              Basic Rate </th>
                           
                            <th class="table-width-10" rowspan="2" style="text-align:right;">Basic Rate </th>


                            <th class="table-width-10" rowspan="2" ng-if='namecate.uom!="Kg"' style="text-align:right;">
                              {{ namecate.uom }} </th>
                            <th class="table-width-10 <?php echo $classdata; ?>" rowspan="2" ng-if='namecate.uom=="Kg"'
                              style="text-align:right;">Approx KG </th>
                        ...
                        <thead class="bg-gray text-red" ng-if="namecate.categories_id!=1">
                          ...
                          <tr>
                            ...
                            <th class="table-width-18" ng-if="(namecate.labletype==4 && namecate.tile_check == 0) || namecate.categories_id==599"
                            ...
                            <th class="table-width-8" ng-if="namecate.labletype==5 || namecate.labletype==6">Billing
                              Option</th>

                            <th class="table-width-8" ng-if="namecate.labletype==11 || namecate.labletype==12">Dim 1
                            </th>
                            <th class="table-width-8" ng-if="namecate.labletype==11 || namecate.labletype==12">Dim 2
                            </th>
                            ...
                            <th class="table-width-10" ng-if="namecate.labletype==8" style="display:none;">Extra
                              {{ namecate.lable }} </th>
                            <th class="table-width-8" ng-if="namecate.labletype==8" style="display:none;"
                              style="padding-bottom:0px">Back {{ namecate.lable }} </th>
                            <th class="table-width-8"
                              ng-if="namecate.labletype==11 || namecate.labletype==12 || namecate.labletype==15">
                              {{ namecate.lable2 }} </th>


                            <th class="table-width-8" ng-if="namecate.labletype==1 || namecate.labletype==6"
                              style="padding-bottom:0px">{{ namecate.lable2 }} </th>
                            <th class="table-width-6" ng-if="namecate.labletype!=9" rowspan="2"
                              ng-click='sortColumn("nos_tab")' ng-class='sortClass("nos_tab")'
                              style="text-align:right;">{{ namecate.lablenos }} </th>
                            <th class="table-width-6 d-none"
                              ...
                              rowspan="2"><small>{{ namecate.lablefact1 }} <br> {{ namecate.lablefact2 }} </small> </th>
                        ...
                        <tbody ng-repeat="name in namesData|orderBy:column:reverse" ng-if="namecate.categories_id==1">
                          ...
                          <tr class="view"
                            ...
                            <td style="text-align:center;" data-label="NO">{{ name.no }}</td>
                            <td title="{{ name.categories }}" class="sstp"  data-label="Products">{{ name.product_name_tab }} <span ng-if="name.select_profile">
                                <br> Profile ---> {{ name.select_profile }}</span>
                              <span ng-if="name.cate_status==1">
                                <hr>
                                </hr> Accessories Specification: {{ name.sub_product_name_tab }}</span>

                            </td>
                            <td data-label="UOM"><select class="selectbox" disabled>
                            ...
                            <td style="text-align:right;" data-label="Nos">{{ name.nos_tab }}</td>
                            <td style="display:none;" data-label="Fact">{{ name.fact_tab }}</td>
                            <td ng-if="base_check==1" style="text-align:right;" data-label="Base rate">{{ name.base_rate }}</td>
                           
                            <td style="text-align:right;" data-label="Base Rate">{{ name.rate_tab | number : 2 }}</td>





                            <td id="qty_{{ name.id }}" data-label="QTY" class="qtyfind_{{ namecate.type }}" ng-if='namecate.uom!="Kg"'
                              style="text-align:right;">{{ name.qty_tab }}</td>
                            <td id="qty_{{ name.id }}" class="qtyfind_{{ namecate.type }} <?php echo $classdata; ?>"
                              ng-if='namecate.uom=="Kg"' data-label="QTY"  style="text-align:right;">{{ name.qty_tab }}</td>





                            <td id="amount_{{ name.id }}" data-label="Amount"  class="amounttot_{{ namecate.type }} " style="text-align:right;">
                            ...
                            <td ng-if="namecate.cate_status==1" data-label="Reference Image">
                              ...
                              <span ng-if="name.reference_image!=''">
                                ...
                                <a href="{{ name.reference_image }}" style="margin: 15px 5px;" target="_blank"> <img
                                    src="{{ name.reference_image }}" style="width: 285px;border: #4a4a4a solid 1px;"> </a>
                              </span>
                        ...
                        <tr ng-if="namecate.categories_id==1" style="display:none;">
                          <td></td>
                          <td class="table-widtd-6 hidmob"><b>Table total</b></td>
                          <td class="table-widtd-6 hidmob"> </td>
                          <td class="table-widtd-6 hidmob"> </td>


                          <td class="hidmob" ng-if="namecate.labletype==2"><b></b></td>
                          <td data-label="Total:" style="text-align:right;"><b
                              id="nostot_{{ namecate.categories_id }}">{{ namecate.nos_total }}</b></td>
                          <td class="hidmob"><b></b></td>
                          <td ng-if="commission_check==1" class="comdisplay"><b></b></td>
                          
                          <td ng-if="base_check==1"></td>
                          <td style="text-align:right;"><b
                              id="fullqty_{{ namecate.categories_id }}">{{ namecate.qty_total }}</b></td>

                          <td style="text-align:right;"><b
                              id="fulltotal_{{ namecate.categories_id }}">{{ namecate.amount_total }} </b></td>
                          ...
                          <tr class="view" ng-if="namecate.categories_id==name.categories_id_get">
                            ...
                            <td title="{{ name.categories }}" class="sstp" data-label="Products">{{ name.product_name_tab }} <span ng-if="name.select_profile">
                              ...
                              <span ng-if="name.cate_status==1">
                                ...
                                <span ng-if="namecate.labletype==4  || namecate.labletype==16 || namecate.labletype==19 || namecate.categories_id==592 || namecate.categories_id==599">
                                <hr>
                                </hr> Material Specification: {{ name.tile_material_name }}</span>
                            ...
                            <td ng-if="namecate.labletype==19" data-label="Dim 1">{{ name.dim_one }}</td>
                            <td ng-if="namecate.labletype==19" data-label="Dim 2">{{ name.dim_two }}</td>
                            ...
                            <td ng-if="namecate.labletype!=9" data-label="UOM">
                              ...
                              <span ng-if="namecate.labletype!=14">
                                ...
                                <option value="5" ng-selected="{{ name.uom == 5 }}" ng-style="namecate.categories_id == 13 && {'display':'none'}">MTR</option>
                            ...
                            <td ng-if="namecate.labletype==19" data-label="Dim 3">{{ name.dim_three }}</td>

                            <td ng-if="namecate.labletype==5 || namecate.labletype==6" data-label="Coil No">



                              <select class="selectbox" disabled ng-if="namecate.labletype==5">
                                <option value="1" ng-selected="{{ name.billing_options == 1 }}">Running MTR
                                </option>
                            ...
                            <td ng-if="namecate.labletype==12"  data-label="Dim 2">{{ name.dim_two }}</td>


                            <td ng-if="namecate.labletype==4" data-label="{{ namecate.lable }}"> {{ name.profile_tab }}</td>
                            ...
                            <td style="display:none;"
                              ng-if="namecate.labletype==8 || namecate.labletype==11 || namecate.labletype==12 || namecate.labletype==15">
                              {{ name.crimp_tab }}</td>
                            <td ng-if="namecate.labletype==8" style="display:none;">{{ name.back_crimp }}</td>
                            <td ng-if="namecate.labletype==1 || namecate.labletype==6" data-label="{{ namecate.lable2 }}">{{ name.crimp_tab }}</td>
                            <td ng-if="namecate.labletype!=9" style="text-align:right;" data-label="Nos">{{ name.nos_tab }}</td>
                            <td style="display:none;"
                              ng-if="namecate.labletype==1 || namecate.labletype==2 || namecate.labletype==3 || namecate.labletype==4 || namecate.labletype==5 || namecate.labletype==6 || namecate.labletype==7 || namecate.labletype==16 || namecate.labletype==8 || namecate.labletype==10 || namecate.labletype==11 || namecate.labletype==12 || namecate.labletype==13 || namecate.labletype==14">
                              {{ name.fact_tab }}</td>
                            ...
                            <td style="text-align:right;" id="qty_{{ name.id }}" class="qtyfind_{{ namecate.type }}"
                              ng-if='namecate.uom!="Kg"' data-label="QTY">{{ name.qty_tab }}</td>
                            <td style="text-align:right;" id="qty_{{ name.id }}"
                              class="qtyfind_{{ namecate.type }} <?php echo $classdata; ?>" ng-if='namecate.uom=="Kg"'>
                              {{ name.qty_tab }}</td>




                            <td id="amount_{{ name.id }}" class="amounttot_{{ namecate.type }} " data-label="Amount" style="text-align:right;">
                              <sapn ng-if='namecate.uom=="Kg"'>{{ name.amount_tab }}</sapn>
                              <sapn ng-if='namecate.uom!="Kg"'>{{ name.amount_tab }}</sapn>
                            </td>


                            <td ng-if="namecate.cate_status==1" data-label="Reference">
                        ...
                        <tr ng-if="namecate.categories_id!=1" style="display:none;">
                          ...
                          <th class="table-width-6"
                            ng-if="namecate.labletype==6 || namecate.labletype==11 || namecate.labletype==12"> </th>
                          <th class="table-width-6 hidmob" ng-if="namecate.labletype==15"> </th>
                          <th class="table-width-6"
                            ng-if="namecate.labletype==1 || namecate.labletype==2 || namecate.labletype==3 || namecate.labletype==4 || namecate.labletype==5 || namecate.labletype==6 || namecate.labletype==7 || namecate.labletype==16 || namecate.labletype==8 || namecate.labletype==10 || namecate.labletype==11 || namecate.labletype==12 || namecate.labletype==13 || namecate.labletype==14 || namecate.labletype==15 || namecate.categories_id==599">
                          </th>
                          <th class="table-width-6"
                            ng-if="namecate.labletype==1 || namecate.labletype==2 || namecate.labletype==3 || namecate.labletype==4 || namecate.labletype==5 || namecate.labletype==6 || namecate.labletype==7 || namecate.labletype==16 || namecate.labletype==10 || namecate.labletype==11 || namecate.labletype==12 || namecate.labletype==13 || namecate.labletype==14 || namecate.labletype==15">
                          </th>
                          ...
                          <th ng-if="namecate.labletype!=9" style="text-align:right;"><b
                              id="nostot_{{ namecate.type }}">{{ namecate.nos_total }}</b></th>
                          <th style="display:none;"
                            ng-if="namecate.labletype==1 || namecate.labletype==2 || namecate.labletype==3 || namecate.labletype==4 || namecate.labletype==5 || namecate.labletype==6 || namecate.labletype==7 || namecate.labletype==16 || namecate.labletype==8 || namecate.labletype==10 || namecate.labletype==11 || namecate.labletype==12 || namecate.labletype==13 || namecate.labletype==14">
                            <b>{{ namecate.fact_total }}</b></th>

                          <th></th>
                        
                          <th ng-if="base_check==1"></th>
                          <th style="text-align:right;"><b id="fullqty_{{ namecate.type }}">{{ namecate.qty_total }}</b>
                          </th>

                          <th style="text-align:right;"><b id="fulltotal_{{ namecate.type }}">{{ namecate.amount_total }}
                            </b></th>
                  ...
                  <table class="table invoice-table  m-show"   ng-init="fetchSingleDatatotal('1')">
                    ...
                    <tr>
                      ...
                      <td>
                        ...
                        <p class="text-end" style="font-size: 18px;"><b>SubTotal : Rs.
                            {{ fulltotal+discounttotal | number : 2 }}</b></p>

                        <p class="text-end" style="font-size: 18px;" ng-if="minisroundoff>0"><b>RoundOff : Rs.
                            ({{ roundoff_val }}) {{ minisroundoff }}</b></p>
                        <p class="text-end" style="font-size: 18px;" ng-if="discounttotal>0"><b>Discount {{ discountPre }}
                            %: Rs. {{ discounttotal }}</b></p>
                        <p class="text-end" style="font-size: 18px;" ng-if="gst_check==1"><b>CGST 9 % : Rs.
                            {{ gsttotal | number : 2}}</b> </p>
                        <p class="text-end" style="font-size: 18px;" ng-if="gst_check==1"><b>SGST 9 % : Rs.
                            {{ gsttotal | number : 2}}</b> </p>
                        <p class="text-end" style="font-size: 18px;" ng-if="tcsamount>0"><b>TCS (+) : Rs. {{ tcsamount }}
                          </b></p>
                        <p class="text-end" style="font-size: 18px;" ng-if="roundoffstatusval_data"><b>Round : Rs.
                           ({{symble}}) {{ roundoffstatusval_data | number : 2 }} </b></p>
                        <p class="text-end" style="font-size: 18px;"><b>Net Total : Rs.
                            {{ discountfulltotal | number : 2 }} </b></p>
                        ...
                        <div class="row">
                          ...
                          <div  class="col-md-12 tableBankInfoMedia">
                          ...
                          <div  class="col-md-6 paymentimg">
                            ...
                            <img src="https://erp.zaron.in/beta1/uploads/qr_code.png"  class="scanforpaytm">
                          </div>
                        </div>
                      </td>
                 ...
                 <table class="table invoice-table d-show"  >
                                ...
                                <tr>
                                    ...
                                    <!--  <span> <b> Name:</b> ZaronIndustriess</span> <br>
                                     ...
                                     <span> <b> Account No: </b> 1643135000001944</span> <br> -->
                                      ...
                                      <div style="text-align: center;" class="col-md-6">
                                         <p style="font-size: 20px;margin: -20px 0px;">Scan To Pay</p>
                                    ...
                                    <td>
                                                    ...
                                                    <p  class="text-end" style="font-size: 18px;"><b>SubTotal : Rs. {{fulltotal+discounttotal | number : 2}}</b></p>
                                                    <p  class="text-end" style="font-size: 18px;" ng-if="minisroundoff>0"><b>RoundOff : Rs. ({{roundoff_val}})  {{minisroundoff}}</b></p>
                                                    <p  class="text-end" style="font-size: 18px;" ng-if="discounttotal>0"><b>Discount {{ discountPre }}%: Rs. {{discounttotal}}</b></p>
                                                    <p  class="text-end" style="font-size: 18px;" ng-if="gst_check==1"><b>CGST 9 % : Rs. {{gsttotal}}</b> </p>
                                                    <p  class="text-end" style="font-size: 18px;" ng-if="gst_check==1"><b>SGST 9 % : Rs. {{gsttotal}}</b> </p>
                                                    <p  class="text-end" style="font-size: 18px;" ng-if="tcsamount>0"><b>TCS (+) : Rs. {{tcsamount}} </b></p>
                                                    <p  class="text-end" style="font-size: 18px;" ng-if="roundoffstatusval_data"><b>Round : Rs. ({{symble}}) {{roundoffstatusval_data | number : 2}} </b></p>
                ...
                <div class="col-sm-12" style="margin: auto">
                  <div class="payment-info row">
                    ...
                    <div class="col-lg-9">
                      ...
                      <p><?php echo $input2; ?></p>
                      <p><?php echo $input3; ?> </p>
                            <input type="hidden" class="form-control linetext" name="order_id"
                ...
                <div class="col-sm-12">
                  <div class="payment-info  gray-dark  row">
                    ...
                    <div class="col-lg-9 col-md-9 col-sm-12">
                       ...
                       <p><?php echo $input11; ?></p>
                        <p><?php echo $input12; ?></p>
                         <p><?php echo $input13; ?></p>
 ...
 <div class="col-sm-12">
                                 ...
                                 <div class="col-lg-3 col-md-3 col-sm-12">
                                             <h3 class="inv-title-1">Reservation of Rights and Order Policy </h3>
                                </div> 
                                 <div class="col-lg-9 col-md-9 col-sm-12">
                               
                                      <p style="color: #161616;font-size: 14px;">Zaron reserves the right to modify or remove any of the above description without prior notice to client.</p>
                                    <p style="color: #161616;font-size: 14px;">Zaron reserves the right to cancel the order at any point of time without prior notice to client.</p>
              ...
              <div class="row">
                <div class="col-sm-12">
                  ...
                  <p class="text-muted">From the time you place the funds transfer request with your local bank, it
                    takes 24-48 banking hours for the funds to reach our account held with our correspondent bank. The
                    Wire transfer will be processed and the money will be transferred to our account in 2 hour time.</p>
                </div>
              </div>
    ...
    $http({
      ...
      data:{'action':'fetch_single_data','tablenamemain':'<?php echo $tablename; ?>','tablename_sub':'<?php echo $tablename_sub; ?>','convert':id}
       ...
       $scope.discounttotal = data.discount;
        $scope.discountPre = data.discountPre;
...
$scope.fetchCustomerorderdata = function(){
    $http({
      ...
      data:{'action':'fetch_single_data','tablenamemain':'<?php echo $tablename; ?>','tablename_sub':'<?php echo $tablename_sub; ?>'}
       ...
       $scope.delivery_gst = data.delivery_gst;

...
<div class="search-table-outter wrapper">
   <input type="text" class="form-control rounded border ng-pristine ng-valid ng-touched" placeholder="Search..." ng-model="query[queryBy]">
                                         ...
                                         <table class="table ss-show-table mbbody">
                          ...
                          <tbody ng-repeat="namesd in namesDataassign | filter:query | orderBy:orderKey:reverse" id="heading{{namesd.trip_id}}" class="{{namesd.collapsed}}"  >
                                          <tr style="cursor: pointer;font-weight: 800;" class="bgnone {{namesd.bgnone}} mbfirsttr">
                                           ...
                                           <td><a href="javascript:void(0);" ng-click="viewOrder(namesd.vehicle_id,namesd.trip_id,namesd.randam_id)">{{namesd.no}}</a></td>


                                            <td><a href="javascript:void(0);" ng-click="viewOrder(namesd.vehicle_id,namesd.trip_id,namesd.randam_id)">{{namesd.vehicle_number}}</a></td>

                                            <!-- <td><a href="javascript:void(0);" ng-click="viewOrder(namesd.vehicle_id,namesd.trip_id,namesd.randam_id)">{{namesd.vehicle_number}}</a></td> -->

                                           

                                             <td><a href="javascript:void(0);" ng-click="viewOrder(namesd.vehicle_id,namesd.trip_id,namesd.randam_id)">{{namesd.trip_id}}</a></td>




                                            <td class=" checkdata_1 <?php echo $checkdata_1_hide; ?>"><a href="javascript:void(0);" ng-click="viewOrder(namesd.vehicle_id,namesd.trip_id,namesd.randam_id)">{{namesd.assign_date}}</a></td>
                                           <td class=" checkdata_2 <?php echo $checkdata_2_hide; ?>"><a href="javascript:void(0);" ng-click="viewOrder(namesd.vehicle_id,namesd.trip_id,namesd.randam_id)">{{namesd.loc_name}}</a></td>
                                            <td class=" checkdata_3 <?php echo $checkdata_3_hide; ?>"><a href="javascript:void(0);" ng-click="viewOrder(namesd.vehicle_id,namesd.trip_id,namesd.randam_id)">{{namesd.driver_name}} {{namesd.driver_phone}}</a></td>
                                             <td class=" checkdata_4 <?php echo $checkdata_4_hide; ?>"><a href="javascript:void(0);" ng-click="viewOrder(namesd.vehicle_id,namesd.trip_id,namesd.randam_id)">{{namesd.trip_status}}</a></td>
                                            <td class=" checkdata_5 <?php echo $checkdata_5_hide; ?>"><a href="javascript:void(0);" ng-click="viewOrder(namesd.vehicle_id,namesd.trip_id,namesd.randam_id)">{{namesd.start_reading}}</a></td>
                                            <td class=" checkdata_6 <?php echo $checkdata_6_hide; ?> {{namesd.emptycolor}}"><a href="javascript:void(0);" ng-click="viewOrder(namesd.vehicle_id,namesd.trip_id,namesd.randam_id)">{{namesd.km_reading_end}}</a></td>
                                            <td class=" checkdata_7 <?php echo $checkdata_7_hide; ?>"><a href="javascript:void(0);" ng-click="viewOrder(namesd.vehicle_id,namesd.trip_id,namesd.randam_id)">{{namesd.totalkm}}</a></td>
                                             <td class=" checkdata_8 <?php echo $checkdata_8_hide; ?>"><a href="javascript:void(0);" ng-click="viewOrder(namesd.vehicle_id,namesd.trip_id,namesd.randam_id)">{{namesd.lengeth_total}}</a></td>
                                            <td class=" checkdata_9 <?php echo $checkdata_9_hide; ?>"><a href="javascript:void(0);" ng-click="viewOrder(namesd.vehicle_id,namesd.trip_id,namesd.randam_id)">{{namesd.weighttotal}}</a></td>
                                            <td class=" checkdata_10 <?php echo $checkdata_10_hide; ?>"><a href="javascript:void(0);" ng-click="viewOrder(namesd.vehicle_id,namesd.trip_id,namesd.randam_id)">{{namesd.bill_total | indianCurrency}}</a></td>
                                            <td class=" checkdata_11 <?php echo $checkdata_11_hide; ?>"><a href="javascript:void(0);" ng-click="viewOrder(namesd.vehicle_id,namesd.trip_id,namesd.randam_id)">{{namesd.load_amt | indianCurrency}}</a></td>
                                            <td class=" checkdata_12 <?php echo $checkdata_12_hide; ?>"><a href="javascript:void(0);" ng-click="viewOrder(namesd.vehicle_id,namesd.trip_id,namesd.randam_id)">{{namesd.collectable_amount_tot | indianCurrency}}</a></td>
                                            <td class=" checkdata_13 <?php echo $checkdata_13_hide; ?>"><a href="javascript:void(0);" ng-click="viewOrder(namesd.vehicle_id,namesd.trip_id,namesd.randam_id)">{{namesd.collected_amount | indianCurrency}}</a></td>
                                            <td class=" checkdata_14 <?php echo $checkdata_14_hide; ?>"><a href="javascript:void(0);" ng-click="viewOrder(namesd.vehicle_id,namesd.trip_id,namesd.randam_id)">{{namesd.diff_amt | indianCurrency}}</a></td>
                                            <td class=" checkdata_15 <?php echo $checkdata_15_hide; ?>"><a href="javascript:void(0);" ng-click="viewOrder(namesd.vehicle_id,namesd.trip_id,namesd.randam_id)">{{namesd.re_status}}</a></td>
                                 ...
                                 <div class="card-body p-0">
                                    ...
                                    <table class="table">
                                      ...
                                      <tr> 
                                       ...
                                       <!-- <tr> -->
                                       <tr ng-if="(names.last_sort_id != names.no) || (names.last_sort_id == names.no)" style="height: {{ names.last_sort_id != names.no ? '128px' : '114px' }}">
                                        <th>STATUS : </th>
                                        <th>
                                                 {{names.reason}}
                                        ...
                                        <th colspan="2">
                                           ...
                                           <span ng-if="names.assign_status==3">
                                            ...
                                            <div ng-if="names.last_sort_id==names.no">
                                                      ...
                                                      <input type="text" style="width: 100%;"  maxlength="6" id="end_reading_{{names.id}}" value="{{names.km_reading_end}}" ng-keyup="saveReading(names.id,names.return_id,names.randam_id)" class="formta" placeholder="End Reading">
                                                        ...
                                                        <div class="row" style="display:flex;">
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" class="form-control" id="tollCharge_{{names.id}}" ng-model="names.toll_charge"  ng-keyup="saveTollCharge(names.id,names.return_id,names.randam_id,names.trip_id)" value="{{names.toll_charge}}" style="background-color:#f2f2f2; margin-bottom: 10px; width: 85%;">
                                                                </div>
                                                            </div>
                                                            <div class="col-md-6">
...
$scope.toll_attachment = function(id) {
        ...
        $http.post('<?php echo base_url() ?>index.php/order_second/upload_tollattachment?id=' + id + '&tablename=' + table, form_data, {
            ...
            $('#uploadbutton').html('<i class="fa fa-upload" aria-hidden="true"></i>');
        });
    };
...
$scope.viewOrder = function(base_id,trip_id,randam_id){
    
  var from_date = $('#from_date').val();
var delivery_status = '<?php echo $delivery_status; ?>';

  window.open(
  '<?php echo base_url(); ?>index.php/order_second/driver_orders_list_trip_order_base?from_date='+from_date+'&vehicle_id='+base_id+'&trip_id='+trip_id+'&delivery_status='+delivery_status+'&DC_id='+randam_id,

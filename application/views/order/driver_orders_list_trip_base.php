...
<div class="search-table-outter wrapper">
                                        ...
                                        <tbody ng-repeat="namesd in namesDataassign" id="heading{{namesd.trip_id}}" class="{{namesd.collapsed}}"  >
                                          <tr style="cursor: pointer;background: #e6e6e6;font-weight: 800;">

                                            <td><a href="<?php echo base_url() ?>index.php/order_second/driver_orders_list_trip_order_base?vehicle_id={{namesd.vehicle_id}}" target="_blank">{{namesd.no}} . {{namesd.vehicle_number}}</a></td>
                                            ...
                                            if($vehicle_id>0)
                                            {
                                             ...
                                             <td><a href="<?php echo base_url() ?>index.php/order_second/driver_orders_list_trip_order_base?vehicle_id={{namesd.vehicle_id}}" target="_blank">{{namesd.trip_id}}</a></td>
                                            ...
                                            <td><a href="<?php echo base_url() ?>index.php/order_second/driver_orders_list_trip_order_base?vehicle_id={{namesd.vehicle_id}}" target="_blank">{{namesd.assign_date}}</a></td>
                                            <td><a href="<?php echo base_url() ?>index.php/order_second/driver_orders_list_trip_order_base?vehicle_id={{namesd.vehicle_id}}" target="_blank">{{namesd.loc_name}}</a></td>
                                            <td><a href="<?php echo base_url() ?>index.php/order_second/driver_orders_list_trip_order_base?vehicle_id={{namesd.vehicle_id}}" target="_blank">{{namesd.driver_name}} {{namesd.driver_phone}}</a></td>
                                             <td><a href="<?php echo base_url() ?>index.php/order_second/driver_orders_list_trip_order_base?vehicle_id={{namesd.vehicle_id}}" target="_blank">{{namesd.trip_status}}</a></td>
                                          
                                            <td><a href="<?php echo base_url() ?>index.php/order_second/driver_orders_list_trip_order_base?vehicle_id={{namesd.vehicle_id}}" target="_blank">{{namesd.start_reading}}</a></td>
                                            <td><a href="<?php echo base_url() ?>index.php/order_second/driver_orders_list_trip_order_base?vehicle_id={{namesd.vehicle_id}}" target="_blank">{{namesd.km_reading_end}}</a></td>
                                            <td><a href="<?php echo base_url() ?>index.php/order_second/driver_orders_list_trip_order_base?vehicle_id={{namesd.vehicle_id}}" target="_blank">{{namesd.totalkm}}</a></td>
                                             <td><a href="<?php echo base_url() ?>index.php/order_second/driver_orders_list_trip_order_base?vehicle_id={{namesd.vehicle_id}}" target="_blank">{{namesd.lengeth_total}}</a></td>
                                            <td><a href="<?php echo base_url() ?>index.php/order_second/driver_orders_list_trip_order_base?vehicle_id={{namesd.vehicle_id}}" target="_blank">{{namesd.weighttotal}}</a></td>

                                            <td><a href="<?php echo base_url() ?>index.php/order_second/driver_orders_list_trip_order_base?vehicle_id={{namesd.vehicle_id}}" target="_blank">{{namesd.bill_total}}</a></td>
                                            <td><a href="<?php echo base_url() ?>index.php/order_second/driver_orders_list_trip_order_base?vehicle_id={{namesd.vehicle_id}}" target="_blank">{{namesd.load_amt}}</a></td>
                                            <td><a href="<?php echo base_url() ?>index.php/order_second/driver_orders_list_trip_order_base?vehicle_id={{namesd.vehicle_id}}" target="_blank">{{namesd.collectable_amount_tot}}</a></td>
                                            <td><a href="<?php echo base_url() ?>index.php/order_second/driver_orders_list_trip_order_base?vehicle_id={{namesd.vehicle_id}}" target="_blank">{{namesd.collected_amount}}</a></td>
                                           
                                          
                                            <td><a href="<?php echo base_url() ?>index.php/order_second/driver_orders_list_trip_order_base?vehicle_id={{namesd.vehicle_id}}" target="_blank">{{namesd.diff_amt}}</a></td>
                                            <td><a href="<?php echo base_url() ?>index.php/order_second/driver_orders_list_trip_order_base?vehicle_id={{namesd.vehicle_id}}" target="_blank">{{namesd.re_status}}</a></td>

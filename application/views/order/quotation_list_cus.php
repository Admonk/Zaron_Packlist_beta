...
table.table.align-middle.newBorderedTable {
    font-size: 11px;
}
            ...
            <div class="page-content">
               <div class="container-fluid">
                                          ...
                                          <div class="card shadow-none mb-1">
                                             <div class="card-header align-items-start d-flex p-3">
                                                <div class="w-100 flex-shrink-md-0">
                                                   <ul class="nav  nav-tabs-custom rounded card-header-tabs" role="tablist" ng-init="getcount('orders_quotation')">
                                                     ...
                                                     if($this->session->userdata['logged_in']['access']=='31') //Sales Head
                                                     {
                                                      ...
                                                      <li class="nav-item">
                                                         <a class="nav-link" data-bs-toggle="tab" href="#messages2" role="tab" ng-click="pageTab('orders_quotation',121)">
                                                         <span class="d-none d-sm-none"><i class="far fa-envelope"></i></span>
                                                         <span class="d-block d-sm-block">Total Quotation<span class="badge rounded-pill bg-success float-end"> {{totalenquiry}} </span></span>   
                                                         </a>
                                                      </li>
                                                       ...
                                                       <li class="nav-item">
                                                         ...
                                                         <span class="d-block d-sm-block">Open Quotation <span class="badge rounded-pill bg-warning  float-end"> {{pending}} </span></span> 
                                                         </a>
                                                      </li>
                                                         ...
                                                         <span class="d-none d-sm-none"><i class="far fa-envelope"></i></span>
                                                         <span class="d-block d-sm-block">Cancelled <span class="badge rounded-pill bg-danger  float-end"> {{cancel}} </span></span>   
                                                         </a>
                                                      </li>
                                                        ...
                                                        <li class="nav-item">
                                                         ...
                                                         <span class="d-none d-sm-none"><i class="far fa-envelope"></i></span>
                                                         <span class="d-block d-sm-block">Missed Quotation<span class="badge rounded-pill bg-danger  float-end"> {{missed}} </span></span>   
                                                         </a>
                                                      </li>
                                                     ...
                                                     else
                                                     {
                                                      ...
                                                      <li class="nav-item" style="display:none;">
                                                         <a class="nav-link"  href="<?php echo base_url(); ?>index.php/order/ordercreate_product_quotation?order_id=<?php echo $neworder_id; ?>" role="tab" ng-click="disable_load()">
                                                      ...
                                                      <li class="nav-item">
                                                         ...
                                                         <span class="d-none d-sm-block">Total Quotation<span class="badge rounded-pill bg-success float-end"> {{totalenquiry}} </span></span>   
                                                         </a>
                                                      </li>
                                                      ...
                                                      ?>
                                                       ...
                                                       <li class="nav-item">
                                                        ...
                                                        <li class="nav-item">
                                                         <a class="nav-link" data-bs-toggle="tab" href="#messages2" role="tab" ng-click="pageTab('orders_quotation',-2)">
                                                         <span class="d-block d-sm-none"><i class="far fa-envelope"></i></span>
                                                         <span class="d-none d-sm-block">Missed Quotation<span class="badge rounded-pill bg-danger  float-end"> {{missed}} </span></span>   
                                                         </a>
                                                      </li>
                        ...
                        <div id="example_filter" class="dataTables_filter">
                            <label>Search:</label>
                            <input type="search" class="form-control input-sm" aria-controls="example" ng-model="searchText" ng-change="searchTextChanged()">
                        </div>
                    </div>
                       </div>
                                                              ...
                                                              <table class="table align-middle newBorderedTable">
                                                                  <thead >
                                                                      <tr>
                                                                          ...
                                                                          <th class="<?php echo  $d_none_c; ?>">Quotation Date (Created)</th>
                                                                          <th>Enquiry Date</th>
                                                                          <th>Action</th>
                                                                      </tr>
                                                                  </thead>
                                                                  <tbody>
                                                                      ...
                                                                      <tr  ng-repeat="name in namesData" class="{{name.color}}">
                                                                          ...
                                                                          <td data-label="Quotation No : ">
                                                                              ...
                                                                              <a href="<?php echo base_url(); ?>index.php/order/ordercreate_product_quotation?order_id={{name.base_id}}" ng-click="disable_load()">{{name.order_no}}</a>
                                                                              
                                                                              
                                                                              
                                                                              </td>
                                                                          <td data-label="Name : "><a href="<?php echo base_url(); ?>index.php/order/ordercreate_product_quotation?order_id={{name.base_id}}" ng-click="disable_load()">{{name.name}}</a></td>
                                                                          <td data-label="Phone : ">
                                                                              <a href="<?php echo base_url(); ?>index.php/order/ordercreate_product_quotation?order_id={{name.base_id}}" ng-click="disable_load()">{{name.phone}}</a>
                                                                          </td>
                                                                          
                                                                        <td data-label="Commission : " class="<?php echo $d_none_c; ?>"><a href="<?php echo base_url(); ?>index.php/order/ordercreate_product_quotation?order_id={{name.base_id}}" ng-click="disable_load()">
                                                                           ...
                                                                           <td data-label="Bill Amount : "><a href="<?php echo base_url(); ?>index.php/order/ordercreate_product_quotation?order_id={{name.base_id}}"  ng-click="disable_load()">{{name.totalamount | indianCurrency }}</a></td>
                                                                         ...
                                                                         <span ng-if="name.order_base==-1">
                                                                          ...
                                                                          <td data-label="Status : " class="<?php echo $d_none_c; ?>"><a href="<?php echo base_url(); ?>index.php/order/ordercreate_product_quotation?order_id={{name.base_id}}"  ng-click="disable_load()">
                                                                          ...
                                                                          <td data-label="Quotation BY : " class="<?php echo $d_none_c; ?>"><a href="<?php echo base_url(); ?>index.php/order/ordercreate_product_quotation?order_id={{name.base_id}}"  ng-click="disable_load()">{{name.order_by}}</a></td>
                                                                          
                                                                        
                                                                          <td data-label="Quotation Date : "><a href="<?php echo base_url(); ?>index.php/order/ordercreate_product?order_id={{name.base_id}}&viewbase=1">{{name.quotation_date}}</a></td>
                                                                          <td class="<?php echo $d_none_c; ?>"><a href="<?php echo base_url(); ?>index.php/order/ordercreate_product?order_id={{name.base_id}}&viewbase=1">{{name.enquiry_date}} </a></td>
                                                                      ...
                                                                      <td data-label="Action : ">
                                                                               ...
                                                                               <a href="<?php echo base_url(); ?>index.php/order/ordercreate_product_quotation?order_id={{name.base_id}}&via_redirect=1"   ng-click="disable_load()"><i class="mdi mdi-eye font-size-16 text-success me-1"></i> View</a>
...
$scope.getcount = function (tabelename) {
 ...
 $http({
      ...
      data:{'pincode':$scope.pincode}
       ...
       $scope.totalenquiry=data.pending+data.proceed+data.cancel+data.archive+data.reassign+data.remainder;

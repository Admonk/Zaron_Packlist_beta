                                                            ...
                                                            <div class="row">
                                                                 ...
                                                                 <div class="col-lg-12">
                                                                              <div class="border rounded gray p-2">
                                                                                 ...
                                                                                 <div id="task-1">
                                                                                    <div id="upcoming-task" class="pb-1 task-list" ng-init="procseeGroupcompleted(<?php echo $status; ?>)">
                                                                                       <div class="card task-box" id="uptask-1"   ng-init="fetchDataCategorybasecompleted(<?php echo $status; ?>)" >
                                                                                         
                                                                                       <div class="row" style="padding: 5px 21px;"   ng-init="fetchDatacompleted(<?php echo $status; ?>)"> 
                                                                                       
                                                                                       
                                                                                       
                                                                                       <h3>Order ID: {{order_no_id}}</h3>
                                                                                                        ...
                                                                                                        <td>
                                                                                                            ...
                                                                                                            <label for="colorYes_{{name.labelid}}">
                                                                                                                ...
                                                                                                                <span ng-if="name.color==0">
                                                                                                                     <input type="checkbox" checked name="coloryes_no{{name.labelid}}" ng-click="chekboxUncheckcolor(name.labelid)"  class="form-check-input" value="1" id="colorYes_{{name.labelid}}">
                                                                                                                </span>
                                                                                                                
                                                                                                                <span ng-if="name.color==1">
                                                                                                                     <input type="checkbox"  name="coloryes_no{{name.labelid}}" ng-click="chekboxUncheckcolor(name.labelid)" class="form-check-input" value="1" id="colorYes_{{name.labelid}}">
                                                                                                                </span>
                                                                                                        ...
                                                                                                        <td>
                                                                                                            ...
                                                                                                            <label for="thicknessYes_{{name.labelid}}">
                                                                                                                <span ng-if="name.thickness==0">
                                                                                                                   <input type="checkbox" checked name="thicknessyes_no{{name.labelid}}" ng-click="chekboxUncheckthickness(name.labelid)" class="form-check-input" value="1" id="thicknessYes_{{name.labelid}}"> 
                                                                                                                </span>
                                                                                                                
                                                                                                                <span ng-if="name.thickness==1">
                                                                                                                   <input type="checkbox" name="thicknessyes_no{{name.labelid}}" ng-click="chekboxUncheckthickness(name.labelid)" class="form-check-input" value="1" id="thicknessYes_{{name.labelid}}"> 
                                                                                                                </span>
                                                                                                          ...
                                                                                                          <td>
                                                                                                            ...
                                                                                                            <label for="CornersYes_{{name.labelid}}">
                                                                                                                 <span ng-if="name.corners==0">
                                                                                                                   <input type="checkbox" checked name="Cornersyes_no{{name.labelid}}"  ng-click="chekboxUncheckcorners(name.labelid)" class="form-check-input" value="1" id="CornersYes_{{name.labelid}}"> 
                                                                                                                </span>
                                                                                                                
                                                                                                                <span ng-if="name.corners==1">
                                                                                                                  <input type="checkbox" name="Cornersyes_no{{name.labelid}}" value="1" ng-click="chekboxUncheckcorners(name.labelid)"  class="form-check-input" id="CornersYes_{{name.labelid}}"> 
                                                                                                                </span>
                                                                                                         ...
                                                                                                         <td ng-if="namecate.categories_id!=1">
                                                                                                            ...
                                                                                                            <label for="CrimpYes_{{name.labelid}}">
                                                                                                                 <span ng-if="name.crimp_check==0">
                                                                                                                   <input type="checkbox" checked name="Crimpyes_no{{name.labelid}}" ng-click="chekboxUncheckcrimpcheck(name.labelid)" class="form-check-input" value="1" id="CrimpYes_{{name.labelid}}"> 
                                                                                                                </span>
                                                                                                                
                                                                                                                <span ng-if="name.crimp_check==1">
                                                                                                                   <input type="checkbox" name="Crimpyes_no{{name.labelid}}" value="1" ng-click="chekboxUncheckcrimpcheck(name.labelid)"  class="form-check-input" id="CrimpYes_{{name.labelid}}"> 
                                                                                                                </span>
...
app.controller('crudController', function($scope, $http){
 ...
 $scope.routeOrder = function(id,name) {
   ...
   $scope.fetchRouteorderassignorder('orders_process',<?php echo $status; ?>,id,1);
 ...
 $scope.chekboxUncheckcolor = function (id) {
                        ...
                        $http({
                          ...
                          data:{'id':id,'action':'qcstatuschange','idstatus':idstatus,'statuss':statuss,'field':'color'}
                            ...
                            $scope.procseeGroupcompleted(<?php echo $status; ?>);
                              $scope.fetchDatacompleted(<?php echo $status; ?>);
                              $scope.fetchDataCategorybasecompleted(<?php echo $status; ?>);
                  ...
                  if($(spiltparicel[i]).is(':checked')) {
                   ...
                   var order_production_no_cmd= order_product_id_set_value_no_cmd.join("|");
                    ...
                    data:{'order_product_id':order_product_id,'status':status,'order_production_no':order_production_no,'order_production_no_cmd':order_production_no_cmd,'order_id':'<?php echo $id; ?>', 'action':'processStatuschages','tablenamemain':'proudtcion_order_products'}
                      ...
                      $scope.procseeGroupcompleted(4);
                      $scope.fetchDatacompleted(4);
                      $scope.fetchDataCategorybasecompleted(4);
...
//end
  ...
  $scope.procseeGroup = function(id){
    ...
    $http.get('<?php echo base_url() ?>index.php/order/fetchDataCategorybase_order_process_group_by_order?order_id=<?php echo $id; ?>&tablename_sub=<?php echo 'order_product_list_process'; ?>&convert='+id).success(function(data){
 ...
 $scope.procseeGroupcompleted = function(id){
  ...
  $scope.fetchDataCategorybase = function(id){
    ...
    $http.get('<?php echo base_url() ?>index.php/order/fetchDataCategorybase_order_process_panel_order_by?order_id=<?php echo $id; ?>&tablename_sub=<?php echo 'order_product_list_process'; ?>&convert='+id).success(function(data){
...
$scope.fetchDatacompleted = function(status){
    ...
    $http.get('<?php echo base_url() ?>index.php/order/fetch_data_production_order_by?order_id=<?php echo $id; ?>&tablenamemain=<?php echo 'orders_process'; ?>&&tablename_sub=<?php echo 'order_product_list_process'; ?>&convert=1&production_id=1&status='+status).success(function(data){

                                                    ...
                                                    <div class="tab-pane" id="progress-company-document" >
                                                      <div>
                                                       ...
                                                       <a  target="_blank" href="<?php echo base_url(); ?>index.php/order/overview?order_id=<?php echo base64_encode($id); ?>&old_tablename=orders_quotation&old_tablename_sub=order_product_list_quotation&tablename=orders_process&tablename_sub=order_product_list_process&movetablename=orders_process&movetablename_sub=order_product_list_process" >Download</a> 
                                                                  ...
                                                                  <p><span> Bill Amount</span><span> Rs. {{fulltotaldel-tcsamount}}</span></p>
...
<p><span>SubTotal</span><span> Rs. {{collection_remarks}}</span></p>

 <p ng-if="loading_status==0"><span>Amount to collect</span><span> Rs. {{collection_remarks}}</span></p>
 <p ng-if="loading_status==1"><span>Amount to collect</span><span> Rs. {{collection_remarks}}</span></p>
                                                                        ...
                                                                        <div id="flush-collapseOne" class="accordion-collapse collapse" aria-labelledby="flush-headingOne"
                                                                            ...
                                                                            <div class="accordion-body p-1 text-muted">
                                                                                ...
                                                                                <div class="talbe-productList" ng-init="fetchDataCategorybase(1)">
                                                                                          ...
                                                                                          <div class="table-responsive"  ng-init="fetchData()">
      ...
      <table class="table" >
                                    ...
                                    <thead class="bg-gray text-red" ng-if="namecate.categories_id==1">
                                                                    ...
                                                                    <tr>
                                                                       ...
                                                                       <th class="table-width-3"> S.No</th>
                                                          ...
                                                          <th class="table-width-10" rowspan="2" ng-if="gst_check==1" > GST {{namecate. gst}} %  </th>
                                                                       <th class="table-width-10"  rowspan="2" >Net Rate </th>
                                                                        ...
                                                                        <th class="table-width-10"  rowspan="2" ng-if='namecate.uom!="Kg"' >{{namecate.uom}} </th>
                                                                       <th class="table-width-10 <?php echo $classdata; ?>"  rowspan="2" ng-if='namecate.uom=="Kg"' >Approx KG </th>
...
<span ng-if="name.sub_product_name_tab"> <hr></hr> Accessories Specification:  {{name.sub_product_name_tab}}</span>
                                             ...
                                             <td  class="qtyfind_{{namecate.type}}" ng-if='namecate.uom!="Kg"' >{{name.qty_tab}}
                                             </td>
                                              


                                            <td class="qtyfind_{{namecate.type}} <?php echo $classdata; ?>" ng-if='namecate.uom=="Kg"' >{{name.qty_tab}}
                                           ...
                                           <tr ng-if="namecate.categories_id==1">
                                             ...
                                             <th ng-if="commission_check==1" class="comdisplay"><b ></b></th>
                                              ...
                                              <th ><b  id="fullqty_{{namecate.categories_id}}">{{namecate.qty_tab}}</b></th>
                                            ...
                                            <th ></th>
                                             ...
                                             <th ><b  id="fulltotal_{{namecate.type}}">{{namecate.amount_total}} </b></th>
                                                        ...
                                                        <ul class="pager wizard twitter-bs-wizard-pager-link">
                                                            ...
                                                            <li class="next"><a href="javascript: void(0);" class="btn btn-primary" onclick="nextTab()" ng-click='reachedlocation()'>Next <i
                                                                        class="bx bx-chevron-right ms-1"></i></a></li>
                                                        </ul>
                                                      </div>
                                                    </div>
...
<div class="alert alert-danger alert-dismissible fade show" role="alert" ng-show="error">
                             ...
                             <input id="return_date" class="form-control"  name="create_date" required ng-model="create_date" type="date">
                                    ...
                                    <thead class="bg-gray text-red" ng-if="namecate.categories_id==1">
                                                                    ...
                                                                    <tr>
                                                                       ...
                                                                       <th class="table-width-3" "><input type="checkbox" id="checkall" ng-click="loadProductAll()"> S.No</th>
                                                                       <th class="table-width-18" rowspan="2"   >Products </th>
                                                                       <th class="table-width-8" >UOM</th>
                                                                       <th class="table-width-8" ng-if="namecate.labletype==2 || namecate.labletype==1"  style="padding-bottom:0px" >{{namecate.lable}} </th>
                                                                       <th class="table-width-8" ng-if="namecate.labletype==2"  >Length </th>
                                                          ...
                                                          <th class="table-width-10" rowspan="2" ng-if="gst_check==1" > GST {{namecate. gst}} %  </th>
                                                                       ...
                                                                       <th class="table-width-10"  rowspan="2" >Amount </th>
                                                                       <th class="table-width-10"  rowspan="2" >Weight </th> <th class="table-width-10">#</th>
                            ...
                            <th class="table-width-15" ng-if="namecate.labletype==19" >Coil_no 
                                                  ...
                                                  <th class="table-width-10" rowspan="2" ng-if="gst_check==1" > GST {{namecate. gst}} % </th>
                                                                       ...
                                                                       <th class="table-width-10"  rowspan="2" >Amount </th>
                                                                         ...
                                                                         <th class="table-width-10"  rowspan="2" >Weight </th>
    ...
    <tbody  ng-repeat="name in namesData|orderBy:column:reverse" ng-if="namecate.categories_id==1">
                                          ...
                                          <tr class="view" ng-if="namecate.categories_id==name.categories_id_get">
                                             <td ><input type="checkbox" class="purchase_order_product_id" name="purchase_order_product_id" value="{{name.id}}"> {{name.no}}</td>
                                             <td title="{{name.categories}}">{{name.product_name_tab}} <span ng-if="name.select_profile"> <br> Profile ---> {{name.select_profile}}</span> 
<span ng-if="name.sub_product_name_tab"> <hr></hr> Accessories Specification:  {{name.sub_product_name_tab}}</span>
                                             ...
                                             <td >
                                                 ...
                                                 <input type="textt" value="{{name.nos_tab}}" data-nos="{{name.nos_tab}}" ng-keyup="inputsave_1(name.id,'nos',name.categories_id,name.type,name.profile_tab,name.crimp_tab,name.fact_tab,name.rate_tab,name.uom,name.weight)" id="nos_{{name.id}}" class="form-control order_nos" name="order_nos" >
...
$scope.fetchSingleDatatotaldel = function(){
    $http({
      method:"POST",
      url:"<?php echo base_url() ?>index.php/order/fetch_single_data_totaldel?order_id=<?php echo $id; ?>&DC_id=<?php echo $DC_id; ?>",

...
app.controller('crudController', function($scope, $http){
  ...
  $scope.to_date = new Date();
   ...
   function getData() {
     ...
     $http.get('<?php echo base_url() ?>index.php/order_check/fetch_data_production_order_by_print?order_id=0&cancelid=-1&tablenamemain=<?php echo 'orders_process'; ?>&&tablename_sub=<?php echo 'order_product_list_process'; ?>&convert=1&production_id=1&status=0&from_date='+from_date+'&to_date='+to_date+'&order_no1='+order_no1+'&order_no2='+order_no2)

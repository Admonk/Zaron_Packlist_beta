                                                ...
                                                <div class="flex-shrink-0">
                                                   <ul class="nav justify-content-end nav-tabs-custom rounded card-header-tabs" role="tablist" ng-init="getcount('orders_quotation')">
                                                      <li class="nav-item" style="display:none;">
                                                         <a class="nav-link"  ng-click="disable_load()" href="<?php echo base_url(); ?>index.php/order/ordercreate_product_quotation?order_id=<?php echo $neworder_id; ?>" role="tab">
                                                                  ...
                                                                  <tbody>
                                                                      ...
                                                                      <tr  ng-repeat="name in namesData" class="{{name.color}}">
                                                                          ...
                                                                          <td>
                                                                              ...
                                                                              <a ng-click="disable_load()" href="<?php echo base_url(); ?>index.php/order/ordercreate_product_quotation?order_id={{name.base_id}}">{{name.order_no}}</a>
                                                                              
                                                                              
                                                                              
                                                                              </td>
                                                                          <td><a ng-click="disable_load()" href="<?php echo base_url(); ?>index.php/order/ordercreate_product_quotation?order_id={{name.base_id}}">{{name.name}}</a></td>
                                                                          <td>
                                                                              <a ng-click="disable_load()" href="<?php echo base_url(); ?>index.php/order/ordercreate_product_quotation?order_id={{name.base_id}}">{{name.phone}}</a>
                                                                          </td>
                                                                          
                                                                        <td><a ng-click="disable_load()" href="<?php echo base_url(); ?>index.php/order/ordercreate_product_quotation?order_id={{name.base_id}}">
                                                                           ...
                                                                           <td><a ng-click="disable_load()" href="<?php echo base_url(); ?>index.php/order/ordercreate_product_quotation?order_id={{name.base_id}}">{{name.totalamount | indianCurrency}}</a></td>
                                                                         ...
                                                                         <span ng-if="name.order_base==-1">
                                                                          ...
                                                                          <td><a ng-click="disable_load()" href="<?php echo base_url(); ?>index.php/order/ordercreate_product_quotation?order_id={{name.base_id}}">{{name.order_by}}</a></td>
                                                                          
                                                                         
                                                                           <td><a ng-click="disable_load()" href="<?php echo base_url(); ?>index.php/order/ordercreate_product_quotation?order_id={{name.base_id}}">{{name.quotation_date}}</a></td>
                                                                          <td><a ng-click="disable_load()" href="<?php echo base_url(); ?>index.php/order/ordercreate_product_quotation?order_id={{name.base_id}}">{{name.enquiry_date}} </a></td>
                                                                          <td>
                                                                               ...
                                                                               <a ng-click="disable_load()" href="<?php echo base_url(); ?>index.php/order/ordercreate_product_quotation?order_id={{name.base_id}}" ><i class="mdi mdi-eye font-size-16 text-success me-1"></i> View</a>
...
$scope.getcount = function (tabelename) {
 ...
 $http({
      ...
      data:{'pincode':$scope.pincode}
       ...
       $scope.totalenquiry=data.pending+data.proceed+data.cancel+data.reassign+data.remainder;

...
<div class="modal fade bs-example-modal-center" tabindex="-1" role="dialog" aria-hidden="true">
                                                ...
                                                <div class="flex-shrink-0">
                                                   <ul class="nav justify-content-end nav-tabs-custom rounded card-header-tabs" role="tablist" >
                                                        ...
                                                        <li class="nav-item ">
                                                         ...
                                                         <span class="d-none d-sm-block"><?php echo $title; ?> <span class="badge rounded-pill bg-danger  float-end"> {{totalItems}} </span></span>   
                                                         </a>
                                                         </li> 
    ...
    <a href=" <?php echo base_url(); ?>index.php/order/pickup_orders_list_view?id={{name.id}}&driver_pickip=0&DC_id={{name.randam_id}}&approved_view=1" target="_blank"><i class="mdi mdi-truck font-size-16 text-success me-1"></i>Check Dispatch</a>
  ...
  $scope.to_date = new Date();
   ...
   function getData() {
      ...
      var to_date = $('#to_date').val();
       var approved_status = order_base;
  
      
     $http.get('<?php echo base_url() ?>index.php/order_second/fetch_data_table_delivery_notes?page=' + $scope.currentPage + '&size=' + $scope.pageSize + '&search=' + $scope.searchText + '&tablename=' + $scope.tablename+'&order_base='+order_base+'&from_date='+from_date+'&to_date='+to_date+'&list=delivery&approved_status='+approved_status)
...
$scope.onPre = function(currentPage,pageSize){
  ...
  function getDataPage(currentPage,pageSize) {
      ...
      var to_date = $('#to_date').val();
        ...
        $http.get('<?php echo base_url() ?>index.php/order_second/fetch_data_table_delivery_notes?page_next=' + currentPage + '&size=' + pageSize + '&search=' + $scope.searchText + '&tablename=' + $scope.tablename+'&order_base='+order_base+'&from_date='+from_date+'&to_date='+to_date+'&list=delivery')
        .success(function(data) {
            $scope.namesData = [];
            $scope.totalItems = data.totalCount;

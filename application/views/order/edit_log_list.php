                   ...
                   <div class="row">
                                    <div class="col-6">
                                         <div class="page-title-box d-sm-flex align-items-center justify-content-between p-0">
                                            <h4 class="mb-sm-0 font-size-18">Edit Log <?php echo $order_no; ?></h4>
                                        </div>
                                    </div>
                                                ...
                                                <div class="flex-shrink-0">
                                                   <ul class="nav justify-content-end nav-tabs-custom rounded card-header-tabs" role="tablist" >
                                                      ...
                                                      <li class="nav-item">
                                                         ...
                                                         <span class="d-none d-sm-block"><?php echo $order_no; ?> </span> 
                                                         </a>
                                                      </li>
                                                              ...
                                                              <table class="table align-middle table-nowrap newBorderedTable" >
                                                                  ...
                                                                  <tbody>
                                                                      ...
                                                                      $i=1;
                                                                        ...
                                                                        foreach ($bill_changes_log as $value) 
                                                                        {
                                                                      ?>
                                                                      ...
                                                                      <tr>
                                                                          ...
                                                                          <td ><p  style="width: 450px;"><?php echo $value->notes; ?></p></td>
                                                                          <td><?php 

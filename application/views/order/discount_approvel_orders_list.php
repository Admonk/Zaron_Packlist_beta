...
<div class="modal fade bs-example-modal-center" id="re_date" tabindex="-1" role="dialog" aria-hidden="true">
                                                ...
                                                <div class="flex-shrink-0">
                                                   <ul class="nav justify-content-end nav-tabs-custom rounded card-header-tabs" role="tablist" >
                                                       ...
                                                       <li class="nav-item ">
                                                         ...
                                                         <span class="d-sm-block">Collection verification </span>   
                                                         </a>
                                                      </li> 
                                                ...
                                                <div class="table-responsive" >               
                                                              <table class="table align-middle table-nowrap newBorderedTable" >
                                                                  ...
                                                                  <tbody>
                                                                      ...
                                                                      <tr  ng-repeat="name in namesData" ng-if="name.totalamount!=name.collectamount">
                                                                          <td>
                                                                         ...
                                                                         <td><a href="<?php echo base_url(); ?>index.php/order/ordercreate_product_process?order_id={{name.base_id}}">{{name.collectamount | indianCurrency}}</a></td>
                                                                        
                                                                        <td><a href="<?php echo base_url(); ?>index.php/order/ordercreate_product_process?order_id={{name.base_id}}">{{name.totalamount-name.collectamount | indianCurrency }}</a></td>
                                                                        ...
                                                                        <td><a href="<?php echo base_url(); ?>index.php/order/ordercreate_product_process?order_id={{name.base_id}}">
                                                                          ...
                                                                          <td><a href="<?php echo base_url(); ?>index.php/order/ordercreate_product_process?order_id={{name.base_id}}">{{name.create_date}} </td>
                        ...
                        <button type="button"  ng-click="coniformed()" class="btn btn-success waves-effect waves-light" >Discount request</button>
...
app.controller('crudController', function($scope, $http){
  ...
  //$scope.to_date = new Date();
   ...
   function getData() {
     ...
     $http.get('<?php echo base_url() ?>index.php/order/fetch_data_table_discount_approvel?page=' + $scope.currentPage + '&size=' + $scope.pageSize + '&search=' + $scope.searchText + '&tablename=' + $scope.tablename+'&order_base='+order_base+'&from_date='+from_date+'&to_date='+to_date)
...
$scope.onPre = function(currentPage,pageSize){
  ...
  function getDataPage(currentPage,pageSize) {
      ...
      var to_date = $('#to_date').val();
        ...
        $http.get('<?php echo base_url() ?>index.php/order/fetch_data_table_discount_approvel?page_next=' + currentPage + '&size=' + pageSize + '&search=' + $scope.searchText + '&tablename=' + $scope.tablename+'&order_base='+order_base+'&from_date='+from_date+'&to_date='+to_date)
        .success(function(data) {
            $scope.namesData = [];
            $scope.totalItems = data.totalCount;
             ...
             if (confirm("Are you sure confirm!") == true) 
             {
                   ...
                   $('input[name="customerlistcheck"]:checked').each(function(){
                     ...
                     var checkinsert= product_order_id.join("|");
                        ...
                        $http({
                          method:"POST",
                          url:"<?php echo base_url() ?>index.php/order/discount_request_for_md",
                          data:{'order_id':checkinsert}
                        }).success(function(data){
                           
                           
                          
                            alert('MD Approvel Request submited');
                            getData();
             ...
             if (confirm("Are you sure confirm!") == true) 
             {
                   ...
                   $('input[name="customerlistcheck"]:checked').each(function(){
                     ...
                     var checkinsert= product_order_id.join("|");
                        ...
                        $http({
                          method:"POST",
                          url:"<?php echo base_url() ?>index.php/order/discount_rejected_for_sale",
                          data:{'order_id':checkinsert}
                        }).success(function(data){

...
<script src="https://cdnjs.cloudflare.com/ajax/libs/html2pdf.js/0.9.3/html2pdf.bundle.min.js" ></script>
	...
	{ 
		...
		$(document).on('click', '.btn_print', function(event) 
		{
			...
			{
			  margin:       -0.2,
			  filename:     'Order_Invoice_'+js.AutoCode()+'.pdf',
                                       ...
                                       <thead class="bg-gray text-red" ng-if="namecate.categories_id==1">
                                          ...
                                          <tr>
                                             ...
                                             <th class="table-width-10"  rowspan="2" >Amount </th>
                                               ...
                                               <th class="table-width-10" data-priority="6" colspan="3" >Attachment</th>
                                          ...
                                          <tr class="view" ng-if="namecate.categories_id==name.categories_id_get && namecate.type==name.type">
                                             ...
                                             <td id="amount_{{name.id}}" class="amounttot_{{namecate.type}}">{{name.amount_tab}}</td>
                                              ...
                                              <td  ng-if="name.reference_image!=0">
                                                 ...
                                                 <a href="{{name.reference_image}}" style="margin: 15px 5px;" target="_blank"> <img src="{{name.reference_image}}" style="width: 50px;border: #4a4a4a solid 1px;" > </a>

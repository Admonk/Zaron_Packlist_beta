...
$from_date_url = $_GET['fromDate'];
$to_date_url = $_GET['toDate'];
} 
?>
                                                ...
                                                <div class="flex-shrink-0">
                                                   <ul class="nav justify-content-end nav-tabs-custom rounded card-header-tabs" role="tablist" ng-init="getcount('orders_process')">
                                                      ...
                                                      <li class="nav-item">
                                                       ...
                                                       <li class="nav-item">
                                                         <a class="nav-link" data-bs-toggle="tab" href="#messages3" role="tab" ng-click="pageTab('orders_process',28)">
                                                         <span class="d-block d-sm-none"><i class="far fa-envelope"></i></span>
                                                      ...
                                                      <?php
                                                       ...
                                                       <li class="nav-item">
                                                         ...
                                                         <span class="d-block d-sm-none"><i class="far fa-envelope"></i></span>
                                                         <span class="d-none d-sm-block">Order req from customer <span class="badge rounded-pill bg-success  float-end"> {{missing}} </span></span>   
                                                         </a>
                                                      </li> 
                                              ...
                                              <div class="col-12">
                                                  <div class="card shadow-none">
                                                      <div class="card-body">
                                                         ...
                                                         <div class="col-md-8" id="showbtn" style="display: none;">
             
              <a href="#" class="btn btn-secondary active ssd" id="ss1" ng-click="pageTab('orders_process',156)">Pending</a>
             

              
              <a href="#" class="btn btn-secondary ssd" id="ss2" ng-click="pageTab('orders_process',157)">Approved</a>
                          ...
                          <div class="col-sm-3">
                          <label>From Date: </label><input type="date" class="form-control" id="from_date" ng-model="from_date" ng-change="DateFilter()" value="<?=$from_date_url?>">
                          </div>
                          
                           <div class="col-sm-3">
                           <label>To Date:</label><input type="date" class="form-control" id="to_date" ng-model="to_date" value="<?=$to_date_url?>" ng-change="DateFilter()">
                           </div>
                                                ...
                                                <div class="table-responsive" >               
                                                    ...
                                                    <tr  ng-repeat="name in namesData" class="{{name.color}}">
                                                                          <td>
                                                                              <div class="form-check font-size-16">
                                                                                  ...
                                                                                  <label class="form-check-label" for="customerlistcheck01"></label>
                                                                                   <input type="hidden" name="order_ids" class="order_ids" value="{{name.id}}">
                                                                              </div>
                                                                          </td>
                                                                          ...
                                                                          <td><a href="<?php echo base_url(); ?>index.php/order/ordercreate_product_process?order_id={{name.base_id}}">
                                                                           ...
                                                                           <!-- <td><a href="<?php echo base_url(); ?>index.php/order/ordercreate_product_process?order_id={{name.base_id}}">
 <span ng-if="name.tcsamount>0">{{name.tcsamount | indianCurrency}}</span>
                                                                  ...
                                                                  if($this->session->userdata['logged_in']['access']!=12)
                                                                                            {
                                                                                               ...
                                                                                               ?>
<span ng-if="name.reason_by" style="color:red;"><br>{{name.reason_by}}</span>
                                                                        ...
                                                                        <td>
                                                                          ...
                                                                          <td><a href="<?php echo base_url(); ?>index.php/order/ordercreate_product_process?order_id={{name.base_id}}">{{name.order_by}}</a></td>
                                                                           ...
                                                                           <td><a href="<?php echo base_url(); ?>index.php/order/ordercreate_product_process?order_id={{name.base_id}}">{{name.order_date}}</a></td>
                                                                          <td><a href="<?php echo base_url(); ?>index.php/order/ordercreate_product_process?order_id={{name.base_id}}">{{name.quotation_date}}</a></td>
                                    ...
                                    <div class="card-body">
                                        <div class="d-flex align-items-center">
                                            <div class="flex-grow-1">
                                                ...
                                                <h4 class="mb-3">
                                                    Rs.<span class="counter-value" data-target="<?php echo sprintf($toatalvalue); ?>"><?php echo sprintf("%.2f",$toatalvalue); ?></span>
                                                </h4>
                                                <div class="text-nowrap">
                                                    <span class="badge bg-soft-success text-danger counter-value"  data-target="<?php echo sprintf($toatalvaluels); ?>"><b><?php echo round($toatalvaluels,2); ?></b></span>
                                    ...
                                    <div class="card-body">
                                        <div class="d-flex align-items-center">
                                            <div class="flex-grow-1">
                                                ...
                                                <h4 class="mb-3">
                                                    <span class="counter-value count" data-target="<?php echo $totalcount; ?>"><?php echo $totalcount; ?></span>
                                                </h4>
                                                <div class="text-nowrap">
                                    ...
                                    <div class="card-body">
                                        <div class="d-flex align-items-center">
                                            <div class="flex-grow-1">
                                                ...
                                                <div class="text-nowrap">
                                                    <span class="badge bg-soft-success text-danger counter-value" data-target="<?php echo round($toatalvaluelsdd,2); ?>"><b><?php echo round($toatalvaluelsdd,2); ?></b></span>
                                    ...
                                    <div class="card-body">
                                        <div class="d-flex align-items-center">
                                            <div class="flex-grow-1">
                                                ...
                                                <h4 class="mb-3">
                                                    <span class="counter-value count" data-target="<?php echo $totalcountdd; ?>"><?php echo $totalcountdd; ?></span>
                                                </h4>
                                                <div class="text-nowrap">
  ...
  $scope.error = false;
   ...
   var date = new Date();
    ...
    getData();
     ...
     function getDataTotal(order_id) {
           ...
           $http.get('<?php echo base_url() ?>index.php/order_second/fetch_single_data_total_loop?order_id=' + order_id)
     ...
     function getDataTotalC(customer_id) {
...
if(isset($_GET['fromDate']) && isset($_GET['toDate'])){
  ?>
   $scope.from_date = parseDate('<?=$from_date_url?>');
   $scope.to_date = parseDate('<?=$to_date_url?>');
...
?>
   function getData() 
   {
     ...
     let orders = '<?=isset($_GET['orders']) ? $_GET['orders'] : ''?>';
        console.log(atob(orders));
     $http.get('<?php echo base_url() ?>index.php/order/fetch_data_table?page=' + $scope.currentPage + '&size=' + $scope.pageSize + '&search=' + $scope.searchText + '&tablename=' + $scope.tablename+'&order_base='+order_base+'&from_date='+from_date+'&to_date='+to_date+'&orders='+ orders)
        .success(function(data) {
            $scope.namesData = [];
            ...
            angular.forEach(data.PortalActivity, function(temp){
              ...
              for(var i = 0; i < data.PortalActivity.length; i++)
              {
                  var order_id = data.PortalActivity[i].id;
                  var customer_id = data.PortalActivity[i].customer_id;
                 
                  if(order_id>0)
                  {
                       getDataTotal(order_id);
                       getDataTotalC(customer_id);
...
$('.counter-value').each(function(){
        $(this).prop('Counter',0).animate({
            ...
            step: function (now){
              ...
              if(! $(this).hasClass('count'))
                $(this).text(new Intl.NumberFormat('en-IN', { minimumFractionDigits: 2 }).format(now));
 ...
 $(document).ready(function() {
  let baseIdInUrl = <?= isset($_GET['base']) ? $_GET['base']  : '0' ?>;

  if(baseIdInUrl != '0'){
    $('[ng-click*="'+baseIdInUrl+'"]')[0].click('click');

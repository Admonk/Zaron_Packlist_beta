                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-lg-6">
                                                                              <div class="border rounded gray p-2"  ng-init="procseeGroup(1)">
                                                                                 ...
                                                                                 <!-- end dropdown -->
                                                                                 <h4 class="card-title mb-4">Production Started List</h4>
                                                                                 <div id="task-1">
                                                                                           ...
                                                                                           <table class="table mb-0" >
                                                                                                ...
                                                                                                <tbody  ng-repeat="name in namesData">
                                                                                                    ...
                                                                                                    <tr ng-if="namecate.categories_id==name.categories_id_get && namegroup.proudtcion_id==name.proudtcion_id"  id="show_{{name.labelid}}" class="trpoint">
                                                                                                        ...
                                                                                                        <td style="width: 155px;"><label for="check_{{name.labelid}}">{{name.product_name_tab}}</label></td>
...
$scope.inputsave_1 = function (id) {
                        ...
                        $http({
                          method:"POST",
                          url:"<?php echo base_url() ?>index.php/order/insertandupdate?product_id=<?php echo $product_id; ?>",
...
$scope.fetchProcessproduct = function(order_product_id){
      $http.get('<?php echo base_url() ?>index.php/order/fetch_data_order_process?tablename=proudtcion_order_products&order_product_id='+order_product_id+'&product_id=<?php echo $product_id; ?>').success(function(data){
...
//end
  ...
  $scope.procseeGroup = function(id){
    ...
    $http.get('<?php echo base_url() ?>index.php/order/fetchDataCategorybase_order_process_group_base_data?product_id=<?php echo $product_id; ?>&tablename_sub=<?php echo 'order_product_list_process'; ?>&convert='+id).success(function(data){
...
$http.get('<?php echo base_url() ?>index.php/order/fetchDataCategorybase_by_production?product_id=<?php echo $product_id; ?>&tablename_sub=<?php echo 'order_product_list_process'; ?>&convert='+id).success(function(data){
  ...
  $scope.fetchDataCategorybasecompleted = function(id){
    ...
    $http.get('<?php echo base_url() ?>index.php/order/fetchDataCategorybase_order_process_panel_base_data?product_id=<?php echo $product_id; ?>&tablename_sub=<?php echo 'order_product_list_process'; ?>&convert='+id).success(function(data){
...
$scope.fetchDatacompleted = function(status){
    ...
    $http.get('<?php echo base_url() ?>index.php/order/fetch_data_production?product_id=<?php echo $product_id; ?>&tablenamemain=<?php echo 'orders_process'; ?>&&tablename_sub=<?php echo 'order_product_list_process'; ?>&convert=1&production_id=1&status='+status).success(function(data){

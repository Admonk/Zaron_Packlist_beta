...
<hr style="color: #c3c3c3;"></hr>
                    ...
                    <div class="invoice-info">
                        <div class="row">
                              <div class="col-md-4 invoice-details" ng-init="fetchCustomerorderdata()">
                                ...
                                <div class="col-md-4 invoice-details">
                                   <p class="inv-title-1">Order No:  {{order_no_id}}  <b ng-if="SSD_check>0" class="font-size-30" style="color: red;border: #d9d9d9 solid 2px; padding: 2px 9px;">  SDP  </b> (BETA)</p> 
                                                    
                                    <p class="invo-addr-1"> Date : {{create_date}}</p>
                                    
                                    <p ng-if="payment_mode" style="font-size: 20px; border: #b3b3b3 solid 6px; padding: 3px 8px;">Payment Mode :  {{payment_mode}}
 ...
 : {{collection_remarks  | number : 2}}</span>    
                                    ...
                                    <p ng-if="salesphone">Sales Contact No : <span >{{salesphone}}</span> <span>{{salesphone2}}</span> </p> 
                                           <p   style="font-size: 20px; border: #b3b3b3 solid 6px; padding: 3px 8px;"><b>Net Total : Rs. {{discountfulltotal | number : 2}} </b></p>
                                       ...
                                       <thead class="bg-gray text-red" ng-if="namecate.categories_id==1">
                                          ...
                                          <tr>
                                             ...
                                             <!-- <th class="table-width-10" rowspan="2" ng-if="base_check==1" style="text-align:right;"> Basic Rate </th>
                                              <th class="table-width-10" rowspan="2" ng-if="gst_check==1" style="text-align:right;"> GST {{namecate. gst}}% </th> -->
                                        ...
                                        <thead class="bg-gray text-red" ng-if="namecate.categories_id!=1">
                                          ...
                                          <tr>
                                             ...
                                             <th class="table-width-18" ng-if="namecate.labletype==4 || namecate.categories_id==599" rowspan="2"  >Tile Material </th>
 ...
 <th class="table-width-15" ng-if="namecate.labletype==19" >Remarks
  ...
  <th class="table-width-15" ng-if="namecate.labletype==19" >Coil_no 
                                             ...
                                             <th class="table-width-8" ng-if="(namecate.labletype==1 || namecate.labletype==6 || namecate.labletype==11 || namecate.labletype==12 || namecate.labletype==7) && namecate.categories_id!=5"
                            data-label="{{ namecate.lable2 }}"  style="padding-bottom:0px" >{{namecate.lable2}} </th>
                                             


                                             <th class="table-width-3" ng-if="namecate.labletype!=9"  rowspan="2" ng-click='sortColumn("nos_tab")' ng-class='sortClass("nos_tab")' style="text-align:right;">{{namecate.lablenos}} </th>

                                              <th class="table-width-3" ng-if="namecate.categories_id==13"  rowspan="2" ng-click='sortColumn("fact_tab")' ng-class='sortClass("nos_tab")' style="text-align:right;">{{namecate.lablefact1}} <br> {{namecate.lablefact2}} </th>
                                            ...
                                            <!-- For GST Task, Creating SGST and CGST from july 1 -->
                                <!-- comment GST and Basic Rate -->
                                            <!-- <th class="table-width-10" rowspan="2" ng-if="base_check==1" style="text-align:right;"> Basic Rate </th>
                                          <th class="table-width-10" rowspan="2" ng-if="gst_check==1" style="text-align:right;"> GST {{namecate. gst}} % </th> -->
                                             <!-- <th class="table-width-10"  rowspan="2" style="text-align:right;">Net Rate </th> -->
                                <!-- change Net rate to basic rate -->
                                             <th class="table-width-10"  rowspan="2" style="text-align:right;">Basic Rate </th>
...
<span ng-if="name.sub_product_name_tab"> <hr></hr> Accessories Specification:  {{name.sub_product_name_tab}}</span>
                                             ...
                                             <td><select class="selectbox"  disabled><option value="3" ng-selected="{{name.uom == 3}}">FEET</option><option value="4" ng-selected="{{name.uom == 4}}">MM</option><option value="5" ng-selected="{{name.uom == 5}}">MTR</option><option value="6" ng-selected="{{name.uom == 6}}">INCH</option>

                                              <option value="2" ng-selected="{{name.uom == 2}}">SQMRT</option>
                                              <option value="8" ng-selected="{{name.uom == 8}}">SFT</option>
                                             ...
                                             <!-- <td ng-if="base_check==1" style="text-align:right;">{{name.base_rate}}</td>
                                               <th ng-if="gst_check==1" style="text-align:right;"><b  >{{name.gst_price | number : 2}}</b></th> -->
                                             ...
                                             <td id="qty_{{name.id}}" class="qtyfind_{{namecate.type}} <?php echo $classdata; ?>" ng-if='namecate.uom=="Kg"' style="text-align:right;">{{name.qty_tab}}</td>
...
<span ng-if="name.sub_product_name_tab"> <hr></hr> Accessories Specification:  {{name.sub_product_name_tab}}</span>
                                              ...
                                              <td  ng-if="namecate.labletype==4  || namecate.labletype==16 || namecate.labletype==19 || namecate.categories_id==592 || namecate.categories_id==599">{{name.tile_material_name}}</td>
                                            ...
                                            <td  ng-if="namecate.labletype!=9">
                                             ...
                                             <td  ng-if="namecate.labletype==5 || namecate.labletype==6">
                                              ...
                                              <td ng-if="namecate.labletype==11 || namecate.labletype==12">{{name.dim_two}}</td>
                                               <td ng-if="namecate.labletype==12">{{name.dim_three}}</td>
                                             ...
                                             <td ng-if="namecate.labletype==8" >{{name.crimp_tab}}</td>
                                             <td ng-if="(namecate.labletype==1 || namecate.labletype==6 || namecate.labletype==11 || namecate.labletype==12 || namecate.labletype==7) && namecate.categories_id!=5">{{name.crimp_tab}}</td>
                                             <td ng-if="namecate.labletype!=9" style="text-align:right;">{{name.nos_tab}}</td>
                                              <td ng-if="namecate.categories_id==13" style="text-align:right;">{{name.fact_tab}}</td>
                                             ...
                                             <td  style="text-align:right;" id="qty_{{name.id}}" class="qtyfind_{{namecate.type}} <?php echo $classdata; ?>" ng-if='namecate.uom=="Kg"'>{{name.qty_tab}}</td>
...
<!--                                              
                   ...
                   if(count($overview_invoice_content_base_order)>0) 
                   {
                       ...
                       //$Notes=$overview_invoice_content_base_order[13]->input_text;
                      // $Notes=$overview_invoice_content_base_order[14]->input_text;
                       
                   }
                   ?>
                    
                    <form action="<?php echo base_url(); ?>index.php/order/save_content_by_overview" method="POST" class="<?php echo $Content_view; ?>">
                          ...
                          <div class="col-sm-12 sssv">
                              <div class="payment-info gray-dark row">
                                 ...
                                 <div class="col-lg-9 col-md-9 col-sm-12">
                                    <input type="text" class="form-control linetext" id="notes" name="notes" value="<?php echo $notes_section; ?>" >
                            ...
                            <div class="col-sm-12">
                                 ...
                                 <div class="col-lg-9 col-md-9 col-sm-12">
                                      ...
                                      <p style="color: #575e64;font-size: 14px;">Zaron reserves the right to modify or remove any of the above description without prior notice to client.</p>
                                    <p style="color: #575e64;font-size: 14px;">Zaron reserves the right to cancel the order at any point of time without prior notice to client.</p>
...
<div style="position: relative; margin-bottom: 20px;">
    <hr style="border-top: 2px dashed #757373; margin: 0;">
    <img src="<?php echo base_url(); ?>/assets/packlist_images/scissors.png" 
         style="position: absolute; bottom: -12px; right: 0; transform: translateX(50%); width: 24px; height: 24px;" 
         alt="scissors">
</div>
...
<?php
$this->db->where('delivery_date_status','1');
$this->db->where('order_id',$order_id);
$this->db->order_by('id','desc');
$status_data=$this->db->get('order_delivery_order_status');
$status_show=$status_data->row();

?>

<div class="row mt-4">

<?php  if($status_show->payment_mode == 'Bank Transfer' && $status_show->utr_status == '1' ) { ?>

    <div class="col col-md-3 invoice-to" style="text-align: -webkit-center!important;">
        <img src="<?php echo base_url(); ?>/assets/packlist_images/symbols.png" style="width:100px!important;">
        <p style="color:#757373;margin-top: 10px; font-size: 14px; font-weight: bold;">UTR</p>
    </div>

<?php } ?>

<?php  if($status_show->sample_load_status == '1' ) { ?>

    <div class="col col-md-3 invoice-to" style="text-align: -webkit-center!important;">
        <img src="<?php echo base_url(); ?>/assets/packlist_images/payment.png" style="width:100px!important;">
        <p style="color:#757373;margin-top: 10px; font-size: 14px; font-weight: bold;">கேஷ் பில்</p>
    </div>
    <?php } ?>
    <?php  if( $status_show->cash_bill_status == '1' ) { ?>

    <div class="col col-md-3 invoice-to" style="text-align: -webkit-center!important;">
        <img src="<?php echo base_url(); ?>/assets/packlist_images/loading.png" style="width:100px!important;">
        <p style="color:#757373;margin-top: 10px; font-size: 14px; font-weight: bold;">சாம்பிள் லோட் எடுக்கவும்</p>
    </div>
    <?php } ?>
    <?php  if( $status_show->site_status == '1' ) { ?>

    <div class="col col-md-3 invoice-to" style="text-align: -webkit-center!important;">
        <img src="<?php echo base_url(); ?>/assets/packlist_images/receipt.png" style="width:100px!important;">
        <p style="color:#757373;margin-top: 10px; font-size: 14px; font-weight: bold;">பில் கொடுக்க வேண்டாம்</p>
    </div>
    <?php } ?>
    <?php  if( $status_show->tax_status == '1' ) { ?>

    <div class="col col-md-3 invoice-to" style="text-align: -webkit-center!important;">
        <img src="<?php echo base_url(); ?>/assets/packlist_images/customer-service.png" style="width:100px!important;">
        <p style="color:#757373;margin-top: 10px; font-size: 14px; font-weight: bold;">பில் கொடுக்குமுன் கால் செய்யவும்</p>
    </div>
    <?php } ?>
</div>
...
<div class="container invoice-btn-section clearfix d-print-none mb-4 <?php echo $Content_view; ?>">

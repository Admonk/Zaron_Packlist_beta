                                                ...
                                                <div class="flex-shrink-0">
                                                   <ul class="nav justify-content-end nav-tabs-custom rounded card-header-tabs" role="tablist" >
                                                       ...
                                                       <li class="nav-item ">
                                                         ...
                                                         <span class="d-sm-block">Screw Order Product list</span> 
                                                         </a>  
...
app.controller('crudController', function($scope, $http){
  ...
  $scope.to_date = new Date();
   ...
   function getData() {
     ...
     $http.get('<?php echo base_url() ?>index.php/order/screw_order_product_list_get?page=' + $scope.currentPage + '&size=' + $scope.pageSize + '&search=' + $scope.searchText + '&tablename=' + $scope.tablename+'&order_base='+order_base+'&from_date='+from_date+'&to_date='+to_date)
...
$scope.onPre = function(currentPage,pageSize){
  ...
  function getDataPage(currentPage,pageSize) {
      ...
      var to_date = $('#to_date').val();
        ...
        $http.get('<?php echo base_url() ?>index.php/order/screw_order_product_list_get?page_next=' + currentPage + '&size=' + pageSize + '&search=' + $scope.searchText + '&tablename=' + $scope.tablename+'&order_base='+order_base+'&from_date='+from_date+'&to_date='+to_date)
        .success(function(data) {
            $scope.namesData = [];
            $scope.totalItems = data.totalCount;

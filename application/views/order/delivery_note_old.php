            ...
            <div class="invoice-info">
              <div class="row">
                ...
                <div class="col-md-4 invoice-details">
                  ...
                  <b> DC ID : <span><?php echo $DC_id; ?></span>  </b>
            ...
            <div class="order-summary">
              <div class="table-responsive" ng-init="fetchDataCategorybase(1)">
                ...
                <div navigatable ng-init="fetchData('1')">
                  <div class="navclass">
                    <div ng-repeat="namecate in namesDatacate">
                      ...
                      <h5 style="text-align: left; margin: 9px auto;">{{namecate.no}}. {{namecate.categories_name}} </h5>
                        ...
                        <table id="datatable" border="yes">
                          ...
                          <thead class="bg-gray text-red" ng-if="namecate.categories_id==1">
                            ...
                            <tr>
                              ...
                              <th class="table-width-6" ng-if="namecate.labletype==2 || namecate.labletype==1" rowspan="2" style="padding-bottom:0px;text-align:right;">QTY ({{namecate.lablenos}}) </th>
                          ...
                          <thead class="bg-gray text-red" ng-if="namecate.categories_id!=1">
                            ...
                            <tr>
                              ...
                              <th ng-if="namecate.labletype==12">Dim 2</th>


                              <th ng-if="namecate.labletype==8 ||  namecate.labletype==1 || namecate.labletype==15 ||  namecate.labletype==4 ||  namecate.labletype==5 || namecate.labletype==6 || namecate.labletype==7 || namecate.labletype==16 || namecate.labletype==10 || namecate.labletype==11 || namecate.labletype==12" style="padding-bottom:0px">{{namecate.lable}} </th>
                              ...
                              <th ng-if="namecate.labletype==11 || namecate.labletype==12 || namecate.labletype==15">{{namecate.lable2}} </th>


                              <th ng-if="namecate.labletype==1 || namecate.labletype==6" style="padding-bottom:0px">{{namecate.lable2}} </th>


                              <th ng-if="namecate.labletype!=9">UOM<small>(Billing)</small></th>
                              ...
                              <th ng-if="namecate.labletype!=9">UOM<small>(Default)</small></th>


                              <th class="table-width-6" ng-if="namecate.labletype!=9" rowspan="2" ng-click='sortColumn("nos_tab")' ng-class='sortClass("nos_tab")' style="text-align:right;">QTY ({{namecate.lablenos}}) </th>
                        ...
                        <!--   <tfoot>
                          ...
                          <tbody ng-repeat="name in namesData|orderBy:column:reverse" ng-if="namecate.categories_id!=1">
                            ...
                            <tr class="view" ng-if="namecate.categories_id==name.categories_id_get">
                              ...
                              <td ng-if="namecate.labletype==8 || namecate.labletype==1 || namecate.labletype==15 ||  namecate.labletype==5 || namecate.labletype==6 || namecate.labletype==7 || namecate.labletype==16 || namecate.labletype==10 || namecate.labletype==11 || namecate.labletype==12">{{name.profile_tab_convert}}</td>
                              <td ng-if="namecate.labletype==8 || namecate.labletype==11 || namecate.labletype==12 || namecate.labletype==15">{{name.crimp_tab_convert}} </td>
                              <td ng-if="namecate.labletype==8" style="display:none;">{{name.back_crimp}}</td>
                              <td ng-if="namecate.labletype==1 || namecate.labletype==6">{{name.crimp_tab_convert}}</td>


                              <td ng-if="namecate.labletype!=9">FEET</td>
                ...
                <footer>
                  ...
                  <div class="invoice-info divFooter" style="margin-top: 40px;margin-bottom: 100px;" ng-init="fetchSingleDatatotal('1')">
                    <div class="row">
                      <div class="col-md-4 invoice-details" ng-init="fetchCustomerorderdata()">
  ...
  <script>
    ...
    app.controller('crudController', function($scope, $http) {
      ...
      $scope.fetchData = function(id) {
        ...
        $http.get('<?php echo base_url() ?>index.php/Order_second/fetch_data_delivery_note?attachment_status=0&order_id=<?php echo $order_id; ?>&tablenamemain=<?php echo $tablename; ?>&tablename_sub=<?php echo $tablename_sub; ?>&DC_id=<?php echo $DC_id; ?>&convert=' + id).success(function(data) {
      ...
      $scope.fetchDataCategorybase = function(id) {
        ...
        $http.get('<?php echo base_url() ?>index.php/Order_second/fetchDataCategorybase_delevery_notes?attachment_status=0&order_id=<?php echo $order_id; ?>&tablenamemain=<?php echo $tablename; ?>&tablename_sub=<?php echo $tablename_sub; ?>&DC_id=<?php echo $DC_id; ?>&convert=' + id).success(function(data) {

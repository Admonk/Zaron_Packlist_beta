...
<body data-layout="horizontal" class="full-vh-overflow-hide" data-topbar="dark" ng-app="crudApp" ng-controller="crudController">
 ...
 <th class="table-width-15" ng-if="namecate.labletype==19" rowspan="2" data-priority="1" >Remarks
  ...
  <th class="table-width-10" ng-if="namecate.categories_id==592" rowspan="2" data-priority="1" >Description
                                            ...
                                            <th class="table-width-15 sst" style="width: 6px;" ng-if="namecate.categories_id!=15 && namecate.categories_id!=30 && namecate.categories_id!=609 && namecate.categories_id!=614  && namecate.categories_id!=39  && namecate.categories_id!=41  && namecate.categories_id!=24 && namecate.categories_id!=626 && namecate.categories_id!=611 && namecate.categories_id!=590 && namecate.categories_id!=34 && namecate.categories_id!=19 && namecate.categories_id!=36 && namecate.categories_id!=7 && namecate.categories_id!=3 && namecate.categories_id!=17 &&   namecate.categories_id!=595 && namecate.categories_id!=9 && namecate.categories_id!=593  && namecate.categories_id!=13 && namecate.categories_id!=5 && namecate.categories_id!=613" data-priority="1" style="padding-bottom:0px" ng-click='sortColumn("crimp_tab")' ng-class='sortClass("crimp_tab")'>{{namecate.lable2}} </th> 
                                            ...
                                            <th class="table-width-8 " ng-if="namecate.labletype==12" >Dim 3</th>
                                              ...
                                              <th class="table-width-2" ng-if="namecate.labletype==1 && namecate.categories_id!=627 && namecate.categories_id!=611" data-priority="1" style="padding-bottom:0px" ng-click='sortColumn("crimp_tab")' ng-class='sortClass("crimp_tab")'>{{namecate.lable2}} </th> 
                                               ...
                                               <th class="table-width-2" ng-if="namecate.categories_id!=15 && namecate.categories_id!=30 && namecate.categories_id!=609 && namecate.categories_id!=614  && namecate.categories_id!=39 && namecate.categories_id!=41 && namecate.categories_id!=24 && namecate.categories_id!=626 && namecate.categories_id!=611 && namecate.categories_id!=590 && namecate.categories_id!=34 && namecate.categories_id!=19  && namecate.categories_id!=36 && namecate.categories_id!=7 && namecate.categories_id!=3 && namecate.categories_id!=17 && namecate.categories_id!=595 && namecate.categories_id!=9 && namecate.categories_id!=13 && namecate.categories_id!=5 && namecate.categories_id!=613" data-priority="1" style="padding-bottom:0px" ng-click='sortColumn("crimp_tab")' ng-class='sortClass("crimp_tab")'>{{namecate.lable2}} </th> 
...
<td ng-if="namecate.categories_id!=15 && namecate.categories_id!=30 && namecate.categories_id!=609 && namecate.categories_id!=614 && namecate.categories_id!=39 && namecate.categories_id!=41 && namecate.categories_id!=24 && namecate.categories_id!=626 && namecate.categories_id!=611 && namecate.categories_id!=590 && namecate.categories_id!=34 && namecate.categories_id!=19 && namecate.categories_id!=36 && namecate.categories_id!=7 && namecate.categories_id!=3 && namecate.categories_id!=17 && namecate.categories_id!=595 &&  namecate.categories_id!=9 && namecate.categories_id!=593 && namecate.categories_id!=13 && namecate.categories_id!=5 && namecate.categories_id!=613" data-label="{{namecate.lable2}}" data-label="{{namecate.lable2}}" class="sst"><input type="text" <?php echo $read; ?>  ng-keyup="inputsave_1(name.id,'crimp',namecate.categories_id,namecate.type)" id="crimp_{{name.id}}" value="{{name.crimp_tab}}"></td>
...
<!-- hided by gg changes cleat -->
                            ...
                            <td  ng-if="namecate.categories_id!=15 && namecate.categories_id!=30 && namecate.categories_id!=609 && namecate.categories_id!=614 && namecate.categories_id!=39 && namecate.categories_id!=41 && namecate.categories_id!=24 && namecate.categories_id!=626 && namecate.categories_id!=611  && namecate.categories_id!=590 && namecate.categories_id!=34 && namecate.categories_id!=19  && namecate.categories_id!=7  && namecate.categories_id!=17 && namecate.categories_id!=595 && namecate.categories_id!=9 && namecate.categories_id!=13 && namecate.categories_id!=613"> {{name.profile_tab_convert}}</td>

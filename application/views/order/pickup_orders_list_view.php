...
<body data-layout="horizontal" class="full-vh-overflow-hide" data-topbar="dark" ng-app="crudApp" ng-controller="crudController">
 ...
 <th class="table-width-15" ng-if="namecate.labletype==19" rowspan="2" data-priority="1" >Remarks
  ...
  <th class="table-width-10" ng-if="namecate.categories_id==592" rowspan="2" data-priority="1" >Description
                                            ...
                                            <!-- steel colil crimp removed -->
                                            <th class="table-width-15 sst" style="width: 6px;" ng-if="namecate.categories_id!=13 && namecate.labletype==7 && namecate.categories_id!=5 && namecate.categories_id!=613" data-priority="1" style="padding-bottom:0px" ng-click='sortColumn("crimp_tab")' ng-class='sortClass("crimp_tab")'>{{namecate.lable2}} </th> 
                                            ...
                                            <th class="table-width-8 " ng-if="namecate.labletype==12" >Dim 3</th>
                                              ...
                                              <th class="table-width-2" ng-if="namecate.labletype==1 && namecate.categories_id!=627 && namecate.categories_id!=611" data-priority="1" style="padding-bottom:0px" ng-click='sortColumn("crimp_tab")' ng-class='sortClass("crimp_tab")'>{{namecate.lable2}} </th> 
                                               ...
                                               <th class="table-width-2" ng-if="namecate.categories_id!=13 && namecate.labletype==7 && namecate.categories_id!=5 && namecate.categories_id!=613" data-priority="1" style="padding-bottom:0px" ng-click='sortColumn("crimp_tab")' ng-class='sortClass("crimp_tab")'>{{namecate.lable2}} </th> 
...
<td ng-if="namecate.categories_id!=13 && namecate.labletype==7 && namecate.categories_id!=5 && namecate.categories_id!=613" data-label="{{namecate.lable2}}" data-label="{{namecate.lable2}}" class="sst"><input type="text" <?php echo $read; ?>  ng-keyup="inputsave_1(name.id,'crimp',namecate.categories_id,namecate.type)" id="crimp_{{name.id}}" value="{{name.crimp_tab}}"></td>
...
<!-- hided by gg changes cleat -->
                            ...
                            <td  ng-if="namecate.labletype==7  && namecate.categories_id!=613"> {{name.profile_tab_convert}}</td>
<!-- for steel colil crimp removed -->
                            ...
                            <td ng-if="namecate.labletype==1 || namecate.labletype==0  || namecate.labletype==4" > {{name.profile_tab_convert}}</td>

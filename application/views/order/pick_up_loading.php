...
<body data-layout="horizontal" class="full-vh-overflow-hide" data-topbar="dark" ng-app="crudApp" ng-controller="crudController">
                                                              ...
                                                              <table class="table align-middle table-nowrap newBorderedTable">
                                                                  ...
                                                                  <tbody>
                                                                      ...
                                                                      <tr  ng-repeat="name in namesData">
                                                                          ...
                                                                          <td> <input type="number" value="{{name.sort_id}}" class="setsort_id" id="sort_id_{{name.randam_id}}" style="width: 50px;text-align: center;" ng-keyup="sortidchange(name.id,name.randam_id)" ></td>
 ...
 <td>{{name.trip_id}}</td>
                                                                          ...
                                                                          <td>{{name.name}} <br> {{name.phone}}</td>
                                                                           ...
                                                                           <td>{{name.loadamount | indianCurrency}}</td>
 ...
 <a href="#"  ng-click="cancelData(name.id)"><i class="mdi mdi-account-off font-size-16 text-danger me-1"></i> Cancel</a></span>-->
                                                                                        ...
                                                                                        <span class="badge rounded-pill badge-soft-secondary font-size-11" ng-if="name.assign_status==11 || name.assign_status==12"><a href="#"  ng-click="removeAssign(name.id,name.randam_id)"><i class="mdi mdi-key-remove font-size-16 text-danger me-1"></i> Un-Assign</a></span>
                                                                                       
                                                                                        
                                                                                        
                                                                                        <span class="badge rounded-pill badge-soft-secondary font-size-11" ng-if="name.assign_status==11 ||  name.loading_status==1"><a href="<?php echo base_url(); ?>index.php/order/pickup_orders_list_view?id={{name.id}}&driver_pickip=0&DC_id={{name.randam_id}}" ng-if="name.seq_status==1"><i class="mdi mdi-briefcase-upload font-size-16 text-danger me-1"></i>  Loading </a></span>
                                                                                        ...
                                                                                        <span class="badge rounded-pill badge-soft-secondary font-size-11" ng-if="name.assign_status==12">
                                                                                          <a href="<?php echo base_url(); ?>index.php/order/pickup_orders_list_view?id={{name.id}}&driver_pickip=1&DC_id={{name.randam_id}}" ng-if="name.seq_status==1"><i class="mdi mdi-briefcase-upload font-size-16 text-danger me-1"></i> Driver Pickup </a>
                                                                                        </span>
                                                                                       
                                                                                       
                                                                                        <span class="badge rounded-pill badge-soft-secondary font-size-11" ng-if="name.assign_status=='11' || name.assign_status=='12' || name.assign_status=='1' || name.assign_status=='2'"><a href="#"  ng-click="removeAssignCallback(name.id,name.randam_id)"><i class="mdi mdi-call-split font-size-16 text-danger me-1"></i>  Call Back</a></span>

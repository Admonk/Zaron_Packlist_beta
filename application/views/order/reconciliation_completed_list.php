                                             ...
                                             <div class="card-header align-items-start d-flex p-3">
                                                <div class="flex-shrink-0">
                                                   <ul class="nav justify-content-end nav-tabs-custom rounded card-header-tabs" role="tablist" ng-init="getcount('orders_process')">
                                                      ...
                                                      <li class="nav-item">
                                                         <a class="nav-link" data-bs-toggle="tab" href="#messages2" role="tab" ng-click="pageTab('orders_process',6666,8)">
                                                         <span class="d-block d-sm-none"><i class="far fa-envelope"></i></span>
                                                         <span class="d-none d-sm-block">Sales Return Order List  &nbsp;&nbsp;<span class="badge rounded-pill bg-danger float-end"> {{return}} </span></span>   
                                                         </a>
                                                      </li>
                                              ...
                                              <div class="col-12">
                                                  <div class="card shadow-none">
                                                      <div class="card-body">
                                                            ...
                                                            <input type="hidden" id="order_base" value="5">
                                                             <input type="hidden" id="assign" value="3">
                                                                  ...
                                                                  <tbody>
                                                                      ...
                                                                      <tr  ng-repeat="name in namesData">
                                                                          ...
                                                                          <td>
                                                                              ...
                                                                              <a href="<?php echo base_url(); ?>index.php/order/ordercreate_product_process_finance_verification?order_id={{name.base_id}}" ng-if="name.assign_status==3">{{name.order_no}}</a>
                                                                              
                                                                              <a href="<?php echo base_url(); ?>index.php/order/sales_return_to_order_view?order_id={{name.base_id}}&baseset=1" ng-if="name.assign_status==0">{{name.order_no}}</a>
                                                                        ...
                                                                        <!-- <td> 
                                                                         ...
                                                                         <span ng-if="name.order_base==2">
                                                                               ...
                                                                               <button type="button" class="btn btn-outline-success waves-effect waves-light">Trip-Started</button>
                                                                         ...
                                                                         <span ng-if="name.order_base==4">
                                                                               ...
                                                                               <button type="button" class="btn btn-outline-success waves-effect waves-light">Received</button>
                                                                          ...
                                                                          <span ng-if="name.order_base==8">
                                                                             
                                                                               <button type="button" class="btn btn-outline-success waves-effect waves-light">Re-schedule</button>
                                                                         ...
                                                                         <span ng-if="name.assign_status==3 || name.assign_status==4"><a href="javascript:void(0);" ng-click="getorderid(name.id,name.order_no,name.selforder)" class="btn btn-outline-success"> View</a></span>
                                                                             
                                                                             
                                                                             
                                                                         <a href="<?php echo base_url(); ?>index.php/order/sales_return_to_order_view?order_id={{name.return_id}}&baseset=1" ng-if="name.return_status==1" class="btn btn-outline-success">Return View</a>
                                                                              
                                                                                       
                                                                         <span ng-if="name.return_status==0"><a href="<?php echo base_url(); ?>index.php/order/sales_return_to_order?order_id={{name.base_id}}&baseset=0" ng-if="name.assign_status==3 || name.assign_status==4" class="btn btn-primary" > Return</a></span>          

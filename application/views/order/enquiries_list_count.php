               ...
               <div class="container-fluid">
                         ...
                         <div class="row">
                          ...
                          <label>From Date: </label><input type="date" class="form-control" id="from_date" ng-model="from_date" ng-change="DateFilter()">
                           ...
                           <div class="col-sm-3">
                            <label>Sales :</label>
                            <select class="form-control" name="sales_team" id="sales_team" ng-model="sales_team" ng-change="SalesFilter()" >
                                                ...
                                                <div class="flex-shrink-0">
                                                   <ul class="nav justify-content-end nav-tabs-custom rounded card-header-tabs" role="tablist" ng-init="getcount('orders')">
                                                      ...
                                                      <li class="nav-item">
                                                         ...
                                                         <span class="d-none d-sm-block">Total Enquiry<span class="badge rounded-pill bg-danger"> {{totalenquiry}} </span></span>   
                                                         </a>
                                                      </li>
                                                      ...
                                                      <li class="nav-item">
                                                         ...
                                                         <span class="d-none d-sm-block">Open Enquiry <span class="badge rounded-pill bg-danger"> {{pending}} </span></span> 
                                                         </a>
                                                      </li>
                                                       ...
                                                       <li class="nav-item">
                                                         ...
                                                         <span class="d-block d-sm-none"><i class="far fa-envelope"></i></span>
                                                         <span class="d-none d-sm-block">Moved <span class="badge rounded-pill bg-danger"> {{proceed}} </span></span>   
                                                         </a>
                                                      </li>
                                                      ...
                                                      <li class="nav-item" style="display:none;">
                                                         ...
                                                         <span class="d-block d-sm-none"><i class="far fa-envelope"></i></span>
                                                         <span class="d-none d-sm-block">Purchase Requisition Sent<span class="badge rounded-pill bg-danger"> {{requestp}} </span></span>   
                                                         </a>
                                                      </li>
                                                     ...
                                                     <li class="nav-item">
                                                         ...
                                                         <span class="d-block d-sm-none"><i class="far fa-envelope"></i></span>
                                                         <span class="d-none d-sm-block">Price Requested TL<span class="badge rounded-pill bg-danger"> {{request}} </span></span>   
                                                         </a>
                                                      </li>
                                                      ...
                                                      <li class="nav-item">
                                                         ...
                                                         <span class="d-block d-sm-none"><i class="far fa-envelope"></i></span>
                                                         <span class="d-none d-sm-block">Request TO Price MD <span class="badge rounded-pill bg-danger"> {{md_team}} </span></span>   
                                                         </a>
                                                      </li>
                                                      ...
                                                      ?>
                                                       ...
                                                       <li class="nav-item">
                                                         <a class="nav-link" data-bs-toggle="tab" href="#messages2" role="tab" ng-click="pageTab('orders',-1)">
                                                         <span class="d-block d-sm-none"><i class="far fa-envelope"></i></span>
                                                         <span class="d-none d-sm-block">Cancelled <span class="badge rounded-pill bg-danger"> {{cancel}} </span></span>   
                                                         </a>
                                                      </li>
                                                      ...
                                                      <li class="nav-item">
                                                         ...
                                                         <span class="d-block d-sm-none"><i class="far fa-envelope"></i></span>
                                                         <span class="d-none d-sm-block">Missed Enquiry<span class="badge rounded-pill bg-danger"> {{missed}} </span></span>   
                                                         </a>
                                                      </li>
                                                      ...
                                                      <li class="nav-item">
                                                         <a class="nav-link" data-bs-toggle="tab" href="#messages2" role="tab" ng-click="pageTab('orders',-4)">
                                                         <span class="d-block d-sm-none"><i class="far fa-envelope"></i></span>
                                                         <span class="d-none d-sm-block">Remainder <span class="badge rounded-pill bg-danger"> {{remainder}} </span></span>   
                                                         </a>
                                                      </li>
                                                       ...
                                                       <li class="nav-item" >
                                                         <a class="nav-link" data-bs-toggle="tab" href="#messages2" role="tab" ng-click="pageTab('orders',-3)">
                                                         <span class="d-block d-sm-none"><i class="far fa-envelope"></i></span>
                                                         <span class="d-none d-sm-block">Archive List<span class="badge rounded-pill bg-danger"> {{archive}} </span></span>   
                                                         </a>
                                                      </li>
                                                                  ...
                                                                  <tbody>
                                                                      ...
                                                                      <tr  ng-repeat="name in namesData">
                                                                          ...
                                                                          <td><a href="<?php echo base_url(); ?>index.php/order/ordercreate_product?order_id={{name.base_id}}&viewbase=1">
                                                                           ...
                                                                           <td><a href="<?php echo base_url(); ?>index.php/order/ordercreate_product?order_id={{name.base_id}}&viewbase=1">{{name.totalamount | number:2}}</a></td>
                                                                         ...
                                                                         <span ng-if="name.order_base==-1">
                                                                          ...
                                                                          <td><a href="<?php echo base_url(); ?>index.php/order/ordercreate_product?order_id={{name.base_id}}&viewbase=1">{{name.enquiry_date}} </a></td>
                                                                          <td><a href="<?php echo base_url(); ?>index.php/order/ordercreate_product?order_id={{name.base_id}}&viewbase=1">{{name.quotation_date}}</a></td>
                                                                          <td>
  ...
  $scope.error = false;
   ...
   function getData() {
      ...
      var sales_team = $('#sales_team').val();
       ...
       $http.get('<?php echo base_url() ?>index.php/order_check/get_fetch_order_list?page=' + $scope.currentPage + '&size=' + $scope.pageSize + '&search=' + $scope.searchText + '&tablename=' + $scope.tablename+'&order_base='+order_base+'&from_date='+from_date+'&to_date='+to_date+'&sales_team='+sales_team)
...
$scope.onPre = function(currentPage,pageSize){
  ...
  function getDataPage(currentPage,pageSize) {
      ...
      var sales_team = $('#sales_team').val();
        ...
        $http.get('<?php echo base_url() ?>index.php/order_check/get_fetch_order_list?page_next=' + currentPage + '&size=' + pageSize + '&search=' + $scope.searchText + '&tablename=' + $scope.tablename+'&order_base='+order_base+'&from_date='+from_date+'&to_date='+to_date+'&sales_team='+sales_team)
        .success(function(data) {
            $scope.namesData = [];
            $scope.totalItems = data.totalCount;
...
$scope.getcount = function (tabelename) {
      ...
      $http({
      method:"POST",
      url:"<?php echo base_url() ?>index.php/order_check/getcount?tablename="+tabelename+'&from_date='+from_date+'&to_date='+to_date+'&sales_team='+sales_team,

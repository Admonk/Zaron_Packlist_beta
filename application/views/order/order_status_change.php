 ...
 <div class="row">
  ...
  <div class="col-xl-12 mb-4" ng-repeat="name in namesData">
    ...
    <label class="radio-inline">
      <input type="radio" name="optradio" value="1" ng-checked="name.statuscheck==1" > Order Created
    </label>

    <label class="radio-inline">
      <input type="radio" name="optradio" value="7" ng-checked="name.statuscheck==7" > Order Date Confirmed
    </label>

    <label class="radio-inline">
      <input type="radio" name="optradio" value="2" ng-checked="name.statuscheck==2" > Order Assigned
    </label>
    <label class="radio-inline">
      <input type="radio" name="optradio" value="3" ng-checked="name.statuscheck==3"> Dispatch  Loaded
    </label>
    <label class="radio-inline">
      <input type="radio" name="optradio" value="4" ng-checked="name.statuscheck==4"> Driver  Loaded
    </label>
    <label class="radio-inline">
      <input type="radio" name="optradio" value="5" ng-checked="name.statuscheck==5"> Driver Trip Started
    </label>

    <label class="radio-inline">
      <input type="radio" name="optradio" value="6" ng-checked="name.statuscheck==6"> Driver Trip Completed
    </label>


    <label class="radio-inline">
      <input type="radio" name="optradio" value="8" ng-checked="name.statuscheck==8"> In Production Return
    </label>
    ...
    <?php
     ...
     ?>
  <label class="radio-inline">
      <button class="btn btn-outline-danger" ng-click="saveOrder(name.id,name.order_no)">SAVE</button>
    </label>
...
$scope.saveOrder = function(id,order_no)
{
      ...
      if(confirm("Are you sure you want to status change?"))
    {
        ...
        data:{'id':id,'checked':checked,'order_no':order_no, 'action':'order_full_status_change','tablename':'orders_process'}
        }).success(function(data){

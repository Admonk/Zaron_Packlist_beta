                                        ...
                                        <div class="row">
                                            <div class="col-md-1">
                                                <input type="number" value="{{ names.no }}"
                                                    ...
                                                    id="sort_id_{{ names.id }}" ng-keyup="sortidchange(names.id)">
                                                </div>
                                  ...
                                  <tr>
                                      ...
                                      <tr>
                                       ...
                                       <tr>
                                        ...
                                        <th>STATUS : </th>
                                        <th style="height: 4.5em!important; max-height: 4.5em!important;">
                                                 {{names.reason}}
                                        ...
                                        <th colspan="2" style="height: 4.5em!important; max-height: 4.5em!important;">
                                            ...
                                            <span ng-if="names.assign_status==12">
                                                <button ng-click="statusChange_view1(names.id)" class="btn btn-danger waves-effect waves-light float-end" ng-if="names.seq_status==1 && names.pickup==1">
                                            ...
                                            <span ng-if="names.assign_status==2 || names.assign_status==8">  
                                                <button ng-click="statusChange_view(names.id)" class="btn btn-primary float-end">
                                            ...
                                            <div ng-if="names.last_sort_id==names.no">
                                                      ...
                                                      <input type="text"  maxlength="6" id="end_reading_{{names.id}}" value="{{names.km_reading_end}}" ng-keyup="saveReading(names.id,names.return_id)" class="formta" placeholder="End Reading">
...
$scope.statusChange_view1 = function(id){
    ...
    window.location.replace("<?php echo base_url(); ?>index.php/order/pickup_orders_list_view?id="+id+"&driver_pickip=1");
...
$scope.statusChange_view = function(id){

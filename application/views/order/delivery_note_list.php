                                                ...
                                                <div class="flex-shrink-0">
                                                   <ul class="nav justify-content-end nav-tabs-custom rounded card-header-tabs" role="tablist" >
                                                        ...
                                                        <li class="nav-item ">
                                                         ...
                                                         <span class="d-none d-sm-block"><?php echo $title; ?> <span class="badge rounded-pill bg-success  float-end"> {{totalItems}} </span></span>   
                                                         </a>
                                                         </li> 
                                                  ...
                                                  <div class="card shadow-none">
                                                      <div class="card-body">
                                                          ...
                                                          <!--datatable="ng" dt-options="vm.dtOptions"-->
                                                            ...
                                                            <input type="hidden" id="order_base" value="picked">
...
app.controller('crudController', function($scope, $http){
  ...
  $scope.to_date = new Date();
   ...
   function getData() {
     ...
     $http.get('<?php echo base_url() ?>index.php/order_second/fetch_data_table_delivery_notes?page=' + $scope.currentPage + '&size=' + $scope.pageSize + '&search=' + $scope.searchText + '&tablename=' + $scope.tablename+'&order_base='+order_base+'&from_date='+from_date+'&to_date='+to_date+'&list=delivery')

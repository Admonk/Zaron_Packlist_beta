                                                ...
                                                <div class="tab-content twitter-bs-wizard-tab-content">
                                                    <div class="tab-pane" id="progress-seller-details">
                                                       ...
                                                       <a  target="_blank" href="<?php echo base_url(); ?>index.php/order/overview?order_id=<?php echo base64_encode($id); ?>&old_tablename=orders_quotation&old_tablename_sub=order_product_list_quotation&tablename=orders_process&tablename_sub=order_product_list_process&movetablename=orders_process&movetablename_sub=order_product_list_process" >Download</a> 
                                                                  ...
                                                                  <p><span>Total Amount</span><span> Rs. {{fulltotaldel}}</span></p>
                                                                  <p><span>Loaded</span><span> Rs. {{unbilledloadamount}}</span></p>
                                                                  <p ng-if="deliveredamount>0"><span>Delivered</span><span> Rs. {{deliveredamount}}</span></p>
                                                                  
                                                                  <p><span>Balance </span><span> Rs. {{fulltotaldel-unbilledloadamount-deliveredamount}}</span></p>
                                    ...
                                    <table id="datatable_{{namecate.categories_id}}" class="table table-bordered dt-responsive  nowrap w-100 salestable" >
                                       ...
                                       <thead class="bg-gray text-red" ng-if="namecate.categories_id==1">
                                          ...
                                          <tr>
                                             ...
                                             <th class="table-width-6" ng-if="namecate.labletype==2 || namecate.labletype==1" rowspan="2" style="padding-bottom:0px" data-priority="3" ng-click='sortColumn("nos_tab")' ng-class='sortClass("nos_tab")'><?php echo $readdriverset; ?>{{namecate.lablenos}} </th>
                                             
                                             <?php
                                                 if($readdriver=='')
                                                 {
                                                     ?> 
                                             <th class="table-width-6" ng-if="namecate.labletype==2 || namecate.labletype==1" rowspan="2" style="padding-bottom:0px" data-priority="3" ng-click='sortColumn("nos_tab")' ng-class='sortClass("nos_tab")'>Packed {{namecate.lablenos}} </th>
                                             <?php 
                                             }
                                             ?>
                                             
                                             
                                             <th class="table-width-6" ng-if="namecate.labletype==2 || namecate.labletype==1" rowspan="2" style="padding-bottom:0px" data-priority="3" ng-click='sortColumn("nos_tab")' ng-class='sortClass("nos_tab")'>Loaded {{namecate.lablenos}} </th>
                                              ...
                                              <?php
                                                 ...
                                                 {
                                                     ?> 
                                             <th class="table-width-6" ng-if="namecate.labletype==9 || namecate.labletype==19" rowspan="2" style="padding-bottom:0px" data-priority="3" ng-click='sortColumn("nos_tab")' ng-class='sortClass("nos_tab")'>Packed QTY </th>
                                             <?php 
                                             }
                                             ?>
 ...
 <th class="table-width-15" ng-if="namecate.labletype==19" rowspan="2" data-priority="1" >Remarks
  ...
  <th class="table-width-18" ng-if="namecate.categories_id==592" rowspan="2" data-priority="1" >Description
                                             ...
                                             <th class="table-width-8" data-priority="3" ng-if="namecate.labletype!=9">UOM</th>
                                              ...
                                              <th class="table-width-6"  data-priority="3" ng-if="namecate.labletype!=9" rowspan="2" ng-click='sortColumn("nos_tab")' ng-class='sortClass("nos_tab")'><?php echo $readdriverset; ?>{{namecate.lablenos}}</th>
                                                 ...
                                                 {
                                                     ?> 
                                             <th class="table-width-6" ng-if="namecate.labletype!=9" rowspan="2" style="padding-bottom:0px" data-priority="3" ng-click='sortColumn("nos_tab")' ng-class='sortClass("nos_tab")'>Packed {{namecate.lablenos}} </th>
                                             ...
                                             <th class="table-width-6"  data-priority="3" ng-if="namecate.labletype!=9" rowspan="2" ng-click='sortColumn("nos_tab")' ng-class='sortClass("nos_tab")'>Loaded {{namecate.lablenos}}</th>
                                       ...
                                       <tbody   ng-repeat="name in namesData|orderBy:column:reverse"  ng-if="namecate.categories_id==1">
                                          ...
                                          <tr  class="{{name.picked_status == 0 ? 'disabled-div' : ''}} view " ng-style="name.rate_edit == 1 && {'color':'red'}" ng-if="namecate.categories_id==name.categories_id_get && namecate.type==name.type">
                                            ...
                                            <td  data-priority="3" data-label="UOM" ng-if="namecate.labletype!=9" >
                                            ...
                                            <td ng-if="namecate.labletype!=9">
                                                    ...
                                                    <span  ng-if='name.dispatch_nos==0' >{{name.packed_nos}}</span>
                                                      ...
                                                      if(count($DC_list)==0)
                                                    {
                                                     ?>
                                                      <span ng-if='name.dispatch_nos==0'>
                                                       ...
                                                       <input type="text" disabled ng-blur="inputsave_1(name.id,'nos',namecate.categories_id,namecate.type)" style="border: #bbbbbb solid 2px;"   data-val="{{name.bill_nos}}" class="nos_{{namecate.categories_id}}" id="nos_{{name.id}}" value="{{name.packed_nos}}">
                                                       </span>
                                                     ...
                                                     else
                                                     {
                                                       ...
                                                       <span ng-if='name.packed_nos>0'>
                                                       <input type="text" disabled ng-blur="inputsave_1(name.id,'nos',namecate.categories_id,namecate.type)" style="border: #bbbbbb solid 2px;"   data-val="{{name.packed_nos}}" class="nos_{{namecate.categories_id}}" id="nos_{{name.id}}" value="{{name.packed_nos}}">
                                                       </span>
                                             ...
                                             <td  data-label="Amount" class="amounttot_{{namecate.categories_id}}">
                                              ...
                                              <?php 
                                                                      ...
                                                                      <span ng-if="name.loadstatus==0 && name.unlode_check_box==0">
                                                                                                            ...
                                                                                                            <label for="set_id{{name.id}}"><input type="checkbox" value="{{name.id}}" id="set_id{{name.id}}"  ng-click="loadProduct(name.id)" <?php echo $disabled; ?> class="loaditems" name="loaditems"> <span id="textchange_{{name.id}}">Load</span></label>
                                                                                                         ...
                                                                                                         <span ng-if="name.loadstatus==1">
                                                                                                           ...
                                                                                                           <label for="set_id{{name.id}}" title="Delivered" ng-if="name.delivery_status==1"><input type="checkbox" disabled checked value="{{name.id}}" id="set_id{{name.id}}" ng-click="loadProduct(name.id)" class="loaditems" name="loaditems"> <span id="textchange_{{name.id}}">Delivered</span></label>
                                                                                                            <label for="set_id{{name.id}}"  ng-if="name.delivery_status==0"><input type="checkbox"   <?php echo $disabled; ?> checked value="{{name.id}}" id="set_id{{name.id}}" ng-click="loadProduct(name.id)" class="loaditems" name="loaditems"> <span id="textchange_{{name.id}}">Loaded</span></label>
                                         ...
                                         <td  ng-if="namecate.labletype==19" data-label="Sub Products" ><input type="text" <?php echo $read; ?> placeholder="Search Product" ng-keyup="completeProductSUb3(name.id)"  ng-blur="inputsave_1(name.id,'tile_material_name',namecate.categories_id,namecate.type)"   id="tile_material_name_{{name.id}}" value="{{name.tile_material_name}}"></td>
                                          ...
                                          <td  ng-if="namecate.labletype==19" data-label="Coil No" ><input type="text" <?php echo $read; ?>   ng-blur="inputsave_1(name.id,'dim_two',namecate.categories_id,namecate.type)"   id="dim_two_{{name.id}}" value="{{name.dim_two}}"></td>
                                            ...
                                            <td   style="display:none;" data-label="Fact"><input type="text" <?php echo $read; ?>  ng-keyup="inputsave_1(name.id,'fact',namecate.categories_id,namecate.type)" id="fact_{{name.id}}" value="{{name.fact_tab}}"></td>
                                             ...
                                             <td><span class="loadamount"  id="qty_{{name.id}}">{{name.loadqty}}</span></td>
...
$scope.fetchSingleDatatotaldel = function(){
    $http({
      method:"POST",
      url:"<?php echo base_url() ?>index.php/order/fetch_single_data_totaldel?order_id=<?php echo $id; ?>&DC_id=<?php echo $DC_id; ?>&DC_id=<?php echo $DC_id; ?>",

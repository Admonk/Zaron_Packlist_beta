               ...
               <div class="container-fluid">
                                             ...
                                             <div class="card-header align-items-start d-flex p-3">
                                                <div class="flex-shrink-0">
                                                   <ul class="nav justify-content-end nav-tabs-custom rounded card-header-tabs" role="tablist" ng-init="getcount('orders_process')">
                                                      ...
                                                      <li class="nav-item">
                                                         <a class="nav-link active" data-bs-toggle="tab" href="#messages2" role="tab" ng-click="pageTab('orders_process',3)">
                                                         <span class="d-block d-sm-none"><i class="far fa-envelope"></i></span>
                                                         <span class="d-none d-sm-block">Approved Request Order <span class="badge rounded-pill bg-warning  float-end"> {{request}} </span></span>   
                                                         </a>
                                                      </li>
                                                      ...
                                                      <!-- <li class="nav-item">
                                                         ...
                                                         <span class="d-block d-sm-none"><i class="far fa-envelope"></i></span>
                                                         <span class="d-none d-sm-block">Request To Purchase Team <span class="badge rounded-pill bg-success  float-end"> {{purchase_team}} </span></span>   
                                                         </a>
                                                      </li>-->
                                                      ...
                                                      <li class="nav-item">
                                                         ...
                                                         <span class="d-block d-sm-none"><i class="far fa-envelope"></i></span>
                                                         <span class="d-none d-sm-block">Price  Request To MD <span class="badge rounded-pill bg-success  float-end"> {{md_team}} </span></span>   
                                                         </a>
                                                      </li>
                        ...
                        <div id="example_filter" class="dataTables_filter">
                            <label>Search:<input type="search" class="form-control input-sm" aria-controls="example" ng-model="searchText" ng-change="searchTextChanged()"></label>
                                                          ...
                                                          <div class="table-responsive" ng-init="fetchData('orders_process',3)">
                                                              <table class="table align-middle table-nowrap newBorderedTable" >
                                                                  ...
                                                                  <tbody>
                                                                      ...
                                                                      <tr  ng-repeat="name in namesData">
                                                                          ...
                                                                          <td><a href="<?php echo base_url(); ?>index.php/order/ordercreate_product_process_tl_verification?order_id={{name.base_id}}">{{name.order_no}}</a></td>
                                                                          <td>{{name.name}}</td>
                                                                          <td>{{name.phone}}</td>
                                                                         ...
                                                                         <span ng-if="name.order_base==-2">
                                                                               ...
                                                                               <button type="button" class="btn btn-outline-danger waves-effect waves-light">Re-Assigned</button>
                                                                          ...
                                                                          <td>
                                                                                     ...
                                                                                     <a href="<?php echo base_url(); ?>index.php/order/ordercreate_product_process_tl_verification?order_id={{name.base_id}}" ><i class="mdi mdi-eye font-size-16 text-success me-1"></i> View</a>

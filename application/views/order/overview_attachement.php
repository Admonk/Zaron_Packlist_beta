...
<span ng-if="name.sub_product_name_tab"> <hr></hr> Accessories Specification:  {{name.sub_product_name_tab}}</span>
                                             ...
                                             <td style="display:none;">{{name.fact_tab}}</td>
                                              <td ng-if="base_check==1" style="text-align:right;">{{name.base_rate}}</td>
                                                <th ng-if="gst_check==1" style="text-align:right;"><b  >{{name.gst_price}}</b></th>
...
<span ng-if="name.sub_product_name_tab"> <hr></hr> Accessories Specification:  {{name.sub_product_name_tab}}</span>
                                ...
                                <option value="7" ng-selected="{{ name.uom == 7 }}" ng-style="namecate.type != 19 && {'display':'none'}">KG</option>
                                             ...
                                             <td style="display:none;" ng-if="namecate.labletype==1 || namecate.labletype==2 || namecate.labletype==3 || namecate.labletype==4 || namecate.labletype==5 || namecate.labletype==6 || namecate.labletype==7 || namecate.labletype==16 || namecate.labletype==8 || namecate.labletype==10 || namecate.labletype==11 || namecate.labletype==12 || namecate.labletype==13 || namecate.labletype==14">{{name.fact_tab}}</td>
                                              <td ng-if="base_check==1" style="text-align:right;">{{name.base_rate}}</td>
                                                <th style="text-align:right;" ng-if="gst_check==1"><b  >{{name.gst_price}}</b></th>
                                             <td style="text-align:right;">{{name.rate_tab | number : 2}}</td>
                              ...
                              <table class="table invoice-table" ng-init="fetchSingleDatatotal('1')">
                                ...
                                <tr>
                                    ...
                                    <td>
                                                    ...
                                                    <p  class="text-end" style="font-size: 18px;"><b>SubTotal : Rs. {{fulltotal | number : 2}}</b></p>
...
//}
  ...
  $scope.fetchData = function(id){
    ...
    $http.get('<?php echo base_url() ?>index.php/Order_second/fetch_data?attachment_status=1&order_id=<?php echo $order_id; ?>&tablenamemain=<?php echo $tablename; ?>&tablename_sub=<?php echo $tablename_sub; ?>&convert='+id).success(function(data){
  ...
  $scope.fetchDataCategorybase = function(id){
    ...
    $http.get('<?php echo base_url() ?>index.php/Order_second/fetchDataCategorybase?attachment_status=1&order_id=<?php echo $order_id; ?>&tablenamemain=<?php echo $tablename; ?>&tablename_sub=<?php echo $tablename_sub; ?>&convert='+id).success(function(data){

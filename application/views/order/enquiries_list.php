                                                                  ...
                                                                  <tbody>
                                                                      ...
                                                                      <tr  ng-repeat="name in namesData" class="{{name.color}}">
                                                                          ...
                                                                          <td><a href="<?php echo base_url(); ?>index.php/order/ordercreate_product?order_id={{name.base_id}}&viewbase=1">
                                                                           ...
                                                                           <td><a href="<?php echo base_url(); ?>index.php/order/ordercreate_product?order_id={{name.base_id}}&viewbase=1">{{name.totalamount | indianCurrency}}</a></td>
...
$scope.getcount = function (tabelename) {
 ...
 $http({
      ...
      $scope.totalenquiry=data.pending+data.proceed+data.cancel+data.reassign+data.remainder+data.request;

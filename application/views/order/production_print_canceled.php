...
<div class="modal fade bs-example-modal-center" tabindex="-1" role="dialog" aria-hidden="true">
                                                ...
                                                <div class="flex-shrink-0">
                                                   <ul class="nav justify-content-end nav-tabs-custom rounded card-header-tabs" role="tablist" ng-init="getcount('orders_process')">
                                                        ...
                                                        <li class="nav-item" >
                                                         ...
                                                         <span class="d-none d-sm-block">Production Print canceled Order</span> 
                                                         </a>
                        ...
                        <div class="col-sm-2" >
                          ...
                          <button onclick="window.print()" class="btn btn-default" style="margin: 25px 0px;">Print this page</button>
                                                                      ...
                                                                      <tr>
                                                                       ...
                                                                       <tr ng-repeat="names in name.subarray" class="{{names.color_style}}">
                                                                                                        ...
                                                                                                        <td > 
                                                                                                           ...
                                                                                                           <span ng-if="names.product_name_sub!=''"><b>Size : {{names.product_name_sub}} </b></span>
...
app.controller('crudController', function($scope, $http){
  ...
  $scope.to_date = new Date();
   ...
   function getData() {
     ...
     $http.get('<?php echo base_url() ?>index.php/order/fetch_data_production_order_by_print?order_id=0&cancelid=-1&tablenamemain=<?php echo 'orders_process'; ?>&&tablename_sub=<?php echo 'order_product_list_process'; ?>&convert=1&production_id=1&status=0&from_date='+from_date+'&to_date='+to_date+'&order_no1='+order_no1+'&order_no2='+order_no2)

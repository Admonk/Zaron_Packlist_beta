...
<body data-layout="horizontal" class="full-vh-overflow-hide" data-topbar="dark" ng-app="crudApp" ng-controller="crudController">
                           ...
                           <div class="row">
                                 ...
                                 <div class="d-flex inlineFlexBox">
                                  ...
                                  <div class="d-inline col-2 pe-3 border-end">
                                    ...
                                    <h4 class="mb-sm-0 font-size-11 text-primary" ng-if="mark_request_to_sales!=0">Quotation  No : <a href="<?php echo base_url(); ?>index.php/order/ordercreate_product_quotation?order_id={{qutation_orders_id}}" target="_blank" ng-click="disable_load()" >{{mark_request_to_sales}}</a></h4>
                        ...
                        <div class="floater-options1"    ng-init="fetchSingleDatatotal('1')">
                            ...
                            <div class="row">
                              ...
                              <div class="flex-grow-1 settotal" ng-if="order_base >= 2">
                                ...
                                <!-- Display GST 18% only if the state is Tamil Nadu -->
                                <h5 class="ng-binding font-size-11" ng-if="state !== 'Tamilnadu'"><b>IN-IGST : {{totalamountgat | number : 2}}</b></h5>
                                
                                <!-- Display CGST and SGST only if the state is other than Tamil Nadu -->
                                <h5 class="ng-binding font-size-11" ng-if="state === 'Tamilnadu'"><b>IN-CGST-{{gst/2}}%: {{ gstAmount | number : 2 }}</b></h5>
                                <h5 class="ng-binding font-size-11" ng-if="state === 'Tamilnadu'"><b>IN-SGST-{{gst/2}}%: {{ gstAmount | number : 2 }}</b></h5>
 ...
 <div class="modal fade" id="firstmodal2" aria-hidden="true" aria-labelledby="exampleModalToggleLabel" tabindex="-1">
  ...
  <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasRight" aria-labelledby="offcanvasRightLabel" style="width: 1400px;" >
                 ...
                 <div class="col-4" ng-repeat="comparevendor in getcomparedatavendor" style="margin-bottom:20px;">
                   ...
                   <table class="table border">
                    <tbody >
                                      ...
                                      <td>{{compare.price | number}}</td>
                                      <td> {{compare.total | number}}</td>
                                      <!-- <td> {{comparevendor.state}}</td> -->
                                      </tr>
   ...
   <tr ng-repeat="compareunc in getcomparedataunc" ng-if="compareunc.vendor_id==comparevendor.vendor_id && comparevendor.state.includes('Tamilnadu')">
        ...
        <td>
            <table class="price-table" style="background: #f7f7f7;">
                ...
                <td><b>IN-SGST: {{ compare_percentage / 2 }}</b>%</td>
                
                <tr><td><b>IN-CGST: {{ compare_percentage / 2 }}</b>%</td></tr>
                ...
                <tr ng-if="compareunc.extra_included=='Extra'"><td>Freight GST</td></tr>
        ...
        <td ng-style="compareunc.selected_status == 1 && {'background-color':'#ffe0e0'}">
            <table class="price-table">
                ...
                <tr ng-if="compareunc.payment_terms!='Advance'"><td><span ng-if="compareunc.payment_terms!='Advance'">{{compareunc.due_date}}</span></td></tr>
                <tr ng-if="compareunc.remarks!=''"><td style="height: 40px;">{{compareunc.remarks}}</td></tr>
                <tr>
                    <td data-bs-toggle="modal" ng-if="compareunc.attachement!=''" ng-click="seletQutationfile(compareunc.attachement)" data-bs-target="#previewPdf">
                        <u><i class="mdi mdi-file-outline text-muted font-size-16 me-1"></i><span style="margin:3px;"> QUOTE </span></u>
                    </td>
                ...
                <tr><td><b>Rs {{compareunc.gstamount/2 | number : 2}}</b></td></tr> <!-- SGST -->
                <tr><td><b>Rs {{compareunc.gstamount/2 | number : 2}}</b></td></tr> <!-- CGST -->
                ...
                <tr ng-if="compareunc.extra_included=='Extra'"><td><span ng-if="compareunc.extra!=''">Rs {{compareunc.extra | number : 2}}</span></td></tr>
                <tr ng-if="compareunc.extra_included=='Extra'"><td><span ng-if="compareunc.extra_gst!=''">Rs {{compareunc.extra_gst | number : 2 }}</span></td></tr>
                <tr ng-if="compareunc.extra_included=='Extra'"><td><span ng-if="compareunc.extra_total!=''">Rs {{compareunc.extra_total | number : 2}}</span></td></tr>
                <tr>
                    <td class="price">
                        <span ng-if="order_base==1">
                        ...
                        <span ng-if="compareunc.selected_status == 1">
                            <button class="pobtn" style="background: #ff1800;padding: 0px 10px;line-height: 24px;" ng-click="seletGenrate('<?php echo base_url(); ?>index.php/purchase/po?order_id=<?php echo $enable_order; ?>&old_tablename=<?php echo $old_tablename; ?>&old_tablename_sub=<?php echo $old_tablename_sub; ?>&tablename=<?php echo $tablename; ?>&tablename_sub=<?php echo $tablename_sub; ?>&movetablename=<?php echo $movetablename; ?>&movetablename_sub=<?php echo $movetablename_sub; ?>')">Generate PO</button>
                            <button type="button" ng-click="viewAddressCompany()" title="Select Address" class="btn btn-outline-primary"><i class="fa fa-address-card" aria-hidden="true"></i></button>
                            <button type="button" ng-click="addAddress()" title="Address Add" class="btn btn-outline-primary"><i class="fa fa-map-marker" aria-hidden="true"> + </i></button>
                        </span>
                    </td>
                </tr>
            </table>
...
<tr ng-repeat="compareunc in getcomparedataunc" ng-if="compareunc.vendor_id==comparevendor.vendor_id && !comparevendor.state.includes('Tamilnadu')">
       ...
       <tr ><td> <b>IGST: {{ compare_percentage}}</b>%</td></tr>
...
<div class="alert alert-danger alert-dismissible fade show" role="alert" ng-show="error">
                       ...
                       <div class="row">
                          ...
                          <div class="form-group row">
                            ...
                            <div class="col-sm-12">
                             <input id="inovice_no" class="form-control" ng-blur="invoiceNocheck()" plaseholder="Enter the invoice no"  name="inovice_no" required ng-model="inovice_no" type="test3">
                            </div>
                          </div>
                        </div>
                       ...
                       <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                          <div class="form-group row">
                            ...
                            <div class="col-sm-12">
                            <input id="invoice_amount" class="form-control" readonly name="invoice_amount" required type="text" ng-value="fulltotalinvoice">
                        </div>
                          </div>
                        </div>
                         ...
                         <div  class="col-md-12" id="showdata" ng-show="namesDataproduct.length>0" style="margin-top:20px;">
                                                                ...
                                                                <table class="table" >
                                                                     ...
                                                                     <tr  ng-repeat="namesp in namesDataproduct">
                                                                         ...
                                                                         //         // Assuming you have already fetched gst_percentage in AngularJS
                                                                         //         var gst_percentage = parseFloat($scope.gst_percentage);
                                                                         
                                                                         //         var totalextra = 0;
                                                                         //         var sum = 0;
                                                                         
                                                                         //         $('.totalv').each(function() {
                                                                         //             var combat = parseFloat($(this).html()) || 0;
                                                                         //             sum += combat;
                                                                         //         });
                                                                         
                                                                         //         var totalsum = sum + totalextra;
                                                                         //         var totalgst = totalsum * (gst_percentage / 100);
                                                                         ...
                                                                         $(document).ready(function() {
                                                                             ...
                                                                             // Calculate and update totals when any relevant input changes
                                                                             $('.purchase_qty, .price').on('input', function() {
                                                                                 calculateTotals();
                                                                             });
                                                                         
                                                                             function calculateTotals() {
                                                                                 var totalextra = parseFloat($('#totalextra').val()) || 0;
                                                                                 var sum = 0;
                                                                                 var gst_percentage = parseFloat($scope.gst_percentage);
                                                                                 var fulltotalinvoice = 0; // Initialize total amount
                                                                         
                                                                                 // Calculate individual row totals and sum them up
                                                                                 $('.purchase_qty').each(function() {
                                                                                     var id = $(this).data('set');
                                                                                     var qty = parseFloat($(this).val()) || 0;
                                                                                     var price = parseFloat($('#price_invoice_' + id).val()) || 0;
                                                                                     var subtotal = qty * price;
                                                                                     $('#dd_' + id).html(subtotal.toFixed(2));
                                                                                     sum += subtotal;
                                                                                 });
                                                                         
                                                                                 var totalsum = sum + totalextra;
                                                                                 var totalgst = totalsum * (gst_percentage / 100);
                                                                                 fulltotalinvoice = totalsum + totalgst;
                                                                         
                                                                                 // Update AngularJS scope with the calculated total
                                                                                 $scope.fulltotalinvoice = fulltotalinvoice;
                                                                         
                                                                                 // Update HTML elements with calculated values
                                                                                 $('#totalamount').html('Rs. ' + totalsum.toFixed(2));
                                                                                 $('#gst').html('Rs. ' + totalgst.toFixed(2));
                                                                                 $('#totalamountgst').html('Rs. ' + fulltotalinvoice.toFixed(2));
                                                                                 $('#invoice_amount').val(fulltotalinvoice.toFixed(2));
                                                                             }
                                                                         });
                                                                         </script>
                                                                     </tr>
                                                                  ...
                                                                  <tr ng-show="!showTamilnaduTax">
                                                                        <th></th>
                                                                        <th></th>
                                                                        <th></th>
                                                                        <th></th>
                                                                        <td>IN-IGST: <span id="">{{ gst_percentage}}</span>%</td>
                                                                        <!-- <th><b>IGST</b></th> -->
                                                                        <th id="gst">{{ gstamount }}</th>
                                                                    </tr>
                                                                    <tr ng-show="showTamilnaduTax">
                                                                        <th></th>
                                                                        <th></th>
                                                                        <th></th>
                                                                        <th></th>
                                                                        <td>IN-CGST: <span id="">{{ gst_percentage/2 }}</span>%</td>
                                                                        <th id="cgst">{{ gstamount/2}}</th>
                                                                    </tr>
                                                                    <tr ng-show="showTamilnaduTax">
                                                                        <th></th>
                                                                        <th></th>
                                                                        <th></th>
                                                                        <th></th>
                                                                        <td>IN-SGST: <span id="">{{ gst_percentage/2 }}</span>%</td>
                                                                       
                                                                        <th id="sgst">{{ gstamount/2}}</th>
                                                                    </tr>
...
<div class="alert alert-danger alert-dismissible fade show" role="alert" ng-show="error">
                       ...
                       <div class="row">
                          ...
                          <div class="form-group row">
                            <label class="col-sm-12 col-form-label">Invoice No <span style="color:red;">*</span></label>
                            <div class="col-sm-12">
                             <input id="inovice_no_2" class="form-control" ng-blur="invoiceNocheck2()" plaseholder="Enter the invoice no"  name="inovice_no_2" required ng-model="inovice_no_2" type="test3">
                            </div>
                          </div>
                        </div>
...
<div class="alert alert-danger alert-dismissible fade show" role="alert" ng-show="error">
   ...
   <div ng-init="fetchDataaddress()" ng-show="namesDataaddress.length>0">
                                                      <h3>Product View</h3>
                                                                ...
                                                                <tr ng-if="isTamilNadu">
                                                                    <td></td>
                                                                    <td></td>
                                                                    <td></td>
                                                                    <td></td>
                                                                    <!-- <th><b>IGST: <span id="igst_percentage_display">{{ igst_percentage }}</span>%</b></th> -->
                                                                    <td>IN-CGST: <span id="">{{ gst_percentage /2}}</span>%</td>
                                                                    <td>Rs. {{cgstAmount | number : 2}}</td>
                                                                </tr>
                                                                <tr ng-if="isTamilNadu">
                                                                    <td></td>
                                                                    <td></td>
   ...
   <div  ng-show="namesDatainvoice.length>0">
                                                                ...
                                                                <table class="table" >
                                                                     ...
                                                                     <tr  ng-repeat="names in namesDatainvoice">
                                                                         ...
                                                                         <td>{{names.invoice_amount | number}}</td>
                                                                         <td>{{names.payout_amount | number}}</td>
                                                                         <td><span style="color:red;">{{names.pending_amount | number}}</span></td>
...
app.controller('crudController', function($scope, $http){
    ...
    $scope.getcompareProduct=function(){  
            ...
            $scope.compare_percentage = data[0].gst_percentage;  //loges
            // console.log('Fetched data:', $scope.compare_percentage);
...
if (item.state.includes('Tamilnadu')) {

  // alert('Vendor address is in Tamil Nadu!');
}
});
...
console.log(data);
       ...
       $scope.discountfulltotal = data.discountfulltotal;
        ...
        $scope.gstAmount = $scope.totalamountgat / 2;
...
$scope.fetchVendor = function(id){
    $http({
      ...
      data:{'order_id':'<?php echo $order_id; ?>'}
       ...
       $scope.state = data.state; // Set the state variable
       
       // Check if the state is Tamil Nadu and show an alert
       if ($scope.state && $scope.state.trim().toLowerCase() === 'tamilnadu') {
          //  alert('This vendor is located in Tamil Nadu!');
       }
    });
};
...
$scope.getProductlist_extra = function(){
   ...
   $scope.getProductlist = function(){
    ...
    $http.get('<?php echo base_url() ?>index.php/purchase/get_purchase_product_list_po_number?po_no='+po_no+'&vendor_id_fix='+vendor_id_fix+'&order_id='+id).success(function(data){
        console.log(data);
        $scope.namesDataproduct = data;
        var isTamilnadu = data.some(function(item) {
            return item.state === 'Tamilnadu';
        });

        if (isTamilnadu) {
            $scope.showTamilnaduTax = true;
        } else {
            $scope.showTamilnaduTax = false;
        }
    });
    ...
    $http.get('<?php echo base_url() ?>index.php/purchase/get_purchase_product_list_po_number_gst_total?po_no=' + po_no + '&order_id=' + id)
    .then(function(response) {
        ...
        $scope.gstamount_extra = data.gstamount_extra;
        $scope.fulltotal_extra = data.fulltotal_extra;
        $scope.gst_percentage = data.gst_percentage; // Assign GST percentage to scope variable

        initializejQueryCalculations($scope);
    })
    .catch(function(error) {
     ...
     function initializejQueryCalculations($scope) {                          // loges
        $(document).on('input', '.price', function() {
            ...
            // Retrieve GST percentage from AngularJS scope
            var gst_percentage = parseFloat($scope.gst_percentage);
            ...
            var cgst = (totalgst / 2).toFixed(2); 
            var sgst = (totalgst / 2).toFixed(2); 
            var igst = totalgst.toFixed(2); 
  ...
  $scope.viewallInvoices = function()
  {
   ...
   $scope.fetchDataaddress = function(id) {
    $http.get('<?php echo base_url() ?>index.php/purchase/purchase_fetch_cp_invoice_product?id=' + id).success(function(dataaddress) {
        ...
        $scope.isTamilNadu = false; 
        dataaddress.forEach(function(item) {
            if (item.vendor_state === 'Tamilnadu') {
                $scope.isTamilNadu = true; 
            }
        });
    });
};
...
$scope.invoicepayment = function(id){
    $http.get('<?php echo base_url() ?>index.php/purchase/fetch_invoicetotal?id='+id).success(function(dataaddress){
        ...
        var gstAmount = dataaddress.invoice_gstamount;
        var cgstAmount = gstAmount / 2;
        var sgstAmount = gstAmount / 2;

        $scope.invoice_gstamount = gstAmount;
        $scope.cgstAmount = cgstAmount;
        $scope.sgstAmount = sgstAmount;
    });
};

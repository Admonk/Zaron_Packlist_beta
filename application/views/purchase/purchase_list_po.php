                                                          ...
                                                          <div class="table-responsive" >
                                                              ...
                                                              <table class="table align-middle table-nowrap newBorderedTable" >
                                                                  ...
                                                                  <tbody>
                                                                      ...
                                                                      <td><a href="<?php echo base_url(); ?>index.php/purchase/purchase_ordercreate_product?order_id={{name.base_id}}&sales_request=0">{{name.totalamount | indianCurrency}}</a></td>

                    ...
                    <form id="pristine-valid-common" ng-submit="submitForm()" method="post">
                      ...
                      <div class="row">
                          ...
                          <div class="form-group row">
                            ...
                            <div class="col-sm-12">
                             <select class="form-control" required id="sales_head" data-trigger multiple name="sales_head[]" >
                              ...
                              <?php
                                foreach ($sales_head as $value) {
                                     ...
                                     if(in_array($value->id, $sales_head_id))
                                     {
                                       ?>
                         ...
                         <div class="col-md-4" >
                          <div class="form-group row">
                            ...
                            <div class="col-sm-12">
                             <select class="form-control" required name="sales_group" data-trigger  id="sales_group">
                         ...
                         <div class="col-md-4">
                          <div class="form-group row">
                            ...
                            <div class="col-sm-12">
                            <select class="form-control" required id="choices-multiple-default"  data-trigger  placeholder="This is a placeholder" multiple  name="route[]" >
                              ...
                              <?php
                                foreach ($route as $value) 
                                {
                                     ...
                                     if(in_array($value->id, $sales_route_id))
                                     {
                                       ?>
                                       <option value="<?php echo $value->id; ?>" selected ><?php echo $value->name; ?></option>
                                     <?php  
...
<div class="col-md-3">
                        ...
                        <div class="col-md-3">
                          <div class="form-group row">
                            <label class="col-sm-12 col-form-label">Whatsapp Key</label>
                            <div class="col-sm-12">
                              <input id="whatsapp_key" class="form-control" name="whatsapp_key" ng-model="whatsapp_key" type="textDD">
                            </div>
                          </div>
                        </div>
      ...
      <h4 class="card-title mt-3">Presonal Info </h4>
                      ...
                      <div class="row">
                        ...
                        <div class="col-md-6">
                          <div class="form-group row">
                            ...
                            <div class="col-sm-12">
                             <input id="wedding_anniversary" class="form-control" name="wedding_anniversary" ng-init="wedding_anniversary=(myDate | date:'yyyy-MM-dd')"   ng-model="wedding_anniversary" type="date">
                            </div>
                          </div>
                        </div>
                      </div>
                    ...
                    <div class="row">
                       ...
                       <div class="col-md-4">
                          ...
                          <div class="col-md-4">
                          <div class="form-group row">
                            <label class="col-sm-12 col-form-label">Assign the customer to</label>
                            <div class="col-sm-12">
                             <select class="form-control" name="mark_sales_member" data-trigger  id="mark_sales_member" >
                               
                                 <option value="">Select Sales Member</option>
                                 
                                 <?php
                                foreach ($sales_mamber as $sale) 
                                {
      ...
      <input type="radio" name="assign_base" checked value='0'> Move Data 
    </label>



    <label class="radio-inline">
      <input type="radio" name="assign_base"  value='1'> Retain Data
    </label>
                        ...
                        <div class="col-md-12 mt-4">
                          <div class="form-group flaot-end text-end">
                              <input type="hidden" name="hidden_id" value="{{hidden_id}}" />
                                         ...
                                         <a href="<?php echo base_url(); ?>index.php/salesteam/log?status=1"  target="_blank">Log List</a>
...
app.controller('crudController', function($scope, $http){
  ...
  $scope.submitForm = function(){
       ...
       var assign_base=$('input[name="assign_base"]:checked').val();
     var selected2= $('#sales_head').val();
     var sales_group= $('#sales_group').val();
     var mark_sales_member= $('#mark_sales_member').val();
     
     
    $http({
      method:"POST",
      url:"<?php echo base_url() ?>index.php/salesteam/insertandupdate",
      data:{'assign_base':assign_base,'status':$scope.status,'target':$scope.target,'whatsapp_key':$scope.whatsapp_key,'mark_sales_member':mark_sales_member, 'marital_status':$scope.marital_status,'dob':new Date($scope.dob),'fathername':$scope.fathername,'mothername':$scope.mothername,'spouse_details':$scope.spouse_details,'spouse_name':$scope.spouse_name,'sdob':new Date($scope.sdob),'wedding_anniversary':new Date($scope.wedding_anniversary),'sales_id':$scope.sales_id,'phone2':$scope.phone2,'phone':$scope.phone,'pin':$scope.pin,'name':$scope.name,'email':$scope.email,'sales_head':selected2,'route':selected,'sales_group':sales_group,'id':$scope.hidden_id,'action':$scope.submit_button,'tablename':'sales_team'}
...
$scope.fetchData = function(){
    $http({
      ...
      data:{'id':<?php echo $id; ?>, 'action':'fetch_single_data','tablename':'sales_team'}
        ...
        $scope.assign_base = data.assign_base;
       
        
        $scope.mark_sales_member = data.mark_sales_member;
        ...
        $scope.target = data.target;
         ...
         $scope.whatsapp_key = data.whatsapp_key;

                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    <h4 class="mb-sm-0 font-size-18">Sales Team List</h4>

                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            
                                            <li class="breadcrumb-item"><a href="<?php echo base_url(); ?>index.php/salesteam/sales_team_add">Sales Team Create</a></li>
                                            <li class="breadcrumb-item active"> Sales Team List </li>
                                        </ol>
                                    </div>
              ...
              <div class="col-lg-12">
                <div class="card">
                    ...
                    <div class="card-header">
                                        <h4 class="card-title">Sales Team List Table</h4>
                   ...
                   <table id="datatable" class="table table-bordered dt-responsive" datatable="ng" dt-options="vm.dtOptions" >
                     <thead>
                      ...
                      <tbody>
                        ...
                        <!--   <td>{{name.pin}}</td> -->
                          <td>{{name.whatapp_token}}</td>
                            
                          <td>{{name.status}}</td>
                          <td style="display: flex;">
                            <a href="<?php echo base_url(); ?>index.php/salesteam/sales_team_edit/{{name.id}}" target="_blank"  class="btn btn-outline-primary"><i class="mdi mdi-pencil menu-icon"></i></a>
...
app.controller('crudController', function($scope, $http){
  ...
  $scope.fetchData = function(){
    $http.get('<?php echo base_url() ?>index.php/salesteam/fetch_data').success(function(data){

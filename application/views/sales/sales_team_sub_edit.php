                            ...
                            <div class="col-sm-12">
                              ...
                              <?php
                                foreach ($sales_head as $value) {
                                     ...
                                     if(in_array($value->id, $sales_member_id_data))
                                     {
                                       ?>
                          ...
                          <div class="form-group row">
                            ...
                            <div class="col-sm-12">
                             <select class="form-control" name="mark_sales_member" data-trigger  id="mark_sales_member" >
                                 ...
                                 <option value="">Select Sub Sales Member</option>
                        ...
                        <div class="col-md-12 mt-4">
                          <div class="form-group flaot-end text-end">
                              <input type="hidden" name="hidden_id" value="{{hidden_id}}" />
                                    ...
                                    <?php
                                   if(count($mark_sales_member)>0)
                                    {
                                        ?>
                                         <a href="<?php echo base_url(); ?>index.php/salesteam/log?status=2" ng-if="mark_sales_member>0" target="_blank">Log List</a>
...
$scope.fetchData = function(){
    $http({
      method:"POST",
      url:"<?php echo base_url() ?>index.php/salesteamsub/fetch_single_data",
      data:{'id':<?php echo $id; ?>, 'action':'fetch_single_data','tablename':'sales_team_sub'}
    }).success(function(data){

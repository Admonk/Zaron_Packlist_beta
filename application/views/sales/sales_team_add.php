                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    <h4 class="mb-sm-0 font-size-18">Sales Team  Create</h4>

                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                           <li class="breadcrumb-item"><a href="<?php echo base_url(); ?>index.php/dashboard">Dashboard</a></li>
                                            <li class="breadcrumb-item active"> Sales Team Forms </li>
                                        </ol>
                                    </div>
                    ...
                    <form id="pristine-valid-common" ng-submit="submitForm()" method="post">
                      ...
                      <div class="row">
                          ...
                          <div class="form-group row">
                            ...
                            <div class="col-sm-12">
                             <select class="form-control" required id="sales_head" data-trigger multiple name="sales_head" ng-model="sales_head">
                         ...
                         <div class="col-md-4">
                          <div class="form-group row">
                            ...
                            <div class="col-sm-12">
                             <select class="form-control" required id="sales_group" name="sales_group" ng-model="sales_group">

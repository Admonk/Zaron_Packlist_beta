                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    <h4 class="mb-sm-0 font-size-18">Ticket Sent</h4>

                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            <li class="breadcrumb-item"><a href="javascript: void(0);">Ticket</a></li>
                                            <li class="breadcrumb-item active">Ticket Sent</li>
                                        </ol>
                                    </div>
                            ...
                            <div class="col-12">
                                ...
                                <div class="email-leftbar card">
                                    ...
                                    <div class="mail-list mt-4" ng-init="fetchDatacount()">
                                        ...
                                        <a href="<?php echo base_url(); ?>index.php/ticket/ticketcreate" class="active"><i class="mdi mdi-email-check-outline me-2"></i>Sent</a>
                                            ...
                                            <li ng-repeat="name in namesData | filter:query" >
                                                <div class="col-mail col-mail-1 {{name.bgcolor}}" >
                                                    <div class="checkbox-wrapper-mail">
                                                        <input type="checkbox" id="chk_{{name.id}}" class="chaeckboxset" value="{{name.id}}">
                                                        <label for="chk_{{name.id}}" class="toggle"></label>
                                                    </div>
                                                    <a href="<?php echo base_url(); ?>index.php/ticket/ticket_view/{{name.id}}/1/{{name.sub_id}}" class="titlestatus"><b>{{name.ticket_id}}</b> | {{name.lable}} : {{name.username}}</a>
                                                </div>
                                                <div class="col-mail col-mail-2 {{name.bgcolor}}" >
                                                    <a href="<?php echo base_url(); ?>index.php/ticket/ticket_view/{{name.id}}/1/{{name.sub_id}}" class="subject">
...
$scope.user_group = "0";
  ...
  $scope.submit_button = 'Create';
   ...
   $scope.userlist = function (user_group) {
    ...
    $http.get('<?php echo base_url() ?>index.php/ticket/fetchData_sent').success(function(data){

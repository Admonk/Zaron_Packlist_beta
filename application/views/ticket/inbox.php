...
span.active.ng-binding.ng-scope {
    color: #ef6767;
    font-weight: 800;
}
</style>
                                        ...
                                        <ul class="message-list"  ng-init="fetchData_sent()">
                                            ...
                                            <li ng-repeat="name in namesData | filter:query" >
                                                <div class="col-mail col-mail-1 {{name.bgcolor}}" >
                                                    ...
                                                    <a href="<?php echo base_url(); ?>index.php/ticket/ticket_view/{{name.id}}/0/{{name.sub_id}}" class="titlestatus"><b>{{name.ticket_id}}</b> | {{name.lable}} : {{name.username}} <span ng-if="name.replaycount>0" class="active" >( {{name.replaycount}} )</span></a>
                                                </div>
                                                <div class="col-mail col-mail-2 {{name.bgcolor}}" >
                                                    <a href="<?php echo base_url(); ?>index.php/ticket/ticket_view/{{name.id}}/0/{{name.sub_id}}" class="subject">
                                                    ...
                                                    <div class="date">{{name.dateset}}  <span  ng-if="name.status==0" class="bg-danger badge me-2" >New</span> </div>
                                                </div>
                                            </li>

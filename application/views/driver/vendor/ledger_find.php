...
<body data-layout="horizontal" class="full-vh-overflow-hide" data-topbar="dark" ng-app="crudApp" ng-controller="crudController">
                              ...
                              <div class="col-lg-12" >
                                 <form>
                                    <div class="row">
                                       ...
                                       <div class="col">
                                          <input type="date" class="form-control" id="from-date" min="<?php echo date('2024-04-01'); ?>" value="<?php echo date('Y-m-01'); ?>">
                                       </div>
                                       <div class="col">
                                       ...
                                       <div class="col">
                                          ...
                                          <a href="<?php echo base_url(); ?>index.php/vendor/ledger_find_delete_log?customer_id={{customer_id_data}}" target="_blank">Delete Log</a>
                                       </div>
                                    </div>
                                 </form>
                                    ...
                                    <div class="col-xl-3 col-md-3">
                                       ...
                                       <div class="card shadow-none card-h-50 mb-0">
                                          ...
                                          <div class="card-body">
                                             <div class="d-flex align-items-center">
                                                <div class="flex-grow-1">
                                                   <h3 class="text-muted mb-1 font-size-14 lh-1 d-block text-truncate">Total Credit: <span >{{totalcridit | indianCurrency}}</span></h3>
                                                </div>
                                             </div>
                                          </div>
                                          <!-- end card body -->
                                       ...
                                       <table id="datatable"  class="table table-striped table-bordered" style="position: relative;" width="100%" ng-init="fetchDatagetlegderGroup('<?php echo $customer_id; ?>')" >
                                          <thead>
                                             <tr style="position: sticky;top: 0;background: #dfdfdf;">
                                                ...
                                                <th style="width:100px;"><h5 class="font-size-12 mb-0">Particular</th>
                                          ...
                                          <tbody  ng-repeat="names in namesDataledgergroup | filter:query" >
                                             <tr  class="trpoint" ng-if="names.no=='#'" style="background: #e3e3e3;font-weight: 800;vertical-align: baseline;">
                                                ...
                                                <td></td>
                                                <td></td>
                                                <td ><span ng-if="names.debits!=0">{{names.debits | indianCurrency }}</span></td>
                                                <td ><span ng-if="names.credits!=0">{{names.credits | indianCurrency }}</span></td>
                                                <td >
                                          ...
                                          <tbody  ng-repeat="names in namesDataledgergroup | filter:query" >
                                             <tr  class="trpoint {{names.addclass}}" ng-if="names.no!='#'">
                                                <td>{{names.no}}</td>
                                                 <td>
                                                   <a href="<?php echo base_url(); ?>index.php/purchase/invoice?order_id={{names.order_id}}&invoice_id={{names.order_base_id}}&invoice_no={{names.order_no}}&old_tablename_sub=0&tablename=purchase_orders_process&tablename_sub=purchase_product_list_process&movetablename=purchase_orders_process&movetablename_sub=purchase_product_list_process" ng-if="names.order_id!='#'" target="_blank">{{names.account_head_name || names.name}}</a>
                                                      
                                                      <a href="#" ng-if="names.order_id=='#'">{{names.account_head_name || names.name}}</a>
                                                ...
                                                <td >
                                                   <a href="<?php echo base_url(); ?>index.php/purchase/invoice?order_id={{names.order_id}}&invoice_id={{names.order_base_id}}&invoice_no={{names.order_no}}&old_tablename_sub=0&tablename=purchase_orders_process&tablename_sub=purchase_product_list_process&movetablename=purchase_orders_process&movetablename_sub=purchase_product_list_process" ng-if="names.order_id!='#'" target="_blank">
  ...
  <?php 
          if($this->session->userdata['logged_in']['userid'] == '1541' || $this->session->userdata['logged_in']['userid'] == '1453' || $this->session->userdata['logged_in']['userid'] == '1769' || $this->session->userdata['logged_in']['userid'] == '1773' || $this->session->userdata['logged_in']['userid'] == '1763' ){
        ?>
                                                   ...
                                                   <a href="<?php echo base_url(); ?>index.php/journal/edit?id={{names.id}}&deletemod={{names.deletemod}}&customer_id={{names.customer_id}}"  
                                                    ...
                                                    <button type="button" ng-click="editData(names.id)" ng-if="names.edit_status==1 || names.process_by !='Voucher'" class="btn btn-outline-danger btn-sm"><i class="mdi mdi-pencil menu-icon"></i>
                                                    </button>
       ...
       ?>
                                                     <button type="button" class="btn btn-outline-danger btn-sm" ng-if="names.process_by == 'Voucher'">
                                                   <a href="<?php echo base_url(); ?>index.php/journal/edit?id={{names.id}}&deletemod={{names.deletemod}}&customer_id={{names.customer_id}}&voucher_type=journal"    
                                                      target="_blank"><b class="mdi  menu-icon" style="color: red;">V</b>
                                                   </a>
                                                </button>
                                                   

                                                   <button type="button"   ng-if="names.edit_status==1" ng-click="deleteData(names.id)" class="btn btn-outline-danger btn-sm"><i class="mdi mdi-delete menu-icon"></i></button>
            ...
            <div class="modal-body">
               <div class="form-group row">
                  ...
                  <div class="some-class">
                     ...
                     <input type="radio" checked class="radio" name="Payer12" value="3" id="Vendor12" ng-click="selectOption('Other')"/>
            ...
            <div class="modal-body">
               ...
               <div class="form-group row">
                  ...
                  <div class="some-class">
                     ...
                     <input type="radio" class="radio" name="Payee1" checked value="3" id="Vendor1" ng-click="selectOption('Other2')"/>
               ...
               <div class="show2" style="display:none;">
                  <div class="form-group row">
                     ...
                     <div class="some-class">
                        ...
                        <input type="radio" class="radio" name="Payee2" checked value="3" id="Vendor2"ng-click="selectOption('Other3')" />
               ...
               <div class="show3" style="display:none;">
                  <div class="form-group row">
                     ...
                     <div class="some-class">
                        ...
                        <input type="radio" class="radio" name="Payee3" checked value="3" id="Vendor3" ng-click="selectOption('Other4')"/>
               ...
               <div class="show4" style="display:none;">
                  <div class="form-group row">
                     ...
                     <div class="some-class">
                        ...
                        <input type="radio" class="radio" name="Payee4" checked value="3" id="Vendor4" ng-click="selectOption('Other5')"/>
               ...
               <div class="show5" style="display:none;">
                  <div class="form-group row">
                     ...
                     <div class="some-class">
                        ...
                        <input type="radio" class="radio" name="Payee5" checked  value="3" id="Vendor5" ng-click="selectOption('Other6')"/>
               ...
               <div class="show6" style="display:none;">
                  <div class="form-group row">
                     ...
                     <div class="some-class">
                        ...
                        <input type="radio" class="radio" name="Payee6" checked value="3" id="Vendor6"ng-click="selectOption('Other7')" />
               ...
               <div class="show7" style="display:none;">
                  <div class="form-group row">
                     ...
                     <div class="some-class">
                        ...
                        <input type="radio" class="radio" name="Payee7" checked value="3" id="Vendor7" ng-click="selectOption('Other8')"/>
               ...
               <div class="show8" style="display:none;">
                  <div class="form-group row">
                     ...
                     <div class="some-class">
                        ...
                        <input type="radio" class="radio" name="Payee8" checked value="3" id="Vendor8" ng-click="selectOption('Other9')"/>
               ...
               <div class="show9" style="display:none;">
                  <div class="form-group row">
                     ...
                     <div class="some-class">
                        ...
                        <input type="radio" class="radio" name="Payee9" checked value="3" id="Vendor9" ng-click="selectOption('Other10')"/>
               ...
               <div class="show10" style="display:none;">
                  <div class="form-group row">
                     ...
                     <div class="some-class">
                        ...
                        <input type="radio" class="radio" name="Payee10" checked value="3" id="Vendor10" ng-click="selectOption('Other11')"/>
   ...
   <script>
      ...
      $('#exportdata').on('click', function() {
          ...
          url = '<?php echo base_url() ?>index.php/vendor/fetch_data_get_ledger_view_export?limit=10&deleteid=0&customer_id='+id+'&formdate='+fromdate+'&todate='+fromto+'&payment_status='+payment_status;
   ...
   <script>
      ...
      $scope.fetchDatagetlegderGroup = function(id,fromdate,fromto,payment_status){
        ...
        var fromdate= $('#from-date').val();
          ...
          $http.get('<?php echo base_url() ?>index.php/vendor/fetch_data_get_ledger_view?limit=10&deleteid=0&customer_id='+id+'&formdate='+fromdate+'&todate='+fromto+'&payment_status='+payment_status).success(function(data){
      ...
      $scope.onviewparty_edit = function(l_id,id,name,dc,cc,d_cid,d_cname,d_party_type,d_amount)
      {
        ...
        var amount=0;
          ...
          if(d_cid>0)
          {
              ...
              $('#party1').val(id+'-'+name);
              $("input[name='Payer1'][value='" + 3 + "']").attr("checked", "checked");
        ...
        $scope.deleteData = function(id)
        {
          if(confirm("Are you sure you want to remove it?"))
          {
            ...
            $http({
              ...
              data:{'id':id, 'action':'Deletepurchase_invoice','tablename':'all_ledgers'}
            }).success(function(data){
      ...
      $scope.fetchDatagetlegderGroupTotal = function(id,fromdate,fromto,payment_status){
          ...
          var fromto= $('#to-date').val();
          var payment_status= $('#payment_status').val();
         $http.get('<?php echo base_url() ?>index.php/vendor/fetch_data_get_ledger_view_total?limit=10&deleteid=0&customer_id='+id+'&formdate='+fromdate+'&todate='+fromto+'&payment_status='+payment_status).success(function(data){

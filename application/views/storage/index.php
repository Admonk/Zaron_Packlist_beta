                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    <h4 class="mb-sm-0 font-size-18">Storage Form</h4>

                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                               <li class="breadcrumb-item"><a href="<?php echo base_url(); ?>index.php/dashboard">Dashboard</a></li>
                                            <li class="breadcrumb-item active"> Storage Form</li>
                                        </ol>
                                    </div>
                         ...
                         <div class="col-md-6">
                          <div class="form-group row">
                            ...
                            <div class="tooltip">
                                   ...
                                   <span class="tooltiptext">Enter the storage items name in the field and click on add to store the list of storage items</span>
                           </div>
...
<hr></hr>
<h4 class="mb-sm-0 font-size-18">Storage List</h4>      
<br>
...
app.controller('crudController', function($scope, $http){
  ...
  $scope.fetchData = function(){
    $http.get('<?php echo base_url() ?>index.php/storage/fetch_data').success(function(data){
  ...
  $scope.submitForm = function(){
    $http({
      method:"POST",
      url:"<?php echo base_url() ?>index.php/storage/insertandupdate",
      data:{'name':$scope.name,'id':$scope.hidden_id,'action':$scope.submit_button,'tablename':'storage'}
      ...
      if(data.error != '1')
      {
        ...
        $scope.name = "";
        $scope.hidden_id = "";
        $scope.successMessage = "storage name successfully "+$scope.submit_button;
        $scope.fetchData();
      }
...
$scope.fetchSingleData = function(id){
    $http({
      method:"POST",
      url:"<?php echo base_url() ?>index.php/storage/fetch_single_data",
      data:{'id':id, 'action':'fetch_single_data','tablename':'storage'}
    }).success(function(data){
...
$scope.deleteData = function(id){
    if(confirm("Are you sure you want to remove it?"))
    {
      $http({
        method:"POST",
        url:"<?php echo base_url() ?>index.php/storage/insertandupdate",
        data:{'id':id, 'action':'Delete','tablename':'storage'}
      }).success(function(data){
        $scope.success = false;
        $scope.error = false;
        $scope.fetchData();

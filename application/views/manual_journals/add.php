...
<body data-layout="horizontal" class="full-vh-overflow-hide" data-topbar="dark" ng-app="crudApp" ng-controller="crudController">
 ...
 <div class="main-content">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    <h4 class="mb-sm-0 font-size-18">Manual Journal Entry </h4>

                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            <li class="breadcrumb-item"><a href="<?php echo base_url(); ?>index.php/dashboard">Dashboard</a></li>
                                            <li class="breadcrumb-item">Manual Journal  Create !</li>
                                        </ol>
                                    </div>
             ...
             <a href="<?php echo base_url(); ?>index.php/accountheads/accountheads_add" class="btn btn-primary"   style="float:right;margin: 5px 10px;"  target="_blank">Others Ledger Creation</a>
               <a href="<?php echo base_url(); ?>index.php/manual_journals/newcreate_excess" class="btn btn-success"   style="float:right;margin: 5px 10px;"  target="_blank">Excess Return</a>
                    <a href="<?php echo base_url(); ?>index.php/manual_journals/discount_allowed" class="btn btn-success"   style="float:right;margin: 5px 10px;"  target="_blank">Discount Allowed</a>
                    ...
                    <form id="pristine-valid-common" ng-submit="submitForm()" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <input id="party_type" type="hidden" value="1">
                               ...
                               <div class="col-md-12" ng-if="get_user_id == 2">
                                              
                                              <div class="form-group row">
                                                   
                                                      <label class="col-sm-2 col-form-label"><b>Type</b> <span style="color:red;">*</span> </label>
                                                      <div class="col-sm-4">
                               ...
                               <input type="radio" checked id="type" name="settype" value="1">
                               <label class="radio-inline"  for="type">Rent</label> &nbsp;&nbsp;
                             
                              <input type="radio"  id="type1" name="settype" value="0">
                              <label class="radio-inline" for="type1">Collection</label>
                              ...
                              <div class="col-md-12"  id="displayexpence" style="display:none;">
                                                   ...
                                                   <div class="form-group row" >
                                                         ...
                                                         <div class="col-sm-4">
                                                            ...
                                                            <select class="form-control"  id="expense_head" name="expense_head">
                                                                
                                                                <option value="0">Select Expense head</option>
                                                                  
                                                                       <option  ng-repeat="name in accountshead" value="{{name.id}}">{{name.name}}</option>
                    ...
                    <table  class="table table-bordered dt-responsive  nowrap w-100"  >
                      ...
                      <tbody id="show_details">
                        <tr>
                            ...
                            <td><input type="textt" class="form-control debits" min="0" onkeypress="return isNumberKey(event)" name="debits"></td>
                            <td><input type="textt" class="form-control credits" min="0" onkeypress="return isNumberKey(event)" name="credits"></td>
...
<input type="hidden" name="cid" id="checkids" value="0">
...
$(document).ready(function(){
    ...
    $('.payment_mode').on('change',function(){
      ...
      if(val=='Cash')
      {
          ...
          var data='<option value="0">Select Cash</option><?php foreach($bankaccount as $val) { if($val->id==25) { ?> <option seletced value="<?php echo $val->id ?>"><?php echo $val->bank_name ?>-<?php echo $val->account_no ?></option> <?php } } ?>';
          $('#bankaccount').html(data);
          $('#reference_no').show();
          $('#bankaccountshow').show();
...
$scope.submitFormmaster = function(){
   ...
   $scope.completeCustomer=function(){
        ...
        var search=  $('#choices-single-default').val();
         ...
         var type = $("input[name='settype']:checked").val();
        ...
        $http({
          method:"POST",
          url:"<?php echo base_url() ?>index.php/manual_journals/usergetjm",
          data:{'party_type':party_type,'search':search,'type': type}
        }).success(function(data){
  ...
  $scope.submitForm = function(){
    ...
    $http({
      ...
      data:{
          ...
          ?>
          'id':$scope.hidden_id,'bankaccount':bankaccount,'expense_head':expense_head,'bill_no':bill_no,'action':$scope.submit_button,'party_type':party_type,'get_users':$scope.get_users,'tablename':'manual_journals'}
         }).success(function(data){

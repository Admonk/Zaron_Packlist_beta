                          ...
                          <div class="row">
                              ...
                              <select class="form-control" data-trigger name="choices-single-default"
                                                ...
                                                if(isset($_GET['to_date']))
                                                {
                                                  ...
                                                  ?>
                            <div class="col">
                              <input type="date" class="form-control" id="from-date" min="<?php echo date('2024-04-01'); ?>" value="<?php echo $search_date; ?>">
                            </div>
                            <div class="col">
...
<hr>
  ...
  ?>
                                        ...
                                        <div class="d-flex align-items-center">
                                            <div class="flex-grow-1">
                                                <h3 class="text-muted mb-1 font-size-14 lh-1 d-block text-truncate">Opening Balance: 
                                                  <span ng-if="opstatus==1" style="color:red" class="ng-binding ng-scope">{{totals_opeing | indianCurrency}}</span>
                                                  <span ng-if="opstatus==0" style="color:green" class="ng-binding ng-scope">{{totals_opeing | indianCurrency}}</span>
                                                </h3>
                            ...
                            <div class="col-xl-3 col-md-3">
                                <div class="card shadow-none card-h-50 mb-0">
                                    <div class="card-body">
                                        <div class="d-flex align-items-center">
                                            <div class="flex-grow-1">
                                                <h3 class="text-muted mb-1 font-size-14 lh-1 d-block text-truncate">Total Debit: <span class="ng-binding">{{totalbalancec | indianCurrency}}</span></h3>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-xl-3 col-md-3">
                                ...
                                <div class="card shadow-none card-h-50 mb-0">
                                    ...
                                    <div class="card-body">
                                        <div class="d-flex align-items-center">
                                            <div class="flex-grow-1">
                                                <h3 class="text-muted mb-1 font-size-14 lh-1 d-block text-truncate">Total Credit: <span class="ng-binding">{{totalbalanced | indianCurrency}}</span></h3>
                                            </div>
                                        </div>
                                    </div><!-- end card body -->
                                </div><!-- end card -->
                                        ...
                                        <div class="d-flex align-items-center">
                                             ...
                                             <div class="flex-grow-1">
                                                <h3 class="text-muted mb-1 font-size-14 lh-1 d-block text-truncate">Current Balance: 
                                                  <span ng-if="cgetstatus==1" style="color:red" class="ng-binding ng-scope">{{ctotalbalance | indianCurrency}}</span>
                                                  <span ng-if="cgetstatus==0" style="color:green" class="ng-binding ng-scope">{{ctotalbalance | indianCurrency}}</span>
                                                </h3>
                                            </div>
                                             </div>
                                    </div><!-- end card body -->
                                                    ...
                                                    <table class="table table-bordered" style="font-size:11.5px;position: relative;">
                                                            ...
                                                            <tr style="position: sticky;top: 0;background: #dfdfdf;">
                                                                ...
                                                                <td style="width: 15%;text-align: left;">
                                                                        ...
                                                                        <h5 class="font-size-12 mb-0">Voucher No</h5>
                                                            ...
                                                            <tr ng-if="namess.no=='OP1'" style="font-weight: 800;">
                                                               ...
                                                               <td style="text-align: left;"> </td>
                                                                ...
                                                                <td style="text-align: left;"><span ng-if="namess.credit!=0">{{namess.credit | indianCurrency}}</span></td>
                                                               <td style="text-align: left;"><span ng-if="namess.debit!=0">{{namess.debit | indianCurrency}}</span></td>

                                                               <td style="text-align: left;">
                                                               <span  ng-if="namess.getstatus==1" style="color:green">{{namess.balance | indianCurrency}}</span>
                                                               <span  ng-if="namess.getstatus==0" style="color:red">{{namess.balance | indianCurrency}}</span>
                                                               </td >
                                                               <td style="text-align: left;"></td>
                                                               <td style="text-align: left;"></td>
                                                               <td style="text-align: left;"></td>
                                                            ...
                                                            <tr ng-if="namess.no!='OP1'" class="{{namess.addclass}}">
                                                               ...
                                                               <td style="text-align: left;">{{namess.create_date}}</td>
                                                                ...
                                                                <td style="text-align: left;">
                                                                <span ng-if="namess.credit!=0"> {{namess.credit | indianCurrency}}</span>
                                                                  ...
                                                                  <span ng-if="namess.debit!=0"> {{namess.debit | indianCurrency}}</span>
                                                                </td>
                                                                 ...
                                                                 <td style="text-align: left;">
                                                                      ...
                                                                      <span  ng-if="namess.getstatus1==1" style="color:green">{{namess.balance | indianCurrency}}</span>
                                                                      <span  ng-if="namess.getstatus1==0" style="color:red">{{namess.balance | indianCurrency}}</span>
                                                                ...
                                                                <td style="text-align: left;">
                                                                      ...
                                                                      <span ng-if="namess.notes">{{namess.notes}}</span>
                                                                      <samll ng-if="namess.amount!=0"><br>{{namess.username}} {{namess.amount}}</samll>
                                                                </td>

                                                                <td style="text-align: left;">
                                                                   <span>{{namess.voucher_no}}</span> 
   ...
   if($this->session->userdata['logged_in']['access']=='1' || $this->session->userdata['logged_in']['access']=='14' || $this->session->userdata['logged_in']['access']=='2'  || $this->session->userdata['logged_in']['access']=='5' || $this->session->userdata['logged_in']['access']=='15')
   {
       ...
       <?php 
        ...
        ?>
      <button type="button" class="btn btn-outline-danger btn-sm" ng-if="namess.process_by == 'Voucher'">
                  <a href="<?php echo base_url(); ?>index.php/journal/edit?id={{namess.id}}&deletemod={{namess.deletemod}}&customer_id={{namess.customer_id}}&voucher_type={{namess.voucher_base}}"  
                      target="_blank"><i class="mdi mdi-pencil menu-icon" style="color: red;"></i>
                  </a>
                </button> 
                
                           <button ng-if="namess.process_by != 'Voucher'" type="button" ng-click="editData(namess.id)" class="btn btn-outline-danger btn-sm"><i class="mdi mdi-pencil menu-icon"></i></button>
        <?php
       }
  ...
  <button type="button" class="btn btn-outline-danger btn-sm" ng-if="namess.process_by == 'Voucher'">
                  <a href="<?php echo base_url(); ?>index.php/journal/edit?id={{namess.id}}&deletemod={{namess.deletemod}}&customer_id={{namess.customer_id}}&voucher_type={{namess.voucher_base}}&voucher_type=journal"    

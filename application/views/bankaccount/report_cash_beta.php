                      ...
                      <form>
                          <div class="row">
                           ...
                           <div class="col">
                             ...
                             <button type="button" id="exportdata1"  ng-click="exportToExcel()" class="btn btn-success waves-effect waves-light"  >Export</button>
                            </div>
               ...
               <div class="row my-3">
                ...
                <div class="row" ng-init="fetchDatadetailsTotal(<?php echo $bank_id; ?>)">
                            ...
                            <div class="col-xl-3 col-md-3" >
                                    ...
                                    <div class="card-body">
                                        <div class="d-flex align-items-center">
                                            <div class="flex-grow-1">
                                                ...
                                                <h4 class="mb-3">
                                                     <span ng-if="getstatus1==1" style="color:red" class="ng-binding ng-scope">{{opeingbalance | number}}</span>
                                                     <span ng-if="getstatus1==0" style="color:green" class="ng-binding ng-scope">{{opeingbalance | number}}</span>
                                                </h4>
                              ...
                              <div class="col-xl-3 col-md-3"  ng-if="totalbalancec > 0">
                                <!-- card -->
                            ...
                            <div class="col-xl-3 col-md-3" ng-if="totalbalanced > 0">
                                <!-- card -->
                                <div class="card card-h-50">
                                    <!-- card body -->
                                    <div class="card-body">
                         ...
                         <div class="col-xl-3 col-md-3"  ng-if="totalbalance > 0">
                                <!-- card -->
                                <div class="card card-h-50">
                                    <!-- card body -->
                                    <div class="card-body">
                                        <div class="d-flex align-items-center">
                                            <div class="flex-grow-1">
                                                ...
                                                <h4 class="mb-3">
                                                  ...
                                                  <span ng-if="getstatus==1" style="color:green" class="ng-binding ng-scope">{{ closing_balance | number}}</span>
                                                  <span ng-if="getstatus==0" style="color:red" class="ng-binding ng-scope">{{ closing_balance | number}}</span>
                                        ...
                                        <div class="tab-content text-muted mt-4 mt-xl-0" id="v-pills-tabContent" ng-init="fetchDatadetails(<?php echo $bank_id; ?>)">
                                            <div class="tab-pane fade active show" id="v-price-one" role="tabpanel" aria-labelledby="v-pills-tab-one">
                                                <div class="table-responsive text-center pricing-table-bg">
                                                    <table class="table table-bordered" style="font-size:11.5px;position: relative;" id="datatable">
                                                            ...
                                                            <tr style="position: sticky;top: 0;background: #dfdfdf;">
                                                                ...
                                                                <td style="width: 10%;text-align: left;">
                                                                 ...
                                                                 <td style="width: 10%;text-align: left;">
                                                                        ...
                                                                        <h5 class="font-size-14 mb-0">Payment Mode</h5>
                                                            ...
                                                            <tr ng-if="namess.no=='OP1'" style="font-weight: 800;">
                                                               ...
                                                               <td style="text-align: left;"> </td>
                                                                ...
                                                                <td style="text-align: left;"></td>
                                                               <td style="text-align: left;" ng-if="namess.getstatus==0">
                                                               ...
                                                               <td style="text-align: left;" ng-if="namess.getstatus==1">
                                                               <span  ng-if="namess.getstatus==1" style="color:green">{{namess.balance | number}}</span>
                                                               <span  ng-if="namess.getstatus==0" style="color:red">{{namess.balance | number}}</span>
                                                               </td >
                                                               <td style="text-align: left;"></td>
                                                            ...
                                                            <tr ng-if="namess.no!='OP1'" class="{{namess.addclass}}">
                                                               ...
                                                               <td style="text-align: left;">{{namess.create_date}}</td>
                                                                ...
                                                                <!-- <td style="text-align: left;">
                                                                   ...
                                                                   <span ng-if="namess.credit!=0"> {{namess.balance | number}}</span>
                                                               </td > -->
...
$scope.Getbankaccount3 = function () {
   ...
   $scope.exportToExcel = function () {
                ...
                $("#datatable").table2excel({
                    filename: "CASH_REPORT_"+date+".xls"
                });
 };
...
$scope.deleteData = function(id){
 ...
 $scope.fetchDatadetails = function(id,fromdate,fromto){
    ...
    $http.get('<?php echo base_url() ?>index.php/bankaccount/fetch_data_details_cash_only_beta?account_id=25&fromdate='+fromdate+'&fromto='+fromto).success(function(data){
...
$scope.fetchDatadetailsTotal = function(id,fromdate,fromto){
     ...
     var fromdate= $('#from-date').val();
       ...
       $http.get('<?php echo base_url() ?>index.php/bankaccount/fetch_data_details_total_cash_only_beta?account_id=25&fromdate='+fromdate+'&fromto='+fromto).success(function(data){
                ...
                $scope.getstatus1=data.getstatus1;
                      ...
                      $scope.closing_balance=  $scope.opeingbalance + $scope.totalbalancec -  $scope.totalbalanced;

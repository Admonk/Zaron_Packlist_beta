                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    <h4 class="mb-sm-0 font-size-18">NON Cash Report </h4>

                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                               <li class="breadcrumb-item"><a href="<?php echo base_url(); ?>index.php/dashboard">Dashboard</a></li>
                                            <li class="breadcrumb-item active">NON Cash Report</li>
                                        </ol>
                                    </div>
     ...
     <div class="row">
               ...
               <div class="row my-3">
                            <div class="col-xl-12">
                                    ...
                                    <h4 class="card-title font-size-18">NON CASH Report Date :  {{ fromdate | date : "dd-MM-yyyy"}} </h4>
...
$(document).ready(function(){
 $('#from-date').blur(function() 
 {
    ...
    var date = $(this).val();
     ...
     var valdationdate='<?php echo date("2023-10-01"); ?>';
...
$scope.Getbankaccount3 = function () {
   ...
   $scope.exportToExcel = function () {
                ...
                $("#datatable").table2excel({
                    filename: "NON_CASH_REPORT_"+date+".xls"
                });
 };
...
$scope.deleteData = function(id){
 ...
 $scope.fetchDatadetails = function(id,fromdate,fromto){
    ...
    $http.get('<?php echo base_url() ?>index.php/bankaccount/fetch_data_details_cash_only_beta?account_id=0&fromdate='+fromdate+'&fromto='+fromto).success(function(data){
...
$scope.fetchDatadetailsTotal = function(id,fromdate,fromto){
     ...
     var fromdate= $('#from-date').val();
       ...
       $http.get('<?php echo base_url() ?>index.php/bankaccount/fetch_data_details_total_cash_only_beta?account_id=0&fromdate='+fromdate+'&fromto='+fromto).success(function(data){

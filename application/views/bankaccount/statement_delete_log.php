                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    <h4 class="mb-sm-0 font-size-18">Bank Accounts & Transactions Delete Log</h4>

                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                               <li class="breadcrumb-item"><a href="<?php echo base_url(); ?>index.php/dashboard">Dashboard</a></li>
                                            <li class="breadcrumb-item active"> Bank Accounts & Transactions Delete Log</li>
                                        </ol>
                                    </div>
...
<div class="row my-3">
                ...
                <div class="row" ng-init="fetchDatadetailsTotal(<?php echo $bank_id; ?>)" style="display:none;">
                         ...
                         <div class="col-xl-4 col-md-4">
                           ...
                           if($this->session->userdata['logged_in']['access']=='1' ||  $this->session->userdata['logged_in']['access']=='2')
                           {
                               ...
                               ?>
                                                       <th style="width:10%;"><h5 class="font-size-14 mb-0">Action</h5></th>
                                   <?php
                                                            ...
                                                            <tr ng-if="namess.no!='OP1'" class="{{namess.addclass}}">
                                                               ...
                                                               <td style="text-align: left;">{{namess.create_date}}</td>
                                                                ...
                                                                <td style="text-align: left;">
                                                                     ...
                                                                     <samll ><br><b>{{namess.username}}</b> </samll>
                                                                </td>
                                                                    <td style="text-align: left;">
   ...
   if($this->session->userdata['logged_in']['access']=='1' ||  $this->session->userdata['logged_in']['access']=='2')
   {
       ...
       ?>
                               <td > <button type="button" ng-click="deleteDataRevart(namess.id)" class="btn btn-outline-danger btn-sm">Revert</button></td></td>
           <?php
...
$('#exportdata').on('click', function() {
    ...
    url = '<?php echo base_url() ?>index.php/bankaccount/export_bank_statement_full?limit=10&deleteid=1&account_id='+id+'&formdate='+fromdate+'&todate='+fromto;
...
$scope.deleteDataRevart = function(id){
    if(confirm("Are you sure you want to Revert it?"))
    {
      ...
      $http({
        ...
        data:{'id':id, 'action':'Deleterevart','tablename':'bankaccount_manage'}
      }).success(function(data){
        $scope.success = false;
        $scope.error = false;
 ...
 $scope.fetchDatadetails = function(id,fromdate,fromto){
    ...
    $http.get('<?php echo base_url() ?>index.php/bankaccount/fetch_data_details?deleteid=1&account_id='+id+'&fromdate='+fromdate+'&fromto='+fromto).success(function(data){
...
$scope.fetchDatadetailsTotal = function(id){
     
     
     
      

       $http.get('<?php echo base_url() ?>index.php/bankaccount/fetch_data_details_total?account_id='+id).success(function(data){

                            ...
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                ...
                                <div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        ...
                                        <li class="breadcrumb-item active">Profit And Loss View</li>
                                    </ol>
                                </div>
                                ...
                                <div class="row" style="margin: 13px 0px;">
                                    <div class="col-6 mb-2">
                                        <div class="page-title-box d-sm-flex align-items-center justify-content-between p-0">
                                            <h4 class="mb-sm-0 font-size-18">Profit And Loss View</h4>
                                        </div>
                                    </div>
                                    <div class="col-lg-12">
                                        <form>
                              ...
                              <select class="form-control" data-trigger name="choices-single-default" id="choices-single-default">
                                                            ...
                                                            foreach($categories as $val)
                                                            {
                                                                ?>
                                                                 ...
                                                                 <option  value="<?php echo $val['short_word']; ?>"><?php echo $val['title']; ?></option>

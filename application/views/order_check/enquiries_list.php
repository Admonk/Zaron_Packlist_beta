               ...
               <div class="container-fluid">
                         ...
                         <div class="row">
                          ...
                          <label>From Date: </label><input type="date" class="form-control" id="from_date" ng-model="from_date" ng-change="DateFilter()">
                           ...
                           <div class="col-sm-3" style="align-self: end;"> <!--data-trigger -->
...
app.controller('crudController', function($scope, $http){
  ...
  $scope.error = false;
   ...
   function getData() {
      ...
      var sl = $('#choices-single-default').val();
      
       $http.get('<?php echo base_url() ?>index.php/order_check/fetch_data_table?page=' + $scope.currentPage + '&size=' + $scope.pageSize + '&search=' + $scope.searchText + '&tablename=' + $scope.tablename+'&order_base='+order_base+'&from_date='+from_date+'&to_date='+to_date+'&sl='+sl)

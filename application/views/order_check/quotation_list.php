                                                                  ...
                                                                  <tbody>
                                                                      ...
                                                                      <tr  ng-repeat="name in namesData">
                                                                        ...
                                                                        <td><a ng-click="disable_load()" href="<?php echo base_url(); ?>index.php/order/ordercreate_product_quotation?order_id={{name.base_id}}">
                                                                           ...
                                                                           <td><a ng-click="disable_load()" href="<?php echo base_url(); ?>index.php/order/ordercreate_product_quotation?order_id={{name.base_id}}">{{name.totalamount}}</a></td>
                                                                         ...
                                                                         <td> <a ng-click="disable_load()" href="<?php echo base_url(); ?>index.php/order/ordercreate_product_quotation?order_id={{name.base_id}}&viewbase=1">
                                                                               {{ name.new_status }}
                                                                               </a></td>

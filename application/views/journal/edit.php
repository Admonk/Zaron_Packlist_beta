                  ...
                  <div class="col-12">
                     ...
                     <div class="row align-items-start">
                        <div class="col-md-4">
                           ...
                           <select id="vch_type" name="selectedVoucherType" ng-model="selectedVoucherType" ng-options="value as label for (value, label) in voucherTypes" ng-change="onVoucherTypeChange()" class="form-control " ng-disabled="true">
                        ...
                        <div class="col-md-4">
                           ...
                           <div class="input-group date">
                              <input id="vch_date" type="date" name="selectedDateModels" ng-model="selectedDateModels" value="{{selectedDateModels}}" class="form-control" ng-model-options="{ getterSetter: true }">
        ...
        $http({
            ...
            $scope.id = datas.id;
                    if(datas.debits > 0){
                        cr_dr_type = 'dr';
                        cr_val = null;
                        dr_val =parseInt(datas.debits);
                        
                        
                    }else{
                        cr_dr_type = 'cr';
                        dr_val = null;
                        cr_val = parseInt(datas.credits);
...
// console.log(customer_id)
         ...
         if($scope.selectedVoucherType == 'contra'){
            ...
            endpoint = 'index.php/journal/update_data?cr_type=' + cr_type + '&cr_party=' + cr_party;
         }

...
<body data-layout="horizontal" class="full-vh-overflow-hide" data-topbar="dark" ng-app="crudApp" ng-controller="crudController">
            ...
            <div class="col-lg-12">
              <div class="card">
                ...
                <div class="card-header1">
                  ...
                  <a href="#" class="btn btn-success" data-bs-toggle="modal" data-bs-target=".exampleModalToggleLabel2" style="float:right;margin: 5px 10px;">Purchase Name Update</a>
                ...
                <div class="card-body" ng-init="fetchData()">
                  ...
                  <h5 ng-if="purchase_name_view">Purchase name : {{purchase_name_view}} </h5>
                  <h5 ng-if="specification_view">Specification : {{specification_view}} </h5>
                  <small style="color:red;" ng-if="source_name">Old name: {{source_name}}</small>
                  ...
                  <form id="pristine-valid-common" ng-submit="submitForm()" method="post">
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-6">
                        <div class="form-group row">
                          <label class="col-sm-12 col-form-label">Sub Categories <span style="color:red;">*</span></label>
                          <div class="col-sm-12">
                            <select class="form-control categories" required name="sub_categories" ng-model="sub_categories">
                              ...
                              ?>
                                <option value="<?php echo $value->id; ?>" data-id="<?php echo $value->id; ?>"><?php echo $value->sub_categories; ?></option>
                              <?php
                        ...
                        <div class="form-group row">
                          ...
                          <div class="col-sm-12">
                            ...
                            <select class="form-control" name="type" ng-model="type">
                              ...
                              <option value="0"> Iron And Steel Corrugated Sheet</option>
                              ...
                              <option value="16">Roll Sheet 17</option>
                              <option value="9">Rent&charges 18</option>
                      ...
                      <div class="col-md-3" id="formuladiv">
                        <div class="form-group row">
                          <label class="col-sm-12 col-form-label">Fact <span style="color:red;">*</span> </label>
                          <div class="col-sm-12">
                      ...
                      <div class="col-md-3" id="formula2" style="display:none">
                        <div class="form-group row">
                          <label class="col-sm-12 col-form-label">Fact 2 <span style="color:red;">*</span></label>
                          <div class="col-sm-12">
                      ...
                      <div class="col-md-4" style="display:none;">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-12">
                            <input id="source_name" class="form-control" name="source_name" placeholder="Source Name" ng-model="source_name" type="text">
                          </div>
                        </div>
                      </div>
                      ...
                      foreach ($additional_information2 as $vvl) {
                      ...
                      <h4 class="card-title mt-3">Purchase Price Details <a href="<?php echo base_url(); ?>index.php/products/products_purchase_price_list?product_id=<?php echo $id; ?> " target="_blank">History</a></h4>
                      ...
                      <div class="col-md-4">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-12">
                            <input id="purchase_price" class="form-control" name="purchase_price" ng-model="purchase_price" type="text">
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="col-md-4">
                        <div class="form-group row">
                          <label class="col-sm-12 col-form-label">Purchase Average Price </label>
                          <div class="col-sm-12">
                            {{average_price}}
                          </div>
                        </div>
                      ...
                      <div class="col-md-4">
                        <div class="form-group row">
                            <label class="col-sm-12 col-form-label">Profit Or Loss</label>
                            <div class="col-sm-12 {{profile_and_loss < 0 ? 'red-text' : ''}}">
                                {{profile_and_loss}}
                            </div>
                        </div>
                    </div>

                      <h4 class="card-title mt-3">Selling Price Details <a href="<?php echo base_url(); ?>index.php/products/products_selling_price_list?product_id=<?php echo $id; ?> " target="_blank">History</a></h4>
                      ...
                      <span class="row">
                        ...
                        <div class="col-md-2">
                          <div class="form-group row">
                            <label class="col-sm-12 col-form-label">Selling Average Price <span style="color:red;">*</span></label>
                            <div class="col-sm-12">
                              {{selling_average_price}}
                            </div>
                          </div>
                        </div>
                      ...
                      <h4 class="card-title mt-3">Actual Sales Price Details <a href="<?php echo base_url(); ?>index.php/products/actual_product_selling_price?product_id=<?php echo $id; ?> " target="_blank">History</a></h4>

                      <span class="row">

                          <div class="col-md-2">
                            <div class="form-group row">
                              <label class="col-sm-12 col-form-label"> Actual Average Selling Price <span style="color:red;">*</span></label>
                              <div class="col-sm-12">
                        ...
                        <div class="col-md-5">
                          ...
                          <div class="form-group row">
                            ...
                            <select class="form-control price_type" name="price_type">
                              ...
                              ?>
                                <option value="<?php echo $value->id; ?>" <?php if ($value->id == 5) {
                                                                            echo "selected";
                                                                          } ?>><?php echo $value->name; ?></option>
                              <?php
                        ...
                        <div class="col-md-5">
                          ...
                          <div class="form-group row">
                            ...
                            <select class="form-control price_type" name="price_type">
                              ...
                              ?>
                                <option value="<?php echo $value->id; ?>" <?php if ($value->id == 3) {
                                                                            echo "selected";
                                                                          } ?>><?php echo $value->name; ?></option>
                              <?php
                        ...
                        <div class="col-md-5">
                          ...
                          <div class="form-group row">
                            ...
                            <select class="form-control price_type" name="price_type">
                              ...
                              ?>
                                <option value="<?php echo $value->id; ?>" <?php if ($value->id == 4) {
                                                                            echo "selected";
                                                                          } ?>><?php echo $value->name; ?></option>
                              <?php
                    ...
                    <h4 class="card-title mt-3">Stock Details  <a href="<?php echo base_url(); ?>index.php/stock_journal/history?product_id=<?php echo $id; ?> " target="_blank">Journal History</a> </h4>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                          <div class="form-group row">
                            <label class="col-sm-12 col-form-label">Opening Stock</label>
                            <div class="col-sm-12">
                              <input id="opening_qty" class="form-control" readonly name="opening_qty" ng-model="opening_qty"  style="background-color: #fff;">
                            </div>
                          </div>
                        </div>
                      ...
                      <div class="col-md-3">
                        <div class="form-group row">
                          <label class="col-sm-12 col-form-label">Closing Stock</label>
                          <div class="col-sm-12">
                      ...
                      <h4 class="card-title mt-3">Other Details </h4>
                    ...
                    <div class="row">
                      ...
                      <h4 class="card-title mt-3">Weighted Average </h4>
                      <div class="row">
                        <div class="col-md-3">
                          <div class="form-group row">
                            <label class="col-sm-12 col-form-label">Date Range</label>
                            <div class="col-sm-12">
                              <input id="order_daterange" class="form-control" name="order_daterange" type="text" value="2023-07-01 " readonly style="background-color: #fff;">
                            </div>
                          </div>
                        </div>
                        <div class="col-md-3">
                          <div class="form-group row">
                            <label class="col-sm-12 col-form-label">Total Value</label>
                            <div class="col-sm-12">
                              <input id="tot_val" class="form-control" name="tot_val" value="<?php echo $total_value; ?>" readonly style="background-color: #fff;">
                            </div>
                          </div>
                        </div>
                        <div class="col-md-3">
                          <div class="form-group row">
                            <label class="col-sm-12 col-form-label">Total Qty(<?php echo $total_uom; ?>)</label>
                            <div class="col-sm-12">
                              <input id="tot_qty" class="form-control" name="tot_qty" value="<?php echo $total_qty; ?>" readonly style="background-color: #fff;">
                            </div>
                          </div>
                        </div>
                        <div class="col-md-3">
                          <div class="form-group row">
                            <label class="col-sm-12 col-form-label">Average Price</label>
                            <div class="col-sm-12">
                              <input id="avg_price" class="form-control" name="avg_price" value="<?php echo $average_value; ?>" readonly style="background-color: #fff;">
                            </div>
                          </div>
                        </div>
                      </div>
                      <div class="row">
                        <div class="col-md-3">
                          <div class="form-group row">
                            <label class="col-sm-12 col-form-label">Opening Value</label>
                            <div class="col-sm-12">
                              <input id="opening_val" class="form-control" name="opening_val" ng-model="opening_val"  style="background-color: #fff;">
                            </div>
                          </div>
                        </div>
                       <!--  <div class="col-md-3">
                          <div class="form-group row">
                            <label class="col-sm-12 col-form-label">Opening Qty</label>
                            <div class="col-sm-12">
                              <input id="opening_qty" class="form-control" name="opening_qty" ng-model="opening_qty"  style="background-color: #fff;">
                            </div>
                          </div>
                        </div>-->
                      </div> 
                      ...
                      <div class="col-md-12 mt-4">
                        <div class="form-group flaot-end text-end">
                          ...
                          <input class="btn btn-danger w-lg btn-rounded waves-effect waves-light"  id="archive_button" value="{{ archive_button }}" />
                        </div>
                      </div>
        ...
        <div class="modal-body" style="height: 500px;overflow: auto;">
            ...
            <div class="row" style="margin-bottom: 10px;">
              ...
              <div class="col-md-4 showhide">
                ...
                <select class="form-control" name="layout_plan" id="layout_plan">
                  ...
                  <option value="layout_plan">Select Base Name</option>
                  <?php
              ...
              <div class="col-md-4">
                <select class="form-control" name="view_base" id="view_base">
          ...
          <form ng-submit="imageuploadInproductupdate()" method="post" id="productupdate" style="display:none;">
            ...
            <div class="row" style="margin-bottom: 10px;">
              ...
              <div class="col-md-2" style="display:none;"><input type="text" class="form-control " id="lengthvalset1" placeholder="length"></div>

              <input type="hidden" id="image_plan_id">
              <div class="col-md-4">
                <select class="form-control" name="view_base" id="view_base1">
                  <option value="1">IMAGE</option>
                  <option value="0">HTML</option>
                </select>
              </div>
          ...
          <div class="row" ng-init="imgpreviewimages()">
            ...
            <div class="col-md-6" ng-repeat="nameimage in namesDataoptonsimages">
               ...
               <span ng-if="nameimage.html_img == 'NO'"><button type="button" ng-click="deleteDataimage(nameimage.id)" class="btn btn-outline-danger buttonright"><i class="mdi mdi-delete menu-icon"></i></button></span>
  ...
  <div class="modal fade exampleModalToggleLabel2" id="firstmodalcommison2" aria-hidden="true" aria-labelledby="exampleModalToggleLabel2" tabindex="-1">
    <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalToggleLabel2">Update Purchase Name</h5>
          <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
        </div>
        <div class="modal-body">


          <form id="pristine-valid-common2" ng-submit="submitFormmaster2()" method="post">
            ...
            <div class="row">
              ...
              <div class="col-md-12">
                <div class="form-group row">
                  <label class="col-sm-5 col-form-label">Purchase name </label>
                  <div class="col-sm-7">
                    <input id="purchase_name" class="form-control" required ng-model="purchase_name" name="purchase_name" type="text">
              ...
              <div class="col-md-12">
                <div class="form-group row">
                  <label class="col-sm-5 col-form-label">Specification </label>
                  <div class="col-sm-7">
                    <textarea id="specification" class="form-control" rows="4" ng-model="specification" name="specification"></textarea>
              ...
              <div class="col-md-12">
                <div class="form-group row">
                  ...
                  <div class="col-sm-12">
                    ...
                    <input class="btn btn-success w-lg waves-effect waves-light" style="float: right;" type="submit" value="UPDATE">
  ...
  <script>
    document.addEventListener('DOMContentLoaded', function() {
      const dateInput = document.getElementById('order_daterange');

      // Function to update the input value with the selected date range
      function updateDateRange() {
        const startDate = dateInput.value;
        const currentDate = new Date();
        const formattedDate = `${startDate} - ${currentDate.getFullYear()}-${(currentDate.getMonth() + 1).toString().padStart(2, '0')}-${currentDate.getDate().toString().padStart(2, '0')}`;
        dateInput.value = formattedDate;
      }

      // Attach an event listener to the input element to update the date range
      dateInput.addEventListener('change', updateDateRange);
  ...
  <script>
    $(document).ready(function() {
      ...
      $(".categories").change(function() {
        ...
        if (acc == '1' || acc == '26' || acc == '36' || acc == '5' || acc == '34' || acc == '32' || acc == '7' || acc == '9' || acc == '590' || acc == '591' || acc == '592' || acc == '593') {
          $('#dis_acc').show();
        } else {
          $('#dis_acc').hide();
        }
    ...
    app.controller('crudController', function($scope, $http) {
      ...
      $scope.archive_button = 'Move to Archive';
      ...
      $('#archive_button').on('click', function(e) {
        let statusVar =  $scope.archive_button == 'Move to Archive' ? -1 : 1;
        let deleteid = statusVar == -1 ? 1 : 0;
        ...
        $http({
          ...
          $scope.archive_button = statusVar == 1 ? 'Move to Archive' : 'Retrive Archive';
        })
      ...
      $scope.submitFormmaster = function() {
        $http({
          ...
          data: {
            ...
            'type': $scope.typebase,
            'sort_order_id': $scope.sort_order_id,
      ...
      $scope.submitFormmaster2 = function() {
      ...
      $scope.imageuploadInproductupdate = function() {
        ...
        $http({
          ...
          data: {
            ...
            'view_base': view_base,
            'lengthvalset': lengthvalset1,
            'id': image_plan_id,
            'action': 'base_name_change',
            'tablename': 'product_images'
          }
        }).success(function(data) {
      ...
      $scope.submitForm = function() {
        ...
        $http({
          ...
          data: {
            ...
            'stock': $scope.stock,
            <?php
            foreach ($additional_information2 as $vl) {
            ...
            'type': $scope.type,
            'link_to_purchase': $scope.link_to_purchase,
            'label2': lab2,
            'point': lab_point,
            'formula': $scope.formula,
            'description': $scope.description,
            'opening_val': $scope.opening_val,
            'opening_qty': $scope.opening_qty,
            'side_label': $scope.side_label,
            'input_label': $scope.input_label,
            'price': price,
            'uom': $scope.uom,
            'HSN_SAC': $scope.HSN_SAC,
      ...
      $scope.fetchData = function() {
        $http({
          ...
          $scope.purchase_name_view = data.purchase_name;
          $scope.specification_view = data.specification;

          if(data.status == -1){
            $scope.archive_button = 'Retrive Archive';
          }
          ...
          $('.set_' + data.categories_id).show();


          $scope.categories = data.categories_id;
          $scope.sub_categories = data.sub_categories_id;



          if (data.categories_id == '32') {
            $('.showhide').hide();
          }


          if (data.categories_id == '34' ||data.categories_id == '36' || data.categories_id == '591') {
            $('#formula2').show();
          }

            if(data.categories_id == '626'){
              $('#formuladiv').hide();
              $('#formula2').hide();
          }

          $scope.description = data.description;
          $scope.opening_val = data.opening_val;
          $scope.opening_qty = data.opening_qty;
          ...
          $scope.min_order_stock = data.min_order_stock;
          ...
          $scope.purchase_price = data.purchase_price;
          $scope.average_price = data.average_price;
          $scope.profile_and_loss = data.profile_and_loss;


          $scope.kg_price = data.kg_price;


          $scope.selling_average_price = data.selling_average_price;
          $scope.actual_selling_price = data.actual_selling_price;
          ...
          <?php
          foreach ($additional_information1 as $vl1) {
            $label_name1 = strtolower($vl1->label_name);
          ?>
            $scope.<?php echo $label_name1; ?> = data.<?php echo $label_name1; ?>;
          <?php
          }
          ?>
          ...
          if (data.categories_id == '34' || data.categories_id == '36') {
            $('#kgprice').show();
            $('#formula2').show();
          }
      ...
      $scope.imageuploadInproduct = function() {
        ...
        $http.post('<?php echo base_url() ?>index.php/products/fileuplaodimgsave?id=' + product_id + '&lengthval=' + lengthvalset + '&view_base=' + view_base + '&layout_plan=' + layout_plan, form_data, {
          transformRequest: angular.identity,
          headers: {
            'Content-Type': undefined,
            'Process-Data': false

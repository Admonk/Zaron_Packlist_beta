...
<form id="pristine-valid-example" novalidate method="post"></form>
                    ...
                    <form id="pristine-valid-common" ng-submit="submitForm()" method="post" enctype="multipart/form-data">
                       ...
                       <div class="row">
                         ...
                         <div class="col-md-3">
                          <div class="form-group row">
                             <label class="col-sm-12 col-form-label">Purchase Name  </label>
                            <div class="col-sm-12">
                              <input id="purchase_name" class="form-control" required name="purchase_name" ng-model="purchase_name" type="text">
                            </div>
                          </div>
                        </div>
                         <div class="col-md-3">
                          <div class="form-group row">
                            ...
                            <div class="col-sm-12">
                              <input id="specification" class="form-control" required name="specification" ng-model="specification" type="text">
                            </div>
                          </div>
                        </div>
  ...
  $scope.submitForm = function(){
    ...
    $http({
      ...
      data:{
          ...
          'purchase_name':$scope.purchase_name,

                                ...
                                <div class="d-flex flex-column h-100">
                                    ...
                                    <div class="auth-content my-auto">
                                        <div class="text-center">
                                            ...
                                            <p class="text-muted mt-2">Please enter  the otp</p>
                                        </div>
...
<?php  if($this->session->flashdata('success')){ ?><div class="alert alert-success"><?php echo $this->session->flashdata('success'); ?></div> <?php } ?>
                                        ...
                                        <form class="mt-4 pt-2" method="post"  action="<?php echo base_url(); ?>index.php/adminmain/userlogin_otp">  
                                            
<!-- 
                                            <div class="form-floating form-floating-custom mb-4 auth-pass-inputgroup">
                                                <input type="number" class="form-control pe-5" id="password-input"  name="password" id="Password" placeholder="Enter The OTP"> 
                                                <button type="button" class="btn btn-link position-absolute h-100 end-0 top-0" id="password-addon">
                                                    <i class="mdi mdi-eye-outline font-size-18 text-muted"></i>
                                                </button>
                                                <label for="input-password">Enter OTP</label>

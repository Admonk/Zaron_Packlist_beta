                                            ...
                                            <div class="table-container" style="height: 700px;overflow-y: scroll;">
                                                <table id="datatable" class="table table-bordered dt-responsive  nowrap w-100" ng-init="fetchDatagetlegderGroup(0)">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr class="trpoint">
                                                            <td style="width:20px"></td>
                                                            <td class="text-center fw-bold text-danger">Topaaz Industrries Coil</td>
                                                            <td class="text-center">-</td>
                                                            <td class="text-center">{{topaaz_industrries_coil.bill_total | number}}</td>
                                                            <td class="text-center">{{topaaz_industrries_coil.bill_returns | number}} </td>
                                                            <td class="text-center">{{topaaz_industrries_coil.bill_actual | number}} </td>
                                                            <td class="text-center">-</td>
                                                            <td>-</td>
                                                            <td>-</td>
                                                        ...
                                                        <tr class="trpoint">
                                                            <td style="width:20px"> </td>
                                                            <td class="text-center fw-bold text-danger">Zaron Metal Section</td>
                                                            <td class="text-center">-</td>
                                                            <td class="text-center">{{zaron_metal_section.bill_total | number}}</td>
                                                            <td class="text-center">{{zaron_metal_section.bill_returns | number}} </td>
                                                            <td class="text-center">{{zaron_metal_section.bill_actual | number}} </td>
                                                            <td class="text-center">-</td>
                                                            <td>-</td>
                                                            <td>-</td>
...
?>
            ...
            $scope.fetchDatagetlegderGroup = function(cateid, productid, fromdate, fromto, sales_group, status) {
                ...
                var url = 'index.php/other_reports/fetch_data_sales_team_report_testing';
                $http.get('<?php echo base_url() ?>' + url + '?limit=10&formdate=' + fromdate + '&todate=' + fromto +
                    ...
                    // gg changes testing
                    $scope.topaaz_industrries_coil = data['TOPAAZ_INDUSTRRIES_COIL'];
                    $scope.zaron_metal_section = data['ZARON_METAL_SECTION'];
    ...
    ?>
            $scope.fetchTargets = function() {
                ...
                var sales_group = $('#sales_group').val();
                var status = $('#filterStatus') && $('#filterStatus').is(':checked') ? $('#filterStatus').is(':checked') : false;
                var url = 'index.php/other_reports/fetch_data_sales_product_targets_testing';
            ...
            $scope.fetchCatTargets = function() {
                ...
                var sales_group = $('#sales_group').val();
                var status = $('#filterStatus') && $('#filterStatus').is(':checked') ? $('#filterStatus').is(':checked') : false;
                var url = 'index.php/other_reports/fetch_data_sales_category_targets_testing';
                var salepersonArr = getJson(true);
        ...
        ?>
            ...
            $('#exportdata').on('click', function() {
                ...
                var status = $('#filterStatus') && $('#filterStatus').is(':checked') ? $('#filterStatus').is(':checked') : false;
                var showMode = $scope.showMode;
                url = '<?php echo base_url() ?>index.php/other_reports/fetch_data_sales_team_report_export_testing?limit=10&formdate=' + fromdate + '&todate=' + fromto +

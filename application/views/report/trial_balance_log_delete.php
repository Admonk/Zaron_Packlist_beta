                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    <h4 class="mb-sm-0 font-size-18">Trial Balance Log Delete</h4>

                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                             <li class="breadcrumb-item"><a href="<?php echo base_url(); ?>index.php/dashboard">Dashboard</a></li>
                                            <li class="breadcrumb-item active">Trial Balance Log Delete!</li>
                                        </ol>
                                    </div>
                   ...
                   <table id="datatable" class="table table-bordered dt-responsive  nowrap w-100"   >
                      <thead>
                        ...
                        <tr  class="trpoint">
                           ...
                           <td style="width: 200px;">{{names.notes}}</td>
 ...
 $scope.getProduct = function(){
  ...
  $scope.exportToExcel = function () {
                ...
                $("#datatable").table2excel({
                    filename: "TRAIL_BALANCE_LOG_BOOK_DELETE"+date+".xls"
                });
 };
...
$scope.fetchDatagetlegderGroup = function(){
    ...
    $http.get('<?php echo base_url() ?>index.php/report/fetch_data_accounts_log_report?formdate='+fromdate+'&todate='+fromto+'&delete=1').success(function(data){

                     ...
                     <div class="row">
                        <div class="col-lg-12">
                                 ...
                                 <div class="row">
                                    <div class="col-lg-12">
                                       ...
                                       <div id="search-view" style="display: none;">
                                          <div class="text-center" ng-init="fetchSingleData(0)">
                           ...
                           <div  class="table-body-cell  custom-header <?php echo $checkdata_14_hide; ?>"  > Action</div>                         
                                                ...
                                                <div class="resp-table-row" style="position: sticky;top: 30px;z-index:1; " class="table table-bordered" ng-init="fetchDatagetlegderGroup(0,0)">
                                                ...
                                                <div class="primary " ng-repeat="data in namesDataledgergroup" >
                                                      <div class="resp-table-row trpoint" style=" box-shadow: inset -1px 0px 0px 3px #f0f0f0f7;background: #ffdfdf;" ng-click="toggleCollapse($event,data.teamGroupIndex,data.groupIndex,data.index)">
                                                         ...
                                                         <div class="table-body-cell price-main checkdata_15 <?php echo $checkdata_15_hide; ?>">
                                                            <b class="pri-main" ng-if="data.sheet!=0">{{data.sheet | number}}</b>
                                                         </div>
                                                   ...
                                                   <div class="primary" ng-repeat="names in data.values">
                                                      <div class="resp-table-row trpoint " style="background: #e7e7e7;"  ng-if="(!names.collapsed)"  ng-click="toggleCollapse($event,names.teamGroupIndex,names.groupIndex,names.index)">
                                                         ...
                                                         <div class="table-body-cell price-main checkdata_15 <?php echo $checkdata_15_hide; ?>">
                                                            <b class="pri-main" ng-if="names.sheet!=0">{{names.sheet | number}}</b>
                                                         </div>
         ...
         <script>
            ...
            $(document).ready(function() {
               ...
               $('#exportdata').on('click', function() {
                  ...
                  var order_status = 1;
                   <?php
                    $url_name = $testMode ? 'fetch_data_customer_balance_report_export?test=true&':'fetch_data_customer_balance_report_export?';
                ?>


                  var sales_group = $('#sales_group').val();
                  var payment_mode = $('#payment_mode').val();
                   url = '<?php echo base_url() ?>index.php/report/<?=$url_name?>limit=10&customer_id=' +
 ...
 //  }
              ...
              setTimeout(()=>{
               ...
               $scope.toggleCollapse = function(e,teamGroupIndex, headIndex, spIndex) {
                  ...
                  var rowToScrollTo = $(e.currentTarget);  
                  var scrollTo = rowToScrollTo.position().top - container.position().top;
                  console.log("rowToScrollTo.position().top",rowToScrollTo.position().top)
                  container.animate({
                     scrollTop: scrollTo
                  }, 500);  
                  if($scope.memKey == ''){
               ...
               $scope.fetchDatagetlegderGroup = function(cateid, sales_group){
                  ...
                  var fromto = $('#to-date').val();
                   <?php
                    $url_name = $testMode ? 'fetch_data_customer_balance_report_color?test=true&':'fetch_data_customer_balance_report_color?test=true&';
                ?>
                  if (cateid != 0) {
                    $http.get('<?php echo base_url() ?>index.php/report/<?=$url_name?>limit=10&customer_id=' +
                     ...
                     dataNew && dataNew.map((el0, teamGroupIndex) => {
                        ...
                        sample.forEach((head) => {
                           console.log("el0",el0[head])
                           if((!isNaN(el0[head])) && el0[head]){
                              totalVals[head] = totalVals[head] ?  Math.round(totalVals[head] + el0[head]) : el0[head];
                           }
                        })
                        el0.teamGroupIndex = teamGroupIndex;
                        el0.Open_Cr = Math.round(el0.Open_Cr)

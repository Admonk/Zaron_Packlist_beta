...
if($this->session->userdata['logged_in']['access']=='31')
{
  ...
  $url=base_url().'index.php/report/customer_balance_report?customer_id='.$customer_id;
  header("Location: $url");
}
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    <h4 class="mb-sm-0 font-size-18">In production & Sheet in factory report (customer wise data)</h4>
                ...
                <div class="row">
                  ...
                  <div id="search-view" style="display:none;" >
                                     ...
                                     <div class="card-header"  ng-init="fetchSingleData(0)">
                                           ...
                                           <h4 class="card-title">In production & Sheet in factory report (customer wise data)
                   ...
                   <div id="search-view1"  >
                                     ...
                                     <div class="card-header"  ng-init="fetchSingleData(0)">
                                           <h4 class="card-title">In production & Sheet in factory report (customer wise data)
                                           <br><?php echo date('Y-04-01',strtotime("-1 year")); ?> To <?php echo $this->session->userdata['logged_in']['to_date']; ?></h4>
...
<div id="resp-table">
    <div id="resp-table-body" style="position: relative;">
        <div class="resp-table-row" style="position: sticky;top: 0;background: #dfdfdf;" class="table table-bordered"  ng-init="fetchDatagetlegderGroup(0,0)"> 
                          ...
                          <div  class="table-body-cell checkdata_14 ">In Production Return</div>
                          <div  class="table-body-cell checkdata_14 ">In Production</div>
                          <div  class="table-body-cell checkdata_11 ">Sheet_in_Factory</div>
                          <div  class="table-body-cell checkdata_12 ">Transit</div>
       ...
       <div class="resp-table-row setload"> 
                                   ...
                                   <div class="table-body-cell checkdata_14"></div>
                                   <div class="table-body-cell checkdata_14"></div>
                                   <div class="table-body-cell checkdata_11"></div>
        ...
        <div class="primary" ng-repeat="names in namesDataledgergroup">
         ...
         <div class="resp-table-row trpoint" style="background: #fff1e7;"  >
                           ...
                           <div class="table-body-cell"></div>
                           <div class="table-body-cell"></div>
                           <div class="table-body-cell checkdata_14 "><b style="color:#ff5e14;" ng-if="names.production_return!=0">{{names.production_return | number}}</b></div>
                           <div class="table-body-cell checkdata_14 "><b style="color:#ff5e14;" ng-if="names.production!=0">{{names.production | number}}</b></div>
                           <div class="table-body-cell checkdata_11 "><b style="color:#ff5e14;" ng-if="names.sheet_in_factory!=0">{{names.sheet_in_factory | number}}</b></div>
                           <div class="table-body-cell checkdata_12 "><b style="color:#ff5e14;" ng-if="names.transit!=0">{{names.transit | number}}</b></div>
         ...
         <div class="resp-table-row" >
          ...
          <div class="chriedchild" ng-repeat="namesvv in namesvvssget.subarray | filter:query" >
              ...
              <div class="resp-table-row {{ namesvv.hidestatus }}" ng-if="namesvvssget.sales_team_id==namesvv.sales_team_id">
                           ...
                           <div class="table-body-cell checkdata_14"><a href="<?php echo base_url(); ?>index.php/customer/ledger_find?customer_id={{namesvv.id}}" target="_blank"><b ng-if="namesvv.inproduction_total_return!=0">{{namesvv.inproduction_total_return | number}}</b></a></div>
                           <div class="table-body-cell checkdata_14"><a href="<?php echo base_url(); ?>index.php/customer/ledger_find?customer_id={{namesvv.id}}" target="_blank"><b ng-if="namesvv.production!=0">{{namesvv.production | number}}</b></a></div>
                           <div class="table-body-cell checkdata_11"><a href="<?php echo base_url(); ?>index.php/customer/ledger_find?customer_id={{namesvv.id}}" target="_blank"><b ng-if="namesvv.sheet_in_factory!=0">{{namesvv.sheet_in_factory | number}}</b></a></div>
                           <div class="table-body-cell checkdata_12"><a href="<?php echo base_url(); ?>index.php/customer/ledger_find?customer_id={{namesvv.id}}" target="_blank"><b ng-if="namesvv.transit!=0">{{namesvv.transit | number}}</b></a></div>
...
$('#exportdata').on('click', function() {
      ...
      url = '<?php echo base_url() ?>index.php/report/fetch_data_customer_balance_report_export_production?limit=10&customer_id='+customer_id+'&cate_id='+cateid+'&sales_group='+sales_group+'&productid='+productid+'&formdate='+fromdate+'&todate='+fromto+'&order_status='+order_status+'&payment_mode='+payment_mode;
      location = url;
...
$scope.fetchDatagetlegderGroup = function(cateid,sales_group)
{
  ...
  if(cateid!=0)
  {
      ...
      $http.get('<?php echo base_url() ?>index.php/report/fetch_data_customer_balance_report_production?limit=10&customer_id='+customer_id+'&formdate='+fromdate+'&page=' + $scope.currentPage +'&size=' + $scope.pageSize +'&search=' + $scope.searchText+'&todate='+fromto+'&sales_group='+sales_group+'&order_status='+cateid+'&payment_mode='+payment_mode).success(function(data)
      {

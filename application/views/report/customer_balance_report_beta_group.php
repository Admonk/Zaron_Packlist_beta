                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    <h4 class="mb-sm-0 font-size-18">Customer Balance Report Group</h4>

                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                             <li class="breadcrumb-item"><a href="<?php echo base_url(); ?>index.php/dashboard">Dashboard</a></li>
                                            <li class="breadcrumb-item active">Customer Balance Report Group !</li>
                                        </ol>
                                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12" >
                      ...
                      <form>
                          <div class="row">
                            ...
                            <div class="col">
                              <input type="date" class="form-control" min="<?php echo date('2024-01-01'); ?>" id="from-date" value="<?php echo date('Y-m-d'); ?>">
                            </div>
                            <div class="col">
                  ...
                  <div id="search-view" style="display:none;" >
                                     ...
                                     <div class="card-header"  ng-init="fetchSingleData(0)">
                                           ...
                                           <h4 class="card-title">Customer Balance Report GROUP {{formdate}}</h4>
                   ...
                   <div id="search-view1">
                                     ...
                                     <div class="card-header"  ng-init="fetchSingleData(0)">
                                           ...
                                           <h4 class="card-title">Customer Balance Report GROUP <?php echo date('Y-m-d'); ?></h4>
                   ...
                   <p style="color: red;">Time Update :  <?php echo $last; ?></p>
...
<div id="resp-table">
    <div id="resp-table-body" style="position: relative;">
        <div class="resp-table-row" style="position: sticky;top: 0;background: #dfdfdf;" class="table table-bordered"  ng-init="fetchDatagetlegderGroup('ALL','ALL')"> 
           
            
                        <!--  
                          <div  class="table-body-cell" style="width: 150px;">Group name</div>
                          ...
                          <div  class="table-body-cell <?php echo $d_none; ?>" style="width: 150px;" title="Group the customer is mapped with">Group name
                          ...
                          <div  class="table-body-cell checkdata_13 <?php echo $checkdata_13_hide; ?>" title="in production return+in production+sheet in factory+transit">Total
                          <i class="fa fa-exclamation"></i></div> 
       ...
       <div class="resp-table-row setload"> 
                                  ...
                                  <div class="table-body-cell checkdata_2 "></div>
                                  ...
                                  <div class="table-body-cell checkdata_8 <?php echo $checkdata_8_hide; ?>"> <loading></loading></div>
        ...
        <div class="primary" ng-repeat="names in namesDataledgergroup">
         ...
         <div class="resp-table-row trpoint " ng-if="names.hidestatus=='SS'" >
                          
                           <div class="table-body-cell">Total : </div>
 ...
 <span ng-if="names.net_balance_status==0" style="color:red;">{{names.net_balance | number}} </span>
                          ...
                          <div class="table-body-cell checkdata_13 <?php echo $checkdata_13_hide; ?>"><b style="color:#ff5e14;" ng-if="names.sheet_total!=0">
                              {{names.net_balance+names.sheet_total | number}}
                          </b></div>
         ...
         <div class="resp-table-row trpoint {{ names.hidestatus }}" ng-if="names.hidestatus!='SS'" >
                          
                           <div class="table-body-cell">{{names.no}}</div>
                           
                          <div class="table-body-cell"><b style="color:#ff5e14;"><a href="<?php echo base_url(); ?>index.php/report/customer_balance_report_beta_group_sales?sales_group_id={{names.sales_group_id}}" target="_blank"> {{names.sales_group_name}}</b></a></div>
...
$('#exportdata').on('click', function() {
      ...
      var order_status= 1;
       <?php
                    $url_name = $testMode ? 'fetch_data_customer_balance_report_export_beta_group?test=true&':'fetch_data_customer_balance_report_export_beta_group?';
                ?>
      var sales_group= $('#sales_group').val();
      var payment_mode= $('#payment_mode').val();
     url = '<?php echo base_url() ?>index.php/report/<?=$url_name?>limit=10&customer_id='+customer_id+'&cate_id='+cateid+'&sales_group='+sales_group+'&productid='+productid+'&formdate='+fromdate+'&todate='+fromto+'&order_status='+order_status+'&payment_mode='+payment_mode;
      location = url;
...
$scope.fetchDatagetlegderGroup = function(cateid,sales_group)
{
     ...
     <?php
                    $url_name = $testMode ? 'fetch_data_customer_balance_report_beta_group?test=true&':'fetch_data_customer_balance_report_beta_group?';
                ?>

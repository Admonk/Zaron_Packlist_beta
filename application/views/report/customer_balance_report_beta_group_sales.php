                    ...
                    <div class="col-lg-12" >
                      ...
                      <form>
                          <div class="row">
                            ...
                            <div class="col">
                              <input type="date" class="form-control" id="from-date" min="<?php echo date('2024-01-01'); ?>" value="<?php echo date('Y-m-d'); ?>">
                            </div>
                            <div class="col" >
                              <input type="date" class="form-control" id="to-date" min="<?php echo date('2024-01-01'); ?>" value="<?php echo date('Y-m-d'); ?>">
                            </div>
...
<div class="resp-table-row" style="position: sticky;top: 0;background: #dfdfdf;" class="table table-bordered"  ng-init="fetchDatagetlegderGroup('ALL',<?php echo $sales_group_id ?>)"> 
                          ...
                          <div  class="table-body-cell <?php echo $d_none; ?>" style="width: 150px;" title="Sales Person the customer is mapped with">Sales name
...
<a href="<?php echo base_url(); ?>index.php/report/customer_balance_report?sales_group_id={{namesvvssget.sales_group_id}}&sales_team_id={{namesvvssget.sales_team_id}}" target="_blank"> 
 ...
 <span ng-if="namesvvssget.closeing_status==0" style="color:red;">{{namesvvssget.closeing | number}} </span>
                         ...
                         <div class="table-body-cell checkdata_14 <?php echo $checkdata_14_hide; ?>"><b  ng-if="namesvvssget.production!=0">{{namesvvssget.production | number}}</b></div>
                          ...
                          <div class="table-body-cell checkdata_13 <?php echo $checkdata_13_hide; ?>"><b  ng-if="namesvvssget.sheet_total!=0">
                              {{namesvvssget.sheet_total | number}}
                          </b></div>



                           <div class="table-body-cell checkdata_13 <?php echo $checkdata_13_hide; ?>"><b  ng-if="namesvvssget.sheet_total!=0">
                              {{namesvvssget.net_balance+namesvvssget.sheet_total | number}}
                          </b></div>

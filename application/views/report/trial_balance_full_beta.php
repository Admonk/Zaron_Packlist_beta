                    ...
                    <div class="col-lg-12"  >
                      ...
                      <form class="ng-pristine ng-valid">
                          <div class="row">
                            ...
                            <div class="col">
                                <label>To date</label>
                              <input type="date" class="form-control" min="<?php echo date('Y-01-01'); ?>" id="to-date" value="<?php echo date('Y-m-d'); ?>">
                            </div>
                  ...
                  <div id="search-view" style="display:none;" >
                   ...
                   <table  border="yes" ng-init="fetchDatagetlegderGroup(0)" >
                      <thead>
                        ...
                        <tr  class="trpoint ss_tty_{{names.id}} dis_{{names.account_type}} {{names.dnone}} d-none" ng-repeat="names in namesvv.sub | orderBy:'name'" ng-if="names.set>0" >
                          
                           <td><a href="{{names.url}}" >{{names.name}}</a></td>
                           <td> <span ng-if="names.debit>0" ><a href="{{names.url}}" >{{names.debit | indianCurrency}}</a></span></td>
                          
    <td ><span ng-if="names.credit > 0 "><a href="{{names.url}}" >{{names.credit | indianCurrency}}</a></span></td>
...
$scope.fetchDatagetlegderGroup = function(fromdate,fromto){
  ...
  var fromdate= $('#from-date').val();
    ...
    $http.get('<?php echo base_url() ?>index.php/report/trial_balance_report_full_beta?limit=10&formdate='+fromdate+'&fromto='+fromto+'&accountstype=<?php echo $accountstype; ?>').success(function(data){

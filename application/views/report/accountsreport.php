              ...
              <div class="col-lg-12">
                ...
                <div class="row">
                  ...
                  <div id="search-view" >
                   ...
                   <table id="datatable" class="table table-bordered dt-responsive" width="100%"  ng-init="fetchDatagetlegderGroup(0,'<?php echo date('Y-m-01'); ?>','<?php echo date('Y-m-t'); ?>','All','All')" >
                      <thead>
                        <tr>

                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    <h4 class="mb-sm-0 font-size-18">Product Re-Sale Stock Report</h4>

                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                             <li class="breadcrumb-item"><a href="<?php echo base_url(); ?>index.php/products/productscreate">Dashboard</a></li>
                                            <li class="breadcrumb-item active"> Product Re-Sale Stock Report</li>
                                        </ol>
                                    </div>
...
app.controller('crudController', function($scope, $http){
  ...
  $scope.fetchData = function(){
    $http.get('<?php echo base_url() ?>index.php/order_second/fetch_data_stock_re_sale').success(function(data){

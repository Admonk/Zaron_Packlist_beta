...
$scope.fetchDatagetlegderGroup = function(fromdate,fromto,search){
  ...
  var fromdate= $('#from-date').val();
    ...
    $http.get('<?php echo base_url() ?>index.php/report_new/trial_balance_report_full_nov?limit=10&formdate='+fromdate+'&fromto='+fromto+'&accountstype=<?php echo $accountstype; ?>').success(function(data){

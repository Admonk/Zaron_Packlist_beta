...
<div id="resp-table">
         ...
         <div class="resp-table-row" >
          ...
          <div class="chriedchild" ng-repeat="namesvv in namesvvssget.subarray | filter:query" >
              ...
              <div class="resp-table-row {{ namesvv.hidestatus }}" ng-if="namesvvssget.sales_team_id==namesvv.sales_team_id">
                          ...
                          <div ng-if="column_status !=1"  class="table-body-cell" ng-click="handleClick(namesvv,0)">{{namesvv.customerphone}}</div>
                          
                          
                          
                           <div ng-if="column_status !=1"  class="table-body-cell table-body-cell" ng-click="handleClick(namesvv,0)">{{namesvv.route_name}}</div>
 ...
 <div ng-if="column_status !=1"  class="table-body-cell checkdata_14 <?php echo $checkdata_14_hide; ?>" ng-click="handleClick(namesvv,4)"><b ng-if="namesvv.inproduction_total_return!=0">{{namesvv.inproduction_total_return | number}}</b></div>
                           
                           
                            <div ng-if="column_status !=1"  class="table-body-cell checkdata_14 <?php echo $checkdata_14_hide; ?>" ng-click="handleClick(namesvv,1)"><b ng-if="namesvv.production!=0">{{namesvv.production | number}}</b></div>
                           
                           
                           <div ng-if="column_status !=1"  class="table-body-cell checkdata_11 <?php echo $checkdata_11_hide; ?>" ng-click="handleClick(namesvv,2)"><b ng-if="namesvv.sheet_in_factory!=0">{{namesvv.sheet_in_factory | number}}</b></div>
                           <div ng-if="column_status !=1"  class="table-body-cell checkdata_12 <?php echo $checkdata_12_hide; ?>" ng-click="handleClick(namesvv,3)"><b ng-if="namesvv.transit!=0">{{namesvv.transit | number}}</b></div>
                           <div ng-if="column_status !=1"  class="table-body-cell checkdata_13 <?php echo $checkdata_13_hide; ?>" ng-click="handleClick(namesvv,0)"><b ng-if="namesvv.balance!=0">
                               ...
                               <div ng-if="column_status !=1"  class="table-body-cell checkdata_13 <?php echo $checkdata_13_hide; ?>" ng-click="handleClick(namesvv,0)"><b ng-if="namesvv.sheet!=0">
...
$scope.fetchDatagetlegderGroup = function(cateid,sales_group)
{
 ...
 var customer_id = namesvv.id;
      var url = "<?php echo base_url(); ?>index.php/other_reports/list_ret_resale?customer_id=" + customer_id +'&formdate='+fromdate+'&todate='+fromto;

              ...
              <div class="col-lg-12">
                ...
                <div class="row">
                                    ...
                                    <div class="card-body">
                                        <div class="d-flex align-items-center">
                                            <div class="flex-grow-1">
                                                <h3 class="text-muted mb-3 lh-1 d-block text-truncate">Cash Credit</h3>
                                                <h4 class="mb-3">
                            ...
                            <div class="col-xl-4 col-md-4" >
                                ...
                                <div class="card card-h-50">
                                    ...
                                    <div class="card-body">
                                        <div class="d-flex align-items-center">
                                            <div class="flex-grow-1">
                                                <h3 class="text-muted mb-3 lh-1 d-block text-truncate">Credit Non Cash</h3>
                                                <h4 class="mb-3">
                                                     <span >{{totalcridit | number}}</span>
                                                </h4>
                  ...
                  <div id="search-view" >
                   ...
                   <table id="datatable" class="table table-striped table-bordered"  width="100%" ng-init="fetchDatagetlegderGroup('<?php echo $customer_id; ?>','<?php echo $this->session->userdata['logged_in']['from_date']; ?>','<?php echo $this->session->userdata['logged_in']['to_date']; ?>','All','All')" >
                      <thead>
                        <tr>
                             <th style="width:70px;"><input type="checkbox" id="checkAll" class="cheackall"></th>
                          ...
                          <th style="text-align: left;">Accounts Head </th>
...
$('#exportdata').on('click', function() {
    ...
    url = '<?php echo base_url() ?>index.php/report/fetch_data_get_ledger_view_export_all_base_by?limit=10&customer_id='+id+'&formdate='+fromdate+'&todate='+fromto+'&party_type='+party_type+'&payment_status='+payment_status;

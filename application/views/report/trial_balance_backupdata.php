...
<p> (All amounts are in Indian Rupees unless otherwise stated) </p>
  ...
  <tr>
   ...
   <th> <?php echo date('d'); ?>/<?php echo date('M'); ?>/<?php echo date('Y'); ?> </th>
  </tr>
  ...
  <tr><td> <b> <a href="{{names.url}}" >{{names.name}}</a> </b> </td> <td>{{names.credit | number}}</td></tr>
      ...
      <tr>
                         ...
                         <div class="col-md-6">
                        <input type="text" style="display:none;" class="form-control rounded border ng-pristine ng-valid ng-touched" placeholder="Search..." ng-model="queryss[queryByss]">
                    <div class="table-responsive">                

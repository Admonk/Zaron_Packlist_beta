                ...
                <div class="row">
                    ...
                    <div class="col-lg-12" >
                      ...
                      <form>
                          <div class="row">
                            ...
                            <div class="col <?php echo $d_none; ?>" > <!--data-trigger -->
                            ...
                            <div class="col">
                             ...
                             <button type="button"  class="btn btn-success waves-effect waves-light <?php echo $d_none; ?>" id="exportdata" >Export</button>
                             <!-- <button type="button"  class="btn btn-success waves-effect waves-light" id="exportdata_static" >Export<sup>test</sup></button> -->
                  ...
                  <div id="search-view" style="display:none;" >
                                     ...
                                     <div class="card-header"  ng-init="fetchSingleData(0)">
                                           ...
                                           <h4 class="card-title"><?php echo $title; ?> {{formdate}} To {{todate}}</h4>
                   ...
                   <div id="search-view1"  >
                                     ...
                                     <div class="card-header"  ng-init="fetchSingleData(0)">
                                           ...
                                           <h4 class="card-title"><?php echo $title; ?> <?php echo date('2024-01-01',strtotime("-1 year")); ?> To <?php echo $this->session->userdata['logged_in']['to_date']; ?></h4>
                      ...
                      <div class="row" style="margin-bottom: 10px;">                                    
                         ...
                         <div class="col-sm-12 <?php echo $d_none; ?>">
...
Mouse hover on the respective column title to view the help text details.
</div> -->
...
<div id="resp-table">
    <div id="resp-table-body" style="position: relative;">
        <div class="resp-table-row" style="position: sticky;top: 0;background: #dfdfdf;" class="table table-bordered"  ng-init="fetchDatagetlegderGroup(0,0)"> 
                          ...
                          <div  class="table-body-cell <?php echo $d_none; ?>"  title="Name of the customer" style="width: 150px;">Customer_Name 
                            <i class="fa fa-exclamation"></i>
                          </div>
                          <div  class="table-body-cell <?php echo $d_none; ?>" title="Phone number of the customer">Customer_phone
                          <i class="fa fa-exclamation"></i>
                          </div>
                          <div  class="table-body-cell <?php echo $d_none; ?>" style="width: 150px;" title="Area the customer is mapped with">Area
                          <i class="fa fa-exclamation"></i>
                          </div>
                          <div  class="table-body-cell checkdata_1 <?php echo $checkdata_1_hide; ?>">Open_Dr
                          </div>
                          <div  class="table-body-cell checkdata_2 <?php echo $checkdata_2_hide; ?>">Open_Cr</div>
                          <div  class="table-body-cell checkdata_3 <?php echo $checkdata_3_hide; ?>" title="Balance specified as opening during the start of the financial period">Open_Bal 
                          <i class="fa fa-exclamation"></i></div>
                          <div  class="table-body-cell checkdata_4 <?php echo $checkdata_4_hide; ?>" title="Sum of transactional debit entries">Tran_Dr
                          <i class="fa fa-exclamation"></i></div>
                          <div  class="table-body-cell checkdata_5 <?php echo $checkdata_5_hide; ?>">Tot_Dr</div>
                          <div  class="table-body-cell checkdata_6 <?php echo $checkdata_6_hide; ?>" title="Sum of transactional credit entries">Tran_Cr
                          <i class="fa fa-exclamation"></i></div>
                          <div  class="table-body-cell checkdata_7 <?php echo $checkdata_7_hide; ?>">Tot_Cr</div>
                          <div  class="table-body-cell checkdata_8 <?php echo $checkdata_8_hide; ?>" title="Sum of total debit entries">Debit
                          <i class="fa fa-exclamation"></i></div>
                          <div  class="table-body-cell checkdata_9 <?php echo $checkdata_9_hide; ?>" title="Sum of total credit entries">Credit
                          <i class="fa fa-exclamation"></i></div>
                          <div  class="table-body-cell checkdata_10 <?php echo $checkdata_10_hide; ?>" title="Sum of debit & credit entries">Closing
                          <i class="fa fa-exclamation"></i></div>
                          <div  class="table-body-cell checkdata_14 <?php echo $checkdata_14_hide; ?>" title="Return to sale - Driver initiated">In Production Return
                          <i class="fa fa-exclamation"></i></div>
                          <div  class="table-body-cell checkdata_14 <?php echo $checkdata_14_hide; ?>" title="Orders in the status - Order created, confirmed date of delivery, Pick-list">In Production
                          <i class="fa fa-exclamation"></i></div>
                          <div  class="table-body-cell checkdata_11 <?php echo $checkdata_11_hide; ?>" title="Orders in the status - Vehicle assigned, Despatch loaded, Driver picked">Sheet_in_Factory
                          <i class="fa fa-exclamation"></i></div>
                          <div  class="table-body-cell checkdata_12 <?php echo $checkdata_12_hide; ?>" title="Orders in the status - Trip started but not delivered">Transit
                          <i class="fa fa-exclamation"></i></div>
                          <div  class="table-body-cell checkdata_13 <?php echo $checkdata_13_hide; ?>" title="Sheet if not more than or equal to debit + Debit-(in production return+in production+sheet in factory+transit)">Net_Balance
                          <i class="fa fa-exclamation"></i></div>
                          <div  class="table-body-cell checkdata_13 <?php echo $checkdata_13_hide; ?>" title="in production return+in production+sheet in factory+transit">Sheet
                          <i class="fa fa-exclamation"></i></div> 
                          <div  class="table-body-cell checkdata_13 <?php echo $d_none; ?> <?php echo $checkdata_13_hide; ?>">Action</div>
       ...
       <div class="resp-table-row setload"> 
                                   ...
                                   <div class="table-body-cell <?php echo $d_none; ?>"></div>
                                   <div class="table-body-cell <?php echo $d_none; ?>"></div>
                                    <div class="table-body-cell <?php echo $d_none; ?>"></div>
          ...
          <div class="resp-table-row <?php echo $d_none; ?>" style="background: #fff1e7;font-weight: bold;font-size: larger"> 
                            <div class="table-body-cell"><b>Totals</b></div>
                          <div class="table-body-cell <?php echo $d_none; ?>"><b class="sales_name"> </b></div>
                          <div class="table-body-cell <?php echo $d_none; ?>"></div>
                          <div class="table-body-cell <?php echo $d_none; ?>"></div>
                          <div class="table-body-cell checkdata_1 <?php echo $checkdata_1_hide; ?>"></div>
                          ...
                          <div class="table-body-cell checkdata_13 <?php echo $checkdata_13_hide; ?>"> {{net_balance+sheet_total | number}}</div>
        ...
        <div class="primary" ng-repeat="names in namesDataledgergroup">
         ...
         <div class="resp-table-row trpoint <?php echo $d_none; ?>" style="background: #fff1e7;"  >
                          
                           <div class="table-body-cell">{{names.no}}</div>
                           
                          <div class="table-body-cell <?php echo $d_none; ?>"><b style="color:#ff5e14;"> {{names.sales_group_name}}</b></div>
                          <div class="table-body-cell <?php echo $d_none; ?>"></div>
                          <div class="table-body-cell <?php echo $d_none; ?>"></div>
         ...
         <div class="resp-table-row <?php echo $d_none; ?>" >
                          
                           
                          <div class="table-body-cell"></div>
                          <div class="table-body-cell <?php echo $d_none; ?>"><b class="sales_name">{{namesvvssget.sales_person_name}}</b></div>
                          <div class="table-body-cell <?php echo $d_none; ?>"><a href="<?php echo base_url(); ?>index.php/customer/ledger_find?customer_id={{namesvvssget.sl_totals.id}}" target="_blank"> </a></div>
                          
                          
                          
                           <div class="table-body-cell table-body-cell <?php echo $d_none; ?>"> </div>
...
<div class="table-body-cell checkdata_12 <?php echo $checkdata_12_hide; ?>"><b>{{namesvvssget.sl_totals.transit | number}}</b></div>
          ...
          <div class="chriedchild" ng-repeat="namesvv in namesvvssget.subarray | filter:query" >
              ...
              <div class="resp-table-row {{ namesvv.hidestatus }}" ng-if="namesvvssget.sales_team_id==namesvv.sales_team_id">
                           ...
                           <div class="table-body-cell <?php echo $d_none; ?>"  ng-click="handleClick(namesvv,0)"> {{namesvv.customername}} </div>
                          <div class="table-body-cell <?php echo $d_none; ?>"  ng-click="handleClick(namesvv,0)"> {{namesvv.customerphone}} </div>
                          
                          
                          
                           <div class="table-body-cell table-body-cell <?php echo $d_none; ?>"  ng-click="handleClick(namesvv,0)">{{namesvv.route_name}}</div>
 ...
 <div class="table-body-cell checkdata_14 <?php echo $checkdata_14_hide; ?>"  ng-click="handleClick(namesvv,4)"><b ng-if="namesvv.inproduction_total_return!=0">{{namesvv.inproduction_total_return | number}}</b></div>
                           ...
                           <div class="table-body-cell checkdata_13 <?php echo $checkdata_13_hide; ?>" ng-click="handleClick(namesvv,0)"><b ng-if="namesvv.balance!=0">
                             ...
                             <div   class="table-body-cell checkdata_13 <?php echo $checkdata_13_hide; ?>" ng-click="handleClick(namesvv,0)"><b ng-if="namesvv.sheet!=0">
                              ...
                              <div   class="table-body-cell <?php echo $d_none; ?> checkdata_13 <?php echo $checkdata_13_hide; ?>">
                    ...
                    <div class="col-md-12">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-12">
                                ...
                                <button type="submit" class="btn btn-success w-md ss_re" style="float: right;" id="RequestBTN" >Request Verification</button>
...
var url = "<?php echo base_url(); ?>index.php/customer/<?=$ledUrl?>customer_id=" + customer_id +"&filter=" + status+'&formdate='+fromdate+'&todate='+fromto;
 ...
 var url = "<?php echo base_url(); ?>index.php/customer/ledger_commen_find?customer_id=" + customer_id +"&filter=" + status+'&formdate='+fromdate+'&todate='+fromto;
   ...
   else
   {
     ...
     var url = "<?php echo base_url(); ?>index.php/customer/ledger_find?customer_id=" + customer_id +"&filter=" + status+'&formdate='+fromdate+'&todate='+fromto;
   }
...
$scope.search = function(){
  ...
  $scope.getBalance = function(netbalance){
    ...
    if(Math.abs(netbalance)  >=  $scope.amount_set)
    {
         ...
         $('#RequestBTN').show();
         $('#amount_set').css("border-color", "green");
    }
    else
    {
        alert("Please enter an amount that is lower than the net balance.");
        $('#RequestBTN').hide();
        $('#amount_set').css("border-color", "red");
        $('#amount_set').val('');
    }
...
$('#exportdata_static').on('click', function() {
      ...
      var order_status= 1;
       <?php
                    $url_name =   'fetch_data_customer_balance_report_export_static';
                ?>
 
      var sales_group= $('#sales_group').val();
      var payment_mode= $('#payment_mode').val();
      // url = '<?php echo base_url() ?>index.php/report/<?=$url_name?>formdate='+fromdate+'&todate='+fromto+'&data='+
       // JSON.stringify($scope.namesDataledgergroup)+'&totals='+JSON.stringify($scope.totalsStatic) ;
      // location = url;
 $http({
         method:"POST",
         url:'<?php echo base_url() ?>index.php/report/<?=$url_name?>',
         data:{
          'data':JSON.stringify($scope.namesDataledgergroup),
          'fromdate':fromdate,
          'fromto':fromto,
          'totals':JSON.stringify($scope.totalsStatic)
        }
...
$scope.fetchDatagetlegderGroup = function(cateid,sales_group)
{
      ...
      var fromto= $('#to-date').val();
                   ...
                   <?php
                    ...
                    if($_GET['test'] == 'partial'){
                    $url_name = 'fetch_data_customer_balance_report_partial?test=true&';
                      
                    }

                    if($status_val == '1'){
                    $url_name = 'fetch_data_customer_balance_report_parial_data?test=true&';
  ...
  if(cateid!=0)
  {
      ...
      $http.get('<?php echo base_url() ?>index.php/Report_new_customer_balence/<?=$url_name?>limit=10&customer_id='+customer_id+'&formdate='+fromdate+'&page=' + $scope.currentPage +'&size=' + $scope.pageSize +'&search=' + $scope.searchText+'&todate='+fromto+'&sales_group='+sales_group+'&order_status='+cateid+'&payment_mode='+payment_mode).success(function(data)
      {
      ...
      $scope.queryBy = '$';
               ...
               $scope.totalsStatic = data['totals'];
  ...
  else
  {
        if(customer_id>0)
       {
          $http.get('<?php echo base_url() ?>index.php/Report_new_customer_balence/<?=$url_name?>limit=10&customer_id='+customer_id+'&formdate='+fromdate+'&page=' + $scope.currentPage +'&size=' + $scope.pageSize +'&search=' + $scope.searchText+'&todate='+fromto+'&sales_group=ALL&order_status=ALL&payment_mode='+payment_mode).success(function(data)
          {

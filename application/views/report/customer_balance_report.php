                  ...
                  <div id="search-view" style="display:none;" >
                   ...
                   <div id="search-view1"  >
                                     ...
                                     <div class="card-header"  ng-init="fetchSingleData(0)">
                                           ...
                                           <h4 class="card-title">Customer Balance Report <?php echo date('Y-07-01',strtotime("-1 year")); ?> To <?php echo $this->session->userdata['logged_in']['to_date']; ?></h4>
...
<div id="resp-table">
       ...
       <div class="resp-table-row setload"> 
        ...
        <div class="primary" ng-repeat="names in namesDataledgergroup">
         ...
         <div class="resp-table-row" >
                          ...
                          <div class="table-body-cell checkdata_12 <?php echo $checkdata_12_hide; ?>"></div>
                          <div class="table-body-cell checkdata_13 <?php echo $checkdata_13_hide; ?>"></div>
                          <div class="table-body-cell checkdata_13 <?php echo $checkdata_13_hide; ?>"><!-- <b>{{namesvvssget.sheet}}</b> --></div>
 ...
 <div class="table-body-cell checkdata_14 <?php echo $checkdata_14_hide; ?>"><a href="<?php echo base_url(); ?>index.php/customer/ledger_find?customer_id={{namesvv.id}}" target="_blank"><b ng-if="namesvv.inproduction_total_return!=0">{{namesvv.inproduction_total_return | number}}</b></a></div>
                           
                           
                            <div class="table-body-cell checkdata_14 <?php echo $checkdata_14_hide; ?>"><a href="<?php echo base_url(); ?>index.php/customer/ledger_find?customer_id={{namesvv.id}}" target="_blank"><b ng-if="namesvv.production!=0">{{namesvv.production | number}}</b></a></div>
                           
                           
                           <div class="table-body-cell checkdata_11 <?php echo $checkdata_11_hide; ?>"><a href="<?php echo base_url(); ?>index.php/customer/ledger_find?customer_id={{namesvv.id}}" target="_blank"><b ng-if="namesvv.sheet_in_factory!=0">{{namesvv.sheet_in_factory | number}}</b></a></div>
                           <div class="table-body-cell checkdata_12 <?php echo $checkdata_12_hide; ?>"><a href="<?php echo base_url(); ?>index.php/customer/ledger_find?customer_id={{namesvv.id}}" target="_blank"><b ng-if="namesvv.transit!=0">{{namesvv.transit | number}}</b></a></div>
                           <div class="table-body-cell checkdata_13 <?php echo $checkdata_13_hide; ?>"><a href="<?php echo base_url(); ?>index.php/customer/ledger_find?customer_id={{namesvv.id}}" target="_blank"><b ng-if="namesvv.balance!=0">
                             ...
                             <div   class="table-body-cell checkdata_13 <?php echo $checkdata_13_hide; ?>"><a href="<?php echo base_url(); ?>index.php/customer/ledger_find?customer_id={{namesvv.id}}" target="_blank"><b ng-if="namesvv.sheet!=0">

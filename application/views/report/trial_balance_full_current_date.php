...
$scope.fetchDatagetlegderGroup = function(fromdate,fromto){
  ...
  var fromdate= $('#from-date').val();
    ...
    $http.get('<?php echo base_url() ?>index.php/report_new/trial_balance_report_full_beta_test?limit=10&formdate='+fromdate+'&fromto='+fromto+'&accountstype=<?php echo $accountstype; ?>').success(function(data){

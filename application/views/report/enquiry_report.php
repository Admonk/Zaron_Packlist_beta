                                        ...
                                        <div class="col-lg-12">
                                            <form>
                                                <div class="row align-items-end">
                                                    ...
                                                    <div class="col">
                                                        <label for="to-date">To Date :</label> <input type="date" class="form-control" id="to-date" value="<?php echo date('Y-m-d'); ?>">
                                                    </div>
                                            ...
                                            <div class="table-responsive" style="background: #fff;">
                                                <div class="resp-table-row" style="position: sticky;top: 0px;z-index:1;" class="table table-bordered" >

                                                    <div class="table-body-cell  custom-header"> </div>
                                                    <div class="table-body-cell custom-header" style="width: 150px; border-top:none;">
                                                    ...
                                                    <div class="table-body-cell custom-header border-none">
                                                        <span style="font-size: 16px;font-weight: bold;position: relative;left: 136px;">TODAY</span>
                                                ...
                                                <div class="resp-table-row" style="position: sticky;top: 50px;z-index:1;" class="table table-bordered">
                                                    ...
                                                    <div class="table-body-cell custom-header" style="min-width: 200px;" ng-click="resetCollapse()">
                                                        Name</div>
                                                ...
                                                <div class="resp-table-row totals" style="position: sticky;top: 118px;box-shadow: 0px 5px 5px 0px #e7e7e7;z-index:1;" class="table table-bordered">
                                                    <div class="table-body-cell  custom-header"> </div>
                                                    <div class="table-body-cell custom-header" style="position: sticky;top: 118px;box-shadow: 0px 4px 12px 2px #e7e7e7;z-index:1; cursor:pointer" ng-click="expandAll()">
                                                        Totals:
                                                    </div>
                                                    <div class="table-body-cell custom-header blue-section old_total_count">
                                                    </div>
                                                    <div class="table-body-cell custom-header blue-section old_total_convert">
                                                    </div>
                                                    <div class="table-body-cell custom-header blue-section old_total_pending">
                                                    </div>
                                                    <div class="table-body-cell custom-header blue-section old_total_missed">
                                                    </div>
                                                    <div class="table-body-cell custom-header blue-section old_total_cancel">
                                                    </div>

                                                    <div class="table-body-cell custom-header blue-section old_total_billing">
                                                    </div>
                                                    <div class="table-body-cell custom-header today_count">
                                                    </div>
                                                    <div class="table-body-cell custom-header today_convert">
                                                    </div>
                                                    <div class="table-body-cell custom-header today_old_convert">
                                                    </div>
                                                    <div class="table-body-cell custom-header today_billing">

                                                    </div>
                                                    <div class="table-body-cell custom-header today_pending">
                                                    </div>
                                                  
                                                   
                                                    <div class="table-body-cell custom-header today_pending_missed">

                                                    </div>
                                                      <div class="table-body-cell custom-header today_missed">
                                                    </div>

                                                    <div class="table-body-cell custom-header today_cancel">

                                                    </div>
                                                    <div class="table-body-cell custom-header today_pending_cancel">

                                                    </div>
                                                    <div class="table-body-cell custom-header today_converted_cancel">

                                                    </div>
                                                    <div class="table-body-cell custom-header blue-section total_count">
                                                    </div>
                                                    <div class="table-body-cell custom-header blue-section total_convert">
                                                    </div>
                                                    <div class="table-body-cell custom-header blue-section total_pending">
                                                    </div>
                                                    <div class="table-body-cell custom-header blue-section total_missed">
                                                    </div>
                                                    <div class="table-body-cell custom-header blue-section total_billing">
                                                    </div>
                                                    <div class="table-body-cell custom-header blue-section total_cancel">
                                                    </div>
                                                    <div class="table-body-cell custom-header convertion">
                                                    </div>
                                                    <div class="table-body-cell custom-header pending">
                                                    </div>
                                                    <div class="table-body-cell custom-header cancel">
                                                    </div>
                                                ...
                                                <div class="primary" ng-repeat="data in namesDataledgergroup">
                                                    <div class="resp-table-row trpoint" style=" box-shadow: inset -1px 0px 0px 3px #f0f0f0f7;" ng-click="toggleCollapse($event,data.teamGroupIndex,data.groupIndex,data.index)">
                                                        ...
                                                        <div class="table-body-cell  blue-section">
                                                            {{ data.old_total_count }}
                                                        </div>
                                                        <div class="table-body-cell  blue-section">
                                                            {{ data.old_total_convert }}
                                                        </div>
                                                        <div class="table-body-cell    blue-section">
                                                            {{ data.old_total_pending }}
                                                        </div>
                                                        <div class="table-body-cell   blue-section">
                                                            {{ data.old_total_missed }}
                                                        </div>
                                                        <div class="table-body-cell   blue-section">
                                                            {{ data.old_total_cancel }}
                                                        </div>
                                                        <div class="table-body-cell   blue-section">
                                                            {{ data.old_total_billing }}
                                                        </div>
                                                        ...
                                                        <div class="table-body-cell   ">
                                                            {{ data.today_pending_cancel }}
                                                        </div>
                                                        <div class="table-body-cell   ">
                                                            {{ data.today_converted_cancel }}
                                                        </div>
                                                    ...
                                                    <div class="primary" ng-repeat="names in data.values">
                                                        <div class="resp-table-row trpoint" style="background: #ffffff;" ng-if="(!names.collapsed)" ng-click="toggleCollapse($event,names.teamGroupIndex,names.groupIndex,names.index)">
                                                            ...
                                                            <div class="table-body-cell blue-section">
                                                                {{ names.old_total_count }}
                                                            </div>

                                                            <div class="table-body-cell blue-section">
                                                                {{ names.old_total_convert }}
                                                            </div>
                                                            <div class="table-body-cell    blue-section">
                                                                {{ names.old_total_pending }}
                                                            </div>
                                                            <div class="table-body-cell   blue-section">
                                                                {{ names.old_total_missed }}
                                                            </div>
                                                            <div class="table-body-cell   blue-section">
                                                                {{ names.old_total_cancel }}
                                                            </div>
                                                            <div class="table-body-cell   blue-section">
                                                                {{ names.old_total_billing }}
                                                            </div>
                                                            <div class="table-body-cell  ">
                                                                {{ names.today_count }}
                                                            </div>
                                                            ...
                                                            <div class="table-body-cell  ">
                                                                {{ names.today_pending_cancel }}
                                                            </div>
                                                            <div class="table-body-cell  ">
                                                                {{ names.today_converted_cancel }}
                                                            </div>
                                                            <div class="table-body-cell   blue-section">
                                                                {{ names.total_count }}
                                                            </div>
                                                        ...
                                                        <div class="secondchild" ng-repeat="namesvvssget in names.subarray">
                                                            <div class="resp-table-row sales_table_head slide" ng-if="!namesvvssget.collapsed" ng-click="toggleCollapse($event,namesvvssget.teamGroupIndex,namesvvssget.groupIndex,namesvvssget.index)" style="background-color: #f9f9f9;">
                                                                ...
                                                                <div class="table-body-cell blue-section">
                                                                    {{ namesvvssget.old_total_count }}
                                                                </div>
                                                                <div class="table-body-cell blue-section">
                                                                    {{ namesvvssget.old_total_convert }}
                                                                </div>
                                                                <div class="table-body-cell    blue-section">
                                                                    {{ namesvvssget.old_total_pending }}
                                                                </div>
                                                                <div class="table-body-cell   blue-section">
                                                                    {{ namesvvssget.old_total_missed }}
                                                                </div>
                                                                <div class="table-body-cell   blue-section">
                                                                    {{ namesvvssget.old_total_cancel }}
                                                                </div>
                                                                <div class="table-body-cell   blue-section">
                                                                    {{ namesvvssget.old_total_billing }}
                                                                </div>
                                                                <div class="table-body-cell  ">
                                                                    {{ namesvvssget.today_count }}
                                                                </div>
                                                                <div class="table-body-cell  ">
                                                                    {{ namesvvssget.today_convert }}
                                                                </div>
                                                                <div class="table-body-cell  ">
                                                                    {{ namesvvssget.today_old_convert }}
                                                                </div>
                                                                <div class="table-body-cell  ">
                                                                    {{ namesvvssget.today_billing }}
                                                                </div>
                                                                <div class="table-body-cell  ">
                                                                    {{ namesvvssget.today_pending }}
                                                                </div>
                                                                <div class="table-body-cell  ">
                                                                    {{ namesvvssget.today_pending_missed }}
                                                                </div>
                                                                <div class="table-body-cell  ">
                                                                    {{ namesvvssget.today_missed }}
                                                                </div>
                                                                <div class="table-body-cell  ">
                                                                    {{ namesvvssget.today_cancel }}
                                                                </div>
                                                                <div class="table-body-cell  ">
                                                                    {{ namesvvssget.today_pending_cancel }}
                                                                </div>
                                                                <div class="table-body-cell  ">
                                                                    {{ namesvvssget.today_converted_cancel }}
                                                                </div>
                                                              
                                                                <div class="table-body-cell   blue-section">
                                                                    {{ namesvvssget.total_count }}
                                                                </div>
                                                                <div class="table-body-cell   blue-section">
                                                                    {{ namesvvssget.total_convert }}
                                                                </div>
                                                                <div class="table-body-cell   blue-section">
                                                                    {{ namesvvssget.total_pending }}
                                                                </div>
                                                                <div class="table-body-cell   blue-section">
                                                                    {{ namesvvssget.total_missed }}
                                                                </div>
                                                                <div class="table-body-cell   blue-section">
                                                                    {{ namesvvssget.total_billing }}
                                                                </div>
                                                                <div class="table-body-cell   blue-section">
                                                                    {{ namesvvssget.total_cancel }}
                                                                </div>
    ...
    <script>
        ...
        app.controller('crudController', function($scope, $http) {
            ...
            $scope.fetchDatagetlegderGroup = function() {
                ...
                $http.get('<?php echo base_url() ?>index.php/report/fetch_data_enquiry_report_a?limit=10&customer_id=' + customer_id + '&formdate=' + fromdate + '&todate=' + fromto + '&page=' + $scope.currentPage + '&size=' + $scope.pageSize + '&search=' + $scope.searchText + '&todate=' + fromto + '&sales_group=' + sales_group + '&order_status=' + cateid + '&payment_mode=' + payment_mode).success(function(data) {


                    let groupNames = [];
                    let MasterData;
                    data['values'].map((el, headIndex) => {
                           ...
                           ex[head] = 0;
                            ...
                            MasterData[key].forEach((item) => {
                                item.subarray.forEach((el) => {
                                    if (!(head == 'conversion' || head == 'missing' || head == 'pending' || head == 'billing' || head == 'cancel')) {
                    ...
                    for (const key in totals) {
                        if (totals.hasOwnProperty(key)) {
                            ...
                            if (key == 'convertion' || key == 'missed' || key == 'pending' || key == 'billing' || key == 'cancel') {
                                val = val + ' %';
                            }
                    ...
                    dataNew.map((eltop, teamGroupIndex) => {
                        ...
                        eltop.convertion = ifFloat((eltop.total_convert / eltop.total_count) * 100);
                         eltop.cancel = ifFloat((eltop.total_cancel / eltop.total_count) * 100);
                        eltop.missed = ifFloat((eltop.total_missed / eltop.total_count) * 100);
                        eltop.pending = ifFloat((eltop.total_pending / eltop.total_count) * 100);
                        eltop.billing = ifFloat((eltop.total_billing / eltop.total_count) * 100);

                                    ...
                                    <div class="col-lg-12">
                                       ...
                                       <div class="row" style="margin-bottom: 10px;">
                                          <ul class="nav nav-pills m-3" id="pills-tab" role="tablist">
                                             <li class="nav-item" role="presentation">
                                                <button class="nav-link active" id="pills-home-tab" data-toggle="tab" data-bs-target="#pills-home" type="button" role="tab" aria-controls="pills-home" aria-selected="true">Balance Comparision</button>
                                             </li>
                                             <li class="nav-item" role="presentation">
                                                <button class="nav-link" id="pills-profile-tab" data-toggle="tab" data-bs-target="#pills-profile" type="button" role="tab" aria-controls="pills-profile" aria-selected="false">Balance Increase Report</button>
                                             </li>
                                       ...
                                       <div class="tab-content" id="pills-tabContent">
                                          <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab" tabindex="0">
                                             ...
                                             <div class="row">
                                                <!-- <h4 class="card-title p-2 text-center text-white bg-primary"> Abstract Reports</h4> -->
                                                <div class="col-6">
                                                   <div class="row">
                                                      <div id="search-view" style="display: none;">
                                                         <div class="card-header" ng-init="fetchSingleData(0)">
                                                            <h4 class="card-title">Balance Ledger Report {{formdate}}
                                                               With {{todate}}</h4>
                                                         </div>
                                                      </div>
                                                      <div id="search-view1">
                                                         <div class="card-header" ng-init="fetchSingleData(0)">
                                                            <h4 class="card-title">Balance Ledger Report
                                                      ...
                                                      <div class="row">
                                                         <div class="col-11">
                                                            ...
                                                            <div class="row mb-2">
                                                               ...
                                                               <div class="col-1" style="align-self: center;white-space: nowrap;">
                                                                  <b>With</b>
                                                               </div>
                                                               <div class="col-4">
                                                         ...
                                                         <div class="col-1">
                                                            <div class="btn-group-vertical mb-2 mx-2" role="group" aria-label="Vertical radio toggle button group">
                                                               <input type="radio" class="btn-check" name="vbtn-radio" id="vbtn-radio12" value="1" autocomplete="off" >
                                                               <label class="btn btn-outline-danger" for="vbtn-radio12">1</label>
                                                               <input type="radio" class="btn-check" name="vbtn-radio" id="vbtn-radio22" value="L" autocomplete="off" checked>
                                                               <label class="btn btn-outline-danger" for="vbtn-radio22">L </label>
                                                               <input type="radio" class="btn-check" name="vbtn-radio" id="vbtn-radio32" value="C" autocomplete="off">
                                                ...
                                                <div class="col-6">
                                                   <div class="row">
                                                      <div id="search-view2" style="display: none;">
                                                         <div class="card-header" ng-init="fetchSingleData(0)">
                                                            <h4 class="card-title"> Balance Report with Credit Ledgers {{formdate1}}
                                                               With {{todate1}}</h4>
                                                         </div>
                                                      </div>
                                                      <div id="search-view3">
                                                         <div class="card-header" ng-init="fetchSingleData(0)">
                                                            <h4 class="card-title">Balance Report with Credit Ledgers
                                                         ...
                                                         <div id="resp-table-body" style="position: relative;">
                                                            ...
                                                            <div class="primary" ng-repeat="data in namesDataledgergroup2">
                                                               ...
                                                               <div class="primary" ng-repeat="names in data.values">
                                                                  ...
                                                                  <div class="secondchild" ng-repeat="namesvvssget in names.salesperson">
                                                                     <div class="resp-table-row sales_table_head slide" ng-if="!namesvvssget.collapsed" ng-click="toggleCollapse2($event,namesvvssget.teamGroupIndex,namesvvssget.groupIndex,namesvvssget.index)" style="background-color: #f9f9f9;">
                                          ...
                                          <div class="tab-pane fade" id="pills-profile" role="tabpanel" aria-labelledby="pills-profile-tab" tabindex="0">
                                             <div class="row">
                                                <div id="search-view4" style="display: none;">
                                                   <div class="card-header" ng-init="fetchSingleData(0)">
                                                      <h4 class="card-title p-2 text-center text-white  bg-danger">Balance Increase Report {{formdate2}}
                                                         With {{todate2}}</h4>
                                                   </div>
                                                </div>
                                                <div id="search-view5">
                                                   <div class="card-header" ng-init="fetchSingleData(0)">
                                                      <h4 class="card-title p-2 text-center text-white  bg-danger">Balance Increase Report
                                                         <?php echo date('d-m-Y', strtotime("-1 day")); ?> With
                                                         <?php echo  date('d-m-Y'); ?>
                                                      </h4>
                                                   </div>
                                                   ...
                                                   <div id="resp-table-body" style="position: relative;">
                                                      ...
                                                      <div class="primary" ng-repeat="data in namesDataledgergroup3">
                                                         ...
                                                         <div class="primary" ng-repeat="names in data.values">
                                                            ...
                                                            <div class="secondchild" ng-repeat="namesvvssget in names.salesperson">
                                                               <div class="resp-table-row sales_table_head slide" ng-if="(!namesvvssget.collapsed)" ng-click="toggleCollapse3($event,namesvvssget.teamGroupIndex,namesvvssget.groupIndex,namesvvssget.index)" style="background-color: #f9f9f9;">
                                                                  <div class="table-body-cell price-sl">{{ namesvvssget.no }}</div>
                                                                  <div class="table-body-cell" style="width: 150px; text-align:right;">
                                                                     {{ namesvvssget.sales_person_name }}
                                                                  </div>
            ...
            <script>
               ...
               app.controller('crudController', function($scope, $http) {
                  ...
                  $scope.handleClick = function(namesvv) {
                     ...
                     var url = "<?php echo base_url(); ?>index.php/customer/ledger_find?customer_id=" +
                        customer_id;
                  ...
                  $('#exportdata_increase').on('click', function() {
                     ...
                     // var payment_mode = $('#payment_mode').val();
                     url =
                        '<?php echo base_url() ?>index.php/report/fetch_data_customer_balance_increase_export?limit=10&customer_id=' +
                  ...
                  $('#exportdata_with_credit').on('click', function() {
                     ...
                     // var payment_mode = $('#payment_mode').val();
                     url =
                        '<?php echo base_url() ?>index.php/report/fetch_data_credit_balance_comparision_export?limit=10&customer_id=' +
                           customer_id + '&formdate=' + fromdate + '&todate=' + fromto + '&page=' + $scope.currentPage + '&dividend=' + $scope.dividentKey1 +
                           '&size=' + $scope.pageSize + '&search=' + $scope.searchText + '&sales_group=' + sales_group + '&order_status=' + cateid +
                           '&payment_mode=' + payment_mode;
                     location = url;
                  ...
                  $scope.fetchDatagetlegderGroup2 = function(cateid, sales_group) {
                     ...
                     if (cateid != 0) {
                        $http.get(
                           '<?php echo base_url() ?>index.php/report/fetch_data_credit_balance_comparision?limit=10&customer_id=' +
                           customer_id + '&formdate=' + fromdate + '&todate=' + fromto + '&page=' + $scope.currentPage + '&dividend=' + $scope.dividentKey1 +
                           '&size=' + $scope.pageSize + '&search=' + $scope.searchText + '&sales_group=' + sales_group + '&order_status=' + cateid +
                           '&payment_mode=' + payment_mode).success(function(data) {
...
dataNew.map((eltop, teamGroupIndex) => {
                  ...
                  $scope.fetchDatagetlegderGroup3 = function(cateid, sales_group) {
                     ...
                     if (cateid != 0) {
                        $http.get(
                           '<?php echo base_url() ?>index.php/report/fetch_data_customer_balance_increase?limit=10&customer_id=' +
                           customer_id + '&formdate=' + fromdate + '&todate=' + fromto + '&page=' + $scope.currentPage + '&dividend=' + $scope.dividentKey2 +
                           '&size=' + $scope.pageSize + '&search=' + $scope.searchText + '&sales_group=' + sales_group + '&order_status=' + cateid +
                           '&payment_mode=' + payment_mode).success(function(data) {

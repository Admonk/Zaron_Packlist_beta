                    ...
                    <form class="ng-pristine ng-valid">
                          <div class="row">
                            ...
                            <div class="col">
                              ...
                              <input type="date" class="form-control" id="from-date" value="<?php echo date('2022-04-01'); ?>">
                            </div>
                            <div class="col">
                                <label>To date</label>
  ...
  <tr ng-if="names.name!=0"><td> <b > <a href="#"  style="color: #ef7b3f;font-weight: 800;">{{names.name}}</a> </b> </td> <td></td></tr>
   ...
   <tr ng-repeat="namesvv in names.resultsub"><td >  <a href="javascript:void(0);" >{{namesvv.name}}</a>  </td> <td>{{namesvv.credit | number}}</td></tr>
                        ...
                        <tr ng-if='ctotal<dtotal'>
                           ...
                           <th><b>NET PROFIT C/D TO BALANCING FIGURE</b></th>
                           
                           <th><b>{{dtotal-ctotal | number}}</b></th>
...
$scope.fetchDatagetlegderGroup = function(fromdate,fromto){
    ...
    $http.get('<?php echo base_url() ?>index.php/report_new/trial_balance_report?limit=10&formdate='+fromdate+'&fromto='+fromto).success(function(data){
...
var fromdate= $('#from-date').val();
    ...
    $http.get('<?php echo base_url() ?>index.php/report_new/trial_balance_report2?limit=10&formdate='+fromdate+'&fromto='+fromto).success(function(data){
...
var fromdate= $('#from-date').val();
    ...
    $http.get('<?php echo base_url() ?>index.php/report_new/trial_balance_report3?limit=10&formdate='+fromdate+'&fromto='+fromto).success(function(data){
...
var fromdate= $('#from-date').val();
    ...
    $http.get('<?php echo base_url() ?>index.php/report_new/trial_balance_report1?limit=10&formdate='+fromdate+'&fromto='+fromto).success(function(data){

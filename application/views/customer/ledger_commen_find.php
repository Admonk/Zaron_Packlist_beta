                      ...
                      <form>
                          <div class="row">
                            ...
                            <?php
                                               ...
                                               ?>
                            <div class="col">
                              <input type="date" class="form-control" id="from-date" min="<?php echo date('2024-04-01'); ?>" value="<?php echo $from_date; ?>">
                            </div>
                            <div class="col">
                        ...
                        <tr   class="trpoint" ng-if="names.no=='#'" style="font-weight: 800;vertical-align: baseline;">
                         ...
                         <tr  class="trpoint" ng-if="names.no!='#'">
                           ...
                           <td>
                                ...
                                {{names.process_by}} {{names.deletemod}}
   ...
   if($this->session->userdata['logged_in']['access']=='1' || $this->session->userdata['logged_in']['access']=='14' || $this->session->userdata['logged_in']['access']=='2'  || $this->session->userdata['logged_in']['access']=='5' || $this->session->userdata['logged_in']['access']=='15')
   {
       ...
       ?>
                               ...
                               <td style="display:flex;">
                                 ...
                                 <?php 
         if($this->session->userdata['logged_in']['userid'] == '1541' || $this->session->userdata['logged_in']['userid'] == '1453' || $this->session->userdata['logged_in']['userid'] == '1769' || $this->session->userdata['logged_in']['userid'] == '1773' || $this->session->userdata['logged_in']['userid'] == '1763' || $this->session->userdata['logged_in']['userid'] == '1777' ){
                 ?>
                                  ...
                                  <button type="button" class="btn btn-outline-danger btn-sm" ng-if="names.process_by == 'Voucher'">
                                                   <a href="<?php echo base_url(); ?>index.php/journal/edit?id={{names.id}}&deletemod={{names.deletemod}}&customer_id={{names.customer_id}}"  
                                                      target="_blank" style="color: red;">V
                                                   </a>
                                                </button>

                                                
                                     <button type="button" ng-if="names.edit_status==1 && names.process_by !='Voucher'" ng-click="editData(names.id)" class="btn btn-outline-danger btn-sm"><i class="mdi mdi-pencil menu-icon"></i></button>
...
$('#exportdata').on('click', function() {
    ...
    url = '<?php echo base_url() ?>index.php/customer/fetch_data_get_ledger_view_export_commen?limit=10&deleteid=0&customer_id='+id+'&formdate='+fromdate+'&todate='+fromto+'&payment_status='+payment_status+'&filter='+filter;
...
$scope.fetchDatagetlegderGroup = function(id,fromdate,fromto,payment_status){
    ...
    var payment_status= $('#payment_status').val();
    $http.get('<?php echo base_url() ?>index.php/customer/fetch_data_get_ledger_view_commen?limit=10&deleteid=0&customer_id='+id+'&formdate='+fromdate+'&todate='+fromto+'&payment_status='+payment_status+'&filter='+filter).success(function(data){
...
$scope.fetchDatagetlegderGroupTotal = function(id,fromdate,fromto,payment_status){
    ...
    var fromto= $('#to-date').val();
    var payment_status= $('#payment_status').val();
    $http.get('<?php echo base_url() ?>index.php/customer/fetch_data_get_ledger_view_total_commen?limit=10&deleteid=0&customer_id='+id+'&formdate='+fromdate+'&todate='+fromto+'&payment_status='+payment_status+'&filter='+filter).success(function(data){

                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    <h4 class="mb-sm-0 font-size-18">Customer ledger Delete Log</h4>

                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                             <li class="breadcrumb-item"><a href="<?php echo base_url(); ?>index.php/dashboard">Dashboard</a></li>
                                            <li class="breadcrumb-item active">Customer ledger Delete Log!</li>
                                        </ol>
                                    </div>
              ...
              <div class="col-lg-12">
                ...
                <div class="row">
                  ...
                  <div id="search-view" >
                   ...
                   <table id="datatable" class="table table-bordered" style="position: relative;" width="100%" ng-init="fetchDatagetlegderGroup('<?php echo $customer_id; ?>')" >
                      <thead>
                        <tr style="position: sticky;top: 0;background: #dfdfdf;">
                          ...
                          <th style="width:150px;"><h5 class="font-size-14 mb-0">Debit</h5></th>
                          <th style="width:150px;"><h5 class="font-size-14 mb-0">Credit</h5></th>
                          <th style="width:200px;"><h5 class="font-size-14 mb-0">Balance</h5></th>
                           <th style="width:200px;"><h5 class="font-size-14 mb-0">Mode</h5></th>
                             <th style="width:200px;"><h5 class="font-size-12 mb-0">User</h5></th>
                          <th style="width:100px;"><h5 class="font-size-14 mb-0">Narration</h5></th>
                           <?php
                         ...
                         <tr  class="trpoint {{names.addclass}}" ng-if="names.no!='#'">
                           ...
                           <td >
                            ...
                            <p style="width:150px;">
                                ...
                                <samll ng-if="names.edit_status==1"><br><b>{{names.username}}</b></samll>
   ...
   if($this->session->userdata['logged_in']['access']=='1' ||  $this->session->userdata['logged_in']['access']=='2')
   {
       ...
       ?>
                               <td> 
                                ...
                                <button type="button" ng-click="deleteDataRevart(names.id)" class="btn btn-outline-danger btn-sm">Revert</button></td>
...
$('#exportdata').on('click', function() {
    ...
    url = '<?php echo base_url() ?>index.php/customer/fetch_data_get_ledger_view_export?limit=10&deleteid=1&customer_id='+id+'&formdate='+fromdate+'&todate='+fromto+'&payment_status='+payment_status+'&cnn_status='+cnn_status;
           ...
           $http({
            ...
            {     
        		    $http({
        		      ...
        		      data:{'id':party, 'action':'fetch_single_data','tablename':1}
        		     }).success(function(data){
...
$scope.fetchDatagetlegderGroup = function(id,fromdate,fromto,payment_status){
    ...
    var fromto= $('#to-date').val();
    var payment_status= $('#payment_status').val();
    $http.get('<?php echo base_url() ?>index.php/customer/fetch_data_get_ledger_view?limit=10&deleteid=1&customer_id='+id+'&formdate='+fromdate+'&todate='+fromto+'&payment_status='+payment_status+'&cnn_status='+cnn_status).success(function(data){
...
$scope.fetchDatagetlegderGroupTotal = function(id,fromdate,fromto,payment_status){
    ...
    var payment_status= $('#payment_status').val();
    $http.get('<?php echo base_url() ?>index.php/customer/fetch_data_get_ledger_view_total?limit=10&deleteid=1&customer_id='+id+'&formdate='+fromdate+'&todate='+fromto+'&payment_status='+payment_status).success(function(data){

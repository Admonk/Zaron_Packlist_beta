                    ...
                    <div class="col-lg-12" >
                      ...
                      <form>
                          <div class="row">
                            ...
                            <div class="col">
                              <input type="date" class="form-control" id="from-date" min="<?php echo date('2024-04-01'); ?>" value="<?php echo $date; ?>">
                            </div>
                            <div class="col">
                              <input type="date" class="form-control" id="to-date" min="<?php echo date('2024-04-01'); ?>"   value="<?php echo $this->session->userdata['logged_in']['to_date']; ?>">
                            </div>

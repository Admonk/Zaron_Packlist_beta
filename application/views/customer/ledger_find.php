...
<style>
   ...
   .card.shadow-none.card-h-50.mb-0 {
    background: #efefef;
    height: 71px;
    margin-top: 10px;
...
<body data-layout="horizontal" class="full-vh-overflow-hide" data-topbar="dark" ng-app="crudApp" ng-controller="crudController">
   <div id="layout-wrapper">
      ...
      <?php
         ...
         $filter=0;
         $Total_Debit_text='Total Debit : ';
         if(isset($_GET['filter']))
         {
            $filter=$_GET['filter'];
            if($filter==1)
            {
                $Total_Debit_text='In Production : ';
            }
            if($filter==2)
            {
                $Total_Debit_text='Sheet in Factory  : ';
            }

             if($filter==3)
            {
                $Total_Debit_text='Transit  : ';
            }

            if($filter==4)
            {
                $Total_Debit_text='In-production Return  : ';
            }
               ...
               <div class="row">
                  <div class="col-12">
                     <div class="page-title-box d-sm-flex align-items-center justify-content-between pb-2">
                        <h4 class="mb-sm-0 font-size-14"><?php echo $cnn_text; ?> Customer ledger</h4>
                        <div class="page-title-right <?php echo $d_none_c; ?>">
                           <ol class="breadcrumb m-0">
                              <li class="breadcrumb-item"><a href="<?php echo base_url(); ?>index.php/dashboard">Dashboard</a></li>
                              <li class="breadcrumb-item active"><?php echo $cnn_text; ?> Customer ledger !</li>
                           </ol>
                        </div>
                     </div>
                  </div>
                        ...
                        <div class="card-body" >
                           <div class="row">
                              <div class="col-lg-12" >
                                 <form>
                                    <div class="row">
                                       <div class="col-md-4 <?php echo $d_none_c; ?>" >
                                       ...
                                       <div class="col">
                                         <?php
                                               ...
                                               ?>
                                          <input type="text" class="form-control" id="from-date" min="<?= date('2024-04-01') ?>" value="<?=  $from_date ?>">
                                       </div>
                                       <div class="col">
                                          <input type="text" class="form-control" id="to-date" min="<?php echo date('2024-04-01'); ?>"   value="<?= isset($_GET['todate']) ? $_GET['todate'] : date('Y-m-d')?>">
                                       </div>
                                       ...
                                       <div class="col">
                                          ...
                                          <?php
                                                 ...
                                                 if(isset($_GET['test']))
                                                 {
                                                  ...
                                                  ?>
<button type="button"
                                           <?=$_GET['test'] && $_GET['test'] == 'true' ? '' : ''?> 
                                           class="btn btn-success waves-effect waves-light <?php echo $d_none_c; ?>" id="exportdata1" ng-click="exportToExcel()" class="<?php echo $d_none_c; ?>">Export</button>
                                                 ...
                                                 else
                                                 {
                                                   ...
                                                   <button type="button"
                                           <?=$_GET['test'] && $_GET['test'] == 'true' ? '' : ''?> 
                                           class="btn btn-success waves-effect waves-light <?php echo $d_none_c; ?>" id="exportdata" class="<?php echo $d_none_c; ?>">Export</button>

<a href="<?php echo base_url(); ?>index.php/customer/ledger_find_delete_log?customer_id={{customer_id_data}}&cnn_status=<?php echo $cnn_status; ?>" target="_blank" class="<?php echo $d_none_c; ?>">Delete Log</a>
                                             ...
                                             <div class="d-flex align-items-center">
                                                <div class="flex-grow-1">
                                                   <h3 class="text-muted mb-1 font-size-14 lh-1 d-block text-truncate"> Opening Balance:  
                                                      <span  ng-if="opstatus==1" style="color:red">{{openingbalance | indianCurrency}}</span>
                                                      <span  ng-if="opstatus==0" style="color:green">{{openingbalance | indianCurrency}}</span>
                                                   </h3>
                                    ...
                                    <div class="col-xl-3 col-md-3">
                                       ...
                                       <div class="card shadow-none card-h-50 mb-0">
                                          ...
                                          <div class="card-body">
                                             <div class="d-flex align-items-center">
                                                <div class="flex-grow-1">
                                                   <h3 class="text-muted mb-1 font-size-14 lh-1 d-block text-truncate"><?php echo $Total_Debit_text; ?> <span>{{totaldebit | indianCurrency}}</span></h3>
                                                </div>
                                             </div>
                                          </div>
                                          <!-- end card body -->
                                    ...
                                    <div class="col-xl-3 col-md-3">
                                       ...
                                       <div class="card shadow-none card-h-50 mb-0">
                                          ...
                                          <div class="card-body">
                                             <div class="d-flex align-items-center">
                                                <div class="flex-grow-1">
                                                   <h3 class="text-muted mb-1 font-size-14 lh-1 d-block text-truncate">Total Credit : {{totalcridit | indianCurrency}}</h3>
                                                </div>
                                             </div>
                                          </div>
                                          <!-- end card body -->
                                 ...
                                 <?php
                                    if ($this->session->userdata['logged_in']['access'] == '1' || $this->session->userdata['logged_in']['access'] == '14' || $this->session->userdata['logged_in']['access'] == '2') {
                                      ...
                                      ?>
                                <!--  <button type="button" ng-click="onviewparty()"  class="btn btn-soft-danger  waves-effect waves-light" style="float: right;margin: 5px 12px;">Internal Transaction</button> -->
                                 <button type="button" ng-click="onview()"  class="btn btn-soft-success  waves-effect waves-light" style="float: right;margin: 5px 12px;">Receive Payment</button>
                                 <?php
                                    }
                                 ...
                                 <div id="search-view" >
                                    <div   ng-init="fetchSingleData('<?php echo $customer_id; ?>')">
                                       <h4 class="card-title"><a href="<?php echo base_url(); ?>index.php/customer/ledger_find?customer_id=<?php echo $customer_id; ?>">{{name}} - {{phone}}</a>
                                       <a href="#" id="popover-trigger" data-toggle="popover" title="" data-content="Content will be displayed here" data-bs-original-title="Linked Customers">
                                           <i class="mdi mdi-information-outline <?php echo $d_none_c; ?>" style="font-size: 20px;"></i><span class="position-absolute translate-middle badge rounded-pill bg-success <?php echo $d_none_c; ?>" style="margin-left: 0px; border-radius: 50rem!important; font-size: x-small;"><?php echo $customer_link_count; ?></span>
                                        </a> </h4>
                                       <h4 class="card-title" ng-if="gst!=0">{{gst}}</h4>
                                       <?php
                                          $url = ($_GET['test'] && $_GET['test'] == 'true') ? 'customer_balance_report?test=true&' : 'customer_balance_report?';

                                       ?>
                                       <a href="<?php echo base_url(); ?>index.php/report/<?=$url?>customer_id={{customer_id_data}}" target="_blank" class="<?php echo $d_none_c; ?>">View Balance Report</a>
                                    </div>
                                 </div>
                                 ...
                                 <div class="table-responsive mt-2">
                                    <table id="datatable" class="table table-striped table-bordered customerLedgerT" style="position: relative;" width="100%" ng-init="fetchDatagetlegderGroup('<?php echo $customer_id; ?>')" >
                                       <thead>
                                          <tr style="position: sticky;top: 0;background: #dfdfdf;">
                                             ...
                                             <th style="width:180px;" class="<?php echo $d_none_c; ?>">
                                             ...
                                             <th style="width:100px;">
                                                <h5 class="font-size-12 mb-0">Voucher_no</h5>
                                             </th>
                                             <th style="width:200px;" class="<?php echo $d_none_c; ?>">
                                                <h5 class="font-size-12 mb-0">User</h5>
                                             </th>
                                             <th style="width:100px;">
                                                <h5 class="font-size-12 mb-0">Narration</h5>
                                             </th class="<?php echo $d_none_c; ?>">
                                             <?php
                                                if ($this->session->userdata['logged_in']['access'] == '1' || $this->session->userdata['logged_in']['access'] == '14' || $this->session->userdata['logged_in']['access'] == '2' || $this->session->userdata['logged_in']['access'] == '5' || $this->session->userdata['logged_in']['access'] == '15') {
                                       ...
                                       <tbody   ng-repeat="names in namesDataledgergroup | filter:query">
                                          <tr   class="trpoint mcolor" ng-if="names.no=='#'" style="font-weight: 800;vertical-align: baseline;">
                                             <td data-label="Opening Balance : ">{{names.no}}</td>
                                             <td data-label="Particular : " class="<?php echo $d_none_c; ?>">Opening Balance</td>
                                             <td data-label="Date : ">{{names.payment_date}} </td>
                                             <td class="<?php echo $d_none_c; ?>"></td>
                                             <td class="<?php echo $d_none_c; ?>"></td>
                                             <td  data-label="Debits : "><span ng-if="names.debits!=0">{{names.debits | indianCurrency}}</span></td>
                                             <td  data-label="Credits : "><span ng-if="names.credits!=0">{{names.credits | indianCurrency}}</span></td>
                                             <td>
...
?>
 ...
 <tr  class="trpoint {{names.addclass}}" ng-if="names.no!='#'">
                                             <td data-label="No : ">{{names.no}}</td>
                                             <td data-label="Particular : ">
                                                
                                                <a href="#" >{{names.account_head_name}}</a>
                                             </td>
                                             <td data-label="Date : ">{{names.payment_date}} {{names.payment_time}}</td>
                                             <td class="<?php echo $d_none_c; ?>">{{names.update_date}} </td>
                                             <td data-label="Reference : ">
                                                <a href="#">{{names.reference_no}}</a>
                                                
                                             <td data-label="Debits : ">
                                               
                                            <a href="#" >  <span ng-if="names.debits!=0">{{names.debits | indianCurrency}}</span></a>
                                             </td>
                                             <td data-label="Credits : ">
                                                
                                        <a href="#" >  <span ng-if="names.credits!=0">{{names.credits | indianCurrency}}</span></a>
                                             </td>
                                             <td data-label="Balance : ">
                                                <a href="#"> 
                                                <span  ng-if="names.getstatus==1" style="color:red">{{names.balance | indianCurrency}}</span>
                                                <span  ng-if="names.getstatus==0" style="color:green">{{names.balance | indianCurrency}}</span>
                                                </a>
                                             ...
                                             <td class="<?php echo $d_none_c; ?>">{{names.username_base}}</td>
                                             <td style="width:300px;" data-label="Notes : ">
                                                <a href="#"> {{names.notes}}</a>
                                                <samll ng-if="names.org_amount!=0"><br>{{names.username}} {{names.org_amount}}</samll>
                                             </td>
                                             <?php
                                                if ($this->session->userdata['logged_in']['access'] == '1' || $this->session->userdata['logged_in']['access'] == '14' || $this->session->userdata['logged_in']['access'] == '5' || $this->session->userdata['logged_in']['access'] == '2') {
                                                
                                                  ?> 
                                             <td style="display: flex;">
       <?php 
       if($this->session->userdata['logged_in']['userid'] == '1541' || $this->session->userdata['logged_in']['userid'] == '1910' || $this->session->userdata['logged_in']['userid'] == '1769' || $this->session->userdata['logged_in']['userid'] == '1773' || $this->session->userdata['logged_in']['userid'] == '1763' ){
        ?>
                                              <button type="button" class="btn btn-outline-danger btn-sm" ng-if="names.process_by == 'Voucher'">
                                                   <a href="<?php echo base_url(); ?>index.php/journal/edit?id={{names.id}}&deletemod={{names.deletemod}}&customer_id={{names.customer_id}}"  
                                                      target="_blank"><i class="mdi mdi-pencil menu-icon" style="color: red;"></i>
                                                   </a>
                                                </button>
      
                                              <button type="button" ng-click="editData(names.id)" ng-if="names.edit_status==1 && names.process_by !='Voucher'" class="btn btn-outline-danger btn-sm"><i class="mdi mdi-pencil menu-icon"></i></button>
     ...
     <?php
       ...
       else
       {
         ?>
          ...
          <span ng-if="names.customer_id==23100">
       ...
       ?>
                                                ...
                                                <button type="button" ng-click="deleteData(names.id)" ng-if="names.edit_status==1" class="btn btn-outline-danger btn-sm"><i class="mdi mdi-delete menu-icon"></i></button>
                                               <!--  <button type="button" ng-click="onviewparty_edit(names.id,names.customer_id,names.name,names.debits,names.credits,names.dummy_customer_id,names.dummy_customer_name,names.dummy_party_type,names.dummy_amount)" ng-if="names.edit_status==1" class="btn btn-outline-danger btn-sm"><i class="mdi mdi-ray-start-arrow menu-icon"></i></button> -->
                                                <button type="button" ng-if="names.commission_button_view>0" ng-click="onviewparty_edit_new(names.commission_button_view,names.customer_id,names.name,names.debits,names.credits)"   class="btn btn-outline-danger btn-sm">VIEW</button>
                                                  <button type="button" ng-if="names.process_by == 'Voucher'" class="btn btn-outline-danger btn-sm">  <a href="<?php echo base_url(); ?>index.php/journal/edit?id={{names.id}}&deletemod={{names.deletemod}}&customer_id={{names.customer_id}}&voucher_type=journal"  
                                                      target="_blank"><b class="mdi menu-icon" style="color: red;">V</b>
                                                   </a></button>
                                             </td>
                                             <?php
                                                }
                                                ...
                                                if ($this->session->userdata['logged_in']['access'] == '15') {
                                                    ...
                                                    if ($this->session->userdata['logged_in']['userid'] == '1763') {
...
else
{
  ...
  ?>
                                          ...
                                          <tr  class="trpoint {{names.addclass}}" ng-if="names.no!='#'">
                                             <td data-label="No : ">{{names.no}}</td>
                                             <td data-label="Particular : ">
                                                <a href="<?php echo base_url(); ?>index.php/order/ordercreate_product_process?order_id={{names.order_id}}&old_tablename=orders_quotation&old_tablename_sub=order_product_list_quotation&tablename=orders_process&tablename_sub=order_product_list_process&movetablename=orders_process&movetablename_sub=order_product_list_process" ng-if="names.order_id!='#'" target="_blank">{{names.account_head_name}}</a>
                                                <a href="#" ng-if="names.order_id=='#'">{{names.account_head_name}}</a>
                                             </td>
                                             <td data-label="Date : ">{{names.payment_date}} {{names.payment_time}}</td>
                                             <td class="<?php echo $d_none_c; ?>">{{names.update_date}} </td>
                                             <td data-label="Reference : ">
                                                <a href="<?php echo base_url(); ?>index.php/order/ordercreate_product_process?order_id={{names.order_id}}" ng-if="names.order_id!='#'" target="_blank">{{names.reference_no}}</a>
                                                <a href="#" ng-if="names.order_id=='#'">{{names.reference_no}}</a>
                                             <td data-label="Debits : ">
                                                <a href="<?php echo base_url(); ?>index.php/order/overview?order_id={{names.order_id}}&old_tablename=orders_quotation&old_tablename_sub=order_product_list_quotation&tablename=orders_process&tablename_sub=order_product_list_process&movetablename=orders_process&movetablename_sub=order_product_list_process" ng-if="names.order_id!='#'" target="_blank">  <span ng-if="names.debits!=0">{{names.debits | indianCurrency}}</span></a>
                                                <a href="#" ng-if="names.order_id=='#'">  <span ng-if="names.debits!=0">{{names.debits | indianCurrency}}</span></a>
                                             </td>
                                             <td data-label="Credits : ">
                                                <a href="<?php echo base_url(); ?>index.php/order/overview?order_id={{names.order_id}}&old_tablename=orders_quotation&old_tablename_sub=order_product_list_quotation&tablename=orders_process&tablename_sub=order_product_list_process&movetablename=orders_process&movetablename_sub=order_product_list_process" ng-if="names.order_id!='#'" target="_blank"> <span ng-if="names.credits!=0">{{names.credits | indianCurrency}}</span></a>
                                                <a href="#" ng-if="names.order_id=='#'">  <span ng-if="names.credits!=0">{{names.credits | indianCurrency}}</span></a>
                                             </td>
                                             <td data-label="Balance : ">
                                             ...
                                             <td data-label="Payment mode : ">
                                                ...
                                                <span  ng-if="names.payment_mode!='Cash'">
                                                 ...
                                                 <span  ng-if="names.payment_mode!='0'">   
                                                {{names.payment_mode}}
                                                <br>
                                                {{names.bank_name}}
                                                </span>
...
?>
         ...
         <div class="modal-content">
            ...
            <div class="modal-body">
               ...
               <div class="form-group row">
                  ...
                  <div class="col-sm-12">
                     <input type="textt" min="0" onkeypress="return isNumberKey(event)" id="discountamount" class="form-control">
                  </div>
               </div>
               <div class="form-group row" >
               ...
               <div class="row" style="margin: 20px -9px;">
                  <div class="col-md-12">
                     <div class="form-group row">
                        <div class="col-sm-12">
                           <button type="submit" class="btn btn-primary w-md" style="float: right;" id="pointtodriver" ng-click="pointtodriver()">Payment Save</button>
                        </div>
                     </div>
                  </div>
               </div>
            ...
            <div class="modal-body">
               ...
               <div class="form-group row">
                  ...
                  <div class="some-class">
                     <input type="radio" class="radio" name="Payer1" checked value="1" id="Customer" ng-click="selectOption('Other1')"/>
               ...
               <div class="form-group row">
                  ...
                  <div class="some-class">
                     <!-- Payee options -->
                     <input type="radio" class="radio" name="Payee1" checked value="1" id="Customer1" ng-click="selectOption('Other2')" />
               ...
               <div class="show2" style="display:none;">
                  <div class="form-group row">
                     ...
                     <div class="some-class">
                        <!-- Payee options -->
                        <input type="radio" class="radio" name="Payee2" checked value="1" id="Customer2" ng-click="selectOption('Other3')"/>
                     ...
                     <!-- Display driver options when showDriverOptions3 is true -->
               ...
               <div class="show3" style="display:none;">
                  <div class="form-group row">
                     ...
                     <div class="some-class">
                        <!-- Payee options -->
                        <input type="radio" class="radio" name="Payee3" checked value="1" id="Customer3" ng-click="selectOption('Other4')"/>
               ...
               <div class="show4" style="display:none;">
                  <div class="form-group row">
                     ...
                     <div class="some-class">
                        <!-- Payee options -->
                        <input type="radio" class="radio" name="Payee4" checked value="1" id="Customer4" ng-click="selectOption('Other5')"/>
               ...
               <div class="show5" style="display:none;">
                  <div class="form-group row">
                     ...
                     <div class="some-class">
                        <!-- Payee options -->
                        <input type="radio" class="radio" name="Payee5" checked value="1" id="Customer5" ng-click="selectOption('Other6')"/>
               ...
               <div class="show6" style="display:none;">
                  <div class="form-group row">
                     ...
                     <div class="some-class">
                        <!-- Payee options -->
                        <input type="radio" class="radio" name="Payee6" checked value="1" id="Customer6" ng-click="selectOption('Other7')"/>
               ...
               <div class="show7" style="display:none;">
                  <div class="form-group row">
                     ...
                     <div class="some-class">
                        <!-- Payee options -->
                        <input type="radio" class="radio" name="Payee7" checked value="1" id="Customer7" ng-click="selectOption('Other8')"/>
               ...
               <div class="show8" style="display:none;">
                  <div class="form-group row">
                     ...
                     <div class="some-class">
                        <!-- Payee options -->
                        <input type="radio" class="radio" name="Payee8" checked value="1" id="Customer8" ng-click="selectOption('Other9')"/>
               ...
               <div class="show9" style="display:none;">
                  <div class="form-group row">
                     ...
                     <div class="some-class">
                        <!-- Payee options -->
                        <input type="radio" class="radio" name="Payee9" checked value="1" id="Customer9" ng-click="selectOption('Other10')"/>
               ...
               <div class="show10" style="display:none;">
                  <div class="form-group row">
                     ...
                     <div class="some-class">
                        <!-- Payee options -->
                        <input type="radio" class="radio" name="Payee10" checked value="1" id="Customer10" ng-click="selectOption('Other11')"/>
         ...
         <div class="modal-content">
            ...
            <div class="modal-body">
               <div class="form-group row">
                  <label class="col-sm-12 col-form-label">Payer <span style="color:red;">*</span></label>
                  <div class="some-class">
                     <input type="radio" class="radio" name="Payer12" checked value="1" id="Customer12" ng-click="selectOption('Other')"/>
                     ...
                     <input type="radio" class="radio" name="Payer12" value="2" id="Driver12" ng-click="selectOption('Driver')"/>
                     ...
                     <label for="Other12">Others Ledger</label>
                      ...
                      <?php
                     if($customer_id=='23100')
                     {
                        ?>

                        <input type="radio" class="radio" name="Payer12" value="4" id="Bank12" ng-click="selectOption('Bank')"/>
                        <label for="Bank12">Move Bank</label>
               ...
               <div class="form-group row" id="customerview">
                  <label class="col-sm-12 col-form-label">{{lable}} <span style="color:red;">*</span></label>
                  <div class="col-sm-12">
                     <input type="text" class="form-control"  ng-keyup="completeCustomer3()" ng-blur="Getbalance3()" placeholder="Search {{lable}}"  id="customerdata">
                     <br>
               ...
               <div class="row" style="margin: 20px -9px;">
                  <div class="col-md-12">
                     <div class="form-group row">
                        <div class="col-sm-12">
                           <button type="submit" class="btn btn-primary w-md" style="float: right;" id="editSave" ng-click="bankstatementupdate()">Update</button>
                        </div>
                     </div>
                  </div>
               </div>
   ...
   <div class="modal fade" id="firstmodalcommisonparty_new" aria-hidden="true" aria-labelledby="exampleModalToggleLabelset" tabindex="-1">
      <div class="modal-dialog modal-dialog-centered modal-lg">
         <div class="modal-content">
            <div class="modal-header">
               <h5 class="modal-title" id="exampleModalToggleLabelset">Commission view </h5>
               <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
               <h6 id="orderccno"></h6>
               <h6 id="company_name_cc"></h6>
               <div class="form-group row">
                  <div class="some-class1">
                     <input type="radio" class="radio" name="Payer_1" disabled ng-model="party_type1" value="1" id="Customer_1" />
                     <label for="Customer_1">Customer</label>
                     <input type="radio" class="radio" name="Payer_1" disabled ng-model="party_type1" value="3" id="Vendor_1" />
                     <label for="Vendor_1">Vendor</label>
                     <?php
                        if ($this->session->userdata['logged_in']['access'] != '12') {
                        
                          ?>
                     <input type="radio" class="radio" name="Payer_1" disabled ng-model="party_type1" value="2" id="Driver_1" />
                     <label for="Driver_1">Driver</label>
                     <input type="radio" class="radio" name="Payer_1" disabled ng-model="party_type1" value="5" id="Other_1" />
                  ...
                  <div class="col-md-3">
                     <div class="form-group row" >
                        <div class="col-sm-12">
                           <input type="text" id="value1" placeholder="Value" disabled class="form-control sum">
                        </div>
                     </div>
                  </div>
                  <div class="col-md-6">
                     <input type="text" class="form-control border-bottom-input ng-pristine ng-valid ng-touched" ng-blur="Getbalance11()" ng-keyup="completeCustomer11()" disabled placeholder="Search Names"  id="remarks1">
                     <br>
                     <span ng-if="opening_balance11"><b>Avilable Balance : {{opening_balance11 | number}}</b></span>
                  </div>
               </div>
               <div class="form-group row">
                  <div class="some-class1">
                     <input type="radio" class="radio" name="Payer_2" disabled ng-model="party_type2" value="1" id="Customer_2" />
                     <label for="Customer_2">Customer</label>
                     <input type="radio" class="radio" name="Payer_2" disabled ng-model="party_type2" value="3" id="Vendor_2" />
                     <label for="Vendor_2">Vendor</label>
                     <?php
                        if ($this->session->userdata['logged_in']['access'] != '12') {
                        
                          ?>
                     <input type="radio" class="radio" name="Payer_2" disabled ng-model="party_type2" value="2" id="Driver_2" />
                     <label for="Driver_2">Driver</label>
                     <input type="radio" class="radio" name="Payer_2" disabled ng-model="party_type2" value="5" id="Other_2" />
                  ...
                  <div class="col-md-3">
                     <div class="form-group row" >
                        <div class="col-sm-12">
                           <input type="text" id="value2"  disabled placeholder="Value" class="form-control sum">
                        </div>
                     </div>
                  </div>
                  <div class="col-md-6">
                     <input type="text" class="form-control border-bottom-input ng-pristine ng-valid ng-touched" ng-blur="Getbalance222()" ng-keyup="completeCustomer222()" disabled placeholder="Search Names"  id="remarks2">
                     <br>
               ...
               <div class="form-group row">
                  <div class="some-class1">
                     <input type="radio" class="radio" name="Payer_3" disabled ng-model="party_type3"  value="1" id="Customer_3" />
                     <label for="Customer_3">Customer</label>
                     <input type="radio" class="radio" name="Payer_3" disabled ng-model="party_type3" value="3" id="Vendor_3" />
                     <label for="Vendor_3">Vendor</label>
                     <?php
                        if ($this->session->userdata['logged_in']['access'] != '12') {
                        
                          ?>
                     <input type="radio" class="radio" name="Payer_3" disabled ng-model="party_type3" value="2" id="Driver_3" />
                     <label for="Driver_3">Driver</label>
                     <input type="radio" class="radio" name="Payer_3" disabled ng-model="party_type3" value="5" id="Other_3" />
                  ...
                  <div class="col-md-3">
                     <div class="form-group row" >
                        <div class="col-sm-12">
                           <input type="text" id="value3" disabled placeholder="Value" class="form-control sum">
                        </div>
                     </div>
                  </div>
                  <div class="col-md-6">
                     <input type="text" class="form-control border-bottom-input ng-pristine ng-valid ng-touched" ng-blur="Getbalance33()" ng-keyup="completeCustomer33()" disabled placeholder="Search Names"  id="remarks3">
                     <br>
               ...
               <div class="form-group row">
                  <div class="some-class1">
                     <input type="radio" class="radio" name="Payer_4" disabled  ng-model="party_type4" value="1" id="Customer_4" />
                     <label for="Customer_4">Customer</label>
                     <input type="radio" class="radio" name="Payer_4" disabled  ng-model="party_type4" value="3" id="Vendor_4" />
                     <label for="Vendor_4">Vendor</label>
                     <?php
                        if ($this->session->userdata['logged_in']['access'] != '12') {
                        
                          ?>
                     <input type="radio" class="radio" name="Payer_4" disabled ng-model="party_type4" value="2" id="Driver_4" />
                     <label for="Driver_4">Driver</label>
                     <input type="radio" class="radio" name="Payer_4" disabled ng-model="party_type4" value="5" id="Other_4" />
                  ...
                  <div class="col-md-6">
                     <input type="text" class="form-control border-bottom-input ng-pristine ng-valid ng-touched" ng-blur="Getbalance44()" ng-keyup="completeCustomer44()" readonly placeholder="Search Names"  id="remarks4">
                     <br>
               ...
               <input type="checkbox" class="form-check-input" readonly name="consider_gst" value="0" id="formrow-excess-val"> 
               </span>
               <span ng-if="consider_gst==1" style="display:none;">
               <label class="form-check-label" for="formrow-excess-val">Consider GST  &nbsp;&nbsp;</label>
               <input type="checkbox" class="form-check-input" readonly checked name="consider_gst" value="1" id="formrow-excess-val"> 
               </span>
               <?php
                  $readonly = "";
   ...
   <script>
      $(document).ready(function () {
        ...
        function generateCustomerProfiles() {
            var customerProfiles = <?php echo json_encode($customer_link); ?>;
            console.log(customerProfiles);
            var content = '<ul class="list-group popoverlink" style="max-height: 100px; overflow-y: auto;" >';

            customerProfiles.forEach(function (customer) {
                var link = '<a href="' + getCustomerProfileLink(customer.id) + '" class="list-group-item" target="_blank">' + customer.name + '</a>';
                content += link;
            });
        ...
        function getCustomerProfileLink(customerId) {
            // Replace this with your logic to generate the customer profile links
            return 'ledger_find?customer_id=' + customerId;
        }
      ...
      $('#exportdata').on('click', function() {
          ...
          url = '<?php echo base_url() ?>index.php/customer/fetch_data_get_ledger_view_export?limit=10&deleteid=0&customer_id='+id+'&formdate='+fromdate+'&todate='+fromto+'&payment_status='+payment_status+'&filter='+filter+'&cnn_status='+cnn_status;
...
$scope.exportToExcel = function () {
                ...
                $("#datatable").table2excel({
                    filename: "customer_balance_report_"+date+".xls"
                });
 };
          ...
          $('#firstmodalcommisonparty_new').modal('toggle');
            ...
            data:{'id':l_id, 'action':'fetch_single_data','tablename':'all_ledgers'}
                 ...
                 $scope.party_type1=data.party_type1;
                  ...
                  $('#orderccno').html(data.order_no);
                  $('#company_name_cc').html(data.company_name_cc);
      ...
      $scope.onviewparty_edit = function(l_id,id,name,dc,cc,d_cid,d_cname,d_party_type,d_amount)
      {
        ...
        var amount=0;
          ...
          if(d_cid>0)
          {
              ...
              $('#party1').val(id+'-'+name);
              $("input[name='Payer1'][value='" + 1 + "']").attr("checked", "checked");
                              ...
                              data:{'notes':notes,'discountamount':discountamount,'payment_date':payment_date,'account_head_id':$scope.account_head_id,'enteramount':enteramount,'payment_type':payment_type,'bankaccount':bankaccount,'writeoff':writeoff,'customer_id':customer_id,'payamount':payamount,'payment_mode_payoff':payment_mode_payoff,'reference_no':reference_no}
                                 ...
                                 $('#firstmodalcommison').modal('toggle');
                                     ...
                                     $('#bankaccount').val('');
                                      ...
                                      $http.get('<?php echo base_url() ?>/customer_balance_cron.php?customer_id='+customer_id).success(function(datass){});
                                      $http.get('<?php echo base_url() ?>/customer_yes_or_no_report.php?customer_id='+customer_id).success(function(datass){});
                           ...
                           {       
                              ...
                              $('#notes_r').val('');
                                     ...
                                     if(customer_id1>0)
                                     {
                                        ...
                                        //$http.get('<?php echo base_url() ?>/customer_balance_cron.php?customer_id='+customer_id1).success(function(datass){});
                                      ...
                                      if(customer_id2>0)
                                     {
                                        ...
                                        //$http.get('<?php echo base_url() ?>/customer_balance_cron.php?customer_id='+customer_id2).success(function(datass){});
     ...
     if($_GET['test'] && $_GET['test'] == 'true'){
          ...
          $retUrl = 'fetch_data_get_ledger_view?test=true&';
          // $ledUrl = 'ledger_find?test=true&';

     }else{

          $retUrl = 'fetch_data_get_ledger_view?';
          // $ledUrl = 'ledger_find?';

     }

    ?>
          $http.get('<?php echo base_url() ?>index.php/customer/<?=$retUrl?>limit=10&deleteid=0&customer_id='+id+'&formdate='+fromdate+'&todate='+fromto+'&payment_status='+payment_status+'&filter='+filter+'&cnn_status='+cnn_status).success(function(data){
    ...
    ?>
      ...
      $scope.fetchDatagetlegderGroupTotal = function(id,fromdate,fromto,payment_status){
          ...
          $http.get('<?php echo base_url() ?>/customer_balance_cron.php?customer_id='+id).success(function(datass){});
          $http.get('<?php echo base_url() ?>/customer_yes_or_no_report.php?customer_id='+id).success(function(datass){});
...
<?php
 if($_GET['test'] && $_GET['test'] == 'true'){
          ...
          $retUrl2 = 'fetch_data_get_ledger_view_total?test=true&';
          // $ledUrl = 'ledger_find?test=true&';

     }else{

          $retUrl2 = 'fetch_data_get_ledger_view_total?';
          // $ledUrl = 'ledger_find?';

     }

     ?>
          $http.get('<?php echo base_url() ?>index.php/customer/<?=$retUrl2?>limit=10&deleteid=0&customer_id='+id+'&formdate='+fromdate+'&todate='+fromto+'&payment_status='+payment_status+'&filter='+filter+'&cnn_status='+cnn_status).success(function(data){
              ...
              data:{'id':id, 'action':'Delete','tablename':'all_ledgers'}
                  ...
                  var party_type= $('#party_type').val();
                   ...
                   $scope.fetchDatagetlegderGroup(userid,fromdate,fromto,payment_status,party_type);
                    ...
                    $http.get('<?php echo base_url() ?>/customer_balance_cron.php?customer_id='+userid).success(function(datass){});

...
<body data-layout="horizontal" class="full-vh-overflow-hide" data-topbar="dark" ng-app="crudApp" ng-controller="crudController">
               ...
               <div class="row">
                  <div class="col-12">
                     <div class="page-title-box d-sm-flex align-items-center justify-content-between pb-2">
                        <h4 class="mb-sm-0 font-size-14">Customer ledger</h4>
                              ...
                              <div class="col-lg-12" >
                                 <form>
                                    <div class="row">
                                       ...
                                       <div class="col">
                                          ...
                                          <a href="<?php echo base_url(); ?>index.php/customer/ledger_find_delete_log?customer_id={{customer_id_data}}" target="_blank">Delete Log</a>
                                       </div>
                                    </div>
                                 </form>
                                    ...
                                    <div class="col-xl-3 col-md-3">
                                       ...
                                       <div class="card shadow-none card-h-50 mb-0">
                                          ...
                                          <div class="card-body">
                                             <div class="d-flex align-items-center">
                                                <div class="flex-grow-1">
                                                   <h3 class="text-muted mb-1 font-size-14 lh-1 d-block text-truncate"><?php echo $Total_Debit_text; ?> <span>{{totaldebit | number}}</span></h3>
                                                </div>
                                             </div>
                                          </div>
                                          <!-- end card body -->
                                    ...
                                    <div class="col-xl-3 col-md-3">
                                       ...
                                       <div class="card shadow-none card-h-50 mb-0">
                                          ...
                                          <div class="card-body">
                                             <div class="d-flex align-items-center">
                                                <div class="flex-grow-1">
                                                   <h3 class="text-muted mb-1 font-size-14 lh-1 d-block text-truncate">Total Credit : {{totalcridit | number}}</h3>
                                                </div>
                                             </div>
                                          </div>
                                          <!-- end card body -->
                                 ...
                                 <div id="search-view" >
                                    <div   ng-init="fetchSingleData('<?php echo $customer_id; ?>')">
                                       <h4 class="card-title"><a href="<?php echo base_url(); ?>index.php/customer/ledger_find?customer_id=<?php echo $customer_id; ?>">{{name}} - {{phone}}</a></h4>
                                       ...
                                       <tbody  ng-repeat="names in namesDataledgergroup | filter:query" >
                                          <tr  class="trpoint {{names.addclass}}" ng-if="names.no!='#'">
                                             ...
                                             <td style="display: flex;">
                                               ...
                                               <!--  <button type="button" ng-click="editData(names.id)" ng-if="names.edit_status==1" class="btn btn-outline-danger btn-sm"><i class="mdi mdi-pencil menu-icon"></i></button> -->
   ...
   <script>
      ...
      $('#exportdata').on('click', function() {
          ...
          url = '<?php echo base_url() ?>index.php/customer/fetch_data_get_ledger_view_export?limit=10&deleteid=0&customer_id='+id+'&formdate='+fromdate+'&todate='+fromto+'&payment_status='+payment_status+'&filter='+filter;
   ...
   <script>
      ...
      $scope.fetchDatagetlegderGroup = function(id,fromdate,fromto,payment_status){
          ...
          var filter= $('#filter').val();
          var payment_status= $('#payment_status').val();
          $http.get('<?php echo base_url() ?>index.php/customer/fetch_data_get_ledger_view?limit=10&deleteid=0&customer_id='+id+'&formdate='+fromdate+'&todate='+fromto+'&payment_status='+payment_status+'&filter='+filter).success(function(data){
      ...
      $scope.fetchDatagetlegderGroupTotal = function(id,fromdate,fromto,payment_status){
          ...
          var payment_status= $('#payment_status').val();
          $http.get('<?php echo base_url() ?>index.php/customer/fetch_data_get_ledger_view_total?limit=10&deleteid=0&customer_id='+id+'&formdate='+fromdate+'&todate='+fromto+'&payment_status='+payment_status+'&filter='+filter).success(function(data){

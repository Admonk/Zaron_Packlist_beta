                            ...
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                ...
                                <div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        ...
                                        <li class="breadcrumb-item active">Sale Regular - Irregular Orders Report</li>
                                    </ol>
                                </div>
                                ...
                                <div class="row" style="margin: 13px 0px;">
                                    <div class="col-6 mb-2">
                                        <div class="page-title-box d-sm-flex align-items-center justify-content-between p-0">
                                            <h4 class="mb-sm-0 font-size-18">Sale Regular - Irregular Orders Report ({{selectedCustomer}})</h4>
                                        </div>
                                    </div>
                                    <div class="col-lg-12">
                                        <form>
        ...
        app.controller('crudController', function($scope, $http) {
           ...
           $scope.fetchSalesProductReportDataExport = function() {
            ...
            $scope.fetchSalesProductDetailReportData = function(brand) {
                ...
                var fromto = $('#to-date').val();
                var customer_id = encodeURIComponent('<?= $_GET['customer_id'] ?>');
                $http.get('<?php echo base_url() ?>index.php/other_reports/fetch_data_regular_irregular_orders_report?limit=10&formdate=' + fromdate + '&todate=' + fromto + '&customer_id=' + customer_id  ).success(function(data) {
                    $scope.query = {}
                    $scope.queryBy = '$';

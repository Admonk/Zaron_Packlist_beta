            ...
            <div class="col-12">
              <div class="page-title-box d-sm-flex align-items-center mt-3 justify-content-between">
                <h4 class="mb-sm-0 font-size-18">
                  ...
                  Recent Ledger Transaction - Round Off
                ...
                <div class="page-title-right">
                  <ol class="breadcrumb m-0">
                    ...
                    <li class="breadcrumb-item active">Recent Ledger Transaction - Round Off</li>
                  </ol>
                </div>
                                ...
                                <div class="d-flex align-items-center">
                                  <div class="flex-grow-1">
                                    ...
                                    <h3 class="text-muted mb-1 font-size-14 lh-1 d-block text-truncate">
                                      <span ng-if="getstatus==1" style="color:red">{{balance | indianCurrency}}</span>
                                      <span ng-if="getstatus==0" style="color:green">{{balance | indianCurrency}}</span>
                                    </h3>
                              ...
                              <div class="card-body">
                                <div class="d-flex align-items-center">
                                  <div class="flex-grow-1">
                                    ...
                                    <h4 class="mb-3">
                                      <span>{{totaldebit | indianCurrency}}</span>
                                    </h4>
                              ...
                              <div class="card-body">
                                <div class="d-flex align-items-center">
                                  <div class="flex-grow-1">
                                    ...
                                    <h3 class="text-muted mb-1 font-size-14 lh-1 d-block text-truncate">
                                      <span>{{ closing_bl | indianCurrency }}</span>
                            ...
                            <tbody ng-repeat="names in namesDataledgergroup | filter:query">
                              ...
                              <tr class="trpoint {{names.addclass}}">
                                ...
                                ?>
                                  ...
                                  <td>{{names.credits | indianCurrency}}</td>

                                  <td>{{names.debits | indianCurrency}}</td>
  ...
  <script>
    ...
    app.controller('crudController', function($scope, $http) {
      ...
      $scope.saveTransfer = function(bankaccount, notes, selectcollection_id_data, selectcollection_id_data_table, create_date) {
        ...
        $http({
          ...
          data: {
            ...
            'selectcollection_id_data': selectcollection_id_data,
            'selectcollection_id_data_table': selectcollection_id_data_table,
      ...
      $scope.bankstatementupdate = function() {
        ...
        $http({
          ...
          data: {
            ...
            'bankaccount': bankaccount,
            'payment_mode_payoff': payment_mode_payoff,
            'party_type_data': party_type_data,
            'id': $scope.hidden_id,
            'debit': $scope.debit,
            'notes': notes,
            'create_date': new Date($scope.create_date)
          }
        }).success(function(data) {
      ...
      $scope.fetchDatagetlegderGroup = function(id, fromdate, fromto, payment_status, party_type) {
        ...
        $http.get('<?php echo base_url() ?>index.php/report/fetch_data_get_ledger_view_all_base_by?limit=10&deleteid=0&accountshead=' + id + '&formdate=' + fromdate + '&todate=' + fromto + '&party_type=' + party_type + '&payment_status=' + payment_status).success(function(data) {

                            ...
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                ...
                                <div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        ...
                                        <li class="breadcrumb-item active">Customer CNN Report</li>
                                    </ol>
                                </div>
                                ...
                                <div class="row" style="margin: 13px 0px;">
                                    <div class="col-6 mb-2">
                                        <div class="page-title-box d-sm-flex align-items-center justify-content-between p-0">
                                            <h4 class="mb-sm-0 font-size-18">Customer CNN Report</h4>
                                        </div>
                                    </div>
                                    <div class="col-lg-12">
                                        <form>
                                            <div class="row">
                                                ...
                                                <label class="col-sm-12 col-form-label">From Date</label>
                                                    <input type="date" class="form-control" id="from-date" value="<?php echo $_GET['formdate'] != '' ? $_GET['formdate'] : date('Y-m-01'); ?>">
                                                </div>
                                                <div class="col">
                                                        ...
                                                        <div class="table-responsive table-container" style="height: 700px;" ng-init="fetchSalesProductDetailReportData(0,0)">
                                                            <table class="main" style="width:100%">
                                                                ...
                                                                <thead style="position: sticky;top: 0px;">
                                                                    ...
                                                                    <tr>
                                                                        <th colspan="2" style="text-align: end">Totals :&nbsp;&nbsp;</th>
                                                                        <th>{{credits ? (credits | number) : 0}}</th>
                                                                    </tr>
                                                                </thead>
                                                                <tbody>
                                                                    <tr ng-repeat="(index, row) in salesDataDetail">
                                                                        ...
                                                                        <td class="text-end">{{row.credits ? (row.credits | number) : 0}}</td>
                                                                    </tr>
                                                                </tbody>
        ...
        app.controller('crudController', function($scope, $http) {
           ...
           $scope.fetchSalesProductReportDataExport = function() {
            ...
            $scope.fetchSalesProductDetailReportData = function(brand) {
                ...
                var fromto = $('#to-date').val();
                var customer_id = encodeURIComponent('<?= $_GET['customer_id'] ?>');
                $http.get('<?php echo base_url() ?>index.php/other_reports/fetch_data_customer_cnn_report?limit=10&formdate=' + fromdate + '&todate=' + fromto + '&customer_id=' + customer_id  ).success(function(data) {
                    $scope.query = {}
                    $scope.queryBy = '$';

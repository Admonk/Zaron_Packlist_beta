...
?>
  ...
  <a href="<?php echo base_url(); ?>index.php/group/menu_permission_user?user_id={{name.id}}&user_name={{name.name}}" target="_blank" class="btn btn-outline-success">Menu Permission</a>

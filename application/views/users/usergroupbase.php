                      ...
                      {  
                          ...
                          ?>
                                   ...
                                   <div class="col-sm-6 col-lg-4" >
                                       ...
                                       {
                                           ?>
                                            <a href="<?php echo base_url(); ?>index.php/salesteamsub/sales_team_sub_list">
                                           <?php
                                       }
                                       elseif($value->id==12)
                                       {
                                           ?>
                                            <a href="<?php echo base_url(); ?>index.php/salesteam/sales_team_list">
                                           <?php
                                       }
                                       elseif($value->id==13)
                                       {
                                           ?>
                                            <a href="<?php echo base_url(); ?>index.php/driver/driverview">
                                           <?php
                                       }
                                       else
                                       {

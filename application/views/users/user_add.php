 ...
 <h4 class="card-title mt-3">Contact Details </h4>
                       ...
                       <div class="row">
                        ...
                        <div class="col-md-6">
                          <div class="form-group row">
                            ...
                            <div class="col-sm-12">
                              <input id="phone" class="form-control caps" name="phone" required ng-model="phone" type="number">
                            </div>
                          </div>
                        </div>
                      ...
                      ?>
                          ...
                          <div class="form-group row">
                            ...
                            {
                                ?>
                                <select class="form-control caps"  ng-init="customer_group=<?php echo $sd; ?>" name="customer_group" id="customer_group"  required ng-model="customer_group">
                      ...
                      <div class="row <?php echo $na; ?>"  id="showslaesgroup">
                          ...
                          <div class="form-group row">
                            ...
                            <div class="col-sm-12">
                             <select class="form-control caps" id="choices-multiple-default"  data-trigger  
                     ...
                     <div class="row">
                       ...
                       <div class="col-md-4">
                          <div class="form-group row">
                            ...
                            <div class="col-sm-12">
                             <select class="form-control caps" ng-init="status=1" name="status" required ng-model="status" >

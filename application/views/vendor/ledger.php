                                    ...
                                    <div class="card-body">
                                        <div class="d-flex align-items-center">
                                            <div class="flex-grow-1">
                                                <h3 class="text-muted mb-1 font-size-14 lh-1 d-block text-truncate"> Total DR : <span >{{totaldebit | number}}</span></h3>
                                            </div>
                            ...
                            <div class="col-xl-2 col-md-2">
                                ...
                                <div class="card shadow-none card-h-50 mb-0">
                                    ...
                                    <div class="card-body">
                                        <div class="d-flex align-items-center">
                                            <div class="flex-grow-1">
                                                <h3 class="text-muted mb-1 font-size-14 lh-1 d-block text-truncate"> Total CR : <span >{{totalcridit | number}}</span></h3>
                                            </div>
                                             </div>
                                    </div><!-- end card body -->
                                </div><!-- end card -->
                   ...
                   <table id="datatable"  class="table table-striped table-bordered" style="position: relative;" width="100%" ng-init="fetchDatagetlegderGroup(0)" >
                      <thead>
                        ...
                        <tr  class="trpoint {{names.done_set}}" >
                           ...
                           <td>{{names.no}}</td>
                           <td><a href="<?php echo base_url(); ?>index.php/vendor/ledger_find?customer_id={{names.customer_id}}&from_date={{fromdate}}&to_date={{todate}}&trail_balance=<?php echo $trail_balance; ?>" target="_blank">{{names.name}}</a></td>
                          
                          <td >

                            <span ng-if="names.opening_balance>0">
                            <a href="<?php echo base_url(); ?>index.php/vendor/ledger_find?customer_id={{names.customer_id}}&from_date={{fromdate}}&to_date={{todate}}&trail_balance=<?php echo $trail_balance; ?>" target="_blank"><span ng-if="names.opening_balance!=0">{{names.opening_balance | number}} {{names.payment_status}}</span></a>
                            </span>

                                 
                          </td>
                          
                          <td ><a href="<?php echo base_url(); ?>index.php/vendor/ledger_find?customer_id={{names.customer_id}}&from_date={{fromdate}}&to_date={{todate}}&trail_balance=<?php echo $trail_balance; ?>" target="_blank"><span ng-if="names.debits!=0">{{names.debits | number}}</span></a></td>
                           <td ><a href="<?php echo base_url(); ?>index.php/vendor/ledger_find?customer_id={{names.customer_id}}&from_date={{fromdate}}&to_date={{todate}}&trail_balance=<?php echo $trail_balance; ?>" target="_blank"><span ng-if="names.credits!=0">{{names.credits | number}}</span></a></td>
                           <td >
                               
                                
                                <span ng-if="names.balance>0">
                                 <a href="<?php echo base_url(); ?>index.php/vendor/ledger_find?customer_id={{names.customer_id}}&from_date={{fromdate}}&to_date={{todate}}&trail_balance=<?php echo $trail_balance; ?>" target="_blank"> 
...
$scope.loading = true;
    ...
    $http.get('<?php echo base_url() ?>index.php/vendor/fetch_data_get_ledger_view_group?limit=10&trail_balance='+trail_balance+'&customer_id='+id+'&formdate='+fromdate+'&todate='+fromto+'&payment_status='+payment_status).success(function(data){
...
$scope.fetchDatagetlegderGroupTotal = function(id,fromdate,fromto,payment_status){
    ...
    $http.get('<?php echo base_url() ?>index.php/vendor/fetch_data_get_ledger_view_total?limit=10&trail_balance='+trail_balance+'&customer_id='+id+'&formdate='+fromdate+'&todate='+fromto+'&payment_status='+payment_status).success(function(data){

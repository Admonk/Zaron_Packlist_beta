                                          ...
                                          <tbody  ng-repeat="names in namesDataledgergroup | filter:query" >
                                             <tr  class="trpoint {{names.addclass}}" ng-if="names.no!='#'">
                                                ...
                                                <td style="display: contents;">
                                                   ...
                                                   <a href="<?php echo base_url(); ?>index.php/journal/edit?id={{names.id}}&deletemod={{names.deletemod}}"  
                                                      target="_blank"><i class="mdi mdi-pencil menu-icon" style="color: red;"></i>
                                                   </a>
                                                   </button>
                                                   
                                                   <!-- <button type="button" ng-if="names.edit_status==1" ng-click="editData(names.id)" class="btn btn-outline-danger btn-sm"><i class="mdi mdi-pencil menu-icon"></i></button> -->

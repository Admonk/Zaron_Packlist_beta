                                    ...
                                    <div class="row">
                                       ...
                                       <div class="col">
                                            <?php
                                               ...
                                               ?>
                                                <input type="date" class="form-control" id="from-date" min="<?php echo date('2024-01-01'); ?>" value="<?php echo $from_date; ?>">
                                       </div>
                                       <div class="col">
                                          <input type="date" class="form-control" id="to-date" min="<?php echo date('2024-01-01'); ?>" value="<?php echo $to_date; ?>">
                                       </div>
                                          ...
                                          <tbody  ng-repeat="names in namesDataledgergroup | filter:query" >
                                             <tr  class="trpoint {{names.addclass}}" ng-if="names.no!='#'">
                                                ...
                                                <button type="button" class="btn btn-outline-danger btn-sm" ng-if="names.process_by == 'Voucher'">
                                                   ...
                                                   <button type="button" ng-if="names.process_by!='Voucher' && names.edit_status==1" ng-click="editData(names.id)" class="btn btn-outline-danger btn-sm"><i class="mdi mdi-pencil menu-icon"></i></button>
   ...
   <script>
      ...
      $('#payment_date').blur(function() 
      {
          ...
          var date = $(this).val();
             ...
             var valdationdate='<?php echo date("Y-01-01"); ?>';
   ...
   var id= '<?php echo $customer_id; ?>';
     ...
     if(trail_balance==1)
     {
       var fromdate= $('#from-date').val();
         ...
         $http.get('<?php echo base_url() ?>index.php/vendor/fetch_data_get_ledger_view_total?limit=10&deleteid=0&customer_id='+id+'&formdate='+fromdate+'&todate='+fromto+'&payment_status='+payment_status+'&party_type='+party_type).success(function(data){

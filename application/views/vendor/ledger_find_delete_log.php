                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    <h4 class="mb-sm-0 font-size-18">Vendor ledger Delete Log</h4>

                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                             <li class="breadcrumb-item"><a href="<?php echo base_url(); ?>index.php/dashboard">Dashboard</a></li>
                                            <li class="breadcrumb-item active">Vendor ledger Delete Log!</li>
                                        </ol>
                                    </div>
...
$('#exportdata').on('click', function() {
    ...
    url = '<?php echo base_url() ?>index.php/vendor/fetch_data_get_ledger_view_export?limit=10&deleteid=1&customer_id='+id+'&formdate='+fromdate+'&todate='+fromto+'&payment_status='+payment_status;
...
$scope.fetchDatagetlegderGroup = function(id,fromdate,fromto,payment_status){
  ...
  var fromdate= $('#from-date').val();
    ...
    $http.get('<?php echo base_url() ?>index.php/vendor/fetch_data_get_ledger_view?limit=10&deleteid=1&customer_id='+id+'&formdate='+fromdate+'&todate='+fromto+'&payment_status='+payment_status).success(function(data){
...
$scope.Getbalance3 = function () {
        ...
        var party=  $('#customerdata').val();
           ...
           $http({
		      ...
		      data:{'id':party, 'action':'fetch_single_data','tablename':'3'}
		    }).success(function(data){
...
$scope.fetchDatagetlegderGroupTotal = function(id,fromdate,fromto,payment_status){
    ...
    var payment_status= $('#payment_status').val();
   $http.get('<?php echo base_url() ?>index.php/vendor/fetch_data_get_ledger_view_total?limit=10&deleteid=1&customer_id='+id+'&formdate='+fromdate+'&todate='+fromto+'&payment_status='+payment_status).success(function(data){

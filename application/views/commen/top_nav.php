                       ...
                       <nav class="navbar navbar-light navbar-expand-lg topnav-menu">
                           <div class="collapse navbar-collapse" id="topnav-menu-content">
                              <ul class="navbar-nav">
                                 ...
                                 $result_check=$this->db->query("SELECT b.* FROM `menu_primary_save_user` as a JOIN menu_group as b ON a.sub_menu_id=b.id WHERE  a.user_id='".$this->session->userdata['logged_in']['userid']."' AND b.deleteid='0' ORDER BY b.sort_order  ASC");
                                 ...
                                 if(count($result_check)==0)
                                 {
                                     ...
                                     $result_check=$this->db->query("SELECT b.* FROM `menu_primary_save` as a JOIN menu_group as b ON a.sub_menu_id=b.id WHERE  a.group_id='".$this->session->userdata['logged_in']['access']."'  AND b.deleteid='0' ORDER BY b.sort_order  ASC");
                                     $result_check=$result_check->result();
                                     ...
                                     foreach($result_sub_check as $svalue)
                                     {
                                        if($svalue->menu_group_id==$pvalue->id) 
                                        {
                                            ...
                                            if($this->session->userdata['logged_in']['access']=='31') 
                                            {
                                                 if($svalue->id==18)
                                                 {
                                                    $svalue->sub_menu='Order Requested to Zaron';
                                                 }
                                            }
                                                               ...
                                                               <?php 
                                                                ...
                                                                ?>
                                                                 ...
                                                                 <a class="dropdown-item" href="<?php echo base_url(); ?>index.php/customer/customer_list">Customer List</a>
                                                                  ...
                                                                  <a class="dropdown-item" href="<?php echo base_url(); ?>index.php/customer/commen_list">Common List</a>

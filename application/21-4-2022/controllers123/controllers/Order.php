		...
		public function ordercreate_product()
	{
									    ...
									    if(isset($this->session->userdata['logged_in']))
							            {
							            	 ...
							            	 else
							            	 {
							            	      ...
							            	      $data['order_id']=$neworder_id;
							            	      $data['order_no']=$this->sales_id.'/E'.$neworder_id.'/'.date('Y');
		...
		public function ordercreate_product_quotation()
	{
									    ...
									    if(isset($this->session->userdata['logged_in']))
							            {
							            	 ...
							            	 else
							            	 {
							            	      ...
							            	      $data['order_id']=$neworder_id;
							            	      $data['order_no']=$this->sales_id.'/Q'.$neworder_id.'/'.date('Y');
									    ...
									    if(isset($this->session->userdata['logged_in']))
							            {
							            	...
							            	if($this->session->userdata['logged_in']['access']=='11')
							            	 ...
							            	 else
							            	 {
							            	      ...
							            	      $data['order_id']=$neworder_id;
							            	      $data['order_no']=$this->sales_id.'/O'.$neworder_id.'/'.date('Y');
                                                                ...
                                                                {  
                                                                    ...
                                                                    else
                                                                    {
                                                                      ...
                                                                      {   
                                                                          ...
                                                                          $data_address['balance']=$Totalbal-$collectamount;
                                                                      }
                                                                      else
                                                                      {   
                                                                          $data_address['balance']=round($totalamount)-$collectamount;
                                                                      }

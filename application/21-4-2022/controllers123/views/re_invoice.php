...
<form action="#" id="add_appointment">
    ...
    { 
       ...
       $customer_name_id= $views->customer_name;
...
if($views->payment_mode=='3')
{
    ...
    foreach($customer as $sview)
    {
        if($retail_store_id==$sview->id)
        {
            
        
       $customer_name= $sview->name;
       $customer_phone= $sview->phone;
       $customer_email= $sview->email;
       $customer_address= $sview->address;
       $delivery_address= $sview->delivery_address;
       
        }
    }
    
    
     foreach($executive_list as $eview)
    {
        if($execute_name_id==$eview->id)
        {
            
        
           $executive_name= $eview->name;
    ...
    <tr>
      ...
      <div class="paddingset">
             ...
             <div class="paddingset">
                        ...
                        <p>Order : Retail Order </p>
                        <p><b>Distributor Name :</b> <?php echo $executive_name; ?></p>

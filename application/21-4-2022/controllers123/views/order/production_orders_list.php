                                                              ...
                                                              <table class="table align-middle table-nowrap newBorderedTable" datatable="ng" dt-options="vm.dtOptions">
                                                                  ...
                                                                  <tbody>
                                                                      ...
                                                                      <tr  ng-repeat="name in namesData">
                                                                          ...
                                                                          <td><a href="<?php echo base_url(); ?>index.php/order/production?order_id={{name.base_id}}" >{{name.order_no}}</a></td>
                                                                          <td>{{name.name}}</td>
                                                                          <td>
                                                                             {{name.phone}}
                                                                          </td>
                                                                          ...
                                                                          <td>
                                                                              ...
                                                                              <span ng-if="name.order_base==0">
                                                                                  ...
                                                                                  <p style="color:red;margin:0;">Production Not Assiend</p>
                                                                          ...
                                                                          <td>
                                                                                     ...
                                                                                     <a href="<?php echo base_url(); ?>index.php/order/production?order_id={{name.base_id}}" ><i class="mdi mdi-eye font-size-16 text-success me-1"></i> View</a>

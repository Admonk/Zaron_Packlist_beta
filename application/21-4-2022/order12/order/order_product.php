                                                                           ...
                                                                           <form  ng-submit="submitSizeguid()" method="post">
                                                                             ...
                                                                             <div class="container row">
                                                                                ...
                                                                                <div class="col-md-12 mt-4">
                                                                                       ...
                                                                                       <input type="text" class="form-control"  id="enterlengthval" ng-keyup="sizedefindbylayoutInputlength()"  placeholder="Enter Length">
                                                                                       ...
                                                                                       <input type="text" class="form-control" placeholder="0,1" ng-keyup="sizedefindbylayoutInputbaseno()"  id="enthernobase" >
                                                                                      ...
                                                                                      <span ng-init="fetchDatasizeoptionsoninput()" class="set-padding showhide" >
                                                                                         
                                                                                       <div class="row mt-4" ng-repeat="nameoptioninput in namesDataoptonsinput">  
                                       ...
                                       <tbody  ng-repeat="name in namesData|orderBy:column:reverse" ng-if="namecate.categories_id==1">
                                          ...
                                          <tr  ng-style="name.rate_edit == 1 && {'color':'red'}"    class="view" ng-if="namecate.categories_id==name.categories_id_get && namecate.type==name.type">
                                            ...
                                            <input type="hidden"  value="{{name.product_id}}"  id="ppid_{{name.id}}">
                                             ...
                                             <td data-label="Nos"><input type="text"  ng-keyup="inputsave_1(name.id,'nos',namecate.categories_id,namecate.type)" class="nos_{{namecate.categories_id}}" id="nos_{{name.id}}" value="{{name.nos_tab}}"></td>
...
$scope.sizedefind = function(id,product_id,cateid,profile_val,base_id){
       ...
       $(window).scrollTop(0);
        ...
        $scope.fetchDatasizeoptionsoninput(30,base_id,id);
        ...
        var order_product_id=  $('#product_id_base_define').val();
               ...
               $http({
                              method:"POST",
                                ...
                                $scope.fetchDatasizeoptionsoninput(length,base_no,order_product_id);
               });

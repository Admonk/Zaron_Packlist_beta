                                             ...
                                             <div class="card-header align-items-start d-flex p-3">
                                                <div class="flex-shrink-0">
                                                   <ul class="nav justify-content-end nav-tabs-custom rounded card-header-tabs" role="tablist" ng-init="getcount('orders')">
                                                      ...
                                                      <li class="nav-item">
                                                         <a class="nav-link active" data-bs-toggle="tab" href="#messages2" role="tab" ng-click="pageTab('orders',4)">
                                                         <span class="d-block d-sm-none"><i class="far fa-envelope"></i></span>
                                                         <span class="d-none d-sm-block">Request Enquiry Order <span class="badge rounded-pill bg-warning  float-end"> {{purchase_team}} </span></span>   
                                                         </a>
                                                      </li>
                                                       ...
                                                       <li class="nav-item">
                                                         ...
                                                         <span class="d-block d-sm-none"><i class="far fa-envelope"></i></span>
                                                         <span class="d-none d-sm-block">Request Enquiry Price TO MD<span class="badge rounded-pill bg-danger  float-end"> {{md_team}} </span></span>   
                                                         </a>
                                                      </li>
                                              ...
                                              <div class="col-12">
                                                  <div class="card shadow-none">
                                                      <div class="card-body">
                                                          ...
                                                          <div class="table-responsive" ng-init="fetchData('orders',4)">
                                                              <table class="table align-middle table-nowrap newBorderedTable" datatable="ng" dt-options="vm.dtOptions">
                                                                  ...
                                                                  <tbody>
                                                                      ...
                                                                      <tr  ng-repeat="name in namesData">
                                                                          ...
                                                                          <td><a href="<?php echo base_url(); ?>index.php/order/enquiry_product_process_purchase_verification?order_id={{name.base_id}}">{{name.order_no}}</a></td>
                                                                          <td>{{name.name}}</td>
                                                                          <td>{{name.phone}} </td>

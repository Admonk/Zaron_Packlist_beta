...
class Order extends CI_Controller {
		...
		public function ordercreate_product()
	{
									    ...
									    if(isset($this->session->userdata['logged_in']))
							            {
							            	 ...
							            	 if(count($resorder)>0)
							            	 {
							            	     ...
							            	     $resultmain=$this->db->query("SELECT * FROM $tablename  WHERE id='".$neworder_id."' AND user_id='".$this->userid."'");
	...
	{         
                                                                 ...
                                                                 $resultmain=$this->db->query("SELECT * FROM $tablename  WHERE id='".$form_data->order_id."' AND user_id='".$this->userid."'");
                                                                 $resultcs=$resultmain->result();
                                                                 if(count($resultcs)>0)
                                                                 {
	          ...
	          $route_id= $_GET['route_id'];
	                $array=array();
    	               ...
    	               if($route_id!=0)
    	                ...
    	                $result=  $this->db->query("SELECT c.name as route_name,a.vehicle_number as vehicle_number,b.phone as driver_phone,b.name as driver_name,a.id as vehicle_id FROM vehicle as a JOIN driver as b ON a.id=b.vehicle_id JOIN route as c ON c.id=a.route_id WHERE   a.deleteid=0 AND b.deleteid=0  $sql ORDER BY a.id ASC");
                         ...
                         foreach ($results as  $valuep) {
                            ...
                            if($value->payment_image!="")
                             ...
                             $array[] = array(
                                    ...
                                    'fulltotalamount' => $totalamount+$value->delivery_charge,
                                    'totalkm'=>$totalkm
	  ...
	  public function cash_mode()
    {
                    ...
                    $result=$result->result();
                     ...
                     foreach ($result as  $value) {
                             ...
                             $denomination_total=50*$value->c50rs+100*$value->c100rs+200*$value->c200rs+500*$value->c500rs+2000*$value->c2000rs;
                 	 ...
                 	 foreach ($result as  $value) {
                 	      ...
                 	      $paricel_mode= $value->paricel_mode;
                         	 ...
                         	 foreach ($resulttotal as  $tot) {
                         	         ...
                         	         $totalamount_total+=$tot->amount+$tot->commission+$delivery_charge;
                         	         $commission_total+=$tot->commission;
                         	        
                         	        
                         	         $totalamountparciel+=$tot->rate*$tot->modify_qty+$tot->commission+$delivery_charge;
                         	 ...
                         	 if($paricel_mode==0)
                         	 {
                         	    $totalamount= round($totalamount_total);
                         	 ...
                         	 if($paricel_mode==1)
                         	 {
                         	     $totalamount= round($totalamountparciel);
                                            			       ...
                                            			       foreach($result_order as $val)
                                            			       {
                                                                ...
                                                                { 
                                                                    ...
                                                                    if($customer_paid==1)
                                                                    {
                                                                         ...
                                                                         $data_address['credits']=$collectamount; 
                                                                ...
                                                                else
                                                                {
                                                                    ...
                                                                    if($customer_paid==1)
                                                                    {
                                                                           ...
                                                                           $data_address['balance']=$balancetotal-round($totalamount);
                                                                ...
                                                                $data_address['balance']=str_replace('-','', $data_address['balance']);
                                                                ...
                                                                if($customer_paid==1)
                                                                {
                                                                                 ...
                                                                                 foreach($res as $val)
                                                                                 {
                                                                                  ...
                                                                                  $bank_name="";
                                                                                  $bid="";
                                                                                  if($bankaccount_customer!='0')
                                                                                  {
                                                                                      
                                                                                      
                                                                                    
                                                                                      
                                                                                            $resbankaccount = $this->Main_model->where_names('bankaccount','id',$bankaccount_customer);
                                                                                            ...
                                                                                            $data_bank['debit']=0;
                                                                                            $data_bank['credit']=round($totalamount);
                                                                                            $data_bank['name']=$company_name;
                                                                                            $data_bank['create_date']=date('Y-m-d');
                                                                                            $data_bank['status_by']='Order Payment '.$trip_id;
                                                                ...
                                                                $this->Main_model->insert_commen($data_address,$tablename_customer_ledger);
                                                                     ...
                                                                     $res = $this->Main_model->where_names('driver_ledger','customer_id',$customer_id);
                                                                     $balancetotaldd=0;
                                                                     foreach($res as $val)
                                                                     {
                                                                         $payid=$val->id;
                                                                      ...
                                                                      $datavvdd['get_id']=$customer_id;
                                                                      $datavvdd['balance']=0;
                                                                      $datavvdd['paid_status']='Paid';
                                                                ...
                                                                {  
                                                                    ...
                                                                    if($checkid==0)
                                                                    {
                                                                          ...
                                                                          $data_driver['debits']=$drivercharge;
                                                                         
                                                                    }
                                                                    else
                                                                    {
                                                                          $data_driver['paid_status']=1; 
                                                                          $data_driver['credits']=$drivercharge;
                                                                         ...
                                                                         if($balancetotaldd!='0')
                                                                          {
                                                                               $data_driver['balance']=$balancetotaldd-round($drivercharge);
                                                                          }
                                                                          else
                                                                          {
                                                                ...
                                                                else
                                                                {
                                                                    ...
                                                                    {
                                                                        $data_driver['paid_status']=0;
                                                                        $data_driver['debits']=round($totalamount);

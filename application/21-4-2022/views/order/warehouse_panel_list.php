                                                            ...
                                                            <div class="row">
                                                                 ...
                                                                 <div class="col-lg-12">
                                                                              <div class="border rounded gray p-2">
                                                                                 ...
                                                                                 <div id="task-1">
                                                                                    <div id="upcoming-task" class="pb-1 task-list" ng-init="procseeGroupcompleted(4)">
                                                                                       <div class="card task-box" id="uptask-1"   ng-init="fetchDataCategorybasecompleted(4)" >
                                                                                         
                                                                                       <div class="row" style="padding: 5px 21px;"   ng-init="fetchDatacompleted(4)">

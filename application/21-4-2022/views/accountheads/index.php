                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    <h4 class="mb-sm-0 font-size-18">Account Heads Form</h4>

                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                               <li class="breadcrumb-item"><a href="<?php echo base_url(); ?>index.php/dashboard">Dashboard</a></li>
                                            <li class="breadcrumb-item active"> Account Heads Form</li>
                                        </ol>
                                    </div>
 ...
 <div class="row">
                       ...
                       <div class="col-md-4" style="display:none;">
                          <div class="form-group row">
                            <label class="col-sm-5 col-form-label">Account Type </label>
                            <div class="col-sm-7">
                         ...
                         <div class="col-md-4">
                          <div class="form-group row">
                            <label class="col-sm-5 col-form-label">Account Heads name</label>
                            <div class="col-sm-7">
...
<hr></hr>
<h4 class="mb-sm-0 font-size-18">Account Heads List</h4>      
<br>
                   ...
                   <table id="datatable" class="table table-bordered dt-responsive  nowrap w-100" datatable="ng" dt-options="vm.dtOptions" >
                      ...
                      <tbody>
                        <tr ng-repeat="name in namesData">
                          <td>{{name.no}}</td>
                          <td style="display:none;"> {{name.account_type}}</td>
                          <td>{{name.name}}</td>
 ...
 $scope.account_type='M1';
  ...
  $scope.submitForm = function(){
    $http({
      ...
      data:{'name':$scope.name,'account_type':$scope.account_type,'id':$scope.hidden_id,'action':$scope.submit_button,'tablename':'accountheads'}

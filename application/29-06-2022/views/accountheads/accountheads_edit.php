                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    <h4 class="mb-sm-0 font-size-18">Master  Edit</h4>

                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            <li class="breadcrumb-item"><a href="#">Master list</a></li>
                                            <li class="breadcrumb-item active"> Master Forms Edit</li>
                                        </ol>
                                    </div>
                       ...
                       <div class="row">
                            ...
                            <div class="col-md-3" >
                                                 ...
                                                 <div class="form-group row">
                                                         ...
                                                         <div class="col-sm-12">
                                                            <select class="form-control"  required  name="account_heads_id"  ng-model="account_heads_id">

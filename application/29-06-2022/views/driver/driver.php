                    ...
                    <form id="pristine-valid-common" ng-submit="submitForm()" method="post" style="display:none;">
                        ...
                        <div class="col-md-4">
                          ...
                          <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                             <select class="form-control"  data-trigger  name="vehicle_id" required ng-model="vehicle_id">
...
$scope.pin = '<?php echo substr(time(), 4); ?>';
  ...
  $scope.submitForm = function(){
    $http({
      ...
      data:{'name':$scope.name,'account_heads_id':$scope.account_heads_id,'delivery_fixced':$scope.delivery_fixced,'km_base_charge':$scope.km_base_charge,'name':$scope.name,'vehicle_id':$scope.vehicle_id,'phone':$scope.phone,'pin':$scope.pin,'status':$scope.status,'id':$scope.hidden_id,'action':$scope.submit_button,'tablename':'driver'}

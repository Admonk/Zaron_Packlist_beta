                                                                  ...
                                                                  <tbody>
                                                                      ...
                                                                      <tr  ng-repeat="name in namesData">
                                                                        ...
                                                                        <!-- <td> 
                                                                         ...
                                                                         <span ng-if="name.assign_status==3 || name.assign_status==4"><a href="javascript:void(0);" ng-click="getorderid(name.id,name.order_no)" class="btn btn-outline-success"> View</a></span>
                                                                             
                                                                             
                                                                             
                                                                         <a href="<?php echo base_url(); ?>index.php/order/sales_return_to_order_view?order_id={{name.base_id}}&baseset=1" ng-if="name.assign_status==0" class="btn btn-outline-success">Return View</a>
                                                                              
                                                                                       
                                                                         <span ng-if="name.return_status==0"><a href="<?php echo base_url(); ?>index.php/order/sales_return_to_order?order_id={{name.base_id}}&baseset=0" class="btn btn-primary" > Return</a></span>          

                  ...
                  <form ng-submit="submitPayment()" method="post" class="ng-pristine ng-invalid ng-invalid-required">
                       ...
                       <div class="row">
                           ...
                           <label class="col-sm-12 col-form-label">Amount <span style="color:red;">*</span></label>
                            <div class="col-sm-12">
                            <input type="number"  value="{{discountfulltotal-amounttotal}}" style="padding:9px;" class="form-control" required  id="vendor_amount">                            
                            </div>
                             </div>
         ...
         <div class="offcanvas-body pt-0">
            ...
            <table class="price-table" >
                ...
                <tr><td> {{compareunc.remarks}}</td></tr>
                 <tr ><td> <b> {{compareunc.qty*compareunc.total}}</b></td></tr>
                ...
                <tr><td class="price">     
                       ...
                       <span ng-if="order_base==1">
                          <a href="javascript:void(0);" ng-click="seletQutation(compareunc.id,compareunc.order_id,compareunc.vendor_id,compareunc.qty*compareunc.total)">Select</a>
                       </span>

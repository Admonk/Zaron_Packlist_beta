                                       ...
                                       <tbody  ng-repeat="name in namesData|orderBy:column:reverse" >
                                          ...
                                          <tr class="view" >
                                            ...
                                            <td title="{{name.categories}}"  data-label="Products">
                                             ...
                                             <td  data-label="Rate"> <input type="text"  ng-keyup="inputsave_1(name.id,'rate',1,1)"    id="rate_{{name.id}}" value="{{name.rate_tab}}"> </td>
                                             <td  data-label="Qty"> <input type="text"  ng-keyup="inputsave_1(name.id,'qty',1,1)"    id="qty_{{name.id}}" value="{{name.qty_tab}}"> </td>
                        ...
                        <div class="floater-options1"    ng-init="fetchSingleDatatotal('1')">
                            ...
                            <div class="row">
                              ...
                              <div class="col-8 <?php echo $none; ?>" >
                                 ...
                                 <div class="mt-3 hstack gap-3" ng-if="vendorcount>1" >
         ...
         <div class="offcanvas-body pt-0">
            <div class="card bg-transparent pt-0" style="box-shadow: none !important;">
               <div class="card-body pt-0">
                 ...
                 <div class="col-12" ng-repeat="comparevendor in getcomparedatavendor" style="margin-bottom:20px;">
                   ...
                   <table class="table border">
                    <tbody>
                     ...
                     <th>Price</th>
                                      ...
                                      <th>{{compare.product_name}}</th>
                                      <th>{{compare.specifications}}</th>
                                      <th>{{compare.uom}}</th>
                                      <th>{{compare.qty}}</th>
                                      <th>{{compare.price}}</th>
                                      </tr>
               ...
               <table style="width: 100%;">
                ...
                <td ng-repeat="compareunc in getcomparedataunc" ng-if="compareunc.vendor_id==comparevendor.vendor_id" ng-style="compareunc.selected_status == 1 && {'background-color':'#ffe0e0'}">
                ...
                <tr><td data-bs-toggle="modal" ng-click="seletQutationfile(compareunc.attachement)" data-bs-target="#previewPdf"><u><i class="mdi mdi-file-outline text-muted font-size-16  me-1"></i><span style="margin:3px;"> QUOTE </span></u></td></td>
                <tr><td class="price" >
                    
                    
                    <span ng-if="order_base==1">
                          <a href="javascript:void(0);" ng-click="seletQutation(compareunc.id,compare.order_id,compare.vendor_id)">Select</a>
                   </span>

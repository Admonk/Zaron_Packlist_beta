                   ...
                   <table id="datatable" class="table table-bordered dt-responsive" datatable="ng" dt-options="vm.dtOptions" >
                      ...
                      <tbody>
                        <tr ng-repeat="name in purchaseData">
                          ...
                          <td>{{name.bin_info}}</td>
                         <th>{{name.coil_no}}</th>
                         <td><a href="javascript:void(0)" ng-click="fetchSingleData(name.id)" style="padding: 3px;font-size: 11px;" class="btn btn-outline-primary">UPDATE COIL NO</a> </td>
                       ...
                       <div class="row">
                        ...
                        <div class="col-md-6">
                          ...
                          <div class="form-group row">
                            ...
                            <div class="col-sm-12">
                              <input id="qty" class="form-control" name="qty" readonly  ng-model="qty" type="text">
                            </div>
                          </div>
                        </div>
...
$scope.fetchSingleData = function(id){
  ...
  $scope.submitForm = function(){
    ...
    var total_amount=  $('#total_amount').val();
      ...
      data:{'total_amount':total_amount,'product_id':$scope.product_id,'rack_info':$scope.rack_info,'coil_no':$scope.coil_no,'bin_info':$scope.bin_info,'inward_date':$scope.inward_date,'vendor_id':$scope.vendor_id,'po_number':$scope.po_no,'qty':$scope.qty,'price':$scope.price,'id':$scope.hidden_id,'action':'Inward','tablename':'purchase_order'}
    }).success(function(data){

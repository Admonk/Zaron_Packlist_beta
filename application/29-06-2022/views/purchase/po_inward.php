                                    ...
                                    <table id="datatable" class="table invoice-table" >
                                       ...
                                       <thead class="bg-gray text-red" >
                                          ...
                                          <tr>
                                           ...
                                           <th class="table-width-8" >QTY </th>
                                             ...
                                             <th class="table-width-18">UPDATE RATE</th>
                                           <th class="table-width-18" >UPDATE QTY </th>
                                       ...
                                       <tbody  ng-repeat="name in namesData|orderBy:column:reverse" >
                                          ...
                                          <tr class="view">
                                             ...
                                             <td><select class="selectbox"   ng-change="inputsave_1(name.id,'uom',1,1)" id="uom_{{name.id}}"  ng-model="calulation"><option value="1" ng-selected="{{name.uom == 1}}">TON</option><option value="2" ng-selected="{{name.uom == 2}}">KG</option></select>
                                             </td>
                                              <td>{{name.rate_tab}}</td>
                                             <td>{{name.qty_tab}}</td>
                                            ...
                                            <td>
                                             ...
                                             <td>  
                                               ...
                                               <a href="javascript:void(0)" ng-Click="inword(name.id)" ng-if="name.checked==0">Inward </a>
                                              <a href="javascript:void(0)"  ng-if="name.checked==1">Completed</a>

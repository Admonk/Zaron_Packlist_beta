                      ...
                      <tbody>
                        <tr ng-repeat="name in purchaseData">
                          ...
                          <td >
                             ...
                             <button type="button" ng-if="name.return_status==1"   ng-click="viewAddress(name.id)"  title="View" style="padding: 3px 7px;"  class="btn btn-outline-primary"><i class="mdi mdi-eye menu-icon"></i> DC </button> 
                             <a href="javascript:void(0)" ng-click="fetchSingleData(name.id)"  style="padding: 3px 7px;" class="btn btn-outline-primary" ng-if="name.return_status==0">Purchase Return</a> 

                  ...
                  <div id="search-view" style="display:none;" >
                   ...
                   <table   ng-init="fetchDatagetlegderGroup(0)" >
                      <thead>
                          ...
                          <th></th>
                          <th ><b>   Generl Ledger A/c Bal.</b></th>
                        ...
                        <tr  class="trpoint" ng-if="names.set!=0">
                          
                           <td><a href="{{names.url}}" >{{names.name}}</a></td>
                           <td> <span  ng-if="names.trail_view_status==1"><a href="{{names.url}}" >{{names.debit | number}}</a></span></td>
                           <td><spa ng-if="names.trail_view_status==0"n><a href="{{names.url}}" >{{names.credit | number}}</a></span></td>

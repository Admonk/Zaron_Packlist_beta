                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    <h4 class="mb-sm-0 font-size-18">Ledger Accounts Head Form</h4>

                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                               <li class="breadcrumb-item"><a href="<?php echo base_url(); ?>index.php/dashboard">Dashboard</a></li>
                                            <li class="breadcrumb-item active">Ledger AccountHead Form</li>
                                        </ol>
                                    </div>
 ...
 <div class="row">
                       ...
                       <div class="col-md-3" >
                          <div class="form-group row">
                            <label class="col-sm-5 col-form-label">Ledger Group </label>
                            <div class="col-sm-7">
                                
                                
                                <select id="account_type" class="form-control" required  ng-model="account_type" name="account_type">
                         ...
                         <div class="col-md-3">
                          <div class="form-group row">
                            <label class="col-sm-3 col-form-label">Opeing Balance</label>
                            <div class="col-sm-9">
                              <input id="balance" class="form-control" required  ng-model="balance" name="balance" type="text">
...
<hr></hr>
<h4 class="mb-sm-0 font-size-18">Ledger Account List</h4>      
<br>
...
app.controller('crudController', function($scope, $http){
  ...
  $scope.fetchData = function(){
    $http.get('<?php echo base_url() ?>index.php/accountheads/fetch_data').success(function(data){
  ...
  $scope.submitForm = function(){
    $http({
      ...
      data:{'name':$scope.name,'balance':$scope.balance,'spilt_status':$scope.spilt_status,'account_type':$scope.account_type,'id':$scope.hidden_id,'action':$scope.submit_button,'tablename':'accountheads'}

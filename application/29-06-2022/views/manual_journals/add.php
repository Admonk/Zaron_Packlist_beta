...
<body data-layout="horizontal" class="full-vh-overflow-hide" data-topbar="dark" ng-app="crudApp" ng-controller="crudController">
 ...
 <div class="main-content">
             ...
             <a href="<?php echo base_url(); ?>index.php/accountheads/accountheads_add" class="btn btn-primary"   style="float:right;margin: 5px 10px;"  target="_blank">Others Creation</a>
  ...
  $scope.submitForm = function(){
    ...
    $http({
      ...
      data:{
          ...
          ?>
          'id':$scope.hidden_id,'bankaccount':bankaccount,'action':$scope.submit_button,'party_type':party_type,'get_users':$scope.get_users,'tablename':'manual_journals'}
         }).success(function(data){

...
class Customer extends CI_Controller {
	...
	public function fetch_data_get_ledger_view()
	{
                     ...
                     if($formdate=='undefined' || $formdate=='0')
                     {
                              ...
                              $result=$this->db->query("SELECT * FROM all_ledgers  WHERE  deleteid=0 AND party_type=1 AND `payment_date` BETWEEN '".$formdate."' AND '".$todate."' $sql ORDER BY id ASC");
                     ...
                     else
                     {
                          ...
                          {
                              $result=$this->db->query("SELECT * FROM all_ledgers  WHERE `payment_date` BETWEEN '".$formdate."' AND '".$todate."'    AND deleteid=0 AND party_type=1 $sql   ORDER BY id ASC");
                 	          $resultsub=$this->db->query("SELECT * FROM all_ledgers  WHERE `payment_date` BETWEEN '".$formdate."' AND '".$todate."'   AND deleteid=0 AND party_type=1 $sql ORDER BY id ASC");
                 	     
                          }
                          else
                          {
                             $result=$this->db->query("SELECT * FROM all_ledgers  WHERE `payment_date` BETWEEN '".$formdate."' AND '".$todate."'  AND paid_status='".$payment_status."'  AND deleteid=0 AND party_type=1 $sql ORDER BY id ASC");
                 	         $resultsub=$this->db->query("SELECT * FROM all_ledgers  WHERE `payment_date` BETWEEN '".$formdate."' AND '".$todate."'  AND paid_status='".$payment_status."' AND order_no='' AND deleteid=0 AND party_type=1 $sql ORDER BY id ASC");
    ...
    public function fetch_balance()
    {
    	                 ...
    	                 $res= $this->Main_model->where_names_three_order_by('all_ledgers','customer_id',$id,'party_type',1,'deleteid',0);
		...
		public function fetch_data_get_ledger_view_export()
	{
                     ...
                     else
                     {
                          ...
                          {
                              $result=$this->db->query("SELECT * FROM all_ledgers  WHERE `payment_date` BETWEEN '".$formdate."' AND '".$todate."'    AND deleteid=0 AND party_type=1  $sql  ORDER BY id ASC");
                 	          $resultsub=$this->db->query("SELECT * FROM all_ledgers  WHERE `payment_date` BETWEEN '".$formdate."' AND '".$todate."'  AND order_no=''  AND deleteid=0 AND party_type=1 $sql ORDER BY id ASC");
		...
		public function save_to_pay_transfer()
    {
                    ...
                    $account_head_id=$form_data->account_head_id;
                     ...
                     $balancetotal=$creditsamount-$debitsamount;
                              ...
                              $data_driver['customer_id']=$customer_id;
                              $data_driver['payment_mode']='Party Transfer To '.$customer_name2;
		...
		public function save_to_pay_transfer1()
    {
                     ...
                     $res =$this->Main_model->where_names_three_order_by($tablename,'customer_id',$customer_id,'party_type',1,'deleteid','0','id','ASC');
                     ...
                     $balancetotal=$creditsamount-$debitsamount;
                              ...
                              $data_driver['user_id']=$this->userid;
                              $data_driver['customer_id']=$customer_id;
                              $data_driver['payment_mode']='Party Transfer From '.$customer_name2;
                              $data_driver['payment_mode_payoff']='0';
                              ...
                              $data_driver['reference_no']='0000000';

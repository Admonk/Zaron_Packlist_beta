...
class Partytype extends CI_Controller {
      ...
      public function partyusers()
    {
                                        ...
                                        if(isset($this->session->userdata['logged_in']))
                                        {
                                             ...
                                             $data['active_base']='route';
                                             $data['active']='route';
                                             $data['title']    = 'Party Usres';
                                             $data['top_nav']  = $this->load->view('commen/top_nav', $data, TRUE);
                                             $data['side_nav'] = $this->load->view('commen/side_nav', $data, TRUE);
                                             $data['footer_copy_rights'] = $this->load->view('commen/footer_copy_rights', $data, TRUE);
                                             $this->load->view('partytype/partyusers',$data);
	...
	public function fetch_data_users()
	{
                 	 ...
                 	 $result= $this->Main_model->where_names('partyusers','deleteid','0');
                 	 $data=array();
                  	 $i=1;
                  	 $type='';
                 	 foreach ($result as  $value) {
                 	       ...
                 	       $partytype= $this->Main_model->where_names('partytype','deleteid','0');

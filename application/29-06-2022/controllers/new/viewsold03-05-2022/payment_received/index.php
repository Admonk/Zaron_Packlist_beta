...
<body data-layout="horizontal" class="full-vh-overflow-hide" data-topbar="dark" ng-app="crudApp" ng-controller="crudController">
 ...
 <div class="col-lg-12">           
 <a href="<?php echo base_url(); ?>index.php/payment_received/newcreate" class="btn btn-success"   style="float:right;margin: 5px 10px;">Add New Payment </a>
</div>
                  <div class="card-body" >
                   ...
                   <table id="datatable" class="table table-bordered dt-responsive"  >
                      ...
                      <tbody>
                        <tr ng-repeat="name in namesData">
                          ...
                          <a href="<?php echo base_url(); ?>index.php/payment_received/invoice/{{name.id}}" target="_blank"  class="btn btn-outline-success"><i class="mdi mdi-file menu-icon"></i></a>
                           
                          <a href="<?php echo base_url(); ?>index.php/payment_received/edit/{{name.id}}" target="_blank"  class="btn btn-outline-primary"><i class="mdi mdi-pencil menu-icon"></i></a>
...
app.controller('crudController', function($scope, $http){
  ...
  $scope.error = false;
    ...
    $scope.tablename='payment_received';
    getData();
   ...
   function getData() {
    ...
    var order_base = 0;
     ...
     $http.get('<?php echo base_url() ?>index.php/payment_received/fetch_data?page=' + $scope.currentPage + '&size=' + $scope.pageSize + '&search=' + $scope.searchText + '&tablename=' + $scope.tablename+'&order_base='+order_base)
...
$scope.onPre = function(currentPage,pageSize){
  ...
  function getDataPage(currentPage,pageSize) {
        ...
        $http.get('<?php echo base_url() ?>index.php/payment_received/fetch_data?page_next=' + currentPage + '&size=' + pageSize + '&search=' + $scope.searchText + '&tablename=' + $scope.tablename+'&order_base='+order_base)
        .success(function(data) {
            $scope.namesData = [];
            $scope.totalItems = data.totalCount;
...
$scope.deleteData = function(id){
    if(confirm("Are you sure you want to remove it?"))
    {
      $http({
        ...
        data:{'id':id, 'action':'Delete','tablename':'payment_received'}
      }).success(function(data){
        $scope.success = false;
        $scope.error = false;
        getData();

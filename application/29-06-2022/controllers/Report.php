...
class Report extends CI_Controller {
		...
		public function trial_balance_report_full()
	{
                     ...
                     $result=$this->db->query("SELECT * FROM accountheads_sub_group WHERE deleteid=0 AND trail_balance_view='1' $sql  ORDER BY trail_balance_sort ASC");
                 	 $result=$result->result();
                 	 ...
                 	 foreach ($result as  $value) {
                             ...
                             $debit1=0;
                             $balance1=0;
                             $result=$this->db->query("SELECT SUM(credits) as totalcridit,SUM(debits) as totaldebit FROM all_ledgers WHERE deleteid=0 AND account_heads_id_2='".$value->id."'  ORDER BY id DESC");
                 	         $result=$result->result();
                 	 ...
                 	 foreach ($result as  $value) {
                             ...
                             foreach ($result_sub as  $valuess) 
                             {
                 	                  if($value->id==$valuess->account_type)
                                       {
                                              $debits=0;
                                              $credits=0;
                                              $result1=$this->db->query("SELECT SUM(debits) as debits,SUM(credits) as credits FROM all_ledgers WHERE deleteid=0 AND account_head_id='".$valuess->id."' ORDER BY id DESC");
                                             ...
                                             if($valuess->id=='120' || $valuess->id=='119')
                                             {
                                                 $viewststi="1";
                                             }
                                             else
                                             {
                                                ...
                                                foreach($partyfull as $ssdata)
                                                {
                                                      ...
                                                      $creditsfull=$ssdata->credits-$ssdata->debits;
                 	 ...
                 	 foreach ($result as  $value) {
                             ...
                             foreach ($result_sub as  $valuess) 
                             {
                 	                   if($value->id==$valuess->account_type)
                                       {
                                                              ...
                                                              $credits2=0;
                                                              $result1=$this->db->query("SELECT SUM(debit) as debits,SUM(credit) as credits FROM bankaccount_manage WHERE deleteid=0 AND account_head_id='".$valuess->id."' ORDER BY id DESC");
                                                              $party1=$result1->result();
                                                              foreach($party1 as $partys1)
                                                              {
                 	 ...
                 	 foreach ($result as  $value) {
                                     ...
                                     foreach ($result_sub as  $valuess) 
                                     {
                         	                  if($value->id==$valuess->account_type)
                                               {
                                                   ...
                                                   $debits=0;
                                                      $credits=0;
                                                    $result1=$this->db->query("SELECT SUM(debits) as debits,SUM(credits) as credits FROM all_ledgers WHERE deleteid=0 AND account_heads_id_2='".$valuess->id."' ORDER BY id DESC");
                                                    $party1=$result1->result();
                                                      foreach($party1 as $partys1)
                                                      {
                                                        ...
                                                        $debits=$partys1->debits;
                                                            ...
                                                            $resultfull=$this->db->query("SELECT SUM(a.debits) as debits,SUM(a.credits) as credits,a.account_head_id FROM all_ledgers as a JOIN accountheads_sub_group as b On a.account_heads_id_2=b.id WHERE a.deleteid=0 AND b.account_type='".$value->id."'");
                                                            $partyfull=$resultfull->result();
                                                            foreach($partyfull as $ssdata)
                                                            {
                                                                                 
                                                                              
                                                              $creditsfull=$ssdata->credits;
                                                             ...
                                                             $vals=$getval2/2;
                                                     	 	 ...
                                                     	 	 $array[] = array(
                                                                ...
                                                                'name' => $value->name, 
                                                                'url'=>base_url().'index.php/report/trial_balance_full?accountstype='.$value->id,
                                                     	 		'credit' => round($creditsfull-$vals+$getval3,2),
                                                     	 		'resultsub'=>$array2
                    ...
                    if(isset($_GET['accountshead']))
                    {
                     ...
                     if(isset($_GET['payment_status']))
                     {
                              ...
                              if($payment_status!='')
                              {
                                      if($payment_status=='1')
                                      {
                                          $Stl=' AND account_head_id IN ("105","106")';
                                      }
                                      else
                                      {
                                         $Stl=' AND account_head_id  NOT IN ("105","106")';
                                      } 
                            ...
                            if($accountshead!='0')
                            {
                     	         ...
                     	         $result4=$this->db->query("SELECT * FROM all_ledgers  WHERE  deleteid=0  $St $qq $Stl ORDER BY id ASC");
                     	         
                     	         if($party_type==4)
                     	         {
                         	         $result5=$this->db->query("SELECT * FROM bankaccount_manage  WHERE  deleteid=0  $St $qq $Stl ORDER BY id ASC");
                            ...
                            else
                            {
                                 ...
                                 $result4=$this->db->query("SELECT * FROM all_ledgers  WHERE `payment_date` BETWEEN '".$formdate."' AND '".$todate."'   AND deleteid=0  $St $qq $Stl ORDER BY id ASC");
                     	        
                     	        
                     	        
                     	         if($party_type==4)
                     	         {
                         	          $result5=$this->db->query("SELECT * FROM bankaccount_manage  WHERE `create_date` BETWEEN '".$formdate."' AND '".$todate."'   AND deleteid=0   $qq $Stl  ORDER BY id ASC");
                         	          $result5=$result5->result();
                     	         }
                   ...
                   ?>
                      ...
                      <thead>
                        ...
                        foreach($arrayval as $names)
                        {
                           ...
                           <td style="font-weight:800;text-align: right;"> <?php echo $names['credits']; ?></td>
                           <td style="font-weight:800;text-align: right;"> <?php echo $names['balance']; ?></td>

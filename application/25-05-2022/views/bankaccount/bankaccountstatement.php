...
<div class="row my-5">
                            <div class="col-xl-12">
                                <div class="text-center">
                                    ...
                                    <h5>Form Date :  {{ fromdate | date : "dd-MM-yyyy"}} To Date :  {{ todate | date : "dd-MM-yyyy"}} </h5>
                                </div>
                                <div class="row">
...
<button type="button" ng-click="onviewparty()"  class="btn btn-soft-danger  waves-effect waves-light" style="float: right;margin: 0px 12px;">Bank to Bank Transfer</button>
                 ...
                 <p ng-init="getvalOpeingBalance()"><b> Opeing Balance  {{ fromdateset | date : "dd-MM-yyyy"}}
 :
                 
                 
                  <span ng-if="totalblanceopeing>=0" style="color:green" class="ng-binding ng-scope">{{totalblanceopeing | number}}</span>
                                                    <span ng-if="totalblanceopeing<0" style="color:red" class="ng-binding ng-scope">{{totalblanceopeing | number}}</span></b>
                ...
                <div class="row" >
                                    ...
                                    <div class="card-body">
                                        <div class="d-flex align-items-center">
                                            <div class="flex-grow-1">
                                                ...
                                                <h4 class="mb-3">
                                                    Rs. <span class="ng-binding">{{amounttotalcredits | number}}</span>
                                                </h4>
                                    ...
                                    <div class="card-body">
                                        <div class="d-flex align-items-center">
                                            <div class="flex-grow-1">
                                                ...
                                                <h4 class="mb-3">
                                                    Rs.  <span class="ng-binding">{{amounttotaldebits | number}}</span>
                                                </h4>
                             ...
                             <div class="col-xl-4 col-md-4">
                                ...
                                <div class="card card-h-50">
                                    ...
                                    <div class="card-body">
                                        <div class="d-flex align-items-center">
                                            <div class="flex-grow-1">
                                                <h3 class="text-muted mb-3 lh-1 d-block text-truncate">Current Closing Balance </h3>
                                                <h4 class="mb-3">
                                                
                                                    <span ng-if="totalblance>=0" style="color:green" class="ng-binding ng-scope">Rs. {{totalblance | number}}</span>
                                                    <span ng-if="totalblance<0" style="color:red" class="ng-binding ng-scope">Rs. {{totalblance | number}}</span>
                                                    ...
                                                    <table class="table table-bordered" style="font-size:11.5px;">
                                                        <tbody>
                                                            <tr>
                                                                ...
                                                                <td style="width: 10%;">
                                                                    <div class="py-3">
                                                                        <h5 class="font-size-14 mb-0">Notes</h5>
                                                                    </div>
                                                                </td>
                                                               
                                                                <td style="width: 20%;">
                                                                    <div class="py-3">
                                                                        <h5 class="font-size-14 mb-0">Status</h5>
                                                                    </div>
                                                                </td>
                                                               ...
                                                               <td>{{namess.create_date}}</td>
                                                                ...
                                                                <td style="text-align: right;">
                                                                 ...
                                                                 <td style="text-align: right;">
                                                                      ...
                                                                      <span  ng-if="namess.no==1">
                                    
                                   <span ng-if="totalblance>=0" style="color:green" class="ng-binding ng-scope">{{totalblance | number}}</span>
                                                    <span ng-if="totalblance<0" style="color:red" class="ng-binding ng-scope">{{totalblance | number}}</span>
                           ...
                           <button type="button" ng-click="deleteData(namess.id)" class="btn btn-outline-danger"><i class="mdi mdi-delete menu-icon"></i></button></td>
                                                             ...
                                                             <tr>
                                                                 ...
                                                                 <td  style="font-weight:800;text-align: right;">{{amounttotalcredits | number}}</td>
                                                                  <td  style="font-weight:800;text-align: right;">{{amounttotaldebits | number}}</td>
                                                                 <td></td>
                                                             </tr>
...
$scope.fromdate='<?php echo date("d-m-Y", strtotime('monday this week')); ?>';
$scope.todate='<?php echo date("d-m-Y", strtotime('sunday this week')); ?>';
...
$scope.getvalOpeingBalance = function(){
    ...
    var fromdate= '<?php echo date("Y-m-d", strtotime('monday this week')); ?>';
    var fromto= '<?php echo date("Y-m-d", strtotime('monday this week')); ?>';
    
    var fromdatess= '<?php echo date("d-m-Y", strtotime('monday this week')); ?>';
...
$scope.bankstatementupdate = function(){
                        ...
                        data:{'bank_account_id':$scope.bankname,'changecustomer':changecustomer,'account_head_id':$scope.account_head_id,'id':$scope.hidden_id,'debit':$scope.debit,'credit':$scope.credit,'status_by':$scope.status_by,'name':$scope.name,'create_date':new Date($scope.create_date)}
                        }).success(function(data){
 ...
 $scope.fetchDatadetails = function(id,fromdate,fromto){
    $http.get('<?php echo base_url() ?>index.php/bankaccount/fetch_data_details?account_id='+id+'&fromdate='+fromdate+'&fromto='+fromto).success(function(data){
     ...
     $scope.namesDatadetails = data;
      ...
      $scope.totalblance=totalval.toFixed(2);
       
       
       //$scope.totalblance=data[0].total;

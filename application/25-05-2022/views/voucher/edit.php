                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    <h4 class="mb-sm-0 font-size-18">Edit Voucher </h4>
                        ...
                        <div class="row" ng-init="fetchData()">
                            ...
                            <div class="col-md-12" >
                                                 ...
                                                 <div class="form-group row">
                                                         ...
                                                         <div class="col-sm-4">
                                                            <select required class="form-control" id="party_type"  name="party_type" ng-change="getUser()" ng-model="party_type">
...
$scope.submitFormmaster = function(){
 ...
 $scope.Getbankaccount = function () {
  ...
  $scope.submitForm = function(){
    ...
    $http({
      ...
      data:{
          ...
          ?>
          'id':'<?php echo $id; ?>','bankaccount':bankaccount,'action':$scope.submit_button,'party_type':$scope.party_type,'get_users':$scope.get_users,'tablename':'voucher'}
         }).success(function(data){
  ...
  $scope.fetchData = function(){
    $http({
      method:"POST",
      url:"<?php echo base_url() ?>index.php/voucher/fetch_single_data",
      data:{'id':<?php echo $id; ?>, 'action':'fetch_single_data','tablename':'voucher'}
    }).success(function(data){
                                 ...
                                 if(data.payment_mode=='Bank Account')
                                   {
                                       $('#bankaccountshow').show();
                                   }
      ...
      $scope.fetchDatasub = function(){
        $http.get('<?php echo base_url() ?>index.php/voucher/fetch_data_sub?id=<?php echo $id; ?>').success(function(data){

                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    <h4 class="mb-sm-0 font-size-18">New Manual Journals </h4>

                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            <li class="breadcrumb-item"><a href="<?php echo base_url(); ?>index.php/dashboard">Dashboard</a></li>
                                            <li class="breadcrumb-item active"> New Manual Journals Create !</li>
                                        </ol>
                                    </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12" >
                                                 ...
                                                 <div class="form-group row">
                                                         ...
                                                         <div class="col-sm-4">
                                                            <select required class="form-control"   name="party_type" id="party_type" ng-change="getUser()" ng-model="party_type">
...
app.controller('crudController', function($scope, $http){
 ...
 $scope.journal_id='JI-<?php echo substr(time(), 4); ?>';
  ...
  $scope.submitForm = function(){
    ...
    $http({
      ...
      data:{
          ...
          ?>
          'id':$scope.hidden_id,'bankaccount':bankaccount,'action':$scope.submit_button,'party_type':$scope.party_type,'get_users':$scope.get_users,'tablename':'manual_journals'}
         }).success(function(data){

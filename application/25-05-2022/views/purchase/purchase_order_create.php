                    ...
                    <div class="col-lg-9 col-12">
                        ...
                        <div class="customer-bill-info mb-1" ng-init="fetchVendor()">
                           <div class="row">
                                ...
                                <div  class="d-inline col-3 pe-3 border-end"  ng-if="vendorname">
                               ...
                               <span ng-if="order_base">
                              <div class="d-inline col-2 pe-3" ng-if="order_base!=0">
                                 <h5 class="font-size-16 mb-2">&nbsp;</h5>
                                 <div class="btn-group" role="group" aria-label="Basic example">
                                    <button type="button" class="btn btn-outline-primary" data-bs-toggle="offcanvas" ng-click="getcompare()" data-bs-target="#offcanvasCompare" aria-controls="offcanvasRight"><i class="mdi mdi-compare"></i> Compare</button>
                              ...
                              <div class="col-8 ">
                                 ...
                                 <div class="mt-3 hstack gap-3">
                                     ...
                                     <label class="form-check-label btn btn-success" for="formrow-customCheck">Request Enquiry</label>
                                      ...
                                      <div class="vr" ng-if="order_base!=0"></div> 
                                                  <span ng-if="order_base!=0">
                                                ...
                                                <span ng-if="order_base!=-1"><button type="button" class="btn btn-primary w-md" ng-click="approved(<?php echo $order_id; ?>,-1,'Purchase Enquiry Canceled')"> Cancel</button> </span> 
                                                 <span ng-if="order_base==-1">
        ...
        <tbody>
            ...
            <tr class="price-table-head">
                ...
                <td>
                    ...
                    <br>
                    <strong>{{compare_qty}}  {{compare_uom}}</strong>
                </td>
                <!--<td> Remarks</td>-->
                <td>File</td>
                <td class="green-width">Action</td>
                   
                
            </tr>
            
            <tr ng-repeat="compare in getcomparedata" ng-style="compare.selected_status == 1 && {'background-color':'#ffe0e0'}">
                
                
                <td>{{compare.name}}</td>
                <td>{{compare.price}} INR</td>
                 <!--<td>{{compare.remarks}} </td>-->
                <td data-bs-toggle="modal" ng-click="seletQutationfile(compare.attachement)" data-bs-target="#previewPdf"><u><i class="mdi mdi-file-outline text-muted font-size-16  me-1"></i><span style="margin:3px;"> QUOTE </span></u></td>
                <td class="price"  style="display: flex;">

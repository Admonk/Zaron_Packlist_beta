                                                   ...
                                                   <div class="form-group row">
                                                         ...
                                                         <div class="col-sm-4">
                                                            ...
                                                            <select class="form-control" data-trigger  name="bankaccount" ng-change="Getbankaccount()" ng-model="getbank" id="bankaccount" >
		                                                     ...
		                                                     <span ng-if="account_no"> <b> Current Balance : {{current_amount | number}}</b></span>     
  ...
  $scope.submitForm = function(){
    ...
    $http({
      ...
      data:{
          ...
          ?>
          'id':'<?php echo $id; ?>','bankaccount':bankaccount,'action':$scope.submit_button,'get_users':get_users,'tablename':'payment_received'}
         }).success(function(data){

                                ...
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    ...
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            ...
                                            <li class="breadcrumb-item active"> New Payment Create !</li>
                                        </ol>
                                    </div>
                    ...
                    <form id="pristine-valid-common" ng-submit="submitForm()" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row">
                              ...
                              <div class="col-md-12" >
                                  ...
                                  <input type="text" class="form-control border-bottom-input ng-pristine ng-valid ng-touched" ng-model="customer" ng-blur="Getbalance1()" ng-keyup="completeCustomer()" placeholder="Search Customer Or Phone"  id="choices-single-default">
          
           
                                                        
                                                           
                                                            <span ng-if="opening_balance1"> <b> Current Balance : {{opening_balance1 | number}}</b></span>
...
$scope.submitFormmaster = function(){
    $http({
      ...
      $scope.userList = function (party_type) {
         ...
         $http({
          method:"POST",
          url:"<?php echo base_url() ?>index.php/payment_received/userget",
  ...
  $scope.submitForm = function(){
    ...
    $http({
      ...
      data:{
          ...
          ?>
          'id':$scope.hidden_id,'bankaccount':bankaccount,'action':$scope.submit_button,'get_users':get_users,'tablename':'payment_received'}
         }).success(function(data){

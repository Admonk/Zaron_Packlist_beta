                  ...
                  <div class="col-md-4">
                     <div class="active-order-sidebar h-100">
                        <div class="row">
                              ...
                              <div class="px-3 col-md-4">
                                  <input type="date" id="filter_date" ng-click="routeassignOrderclick('orders_process',3,0,11)" value="<?php echo date('Y-m-d'); ?>" class="form-control">&nbsp;&nbsp;&nbsp;
                              </div>
                               <div class="px-3 col-md-3" >
                                <div class="btn-group">
                                    ...
                                    <div class="dropdown-menu">
                                        ...
                                        <a class="dropdown-item" href="#" ng-click="routeassignOrderclick('orders_process',3,0,11)">Assigned</a>
                        ...
                        <div class="row" style="margin: 22px 0px;">
                           <div class="col-12">
                              <div class="active-trip-tracking p-3" ng-init="fetchRouteorderassignorder('orders_process',3,0,11,0)">
...
app.controller('crudController', function($scope, $http){
  ...
  $scope.error = false;
   ...
   $('#route_id_set').val(0);
    ...
    function getData(route_id) {
     ...
     $http.get('<?php echo base_url() ?>index.php/order/fetch_data_table_transpot_by_server_own?page=' + $scope.currentPage + '&size=' + $scope.pageSize + '&search=' + $scope.searchText + '&tablename=orders_process&order_base=2&route_id='+route_id)
 ...
 $scope.routeOrder = function(id,name) {
   ...
   $scope.fetchRouteorderassignorder('orders_process',3,id,11,0);
 ...
 $scope.fetchRoute = function(){
    $http.get('<?php echo base_url() ?>index.php/order/group_gy_route_own').success(function(data){
...
$scope.deleteData = function(id){
    if(confirm("Are you sure you want to remove it?"))
    {
      $http({
        ...
        $scope.success = false;
        $scope.error = false;
        $scope.fetchRouteorderassignorder('orders_process',3,0,11,0);
      }); 
    }
};
...
$scope.assign = function () {
    ...
    else
    {
            ...
            $http({
              ...
              var routeid=$('#route_id_set').val();
              getData(routeid);
              $scope.fetchRouteorderassignorder('orders_process',3,routeid,11,0);

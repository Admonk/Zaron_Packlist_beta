                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    <h4 class="mb-sm-0 font-size-18">New Deposit </h4>

                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            <li class="breadcrumb-item"><a href="<?php echo base_url(); ?>index.php/dashboard">Dashboard</a></li>
                                            <li class="breadcrumb-item active"> New Deposit Create !</li>
                                        </ol>
                                    </div>
                        ...
                        <div class="row">
                                    ...
                                    <div class="col-md-12" >
                                     <div class="form-group row">
                                          <label class="col-sm-2 col-form-label"><b>Ledger Account</b> <span style="color:red;">*</span> </label>
                                                                 <div class="col-sm-4">
                                             ...
                                             <div class="col-md-12"  >
                                                   ...
                                                   <div class="form-group row">
                                                         ...
                                                         <div class="col-sm-4">
                                                            ...
                                                            <select class="form-control" data-trigger name="bankaccount" ng-change="Getbankaccount()" ng-model="getbank" id="bankaccount" >
                                           ...
                                           <div class="col-md-12" id="<?php echo strtolower($vvl->label_name); ?>">
                                                   ...
                                                   <div class="form-group row">
                                                         ...
                                                         <div class="col-sm-4">
                                                           ...
                                                           <input type="<?php echo $vv; ?>"  <?php if($vvl->required==1) { ?> required <?php } ?> class="form-control <?php echo strtolower($vvl->label_name); ?>" id="<?php echo strtolower($vvl->label_name); ?>" <?php echo $max; ?>  name="<?php echo strtolower($vvl->label_name); ?>"  ng-model="<?php echo strtolower($vvl->label_name); ?>">
  ...
  $scope.submitForm = function(){
    ...
    $http({
      ...
      data:{
          ...
          ?>
          'id':$scope.hidden_id,'bankaccount':bankaccount,'payment_status':$scope.payment_status,'action':$scope.submit_button,'tablename':'bank_deposit'}
         }).success(function(data){

...
$i++;
	...
	public function fetch_data_get_ledger_view()
	{
                     ...
                     if($formdate=='undefined' || $formdate=='0')
                     {
                              ...
                              $result=$this->db->query("SELECT * FROM vendor_ledger  WHERE  deleteid=0 AND `payment_date` BETWEEN '".$formdate."' AND '".$todate."' $sql  ORDER BY id DESC");
                     ...
                     else
                     {
                          ...
                          {
                              $result=$this->db->query("SELECT * FROM vendor_ledger  WHERE `payment_date` BETWEEN '".$formdate."' AND '".$todate."'   AND deleteid=0 $sql  ORDER BY id DESC");
                 	          $resultsub=$this->db->query("SELECT * FROM vendor_ledger  WHERE `payment_date` BETWEEN '".$formdate."' AND '".$todate."'    AND deleteid=0 $sql ORDER BY id DESC");
                 	     
                          }
                          else
                          {
                             $result=$this->db->query("SELECT * FROM vendor_ledger  WHERE `payment_date` BETWEEN '".$formdate."' AND '".$todate."'  AND paid_status='".$payment_status."'  AND deleteid=0 $sql ORDER BY id DESC");
                 	         $resultsub=$this->db->query("SELECT * FROM vendor_ledger  WHERE `payment_date` BETWEEN '".$formdate."' AND '".$todate."'  AND paid_status='".$payment_status."'  AND deleteid=0 $sql ORDER BY id DESC");
		...
		public function fetch_data_get_ledger_view_total()
	{
                     ...
                     if($formdate=='undefined')
                     {
                              ...
                              $todate=date("Y-m-d", strtotime('sunday this week')); 
                               ...
                               $result=$this->db->query("SELECT SUM(amount) as amount,SUM(payout) as totalpaid,SUM(credits) as totalcridit,SUM(debits) as totaldebit,SUM(balance) as totalblance FROM vendor_ledger  WHERE  deleteid=0 AND `payment_date` BETWEEN '".$formdate."' AND '".$todate."' $sql   ORDER BY id DESC");
                     ...
                     else
                     {
                          ...
                          if($payment_status=='All')
                          {
                              $result=$this->db->query("SELECT SUM(amount) as amount,SUM(payout) as totalpaid,SUM(credits) as totalcridit,SUM(debits) as totaldebit,SUM(balance) as totalblance FROM vendor_ledger  WHERE `payment_date` BETWEEN '".$formdate."' AND '".$todate."'   AND deleteid=0  $sql ORDER BY id DESC");
                 	          
                          }
                          else
                          {
                             $result=$this->db->query("SELECT SUM(amount) as amount,SUM(payout) as totalpaid,SUM(credits) as totalcridit,SUM(debits) as totaldebit,SUM(balance) as totalblance FROM vendor_ledger  WHERE `payment_date` BETWEEN '".$formdate."' AND '".$todate."'  AND paid_status='".$payment_status."'  AND deleteid=0 $sql ORDER BY id DESC");
	...
	public function save_to_pay()
    {
                   ...
                   $time= date('h:i A');
                     ...
                     $bankaccount=$form_data->bankaccount;
                      ...
                      $res = $this->Main_model->where_names_limit_base($tablename,'customer_id',$vendor_id,1);

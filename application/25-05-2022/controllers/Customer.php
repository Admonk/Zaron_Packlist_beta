                 ...
                 if($form_data->action=='updatevalue')
                 {
                      ...
                      if($lab=='payment_status')
                      {
                          ...
                          $data_driver['payment_mode_payoff']='';
                                                                      ...
                                                                      $res = $this->Main_model->where_names('customer_ledger','customer_id',$form_data->id);
                                                                      $balancetotal=0;
                                                                      $debitsamount=0;
                                                                      $creditsamount=0;
                                                                      foreach($res as $val)
                                                                      {
                                                                         ...
                                                                         $balancetotal=str_replace('-','',$balancetotal);
                                                                              ...
                                                                              if($form_data->val=='1')
                                                                              {
                                                                                                             ...
                                                                                                             $data_driver['order_no']='Opening Balance';  
                                                                                                              ...
                                                                                                              else
                                                                                                              {
                                                                                                                   ...
                                                                                                                   //$this->db->query("UPDATE customer_ledger SET balance='0' WHERE customer_id='".$form_data->id."'");
                                                                              ...
                                                                              if($form_data->val!='')
                                                                              {
                                                                                   $query = $this->db->query("SELECT id FROM `customer_ledger`  WHERE customer_id='".$form_data->id."' AND order_no='Opening Balance'");
                                                                                   $resultsales_team=$query->result();
                                                                                   ...
                                                                                   else
                                                                                   {
                                                                                             ...
                                                                                             $this->Main_model->update_commen_where_two($data_driver,'customer_id','order_no','Opening Balance','customer_ledger');
                                                                              ...
                                                                              if($obalance==0)
                                                                              {
                                                                                    $this->db->query("DELETE FROM customer_ledger  WHERE customer_id='".$form_data->id."' AND order_no='Opening Balance'");
                                                                              }
                        ...
                        foreach ($user_group_team as  $team) {
                 	 	...
                 	 	else
                 	 	{
                 	  	...
                 	  	$array[] = array(
                             	 		...
                             	 		'landline'=>$value->landline,customer_type,
...
$i++;
	...
	public function fetch_data_get_ledger_view()
	{
                     ...
                     if($formdate=='undefined' || $formdate=='0')
                     {
                              ...
                              $result=$this->db->query("SELECT * FROM customer_ledger  WHERE  deleteid=0 AND `payment_date` BETWEEN '".$formdate."' AND '".$todate."' $sql ORDER BY id DESC");
                     ...
                     else
                     {
                          ...
                          {
                              $result=$this->db->query("SELECT * FROM customer_ledger  WHERE `payment_date` BETWEEN '".$formdate."' AND '".$todate."'  AND order_no!=''  AND deleteid=0 $sql   ORDER BY id DESC");
                 	          $resultsub=$this->db->query("SELECT * FROM customer_ledger  WHERE `payment_date` BETWEEN '".$formdate."' AND '".$todate."'  AND order_no=''  AND deleteid=0 $sql ORDER BY id DESC");
                 	     
                          }
                          else
                          {
                             $result=$this->db->query("SELECT * FROM customer_ledger  WHERE `payment_date` BETWEEN '".$formdate."' AND '".$todate."'  AND paid_status='".$payment_status."' AND order_no!='' AND deleteid=0 $sql ORDER BY id DESC");
                 	         $resultsub=$this->db->query("SELECT * FROM customer_ledger  WHERE `payment_date` BETWEEN '".$formdate."' AND '".$todate."'  AND paid_status='".$payment_status."' AND order_no='' AND deleteid=0 $sql ORDER BY id DESC");
		...
		public function fetch_data_get_ledger_view_total()
	{
                     ...
                     if($formdate=='undefined')
                     {
                              ...
                              $todate=date("Y-m-d", strtotime('sunday this week')); 
                                    ...
                                    $result=$this->db->query("SELECT SUM(amount) as amount,SUM(payout) as totalpaid,SUM(credits) as totalcridit,SUM(debits) as totaldebit,SUM(balance) as totalblance FROM customer_ledger  WHERE  deleteid=0 AND `payment_date` BETWEEN '".$formdate."' AND '".$todate."' $sql   ORDER BY id DESC");
                     ...
                     else
                     {
                          ...
                          if($payment_status=='All')
                          {
                              $result=$this->db->query("SELECT SUM(amount) as amount,SUM(credits) as totalcridit,SUM(debits) as totaldebit,SUM(payout) as totalpaid,SUM(balance) as totalblance FROM customer_ledger  WHERE `payment_date` BETWEEN '".$formdate."' AND '".$todate."'    AND deleteid=0 $sql   ORDER BY id DESC");
                 	          
                          }
                          else
                          {
                             $result=$this->db->query("SELECT SUM(amount) as amount,SUM(credits) as totalcridit,SUM(debits) as totaldebit,SUM(payout) as totalpaid,SUM(balance) as totalblance FROM customer_ledger  WHERE `payment_date` BETWEEN '".$formdate."' AND '".$todate."'  AND paid_status='".$payment_status."'  AND deleteid=0 $sql ORDER BY id DESC");
    ...
    public function fetch_balance()
    {
                     ...
                     $id=$form_data->id;  
        	             ...
        	             $res = $this->Main_model->where_names('customer_ledger','customer_id',$id);
                         $balancetotal=0;
                         $debitsamount=0;
                         $creditsamount=0;
      ...
      public function fetch_balance_by_data()
    {
                     ...
                     $id=$form_data->id;  
    	                 ...
    	                 elseif($tablename=='Vendor')
    	                 {
    	                     $table="vendor_ledger";
    	                 }
    	                 elseif($tablename=='Driver')
    	                 {
    	                     $table="driver_ledger";
    	                 }
    	                 else
        	             ...
        	             $res = $this->Main_model->where_names($table,'customer_id',$id);
                         $balancetotal=0;
                         $debitsamount=0;
                         $creditsamount=0;
                         foreach($res as $val)

...
$i=1;
		...
		public function fetch_data_get_ledger_view()
	{
                     ...
                     if($formdate=='undefined' || $formdate=='0')
                     {
                             ...
                             $result=$this->db->query("SELECT * FROM driver_ledger  WHERE  deleteid=0  AND `payment_date` BETWEEN '".$formdate."' AND '".$todate."' $sql ORDER BY id DESC");
                     ...
                     else
                     {
                          ...
                          {
                              $result=$this->db->query("SELECT * FROM driver_ledger  WHERE `payment_date` BETWEEN '".$formdate."' AND '".$todate."'  AND order_no!=''  AND deleteid=0 $sql   ORDER BY id DESC");
                 	          $resultsub=$this->db->query("SELECT * FROM driver_ledger  WHERE `payment_date` BETWEEN '".$formdate."' AND '".$todate."'  AND order_no=''  AND deleteid=0 $sql ORDER BY id DESC");
                 	     
                          }
                          else
                          {
                             $result=$this->db->query("SELECT * FROM driver_ledger  WHERE `payment_date` BETWEEN '".$formdate."' AND '".$todate."'  AND paid_status='".$payment_status."' AND order_no!='' AND deleteid=0 $sql ORDER BY id DESC");
                 	         $resultsub=$this->db->query("SELECT * FROM driver_ledger  WHERE `payment_date` BETWEEN '".$formdate."' AND '".$todate."'  AND paid_status='".$payment_status."' AND order_no='' AND deleteid=0 $sql ORDER BY id DESC");
      ...
      public function save_to_pay()
    {
                    ...
                    $time= date('h:i A');
                     ...
                     $res = $this->Main_model->where_names_limit_base($tablename,'customer_id',$driver_id,1);
    		...
    		public function fetch_data_get_ledger_view_total()
	{
                     ...
                     if($formdate=='undefined')
                     {
                              ...
                              $result=$this->db->query("SELECT SUM(amount) as amount,SUM(payout) as totalpaid,SUM(credits) as totalcridit,SUM(debits) as totaldebit,SUM(balance) as totalblance FROM driver_ledger  WHERE  deleteid=0 AND `payment_date` BETWEEN '".$formdate."' AND '".$todate."' $sql  ORDER BY id DESC");
                 	          $result=$result->result();
                     ...
                     else
                     {
                          ...
                          if($payment_status=='All')
                          {
                              ...
                              $result=$this->db->query("SELECT SUM(amount) as amount,SUM(payout) as totalpaid,SUM(credits) as totalcridit,SUM(debits) as totaldebit,SUM(balance) as totalblance FROM driver_ledger  WHERE `payment_date` BETWEEN '".$formdate."' AND '".$todate."' AND deleteid=0 $sql  ORDER BY id DESC");
                 	          
                          }
                          else
                          {
                              
                             $result=$this->db->query("SELECT SUM(amount) as amount,SUM(payout) as totalpaid,SUM(credits) as totalcridit,SUM(debits) as totaldebit,SUM(balance) as totalblance FROM driver_ledger  WHERE `payment_date` BETWEEN '".$formdate."' AND '".$todate."'  AND paid_status='".$payment_status."'  AND deleteid=0 $sql ORDER BY id DESC");
      	...
      	public function fetch_data_get_ledger_view_export()
	{
                     ...
                     if($customer_id=='')
                     {
                           ...
                           $result=$this->db->query("SELECT * FROM driver_ledger  WHERE  deleteid=0 AND `payment_date` BETWEEN '".$formdate."' AND '".$todate."'  ORDER BY id DESC");
                 	       $result=$result->result();  

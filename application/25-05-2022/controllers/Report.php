    	...
    	public function fetch_data_get_ledger_view_all_base_by()
	{
                     ...
                     $party_type=$_GET['party_type'];
                            ...
                            if($accountshead!='0')
                            {
                                 ...
                                 $result=$this->db->query("SELECT * FROM customer_ledger  WHERE   deleteid=0  $St $qq ORDER BY id DESC");
                     	         $result2=$this->db->query("SELECT * FROM driver_ledger  WHERE    deleteid=0  $St $qq ORDER BY id DESC");
                     	         $result3=$this->db->query("SELECT * FROM vendor_ledger  WHERE    deleteid=0  $St $qq ORDER BY id DESC");
                     	         $result4=$this->db->query("SELECT * FROM employee_ledger  WHERE  deleteid=0  $St $qq  ORDER BY id DESC");
                     	         $result5=$this->db->query("SELECT * FROM bankaccount_manage  WHERE  deleteid=0 AND status_by='Bank Deposit' $St $qq  ORDER BY id DESC");
                            ...
                            else
                            {
                                 ...
                                 $result=$this->db->query("SELECT * FROM customer_ledger  WHERE  `payment_date` BETWEEN '".$formdate."' AND '".$todate."'   AND deleteid=0  $St $qq ORDER BY id DESC");
                     	         $result2=$this->db->query("SELECT * FROM driver_ledger  WHERE   `payment_date` BETWEEN '".$formdate."' AND '".$todate."'   AND deleteid=0  $St $qq ORDER BY id DESC");
                     	         $result3=$this->db->query("SELECT * FROM vendor_ledger  WHERE   `payment_date` BETWEEN '".$formdate."' AND '".$todate."'   AND deleteid=0  $St $qq ORDER BY id DESC");
                     	         $result4=$this->db->query("SELECT * FROM employee_ledger  WHERE `payment_date` BETWEEN '".$formdate."' AND '".$todate."'   AND deleteid=0  $St $qq  ORDER BY id DESC");

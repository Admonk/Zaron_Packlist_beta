                  ...
                  <div class="col-md-4">
                     <div class="active-order-sidebar h-100">
                        ...
                        <div class="row" style="margin: 22px 0px;">
                           <div class="col-12">
                              <div class="active-trip-tracking p-3" ng-init="fetchRouteorderassignorder('orders_process',3,0,1,0)">
...
$scope.assign = function () {
    ...
    else
    {
            ...
            $http({
              ...
              var routeid=$('#route_id_set').val();
              getData(routeid);
              $scope.fetchRouteorderassignorder('orders_process',3,routeid,1,0);

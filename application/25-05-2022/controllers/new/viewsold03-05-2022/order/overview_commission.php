                                       ...
                                       <thead class="bg-gray text-red" ng-if="namecate.categories_id==1">
                                        ...
                                        <thead class="bg-gray text-red" ng-if="namecate.categories_id!=1">
                                          ...
                                          <tr>
                                             ...
                                             <th class="table-width-18" ng-if="namecate.labletype==16  || namecate.categories_id==592" rowspan="2"  >Material Specfication </th>
                                             
                                            
                                                                    
 <th class="table-width-15" ng-if="namecate.labletype==19 || namecate.categories_id==591" >Remarks
 ...
 <i class="fa fa-sort" aria-hidden="true"></i></th> 
                                       ...
                                       <tbody  ng-repeat="name in namesData|orderBy:column:reverse" ng-if="namecate.categories_id!=1">
                                          ...
                                          <tr   class="view" ng-if="namecate.categories_id==name.categories_id_get">
                                             ...
                                             <th>{{name.no}}</th>
                                             <td title="{{name.categories}}">{{name.product_name_tab}} </td>
                                             <td  ng-if="namecate.labletype==4 || namecate.labletype==16 || namecate.categories_id==591 || namecate.categories_id==592">{{name.tile_material_name}}</td>
                                               <td  ng-if="namecate.labletype==19 || namecate.categories_id==591">{{name.dim_one}}</td>
                                       ...
                                       <tfoot ng-if="namecate.categories_id!=1">
                                           <tr >
                                             ...
                                             <th class="table-width-6" ng-if="namecate.labletype==12"></th>
                                               ...
                                               <th class="table-width-6" ng-if="namecate.labletype==19 || namecate.categories_id==591"></th>
                                             ...
                                             <th class="table-width-6" ng-if="namecate.labletype==5 || namecate.labletype==6"> </th>    
                                              <th class="table-width-6" ng-if="namecate.labletype==4 || namecate.labletype==16 || namecate.categories_id==591 || namecate.categories_id==592"> </th>    

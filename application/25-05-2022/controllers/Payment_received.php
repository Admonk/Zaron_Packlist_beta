	...
	public function insertandupdate()
	{
                                                ...
                                                foreach($additional_information as $vl)
                                                {
                                                  ...
                                                  $insert_id=$this->Main_model->insert_commen($data,$tablename);
                                                       ...
                                                       foreach($res as $val)
                                                       {
                                                         ...
                                                         $res = $this->Main_model->where_names_limit_base('customer_ledger','customer_id',$form_data->get_users,1);
                                                         $balancetotal=0;
                                                           $debitsamount=0;
                                                                     $creditsamount=0;
                                                         foreach($res as $val)
                 ...
                 if($form_data->action=="Update")
                 {
                     ...
                     {                          
                                                ...
                                                $this->db->query("UPDATE customer_ledger SET deleteid='1' WHERE deleteid='0' AND deletemod='".$idset."'");
                 ...
                 if($form_data->action=='Delete')
                 {
                     ...
                     $this->db->query("UPDATE customer_ledger SET deleteid='1' WHERE deletemod='PE".$id."'");

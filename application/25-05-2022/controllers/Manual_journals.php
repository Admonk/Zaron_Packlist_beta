...
class Manual_journals extends CI_Controller {
	...
	public function insertandupdate()
	{
                                                 ...
                                                 for ($i=0; $i <count($accountshead_value_data) ; $i++) { 
                                                     ...
                                                     $sizedata['description']=$description[$i];
                                                       ...
                                                       if($bankaccount!='0')
                                                       {
                                                             ...
                                                             foreach($resbankaccount as $valb)
                                                             {
                                                                ...
                                                                $data_bank['deletemod']='MJ'.$insert_id;
                                                     ...
                                                     if($sizedata['debits']!='0')
                                                     {
                                                      ...
                                                      if($tableleg!="0")
                                                      {
                                                                              ...
                                                                              $data_driver['deletemod']='MJ'.$insert_id;
                                                 ...
                                                 for ($i=0; $i <count($accountshead_value_data) ; $i++) { 
                                                     ...
                                                     else
                                                     {
                                                       ...
                                                       if($bankaccount!='0')
                                                       {
                                                             ...
                                                             foreach($resbankaccount as $valb)
                                                             {
                                                                ...
                                                                $data_bank['name']=$company_name;
                                                                $data_bank['deletemod']='MJ'.$form_data->id;
                                                     ...
                                                     if($sizedata['debits']!='0')
                                                     {
                                                      ...
                                                      if($tableleg!="0")
                                                      {
                                                                              ...
                                                                              $data_driver['paid_status']='1';
                                                                              $data_driver['process_by']='Manual Journals';
                                                                              $data_driver['deletemod']='MJ'.$form_data->id;
                                                                              $data_driver['payment_date']=$date;
                                                                              $data_driver['payment_time']=$time;
                                                                              $data_driver['account_head_id']=$form_data->account_head_id;
                                                                              $this->Main_model->insert_commen($data_driver,$tableleg);
                 ...
                 if($form_data->action=='Delete')
                 {
                     ...
                     $this->db->query("UPDATE bankaccount_manage SET deleteid='1' WHERE deletemod='MJ".$id."'");
                     $this->db->query("UPDATE customer_ledger SET deleteid='1' WHERE deletemod='MJ".$id."'");
                     $this->db->query("UPDATE vendor_ledger SET deleteid='1' WHERE deletemod='MJ".$id."'");
                     $this->db->query("UPDATE driver_ledger SET deleteid='1' WHERE deletemod='MJ".$id."'");
                     $this->db->query("UPDATE employee_ledger SET deleteid='1' WHERE deletemod='MJ".$id."'");
	...
	public function userget()
	{
                     ...
                     $party_type=$form_data->party_type;
                                   ...
                                   else
                                   {
                                      ...
                                      // $query = $this->db->query("SELECT id,name,phone FROM partyusers  WHERE deleteid='0' $sql ORDER BY name ASC");
    	             ...
    	             $result= $this->Main_model->where_names($tablename,'id',$id);
                 	 foreach ($result as  $value) {
                 	          ...
                 	          foreach($additional_information as $vl)
                              {
                                   ...
                                   elseif($value->party_type=='Driver')
                                   {
                                        $query = $this->db->query("SELECT id,name,phone FROM AND access='13'  WHERE deleteid='0'  AND id='".$value->get_users."' ORDER BY name ASC");

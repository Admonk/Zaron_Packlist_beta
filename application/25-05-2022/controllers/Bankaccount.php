...
class Bankaccount extends CI_Controller {
                     ...
                     $data['payment_status']=$form_data->payment_status;
                      ...
                      $insertid=$this->Main_model->insert_commen($data,$tablename);
                                                       ...
                                                       if($form_data->current_amount!='0' || $form_data->current_amount!='')
                                                       {
                                                                 ...
                                                                 $res = $this->Main_model->where_names_limit_base('bankaccount_manage','bank_account_id',$bid,1);
                                                                 $balancetotal=0;
                                                                 $debitsamount=0;
                                                                 $creditsamount=0;
                                                                 foreach($res as $val)
                                                                ...
                                                                $data_bank['status_by']='Opening Balance';
                                                                   ...
                                                                   $query = $this->db->query("SELECT id FROM `bankaccount_manage`  WHERE bank_account_id='".$bid."' AND status_by='Opening Balance'");
                                                                   ...
                                                                   else
                                                                   {
                                                                                             ...
                                                                                             $this->Main_model->update_commen_where_two($data_bank,'bank_account_id','status_by','Opening Balance','bankaccount_manage');
                                                                    ...
                                                                    if($form_data->current_amount=='0' || $form_data->current_amount=='')
                                                                    {
                                                                                    $this->db->query("DELETE FROM bankaccount_manage  WHERE bank_account_id='".$bid."' AND status_by='Opening Balance'");
                                                                    }
		...
		public function fetch_data_details()
	{
                     ...
                     if($_GET['fromdate']=='undefined')
                     {
                         ...
                         $result=$this->db->query("SELECT * FROM bankaccount_manage as a  WHERE  a.create_date BETWEEN '".$formdate."' AND '".$todate."' AND bank_account_id='".$account_id."' AND a.deleteid=0  ORDER BY a.create_date DESC");
                     ...
                     else
                     {
                        ...
                        $resultcount=$this->db->query("SELECT * FROM bankaccount_manage as a  WHERE   bank_account_id='".$account_id."' AND a.deleteid=0  ORDER BY a.create_date DESC");
      	...
      	public function export_bank_statement()
	{
                      ...
                      if($_GET['fromdate']=='undefined')
                     {
                         ...
                         $formdate=date("Y-m-d", strtotime('monday this week'));
                         $todate=date("Y-m-d", strtotime('sunday this week'));
                         $result=$this->db->query("SELECT * FROM bankaccount_manage as a  WHERE  a.create_date BETWEEN '".$formdate."' AND '".$todate."' AND bank_account_id='".$account_id."' AND a.deleteid=0  ORDER BY a.id DESC");
                  ...
                  ?>
                    ...
                    <table id="datatable" class="table table-bordered dt-responsive  nowrap w-100"    style="border: #d1d1d1 solid 1px;border-collapse: collapse;width: 100%;line-height: 1.5;" >
                         <thead>
                              ...
                              <tr><th colspan="5">Bank Statement <?php echo $formdate; ?> To <?php echo $todate; ?> <?php echo $bankname; ?></th></tr>
                                     ...
                                     $credittot=0;
                                 	 foreach ($result as  $value) {
                                 	    ...
                                 	    ?>
                                          ...
                                          <td><?php echo $value->name; ?> <?php echo $value->ex_code; ?></td>
                                          
                                          <td><?php echo $value->status_by; ?></td>

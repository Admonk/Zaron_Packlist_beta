...
class Vehicle extends CI_Controller {
   ...
   public function fetch_data_sales_group()
    {
        ...
        $where1 = "";       
                ...
                $where .= " AND vehicle_name LIKE '%" . $search . "%' OR vehicle_number LIKE '%" . $search . "%' OR vehicle_type LIKE '%" . $search . "%'";
                $where1 .= " AND vehicle_name LIKE '%" . $search . "%'";
 ...
 $querycount = $this->db->query("SELECT COUNT(*) as count FROM vehicle  WHERE deleteid='0' AND user_id='".$this->userid."' $where ORDER BY id DESC");
 ...
 $result = $this->db->query(
                "SELECT * FROM vehicle  WHERE deleteid='0' AND user_id='".$this->userid."' $where ORDER BY id DESC LIMIT $offset, $pagesize"
            );
            ...
            $querycount = $this->db->query("SELECT COUNT(*) as count FROM vehicle  WHERE deleteid='0' AND user_id IN ('" .
                    $sales_team_id .
            ...
            $querycount = $this->db->query("SELECT COUNT(*) as count FROM vehicle  WHERE deleteid='0' $where ORDER BY id DESC");
            $resultcount = $querycount->result();
            foreach ($resultcount as $value) {
                $count=$value->count;
            }
            ...
            $result = $this->db->query(
                "SELECT * FROM vehicle  WHERE deleteid='0' $where ORDER BY id DESC LIMIT $offset, $pagesize"
            );
            $result = $result->result();
        }

...
class Bankaccount extends CI_Controller {
                   	 ...
                   	 if($form_data->bank_name!='' || $form_data->account_no!='')
                     {
                         ...
                         $this->Main_model->update_commen($data,$tablename);
                                                       ...
                                                       if($form_data->current_amount!='0' || $form_data->current_amount!='')
                                                       {
                                                                ...
                                                                $data_bank['name']='';
                                                                $data_bank['create_date']=date('Y-06-30');
                                                                $data_bank['status_by']='Opening Balance';
                                                                $data_bank['opening_balance_status']='1';
                                                                $data_bank['party_type']= 4; 
		...
		public function fetch_data_details()
	{
        ...
        // exit;
                     ...
                     if($_GET['fromdate']=='undefined')
                     {
                         ...
                         $todate=date('Y-m-d');
                         $result=$this->db->query("SELECT * FROM bankaccount_manage as a  WHERE  a.create_date BETWEEN '".$formdate."' AND '".$todate."' AND a.bank_account_id='".$account_id."' AND a.deleteid='".$deleteid."' AND a.opening_balance_status='0' ORDER BY a.create_date,a.id ASC");
                     ...
                     else
                     {
                          ...
                          $result=$this->db->query("SELECT * FROM bankaccount_manage as a  WHERE  a.create_date BETWEEN '".$formdate."' AND '".$todate."' AND a.bank_account_id='".$account_id."'  AND a.deleteid='".$deleteid."'  AND a.opening_balance_status='0' ORDER BY a.create_date,a.id ASC");
                 	      $resultcount=$this->db->query("SELECT SUM(credit) as credit,SUM(debit) as debit FROM bankaccount_manage as a  WHERE  a.create_date BETWEEN '".$formdate."' AND '".$todate."' AND a.bank_account_id='".$account_id."' AND a.deleteid='".$deleteid."' ORDER BY a.create_date,a.id ASC");
                         ...
                         $resultopeing_new=$this->db->query("SELECT SUM(credit) as creditstotal,SUM(debit) as debitstotal,create_date FROM bankaccount_manage  WHERE  deleteid='".$deleteid."' AND bank_account_id='".$account_id."' AND opening_balance_status='1' ORDER BY create_date ASC");
                         ...
                         $resultopeing=$this->db->query("SELECT SUM(credit) as creditstotal,SUM(debit) as debitstotal FROM bankaccount_manage  WHERE `create_date` < '".$formdate."'   AND deleteid='".$deleteid."' AND bank_account_id='".$account_id."' AND opening_balance_status=0 ORDER BY create_date ASC");
                    	...
                    	$total_tot_range=0;
                    	$resultcount_tot=$this->db->query("SELECT SUM(credit) as credit,SUM(debit) as debit FROM bankaccount_manage as a  WHERE  a.create_date BETWEEN '".$formdate."' AND '".$todate."' AND a.bank_account_id='".$account_id."' AND a.deleteid='".$deleteid."'  ORDER BY a.create_date ASC");
		...
		public function export_bank_statement_full()
	{
                     ...
                     else
                     {
                       ...
                       {     
                    	...
                    	$total_tot_range=0;
                    	$resultcount_tot=$this->db->query("SELECT SUM(credit) as credit,SUM(debit) as debit FROM bankaccount_manage as a  WHERE  a.create_date BETWEEN '".$formdate."' AND '".$todate."' AND a.bank_account_id='".$account_id."' AND deleteid='".$deleteid."'  ORDER BY a.create_date ASC");
                    	$resultset_tot=$resultcount_tot->result();
		...
		public function fetch_data_details_total()
	{
                     ...
                     $result=$this->db->query("SELECT SUM(credit-debit) as total FROM bankaccount_manage as a  WHERE    a.bank_account_id='".$account_id."' AND a.deleteid=0  ORDER BY a.create_date ASC");
                      $result=$result->result();
                     foreach ($result as  $value) 
                     {
                     ...
                     $result=$this->db->query("SELECT SUM(credit-debit) as total FROM bankaccount_manage as a  WHERE  a.bank_account_id='".$account_id."' AND a.deleteid=0 AND create_date < '".$formdate."'  ORDER BY a.create_date ASC");
                      $result=$result->result();
                     foreach ($result as  $value) 
                     {
                     ...
                     $result=$this->db->query("SELECT SUM(credit) as credit,SUM(debit) as debit,SUM(credit-debit) as total FROM bankaccount_manage as a  WHERE    a.bank_account_id='".$account_id."' AND a.deleteid=0  $sql ORDER BY a.create_date ASC");
                 	  $result=$result->result();
                 	 foreach ($result as  $value) 
                     {

...
class Vendor extends CI_Controller {
  ...
  $data['accounttype'] = $this->Main_model->where_names('accountheads_sub_group','deleteid','0');
          ...
          $data['accountheads'] = $this->Main_model->where_names('accountheads','deleteid','0');
...
$query = $this->db->query("SELECT id,deleteid,name,phone FROM vendor  WHERE deleteid='0' AND mark_customer_id IN ('0','1','-1')  ORDER BY name ASC");
$data['vendor']=$result=$query->result();
...
$data['vendor']=$result=$query->result();
    ...
    public function insertandupdate()
    {
     ...
     {
         $data['mark_customer_id']=$form_data->active;
     }  
                                 ...
                                 $data['account_heads_id_2']=119;
                                      ...
                                      $result_name= $this->Main_model->where_names($tablename,'name',$data['name']);
                                       ...
                                       if(count($result_name)>0)
                                      {
                                            ...
                                            if($form_data->active=='-1')
                                            {
                                                ...
                                                $array=array('error'=>'3','massage'=>'Vendor Name already exists');
...
$this->db->query("UPDATE all_ledgers SET customer_id='".$customer_id."',party_type=1,commen_find_status='".$vendor_id."' WHERE customer_id='".$vendor_id."' AND party_type=3 AND deleteid='0'"); 
                                    ...
                                    elseif($form_data->active=='-2')
                                    {
                                         ...
                                         if($form_data->mark_customer_id>0)
                                        {
                                            $data['active_value']=$form_data->mark_customer_id;
                                           $vendor_id=$form_data->mark_customer_id;
                                        }
                                        
                                
 $this->db->query("UPDATE all_ledgers SET customer_id='".$vendor_id."',commen_find_status='".$customer_id."',party_type=2,driver_collection_status=1 WHERE customer_id='".$customer_id."' AND party_type=3 AND deleteid='0'");

$this->db->query("UPDATE vendor SET deleteid='1',mark_customer_id=-2 WHERE id='". $customer_id."'");
$this->db->query("UPDATE driver SET deleteid='0',mark_customer_id=-2 WHERE id='". $vendor_id."'");
                                    ...
                                    elseif($form_data->active=='-3')
                                    {
                                         ...
                                         $mark_vendor_id=$form_data->mark_customer_id;
 ...
 $this->db->query("UPDATE all_ledgers SET customer_id='".$vendor_id."',commen_find_status='".$customer_id."',party_type=2,driver_collection_status=0 WHERE customer_id='".$customer_id."' AND party_type=3 AND deleteid='0'");
                                         
 $this->db->query("UPDATE vendor SET deleteid='1',mark_customer_id=-3 WHERE id='". $customer_id."'");
$this->db->query("UPDATE driver SET deleteid='0',mark_customer_id=-3 WHERE id='". $vendor_id."'");           
 ...
 $this->db->query("UPDATE all_ledgers SET customer_id='".$vendor_id."',commen_find_status='".$customer_id."',party_type=5 WHERE customer_id='".$customer_id."' AND party_type=3 AND deleteid='0'");
                                         
$this->db->query("UPDATE vendor SET deleteid='1',mark_customer_id=-4 WHERE id='". $customer_id."'");
$this->db->query("UPDATE accountheads SET deleteid='0',mark_customer_id=-4 WHERE id='". $vendor_id."'");
  ...
  $this->db->query("UPDATE customers SET deleteid='0',mark_vendor_id='".$vendor_id."' WHERE id='". $customer_id."'");
 ...
 $this->Main_model->update_commen($data,$tablename);
                                    ...
                                    foreach ($user_group_team as  $team) 
                                    {
                                        $username=$team->name;
                                                                  ...
                                                                  $day_log['changes'] = 'Vendor Data Insert';
                                                                  $day_log['table_name'] = $tablename;
                                                                  $day_log['reference_no'] = $vendor_id;
                                                                  $day_log['create_date'] =$date;
                                                                  $day_log['create_time'] =$time;
                                                                  $day_log['details'] =json_encode($data);
     ...
     else
     {
         ///$data['mark_customer_id']=$form_data->active;
           ...
           // $this->db->query("UPDATE customers SET mark_vendor_id='".$data['get_id']."',active_value='".$data['get_id']."' WHERE id='". $form_data->mark_customer_id."'");
 ...
 $this->db->query("UPDATE all_ledgers SET customer_id='".$customer_id."',party_type=1,commen_find_status='".$vendor_id."' WHERE customer_id='".$vendor_id."' AND party_type=3 AND deleteid='0'"); 
            ...
            $this->db->query("UPDATE all_ledgers SET customer_id='".$customer_id."',party_type=1,commen_find_status='".$vendor_id."' WHERE customer_id='".$vendor_id."' AND party_type=3 AND deleteid='0'"); 
                ...
                $this->db->query("UPDATE  vendor SET deleteid='1',mark_customer_id=0 WHERE id='". $vendor_id."'");
              $this->db->query("UPDATE accountheads SET deleteid='0',mark_customer_id=0 WHERE id='". $customer_id."'");
            $this->db->query("UPDATE all_ledgers SET customer_id='".$customer_id."',party_type=5,commen_find_status='".$vendor_id."' WHERE customer_id='".$vendor_id."' AND party_type=3 AND deleteid='0'"); 
                ...
                $this->db->query("UPDATE vendor SET deleteid='1',mark_customer_id=0 WHERE id='". $vendor_id."'");
              $this->db->query("UPDATE driver SET deleteid='0',mark_customer_id=0 WHERE id='". $customer_id."'");
            $this->db->query("UPDATE all_ledgers SET customer_id='".$customer_id."',party_type=2,commen_find_status='".$vendor_id."' WHERE customer_id='".$vendor_id."' AND party_type=3 AND deleteid='0' AND driver_collection_status=1"); 
                ...
                $this->db->query("UPDATE vendor SET deleteid='1',mark_customer_id=0 WHERE id='". $vendor_id."'");
              $this->db->query("UPDATE driver SET deleteid='0',mark_customer_id=0 WHERE id='". $customer_id."'");
            $this->db->query("UPDATE all_ledgers SET customer_id='".$customer_id."',party_type=2,commen_find_status='".$vendor_id."' WHERE customer_id='".$vendor_id."' AND party_type=3 AND deleteid='0' AND driver_collection_status=0"); 
              ...
              $this->db->query("UPDATE customers SET deleteid='1',mark_vendor_id=0 WHERE id='". $customer_id."'");
              $this->db->query("UPDATE all_ledgers SET customer_id='".$customer_id."',party_type=3,commen_find_status='".$vendor_id."' WHERE customer_id='".$vendor_id."' AND party_type=1 AND deleteid='0'"); 
 ...
 $this->Main_model->update_commen($data,$tablename);
                       ...
                       echo json_encode($array);
                                    ...
                                    foreach ($user_group_team as  $team) 
                                    {
                                                                  ...
                                                                  $day_log['username'] = $username;
                                                                  $day_log['changes'] = 'Vendor Data Update';
                                                                  $day_log['table_name'] = $tablename;
  ...
  else
  {
    ...
    $this->db->query("UPDATE all_ledgers SET user_id='".$this->userid."',debits='".$data_driver['debits']."',credits='".$data_driver['credits']."',payment_date='".$data_driver['payment_date']."' WHERE customer_id='".$form_data->id."' AND party_type='3' AND opening_balance_status='1'");
                                 ...
                                 $this->Main_model->insert_commen($datas_log,'customer_edit_log');   
                                                                                     ...
                                                                                     $day_log['username'] = $username;
                                                                                     $day_log['changes'] = 'Vendor Opening Balance';
    ...
    public function fetch_data_get_ledger_view()
    {
                     ...
                     if($formdate=='undefined' || $formdate=='0')
                     {
                              ...
                              $result=$this->db->query("SELECT * FROM all_ledgers  WHERE  deleteid='".$deleteid."' AND party_type=3 AND `payment_date` BETWEEN '".$formdate."' AND '".$todate."' AND opening_balance_status='0' $sql  ORDER BY payment_date,id ASC");
                     ...
                     else
                     {
                          ...
                          {
                              $result=$this->db->query("SELECT * FROM all_ledgers  WHERE `payment_date` BETWEEN '".$formdate."' AND '".$todate."'   AND deleteid='".$deleteid."' AND party_type=3 AND opening_balance_status='0' $sql  ORDER BY payment_date,id ASC");
                             
                          }
                          else
                          {
                             $result=$this->db->query("SELECT * FROM all_ledgers  WHERE `payment_date` BETWEEN '".$formdate."' AND '".$todate."'  AND paid_status='".$payment_status."'  AND deleteid='".$deleteid."' AND party_type=3 AND opening_balance_status='0' $sql ORDER BY payment_date,id ASC");
                   ...
                   foreach($result_account_head_text as $ass)
                   {
                    ...
                    $resultg= $this->Main_model->where_names('purchase_invoice','invoice_no',$value->reference_no);

                                              $newEntry =  0;

                        foreach ($resultg as  $values) 
                        {
                            if($values->invoice_date>'2024-05-31')
                            {
                                              $newEntry = 1;
     ...
     public function fetch_data_get_ledger_view_beta()
    {
                    ...
                    $payment_date=date('d-M-Y',strtotime($formdate));
                     $resultopeing_new=$this->db->query("SELECT SUM(CASE WHEN payment_date > '2024-05-31' AND account_heads_id_2 = 119 THEN credits * 1.18 ELSE credits END) as creditstotal,SUM(debits) as debitstotal,payment_date FROM all_ledgers  WHERE  deleteid='".$deleteid."' AND party_type=3 AND opening_balance_status='1' $sql ORDER BY payment_date ASC");
                     $resultopeing_new=$resultopeing_new->result();
                     $openingbalance_new=0;
                     $openingbalancec_new=0;
                     $openingbalanced_new=0;
                     ...
                     $resultopeing=$this->db->query("SELECT SUM(CASE WHEN payment_date > '2024-05-31' AND account_heads_id_2 = 119 THEN credits * 1.18 ELSE credits END) as creditstotal,SUM(debits) as debitstotal FROM all_ledgers  WHERE `payment_date` < '".$formdate."'   AND deleteid='".$deleteid."' AND party_type=3 AND opening_balance_status='0' $sql ORDER BY payment_date ASC");
                     $resultopeing=$resultopeing->result();
                     $openingbalance=0;
                     $openingbalancec=0;
                     $openingbalanced=0;
                     ...
                     $j=1;
                      $array=array();
                         ...
                         foreach ($result as  $value)
                         {
                             $newEntry =  $value->payment_date  > '2024-05-31' ? 1 : 0;

$creditsVal = $value->account_heads_id_2  == 119 && $newEntry ? ($value->credits * 1.18) : $value->credits;
                              $credits=$creditsVal;
                              $debits=$value->debits;
                              $balanceold[]=  $credits-$debits;
...
$amount = $account_head_idname == 'PURCHASE ACCOUNT' && $newEntry ? ($value->credits * 1.18) : $value->credits;
$credits = $account_head_idname == 'PURCHASE ACCOUNT' && $newEntry ? round($value->credits * 1.18,2) :  round($value->credits,2);
                        $array[] = array(
        ...
        public function fetch_data_get_ledger_view_group()
    {
                     ...
                     foreach ($result as  $value) {
                                 ...
                                 $valss=  round($value->op+$value->debitstoatal+$value->creditstotal);
        ...
        public function fetch_data_get_ledger_view_total()
    {
                     ...
                     $sst=" AND b.mark_customer_id IN ('1','-1','0')";
                     if($trail_balance==1)
                     {
                             ...
                             // $sql.=" AND a.payment_date BETWEEN '".$formdate."' AND '".$todate."'";
                             //$sql2.=" AND a.payment_date BETWEEN '".$formdate."' AND '".$todate."'";
...
// echo "SELECT SUM(a.amount) as amount,SUM(a.payout) as totalpaid,SUM(a.credits) as totalcridit,SUM(a.debits) as totaldebit,SUM(a.balance) as totalblance FROM all_ledgers as a LEFT JOIN vendor as b ON a.customer_id=b.id WHERE  a.deleteid='".$deleteid."' AND a.party_type=3 AND b.deleteid=0 $sst  $sql ORDER BY a.id DESC";
// exit;



                          $result=$this->db->query("SELECT SUM(a.amount) as amount,SUM(a.payout) as totalpaid,SUM(a.credits) as totalcridit,SUM(a.debits) as totaldebit,SUM(a.balance) as totalblance FROM all_ledgers as a LEFT JOIN vendor as b ON a.customer_id=b.id WHERE  a.deleteid='".$deleteid."' AND a.party_type=3 AND b.deleteid=0 $sst  $sql ORDER BY a.id DESC");
                     ...
                     foreach ($result as  $value) {
                        ...
                        $balance=  $value->totalcridit-$value->totaldebit;
...
$amount = $account_head_idname == 'PURCHASE ACCOUNT' && $newEntry ? round($value->credits) :  round($value->credits,2);
$credits = $account_head_idname == 'PURCHASE ACCOUNT' && $newEntry ? round($value->credits) :  round($value->credits,2);
            ...
            public function fetch_data_get_ledger_view_export_group()
    {
                    ...
                    // $result=$this->db->query("SELECT a.*,SUM(a.debits) as debitstoatal,SUM(a.credits) as creditstotal,b.name,b.opening_balance,b.payment_status,b.op,b.op_status FROM all_ledgers as a LEFT JOIN vendor as b ON a.customer_id=b.id  WHERE  a.deleteid=0 AND a.party_type=3 AND b.mark_customer_id IN ('1','-1','0')   $sql GROUP BY a.customer_id ORDER BY b.name ASC");
                    // $result=$result->result();
                        ...
                        <tbody>
                            ...
                            <?php
                                     ...
                                     foreach ($result as  $value) {
                                         ...
                                         $sstotl=$value->op+$value->debitstoatal+$value->creditstotal;
                                         if($sstotl>0)
                                         {

   ...
   if(count($bankquerycheck)==0)
  {
                                                     ...
                                                     if($sizedata['debits']!='0')
                                                     {
                                                      ...
                                                      if($tableleg!="0")
                                                      {
                                                                ...
                                                                if($form_data->get_users==346 && $form_data->party_type==5)
                                                                {
                                         ...
                                         if(isset($form_data->type))
                                        {
                                            ...
                                            if($form_data->party_type==2)
                                            {
                                                ...
                                                $data_driver['driver_collection_status']= $form_data->type;
                                                 if($form_data->type==1)
                                                {
                                                    $data_driver['auto_expence_bank_status']= $form_data->type;
                                                }
...
$querycheck = $this->db->query("SELECT id FROM $tableleg  WHERE party_type='5' AND bank_id='".$data_driver['bank_id']."' AND customer_id='220' AND  user_id='".$this->userid."' AND  payment_date='".$data_driver['payment_date']."' AND payment_time='".$data_driver['payment_time']."' AND  debits='".$data_driver['debits']."' AND  credits='".$data_driver['credits']."'");
   ...
   if(count($querycheck)==0)
  {
                 ...
                 $tableleg="all_ledgers";
                              ...
                              $data_driver['net_balance']=$form_data->net_balance;
                              $data_driver['blance_text']=str_replace('CURRENT NET BALANCE : ', '', $form_data->blance_text);
                              ...
                              $data_driver['payout']=$credits_value_data;
                               ...
                               if($form_data->net_balance_status=='')
                               {
                                    $form_data->net_balance_status='DR';
                               }
                              ...
                              if($form_data->net_balance_status=='CR')
                              {

                                  $data_driver['debits']=$credits_value_data;
                                  $data_driver['credits']=0;
                              ...
                              $data_driver['net_balance_status']=$form_data->net_balance_status;
...
$querycheck = $this->db->query("SELECT id FROM $tableleg  WHERE party_type='5' AND bank_id='".$data_driver['bank_id']."' AND customer_id='220' AND  user_id='".$this->userid."' AND  payment_date='".$data_driver['payment_date']."' AND payment_time='".$data_driver['payment_time']."' AND  debits='".$data_driver['debits']."' AND  credits='".$data_driver['credits']."'");
    ...
    public function userget_cnn()
  {
                ...
                $query = $this->db->query("SELECT id,company_name as name,phone,cnn FROM customers  WHERE deleteid='0'  $sql ORDER BY company_name ASC LIMIT 0,50");
	...
	public function userget()
	{
                     ...
                     $party_type=$form_data->party_type;
                                   ...
                                   elseif($party_type=='11')
                                   {
                                       $query = $this->db->query("SELECT id,deleteid,company_name as name,phone FROM customers  WHERE deleteid='0' AND approved_status>0 AND mark_vendor_id IN ('0','1','-1') $sql ORDER BY company_name ASC LIMIT 0,50");
                                   }
                                   elseif($party_type=='12')
                                   {
                                       $query = $this->db->query("SELECT id,deleteid,name,phone FROM vendor  WHERE deleteid='0' AND mark_customer_id IN ('0','1','-1') $sql ORDER BY name ASC LIMIT 0,50");
                                   }
                                   elseif($party_type=='2')
                                   {
                                   ...
                                   elseif($party_type=='5')
                                   {
                                      $query = $this->db->query("SELECT id,deleteid,name,phone FROM accountheads  WHERE deleteid='0' AND id NOT IN('346') $sql ORDER BY name ASC LIMIT 0,50");
		...
		public function fetch_get_accounthead()
	{
                     ...
                     $result= $this->Main_model->where_names_order_by('accountheads_sub_group','deleteid',0,'id','ASC');
                 	 ...
                 	 $i++;
                                                       ...
                                                       elseif($form_data->party_type=='22')
                                                       {
                                                            $query = $this->db->query("SELECT id,name,account_heads_id,account_heads_id_2 FROM driver  WHERE deleteid='0'  AND id='".$form_data->get_users."' ORDER BY name ASC");
                                                            $tableleg="all_ledgers";
                                                       }
                                                       ...
                                                       elseif($form_data->party_type=='8')
                                                       {
                                                        ...
                                                        elseif($form_data->party_type=='10')
                                                       {
                                                           
                                                           
                                                            $query = $this->db->query("SELECT id,company_name as name,account_heads_id,account_heads_id_2 FROM customers  WHERE deleteid='0' AND id='".$form_data->get_users."' and cnn='YES' ORDER BY company_name ASC");
                                                            $tableleg="all_ledgers";

              ...
              <div class="col-lg-12">
                ...
                <div class="row">
                  ...
                  <div id="search-view" >
                   ...
                   <table id="datatable" class="table table-bordered dt-responsive"  ng-init="fetchDatagetlegderGroup(0,'<?php echo date('Y-m-01'); ?>','<?php echo date('Y-m-t'); ?>','All','All')" >
                      <thead>
                        <tr>
                        ...
                        <tr  class="trpoint" >
                           ...
                           <td><a href="{{names.ss}}">{{names.name}}</a></td>
                           <td style="text-align:right;font-weight:800;"><a href="{{names.ss}}">{{names.balance}}</a></td>

                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    <h4 class="mb-sm-0 font-size-18">layout plan Form</h4>

                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                               <li class="breadcrumb-item"><a href="<?php echo base_url(); ?>index.php/dashboard">Dashboard</a></li>
                                            <li class="breadcrumb-item active"> layout plan Form</li>
                                        </ol>
                                    </div>
 ...
 <div class="row">
                         ...
                         <div class="col-md-3">
                          <div class="form-group row">
                            <label class="col-sm-5 col-form-label">Layout name</label>
                            <div class="col-sm-7">
                         ...
                         <div class="col-md-3">
                          <div class="form-group row">
                            <label class="col-sm-5 col-form-label">Feet</label>
                            <div class="col-sm-7">
                              <input id="feet" class="form-control" required  ng-model="feet" name="feet" type="text">
                          ...
                          <div class="col-md-3">
                          <div class="form-group row">
                            <label class="col-sm-5 col-form-label">Plan values with(,)</label>
                            <div class="col-sm-7">
...
<hr></hr>
<h4 class="mb-sm-0 font-size-18">Layout Plan List</h4>      
<br>
                   ...
                   <table id="datatable" class="table table-bordered dt-responsive   w-100" datatable="ng" dt-options="vm.dtOptions" >
                      <thead>
                        <tr>
                         ...
                         <th>Name</th>
                         <th>Feet</th>
                         <th style="width:400px;">Plan Value</th>
                         <th>Action</th>
                      ...
                      <tbody>
                        <tr ng-repeat="name in namesData">
                          ...
                          <td>{{name.name}}</td>
                          <td>{{name.feet}}</td>
                          <td style="width:400px;">{{name.values}}</td>
                          <td>
...
app.controller('crudController', function($scope, $http){
  ...
  $scope.submitForm = function(){
    $http({
      ...
      data:{'name':$scope.name,'values':$scope.values,'feet':$scope.feet,'id':$scope.hidden_id,'action':$scope.submit_button,'tablename':'layout_plan'}

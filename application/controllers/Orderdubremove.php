...
class Order extends CI_Controller {
                 ...
                 if($form_data->action=='Save')
                 {
                     ...
                     if($form_data->profile!='')
                     {
                               ...
                               $profile=$form_data->profile;
                                    ...
                                    elseif($categories=='Purlin' || $categories=='Tile sheet' || $categories=='Profile ridge & Arch' || $categories=='Decking sheet' || $categories=='Polycarbonate' || $categories=='Sag Road')
                                    {
                                    ...
                                    $insertidmain=$form_data->order_id;
                                    $basedata['id']=$form_data->order_id;
                                    $basedata['order_no']=$form_data->order_no;
                                    $basedata['count_id']=$form_data->count_id;
                                    $basedata['create_date']=$date;
                                    ...
                                    $basedata['entry_user_id']=$this->userid;
                                                                 ...
                                                                 $resultmain=$this->db->query("SELECT * FROM $tablenamemain  WHERE id='".$form_data->order_id."' AND entry_user_id='".$this->userid."'");
                                                                 $resultcs=$resultmain->result();
                                                                 if(count($resultcs)==0)
                                                                 {
                                                                     ...
                                                                     $neworder_quotation_id=1;  
                                                                     $order_last_count = $this->Main_model->order_last_count_users($tablenamemain,$this->userid);
                                                                     foreach($order_last_count as $r)
                                                                     {
                                                                          $neworder_quotation_id=$r->count_id+1;
                                                                     }
                                                                     ...
                                                                     $neworder_id=1;
                                                                     $order_last_count = $this->Main_model->order_last_count($tablenamemain);
                                                                     foreach($order_last_count as $r)
                                                                     {
                                                                                               $neworder_id=$r->id+1;
                                                                     }
                                                                     ...
                                                                     $insertidmain=$this->Main_model->insert_commen($basedata,$tablenamemain);
                                                              ...
                                                              else
                                                              {
                                                                     ...
                                                                     elseif($type==14)
                                                                     {
                                                                         ...
                                                                         $data['Sqr_feet_to_Meter']=$qty;
                                                                         $data['qty']=round($qty,3);
                                                                         $data['amount']=round($data['rate']*$qty*$data['fact'],3);
                                                                     }
                                                                     elseif($type==6)
                                                                     {
                            ...
                            $data_update['get_id']=$insertid;
                                    ...
                                    $this->Main_model->update_commen($data_update,$tablename);
                                     ...
                                     $array=array('error'=>'2','id'=>$insertid,'product_id'=>$product_id,'cateid'=>$categories_id,'cate_status'=>$cate_status,'base_id'=>$insertidmain,'bid'=>base64_encode($insertidmain));
                                     echo json_encode($array);
                                                             ...
                                                             $billing_options=$form_data->billing_options;
                                                              ...
                                                              else
                                                              {
                                                                      ...
                                                                      elseif($type==14)
                                                                     {
                                                                         ...
                                                                         $datass['Sqr_feet_to_Meter']=$qty;
                                                                         $datass['qty']=round($qty,3);
                                                                         $datass['amount']=round($rate*$qty*$fact,3);
                                                                     }
                                                                     elseif($type==5)
                                                                     {
  ...
  public function fetch_data()
  {
                  ...
                  $result=$result->result();
                   ...
                   foreach ($result as  $value) {
                                    ...
                                    if($value->categories_id==41)
                                    {
                                        $amountdata=$value->rate*$value->qty*$value->fact;
                                    }
                                    else
                                    {
    ...
    public function fetch_data_delivery_data()
  {
                  ...
                  $result=  $this->db->query("SELECT * FROM $tablename_sub  WHERE order_id='".$_GET['order_id']."' AND  paricel_mode='".$paricel_mode."' AND deleteid=0 ORDER BY sort_id ASC");
                  $result=$result->result();
                   ...
                   foreach ($result as  $value) {
                                    ...
                                    if($value->paricel_mode==1)
                                    {
                                            ...
                                            else
                                            {
                                                ...
                                                if($value->categories_id==41)
                                                {
                                                    $amountdata=$value->rate*$value->modify_qty*$value->fact;
                                                }
                                                else
                                                {
                                                    $amountdata=$value->rate*$value->modify_qty;
  ...
  public function fetchDataCategorybase()
  {
                   ...
                   foreach ($result as  $value) {
                            ...
                            $array[] = array(
                              ...
                              'lablenos'=>$lablenos,
                              'labletype' => $labletype,
                              'lablefact1' => $lablefact1,
                              'lablefact2' => $lablefact2,
  ...
  public function fetch_data_table()
  {
                  ...
                  $order_base= $_GET['order_base'];
                     ...
                     if($this->session->userdata['logged_in']['access']=='12')
                     {
                         ...
                         if(count($result)==0)
                         {
                             $result= $this->Main_model->where_names_three_order_by($tablename,'order_base',$order_base,'entry_user_id',$this->userid,'deleteid','0','id','DESC');
                         }
                     ...
                     elseif($this->session->userdata['logged_in']['access']=='16')
                     {
                         ...
                         $result= $this->Main_model->where_names_three_thried_where_in_order_by($tablename,'order_base',$order_base,'deleteid','0','sales_group',$sales_team_id,'id','DESC');
    ...
    public function fetch_data_table_tl_price_request()
  {
                  ...
                  $order_base= $_GET['order_base'];
                     ...
                     elseif($this->session->userdata['logged_in']['access']=='11')
                     {
                         ...
                         $result= $this->Main_model->where_names_three_thried_where_in_order_by($tablename,'price_requerst_status',$price_requerst_status,'order_base',$order_base,'user_id',$sales_team_id,'id','DESC');
                     ...
                     elseif($this->session->userdata['logged_in']['access']=='16')
                     {
                         ...
                         $result= $this->Main_model->where_names_three_thried_where_in_order_by($tablename,'price_requerst_status',$price_requerst_status,'order_base',$order_base,'sales_group',$sales_team_id,'id','DESC');
                      ...
                      elseif($this->session->userdata['logged_in']['access']=='4' || $this->session->userdata['logged_in']['access']=='10')
                     {
                        ...
                        $price_requerst_status=3;
                        $result= $this->Main_model->where_names_two_order_by($tablename,'price_requerst_status',$price_requerst_status,'order_base',$order_base,'id','DESC');
                         ...
                         foreach ($results as  $valuep) {
                            ...
                            if($value->payment_image!="")
                             ...
                             $array[] = array(
                                    ...
                                    'totalamount' => $discountfulltotal,
                                    'fulltotalamount' => $discountfulltotal+$value->delivery_charge,
                                    'totalkm'=>$totalkm
      ...
      $route_id=0;
                   ...
                   foreach ($result as  $value) {
                        ...
                        $array = array(
                          ...
                          'totalamount' => round($discountfulltotal+$value->delivery_charge,2), 
                    ...
                    if($minisroundoff=='')
                   {
                     ...
                     else
                     {
                      ...
                      $array = array(
                            ...
                            'fulltotal' => round($discountfulltotal,4),
                            'discountfulltotal' => $discountfulltotal,
                            'totalitems' => count($result),
                            'gsttotal'=>$amounttotalgst,
                   ...
                   foreach ($resultsales as  $valuesales) {
                     ...
                     else
                     {
                      ...
                      $array = array(
                            ...
                            'create_time' => $create_time,
                             'minisroundoff' => $minisroundoff,
                            'fulltotal' => round($discountfulltotal),
                            'discountfulltotal' => $discountfulltotal,
                            'totalitems' => count($result),
                            'discount' => round($discount),
                            'gsttotal' => $amounttotalgst,
    ...
    public function fetchproduct_fullmm()
    {
                ...
                $array =array();
                     ...
                     foreach ($resultpending as  $value) {
                           ...
                           {
                               $array[] = array(
                              'length_mm'=>trim($value->length_mm),
                           ...
                           else
                           {
                              ...
                              'length_mm'=>round(trim($value->length_mm)/304.8,3),
                              'product_name'=>$value->product_name
                               );
                           }
  ...
  public function payment_collected()
  {
            ...
            {   
                                                                ...
                                                                $data_address['amount']=round($totalamount);
                                                                     ...
                                                                     $res = $this->Main_model->where_names('customer_ledger','customer_id',$customer_id);
                                                                     $balancetotal=0;
                                                                     $debitsamount=0;
                                                                     $creditsamount=0;
                                                                     foreach($res as $val)
                                                                     {
                                                                      ...
                                                                      $datavv['get_id']=$customer_id;
                                                                      $datavv['balance']=0;
                                                                      $datavv['paid_status']='1';
                                                                      $this->Main_model->update_commen_where($datavv,'customer_id','customer_ledger');
                                                                ...
                                                                { 
                                                                    ...
                                                                    if($customer_paid==1)
                                                                    {
                                                                               ...
                                                                               $data_address['balance']=round($balancetotal-$collectamount);
                                                                ...
                                                                else
                                                                {
                                                                        ...
                                                                        $data_address['balance']=round($balancetotal+$totalamount);
                                                                ...
                                                                $this->Main_model->insert_commen($data_address,$tablename_customer_ledger);
                                                                     ...
                                                                     $res = $this->Main_model->where_names('driver_ledger','customer_id',$driver_id);
                                                                     $balancetotaldd=0;
                                                                     ...
                                                                     foreach($res as $val)
                                                                     {
                                                                      ...
                                                                      $balancetotalddtotal=$creditsdd-$debitsdd;
                                                                      if($creditsdd==0)
                                                                      {
                                                                          $balancetotalddtotal=$debitsdd;
                                                                      }
                     
                                                                       
                                                                
                                                                
                                                                      $datavvdd['get_id']=$driver_id;
                                                                      $datavvdd['balance']=0;
                                                                      $datavvdd['paid_status']='1';
                                                                      $this->Main_model->update_commen_where($datavvdd,'customer_id','driver_ledger');
                                                                ...
                                                                {  
                                                                                ...
                                                                                if($checkid==1)
                                                                                {
                                                                                      ...
                                                                                      $data_driver['balance']=round($balancetotalddtotal-$drivercharge);
  ...
  public function group_gy_route()
    {
                  ...
                  $i=1;
                   foreach ($result as  $value) {
                    ...
                    $result= $this->Main_model->where_names_four_order_by_new('orders_process','finance_status','2','order_base','1','route_id',$value->id,'assign_status','0','id','DESC');

                      ...
                      <tbody>
                        <tr ng-repeat="name in namesData">
                          ...
                          <td>{{name.phone}}</td>
                           ...
                           <td class="text-end">
                                 <!--   {{name.opening_balance | number}} -->

         <input class="form-control" type="number" value="{{name.opening_balance}}" style="width: 150px;"  id="oo_{{name.id}}" <?php echo $disabled; ?>
                            > 
                          ...
                          <td>
                             ...
                             <select  style="width: 70px;margin: 8px 0px;" ng-blur="changepaystatus(name.id)" id="pay_{{name.id}}" <?php echo $disabled; ?>>

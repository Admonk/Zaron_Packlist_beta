                      ...
                      <thead>
                        ...
                        <tr  class="trpoint" >
                          ...
                          <td >
                            ...
                            <a href="<?php echo base_url(); ?>index.php/vendor/ledger_find?customer_id={{names.customer_id}}" target="_blank"><span ng-if="names.opening_balance!=0">{{names.opening_balance | indianCurrency}} {{names.payment_status}}</span></a>
                            </span>

                                 
                          </td>
                          
                          <td ><a href="<?php echo base_url(); ?>index.php/vendor/ledger_find?customer_id={{names.customer_id}}" target="_blank"><span ng-if="names.debits!=0">{{names.debits | indianCurrency}}</span></a></td>
                           <td ><a href="<?php echo base_url(); ?>index.php/vendor/ledger_find?customer_id={{names.customer_id}}" target="_blank"><span ng-if="names.credits!=0">{{names.credits | indianCurrency}}</span></a></td>
                           <td >

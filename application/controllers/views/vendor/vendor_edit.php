 ...
 <div class="row">
                              ...
                              <div class="col-md-4">
                                 ...
                                 <label class="radio-inline">
                                  ...
                                  <input type="radio" name="optradio" ng-click="onClick(2)" ng-checked="mark_vendor_id_check>0" value="2" id="active"> Both
                                  
                                  
                                </label>
                                <label class="radio-inline">
                                  <input type="radio" name="optradio" ng-click="onClick(0)" ng-checked="mark_vendor_id_check==0" value="0" id="inactive"> Customer
                                </label>
                                
                                <label class="radio-inline">
                                  <input type="radio" name="optradio"  ng-click="onClick(-1)" ng-checked="mark_vendor_id_check==-1" value="-1" id="inactive"> Vendor
                                </label>
    ...
    $http({
      ...
      data:{'id':<?php echo $id; ?>, 'action':'fetch_single_data','tablename':'vendor'}
        ...
        $scope.hidden_id = data.id;
            ...
            $scope.warehouse_address = data.warehouse_address;
            $scope.accounts_person_contact = data.accounts_person_contact;
            $scope.account_details = data.account_details;
            $scope.communication_mode = data.communication_mode;
            $scope.referred_by = data.referred_by;
            $('#feedback1').val(data.feedback1);
            $('#mark_customer_id').val(data.mark_customer_id);
            $scope.feedback1 =data.feedback1;


              $scope.mark_vendor_id_check =data.mark_customer_id; 

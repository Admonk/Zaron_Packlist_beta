                    ...
                    <div class="col-lg-12" >
                      ...
                      <form>
                          <div class="row">
                            ...
                            <div class="col-md-4">
                             <select class="form-control" data-trigger id="sales_group">
                   ...
                   <table id="datatable" class="table table-bordered dt-responsive  nowrap w-100"  ng-init="fetchDatagetlegderGroup(0)" >
                      <thead>
                        ...
                        <tr  class="trpoint">
                           ...
                           <td><b>{{ names.target }}</b></td>
                           <td><b>{{names.total | number}}</b></td>
                          
                            <td>
                                
                                 <b ng-if="names.getstatus==1" style="color:green;">{{names.achieved | number}}</b>
                                 <b ng-if="names.getstatus==0" style="color:red;">{{names.achieved | number}}</b>
...
$scope.fetchDatagetlegderGroup = function(cateid,productid,fromdate,fromto,order_status,sales_group){
 ...
 var sales_group= $('#sales_group').val();
    ...
    $http.get('<?php echo base_url() ?>index.php/report/fetch_data_sales_team_report?limit=10&formdate='+fromdate+'&todate='+fromto+'&order_status='+order_status+'&sales_group='+sales_group).success(function(data){

                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    <h4 class="mb-sm-0 font-size-18">Sales Day Book </h4>

                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                             <li class="breadcrumb-item"><a href="<?php echo base_url(); ?>index.php/dashboard">Dashboard</a></li>
                                            <li class="breadcrumb-item active">Sales Day Book !</li>
                                        </ol>
                                    </div>
                ...
                <div ng-init="fetchDatagetlegderGroup(0)"></div> 
                  ...
                  <div id="search-view" style="display:none;" >
                                     ...
                                     <div class="card-header"  ng-init="fetchSingleData(0)">
                                           ...
                                           <h4 class="card-title"> Sales Day Book {{formdate}} To {{todate}}</h4>
                   ...
                   if($customer_id==0)
                   {
                       ...
                       <div id="search-view1"  >
                                     ...
                                     <div class="card-header"   >
                                           ...
                                           <h4 class="card-title">Sales Day Book</h4>
...
$scope.fetchDatagetlegderGroup = function(cateid,productid,fromdate,fromto,order_status){
    ...
    $http.get('<?php echo base_url() ?>index.php/report/fetch_data_sales_report?limit=10&customer_id=<?php echo $customer_id; ?>&formdate='+fromdate+'&todate='+fromto+'&order_status='+order_status).success(function(data){

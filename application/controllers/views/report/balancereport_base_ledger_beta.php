                  ...
                  <div id="search-view" class="row">
                      ...
                      if($accountshead!=0)
                      {
                          ?>
                                ...
                                <div class="col-xl-3 col-md-3" ng-init="fetchDatagetlegderGroup1()" ng-if="grouped !=1">
                                <!-- card -->
                                ...
                                <div class="card card-h-100">
                                    ...
                                    <?php
                                                ...
                                                ?>
                            <div class="col-xl-3 col-md-3" ng-init="fetchDatagetlegderGroup2()" ng-if="grouped !=1" >
                                <!-- card -->
                                <div class="card card-h-100">
                                    <!-- card body -->
                                    <div class="card-body">
                        ...
                        <tr style="position: sticky;top: 0;background: #dfdfdf;">
                         ...
                         <th style="width:50px;">No</th>
                          ...
                          <th style="width:100px;">Credit</th>
                           ...
                           <th style="width:180px;" ng-if="grouped !=1">Balance</th>
                          ...
                          ?>
                                ...
                                <?php
                                  if($accountshead==116)
                                    {
                                    ?>
                                 <td style="color:green;" ng-if="grouped !=1">{{names.cumulative_sum | number}}</td>
                                    <?php }else{
                                      ?>
                                <td style="color:red;" ng-if="grouped !=1">{{names.cumulative_sum | number}}</td>
                                  <?php
                                    }
                                ?>

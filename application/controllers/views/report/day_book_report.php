              ...
              <div class="col-lg-12">
                ...
                <div class="row">
                             ...
                             <div class="col-xl-4 col-md-4" >
                                ...
                                <div class="card card-h-50">
                                    ...
                                    <div class="card-body">
                                        <div class="d-flex align-items-center">
                                            <div class="flex-grow-1">
                                                <h5 class="text-muted mb-3 lh-1 d-block text-truncate">Balance</h5>
                                                <h6 class="mb-3">
                                                    <span  ng-if="st2==1" style="color:green;">{{totalmines | number}}</span>
                                                    <span  ng-if="st2==0" style="color:red;">{{totalmines | number}}</span>
                                                </h6>
                              ...
                              <div class="col-xl-3 col-md-3" style="display: none;">
                                ...
                                <div class="card card-h-50">
                                    ...
                                    <div class="card-body">
                                        <div class="d-flex align-items-center">
                                            <div class="flex-grow-1">
                                                <h5 class="text-muted mb-3 lh-1 d-block text-truncate">Closing Balance <span ng-if="opening_date!=0" style="font-size: 11px;color: red;">{{opening_date}}</span></h5>
                                                <h6 class="mb-3">
                  ...
                  <div id="search-view" >
                     ...
                     <div class="table-responsive" ng-init="fetchDatagetlegderGroupcloseingbalance('<?php echo $customer_id; ?>','<?php echo date('Y-m-d'); ?>','<?php echo date('Y-m-d'); ?>','All','All')">
                   <table id="datatable" class="table table-striped table-bordered"  width="100%" ng-init="fetchDatagetlegderGroup('<?php echo $customer_id; ?>','<?php echo date('Y-m-d'); ?>','<?php echo date('Y-m-d'); ?>','All','All')" >
                      <thead>
                        <tr>
                           ...
                           <th style="width:70px;display:none;">No</th>
                          <th>Date</th>
                       ...
                       <tr style="font-weight:800;">
                        ...
                        <td></td>
                        <td style="font-weight:800;text-align: right;"> <span ng-if="st==0">{{closing_balance | number}}</span></td>
                        <td style="font-weight:800;text-align: right;"><span ng-if="st==1">{{closing_balance | number}}</span></td>
                        <td></td>
                       </tr>
                        ...
                        <tr  class="trpoint"  >
                           ...
                           <td style="display:none;">{{names.no}}</td>
                      ...
                      <tr>
                         ...
                         <th style="width:70px;"></th>
                          ...
                          <th style="width:200px;">BALANCE</th>
                           <td></td>
                          <th style="font-weight:800;text-align: right;"></th>
                          <th style="font-weight:800;text-align: right;"></th>
                          <th> <span  ng-if="st2==1" style="color:green;">{{totalmines | number}}</span>
                                                    <span  ng-if="st2==0" style="color:red;">{{totalmines | number}}</span></th>
...
$scope.fetchDatagetlegderGroup = function(id,fromdate,fromto,payment_status,party_type){
 ...
 $scope.loading = true;
    ...
    $http.get('<?php echo base_url() ?>index.php/report/day_book_all_view_beta?limit=10&customer_id='+id+'&formdate='+fromdate+'&todate='+fromto+'&party_type='+party_type+'&payment_status='+payment_status).success(function(data){
      ...
      $scope.namesDataledgergroup = data;
       ...
       $scope.totalcridit = data.totalcredits;
        $scope.totaldebit = data.totaldebits;
  ...
  $scope.fetchDatagetlegderGroupcloseingbalance = function(id,fromdate,fromto,payment_status,party_type){
    ...
    $http.get('<?php echo base_url() ?>index.php/report/day_book_all_view_closing_balance?limit=10&customer_id='+id+'&formdate='+fromdate+'&todate='+fromto+'&party_type='+party_type+'&payment_status='+payment_status).success(function(data){
      
     
 
      
      
        $scope.closing_balance =data.closing_balance;
        $scope.st =data.st;

 ...
 <div class="main-content">
                ...
                <div class="page-content">
                    <div class="container-fluid">
                      ...
                      {
                          ?>
                          Recent Ledger Transaction delete Log
                          <?php
                      }
                      ...
                      <form>
                          <div class="row">
                            ...
                            <div class="col">
                              ...
                              <input type="date" class="form-control" min="<?php echo date('Y-07-01'); ?>" id="from-date" value="<?php echo $formdate; ?>">
                            ...
                            <div class="col-xl-4 col-md-4">
                                ...
                                <div class="card card-h-50">
                                    ...
                                    <div class="card-body">
                                        <div class="d-flex align-items-center">
                                            <div class="flex-grow-1">
                                                <h3 class="text-muted mb-3 lh-1 d-block text-truncate">Total <?php echo $totaltest2; ?></h3>
                                                <h4 class="mb-3">
                             ...
                             <div class="col-xl-4 col-md-4">
                                ...
                                <div class="card card-h-50">
                                    ...
                                    <div class="card-body">
                                        <div class="d-flex align-items-center">
                                            <div class="flex-grow-1">
                                                <h3 class="text-muted mb-3 lh-1 d-block text-truncate"><?php echo 'Consolidated'; ?> <?php echo $totaltest3; ?></h3>
                                                <h4 class="mb-3">
                                                       {{totalval | number}}
   ...
   if($this->session->userdata['logged_in']['access']=='1' ||  $this->session->userdata['logged_in']['access']=='2')
   {
       ...
       ?>
                               <td> <button type="button" ng-click="deleteDataRevart(names.id)" class="btn btn-outline-danger btn-sm">Revart</button></td></td>
           <?php
...
$('#exportdata').on('click', function() {
    ...
    url = '<?php echo base_url() ?>index.php/report/fetch_data_get_ledger_view_export_all_base_by?limit=10&deleteid=1&accountshead='+id+'&formdate='+fromdate+'&todate='+fromto+'&party_type='+party_type+'&payment_status='+payment_status;
...
$scope.deleteDataRevart = function(id){
    if(confirm("Are you sure you want to Revart it?"))
    {
...
$scope.fetchDatagetlegderGroup = function(id,fromdate,fromto,payment_status,party_type){
    ...
    $http.get('<?php echo base_url() ?>index.php/report/fetch_data_get_ledger_view_all_base_by?limit=10&deleteid=1&accountshead='+id+'&formdate='+fromdate+'&todate='+fromto+'&party_type='+party_type+'&payment_status='+payment_status).success(function(data){

...
<form id="pristine-valid-example" novalidate method="post"></form>
                    ...
                    <select class="form-control price_type" name="price_type"  >
                       ...
                       <div id="price_details" style="display:none;"></div>
                         ...
                         <h4 class="card-title mt-3">Stock Details </h4>
...
$scope.submitFormmaster = function(){
  ...
  $scope.submitFormmaster2 = function(){
      ...
      $http({
        ...
        data:{'id':'<?php echo $id; ?>','purchase_name':purchase_name,'specification':specification, 'action':'updatepurcahsename','tablename':'product_list'}
      }).success(function(data)
      {
          alert('Updated');
 ...
 $scope.imageuploadInproductupdate = function(){
                              ...
                              var view_base= $('#view_base1').val();
                               ...
                               $http({
                                method:"POST",
                                url:"<?php echo base_url() ?>index.php/products/insertandupdate",
                                data:{'layout_plan':layout_plan,'view_base':view_base,'lengthvalset':lengthvalset1,'id':image_plan_id,'action':'base_name_change','tablename':'product_images'}
                                }).success(function(data){
  ...
  $scope.submitForm = function(){
    ...
    $http({
      ...
      ?>
      'optimal_stock':$scope.optimal_stock,'purchase_price':$scope.purchase_price,'production_stock':$scope.production_stock,'min_order_stock':$scope.min_order_stock,'source_name':$scope.source_name,'formula2':$scope.formula2,'type':$scope.type,'link_to_purchase':$scope.link_to_purchase,'label2':lab2,'point':lab_point,'formula':$scope.formula,'description':$scope.description,'side_label':$scope.side_label,'input_label':$scope.input_label,'price':price,'uom':$scope.uom,'HSN_SAC':$scope.HSN_SAC,'categories':$scope.categories,'id':$scope.hidden_id,'action':$scope.submit_button,'tablename':'product_list'}
      }).success(function(data){ 

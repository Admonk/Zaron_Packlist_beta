                   ...
                   <table id="datatable"  class="table table-striped table-bordered" style="position: relative;" width="100%" ng-init="fetchDatagetlegderGroup(0)" >
                      <thead>
                        ...
                        <tr  class="trpoint" >
                          ...
                          <td ><a href="<?php echo base_url(); ?>index.php/accountheads/others_ledger_find?customer_id={{names.customer_id}}" target="_blank"><span ng-if="names.opening_balance!=0">{{names.opening_balance | number}} {{names.payment_status}}</span></a></td>
                          
                          <td ><a href="<?php echo base_url(); ?>index.php/accountheads/others_ledger_find?customer_id={{names.customer_id}}" target="_blank"><span ng-if="names.debits>0">{{names.debits | number}}</span></a></td>
                           <td ><a href="<?php echo base_url(); ?>index.php/accountheads/others_ledger_find?customer_id={{names.customer_id}}" target="_blank"><span ng-if="names.credits>0">{{names.credits | number}}</span></a></td>
                           <td >
                               
                                
                                 <a href="<?php echo base_url(); ?>index.php/accountheads/others_ledger_find?customer_id={{names.customer_id}}" target="_blank">  <span  ng-if="names.getstatus==1" style="color:red">{{names.balance | number}}</span>

                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    <h4 class="mb-sm-0 font-size-18">Ticket Trash</h4>

                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            <li class="breadcrumb-item"><a href="javascript: void(0);">Ticket</a></li>
                                            <li class="breadcrumb-item active">Ticket Trash</li>
                                        </ol>
                                    </div>
                            ...
                            <div class="col-12">
                                ...
                                <div class="email-leftbar card">
                                    ...
                                    <div class="mail-list mt-4" ng-init="fetchDatacount()">
                                        ...
                                        <a href="<?php echo base_url(); ?>index.php/ticket/trash" class="active"><i class="mdi mdi-trash-can-outline me-2"></i>Trash</a>
                                    </div>
...
$scope.user_group = "0";
  ...
  $scope.submit_button = 'Create';
   ...
   $scope.userlist = function (user_group) {
    ...
    $http.get('<?php echo base_url() ?>index.php/ticket/fetchData_trash').success(function(data){

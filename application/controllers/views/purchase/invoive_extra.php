                                    ...
                                    <table id="datatable" class="table invoice-table" >
                                       ...
                                       <thead class="bg-gray text-red" >
                                          ...
                                          <tr>
                                           ...
                                           <th class="table-width-18"  >Vehicle no </th>
                                       ...
                                       <tbody  >
                                          ...
                                          <tr class="view">
                                             ...
                                             <td>1</td>
                                             <td title="{{name.categories}}">44858  </td>
                                            <td style="text-align: right !important;">{{invoice_totalextra}}</td>
                                          </tr>
                                          ...
                                          <tr ng-init="invoicepayment('<?php echo $invoice_id; ?>')">
                                            ...
                                            <tr >
                                             ...
                                             <td >GST 18 % </td>
                                            <td style="text-align: right !important;">{{invoice_gstamount}}</td>
                                          </tr>
                                            ...
                                            <tr >
                                             ...
                                             <td >FINAL TOTAL </td>
                                            <td style="text-align: right !important;">{{invoice_fulltotal}}</td>
                                          </tr>

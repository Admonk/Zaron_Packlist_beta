                   ...
                   <div class="row">
                                    <div class="col-6">
                                         <div class="page-title-box d-sm-flex align-items-center justify-content-between p-0">
                                            <h4 class="mb-sm-0 font-size-18">Purchase Complaints List</h4>
                                        </div>
                                    </div>
                                          ...
                                          <div class="card mb-1">
                                             <div class="card-header align-items-start d-flex p-3">
                                                <div class="flex-shrink-0">
                                                   <ul class="nav justify-content-end nav-tabs-custom rounded card-header-tabs" role="tablist" ng-init="getcount('purchase_complaints')">
                                                     
                                                      <li class="nav-item">
                                                         <a class="nav-link active" data-bs-toggle="tab" href="#profile2" role="tab" ng-click="pageTab('purchase_complaints',0)">
                                                        ...
                                                        <li class="nav-item">
                                                         <a class="nav-link " data-bs-toggle="tab" href="#profile2" role="tab" ng-click="pageTab('purchase_complaints',1)">
                                                         <span class="d-block d-sm-none"><i class="far fa-user"></i></span>
                                                       ...
                                                       <li class="nav-item">
                                                         <a class="nav-link" data-bs-toggle="tab" href="#messages2" role="tab" ng-click="pageTab('purchase_complaints',2)">
                         ...
                         <div  class="col-md-12" id="showdata" ng-show="namesDataproduct.length>0">
                                                                ...
                                                                <table class="table" >
                                                                     ...
                                                                     <tr  ng-repeat="namesp in namesDataproduct">
                                                                         ...
                                                                         <td><input type="checkbox" class="purchase_order_product_id" name="purchase_order_product_id" value="{{namesp.id}}_{{namesp.baseid}}"></td>
                                                                         
                                                                         <td>{{namesp.product_name}}</td>
                                                                         <td>{{namesp.coil_no}}</td>
...
$scope.create_date=new Date();
    ...
    $scope.tablename='purchase_complaints';
    getData();
   ...
   function getData() {
     ...
     $http.get('<?php echo base_url() ?>index.php/purchase/fetch_data_complaints_table?page=' + $scope.currentPage + '&size=' + $scope.pageSize + '&search=' + $scope.searchText + '&tablename=' + $scope.tablename+'&order_base='+order_base)
...
$scope.onPre = function(currentPage,pageSize){
  ...
  function getDataPage(currentPage,pageSize) {
        ...
        $http.get('<?php echo base_url() ?>index.php/purchase/fetch_data_complaints_table?page_next=' + currentPage + '&size=' + pageSize + '&search=' + $scope.searchText + '&tablename=' + $scope.tablename+'&order_base='+order_base)
        .success(function(data) {
            $scope.namesData = [];
            $scope.totalItems = data.totalCount;
...
$scope.deleteData = function(id){
    if(confirm("Are you sure you want to remove it?"))
    {
      $http({
        ...
        data:{'id':id, 'action':'Delete','tablename':'purchase_complaints'}
      }).success(function(data){
        $scope.success = false;
        $scope.error = false;
         getData();
         $scope.getcount('purchase_complaints');
      }); 
    }
};
...
$scope.cancelData = function(id){
    if(confirm("Are you sure you want to Cancel it?"))
    {
      $http({
        method:"POST",
        url:"<?php echo base_url() ?>index.php/purchase/insertandupdate",
        data:{'id':id, 'action':'Cancel','tablenamemain':'purchase_complaints'}
      }).success(function(data){
        $scope.success = false;
        $scope.error = false;
         getData();
...
$scope.submitForm = function(){
    ...
    if(validation!=0)
    {
      ...
      data:{'create_date':$scope.create_date,'remarks':$scope.remarks,'po_number':$scope.po_no,'purchase_order_product_id':checkinsert,'purchase_qty_data':purchase_qty_data,'purchase_notes_data':purchase_notes_data,'action':'Inward','tablename':'purchase_complaints'}
    }).success(function(data){
...
$scope.submitForm_1 = function(){
      ...
      $http({
      method:"POST",
      url:"<?php echo base_url() ?>index.php/purchase/purchase_complaints_data_remarks_update",
...
$scope.viewAddress = function(id){
 ...
 $scope.fetchDataproducts = function(id){
     ...
     $http.get('<?php echo base_url() ?>index.php/purchase/purchase_fetch_cp_products?id='+id).success(function(data){
     ...
     $http.get('<?php echo base_url() ?>index.php/purchase/purchase_fetch_cp_remarks_fetch?id='+id).success(function(dataaddress){
     ...
     $http.get('<?php echo base_url() ?>index.php/purchase/fetch_product_get_vendor_order_no?search='+autocomplete).success(function(data){

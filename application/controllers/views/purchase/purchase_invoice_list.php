                                                ...
                                                <div class="flex-shrink-0">
                                                   <ul class="nav justify-content-end nav-tabs-custom rounded card-header-tabs" role="tablist" ng-init="getcount('purchase_invoice')">
                                                      ...
                                                      <li class="nav-item">
                                                         ...
                                                         <span class="d-none d-sm-block">OPEN INVOICE<span class="badge rounded-pill bg-primary  float-end"> {{pending}} </span></span> 
                                                         </a>
                                                      </li>
                                                              ...
                                                              <table class="table align-middle table-nowrap newBorderedTable" >
                                                                  ...
                                                                  <tbody>
                                                                      ...
                                                                      <tr  ng-repeat="name in namesData">
                                                                          ...
                                                                          <td>{{name.qty}}</td>
                                                                          <td>{{name.invoice_amount_data}}</td>


                                                                          <td>{{name.loading_charges}}</td>

                                                                          
                                                                          <td>{{name.payout_amount}}</td>
                                                                          
                                                                          <td>{{name.pending_amount}}</td>
                       ...
                       <div class="row">
                        ...
                        <div class="col-md-6">
                          ...
                          <div class="form-group row">
                            ...
                            <div class="col-sm-12">
                             <input id="inovice_no" class="form-control" plaseholder="Enter the invoice no"  name="inovice_no" required ng-model="inovice_no" type="test2">
                            </div>
                          </div>
                        </div>
                                                                ...
                                                                <table class="table" >
                                                                     ...
                                                                     <tr  ng-repeat="names in namesDataaddress">
                                                                      ...
                                                                      <tr ng-if="invoice_totalextra!=0" style="display:none;">
                                                                         ...
                                                                         <td></td>
                                                                         <td>Extra </td>
                                                                         <td> {{invoice_totalextra | number : 2}}</td>
                                                                     </tr>
                                                                     ...
                                                                     <tr>
                                                                         ...
                                                                         <td></td>
                                                                         <td>Sub Total </td>
                                                                         <td> {{invoice_subtotal | number : 2}}</td>
                                                                     </tr>
                                                                     ...
                                                                     <tr ng-if="loading_charges>0">
                                                                         ...
                                                                         <td>{{loading_charges | number : 2}}</td>
                                                                     </tr>
                                                                     ...
                                                                     <tr>
                                                                         ...
                                                                         <td></td>
                                                                         <td>GST 18 % </td>
                                                                         <td>{{invoice_gstamount | number : 2}}</td>
                                                                     </tr>
                                                                     ...
                                                                     <tr ng-if="invoice_tcsamount>0">
                                                                         ...
                                                                         <td></td>
                                                                         <td>TCS </td>
                                                                         <td> {{invoice_tcsamount | number : 2}}</td>
                                                                     </tr>
                                                                       ...
                                                                       <tr ng-if="roundoffset>0">
                                                                         ...
                                                                         <td></td>
                                                                         <td>Round Off </td>
                                                                         <td>{{roundoffset | number : 2}} {{convert_status}}</td>
                                                                     </tr>
                                                                     ...
                                                                     <tr>
                                                                         ...
                                                                         <td></td>
                                                                         <td>Total </td>
                                                                         <td> {{invoice_fulltotal | number : 2}}</td>
                                                                     </tr>
                     ...
                     <div ng-init="fetchDataaddress()" ng-show="namesDataaddress.length>0">
                           ...
                           <table class="table" >
                                                                     ...
                                                                     <tr  ng-repeat="names in namesDataaddress">
                                                                        ...
                                                                        <td  class="totalv2" id="dd2_{{names.id}}"> {{names.row_total}}</td>
                                     ...
                                     $(document).ready(function()
                                     {
                                                           ...
                                                           $('.purchase_qty2').on('input',function () {
                                                                     ...
                                                                     <tr>
                                                                         ...
                                                                         <td></td>
                                                                         <td>Sub Total </td>
                                                                         <td id="totalamount2">{{invoice_subtotal}}</td>
                                                                     </tr>
                                                                     ...
                                                                     <tr>
                                                                         ...
                                                                         <td></td>
                                                                         <td>GST 18 % </td>
                                                                         <td id="gst2">{{invoice_gstamount}}</td>
                                                                     </tr>
                                                                   ...
                                                                   <tr ng-if="roundoffset>0">
                                                                     ...
                                                                     <tr>
                                                                         ...
                                                                         <td></td>
                                                                         <td>Total </td>
                                                                         <td id="totalamountgst2">{{invoice_fulltotal}}</td>
                                                                     </tr>

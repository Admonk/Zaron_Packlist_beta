                    ...
                    <form id="pristine-valid-common" ng-submit="submitForm()" method="post">
                       ...
                       <div class="row mb-4 mt-4">
                            ...
                            <div class="col-md-4" >
                              ...
                              <select class="form-control1"  ng-change="Seletvendor()" data-trigger ng-model="seletvendor" name="choices-single-default"
                       ...
                       <div class="row">
                         <div class="col-md-3">
                          <div class="form-group row">
                            ...
                            <div class="col-sm-12">
                              <input id="phone" class="form-control checkallbox"  data-section="29" name="phone" required ng-model="phone" type="text" >
                            </div>
                          </div>
                        </div>
                        ...
                        <div class="col-md-3">
                          ...
                          <div class="col-md-3">
                          <div class="form-group row">
                            <label class="col-sm-12 col-form-label">PRINT NAME <span style="color:red;">*</span></label>
                            <div class="col-sm-12">
                              <input id="print_name" data-section="20" class="form-control checkallbox" required name="print_name"  ng-model="print_name" type="text">
                       ...
                       <div class="col-md-3">
                          <div class="form-group row">
                            ...
                            <div class="col-sm-12">
                                                        ...
                                                        <select class="form-control checkallbox" data-section="20" required  ng-model="state" name="state" id="state"  >
                          ...
                          <div class="form-group row">
                            ...
                            <div class="col-sm-12">
                                                          ...
                                                          <select class="form-control checkallbox" data-section="20"  required ng-model="zone" name="zone" id="zone" >
                         ...
                         <div class="col-md-3">
                          <div class="form-group row">
                            <label class="col-sm-12 col-form-label">District <span style="color:red;">*</span></label>
                            <div class="col-sm-12">
                             

  <select class="form-control checkallbox" required   ng-model="district" data-section="20" name="district" id="district" >
                        ...
                        <div class="col-md-3">
                          <div class="form-group row">
                            <label class="col-sm-12 col-form-label">Taluk <span style="color:red;">*</span> - ({{city}})</label>
                            <div class="col-sm-12">

                                                          <select class="form-control checkallbox" data-section="20" required  ng-model="city" name="city" id="city" >
    ...
    <i class="mdi mdi-plus-circle font-size-18 right-bar-toggle" style="cursor: pointer;" onclick="return add_rowprice();"></i>
                        ...
                        if($key=='CUSTOMER DETAILS')
                        {
                          ...
                          <div class="form-group row">
                            ...
                            <div class="col-sm-12">
                             <select class="form-control checkallbox" name="sales_group" data-section="29" required ng-model="sales_group">
                         ...
                         <div class="col-md-3">
                          <div class="form-group row">
                            ...
                            <div class="col-md-3">
                          <div class="form-group row">
                            <label class="col-sm-12 col-form-label">Sales Sub Team <span style="color:red;">*</span></label>
                            <div class="col-sm-12">
...
$scope.submitFormmaster = function(){
  ...
  $scope.submitForm = function(){
   ...
   var commission_feed_back=  $('#feedback5').val();
    ...
    else if($scope.sales_team_id=='')
    {
             var nametatus="sales_team_id";
             var res=0;
...
var stop_billing=$('input[name="stop_billing"]:checked').val();
    ...
    $http({
      ...
      url:"<?php echo base_url() ?>index.php/customer/insertandupdate",
       ...
       ?>
       'google_map_link':$scope.google_map_link,'commission_feed_back':commission_feed_back,'mark_vendor_id':mark_vendor_id,'active':active,'gst_status':$scope.gst_status,'feedback_details':$scope.feedback_details,'zone':$scope.zone,'district':$scope.district,'price_rateings':price_rateings,'delivery_time_rateings':delivery_time_rateings,'quality_rateings':quality_rateings,'response_commission':response_commission,'ratings':ratings,'feedback':$scope.feedback,'phone':$scope.phone,'city':$scope.city,'locality':$scope.locality,'state':$scope.state,'pincode':$scope.pincode,'landmark':$scope.landmark,'address1':$scope.address1,'address2':$scope.address2,'company_name':$scope.company_name,'gst':$scope.gst,'landline':$scope.landline,'email':$scope.email,'sales_group':$scope.sales_group,'id':$scope.hidden_id,'action':$scope.submit_button,'tablename':'customers'}
    }).success(function(data){

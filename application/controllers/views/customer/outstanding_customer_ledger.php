                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between pb-2">
                                    <h4 class="mb-sm-0 font-size-16">Outstanding Customer ledger</h4>

                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                             <li class="breadcrumb-item"><a href="<?php echo base_url(); ?>index.php/dashboard">Dashboard</a></li>
                                            <li class="breadcrumb-item active">Outstanding Customer ledger !</li>
                                        </ol>
                                    </div>
                                        ...
                                        <div class="d-flex align-items-center">
                                            <div class="flex-grow-1">
                                                <h4 class="text-muted mb-3 font-size-14 lh-1 d-block text-truncate"><b>Total DR : </b>
                                                  ...
                                                  <p><b> <span >{{totaldebit | number }}</span></b></p>
                                    ...
                                    <div class="card-body py-1">
                                        <div class="d-flex align-items-center">
                                            <div class="flex-grow-1">
                                                ...
                                                <p><b> <span >{{totalcridit | number }}</span></b></p>
                                        ...
                                        <div class="d-flex align-items-center">
                                            <div class="flex-grow-1">
                                                <h4 class="text-muted mb-3 font-size-14 lh-1 d-block text-truncate"><b>Balance DR : </b>
                                                 ...
                                                 <p><b> <span >{{DRtotal | number }}</span></b></p>
                                            </div>
                                             </div>
                                    </div><!-- end card body -->
                                </div><!-- end card -->
                                    ...
                                    <div class="card-body py-1">
                                        <div class="d-flex align-items-center">
                                            <div class="flex-grow-1">
                                                ...
                                                <p><b> <span >{{CRtotal | number }}</span></b></p>
                      ...
                      <thead>
                        ...
                        <tr  class="trpoint" >
                           ...
                           <b style="color:#ff5e14;" ng-if="namesvv.name">{{namesvv.name}} <br></b>
                            <a href="<?php echo base_url(); ?>index.php/customer/ledger_find?customer_id={{namesvv.customer_id}}" target="_blank">

                            {{namesvv.company_name}}
                          </a></td>
                           <td><a href="<?php echo base_url(); ?>index.php/customer/ledger_find?customer_id={{namesvv.customer_id}}" target="_blank">
                           
                            <span ng-if="namesvv.opening_balance_dr!=0" style="color: red;">{{namesvv.opening_balance_dr | number}}</span></a>

                          </td>
                          <td><a href="<?php echo base_url(); ?>index.php/customer/ledger_find?customer_id={{namesvv.customer_id}}" target="_blank"><span ng-if="namesvv.opening_balance_cr!=0" style="color: green;">{{namesvv.opening_balance_cr | number}} </span></a></td>
                           <td><a href="<?php echo base_url(); ?>index.php/customer/ledger_find?customer_id={{namesvv.customer_id}}" target="_blank"><span ng-if="namesvv.debits!=0">{{namesvv.debits | number}}</span></a></td>
                           <td><a href="<?php echo base_url(); ?>index.php/customer/ledger_find?customer_id={{namesvv.customer_id}}" target="_blank"><span ng-if="namesvv.credits!=0">{{namesvv.credits | number}}</span></a></td>
                           


                           <td>
                             <a href="<?php echo base_url(); ?>index.php/customer/ledger_find?customer_id={{namesvv.customer_id}}" target="_blank" ng-if="namesvv.balance!=0"><span  ng-if="namesvv.getstatus==1" style="color:red">{{namesvv.balance | number}}</a></span>
                             </a>
                           </td>


                            <td>
                    <a href="<?php echo base_url(); ?>index.php/customer/ledger_find?customer_id={{namesvv.customer_id}}" target="_blank" ng-if="namesvv.balance!=0">
...
$('#exportdata').on('click', function() {
    ...
    url = '<?php echo base_url() ?>index.php/customer/fetch_data_get_ledger_view_export_group_outstanding_customer_ledger?limit=10&customer_id='+id+'&formdate='+fromdate+'&todate='+fromto+'&payment_status='+payment_status;
...
$scope.loading = true;
    ...
    $http.get('<?php echo base_url() ?>index.php/customer/fetch_data_get_ledger_view_group?limit=10&customer_id='+id+'&formdate='+fromdate+'&todate='+fromto+'&payment_status='+payment_status).success(function(data){
...
$scope.fetchDatagetlegderGroupTotal = function(id,fromdate,fromto,payment_status){
    ...
    $http.get('<?php echo base_url() ?>index.php/customer/fetch_data_get_ledger_view_total_group?limit=10&customer_id='+id+'&formdate='+fromdate+'&todate='+fromto+'&payment_status='+payment_status).success(function(data){

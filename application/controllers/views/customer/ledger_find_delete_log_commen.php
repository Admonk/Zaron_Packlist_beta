...
?>
 ...
 <div class="main-content">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    <h4 class="mb-sm-0 font-size-18">Customer & Vendor Ledger (Common)</h4>
                    ...
                    <div class="col-lg-12" >
                      ...
                      <form>
                          <div class="row">
                            ...
                            <div class="col">
                              <input type="date" class="form-control" id="from-date" min="<?php echo date('Y-07-01'); ?>" value="<?php echo $date; ?>">
                            </div>
                            <div class="col">
                              <input type="date" class="form-control" id="to-date" min="<?php echo date('Y-07-01'); ?>"   value="<?php echo $this->session->userdata['logged_in']['to_date']; ?>">
                            </div>
                      ...
                      <thead>
                        <tr style="position: sticky;top: 0;background: #dfdfdf;">
                          ...
                          <th style="width:100px;"><h5 class="font-size-14 mb-0">Balance</h5></th>
                           <th style="width:100px;"><h5 class="font-size-14 mb-0">Mode</h5></th>
                       ...
                       <tr class="setload" ><td colspan="9"><loading></loading></td></tr>
                         ...
                         <tbody  ng-repeat="names in namesDataledgergroup | filter:query" ng-if="names.no!='#'">
                         ...
                         <tr  class="trpoint" >
                           ...
                           <td>
                                ...
                                <samll ><br>Deleted By  : {{names.username}} </samll>
   ...
   if($this->session->userdata['logged_in']['access']=='1' ||  $this->session->userdata['logged_in']['access']=='2')
   {
       ...
       ?>
                               <td> <button type="button" ng-click="deleteDataRevart(names.id)" class="btn btn-outline-danger btn-sm">Revert</button></td></td>
           <?php
...
$('#exportdata').on('click', function() {
    ...
    url = '<?php echo base_url() ?>index.php/customer/fetch_data_get_ledger_view_export_commen?limit=10&deleteid=1&customer_id='+id+'&formdate='+fromdate+'&todate='+fromto+'&payment_status='+payment_status;
...
$scope.fetchDatagetlegderGroup = function(id,fromdate,fromto,payment_status){
    ...
    var fromto= $('#to-date').val();
    var payment_status= $('#payment_status').val();
    $http.get('<?php echo base_url() ?>index.php/customer/fetch_data_get_ledger_view_commen?limit=10&deleteid=1&customer_id='+id+'&formdate='+fromdate+'&todate='+fromto+'&payment_status='+payment_status).success(function(data){
...
$scope.fetchDatagetlegderGroupTotal = function(id,fromdate,fromto,payment_status){
    ...
    var payment_status= $('#payment_status').val();
    $http.get('<?php echo base_url() ?>index.php/customer/fetch_data_get_ledger_view_total_commen?limit=10&deleteid=1&customer_id='+id+'&formdate='+fromdate+'&todate='+fromto+'&payment_status='+payment_status).success(function(data){

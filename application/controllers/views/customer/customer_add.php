                              ...
                              <select class="form-control1"  ng-change="Seletvendor()" data-trigger ng-model="seletvendor" name="choices-single-default"
                               ...
                               <div class="col-md-4" >
                                 ...
                                 <label class="radio-inline">
                                  ...
                                  <input type="radio" name="optradio"   value="1" id="active"> Both
                                  
                                  
                                </label>
                                <label class="radio-inline">
                                  <input type="radio" name="optradio" checked value="0" id="inactive"> Customer
                                </label>
                                
                                <label class="radio-inline">
                                  <input type="radio" name="optradio"  value="-1" id="inactive"> Vendor
                                </label>
...
<div id="section1Content" class="accordion-collapse collapse show" aria-labelledby="section1Header" data-bs-parent="#section1Content" style="">
  ...
  <select class="form-control checkallbox" required data-section="20"  ng-model="state" name="state" id="state"   ng-init="dateGET1('state')">
                          ...
                          <div class="form-group row">
                            ...
                            <div class="col-sm-12">
                                                          ...
                                                          <select class="form-control checkallbox" data-section="20" required ng-model="zone" name="zone" id="zone" ng-init="dateGET2('zone')">
  ...
  <select class="form-control checkallbox" required  data-section="20" ng-model="district" name="district" id="district" ng-init="dateGET3('district')">
                        ...
                        <div class="col-md-3">
                          <div class="form-group row">
                            <label class="col-sm-12 col-form-label">Taluk <span style="color:red;">*</span></label>
                            <div class="col-sm-12">

                                                          <select class="form-control checkallbox" data-section="20" required  ng-model="city" name="city" id="city" ng-init="dateGET4('city')">
                 ...
                 <input type="text" class="form-control checkallbox" data-section="20" ng-model="locality" ng-keyup="completeLocalty()" ng-blur="Getroute()" required placeholder="Search locality"  id="localitybase">
                     ...
                     <!--     <div class="col-md-3">
                          <div class="form-group row">
                            ...
                            <div class="col-sm-12">
                              <input id="pincode" data-section="20" class="form-control checkallbox" ng-blur="getpencodeDetails($event)" name="pincode" required ng-model="pincode" type="text">
                            </div>
                          </div>
                        </div>
                        <div class="col-md-3">
    ...
    <i class="mdi mdi-plus-circle font-size-18 right-bar-toggle" style="cursor: pointer;" onclick="return add_rowprice();"></i>
                       ...
                       <div class="col-md-3" >
                          <div class="form-group row">
                            ...
                            <div class="col-sm-12">
                             <select class="form-control checkallbox" data-section="29" name="sales_group" required ng-model="sales_group">

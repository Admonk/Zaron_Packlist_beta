                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between pb-2">
                                    <h4 class="mb-sm-0 font-size-16">Customer ledger</h4>
                    ...
                    <div class="col-lg-12" >
                      <form>
                          <div class="row">
                            ...
                            <div class="col">
                              <input type="date" class="form-control" id="from-date" min="<?php echo date('Y-07-01'); ?>" value="<?php echo date('Y-07-01',strtotime("-1 year")); ?>">
                            </div>
                            <div class="col">
                            ...
                            <div class="col" style="display:none;">
                             ...
                             <button type="button" class="btn btn-success waves-effect waves-light" id="exportdata" >Export</button>
                              ...
                              <a href="<?php echo base_url(); ?>index.php/customer/ledger_find_delete_log?customer_id={{c_id}}" target="_blank"> Log</a>
                                    ...
                                    <div class="card-body py-1">
                                        <div class="d-flex align-items-center">
                                            <div class="flex-grow-1">
                                                <h4 class="text-muted mb-3 font-size-14 lh-1 d-block text-truncate"><b>Total Debit</b>
                            ...
                            <div class="col-xl-3 col-md-4 ">
                                ...
                                <div class="card shadow-none card-h-50 mb-0">
                                    ...
                                    <div class="card-body py-1">
                                        <div class="d-flex align-items-center">
                                            <div class="flex-grow-1">
                                                <h4 class="text-muted mb-3 font-size-14 lh-1 d-block text-truncate"><b>Total Credit</b>
                      ...
                      <thead>
                        ...
                        <tr  class="trpoint" >
                           ...
                           <b style="color:#ff5e14;" ng-if="namesvv.name">{{namesvv.name}} <br></b>
                            <a href="<?php echo base_url(); ?>index.php/customer/ledger_find?customer_id={{namesvv.customer_id}}" target="_blank">{{namesvv.company_name}}</a></td>
                           <td><a href="<?php echo base_url(); ?>index.php/customer/ledger_find?customer_id={{namesvv.customer_id}}" target="_blank"><span ng-if="namesvv.opening_balance!=0">{{namesvv.opening_balance | number}} {{namesvv.payment_status}}</span></a></td>
                           ...
                           <td>
                             <a href="<?php echo base_url(); ?>index.php/customer/ledger_find?customer_id={{namesvv.customer_id}}" target="_blank"><span  ng-if="namesvv.getstatus==1" style="color:red">{{namesvv.balance | number}}</a></span>
...
$('#exportdata').on('click', function() {
    ...
    url = '<?php echo base_url() ?>index.php/customer/fetch_data_get_ledger_view_export_group?limit=10&customer_id='+id+'&formdate='+fromdate+'&todate='+fromto+'&payment_status='+payment_status;
...
app.filter('number', function () {        
    return function (input) {
        if (! isNaN(input)) {
            ...
            return parseFloat(currencySymbol + output).toFixed(2);
        }
    }
});

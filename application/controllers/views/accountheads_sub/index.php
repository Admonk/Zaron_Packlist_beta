 ...
 <div class="row">
                       ...
                       <div class="col-md-3" >
                          <div class="form-group row">
                            <label class="col-sm-5 col-form-label">Primary Group </label>
                            <div class="col-sm-7">
                         ...
                         <div class="col-md-3" style="display:none;">
                          <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                              <input id="balance" class="form-control"   ng-model="balance" name="balance" type="text">
...
<hr></hr>
<h4 class="mb-sm-0 font-size-18">Sub Group List</h4>      
<br>
...
<?php
                       ...
                       if($this->session->userdata['logged_in']['access']=='1' || $this->session->userdata['logged_in']['access']=='15' || $this->session->userdata['logged_in']['access']=='28')
                       {

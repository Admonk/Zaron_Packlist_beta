                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    <h4 class="mb-sm-0 font-size-18">Excess Return Entry </h4>
...
$(document).ready(function(){
    ...
    $('.payment_mode').on('change',function(){
      ...
      if(val=='NEFT/RTGS' ||  val=='Cheque')
      {
          ...
          var data='<option value="0">Select Bank</option><option value="0">Select Bank</option> <?php foreach($bankaccount as $val) { if($val->id!=25 && $val->id!=24) { ?> <option value="<?php echo $val->id ?>"><?php echo $val->bank_name ?>-<?php echo $val->account_no ?></option> <?php } } ?>';

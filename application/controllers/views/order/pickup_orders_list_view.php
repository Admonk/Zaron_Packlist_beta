                                                ...
                                                <div class="tab-content twitter-bs-wizard-tab-content">
                                                    <div class="tab-pane" id="progress-seller-details">
                                                       ...
                                                       <a  target="_blank" href="<?php echo base_url(); ?>index.php/order/overview?order_id=<?php echo base64_encode($id); ?>&old_tablename=orders_quotation&old_tablename_sub=order_product_list_quotation&tablename=orders_process&tablename_sub=order_product_list_process&movetablename=orders_process&movetablename_sub=order_product_list_process" >Download</a> 
                                                                  ...
                                                                  <p><span>Balance </span><span> Rs. {{loadtotalamount}}</span></p>
                                       ...
                                       <thead class="bg-gray text-red" ng-if="namecate.categories_id==1">
                                          ...
                                          <tr>
                                             ...
                                             <th class="table-width-10" data-priority="6" rowspan="2" ng-click='sortColumn("rate_tab")' ng-class='sortClass("rate_tab")'>Rate </th>
                                              ...
                                              <th class="table-width-10" data-priority="6" rowspan="2" ng-click='sortColumn("qty_tab")' ng-class='sortClass("qty_tab")'>Actual_QTY </th>
                                             ...
                                             <th class="table-width-10 comdisplay" rowspan="2" ng-if="commission_check==1" data-priority="6" ng-click='sortColumn("commission_tab")' ng-class='sortClass("commission_tab")'> Commission </th>
                                              <th class="table-width-10" data-priority="6" rowspan="2" ng-click='sortColumn("amount_tab")' ng-class='sortClass("amount_tab")'>Actual_Amount </th>
                                          ...
                                          <tr  ng-style="name.rate_edit == 1 && {'color':'red'}"    class="view" ng-if="namecate.categories_id==name.categories_id_get && namecate.type==name.type">
                                            ...
                                            <input type="hidden"  value="{{name.product_id}}"  id="ppid_{{name.id}}">
                                             ...
                                             <td data-label="Nos">
                                                 ...
                                                 {
                                                     ?>
                                                     <span ng-if="name.nos_tab>0">
                                                       <input type="text" <?php echo $readdriver; ?> ng-keyup="inputsave_1(name.id,'nos',namecate.categories_id,namecate.type)" style="border: #bbbbbb solid 2px;"   data-val="{{name.nos_tab}}" class="nos_{{namecate.categories_id}}" id="nos_{{name.id}}" value="{{name.nos_tab}}">
                                            ...
                                            <td ng-if="namecate.labletype!=9"><span  ng-if='name.loadnos!=0' class="loadamount">{{name.loadnos}}</span></td> 
                                             ...
                                             <td data-label="Action" class="last-colorchange">
                                                                                                         ...
                                                                                                         <span ng-if="name.loadstatus==1">
                                                                                                           ...
                                                                                                           <label for="set_id{{name.id}}" title="Delivered" ng-if="name.delivery_status==1"><input type="checkbox" disabled checked value="{{name.id}}" id="set_id{{name.id}}" ng-click="loadProduct(name.id)" class="loaditems" name="loaditems"> <span id="textchange_{{name.id}}">Loaded</span></label>
                                                                                                            <label for="set_id{{name.id}}"  ng-if="name.delivery_status==0"><input type="checkbox"  checked value="{{name.id}}" id="set_id{{name.id}}" ng-click="loadProduct(name.id)" class="loaditems" name="loaditems"> <span id="textchange_{{name.id}}">Loaded</span></label>
                                            ...
                                            <td   style="display:none;" data-label="Fact"><input type="text" <?php echo $read; ?>  ng-keyup="inputsave_1(name.id,'fact',namecate.categories_id,namecate.type)" id="fact_{{name.id}}" value="{{name.fact_tab}}"></td>
                                             ...
                                             <td data-label="Action" class="last-colorchange">
                                                        ...
                                                        <div class="col-md-12">
                                                          ...
                                                          <li class="float-end"><a href="javascript: void(0);" class="btn btn-primary"  ng-click="Proceedtocomplete_only_save()"   data-bs-toggle="modal"
                                                                    data-bs-target=".confirmModal"><i class="mdi mdi-thumb-up pe-1"></i>Save</a></li>
                                                        </ul>
                                                          ...
                                                          <li class="float-end"><a href="javascript: void(0);" class="btn btn-primary"  ng-click="Proceedtocomplete()"   data-bs-toggle="modal"
                                                                    data-bs-target=".confirmModal"><i class="mdi mdi-thumb-up pe-1"></i>Save & Complete  </a></li>
                                                        </ul>
                                                            </div>
          ...
          $('.loaditems').each(function () {
                ...
                $('#textchange_'+id).text('Loaded');
                 ...
                 $http({
                    ...
                    data:{'id':id,'status':status,'driver_pickip':'<?php echo $driver_pickip; ?>', 'action':'loadstatus'}
...
$scope.inputsave_1 = function (id,inputname,categories_id,type) {
                      ...
                      else
                      {
                       ...
                       $http({
                          ...
                          data:{'totalammt':totalammt,'rate':rate,'qty':sqt_qty,'nos':values,'id':id,'action':'Loadinsertproductdata'}
                        }).success(function(data){
...
$scope.fetchData = function(){
    ...
    $http.get('<?php echo base_url() ?>index.php/order/fetch_data_delivery_data_by_load?order_id=<?php echo $id; ?>&driver_pickip=<?php echo $driver_pickip; ?>&tablenamemain=<?php echo 'orders_process'; ?>&tablename_sub=<?php echo 'order_product_list_process'; ?>&convert=1').success(function(data){

...
<div  class="row collapse" id="collapse{{namesd.trip_id}}"  aria-labelledby="heading{{namesd.trip_id}}" data-bs-parent="#accordionExample">
                              ...
                              <div class="card task-box" id="uptask-2">
                                 <div class="card-body p-0">
                                    ...
                                    <div class="p-3 {{names.color}}">
                                       <h5 class="font-size-14 mb-0" style="text-transform: uppercase;">

                                        <a href="javascript: void(0);" class="text-dark" id="task-name" style="display: flex;"> 

                                        <input type="text" value="{{names.sort_id}}" style="width: 70px;margin: -10px 8px;text-align: center;" class="setsort_id" id="sort_id_{{names.id}}" ng-keyup="sortidchange(names.id)" >  {{names.company_name}} ({{names.order_no}})</a>

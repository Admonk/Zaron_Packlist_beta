                                             ...
                                             <div class="card-header align-items-start d-flex p-3">
                                                <div class="flex-shrink-0">
                                                   <ul class="nav justify-content-end nav-tabs-custom rounded card-header-tabs" role="tablist" ng-init="getcount('orders_process')">
                                                      ...
                                                      <li class="nav-item">
                                                         <a class="nav-link active" data-bs-toggle="tab" href="#messages2" role="tab" ng-click="pageTab('orders_process',20)">
                                                       ...
                                                       <li class="nav-item">
                                                         <a class="nav-link" data-bs-toggle="tab" href="#messages2" role="tab" ng-click="pageTab('orders_process',21)">
                                                         <span class="d-block d-sm-none"><i class="far fa-envelope"></i></span>
                                                       ...
                                                       <li class="nav-item">
                                                         <a class="nav-link" data-bs-toggle="tab" href="#messages2" role="tab" ng-click="pageTab('orders_process',22)">
                                                         <span class="d-block d-sm-none"><i class="far fa-envelope"></i></span>
                                                       ...
                                                       <li class="nav-item">
                                                         <a class="nav-link" data-bs-toggle="tab" href="#messages2" role="tab" ng-click="pageTab('orders_process',23)">
                                                         <span class="d-block d-sm-none"><i class="far fa-envelope"></i></span>
                                                       ...
                                                       <li class="nav-item">
                                                         <a class="nav-link" data-bs-toggle="tab" href="#messages2" role="tab" ng-click="pageTab('orders_process',121)">
                                                         <span class="d-block d-sm-none"><i class="far fa-envelope"></i></span>
                                                       ...
                                                       <li class="nav-item">
                                                         <a class="nav-link" data-bs-toggle="tab" href="#messages2" role="tab" ng-click="pageTab('orders_process',26)">
                                                         <span class="d-block d-sm-none"><i class="far fa-envelope"></i></span>
...
$scope.fetchorderidDetails = function(tabelename,status,id){
  ...
  $scope.c5rs_s = data.c5rs_s;
   ...
   function getData() {
     ...
     $http.get('<?php echo base_url() ?>index.php/order/fetch_data_table_md_approved_request?page=' + $scope.currentPage + '&size=' + $scope.pageSize + '&search=' + $scope.searchText + '&tablename=' + $scope.tablename+'&edit_by=' + edit_by+'&order_base='+order_base)
...
$scope.onPre = function(currentPage,pageSize){
  ...
  function getDataPage(currentPage,pageSize) {
        ...
        $http.get('<?php echo base_url() ?>index.php/order/fetch_data_table_md_approved_request?page_next=' + currentPage + '&size=' + pageSize + '&search=' + $scope.searchText + '&tablename=' + $scope.tablename+'&edit_by=' + edit_by +'&order_base='+order_base)
        .success(function(data) {
            $scope.namesData = [];
            $scope.totalItems = data.totalCount;

                                                            ...
                                                            <div class="row">
                                                                 ...
                                                                 <div class="col-lg-12">
                                                                              <div class="border rounded gray p-2">
                                                                                 ...
                                                                                 <h4 class="card-title mb-4">QC Approved List</h4>
                                                                                 <div id="task-1">
                                                                                    <div id="upcoming-task" class="pb-1 task-list" ng-init="procseeGroupcompleted(<?php echo $status; ?>)">
                                                                                       ...
                                                                                       <div class="row" style="padding: 5px 21px;"   ng-init="fetchDatacompleted(<?php echo $status; ?>)">
                                                                                         ...
                                                                                         <div class="col-lg-3">
                                                                                             <div class="text-center d-grid">
                                                                                               <a href="javascript: void(0);" class="btn btn-success waves-effect waves-light addtask-btn" ng-click="processStatuschages(5)"> Proceed to Delivery </a>
                                                                                            </div>
                                                                                         </div>
                                                                                           ...
                                                                                           <table class="table mb-0" >
                                                                                                ...
                                                                                                <tbody  ng-repeat="name in namesDatacompleted">
                                                                                                    ...
                                                                                                    <tr ng-if="namecate.categories_id==name.categories_id_get && namegroup.proudtcion_id==name.proudtcion_id"  id="show_{{name.labelid}}" class="trpoint">
                                                                                                        ...
                                                                                                        <td>
                                                                                                            <b>{{name.bay_info}}</b>&nbsp;&nbsp;&nbsp;
                                                                                                            <select  style="padding: 3px;"  name="bay_info" ng-change="onChangebay(name.labelid)"  ng-model="bay_info" id="bay_info_{{name.labelid}}">
                                                                                                         ...
                                                                                                         <td>
                                                                                                          ...
                                                                                                          <b>{{name.bin_info}}</b>&nbsp;&nbsp;&nbsp;
                                                                                                              <select style="padding: 3px;"  name="bin_info" ng-change="onChangebin(name.labelid)" ng-model="bin_info"  id="bin_info_{{name.labelid}}">
                                                                              <option value="">Select</option>
                                                                              <?php
                                                                                  for($j=0;$j<$val;$j++)
                                                                                   {
...
app.controller('crudController', function($scope, $http){
 ...
 $scope.routeOrder = function(id,name) {
   ...
   $scope.fetchRouteorderassignorder('orders_process',4,id,1);
    ...
    if(confirm("Are you sure you want to Start?"))
    {
      $http({
        ...
        $scope.error = false;
         ...
         $scope.fetchRouteorderassignorder('orders_process',4,0,1);
      }); 
    }
};


$scope.onChangebay = function(id){
    
    var value = $("#bay_info_"+id+" option:selected").val();
    
      $http({
        method:"POST",
        url:"<?php echo base_url() ?>index.php/order/insertandupdate",
        data:{'id':id,'value':value, 'action':'bayinfocnage','tablenamemain':'proudtcion_order_products'}
      }).success(function(data){
...
$scope.onChangebin = function(id){
    
    var value = $("#bin_info_"+id+" option:selected").val();
    
      $http({
        method:"POST",
        url:"<?php echo base_url() ?>index.php/order/insertandupdate",
        data:{'id':id,'value':value, 'action':'bininfocnage','tablenamemain':'proudtcion_order_products'}
      }).success(function(data){

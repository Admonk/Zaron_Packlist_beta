...
<div id="invoice" class="invoice-6 invoice-content" >
 ...
 <th  ng-if="namecate.labletype==19" >Remarks
  ...
  <th  ng-if="namecate.labletype==19" >Coil_no 
                                             ...
                                             <th   ng-if="namecate.labletype!=9">Default_UOM</th>
...
//}
  ...
  $scope.fetchData = function(id){
    ...
    $http.get('<?php echo base_url() ?>index.php/Order_second/fetch_data_delivery_note?attachment_status=0&order_id=<?php echo $order_id; ?>&tablenamemain=<?php echo $tablename; ?>&tablename_sub=<?php echo $tablename_sub; ?>&convert='+id).success(function(data){
  ...
  $scope.fetchDataCategorybase = function(id){
    ...
    $http.get('<?php echo base_url() ?>index.php/Order_second/fetchDataCategorybase_delevery_notes?attachment_status=0&order_id=<?php echo $order_id; ?>&tablenamemain=<?php echo $tablename; ?>&tablename_sub=<?php echo $tablename_sub; ?>&convert='+id).success(function(data){

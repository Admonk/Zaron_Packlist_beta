                                        ...
                                        <i class="bx bx-search search-icon"></i>
                                                                  ...
                                                                  <tbody>
                                                                      ...
                                                                      <tr  ng-repeat="name in namesData2">
                                                                          ...
                                                                          <td><a href="<?php echo base_url(); ?>index.php/order/ordercreate_product_quotation?order_id={{name.base_id}}">{{name.order_no}}</a></td>
                                                                          <td><a href="<?php echo base_url(); ?>index.php/order/ordercreate_product_quotation?order_id={{name.base_id}}">{{name.name}} <br> {{name.phone}}</a></td>

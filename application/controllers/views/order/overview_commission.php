                                ...
                                <div class="row">
                                    ...
                                    <div class="col company-details" style="margin: auto;    background: #f9f9f9;    padding: 20px;">
                                       <p style="font-size: 16px;font-weight: 700; ">  <span style="    color: #ff5e14;">GST NO: </span> 33AAAFZ8146Q1ZI </p>
                                                   ...
                                                   <p ng-if="payment_mode" class="font-size-11" style="text-align: end;"><b>  Payment Mode : </b> {{payment_mode}} </p> 
                                    </div>
                                </div>
...
<hr style="color: #c3c3c3;"></hr>
                    ...
                    <div class="invoice-info">
                         <div class="row">
                            <div class="col-md-3 invoice-to">
                                ...
                                <div class="col-md-3 invoice-details" ng-init="fetchCustomerorderdata()">
                                    <h4 class="inv-title-1">Billing Address</h4>
                                                <p class="invo-addr-1" > {{customername_data}}</p>
                                                <p class="invo-addr-1" > {{company_phone_data}}</p>
                                                <p class="invo-addr-1" > {{address_data}}</p>
                                                    
                                                   
                                </div>
                                <div class="col-md-3 invoice-details">
                                    <h4 class="inv-title-1">Delivery Adress </h4>
                                    <p class="invo-addr-1"> {{delivery_address}}</p>
                                     <p>Contact Person : {{company_name_refer}} </p>
                                     <p>Phone : {{phone_refer}} <span ng-if="phone2">, {{phone2}}</span></p>
                                ...
                                <div class="col-md-3 invoice-details">
                                     <p class="inv-title-1" class="font-size-14">Order No:  {{order_no_id}}  <b ng-if="SSD_check>0" class="font-size-30" style="color: red;border: #d9d9d9 solid 2px; padding: 2px 9px;">  SDP  </b></p> 
                                                    
                                    <p class="invo-addr-1" class="font-size-14"> Date : {{create_date}}</p>
                                    
                                    <p ng-if="payment_mode" class="font-size-14" style="border: #d9d9d9 solid 2px;padding: 4px 9px;">Payment Mode :  {{payment_mode}} </p> 
                                    <p ng-if="locality_name" class="font-size-14"> Locality :  {{locality_name}} </p> 
                                    <p ng-if="route_name" class="font-size-14 ">  Route :  {{route_name}} </p> 
                                    <p ng-if="delivery_date_time" class="font-size-14 ">  Delivery Date :  {{delivery_date_time}} </p> 
                                    
                                    
                                    <p ng-if="salesname" class="font-size-14 ">  Sales Person :  {{salesname}} </p> 
                                    <p ng-if="salesphone" class="font-size-14 ">Sales Contact No : <span >{{salesphone}}</span> <span>{{salesphone2}}</span> </p> 
                                       ...
                                       <thead class="bg-gray text-red" ng-if="namecate.categories_id==1">
                                          ...
                                          <tr>
                                             ...
                                             <th class="table-width-10"  rowspan="2" >Amount </th>
                                               ...
                                               <th class="table-width-10" data-priority="6" colspan="3" ng-if="namecate.cate_status==1">Attachment</th>
 ...
 <th class="table-width-15" ng-if="namecate.labletype==19" >Remarks
  ...
  <th class="table-width-15" ng-if="namecate.labletype==19" >Coil_no 
                                             ...
                                             <th class="table-width-10"  ng-if="namecate.cate_status==1" data-priority="6" >Attachment</th>
                                          ...
                                          <tr class="view" ng-if="namecate.categories_id==name.categories_id_get && namecate.type==name.type">
                                             ...
                                             <td id="amount_{{name.id}}" class="amounttot_{{namecate.type}}">{{name.amount_tab}}</td>
                                                 ...
                                                 <span ng-if="name.reference_image!=''">
                                                  <br>
                                                  <a href="{{name.reference_image}}" style="margin: 15px 5px;" target="_blank"> <img src="{{name.reference_image}}" style="width: 100%;border: #4a4a4a solid 1px;" > </a>
                                                 </span>                                     
                                             </td>
                                       </tr>
                                         ...
                                         <td  ng-if="namecate.labletype==19">{{name.dim_two}}</td>  
                                           ...
                                           <tr ng-if="namecate.categories_id!=1">
                                             ...
                                             <th class="table-width-6" ng-if="namecate.labletype==12"></th>
                                                ...
                                                <th class="table-width-6" ng-if="namecate.labletype==9"></th>
                              ...
                              <table class="table invoice-table" ng-init="fetchSingleDatatotal('1')">
                                ...
                                <tr>
                                    ...
                                    <td>
                                                    ...
                                                    <p  class="text-end" style="font-size: 14px;margin-right: 25px;"><b>SubTotal : Rs. {{fulltotal-gsttotal | number : 2}}</b></p>
                                                    <p  class="text-end" style="font-size: 14px;margin-right: 25px;" ng-if="minisroundoff>0"><b>RoundOff : Rs. ({{roundoff_val}})  {{minisroundoff}}</b></p>
                                                    <p  class="text-end" style="font-size: 14px;margin-right: 25px;" ng-if="discounttotal>0"><b>Discount : Rs. {{discounttotal}}</b></p>
                                                    <p  class="text-end" style="font-size: 14px;margin-right: 25px;" ng-if="gst_check==1"><b>CGST 9 % : Rs. {{gsttotal/2 | number : 2}}</b> </p>
                                                    <p  class="text-end" style="font-size: 14px;margin-right: 25px;" ng-if="gst_check==1"><b>SGST 9 % : Rs. {{gsttotal/2 | number : 2}}</b> </p>
                                                    <p  class="text-end" style="font-size: 14px;margin-right: 25px;" ng-if="tcsamount>0"><b>TCS (+) : Rs. {{tcsamount}} </b></p>
                                                    <p  class="text-end" style="font-size: 14px;margin-right: 25px;" ng-if="roundoffstatusval_data"><b>Round : Rs. {{roundoffstatusval_data}} </b></p>
                                                    <p  class="text-end" style="font-size: 14px;margin-right: 25px;"><b>Net Total : Rs. {{discountfulltotal}} </b></p>
...
//}
  ...
  $scope.fetchDataCategorybase = function(id){
    ...
    $http.get('<?php echo base_url() ?>index.php/Order_second/fetchDataCategorybase?attachment_status=0&order_id=<?php echo $order_id; ?>&tablename_sub=<?php echo $tablename_sub; ?>&convert='+id).success(function(data){

                                    ...
                                    <div class="card" ng-repeat="names in namesData | filter:query">
                                          <div class="card-body" ng-click="getorderid(names.order_id,names.order_no)" ng-class="{activess : activeMenu === names.order_id}">
                                            ...
                                            <a href="#">
                                             ...
                                             <p class="text-muted float-end" ng-if="names.delivery_status_no==2">Trip End : {{names.trip_end_date}} {{names.trip_end_time}} <br></p>
                                    ...
                                    <div class="card" >
                                          <div class="card-body" ng-repeat="namesorderid in namesDataorderid">
                                              ...
                                              <span ng-if="namesorderid.payment_mode=='Cash'">   
                                                ...
                                                <!-- <p>Load Bill Amount : <b style="font-size:14px;" id="totalamountload">{{namesorderid.totalamountload}}</b></p>
                                                 -->
                                               ...
                                               <span  id="cash_payment_mode" class="{{payment_mode_by}}" >
                                                       ...
                                                       <tr style="color:red;font-weight:700;" ><td>Difference  </td><td></td><td><span  id="bal">{{namesorderid.fulltotalamount-denomination_totalexe | number : 0}}</tr>

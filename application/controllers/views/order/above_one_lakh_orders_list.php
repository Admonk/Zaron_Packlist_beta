                                             ...
                                             <div class="card-header align-items-start d-flex p-3">
                                                <div class="flex-shrink-0">
                                                   ...
                                                   <li class="nav-item ">
                                                         ...
                                                         <span class="d-sm-block">Above 1 lakh Enquiry List </span>   
                                                         </a>
                                                      </li> 
                                                      ...
                                                      <li class="nav-item ">
                                                         ...
                                                         <span class="d-sm-block">Above 1 lakh Quotation List </span>   
                                                         </a>
                                                      </li> 
                                                         ...
                                                         <span class="d-sm-block">Above 1 lakh Orders List </span>   
                                                         </a>
                                                      </li> 
                                                              ...
                                                              <table class="table align-middle table-nowrap newBorderedTable" >
                                                                  <thead>
                                                                      <tr>
                                                                          ...
                                                                          <th>Commission</th>
                                                                          <th>Total</th>
                                                                          <th ng-if="tabname == 'orders'">Ledger </th>
                                                                          <!--<th>Delivery</th>-->
                                                                  ...
                                                                  <tbody>
                                                                      ...
                                                                      <tr  ng-repeat="name in namesData" >
                                                                        ...
                                                                        <td ng-if="tabname == 'orders'">{{name.le_amount}}</td>
...
// console.log($scope.tabname)
  ...
  $scope.to_date = new Date();
   ...
   function getData() {
     ...
     $http.get('<?php echo base_url() ?>index.php/order/fetch_data_above_one_lakh?page=' + $scope.currentPage + '&size=' + $scope.pageSize + '&search=' + $scope.searchText + '&tablename=' + $scope.tablename+'&order_base='+order_base+'&from_date='+from_date+'&to_date='+to_date)
...
$scope.onPre = function(currentPage,pageSize){
  ...
  function getDataPage(currentPage,pageSize) {
      ...
      var to_date = $('#to_date').val();
        ...
        $http.get('<?php echo base_url() ?>index.php/order/fetch_data_above_one_lakh?page_next=' + currentPage + '&size=' + pageSize + '&search=' + $scope.searchText + '&tablename=' + $scope.tablename+'&order_base='+order_base+'&from_date='+from_date+'&to_date='+to_date)
        .success(function(data) {
            $scope.namesData = [];
            $scope.totalItems = data.totalCount;

                                    ...
                                    <table id="datatable_{{namecate.categories_id}}" class="table table-bordered dt-responsive  nowrap w-100 salestable" >
                                       ...
                                       <thead class="bg-gray text-red" ng-if="namecate.categories_id==1">
                                          ...
                                          <tr>
                                             ...
                                             {
                                              ?>
                                               <th class="table-width-10" data-priority="6" ng-if="namecate.uom=='Kg'" rowspan="2" ng-click='sortColumn("qty_tab")' ng-class='sortClass("qty_tab")'>Actual Kg <i class="fa fa-sort" aria-hidden="true"></i></th>
...
<input type="checkbox" name="checkinsert" ng-if="name.disabled==1" disabled  class="checkinsert fill_{{namecate.categories_id}}"  alt="{{name.product_id}}" ng-click="checkhidesortid(name.sorthide,name.id)"  value="{{name.id}}" id="nn_{{name.id}}">
                                            ...
                                            <input type="hidden"  value="{{name.product_id}}"  id="ppid_{{name.id}}">
                                             ...
                                             <td  ng-if="name.cate_status==1">
                                                 ...
                                                 <a href="#" class="btn btn-light" style="width: 120px;" ng-click="imgpreview(name.product_id,namecate.categories_id,name.id)" data-bs-toggle="modal" data-bs-target=".bs-example-modal-center">Choose Image</a>
                                             </td>
                                        ...
                                        <input type="checkbox" name="checkinsert" ng-if="name.disabled==0" class="checkinsert fill_{{namecate.categories_id}}" alt="{{name.product_id}}"     value="{{name.id}}" ng-click="checkhidesortid(name.sorthide,name.id)"  id="nn_{{name.id}}">
                                          ...
                                          <input type="checkbox" name="checkinsert" ng-if="name.disabled==1" disabled class="checkinsert fill_{{namecate.categories_id}}" alt="{{name.product_id}}"     value="{{name.id}}" ng-click="checkhidesortid(name.sorthide,name.id)"  id="nn_{{name.id}}">
                                            ...
                                            <input type="hidden"  value="{{namecate.categories_id}}"  id="cateid_{{name.id}}"> 
                                             ...
                                             <td  ng-if="namecate.labletype==4" data-label="Sub Products" ><input type="text" <?php echo $read1; ?> placeholder="Search Product" ng-keyup="completeProductSUb(name.id)"  ng-blur="inputsave_1(name.id,'tile_material_name',namecate.categories_id,namecate.type)"   id="tile_material_name_{{name.id}}" value="{{name.tile_material_name}}"></td>
                                        
                                        
                                        
                                         <td  ng-if="namecate.labletype==16" data-label="Sub Products" ><input type="text" <?php echo $read1; ?> placeholder="Search Product" ng-keyup="completeProductSUb(name.id)"  ng-blur="inputsave_1(name.id,'tile_material_name',namecate.categories_id,namecate.type)"   id="tile_material_name_{{name.id}}" value="{{name.tile_material_name}}"></td>
                                        
                                        
                                         <td  ng-if="namecate.labletype==19" data-label="Sub Products" ><input type="text" <?php echo $read1; ?> placeholder="Search Product" ng-keyup="completeProductSUb3(name.id)"  ng-blur="inputsave_1(name.id,'tile_material_name',namecate.categories_id,namecate.type)"   id="tile_material_name_{{name.id}}" value="{{name.tile_material_name}}"></td>

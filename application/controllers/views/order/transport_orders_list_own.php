                  ...
                  <div class="col-md-3">
                     <div class="tripset-sidebar w-100 ms-1" style="min-width: unset;">  
                        <div class="row">
                                ...
                                <h5 class="font-size-14 mb-3">Unassign Own Scope Orders  <button type="button" class="btn btn-success waves-effect waves-light" id="exportdata">Export</button> <br> <b style="color:#ff5e14;font-size: 11px;">{{route_name}}</b> </h5>
                                                        ...
                                                        <div class="modal-body">
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-12" ng-init="fetchtripids(0)">
                                                                   ...
                                                                   <option ng-repeat="trip in namesDatatripid" value="{{trip.trip_id}}">{{trip.trip_id}}</option>
...
$scope.assignTrip = function () {
    ...
    else
    {
            ...
            $http({
              method:"POST",
              url:"<?php echo base_url() ?>index.php/order/orderassign",
              data:{'sortingInput_data':sortingInput_data,'vehicle_id_data':vehicle_id_data,'trip_id':trip_id,'orderid_data':orderid_data,'tablenamemain':'orders_process'}
            }).success(function(data){

                                                              ...
                                                              <table class="table align-middle table-nowrap newBorderedTable" datatable="ng" dt-options="vm.dtOptions">
                                                                  ...
                                                                  <tbody>
                                                                      ...
                                                                      <tr  ng-repeat="name in namesData">
                                                                          ...
                                                                          <td><a href="<?php echo base_url(); ?>index.php/order/warehouse_check?order_id={{name.base_id}}&status={{name.order_base}}" >{{name.order_no}}</a></td>
                                                                          <td>{{name.name}}</td>
                                                                          <td>
                                                                             {{name.phone}}
                                                                          </td>
                                                                          ...
                                                                          <td>
                                                                                     ...
                                                                                     <a href="<?php echo base_url(); ?>index.php/order/warehouse_check?order_id={{name.base_id}}&status={{name.order_base}}" ><i class="mdi mdi-eye font-size-16 text-success me-1"></i> View</a>
...
$scope.getcount = function (tabelename) {
 ...
 $http({
      ...
      data:{'pincode':$scope.pincode}
            ...
            $scope.allprocess = data.production_qc_completed;

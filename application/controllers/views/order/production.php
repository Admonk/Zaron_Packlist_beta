                                                    ...
                                                    <div class="tab-pane" id="progress-seller-details">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-5 orderListWizardSideB">
                                                                    <div class="title p-3 pb-2 pt-2 justify-content-between">
                                                                        <h4 class="font-size-14 m-0">Date : </h4>
                                                                    ...
                                                                    <div class="mt-3 ps-2">
                                                                        ...
                                                                        <label> Coil No :
                                                                         <select class="coil" id="coilid" style="width:230px;padding: 3px;margin: 0px 10px;">
                                                                            ...
                                                                            {
                                                                                ?>
                                                                                 <option value="<?php echo $val->id; ?>"><?php echo $val->coil_no; ?> - QTY : <?php echo $val->inward_qty; ?></option>
                                                                        ...
                                                                        <table class="table mb-0" ng-init="fetchData('1')">
                                                                            ...
                                                                            <tbody  ng-repeat="name in namesData">
                                                                                ...
                                                                                <tr ng-if="namecate.categories_id==name.categories_id_get"    ng-click="viewGetprocess(name.id,name.product_name_tab,name.product_id)" id="show_{{name.id}}" class="trpoint">
                                                                                    ...
                                                                                    <td scope="row"><label >{{name.no}} </label></td>
                                                                                    <td style="width: 155px;"><label >{{name.product_name_tab}}</label></td>
                                                                                    <td><label >{{name.profile_tab}} </label></td>
                                                                                    <td ng-if="namecate.categories_id!=1"><label>{{name.crimp_tab}}</label></td>
                                                                                    <td><label >{{name.nos_tab}}</label></td>
                                                                                    
                                                                                    
                                                                                    <td>
                                                                                        
                                                                                        <span ng-if="name.production_start=='-1'" style="color:red;">Re-assign</span>
                                                                                        <span ng-if="name.production_start==0 && name.checked==0" style="color:red;">Yet To assign</span>
                                                                                        <span ng-if="name.production_start==1 && name.checked==1" style="color:green;">Process Start</span>
                                                                                         <span ng-if="name.production_start==2" style="color:green;">Progress Started</span>
                                                                                        <span ng-if="name.production_start==3" style="color:green;">Completed</span>
                                                                                        <span ng-if="name.production_start==4" style="color:green;">QC Approved</span>
                                                                                        <span ng-if="name.production_start==5" style="color:green;">Proceed to Delivered</span>
                                                                ...
                                                                <div class="col-7">
                                                                    <div class="text-start mb-2">
                                                                       <h5 class="wizard-title">Order Process Flow    
                                                                       <p style="text-align: right;color: red;font-weight: 800;">{{reason}}</p>
                                                                  </h5>
                                                                            ...
                                                                            <div class="tab-content p-3 text-muted">
                                                                                ...
                                                                                <div class="tab-pane active" id="accessories" role="tabpanel" style="height:400px;overflow: auto;">
                                                                                     ...
                                                                                     <div class="selectBox_production">
                                                                                        <div class="selectBoxFlex" id="sortableProduction" >
                                                                                            
                                                                                            
                                                                                            <div class="selectBoxInline checkedTrue" ng-repeat="nameprocess in fetchprocessproductdata" id="hide_{{nameprocess.order_product_id}}">
                                                        ...
                                                        <hr>
                                                                   ...
                                                                   <span ng-if="production_assign==0">
                                                                        ...
                                                                        <li class="next"><a href="javascript: void(0);" class="btn btn-primary w-md" onclick="nextTab()" ng-click="startProcess(1)">Start Production</a></li>
                                                                    </ul>
                                                                    </span>
                                                                    
                                                                    <span ng-if="production_assign>0">
                                                                         <ul class="pager wizard twitter-bs-wizard-pager-link production-link-wizard">
                                                                        <li class="next"><a href="javascript: void(0);" class="btn btn-success w-md" onclick="nextTab()" ng-click="startProcess(1)"> Production Started</a></li>
                                                                    </ul>
                                                                    </span>
...
$scope.startProcess = function(status){
     ...
     $http({
        method:"POST",
        url:"<?php echo base_url() ?>index.php/order/insertandupdate",
        data:{'status':status,'reason':'Production Started','action':'process_status_assign','order_product_id':order_product_id,'product_id':'<?php echo $product_id; ?>','tablenamemain':'order_product_list_process'}
      }).success(function(data){
          
           
           alert('Production Started');
           $scope.fetchSingleDatatotal();
           window.location.assign("<?php echo base_url(); ?>index.php/order/production_panel?product_id=<?php echo $product_id; ?>");
...
$scope.addProcess = function(name,id){
        ...
        if($('.accCheckbox').prop('checked') == true) 
        {
               ...
               var order_product_id= order_product_id_set_value.join("|");
                 ...
                 $http({
                    method:"POST",
                    url:"<?php echo base_url() ?>index.php/order/insertandupdate",
                    data:{'order_product_id':order_product_id,'name':name,'id':id,'order_id':'<?php echo $product_id; ?>', 'action':'addprocessloop','tablenamemain':'proudtcion_order_products'}
                  }).success(function(data){
        ...
        else
        {
                 ...
                 $http({
                    method:"POST",
                    url:"<?php echo base_url() ?>index.php/order/insertandupdate",
                    data:{'order_product_id':order_product_id,'product_id':product_id,'name':name,'id':id,'order_id':'<?php echo $product_id; ?>', 'action':'addprocess','tablenamemain':'proudtcion_order_products'}
                  }).success(function(data){
...
$scope.fetchProcessproduct = function(order_product_id){
      $http.get('<?php echo base_url() ?>index.php/order/fetch_data_order_process_by_production?tablename=proudtcion_order_products&order_product_id='+order_product_id+'&product_id=<?php echo $product_id; ?>').success(function(data){
...
//end
  ...
  $scope.fetchDataCategorybase = function(id){
    ...
    $http.get('<?php echo base_url() ?>index.php/order/fetchDataCategorybase_by_production?product_id=<?php echo $product_id; ?>&tablename_sub=<?php echo 'order_product_list_process'; ?>&convert='+id).success(function(data){
...
$scope.fetchData = function(){
    ...
    $http.get('<?php echo base_url() ?>index.php/order/fetch_data_by_production?product_id=<?php echo $product_id; ?>&tablenamemain=<?php echo 'orders_process'; ?>&&tablename_sub=<?php echo 'order_product_list_process'; ?>&convert=1').success(function(data){
                 ...
                 for(var i = 0; i < data.length; i++)
                 {
                     ...
                     //{
                          var cheid= data[i].id;
                     //}
                     order_product_id_set_value.push(cheid);
...
$scope.fetchSingleDatatotal = function(){
    $http({
      method:"POST",
      url:"<?php echo base_url() ?>index.php/order/fetch_production_details?product_id=<?php echo $product_id; ?>",

                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    <h4 class="mb-sm-0 font-size-18">Taluk Form</h4>

                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                           <li class="breadcrumb-item"><a href="<?php echo base_url(); ?>index.php/dashboard">Dashboard</a></li>
                                            <li class="breadcrumb-item active"> Taluk Form</li>
                                        </ol>
                                    </div>
...
<!-- <a href="<?php echo base_url(); ?>index.php/group/exportCity" style="float: right;">Export</a> -->
 ...
 <div class="row">
                  ...
                  <div class="col-md-3">
                          ...
                          <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                             <select class="form-control" name="district_id" required ng-model="district_id"  ng-model="seletvendor" 
                                                            id="choices-single-default"
                                                            placeholder="This is a search">
                         ...
                         <div class="col-md-3">
                          <div class="form-group row">
                            <label class="col-sm-4 col-form-label">Taluk name</label>
                            <div class="col-sm-8">
                              <input id="name" class="form-control" required  ng-model="name" name="name" type="text">
                               <small style="color:red;">Add multiple Taluk use ( , ) comma symbol</small>
                            </div>
                          </div>
                        </div>
...
<hr></hr>
<h4 class="mb-sm-0 font-size-18">Taluk List</h4>      
<br>
...
app.controller('crudController', function($scope, $http){
  ...
  $scope.fetchData = function(){
    $http.get('<?php echo base_url() ?>index.php/group/fetch_data_city').success(function(data){
  ...
  $scope.submitForm = function(){
    $http({
      ...
      data:{'name':$scope.name,'id':$scope.hidden_id,'route_id':$scope.route_id,'district_id':$scope.district_id,'action':$scope.submit_button,'tablename':'city'}
      ...
      if(data.error != '1')
      {
        ...
        $scope.name = "";
        $scope.hidden_id = "";
        $scope.successMessage = "City name successfully "+$scope.submit_button;
        $scope.fetchData();
...
$scope.fetchSingleData = function(id){
    $http({
      ...
      data:{'id':id, 'action':'fetch_single_data','tablename':'city'}
    }).success(function(data){
...
$scope.deleteData = function(id){
    if(confirm("Are you sure you want to remove it?"))
    {
      $http({
        method:"POST",
        url:"<?php echo base_url() ?>index.php/group/insertandupdate",
        data:{'id':id, 'action':'Delete','tablename':'city'}
      }).success(function(data){
        $scope.success = false;
        $scope.error = false;
        $scope.fetchData();

               ...
               <div class="d-flex">
                  <div class="topnav">
                     <div class="">
                              ...
                              <ul class="navbar-nav">
                                   ...
                                   <li class="nav-item dropdown">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="topnav-purchase">
                                     ...
                                     <a class="dropdown-item"  href="<?php echo base_url(); ?>index.php/purchase/purchase_return_list">Purchase Return</a>
                                      <a class="dropdown-item"  href="<?php echo base_url(); ?>index.php/purchase/purchase_complaints">Purchase Complaints</a>
                                 ...
                                 <li class="nav-item dropdown">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="topnav-more">
                                       ...
                                       <a class="dropdown-item"  href="<?php echo base_url(); ?>index.php/order/finance_orders_list">Reconciliation (other than cash)</a>
                                       <a class="dropdown-item"  href="<?php echo base_url(); ?>index.php/order/reconciliation_orders_list">Reconciliation Order List</a>
                                       
                                       <a class="dropdown-item"  href="<?php echo base_url(); ?>index.php/order/reconciliation_orders_list_self">Reconciliation Shop Order</a>
                                       
                                       
                                        <a class="dropdown-item"  href="<?php echo base_url(); ?>index.php/order/sales_return">Sales Return</a>
                                        <a class="dropdown-item"  href="<?php echo base_url(); ?>index.php/order/sales_complaints">Sales Complaints</a>
                           ...
                           <a class="dropdown-item"  href="<?php echo base_url(); ?>index.php/order/vehicle_wise_assigned"> Dispatch Load Vehicle Grouped</a>

  <a class="dropdown-item"  href="<?php echo base_url(); ?>index.php/order/pick_up_loading">Dispatch Process Flow</a>
                                     

                                       <a class="dropdown-item"  href="<?php echo base_url(); ?>index.php/order/transport_complated_list">Transport Order List</a>
                                      ...
                                      <a class="dropdown-item"  href="<?php echo base_url(); ?>index.php/order/mass_search">Mass Search By Order</a>
                                       <a class="dropdown-item"  href="<?php echo base_url(); ?>index.php/order/overall_list">Over All List</a>
 ...
 <div class="dropdown">
                 ...
                 <a class="dropdown-item"  href="<?php echo base_url(); ?>index.php/vehicle/vehicle_view">Vehicle List</a>
                  <a class="dropdown-item" href="<?php echo base_url(); ?>index.php/driver/driverview">Driver List</a>
                                       ...
                                       <a class="dropdown-item"  href="<?php echo base_url(); ?>index.php/accountheads">Others Ledger</a>
                                    ...
                                    <a class="nav-link dropdown-toggle arrow-none" href="#" id="topnav-ledger" role="button">
                                     ...
                                     <div class="dropdown">
                                          ...
                                          <div class="dropdown-menu" aria-labelledby="topnav-accountsmaster">
                                               ...
                                               <div class="dropdown" >
                                          <a class="dropdown-item dropdown-toggle arrow-none" href="#" id="topnav-accountsmaster" role="button">
                                              <span data-key="t-authentication">Accounts Report</span> 
                                             <div class="arrow-down"></div>
                                          </a>
                                          <div class="dropdown-menu" aria-labelledby="topnav-accountsmaster">
                                              ...
                                              <a class="dropdown-item" href="<?php echo base_url(); ?>index.php/manual_journals/newcreate">Manual Journal Entry</a>
                                              ...
                                              <a class="dropdown-item" href="<?php echo base_url(); ?>index.php/report/balancereport_base_ledger">Recent Ledger Transaction</a>
                                              ...
                                              <a class="dropdown-item" href="<?php echo base_url(); ?>index.php/driver/ledger">Driver Ledger</a>
                                               ...
                                               <a class="dropdown-item"  href="<?php echo base_url(); ?>index.php/purchase/purchase_list_po">PO Purchase Order</a>
  ...
  <a class="dropdown-item" href="<?php echo base_url(); ?>index.php/report/customer_balance_report">Customer Balance Report </a>
                                              ...
                                              <a class="dropdown-item" href="<?php echo base_url(); ?>index.php/report/vendor_purchase_report">Purchase Report</a>
                              ...
                              <ul class="navbar-nav">
                                 ...
                                 <li class="nav-item dropdown">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="topnav-more">
                                      ...
                                      <a class="dropdown-item"  href="<?php echo base_url(); ?>index.php/order/pick_up_loading">Dispatch PickUP / Loading</a>
                              ...
                              <nav class="navbar navbar-light navbar-expand-lg topnav-menu">
                                 ...
                                 <li class="nav-item dropdown">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="topnav-more">
                                       ...
                                       <a class="dropdown-item"  href="<?php echo base_url(); ?>index.php/order/ordercreate">Order Creation</a>
 ...
 <a class="dropdown-item" href="<?php echo base_url(); ?>index.php/report/customer_balance_report">Customer Balance Report </a>
                ...
                <a class="dropdown-item" href="<?php echo base_url(); ?>index.php/ticket/inbox">Compose</a>
                           ...
                           ?>
                             ...
                             <?php
                            // Salest Team
                             if($this->session->userdata['logged_in']['access']=='21')
                            {
                              ...
                              <nav class="navbar navbar-light navbar-expand-lg topnav-menu">
                                 ...
                                 <li class="nav-item dropdown">
                                    ...
                                    <i data-feather="home"></i><span data-key="t-dashboard">Dashboard</span>
                                       ...
                                       <li class="nav-item dropdown">
                                    <a class="nav-link dropdown-toggle arrow-none" href="#" id="topnav-more" role="button">
                                       <i data-feather="file-text"></i><span data-key="t-extra-pages">Dispatch</span> 
                                       <div class="arrow-down"></div>
                                    </a>
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="topnav-more">
                                           ...
                                           <a class="dropdown-item"  href="<?php echo base_url(); ?>index.php/order/vehicle_wise_assigned">Dispatch Load Vehicle Grouped</a>
                                         <a class="dropdown-item"  href="<?php echo base_url(); ?>index.php/order/pick_up_loading">Dispatch List</a>
                                     ...
                                     <div class="dropdown">
                                         ...
                                         <div class="dropdown" >
                                          ...
                                          <div class="dropdown-menu" aria-labelledby="topnav-accountsmaster">
                                              ...
                                              <a class="dropdown-item" href="<?php echo base_url(); ?>index.php/report/balancereport?type=1">Cash Report</a>
                                              <a class="dropdown-item" href="<?php echo base_url(); ?>index.php/report/accountsreport">Bank Account Report</a>
                                               <a class="dropdown-item" href="<?php echo base_url(); ?>index.php/report/profit_and_loss">Profit Or Loss</a>    <a class="dropdown-item" href="<?php echo base_url(); ?>index.php/report/trial_balance">Balance Sheet</a>
                                               <a class="dropdown-item" href="<?php echo base_url(); ?>index.php/report/trial_balance_full">Trial Balance</a>
                                               <!--<a class="dropdown-item" href="<?php echo base_url(); ?>index.php/report/salesreport"> Day Book </a>-->
 ...
 <div class="dropdown">
                 ...
                 <a class="dropdown-item"  href="<?php echo base_url(); ?>index.php/vehicle/vehicle_view">Vehicle List</a>
                  <a class="dropdown-item" href="<?php echo base_url(); ?>index.php/driver/driverview">Driver List</a>
                           ...
                           <?php
                             if($this->session->userdata['logged_in']['access']=='4' || $this->session->userdata['logged_in']['access']=='22')
                            {
                             ...
                             ?>
                              <nav class="navbar navbar-light navbar-expand-lg topnav-menu">
                                 ...
                                 <ul class="navbar-nav">
                                 <li class="nav-item dropdown">
                                    <a class="nav-link dropdown-toggle arrow-none" href="<?php echo base_url(); ?>index.php/purchase/purchase_list" id="topnav-dashboard" role="button">
                                    <i data-feather="home"></i><span data-key="t-dashboard">Dashboard</span>
                                    </a>
                                 </li>
                                 ...
                                 <li class="nav-item dropdown">
                                    <a class="nav-link dropdown-toggle arrow-none" href="#" id="topnav-more" role="button">
                                       <i data-feather="file-text"></i><span data-key="t-extra-pages">Vendors</span> 
                                       <div class="arrow-down"></div>
                                    </a>
                           ...
                           <?php
                             if($this->session->userdata['logged_in']['access']=='19')
                            {
                                 ...
                                 <li class="nav-item dropdown">
                                   ...
                                   <li class="nav-item dropdown">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="topnav-purchase">
                                     ...
                                     <a class="dropdown-item"  href="<?php echo base_url(); ?>index.php/purchase/purchase_list_inward">Purchase Inward Create</a>
                                     <a class="dropdown-item"  href="<?php echo base_url(); ?>index.php/purchase/purchase_inward_list">Inward List</a>
                                       <a class="dropdown-item"  href="<?php echo base_url(); ?>index.php/purchase/purchase_return_list">Purchase Return</a>
                                        <a class="dropdown-item"  href="<?php echo base_url(); ?>index.php/purchase/purchase_complaints">Purchase Complaints</a>

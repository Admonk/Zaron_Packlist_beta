                                 ...
                                 <li class="nav-item dropdown">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="topnav-more">
                                       ...
                                       <?php
                                                ...
                                                $neworder_id = base64_encode($neworder_id);
                                       
                                       ?>
                                       
                                       
                                       <a class="dropdown-item"  href="<?php echo base_url(); ?>index.php/purchase/purchase_ordercreate_product?order_id=<?php echo $neworder_id; ?>&sales_request=1">Sales Purchase Request</a>
                                       ...
                                       <a class="dropdown-item"  href="<?php echo base_url(); ?>index.php/order/reconciliation_orders_list_self">Reconciliation Self Order</a>
                                       
                                       
                                        <a class="dropdown-item"  href="<?php echo base_url(); ?>index.php/order/reconciliation_completed_list">Sales Return</a>

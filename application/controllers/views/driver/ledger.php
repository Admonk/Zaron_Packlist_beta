                                            ...
                                            <div class="table-responsive mt-3">
                                              ...
                                              <thead>
                                                ...
                                                <tbody  ng-repeat="names in namesDataledgergroup | filter:query |  orderBy:'name'" >
                                                    <tr class="setload" ><td colspan="5"><loading></loading></td></tr>
                                                    
                                                <tr  class="trpoint" >
                                                  
                                                   <td>{{names.no}}</td>
                                                   <td><a href="<?php echo base_url(); ?>index.php/driver/ledger_find?customer_id={{names.customer_id}}&driver_collection_status=<?php echo $driver_collection_status; ?>" target="_blank"><?php echo $text; ?> - {{names.name}}</a></td>
                                                  
                                                   
                                                   <td ><span ng-if="names.opening_balance>0"><a href="<?php echo base_url(); ?>index.php/driver/ledger_find?customer_id={{names.customer_id}}&driver_collection_status=<?php echo $driver_collection_status; ?>" target="_blank">{{names.opening_balance}} {{names.payment_status}}</a></span></td>

                                                  <td ><span ng-if="names.debits!=0"><a href="<?php echo base_url(); ?>index.php/driver/ledger_find?customer_id={{names.customer_id}}&driver_collection_status=<?php echo $driver_collection_status; ?>" target="_blank">{{names.debits | number}}</a></span></td>
                                                   <td ><span ng-if="names.credits!=0"><a href="<?php echo base_url(); ?>index.php/driver/ledger_find?customer_id={{names.customer_id}}&driver_collection_status=<?php echo $driver_collection_status; ?>" target="_blank">{{names.credits | number}}</a></span></td>
                                                   <td >
...
$('#exportdata').on('click', function() {
   ...
   var driver_collection_status= '<?php echo $driver_collection_status; ?>';
    url = '<?php echo base_url() ?>index.php/driver/fetch_data_get_ledger_view_export_group?limit=10&customer_id='+id+'&formdate='+fromdate+'&todate='+fromto+'&payment_status='+payment_status+'&driver_collection_status='+driver_collection_status;
...
var driver_collection_status= '<?php echo $driver_collection_status; ?>';
 ...
 $scope.loading = true;
    ...
    $http.get('<?php echo base_url() ?>index.php/driver/fetch_data_get_ledger_view_group?limit=10&customer_id='+id+'&formdate='+fromdate+'&todate='+fromto+'&payment_status='+payment_status+'&driver_collection_status='+driver_collection_status).success(function(data){

                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    <h4 class="mb-sm-0 font-size-18">Driver ledger Delete Log</h4>

                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                             <li class="breadcrumb-item"><a href="<?php echo base_url(); ?>index.php/dashboard">Dashboard</a></li>
                                            <li class="breadcrumb-item active">Driver ledger Delete Log!</li>
                                        </ol>
                                    </div>
                    ...
                    <div class="col-lg-12" >
                      ...
                      <form>
                          <div class="row">
                            ...
                            <div class="col">
                              <input type="date" class="form-control" id="from-date"  min="<?php echo date('Y-04-01'); ?>" value="<?php echo date('Y-m-01'); ?>">
                            </div>
                            <div class="col">
                                    ...
                                    <div class="card-body">
                                        <div class="d-flex align-items-center">
                                            <div class="flex-grow-1">
                                                <h3 class="text-muted mb-3 lh-1 d-block text-truncate"> Debit</h3>
                                                <h4 class="mb-3">
                            ...
                            <div class="col-xl-4 col-md-4">
                                ...
                                <div class="card card-h-50">
                                    ...
                                    <div class="card-body">
                                        <div class="d-flex align-items-center">
                                            <div class="flex-grow-1">
                                                <h3 class="text-muted mb-3 lh-1 d-block text-truncate"> Credit</h3>
                                                <h4 class="mb-3">
...
$('#exportdata').on('click', function() {
    ...
    url = '<?php echo base_url() ?>index.php/driver/fetch_data_get_ledger_view_export?limit=10&deleteid=1&customer_id='+id+'&formdate='+fromdate+'&todate='+fromto+'&payment_status='+payment_status;
...
$scope.fetchDatagetlegderGroup = function(id,fromdate,fromto,payment_status){
 ...
 $scope.loading = true;
    ...
    $http.get('<?php echo base_url() ?>index.php/driver/fetch_data_get_ledger_view?limit=10&deleteid=1&customer_id='+id+'&formdate='+fromdate+'&todate='+fromto+'&payment_status='+payment_status).success(function(data){
...
$scope.fetchDatagetlegderGroupTotal = function(id,fromdate,fromto,payment_status){
    ...
    $http.get('<?php echo base_url() ?>index.php/driver/fetch_data_get_ledger_view_total?limit=10&deleteid=1&customer_id='+id+'&formdate='+fromdate+'&todate='+fromto+'&payment_status='+payment_status).success(function(data){
  ...
  $scope.Getbalance3 = function () {
        ...
        var party=  $('#customerdata').val();
           ...
           $http({
		      ...
		      data:{'id':party, 'action':'fetch_single_data','tablename':'2'}
		    }).success(function(data){

...
class Purchase extends CI_Controller {
    ...
    function __construct() {
      ...
      public function checkIsExistPurchase_invoice_duplicate(){   
       ...
       $form_data = json_decode(file_get_contents("php://input"));  
        ...
        $invoice_no=$form_data->inovice_no;
        
        $result = $this->db->query("SELECT * FROM purchase_invoice where `invoice_no` = '".$invoice_no."' AND deleteid=0");
        // print_r($invoice_no);
        $array = array('status' => count($result->result()));
     ...
     public function fetch_data_address()
  {
     ...
     public function addresspoint()
    {
     ...
     public function fetch_single_data_total() {
        ...
        foreach ($resultdis as $valuedis) {
            ...
            $create_date_raw = $valuedis->create_date;
   ...
   $office_address = $this->Main_model->where_names_two_order_by('purchase_adddrss', 'id', $address_id, 'deleteid', '0', 'id', 'DESC');
        ...
        else
        {
             ...
             $office_address_phone='Ph: +91 73737 18307';
...
//        if($create_date_raw > '2024-05-31' && $tablenamemain == 'purchase_invoice'){
...
//        }                      
                     ...
                     if($tablename=='purchase_invoice')
                     {
                             $result= $this->Main_model->where_names($tablename,'id',$id);
                               foreach ($result as  $value) {
                                 ...
                                 $newModOrderNo= $value->invoice_no;
                                if($deleteval!='')
                                {
 ...
 $valusset=$newModOrderNo.'-DEL';
                    $this->db->query("UPDATE all_ledgers SET deleteid='1',order_no='".$valusset."',reference_no='".$valusset."',deleted_by='".$this->userid."',notes='Purchase Invoice Deleted' WHERE deletemod='".$deleteval."' AND party_type=3");


                     $sgstIn='SGST IN - '.$newModOrderNo;
                    $this->db->query("UPDATE all_ledgers SET deleteid='1',order_no='".$valusset."',reference_no='".$valusset."',deleted_by='".$this->userid."',notes='Purchase Invoice Deleted' WHERE customer_id='588'  AND order_no='".$newModOrderNo."' AND party_type=5  AND deletemod='".$sgstIn."'");

                       $cgstIn='CGST IN - '.$newModOrderNo;
                    $this->db->query("UPDATE all_ledgers SET deleteid=1,order_no='".$valusset."',reference_no='".$valusset."',deleted_by='".$this->userid."',notes='Purchase Invoice Deleted' WHERE customer_id='589'  AND order_no='".$newModOrderNo."' AND party_type=5  AND deletemod='".$cgstIn."'");

                       $igstIn='IGST IN - '.$newModOrderNo;
                    $this->db->query("UPDATE all_ledgers SET deleteid=1,order_no='".$valusset."',reference_no='".$valusset."',deleted_by='".$this->userid."',notes='Purchase Invoice Deleted' WHERE customer_id='590'  AND order_no='".$newModOrderNo."' AND party_type=5  AND deletemod='".$igstIn."'");


                     $roundoffset='ROUND-'.$newModOrderNo;
                    $this->db->query("UPDATE all_ledgers SET deleteid=1,order_no='".$valusset."',reference_no='".$valusset."',deleted_by='".$this->userid."',notes='Purchase Invoice Deleted' WHERE customer_id='372'  AND order_no='".$newModOrderNo."' AND party_type=5  AND deletemod='".$roundoffset."'");
                      ...
                      if($form_data->action=='Deletepurchase_invoice')
                 {
                     ...
                     $id=$form_data->id;
                     $this->Main_model->deleteupdate($id,$tablename);
                     $this->db->query("UPDATE $tablename SET deleted_by='".$this->userid."' WHERE id='".$id."'");
...
$this->db->query("UPDATE all_ledgers SET deleteid='25',deleted_by='".$this->userid."' WHERE deletemod='".$deleteval."'");


     $sgstIn='SGST IN - '.$newModOrderNo;
                    $this->db->query("UPDATE all_ledgers SET deleteid='25',deleted_by='".$this->userid."',notes='Purchase Invoice Deleted' WHERE customer_id='588'  AND order_no='".$newModOrderNo."' AND party_type=5  AND deletemod='".$sgstIn."'");

                       $cgstIn='CGST IN - '.$newModOrderNo;
                    $this->db->query("UPDATE all_ledgers SET deleteid='25',deleted_by='".$this->userid."',notes='Purchase Invoice Deleted' WHERE customer_id='589'  AND order_no='".$newModOrderNo."' AND party_type=5  AND deletemod='".$cgstIn."'");

                       $igstIn='IGST IN - '.$newModOrderNo;
                    $this->db->query("UPDATE all_ledgers SET deleteid='25',deleted_by='".$this->userid."',notes='Purchase Invoice Deleted' WHERE customer_id='590'  AND order_no='".$newModOrderNo."' AND party_type=5  AND deletemod='".$igstIn."'");
$roundfOffMod = 'ROUND-'.$newModOrderNo;
    $this->db->query("UPDATE all_ledgers SET deleteid='25',deleted_by='".$this->userid."',notes='Purchase Invoice Deleted' WHERE customer_id='372'  AND order_no='".$newModOrderNo."' AND party_type=5  AND deletemod='".$roundfOffMod."'");


    $loadingMod = 'LOADING-'.$newModOrderNo;
    $this->db->query("UPDATE all_ledgers SET deleteid='25',deleted_by='".$this->userid."',notes='Purchase Invoice Deleted' WHERE customer_id='605'  AND order_no='".$newModOrderNo."' AND party_type=5  AND deletemod='".$loadingMod."'");
        ...
        public function purchase_invoice_data()
    {
                         ...
                         $extra=$value->extra;
                                         ...
                                         for ($i=0; $i <count($purchase_order_product_id) ; $i++) { 
                                            ...
                                            if($datadd['qty']>0)
                                            {
                                                ...
                                                $netamount_val+=$purchase_qty_data[$i]*$purchase_price_data[$i];
                ...
                $loadChargenotes = 'Loading Charge - Purchase Invoice '.$form_data->inovice_no;
                $loadChargeorder_no = $form_data->inovice_no;
                $loadChargedeletemod = 'LOADING-'.$loadChargeorder_no;
                $vendor_base_id = $vendor_id;
                $vendorName = $this->db->query("SELECT name FROM `vendor` WHERE `id` = '$vendor_base_id' ")->row();
                $vendorName = $vendorName->name;

                $data_loadCharge['order_id'] = 0;
                $data_loadCharge['customer_id'] =605;
                $data_loadCharge['user_id'] = $this->userid;
                $data_loadCharge['notes'] = $loadChargenotes;
                $data_loadCharge['deletemod'] = $loadChargedeletemod;
                $data_loadCharge['credits'] =  0;
                $data_loadCharge['debits'] =  $loading_charges;
                $data_loadCharge['order_no'] = $loadChargeorder_no;
                $data_loadCharge['reference_no'] = $loadChargeorder_no;
                $data_loadCharge['party_type'] = 5;
                $data_loadCharge['account_head_id'] = 402;
                $data_loadCharge['account_heads_id_2'] = 402;
                $loadChargecreate_date = date('Y-m-d');
                $loadChargecreate_time = date('h:i A');
                $data_loadCharge['payment_date'] = $loadChargecreate_date;
                $data_loadCharge['payment_time'] = $loadChargecreate_time;
                $data_loadCharge['bank_id'] = 0;
                $data_loadCharge['dummy_customer_name'] = $vendorName;
                $data_loadCharge['deleteid'] = 0;



                 $this->Main_model->insert_commen($data_loadCharge , 'all_ledgers');  
                                         ...
                                         if($form_data->roundoff>0)
                                         {
                                            // $roundOff = $form_data->roundoff;
                                                     ...
                                                     else
                                                     {
                                                         $netamount=$netamount-$form_data->roundoff;
                                                          $roundOffcredits = 0;
                                                            $roundOffdebits = $entry->roundoff;
                                                     }

                                                       $roundOffnotes = 'Round off - Purchase Invoice '.$form_data->inovice_no;
                $roundOfforder_no = $form_data->inovice_no;
                // $user_id = $entry->user_id;
                $roundOffdeletemod = 'ROUND-'.$roundOfforder_no;

                                                               $data_roundoff['order_id'] = 0;
                $data_roundoff['customer_id'] =372;
                $data_roundoff['user_id'] = $this->userid;
                $data_roundoff['notes'] = $roundOffnotes;
                $data_roundoff['deletemod'] = $roundOffdeletemod;
                $data_roundoff['credits'] =  $roundOffcredits;
                $data_roundoff['debits'] =  $roundOffdebits;
                $data_roundoff['order_no'] = $roundOfforder_no;
                $data_roundoff['reference_no'] = $roundOfforder_no;
                $data_roundoff['party_type'] = 5;
                $data_roundoff['account_head_id'] = 372;
                $data_roundoff['account_heads_id_2'] = 372;
                 $roundOffcreate_date = date('Y-m-d');
                  $roundOffcreate_time = date('h:i A');
                $data_roundoff['payment_date'] = $roundOffcreate_date;
                $data_roundoff['payment_time'] = $roundOffcreate_time;
                $data_roundoff['bank_id'] = 0;
                $data_roundoff['deleteid'] = 0;
                 ...
                 $this->Main_model->insert_commen($data_roundoff , 'all_ledgers');      
                                         ...
                                         $this->db->query("UPDATE $tablename SET qty='".$netweight."',invoice_amount='".$netamount."',deletemod='PC".$insert_id."' WHERE id='".$insert_id."'");
                                                                ...
                                                                $data_driver['credits_sub_total']=$netamount_val;
                                                                $data_driver['user_id']=$this->userid;
                                                                $data_driver['order_no']=$form_data->inovice_no;
                                                                $data_driver['reference_no']=$form_data->inovice_no;
                                                                if($form_data->create_date > '2024-05-31'){
                                                                $data_driver['amount']=
                                                                round($form_data->invoice_amount/1.18 , 2) + $loading_charges;

                                                            }else{
                                                                $data_driver['amount']=round(($form_data->invoice_amount + $loading_charges) , 2);
                                   ...
                                   $data_driver['credits']=round($form_data->invoice_amount+$loading_charges);
                                                            }
                                                            else
                                                            {
            ...
            if($form_data->action == 'Inward' && $form_data->create_date > '2024-05-31')   {
                 $data_sGst['order_id'] = 0;
                $data_sGst['customer_id'] =588;
                $data_sGst['user_id'] = $this->userid;
                $data_sGst['notes'] = 'SGST - Purchase Order ' . $form_data->inovice_no;
                $data_sGst['deletemod'] = 'SGST IN - '.$form_data->inovice_no;
                $data_sGst['debits'] =   round(($form_data->invoice_amount/1.18) * 0.09, 2);
                // $data_tcs['debitstoatal'] =  $minisroundoff;
                $data_sGst['order_no'] = $form_data->inovice_no;
                $data_sGst['reference_no'] = $form_data->inovice_no;
                $data_sGst['party_type'] = 5;
                $data_sGst['account_head_id'] = 142;
                $data_sGst['account_heads_id_2'] = 142;
                $data_sGst['payment_date'] = $create_date;
                $data_sGst['payment_time'] = $create_time;
                $data_sGst['dummy_customer_name'] = $company_name;
  ...
  $data_cGst['order_id'] = 0;
                $data_cGst['customer_id'] =589;
                $data_cGst['user_id'] = $this->userid;
                $data_cGst['notes'] = 'CGST - Purchase Order ' . $form_data->inovice_no;
                $data_cGst['deletemod'] = 'CGST IN - '.$form_data->inovice_no;
                $data_cGst['debits'] =   round(($form_data->invoice_amount/1.18) * 0.09,2);
                // $data_tcs['debitstoatal'] =  $minisroundoff;
                $data_cGst['order_no'] =$form_data->inovice_no;
                $data_cGst['reference_no'] = $form_data->inovice_no;
                $data_cGst['party_type'] = 5;
                $data_cGst['account_head_id'] = 142;
                $data_cGst['account_heads_id_2'] = 142;
                $data_cGst['payment_date'] = $create_date;
                $data_cGst['payment_time'] = $create_time;
                $data_cGst['dummy_customer_name'] = $company_name;
        ...
        public function purchase_invoice_data_extra()
    {
                   ...
                   $form_data = json_decode(file_get_contents("php://input"));
                                         ...
                                         $netamount=$form_data->invoice_amount;       
                                                                ...
                                                                $data_driver['customer_id']=$vendor_id;
                                                                $data_driver['payment_mode']='0';
                                                                $data_driver['notes']='Purchase Invoice Create Ex Unit';
                                                                $data_driver['user_id']=$this->userid;
                                                                $data_driver['order_no']=$form_data->inovice_no;
                                                                $data_driver['reference_no']=$form_data->inovice_no;
                                                                ...
                                                                $data_driver['credits_sub_total']=$netamount;
                                                                $data_driver['balance']=0;
                                                                $data_driver['bank_id'] = 25;
   ...
   public function insertandupdateinward()
    {
                 ...
                 if($form_data->action=="Inward")
                 {
                                         ...
                                         $data['sqm']=$form_data->coil_width * $form_data->r_mtr_length;
                                        $data['coil_width']=$form_data->coil_width;
                                        $data['kg_per_mtr']=$form_data->kg_per_mtr;
                                        $data['r_mtr_length']=$form_data->r_mtr_length;
                 ...
                 if($form_data->action=="Inwardnewrow")
                 {
                                         ...
                                         foreach ($result as  $value) {
                                                 ...
                                                 $data['po_number']=$value->po_number;
                                        ...
                                        //  $data['get_id']=$form_data->id;
                                         ...
                                         $data['sqm']=$form_data->sqm_val;
                                        $data['coil_width']=$form_data->coil_width;
                                        $data['kg_per_mtr']=$form_data->kg_per_mtr;
                                        $data['r_mtr_length']=$form_data->r_mtr_length;
                                        $data['coil_update_status_new']=$form_data->coil_update_status_new;
                                         ...
                                         $this->Main_model->insert_commen($data,'purchase_order');
                                         $array=array('error'=>'2','insert_id'=>$data['get_id'],'massage'=>'Purchase Product Inward..');
                                         echo json_encode($array);
    ...
    public function getpurchaseorerinvoice()
    {
                     ...
                     foreach ($result as  $value) 
                     {
                                                             ...
                                                             $array[] = array(
                                                                ...
                                                                'no' => $i, 
                                                                'id' => $value->id,
                                                                'base_id' => base64_encode($value->order_id),
                                                                'invoice_no' => $value->invoice_no, 
                                                                'vendor_name' => $value->vendor_id, 
                                                                'vendor_id'=>$value->vendor_base_id,
                                                                'po_number' =>  $value->po_number,
...
if($form_data->sub_total>0)
{

    //$this->db->query("UPDATE all_ledgers SET credits_sub_total='".$form_data->sub_total."',credits='".$form_data->sub_total + $loading_charges."',notes='".$reason."'  WHERE deletemod='".$deletemod."' AND order_id='".$insert_id."' AND party_type=3");
    ...
    public function fetch_invoicetotal()
    {
                     ...
                     foreach ($resultg as  $values) 
                     {
                         ...
                         $invoice_date=$values->update_date;
...
$totalamountWithGST = $totalamountWithGST + $roundoffVal;
     ...
     public function fetch_data()
    {
        ...
        $queryss = $this->db->query("SELECT * FROM purchase_order  WHERE deleteid='0' AND coil_update_status_new='0'  ORDER BY id DESC  ");
        $result = $queryss->result();
        foreach ($result as  $value) {
            $qty_array = [];


            $query1 = $this->db->query("SELECT * FROM purchase_invoice_products  WHERE product_id='$value->product_id' AND c_id ='$value->invoice_id' ");
            $result1 = $query1->result();
            foreach ($result1 as  $value1) {

                if (isset($value1) && $value1->qty > 0) {
                    $invoice_qty = $value1->qty;
                } else {
                    $invoice_qty = $value->qty;
                }
            }
            ...
            foreach ($resultp as  $valuep) {
                ...
                // if($valuep->sub_categories_id > 0){
                //     $product_name = $valuep->sub_categories;
                // }else{
                    $product_name = $valuep->product_name;
                    // if ($valuep->purchase_name != '') {
                    //     $product_name = $valuep->purchase_name;
            ...
            // $result2 = $this->Main_model->where_names('purchase_order_coilupdate', 'purchase_id', $value->id);
            // foreach ($result2 as  $value2) {
            //     $product_id1 = $value2->product_id;
            //     $invoice_no1 = $value2->invoice_no;
            //     $po_number1 = $value2->po_number;
            // }

            // $query2 = $this->db->query("SELECT * FROM purchase_order_coilupdate  WHERE deleteid!='1' AND product_id='" . $product_id1 . "' AND po_number='" . $po_number1 . "' AND invoice_no='" . $invoice_no1 . "'  ORDER BY id ASC");
            // $result3 = $query2->result();

            // foreach ($result3 as  $value3) {

                $result4 = $this->Main_model->where_names('purchase_order_coilupdate', 'purchase_id', $value->id);

                foreach ($result4 as  $value4) {



                    if ($value4->inward_qty >= 0) {
                        $qty4 = $value4->inward_qty;
                    } else {
                        $qty4 = 0;
                        // $qty4 = $value4->qty;
                    }
                    array_push($qty_array, $qty4);
                }
            // }
            ...
            $coil_no = "";
            $coil_count = "";
            $resultc = $this->db->query("SELECT COUNT(id) AS count, GROUP_CONCAT(coil_no) AS coil_numbers 
                          FROM purchase_order_coilupdate 
                          WHERE invoice_id = '" . $value->invoice_id . "' AND product_id = '" . $value->product_id . "' AND deleteid != '1' AND (coil_update_status_new = '1' OR coil_update_status_new = '0')
                          ")->result();
            foreach ($resultc as  $valuec) {
                $coil_no = $valuec->coil_numbers;
                $coil_count = $valuec->count;
            }


            if ($value->type == 0) {
                $total_inward_query = $this->db->query("SELECT SUM(inward_qty) AS total_inward 
                        FROM purchase_order_coilupdate  
                        WHERE  po_number='$value->po_number'");
                $total_result_inward = $total_inward_query->row();
                ...
                $array[] = array(
                    ...
                    'category' => $categories,
                    'kg_per_mtr' => $value->kg_per_mtr,
                    'coil_width' => $value->coil_width,
                    'r_mtr_length' => $value->r_mtr_length,
                    'sqm' => $value->sqm,
                    'unit' => $value->unit,
                    'total_qty' => array_sum($qty_array),
                    'total_invoice_qty' => $purchase_invoice_product->qty,
    ...
    public function fetch_single_data()
    {
                     ...
                     foreach ($result as  $value) {
                      ...
                      $output['invoice_id']= $value->invoice_id; 
                      $output['purchase_id']= $value->id; 
                      $output['vendor_id']= $value->vendor_id;
                      $output['po_number']= $value->po_number;
                      $output['invoice_number']= $value->invoice_no;
                      ...
                      $tot_sqm="";
                      $valuesqm= $this->db->query("SELECT SUM(sqm) as tot_sqm FROM purchase_order_coilupdate  WHERE  deleteid != '1' AND purchase_id='" . $value->id . "'  ORDER BY id ASC")->result();
                      foreach ($valuesqm as  $valuesqm) {
                        $tot_sqm = $valuesqm->tot_sqm;
                      }
                         
                         

                      $output['tot_sqm']= round($tot_sqm , 2);
                      $output['sqm']= $value->sqm;
                      $output['r_mtr_length']= $value->r_mtr_length;
                      $output['coil_width']= $value->coil_width;
                      $output['kg_per_mtr']= $value->kg_per_mtr;
                     ...
                     $result1=  $this->db->query("SELECT b.categories as category, b.* FROM purchase_order_coilupdate as a JOIN product_list as b ON a.product_id=b.id  WHERE  a.product_id='" . $value->product_id . "'   ORDER BY a.id ASC")->result();
                     foreach ($result1 as  $values) {
                        $output['category']= $values->category;
                        // if($values->sub_categories_id > 0){
                        //     $output['product_name'] = $values->sub_categories;
                        // }else{
                     ...
                     $vendorname="";
                          ...
                          foreach ($resultv as  $valuev) {
                             ...
                             $vendorname=$valuev->name;
                          }
                     $output['vendor_name']= $vendorname;
                     $output['po_qty']= $value->qty;
    ...
    public function fetch_data_invoice_table() {
        ...
        foreach ($result as $value) {
           ...
           $total_sub=0;
            $queryss = $this->db->query("SELECT SUM(qty) as qtyqty,SUM(qty*price) as total_sub  FROM purchase_invoice_products  WHERE  c_id='" . $value->id . "' AND deleteid=0 ");
            $resultcount = $queryss->result();
            foreach ($resultcount as $cc) {
                $value->qty = round($cc->qtyqty,2);

                $total_sub = round($cc->total_sub,2);
            }
            ...
            $order_no=$value->invoice_no;
            $deletemod_round = 'ROUND-'.$order_no;
                        if($value->roundoff>0)
            {


                      $roundoff=$value->roundoff;
                      $convert_status=$value->convert_status;
                      
                      if($convert_status==1)
                      {


//$value->invoice_amount=$value->invoice_amount-$roundoff;

                        
                           $this->db->query("UPDATE `all_ledgers` SET payment_date='".$value->invoice_date."', debits= '".$roundoff."', credits = '0',purchase_entry=1 WHERE customer_id = 372 AND order_no = '$order_no' AND deletemod = '$deletemod_round' AND party_type ='5'");
                      ...
                      else
                      {
                           ...
                           $this->db->query("UPDATE `all_ledgers` SET payment_date='".$value->invoice_date."',credits = '".$roundoff."',debits= '0',purchase_entry=1 WHERE customer_id = 372 AND order_no = '$order_no' AND deletemod = '$deletemod_round' AND party_type ='5'");
  ...
  $this->db->query("UPDATE `all_ledgers` SET payment_date='".$value->invoice_date."',credits = '0',debits= '0',purchase_entry=1 WHERE customer_id = 372 AND order_no = '$order_no' AND deletemod = '$deletemod_round' AND party_type ='5'");
...
if($value->invoice_date > '2024-05-31'){
   ...
   if($value->invoice_date >= '2024-12-19')
   {
     
       $totalValue_gst = round($total_sub*1.18,2);
       $subtotal=round($total_sub);
       $gstamount_val=round($totalValue_gst-$total_sub);

   }
   else
   {
       $totalValue_gst = round($total_sub*1.18);
       $subtotal=round($total_sub);
       $gstamount_val=$totalValue_gst-$total_sub;
   }



       $gstamount=round($gstamount_val/2,2);
       $invoice_amount=round($subtotal+$gstamount_val);
            ...
            if($value->roundoff>0)
            {
                      ...
                      if($convert_status==1)
                      {
                       ...
                       $invoice_amount=$invoice_amount+$roundoff;
    ...
    $fulltotal=$invoice_amount+$loading_charges;


 $this->db->query("UPDATE all_ledgers SET payment_date='".$value->invoice_date."',credits='".$fulltotal."',credits_sub_total='".$subtotal."',purchase_entry=1  WHERE order_no='" .$value->invoice_no . "' AND party_type=3  AND deletemod='" .$value->deletemod . "'");
  $this->db->query("UPDATE purchase_invoice SET invoice_amount='".$fulltotal."' WHERE id='" .$value->id . "'");
   ...
   if($gstamount>0)
   {
     ...
     $sgstIn='SGST IN - '.$order_no;
    $this->db->query("UPDATE all_ledgers SET payment_date='".$value->invoice_date."',debits='".$gstamount."',credits='0',purchase_entry=1 WHERE customer_id='588'  AND order_no='".$order_no."' AND party_type=5  AND deletemod='".$sgstIn."'");
    $cgstIn='CGST IN - '.$order_no;
    $this->db->query("UPDATE all_ledgers SET payment_date='".$value->invoice_date."',debits='".$gstamount."',credits='0',purchase_entry=1 WHERE customer_id='589'  AND order_no='".$order_no."' AND party_type=5  AND deletemod='".$cgstIn."'");
...
else
{
    ...
    $totalValue = round($value->invoice_amount) + $loading_charges;

     $this->db->query("UPDATE all_ledgers SET credits_sub_total='".$totalValue."',payment_date='".$value->invoice_date."',credits='".$totalValue."',purchase_entry=1  WHERE order_no='" .$value->invoice_no . "' AND party_type=3  AND deletemod='" .$value->deletemod . "'");
...
if($loading_charges>0)
{
    ...
    $loadingMod = 'LOADING-'.$order_no;
   $this->db->query("UPDATE all_ledgers SET payment_date='".$value->invoice_date."',debits='".$loading_charges."',credits='0',purchase_entry=1,account_head_id='402',account_heads_id_2='402' WHERE customer_id='605'  AND order_no='".$order_no."' AND party_type=5");
...
else
{
    ...
    public function order_quotation_request_po() {
     ...
     public function invoice() {
        if (isset($this->session->userdata['logged_in'])) {
            ...
            if($neworder_id=='5438' && $_GET['invoice_no']=='T0375/2024-25')
            {
                 $neworder_id='28815';
            }
 ...
 public function fetchCustomerororderhistroy_vendor()
 {
    ...
    public function fetch_single_data_new()
    {
        try {
        $qty_array=[];
                        $output=array();
                     ...
                     $id=$form_data->id;
                     $result= $this->Main_model->where_names('purchase_order','id',$id);
                     foreach ($result as  $value) {
                        $product_id= $value->product_id;
                        $invoice_no= $value->invoice_no;
                     ...
                     $tablename='purchase_order_coilupdate';
                     $queryss = $this->db->query("SELECT * FROM purchase_order_coilupdate  WHERE deleteid!='1' AND purchase_id='".$id."'  ORDER BY id ASC");
                     $result = $queryss->result();

                    

                    //  echo "SELECT * FROM purchase_order_coilupdate  WHERE deleteid!='1' AND product_id='".$product_id."' AND po_number='".$po_number."' AND invoice_no='".$invoice_no."'  ORDER BY id ASC";exit();

                foreach ($result as  $value) {

                     $result= $this->Main_model->where_names($tablename,'id',$value->id);
                     
                     foreach ($result as  $value) {

                      
                    // if($value->r_mtr_length > 0){
                     if($value->inward_qty>=0)
                     {
                         $qty= $value->inward_qty;
                    ...
                    // }
                     ...
                     foreach ($result1 as  $values) {
                        ...
                        // if($values->sub_categories_id > 0){
                        //     $prodname = $values->sub_categories;
                        // }else{
                     ...
                     $vendorname="";
                        ...
                        //   $value->r_mtr_length = $value->r_mtr_length >= 0 ? $value->r_mtr_length : 0;
                        //   $value->coil_width = $value->coil_width >= 0 ? $value->coil_width : 0;
                        //   $sqm1 = ($value->coil_width / 1000) * $value->r_mtr_length;
                        //   $kg_per_mtr1 = ($qty * 1000) / $value->r_mtr_length;

                        //   $sqm = round($sqm1, 2);
                        //   $kg_per_mtr = round($kg_per_mtr1, 2);

                          // Check for empty or null values and set to 0
                            $value->r_mtr_length = !empty($value->r_mtr_length) ? $value->r_mtr_length : 0;
                            $value->coil_width = !empty($value->coil_width) ? $value->coil_width : 0;

                            // Perform calculations only if $value->r_mtr_length is non-zero to avoid division by zero
                            if ($value->r_mtr_length != 0) {
                                $sqm1 = ($value->coil_width / 1000) * $value->r_mtr_length;
                                $kg_per_mtr1 = ($qty * 1000) / $value->r_mtr_length;

                                // Check for infinite or not-a-number values before rounding
                                if (is_finite($sqm1) && is_finite($kg_per_mtr1)) {
                                    $sqm = round($sqm1, 2);
                                    $kg_per_mtr = round($kg_per_mtr1, 2);
                                } else {
                                    // Handle the case where calculation results in infinite or not-a-number values
                                    $sqm = 0;
                                    $kg_per_mtr = 0;
                                }
                            } else {
                                // Handle the case where $value->r_mtr_length is zero to avoid division by zero
                                $sqm = 0;
                                $kg_per_mtr = 0;
                            }
                     ...
                     $output[] = array(
                      ...
                      'r_mtr_length'=> $value->r_mtr_length,
                      'coil_width'=> $value->coil_width,
                      'kg_per_mtr'=> $kg_per_mtr >= 0 ? $kg_per_mtr : 0,
                      'po_qty'=> $value->qty,
                      'order_date'=> $value->order_date,
                      'inward_date'=> $value->inward_date,
                      'total_amount'=> $value->total_amount,
                      'rack_info'=> $value->rack_info,
                      'bin_info'=> $value->bin_info,
                      'qty' => $qty,
                      ...
                      'coil_update_status_new' => $value->coil_update_status_new
                     );
                   ...
                   // $output['total_qty_inward']=array_sum($qty_array);
                   $jsonEncodedData = json_encode(array('data' => $output, 'total_count' => array_sum($qty_array), 'unit' => $unit), JSON_THROW_ON_ERROR);
                   echo $jsonEncodedData;
                    // echo json_encode(array('data'=>$output,'total_count'=>array_sum($qty_array)) , JSON_THROW_ON_ERROR);
    ...
    public function checkIsExistPurchase_invoice(){     
        $id=$_GET['id'];
        $invoice_no=$_GET['invoice_no'];
        $result = $this->db->query("SELECT * FROM purchase_invoice where order_id='$id' and `invoice_no` = '$invoice_no'");
        // print_r($invoice_no);
...
public function insertandupdateinward_newrow()
    {
        $rowData = $_POST['rowData']; // Assuming the row data is received in the $_POST['rowData'] 
        $invoice_id = $_POST['invoice_id'];        
        $purchase_id = $_POST['purchase_id'];

        // Print and check the received data
        //         if(isset($_POST['sum'])){
        // echo $_POST['sum'];
        //         }
        ...
        foreach ($rowData as $row) {
            $id = $row['id[]']; // Access 'id[]' property with its exact key name

            if ($id != '') {
                $result = $this->Main_model->where_names('purchase_order_coilupdate', 'id', $id);
                foreach ($result as  $value) {
                    $product_id = $value->product_id;
                }
                $tablename = 'purchase_order_coilupdate';
                $data['get_id'] = $id;
               // echo json_decode($row['qty[]'],true);
                $data['inward_qty'] = $row['qty[]'];
                $array_count += $row['qty[]'];
                // echo count($row['qty[]']);
                $data['coil_no'] = $row['coil_no[]'];
                $coil_width = $row['coil_width[]'];
                $r_mtr_length = $row['r_mtr_length[]'];

                $sqm = round(($coil_width / 1000) * $r_mtr_length, 2);
                $data['sqm'] = $sqm;
                $data['coil_width'] = $row['coil_width[]'];
                $data['kg_per_mtr'] = $row['kg_per_mtr[]'];
                $data['r_mtr_length'] = $row['r_mtr_length[]'];


                $this->Main_model->update_commen($data, $tablename);
                $this->daywisestock($product_id);
                $array = array('error' => '2', 'insert_id' => $data['get_id'], 'massage' => 'Purchase Product Inward..');
                // echo json_encode($array);
            } else {

                
                $querysssss = $this->db->query("SELECT a.id , b.purchase_order_product_id FROM purchase_invoice as a JOIN purchase_invoice_products as b ON a.id =b.c_id WHERE a.id='" . $invoice_id . "' AND b.deleteid=0 AND a.deleteid=0 ORDER BY a.id ASC");
                $resultss = $querysssss->result();
                foreach ($resultss as $val) {
                    $id = $val->id;
                    $product_purcahse_id = $val->purchase_order_product_id;
                }

                $resulttotal = $this->Main_model->where_names_two_order_by('purchase_invoice', 'id', $id, 'deleteid', '0', 'id', 'DESC');
                foreach ($resulttotal as $tot) {

                    $vendor_id =  $tot->vendor_base_id;
                    $invoice_no =  $tot->invoice_no;
                    // $inward_date =  $tot->inward_date;
                    $po_number =  $tot->po_number;
                    $id =  $tot->id;
                    $invoice_amount = $tot->invoice_amount;
                    $vehicle_no = $tot->vehicle_no;
                }
                $date =  date("Y-m-d");
                ...
                $data_inward['user_id'] = $this->userid;
                $data_inward['inward_date'] = $date;
                $data_inward['vehicle_no'] = $vehicle_no;
                $data_inward['total_amount'] = '0';

                $result = $this->Main_model->where_names('purchase_invoice_products', 'purchase_order_product_id', $product_purcahse_id);
                foreach ($result as  $value) {
                    $product_id = $value->product_id;
                    $c_id = $value->c_id;
                    $price = $value->price;
                    ...
                    $stockid = $value->purchase_order_product_id;
                    $this->db->query("UPDATE product_list SET stock=stock+'" . $qty . "' WHERE id='" . $product_id . "'");
                    $data_inward['purchase_id'] = $purchase_id;
                    $data_inward['product_id'] = $product_id;
                    $data_inward['price'] = $price;
                    $data_inward['qty'] = $qty;
                    $data_inward['coil_no'] = $row['coil_no[]'];
                    $data_inward['inward_qty'] = $row['qty[]'];
                    $data_inward['total_amount'] = $invoice_amount ? $invoice_amount : '0';
                    $data_inward['order_id'] = $c_id;
                    $data_inward['stock_id'] = $stockid;
                    $coil_width = $row['coil_width[]'];
                    $r_mtr_length = $row['r_mtr_length[]'];
                    ...
                    $sqm = round(($coil_width / 1000) * $r_mtr_length, 2);
                    $data_inward['sqm'] = $sqm;
                    $data_inward['coil_width'] = $row['coil_width[]'];
                    $data_inward['kg_per_mtr'] = $row['kg_per_mtr[]'];
                    $data_inward['r_mtr_length'] = $row['r_mtr_length[]'];
                    $data_inward['coil_update_status_new'] = '1';
                    $data_inward['deleteid'] = '3';

                }

                $this->Main_model->insert_commen($data_inward, 'purchase_order_coilupdate');

                //inward stock get
                $inward_stock="";
                $data = date('Y-m-d');
                $checksubcat = $this->Main_model->where_names('product_list','id',$product_id);
                foreach ($checksubcat as  $valuec) {
                    if($valuec->sub_categories_id > 0){
                        $were = " AND b.sub_categories_id = '".$valuec->sub_categories_id."'";
                        $where1 = " WHERE b.sub_categories_id = '".$valuec->sub_categories_id."'";
                    }else{
                        $were = " AND a.product_id = '".$product_id."'";
                        $where1 = " WHERE  a.product_id = '".$product_id."'";
                    }
                    }
                   
                $resultinw= $this->db->query("SELECT SUM(a.inward_qty) as inward_qty FROM purchase_order_coilupdate as a JOIN product_list as b ON b.id = a.product_id WHERE DATE(a.inward_date) = '".$data."' $were ORDER BY a.id DESC")->result();
                foreach ($resultinw as  $valuess) {
                    $inward_stock= $valuess->inward_qty; 
                 }
                 ...
                 //inward stock total
                $inward_tot="";
                $resulti= $this->db->query("SELECT SUM(a.inward_qty) as inward_tot FROM purchase_order_coilupdate as a JOIN product_list as b ON b.id = a.product_id $where1 ORDER BY a.id DESC")->result();
                foreach ($resulti as  $values) {
                    $inward_tot= $values->inward_tot; 
                 }
                //daywise stock update
                $datastock['product_id'] = $product_id;                
                $datastock['user_id'] = $this->userid;                
                $datastock['stock_date'] = date('Y-m-d');                
                $datastock['inward_qty'] = $inward_stock;
        ...
        $resultp= $this->Main_model->where_names('product_list','id',$product_id);
        foreach ($resultp as  $valuep) {
           ...
           if($valuep->stock!='')
           {
              ...
              $valuep->stock=$valuep->stock+$array_count;
              $data_update = array(
                  'stock' =>  $valuep->stock, 
              ...
              $this->db->update('product_list', $data_update);   

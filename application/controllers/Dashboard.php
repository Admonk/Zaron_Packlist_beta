...
class Dashboard extends CI_Controller {
	...
	public function index()
	{
							            ...
							            if(isset($this->session->userdata['logged_in']))
							            {
                    					  ...
                    					  if($this->session->userdata['logged_in']['access']=='11' || $this->session->userdata['logged_in']['access']=='12')
                    					  {
								              ...
								              $resulttotalsale=$this->db->query("SELECT SUM(a.bill_total) as toatalvalue FROM orders as a   WHERE a.create_date BETWEEN '".$formdate."' AND '".$todate."'  AND a.deleteid=0  AND a.order_base>0 $sql");
                 	                          ...
                 	                          foreach($resulttotalsale as $totsale)
                 	                          {
                 	                               $data['toatalvalueenc']=round($totsale->toatalvalue+$totsale->tcsamount,2);
                 	                          }
                 	                          ...
                 	                          {
                 	                               $data['toatalvaluelsenc']=round($totsalels->toatalvalue+$totsalels->tcsamount,2);
                 	                          }
								              ...
								              $resulttotalsale=$this->db->query("SELECT SUM(a.bill_total) as toatalvalue FROM orders_quotation as a   WHERE a.create_date BETWEEN '".$formdate."' AND '".$todate."'  AND a.deleteid=0   AND a.order_base>0 $sql");
                 	                          ...
                 	                          foreach($resulttotalsale as $totsale)
                 	                          {
                 	                               $data['toatalvalueqty']=round($totsale->toatalvalue+$totsale->tcsamount,2);
                 	                          }
                 	                          ...
                 	                          foreach($resulttotalsalels as $totsalels)
                 	                          {
                 	                               $data['toatalvaluelsqty']=round($totsalels->toatalvalue+$totsalels->tcsamount,2);
                 	                          }
                 	                          ...
                 	                          foreach($resulttotalsalels as $totsalels)
                 	                          {
                 	                               $data['toatalvaluels']=round($totsalels->toatalvalue+$totsalels->tcsamount,2);
                 	                          }
                 	                          ...
                 	                          {
                 	                               $data['toatalvaluedd']=round($totsaledd->toatalvalue+$totsaledd->tcsamount,2);
                 	                          }
                 	                          ...
                 	                          {
                 	                               $data['toatalvaluelsdd']=round($totsalelsdd->toatalvalue+$totsalelsdd->tcsamount,2);
                 	                          }
								        ...
								        $data['won']=$convertion;       
                                              ...
                                              $data['toatalvalue_1']=0;
                                              $data['totalcount_1']=0;
                                              $resulttotalsale=$this->db->query("SELECT SUM(a.bill_total) as toatalvalue,count(a.id) as count FROM orders_process as a   WHERE a.create_date BETWEEN '".$formdate."' AND '".$todate."'  AND a.deleteid=0 AND a.customer_id=37743  AND a.order_base>0 $sql");
                                              
                                              $resulttotalsale=$resulttotalsale->result();
                                              foreach($resulttotalsale as $totsale)
                                              {

                                                   $data['totalcount_1']=$totsale->count;
                                                   $data['toatalvalue_1']=round($totsale->toatalvalue+$totsale->tcsamount,2);
                                              }




                                               $data['toatalvalue_2']=0;
                                                $data['totalcount_22']=0;
                                              $resulttotalsale=$this->db->query("SELECT SUM(a.bill_total) as toatalvalue,count(a.id) as count FROM orders_process as a   WHERE a.create_date BETWEEN '".$formdate."' AND '".$todate."'  AND a.deleteid=0 AND a.customer_id IN ('33334','375177')   AND a.order_base>0 $sql");
                                              
                                              $resulttotalsale=$resulttotalsale->result();
                                              foreach($resulttotalsale as $totsale)
                                              {

                                                    $data['totalcount_22']=$totsale->count;
                                                    $data['toatalvalue_2']=round($totsale->toatalvalue+$totsale->tcsamount,2);
                                              }



                                              $data['toatalvalue_3']=0;
                                                $data['totalcount_33']=0;
                                              $resulttotalsale=$this->db->query("SELECT SUM(a.bill_total) as toatalvalue,count(a.id) as count FROM orders_process as a   WHERE a.create_date BETWEEN '".$formdate."' AND '".$todate."'  AND a.deleteid=0 AND a.customer_id IN ('371456','373808')   AND a.order_base>0 $sql");
                                              
                                              $resulttotalsale=$resulttotalsale->result();
                                              foreach($resulttotalsale as $totsale)
                                              {

                                                    $data['totalcount_33']=$totsale->count;
                                                    $data['toatalvalue_3']=round($totsale->toatalvalue+$totsale->tcsamount,2);
                                              }



                                              $data['toatalvaluels_1']=0;
                                              $data['totalcountlastmonth_1']=0;
                                              $resulttotalsalels=$this->db->query("SELECT SUM(a.bill_total) as toatalvalue,count(a.id) as count FROM orders_process as a   WHERE a.create_date BETWEEN '".$lastmonthfrom."' AND '".$lastmonthto."'  AND a.deleteid=0 AND a.customer_id=37743  AND a.order_base>0 $sql");
                                              
                                              $resulttotalsalels=$resulttotalsalels->result();
                                              foreach($resulttotalsalels as $totsalels)
                                              {
                                                   $data['totalcountlastmonth_1']=$totsalels->count;
                                                   $data['toatalvaluels_1']=round($totsalels->toatalvalue+$totsalels->tcsamount,2);
                                              }
                                              ...
                                              $data['toatalvaluels_2']=0;
                                               $data['totalcountlastmonth_2']=0;
                                              $resulttotalsalels=$this->db->query("SELECT SUM(a.bill_total) as toatalvalue,count(a.id) as count FROM orders_process as a   WHERE a.create_date BETWEEN '".$lastmonthfrom."' AND '".$lastmonthto."'  AND a.deleteid=0 AND a.customer_id IN ('33334','375177') AND a.order_base>0 $sql");
                                              
                                              $resulttotalsalels=$resulttotalsalels->result();
                                              foreach($resulttotalsalels as $totsalels)
                                              {

                                                   $data['totalcountlastmonth_2']=$totsalels->count;
                                                   $data['toatalvaluels_2']=round($totsalels->toatalvalue+$totsalels->tcsamount,2);
                                              }


                                              $data['toatalvaluels_3']=0;
                                              $data['totalcountlastmonth_3']=0;
                                              $resulttotalsalels=$this->db->query("SELECT SUM(a.bill_total) as toatalvalue,count(a.id) as count FROM orders_process as a   WHERE a.create_date BETWEEN '".$lastmonthfrom."' AND '".$lastmonthto."'  AND a.deleteid=0 AND a.customer_id IN ('371456','373808') AND a.order_base>0 $sql");
                                              
                                              $resulttotalsalels=$resulttotalsalels->result();
                                              foreach($resulttotalsalels as $totsalels)
                                              {

                                                   $data['totalcountlastmonth_3']=$totsalels->count;
                                                   $data['toatalvaluels_3']=round($totsalels->toatalvalue+$totsalels->tcsamount,2);
                                              }
   ...
   redirect('index.php/order_second/driver_orders_list_trip_order_base?vehicle_id=-1&delivery_status=2');
                                            ...
                                            else if($this->session->userdata['logged_in']['access']=='31') // md
                                            {

                                                
                                                  //$this->load->view('dashboard/customer_dashboard',$data);
                                                redirect('index.php/order/enquiries_list');

                                                      
                                                  
                                            }
                                            else if($this->session->userdata['logged_in']['access']=='32') // DATA CLEAR
                                            {

                                                
                                                  //$this->load->view('dashboard/customer_dashboard',$data);
                                                redirect('index.php/adminmain/yr3z8E?r=%212jF%264qW8%23pL');
     ...
     public function monthlysaleschart_main()
    {
...
// echo "SELECT SUM(a.bill_total) as total  FROM orders_process as a  WHERE month(a.create_date)='$monthset' AND year(a.create_date)='$year'  AND a.deleteid=0  AND a.order_base>0   $sql";
// echo "<br>";
// echo "<br>";
// echo "<br>";

                    
                 $resulttotalcountlm=$this->db->query("SELECT SUM(a.bill_total) as total  FROM orders_process as a  WHERE month(a.create_date)='$monthset' AND year(a.create_date)='$year'  AND a.deleteid=0  AND a.order_base>0   $sql");
                 $resulttotalcountlm=$resulttotalcountlm->result();
                 $totals[]=round($resulttotalcountlm[0]->total);



                  $resulttotalcountlm=$this->db->query("SELECT SUM(a.bill_total) as total  FROM orders_process as a  WHERE month(a.create_date)='$monthset' AND year(a.create_date)='$year'  AND a.deleteid=0  AND a.order_base>0 AND a.customer_id NOT IN ('37743','33334','375177','371456','373808')  $sql");
                 $resulttotalcountlm=$resulttotalcountlm->result();
                 $out[]=round($resulttotalcountlm[0]->total);



                   $resulttotalcountlm=$this->db->query("SELECT SUM(a.bill_total) as total  FROM orders_process as a  WHERE month(a.create_date)='$monthset' AND year(a.create_date)='$year'  AND a.deleteid=0  AND a.order_base>0 AND a.customer_id  IN ('37743')  $sql");
                 $resulttotalcountlm=$resulttotalcountlm->result();
                 $out1[]=round($resulttotalcountlm[0]->total);




                 $resulttotalcountlm=$this->db->query("SELECT SUM(a.bill_total) as total  FROM orders_process as a  WHERE month(a.create_date)='$monthset' AND year(a.create_date)='$year'  AND a.deleteid=0  AND a.order_base>0 AND a.customer_id  IN ('33334','375177')  $sql");
                 $resulttotalcountlm=$resulttotalcountlm->result();
                 $out2[]=round($resulttotalcountlm[0]->total);


                 $resulttotalcountlm=$this->db->query("SELECT SUM(a.bill_total) as total  FROM orders_process as a  WHERE month(a.create_date)='$monthset' AND year(a.create_date)='$year'  AND a.deleteid=0  AND a.order_base>0 AND a.customer_id  IN ('371456','373808')  $sql");
                 $resulttotalcountlm=$resulttotalcountlm->result();
                 $out3[]=round($resulttotalcountlm[0]->total);
          ...
          $array=array($totals,$out,$out1,$out2,$out3);
...
ORDER BY `ordercount`  DESC LIMIT 5");
   ...
   $result=$this->db->query("SELECT  o.user_id,o.id,o.order_no,o.table_name,o.order_id,o.status_data,o.remarks,a.company_name,a.phone,o.call_back_date,o.call_back_date_only  FROM call_history as o  JOIN customers as a ON o.customer_id=a.id WHERE o.call_back_date_only<='".$todate."' AND o.status_data='Call Back' AND o.deleteid=0 $sql  GROUP BY o.order_no,o.table_name,o.call_back_date_only ORDER BY o.call_back_date_only DESC");
                         ...
                         if($value->table_name=='orders_process')
                         {
                             ...
                             $url=base_url().'index.php/order/ordercreate_product_process?order_id='.$order_id;
                              ...
                              foreach ($status as $valuew) 
                              {
                                ...
                                $order_no=$valuew->order_no;
                                $deleteid=$valuew->deleteid;
                                if($order_base>0)
                                {
                                ...
                                if($order_base=='-4')
                                {
                                  ...
                                  if($deleteid==0)
                                  {
                                                     ...
                                                     //$this->db->query("UPDATE call_history SET user_id='".$user_id."' WHERE order_no='".$order_no."' AND table_name='".$value->table_name."'");
                              ...
                              if($order_base=='-4')
                              {
                                  ...
                                  if($call_back_date==$value->call_back_date_only)
                                 {
                                            ...
                                            if($value->remarks!='')
                                            {
                                                      ...
                                                      //$value->remarks=$value->status_data;
                                            }   


                                             $username ='';
                                             $user_group_team = $this->Main_model->where_names('admin_users','id',$user_id);
                                            ...
                                            if($this->session->userdata['logged_in']['access']=='12')
                                            {
                                                              ...
                                                              $people=array($user_id);

                                                             if(in_array($this->userid, $people))   
                                                             {
                                            ...
                                            elseif($this->session->userdata['logged_in']['access']=='11')
                                            {
                                                             ...
                                                             if(in_array($user_id, $sales_team_id))   
                                                             {
       ...
       public function changeOtpSettings(){
        $form_data = json_decode(file_get_contents("php://input"));
        $setting = $form_data->status;

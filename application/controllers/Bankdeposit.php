          ...
          $form_data = json_decode(file_get_contents("php://input"));
                    ...
                    $bank2=$form_data->bank2;
                                                                 ...
                                                                 foreach($resbankaccount1 as $valb1)
                                                                 {
                                                                     ...
                                                                     $account_heads_id=$valb1->account_heads_id;
                                                                 }
                                                                 ...
                                                                 $res =$this->Main_model->where_names_two_order_by('bankaccount_manage','bank_account_id',$bank1,'deleteid','0','id','ASC');
                                                                 ...
                                                                 foreach($resbankaccount2 as $valb2)
                                                                 {
                                                                     ...
                                                                     $account_heads_id=$valb2->account_heads_id;
                                                                 }
                                                                ...
                                                                //$data_bank['deletemod']=time();
                                                                
                                                                $data_bank['deletemod']=$this->userid.$enteramount.$bid2.$date;
                                                                $data_bank['create_date']=$date;
                                                                $data_bank['name']='Bank Transfer To:'.$bank_name2;
                                                                $data_bank['status_by']='Bank Internal transfer';
                            ...
                            $res =$this->Main_model->where_names_two_order_by('bankaccount_manage','bank_account_id',$bid1,'deleteid',$data_bank['deletemod'],'id','ASC');
                                                                  if(count($res)==0)
                                                                  {
                    ...
                    $bank2=$form_data->bank2;
                     ...
                     $account_head_id=$form_data->account_head_id;
                                                               ...
                                                               if($bid1==24)
                                                                ...
                                                                $data_bank['deletemod']=$this->userid.$enteramount.$bid1.$date;
                                                                $data_bank['create_date']=$date;
                                                                $data_bank['name']='Bank Transfer From:'.$bank_name2;
                                                                $data_bank['status_by']='Bank Internal transfer';
                                                                $data_bank['single_deposite']=1;
                                                                $data_bank['internal_payment_status']=1;
                                                                if($bid1>0)
	...
	public function updatebankset()
    {
            ...
            $form_data = json_decode(file_get_contents("php://input"));
                   ...
                   $time= date('h:i A');
                                                                 ...
                                                                 $res =$this->Main_model->where_names_two_order_by('bankaccount_manage','bank_account_id',$form_data->bank_account_id,'deleteid','0','id','ASC');
                                                                 $balancetotal=0;
                                                                 $debitsamount=0;
                                                                 $creditsamount=0;
                                                                 foreach($res as $val)
                                                                ...
                                                                if($form_data->status_by!='')
                                                                {
                                                                    $data_bank['status_by']=$form_data->status_by;
                                                                }
                                                                else
                                                                {
                                                                    $data_bank['status_by']='_';
                                                                }
                                                                ...
                                                                if($form_data->bank_account_id==24)
                                                                {
                                                                     $data_bank['account_head_id']=106;
                                                                     $data_bank['account_heads_id_2']=106;
                                                                }
                                                                elseif($form_data->bank_account_id==25)
                                                                {
                                                                     $data_bank['account_head_id']=105;
                                                                     $data_bank['account_heads_id_2']=105;
                                                                }
                                                                ...
                                                                $data_bank['edited_by']=$this->userid;
                                                                $getcurrendata = $this->Main_model->where_names('bankaccount_manage','id',$form_data->id);
                                                                foreach($getcurrendata as $valb1ss)
                                                                {
                                                                    $deletemod= $valb1ss->deletemod;
                                                                    $bank_account_id_old= $valb1ss->bank_account_id;
                                                                    
                                                                     $orgamount= $valb1ss->debit;
                                                                    
                                                                    if($orgamount==0)
                                                                    {

                                                                        $orgamount= $valb1ss->credit.' CR';
                                                                        if($valb1ss->status_by=='Bank Internal transfer')
                                                                        {

                                                                         if($bank_account_id_old>0)
                                                                         {




                                                                     $this->db->query("UPDATE bankaccount_manage SET changes_status=1,debit='".$form_data->credit."',credit='0',create_date='".$form_data->create_date."' WHERE deletemod='".$deletemod."' AND deleteid=0 AND bank_account_id!='".$bank_account_id_old."'");
                                                                    ...
                                                                    else
                                                                    {
                                                                       ...
                                                                       $this->db->query("UPDATE bankaccount_manage SET changes_status=1,credit='".$form_data->debit."',debit='0',create_date='".$form_data->create_date."' WHERE deletemod='".$deletemod."' AND deleteid=0 AND bank_account_id!='".$bank_account_id_old."'");
                                                                ...
                                                                $data_bank['amount']=$orgamount.' Date : '.$date.' '.$time;
                                                                $data_bank['changes_status']=1;
                                                                
                                                               
                                                                $data_bank['ex_code']=$form_data->ex_code;
                                                                ...
                                                                if($bank_account_id_old==$form_data->bank_account_id)
                                                                {           
                                                                            ...
                                                                            $deletelog['all_legers']=$form_data->bank_account_id;
                                                                            $deletelog['bank_legers']='Bank Account Update '.$orgamount;
                                                        ...
                                                        if($form_data->bank_account_id>0)
                                                        { 
                                                              ...
                                                              $this->Main_model->insert_commen($data_bank,'bankaccount_manage');
                                                                       ...
                                                                       $deletelog['userid']=$this->userid;
                                                                       $deletelog['all_legers']=$form_data->bank_account_id;
                                                                       $deletelog['bank_legers']='Bank Account change ';
                                                                       $this->Main_model->insert_commen($deletelog,'deleted_log');

                                                       

                                                                     
                                                             $this->db->query("UPDATE bankaccount_manage SET deleteid='1' WHERE id='".$form_data->id."'");
                                                                ...
                                                                if($form_data->bank_account_id==25)
                                                                {
                                                                     $mode="0";
                                                                }
                                                                else
                   ...
                   $this->db->query("UPDATE all_ledgers SET bank_id='".$form_data->bank_account_id."',payment_mode='".$mode."',org_amount='".$orgamount."',changes_status=1,debits='".$form_data->debit."',credits='".$form_data->credit."',payment_date='".$form_data->create_date."' WHERE deletemod='".$deletemod."' AND deleteid=0");
